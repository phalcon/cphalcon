...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed){
	...
	phalcon_read_property(&t0, this_ptr, "_resourcesNames", sizeof("_resourcesNames")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "in_array", v1, t0, 0x000);
	Z_DELREF_P(v1);
	Z_DELREF_P(t0);
	if (!zend_is_true(r0)) {
		PHALCON_MM_RESTORE();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, _rebuildAccessList){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "count", t0, 0x001);
	...
	Z_ADDREF_P(r3);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "ceil", r3, 0x002);
	Z_DELREF_P(r3);
...
PHP_METHOD(Phalcon_Acl, __construct){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	Z_ADDREF_P(v2);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v2, 0x003);
	Z_DELREF_P(v2);
	if (!zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL_MM(i0);
		object_init_ex(i0, phalcon_acl_exception_class_entry);
...
PHP_METHOD(Phalcon_Acl, __call){
	...
	Z_ADDREF_P(a1);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "call_user_func_array", a1, v1, 0x004);
	Z_DELREF_P(a1);
	Z_DELREF_P(v1);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Cache_Adapter_File, __construct){
	...
	if (eval_int) {
		...
		Z_ADDREF_P(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "is_writable", r1, 0x005);
		Z_DELREF_P(r1);
		if (!zend_is_true(r0)) {
			PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Cache_Adapter_File, start){
	...
	if (phalcon_file_exists(v3 TSRMLS_CC) == SUCCESS) {
		...
		PHALCON_ALLOC_ZVAL_MM(r2);
		PHALCON_CALL_FUNC(r2, "time", 0x006);
		...
		PHALCON_ALLOC_ZVAL_MM(r5);
		Z_ADDREF_P(v3);
		PHALCON_CALL_FUNC_PARAMS_1(r5, "filemtime", v3, 0x007);
		Z_DELREF_P(v3);
		PHALCON_INIT_VAR(r6);
		is_smaller_function(r6, r4, r5 TSRMLS_CC);
		if (zend_is_true(r6)) {
			PHALCON_ALLOC_ZVAL_MM(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "file_get_contents", v3, 0x008);
			PHALCON_RETURN_DZVAL(r7);
		} else {
			phalcon_update_property_zval(this_ptr, "_lastKey", strlen("_lastKey"), v0 TSRMLS_CC);
			PHALCON_CALL_FUNC_NORETURN("ob_start", 0x009);
			PHALCON_MM_RESTORE();
			RETURN_NULL();
		}
	} else {
...
PHP_METHOD(Phalcon_Cache_Adapter_File, save){
	...
	PHALCON_ALLOC_ZVAL_MM(r2);
	PHALCON_CALL_FUNC(r2, "ob_get_contents", 0x00A);
	PHALCON_CPY_WRT(v5, r2);
	Z_ADDREF_P(v4);
	Z_ADDREF_P(v5);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("file_put_contents", v4, v5, 0x00B);
	Z_DELREF_P(v4);
	Z_DELREF_P(v5);
	if (zend_is_true(v0)) {
		PHALCON_CALL_FUNC_NORETURN("ob_end_clean", 0x00C);
	}
...
PHP_METHOD(Phalcon_Cache, factory){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	Z_ADDREF_P(v3);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v3, 0x003);
	Z_DELREF_P(v3);
	if (!zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL_MM(i0);
		object_init_ex(i0, phalcon_cache_exception_class_entry);
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, __construct){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "parse_ini_file", v0, c0, 0x00D);
	...
	if (Z_TYPE_P(v2) == IS_BOOL && !Z_BVAL_P(v2)) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "basename", v0, 0x00E);
		Z_DELREF_P(v0);
		PHALCON_ALLOC_ZVAL_MM(r2);
	...
	if (Z_TYPE_P(v2) != IS_ARRAY) {
		...
		if (Z_TYPE_P(v3) != IS_ARRAY) {
			...
			PHALCON_INIT_VAR(c1);
			ZVAL_STRING(c1, ".", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "strpos", v6, c1, 0x00F);
			if (Z_TYPE_P(r3) != IS_BOOL || (Z_TYPE_P(r3) == IS_BOOL && Z_BVAL_P(r3))) {
				PHALCON_INIT_VAR(r4);
				PHALCON_INIT_VAR(c2);
				ZVAL_STRING(c2, ".", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r4, "explode", c2, v6, 0x010);
...
PHP_METHOD(Phalcon_Controller_Front, getBaseUri){
	...
	if (!zend_is_true(t0)) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_1(r3, "dirname", r4, 0x013);
			PHALCON_CALL_FUNC_PARAMS_2(r2, "explode", c0, r3, 0x010);
			p1[0] = r2;
			...
			p1[2] = r5;
			PHALCON_CALL_FUNC_PARAMS(r1, "array_slice", 3, p1, 0x012);
			PHALCON_INIT_VAR(c1);
			ZVAL_STRING(c1, "/", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r0, "join", r1, c1, 0x011);
			PHALCON_CPY_WRT(v0, r0);
		} else {
			PHALCON_INIT_VAR(v0);
			ZVAL_STRING(v0, "", 1);
...
PHP_METHOD(Phalcon_Controller, __get){
	...
	if (PHALCON_COMPARE_STRING(v0, "session")) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", this_ptr, 0x014);
		Z_ADDREF_P(r1);
		p2[0] = r1;
		PHALCON_CALL_METHOD_PARAMS_NORETURN(i1, "__construct", 1, p2, PHALCON_CALL_CHECK);
		Z_DELREF_P(p2[0]);
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, tableExists){
	...
	if (zend_is_true(v1)) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		Z_ADDREF_P(v1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "addslashes", v1, 0x015);
		Z_DELREF_P(v1);
...
PHP_METHOD(Phalcon_Db_Mysql, connect){
	...
	if (!zend_is_true(v1)) {
		...
		ZVAL_BOOL(p0[3], 1);
		p0[4] = v6;
		PHALCON_CALL_FUNC_PARAMS(r7, "mysql_connect", 5, p0, 0x016);
		...
		p1[2] = v4;
		p1[3] = v6;
		PHALCON_CALL_FUNC_PARAMS(r8, "mysql_pconnect", 4, p1, 0x017);
	...
	if (zend_is_true(t20)) {
		...
		if (zend_is_true(r10)) {
			...
			PHALCON_CALL_FUNC_PARAMS_2(r11, "mysql_select_db", v7, t25, 0x018);
			if (!zend_is_true(r11)) {
				PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Db_Mysql, query){
	...
	Z_DELREF_P(p1[0]);
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_query", v0, v1, 0x019);
	PHALCON_CPY_WRT(v2, r0);
	if (zend_is_true(v2)) {
...
PHP_METHOD(Phalcon_Db_Mysql, close){
	...
	if (zend_is_true(t0)) {
		...
		phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		Z_ADDREF_P(t1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_close", t1, 0x01A);
		Z_DELREF_P(t1);
		PG(display_errors) = silence;
		PHALCON_CPY_WRT(v0, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, fetchArray){
	...
	Z_ADDREF_P(t2);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_fetch_array", v0, t2, 0x01B);
	Z_DELREF_P(v0);
	Z_DELREF_P(t2);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, numRows){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_num_rows", v0, 0x01C);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, dataSeek){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_data_seek", v1, v0, 0x01D);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v2, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, affectedRows){
	...
	PHALCON_ALLOC_ZVAL_MM(t0);
	phalcon_read_property(&t0, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_affected_rows", t0, 0x01E);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
	if (Z_TYPE_P(v1) != IS_BOOL || (Z_TYPE_P(v1) == IS_BOOL && Z_BVAL_P(v1))) {
		PHALCON_RETURN_CHECK_CTOR(v1);
...
PHP_METHOD(Phalcon_Db_Mysql, error){
	...
	if (!zend_is_true(t0)) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC(r0, "mysql_error", 0x01F);
		PHALCON_CPY_WRT(v2, r0);
	} else {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_ALLOC_ZVAL_MM(t1);
		phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "mysql_error", t1, 0x01F);
...
PHP_METHOD(Phalcon_Db_Mysql, noError){
	...
	phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_errno", t1, 0x020);
	Z_DELREF_P(t1);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, lastInsertId){
	...
	PHALCON_ALLOC_ZVAL_MM(t1);
	phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_insert_id", t1, 0x021);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, limit){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_numeric", v1, 0x022);
	if (zend_is_true(r0)) {
		convert_to_long(v1);
		PHALCON_ALLOC_ZVAL_MM(r1);
...
PHP_METHOD(Phalcon_Db_Mysql, tableExists){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	Z_ADDREF_P(v0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "addslashes", v0, 0x015);
	Z_DELREF_P(v0);
	PHALCON_CPY_WRT(v0, r0);
	PHALCON_ALLOC_ZVAL_MM(r1);
	Z_ADDREF_P(v0);
...
PHP_METHOD(Phalcon_Db, insert){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "count", v1, 0x001);
		PHALCON_INIT_VAR(t0);
		ZVAL_LONG(t0, 0);
		PHALCON_ALLOC_ZVAL_MM(r1);
				...
				if (Z_TYPE_P(v1) != IS_ARRAY) {
					...
					if (Z_TYPE_P(r3) == IS_OBJECT) {
						...
						if (zend_is_true(r5)) {
							...
							Z_ADDREF_P(r7);
							PHALCON_CALL_FUNC_PARAMS_1(r6, "addslashes", r7, 0x015);
							Z_DELREF_P(r7);
							Z_ADDREF_P(r6);
							...
							Z_ADDREF_P(r10);
							PHALCON_CALL_FUNC_PARAMS_1(r9, "addslashes", r10, 0x015);
							Z_DELREF_P(r10);
							PHALCON_INIT_VAR(r11);
						...
						Z_ADDREF_P(r13);
						PHALCON_CALL_FUNC_PARAMS_1(r12, "addslashes", r13, 0x015);
						Z_DELREF_P(r13);
		...
		if (Z_TYPE_P(v2) == IS_ARRAY) { 
			...
			PHALCON_INIT_VAR(c0);
			ZVAL_STRING(c0, ", ", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r18, "join", c0, v2, 0x011);
			PHALCON_ALLOC_ZVAL_MM(r16);
			PHALCON_CONCAT_VBOTH(r16, r17, " (", r18);
			PHALCON_ALLOC_ZVAL_MM(r19);
			PHALCON_INIT_VAR(c1);
			ZVAL_STRING(c1, ", ", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r19, "join", c1, v1, 0x011);
			PHALCON_ALLOC_ZVAL_MM(r15);
			...
			PHALCON_INIT_VAR(c2);
			ZVAL_STRING(c2, ", ", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r23, "join", c2, v1, 0x011);
...
PHP_METHOD(Phalcon_Db, update){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "count", v1, 0x001);
	PHALCON_ALLOC_ZVAL_MM(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "count", v2, 0x001);
	PHALCON_INIT_VAR(r3);
		...
		if (zend_is_true(v4)) {
			...
			if (Z_TYPE_P(r4) == IS_OBJECT) {
				...
				if (zend_is_true(r6)) {
					...
					Z_ADDREF_P(r8);
					PHALCON_CALL_FUNC_PARAMS_1(r7, "addslashes", r8, 0x015);
					Z_DELREF_P(r8);
					Z_ADDREF_P(r7);
					...
					Z_ADDREF_P(r11);
					PHALCON_CALL_FUNC_PARAMS_1(r10, "addslashes", r11, 0x015);
					Z_DELREF_P(r11);
					PHALCON_INIT_VAR(r12);
				...
				Z_ADDREF_P(r14);
				PHALCON_CALL_FUNC_PARAMS_1(r13, "addslashes", r14, 0x015);
				Z_DELREF_P(r14);
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_STRING(c0, ", ", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r18, "join", c0, v7, 0x011);
	PHALCON_ALLOC_ZVAL_MM(r19);
...
PHP_METHOD(Phalcon_Db, delete){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "trim", v1, 0x023);
	Z_DELREF_P(v1);
...
PHP_METHOD(Phalcon_Db, factory){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	Z_ADDREF_P(v7);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v7, 0x003);
	Z_DELREF_P(v7);
	if (zend_is_true(r1)) {
...
PHP_METHOD(Phalcon_Dispatcher, dispatch){
	...
	if (!zend_is_true(r3)) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_BOOL(c0, 0);
		PHALCON_CALL_FUNC_PARAMS_2(r4, "class_exists", v10, c0, 0x003);
		Z_DELREF_P(v10);
		if (!zend_is_true(r4)) {
			PHALCON_INIT_VAR(r5);
			...
			PHALCON_INIT_VAR(c1);
			ZVAL_BOOL(c1, 0);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "class_exists", v10, c1, 0x003);
			Z_DELREF_P(v10);
			if (!zend_is_true(r8)) {
				PHALCON_INIT_VAR(i1);
	...
	if (phalcon_method_exists(v6, v14 TSRMLS_CC) == SUCCESS) {
		...
		Z_ADDREF_P(a0);
		Z_ADDREF_P(v12);
		PHALCON_CALL_FUNC_PARAMS_2(r13, "call_user_func_array", a0, v12, 0x004);
		Z_DELREF_P(a0);
		Z_DELREF_P(v12);
		...
		if (phalcon_method_exists_ex(v6, "notfoundaction", strlen("notfoundaction") TSRMLS_CC) == SUCCESS) {
			...
			Z_ADDREF_P(a1);
			Z_ADDREF_P(v12);
			PHALCON_CALL_FUNC_PARAMS_2(r14, "call_user_func_array", a1, v12, 0x004);
			Z_DELREF_P(a1);
			Z_DELREF_P(v12);
...
PHP_METHOD(Phalcon_Dispatcher, forward){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, "/", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "explode", c0, v0, 0x010);
		PHALCON_CPY_WRT(v1, r0);
	}
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		...
		if (Z_TYPE_P(v0) != IS_NULL) {
			if (Z_TYPE_P(v1) != IS_ARRAY) {
				...
				Z_ADDREF_P(v3);
				p0[1] = v3;
				PHALCON_CALL_METHOD_PARAMS(r0, this_ptr, "_filter", 2, p0, PHALCON_CALL_DEFAULT);
				Z_DELREF_P(p0[0]);
				Z_DELREF_P(p0[1]);
				PHALCON_CPY_WRT(v2, r0);
				zend_hash_move_forward_ex(ah0, &hp0);
...
PHP_METHOD(Phalcon_Filter, _sanitize){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_INIT_VAR(t1);
		ZVAL_LONG(t1, 517);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "filter_var", v0, t1, 0x025);
		PHALCON_RETURN_DZVAL(r1);
	}
	PHALCON_INIT_VAR(t2);
	...
	if (zend_is_true(r2)) {
		...
		PHALCON_INIT_VAR(t3);
		ZVAL_LONG(t3, 519);
		PHALCON_CALL_FUNC_PARAMS_2(r3, "filter_var", v0, t3, 0x025);
		PHALCON_RETURN_DZVAL(r3);
	}
	PHALCON_INIT_VAR(t4);
	...
	if (zend_is_true(r4)) {
		...
		PHALCON_INIT_VAR(t5);
		ZVAL_LONG(t5, 513);
		PHALCON_CALL_FUNC_PARAMS_2(r5, "filter_var", v0, t5, 0x025);
	...
	if (zend_is_true(r6)) {
		...
		p3[2] = a0;
		PHALCON_CALL_FUNC_PARAMS(r7, "filter_var", 3, p3, 0x025);
		PHALCON_RETURN_DZVAL(r7);
	}
	PHALCON_ALLOC_ZVAL_MM(i0);
	object_init_ex(i0, phalcon_exception_class_entry);
...
PHP_METHOD(Phalcon_Filter, _filter){
	...
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "trim", v0, 0x023);
		Z_DELREF_P(v0);
		PHALCON_RETURN_DZVAL(r1);
	}
	PHALCON_INIT_VAR(t1);
	...
	if (zend_is_true(r2)) {
		PHALCON_ALLOC_ZVAL_MM(r3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r3, "strip_tags", v0, 0x026);
		Z_DELREF_P(v0);
		PHALCON_RETURN_DZVAL(r3);
	}
	PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Flash, _showMessage){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, " ", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "join", c0, v1, 0x011);
		PHALCON_CPY_WRT(v2, r0);
	} else {
...
PHP_METHOD(Phalcon_Model_Base, __construct){
	...
	PHALCON_ALLOC_ZVAL_MM(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "get_class", this_ptr, 0x014);
...
PHP_METHOD(Phalcon_Model_Base, _createSQLSelectMulti){
	...
	if (eval_int) {
		...
		Z_DELREF_P(p4[0]);
		PHALCON_CALL_FUNC_PARAMS_2(r5, "join", c0, r6, 0x011);
		PHALCON_ALLOC_ZVAL_MM(r7);
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_1(r17, "is_numeric", r18, 0x022);
			if (zend_is_true(r17)) {
	...
	if (Z_TYPE_P(v4) == IS_ARRAY) { 
		...
		if (eval_int) {
			...
			if (eval_int) {
				...
				PHALCON_CALL_FUNC_PARAMS_1(r6, "is_numeric", r7, 0x022);
				if (zend_is_true(r6)) {
					PHALCON_ALLOC_ZVAL_MM(r9);
		...
		PHALCON_ALLOC_ZVAL_MM(r31);
		PHALCON_CALL_FUNC_PARAMS_1(r31, "strlen", v4, 0x027);
		PHALCON_INIT_VAR(t1);
		ZVAL_LONG(t1, 0);
		...
		if (zend_is_true(r32)) {
			PHALCON_ALLOC_ZVAL_MM(r33);
			PHALCON_CALL_FUNC_PARAMS_1(r33, "is_numeric", v4, 0x022);
			if (zend_is_true(r33)) {
				PHALCON_ALLOC_ZVAL_MM(r35);
...
PHP_METHOD(Phalcon_Model_Base, find){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "get_called_class", 0x028);
	PHALCON_CPY_WRT(v1, r0);
...
PHP_METHOD(Phalcon_Model_Base, findFirst){
	...
	if (eval_int) {
		...
		Z_DELREF_P(p9[0]);
		PHALCON_CALL_FUNC_PARAMS_2(r7, "join", c0, r8, 0x011);
		PHALCON_ALLOC_ZVAL_MM(r10);
...
PHP_METHOD(Phalcon_Model_Base, _exists){
	...
	if (!zend_is_true(t0)) {
		...
		PHALCON_CPY_WRT(v6, r5);
		PHALCON_ALLOC_ZVAL_MM(r6);
		PHALCON_CALL_FUNC_PARAMS_1(r6, "count", v5, 0x001);
		PHALCON_INIT_VAR(t1);
		ZVAL_LONG(t1, 0);
		PHALCON_INIT_VAR(r7);
		...
		if (zend_is_true(r7)) {
			...
			PHALCON_ALLOC_ZVAL_MM(r16);
			PHALCON_CALL_FUNC_PARAMS_1(r16, "count", v4, 0x001);
			if (zend_is_true(r16)) {
				PHALCON_ALLOC_ZVAL_MM(r17);
				PHALCON_INIT_VAR(c0);
				ZVAL_STRING(c0, " AND ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r17, "join", c0, v4, 0x011);
		...
		PHALCON_ALLOC_ZVAL_MM(r23);
		PHALCON_CALL_FUNC_PARAMS_1(r23, "count", v5, 0x001);
		PHALCON_INIT_VAR(t7);
		ZVAL_LONG(t7, 0);
		PHALCON_INIT_VAR(r24);
		...
		if (zend_is_true(r24)) {
			...
			PHALCON_ALLOC_ZVAL_MM(r33);
			PHALCON_CALL_FUNC_PARAMS_1(r33, "count", v4, 0x001);
			if (zend_is_true(r33)) {
				PHALCON_ALLOC_ZVAL_MM(r34);
				PHALCON_INIT_VAR(c1);
				ZVAL_STRING(c1, " AND ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r34, "join", c1, v4, 0x011);
...
PHP_METHOD(Phalcon_Model_Base, count){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CPY_WRT(v10, r18);
			PHALCON_ALLOC_ZVAL_MM(r19);
			PHALCON_CALL_FUNC_PARAMS_1(r19, "is_numeric", v10, 0x022);
			if (zend_is_true(r19)) {
				PHALCON_ALLOC_ZVAL_MM(r20);
				PHALCON_ALLOC_ZVAL_MM(r21);
...
PHP_METHOD(Phalcon_Model_Base, appendMessage){
	...
	if (Z_TYPE_P(v0) == IS_OBJECT) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "get_class", v0, 0x014);
		if (!PHALCON_COMPARE_STRING(r0, "Phalcon_Model_Message")) {
			PHALCON_ALLOC_ZVAL_MM(i0);
			object_init_ex(i0, phalcon_model_exception_class_entry);
			PHALCON_ALLOC_ZVAL_MM(r1);
			PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", v0, 0x014);
			PHALCON_ALLOC_ZVAL_MM(r2);
		...
		PHALCON_ALLOC_ZVAL_MM(r3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r3, "gettype", v0, 0x029);
		Z_DELREF_P(v0);
		PHALCON_ALLOC_ZVAL_MM(r4);
...
PHP_METHOD(Phalcon_Model_Base, validate){
	...
	PHALCON_ALLOC_ZVAL_MM(r5);
	Z_ADDREF_P(v3);
	PHALCON_CALL_FUNC_PARAMS_1(r5, "is_array", v3, 0x02A);
	Z_DELREF_P(v3);
	PHALCON_INIT_VAR(t0);
	ZVAL_BOOL(t0, 0);
	PHALCON_ALLOC_ZVAL_MM(r6);
...
PHP_METHOD(Phalcon_Model_Base, _preSave){
	...
	if (Z_TYPE_P(v3) == IS_ARRAY) { 
		...
		ZVAL_BOOL(v5, 0);
		PHALCON_ALLOC_ZVAL_MM(r5);
		PHALCON_CALL_FUNC_PARAMS_1(r5, "count", v3, 0x001);
		PHALCON_CPY_WRT(v6, r5);
		PHALCON_INIT_VAR(v7);
		ZVAL_LONG(v7, 0);
		fs34:
		...
		if (!zend_is_true(r8)) {
			...
			PHALCON_INIT_VAR(r12);
			PHALCON_CALL_FUNC_PARAMS_1(r12, "is_numeric", v10, 0x022);
			if (!zend_is_true(r12)) {
				PHALCON_INIT_VAR(v8);
				ZVAL_BOOL(v8, 1);
			}
		...
		if (zend_is_true(r13)) {
			...
			ZVAL_STRING(p10[1], "", 1);
			p10[2] = v9;
			PHALCON_CALL_FUNC_PARAMS(r17, "str_replace", 3, p10, 0x02B);
...
PHP_METHOD(Phalcon_Model_Base, _doLowInsert){
	...
	if (eval_int) {
		...
		PHALCON_ALLOC_ZVAL_MM(r9);
		Z_ADDREF_P(v10);
		PHALCON_CALL_FUNC_PARAMS_1(r9, "is_null", v10, 0x02C);
		Z_DELREF_P(v10);
		PHALCON_INIT_VAR(t7);
		ZVAL_STRING(t7, "", 1);
		PHALCON_INIT_VAR(r10);
...
PHP_METHOD(Phalcon_Model_Base, delete){
	...
	PHALCON_CPY_WRT(v1, r1);
	PHALCON_ALLOC_ZVAL_MM(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "count", v1, 0x001);
	PHALCON_INIT_VAR(t5);
	ZVAL_LONG(t5, 1);
	PHALCON_ALLOC_ZVAL_MM(r3);
	...
	if (zend_is_true(r3)) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, " AND ", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r10, "join", c0, v3, 0x011);
...
PHP_METHOD(Phalcon_Model_Base, __call){
	...
	PHALCON_INIT_VAR(p0[2]);
	ZVAL_LONG(p0[2], 3);
	PHALCON_CALL_FUNC_PARAMS(r0, "substr", 3, p0, 0x02D);
	Z_DELREF_P(p0[0]);
	if (PHALCON_COMPARE_STRING(r0, "get")) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_LONG(c0, 3);
		PHALCON_CALL_FUNC_PARAMS_2(r3, "substr", v0, c0, 0x02D);
		Z_DELREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r2, "ucfirst", r3, 0x02E);
		PHALCON_CPY_WRT(v3, r2);
		t0 = zend_read_static_property(phalcon_model_base_class_entry, "_manager", sizeof("_manager")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
		...
		if (zend_is_true(r4)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r6, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r6);
			PHALCON_CALL_FUNC_PARAMS_2(r5, "call_user_func_array", a2, r6, 0x004);
			Z_DELREF_P(a2);
			Z_DELREF_P(r6);
			PHALCON_RETURN_DZVAL(r5);
		}
		...
		if (zend_is_true(r7)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r9, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r9);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "call_user_func_array", a4, r9, 0x004);
			Z_DELREF_P(a4);
			Z_DELREF_P(r9);
		...
		if (zend_is_true(r10)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r12, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r12);
			PHALCON_CALL_FUNC_PARAMS_2(r11, "call_user_func_array", a6, r12, 0x004);
			Z_DELREF_P(a6);
			Z_DELREF_P(r12);
	...
	ZVAL_LONG(p13[2], 5);
	PHALCON_CALL_FUNC_PARAMS(r13, "substr", 3, p13, 0x02D);
	Z_DELREF_P(p13[0]);
	if (PHALCON_COMPARE_STRING(r13, "count")) {
		PHALCON_ALLOC_ZVAL_MM(r14);
		PHALCON_CALL_FUNC_PARAMS_1(r14, "get_class", this_ptr, 0x014);
		...
		PHALCON_INIT_VAR(c1);
		ZVAL_LONG(c1, 5);
		PHALCON_CALL_FUNC_PARAMS_2(r16, "substr", v0, c1, 0x02D);
		Z_DELREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r15, "ucfirst", r16, 0x02E);
		...
		if (zend_is_true(r17)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r19, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r19);
			PHALCON_CALL_FUNC_PARAMS_2(r18, "call_user_func_array", a8, r19, 0x004);
			Z_DELREF_P(a8);
			Z_DELREF_P(r19);
		...
		if (zend_is_true(r20)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r22, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r22);
			PHALCON_CALL_FUNC_PARAMS_2(r21, "call_user_func_array", a10, r22, 0x004);
			Z_DELREF_P(a10);
			Z_DELREF_P(r22);
		...
		if (zend_is_true(r23)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r25, "array_merge", v5, v1, 0x02F);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r25);
			PHALCON_CALL_FUNC_PARAMS_2(r24, "call_user_func_array", a12, r25, 0x004);
			Z_DELREF_P(a12);
			Z_DELREF_P(r25);
	...
	PHALCON_ALLOC_ZVAL_MM(r28);
	PHALCON_CALL_FUNC_PARAMS_1(r28, "get_class", this_ptr, 0x014);
	PHALCON_ALLOC_ZVAL_MM(r26);
...
PHP_METHOD(Phalcon_Model_Manager, __construct){
	...
	Z_ADDREF_P(a5);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("spl_autoload_register", a5, 0x030);
	Z_DELREF_P(a5);
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Model_Manager, isModel){
	...
	if (eval_int) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_BOOL(c0, 0);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "class_exists", v0, c0, 0x003);
		Z_DELREF_P(v0);
		if (!zend_is_true(r0)) {
			PHALCON_ALLOC_ZVAL_MM(t1);
			phalcon_read_property(&t1, this_ptr, "_modelsDir", sizeof("_modelsDir")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
...
PHP_METHOD(Phalcon_Model_Manager, load){
	...
	if (!zend_is_true(r0)) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_BOOL(c0, 0);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "class_exists", v0, c0, 0x003);
		Z_DELREF_P(v0);
		if (!zend_is_true(r1)) {
			PHALCON_ALLOC_ZVAL_MM(t1);
			phalcon_read_property(&t1, this_ptr, "_modelsDir", sizeof("_modelsDir")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
			...
			if (phalcon_file_exists(v1 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_INIT_VAR(c1);
				ZVAL_BOOL(c1, 0);
				PHALCON_CALL_FUNC_PARAMS_2(r4, "class_exists", v0, c1, 0x003);
				Z_DELREF_P(v0);
				if (!zend_is_true(r4)) {
					PHALCON_ALLOC_ZVAL_MM(i0);
					object_init_ex(i0, phalcon_model_exception_class_entry);
...
PHP_METHOD(Phalcon_Model_Manager, addHasOne){
	...
	if (!zend_is_true(r3)) {
		if (Z_TYPE_P(v3) == IS_ARRAY) { 
			PHALCON_ALLOC_ZVAL_MM(r4);
			PHALCON_CALL_FUNC_PARAMS_1(r4, "count", v1, 0x001);
			PHALCON_ALLOC_ZVAL_MM(r5);
			PHALCON_CALL_FUNC_PARAMS_1(r5, "count", v3, 0x001);
			PHALCON_INIT_VAR(r6);
...
PHP_METHOD(Phalcon_Model_Manager, _getRelationRecords){
	...
	if (Z_TYPE_P(r0) != IS_ARRAY) { 
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, " AND ", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r14, "join", c0, v6, 0x011);
	...
	Z_ADDREF_P(a2);
	Z_ADDREF_P(v8);
	PHALCON_CALL_FUNC_PARAMS_2(r18, "call_user_func_array", a2, v8, 0x004);
	Z_DELREF_P(a2);
	Z_DELREF_P(v8);
	PHALCON_RETURN_DZVAL(r18);
}
...
PHP_METHOD(Phalcon_Model_MetaData, __construct){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v1, 0x003);
	Z_DELREF_P(v1);
	if (zend_is_true(r1)) {
		ce0 = zend_fetch_class(Z_STRVAL_P(v1), Z_STRLEN_P(v1), ZEND_FETCH_CLASS_DEFAULT TSRMLS_CC);
		PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Model_MetaData, _initializeMetaData){
	...
	if (!zend_is_true(t1)) {
		...
		if (!zend_is_true(v5)) {
			...
			PHALCON_ALLOC_ZVAL_MM(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "get_class", v0, 0x014);
			PHALCON_ALLOC_ZVAL_MM(r4);
			...
			if (Z_TYPE_P(v6) != IS_ARRAY) {
				...
				PHALCON_CALL_FUNC_PARAMS_2(r13, "strpos", v15, c0, 0x00F);
				if (Z_TYPE_P(r13) != IS_BOOL || (Z_TYPE_P(r13) == IS_BOOL && Z_BVAL_P(r13))) {
					...
					PHALCON_CALL_FUNC_PARAMS_2(r14, "strpos", v15, c1, 0x00F);
...
PHP_METHOD(Phalcon_Model_Query, getConditions){
	...
	if (Z_TYPE_P(t2) != IS_ARRAY) {
		...
		if (Z_TYPE_P(t4) != IS_ARRAY) {
			...
			Z_ADDREF_P(v10);
			Z_ADDREF_P(v5);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "in_array", v10, v5, 0x000);
			Z_DELREF_P(v10);
			Z_DELREF_P(v5);
			if (zend_is_true(r8)) {
				PHALCON_INIT_VAR(t5);
		...
		if (Z_TYPE_P(t7) != IS_ARRAY) {
			...
			PHALCON_INIT_VAR(c0);
			ZVAL_STRING(c0, "?", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r14, "explode", c0, v11, 0x010);
		...
		PHALCON_INIT_VAR(r20);
		PHALCON_CALL_FUNC_PARAMS_1(r20, "count", v12, 0x001);
		if (!zend_is_true(r20)) {
			...
			PHALCON_INIT_VAR(c1);
			ZVAL_STRING(c1, " AND ", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r21, "join", c1, v12, 0x011);
...
PHP_METHOD(Phalcon_Model_Resultset, count){
	...
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_null", t1, 0x02C);
	Z_DELREF_P(t1);
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_ALLOC_ZVAL_MM(t2);
...
PHP_METHOD(Phalcon_Model_Validator_Email, validate){
	...
	if (zend_is_true(r0)) {
		...
		Z_SET_ISREF_P(v0);
		p2[2] = v0;
		PHALCON_CALL_FUNC_PARAMS(r2, "preg_match", 3, p2, 0x031);
		Z_DELREF_P(p2[1]);
...
PHP_METHOD(Phalcon_Model_Validator_Exclusionin, checkOptions){
	...
	Z_ADDREF_P(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "is_array", r2, 0x02A);
	Z_DELREF_P(r2);
	if (!zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL_MM(i1);
		object_init_ex(i1, phalcon_model_exception_class_entry);
...
PHP_METHOD(Phalcon_Model_Validator_Exclusionin, validate){
	...
	if (zend_is_true(r0)) {
		...
		if (zend_is_true(r1)) {
			...
			Z_ADDREF_P(r4);
			Z_ADDREF_P(v0);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "in_array", r4, v0, 0x000);
			Z_DELREF_P(r4);
			Z_DELREF_P(v0);
			if (zend_is_true(r3)) {
				PHALCON_ALLOC_ZVAL_MM(r5);
				...
				PHALCON_INIT_VAR(c0);
				ZVAL_STRING(c0, ", ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r8, "join", c0, v0, 0x011);
				PHALCON_ALLOC_ZVAL_MM(r6);
...
PHP_METHOD(Phalcon_Model_Validator_Numericality, validate){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_CALL_FUNC_PARAMS_1(r1, "is_numeric", r2, 0x022);
		if (!zend_is_true(r1)) {
			PHALCON_ALLOC_ZVAL_MM(r3);
	...
	if (zend_is_true(r0)) {
		...
		if (Z_TYPE_P(v1) == IS_ARRAY) { 
			if (Z_TYPE_P(v1) != IS_ARRAY) {
				...
				Z_DELREF_P(p4[0]);
				Z_ADDREF_P(r4);
				PHALCON_CALL_FUNC_PARAMS_1(r3, "addslashes", r4, 0x015);
				Z_DELREF_P(r4);
				PHALCON_CPY_WRT(v4, r3);
				PHALCON_INIT_VAR(r5);
		...
		if (Z_TYPE_P(v7) != IS_ARRAY) {
			...
			Z_DELREF_P(p11[0]);
			Z_ADDREF_P(r16);
			PHALCON_CALL_FUNC_PARAMS_1(r15, "addslashes", r16, 0x015);
			Z_DELREF_P(r16);
			PHALCON_INIT_VAR(r14);
...
PHP_METHOD(Phalcon_Model_Validator, appendMessage){
	...
	if (PHALCON_COMPARE_STRING(v2, "")) {
		...
		PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", this_ptr, 0x014);
		p0[2] = r1;
		PHALCON_CALL_FUNC_PARAMS(r0, "str_replace", 3, p0, 0x02B);
		PHALCON_CPY_WRT(v2, r0);
	}
	PHALCON_ALLOC_ZVAL_MM(i0);
	object_init_ex(i0, phalcon_model_message_class_entry);
...
PHP_METHOD(Phalcon_Paginator_Adapter_Array, getPaginate){
	...
	PHALCON_ALLOC_ZVAL_MM(r4);
	PHALCON_ALLOC_ZVAL_MM(r5);
	PHALCON_CALL_FUNC_PARAMS_1(r5, "count", v1, 0x001);
	PHALCON_INIT_VAR(t4);
	ZVAL_LONG(t4, 1);
	PHALCON_ALLOC_ZVAL_MM(r6);
	...
	Z_ADDREF_P(r7);
	PHALCON_CALL_FUNC_PARAMS_1(r4, "round", r7, 0x032);
	Z_DELREF_P(r7);
	PHALCON_CPY_WRT(v6, r4);
	if (Z_TYPE_P(v1) != IS_ARRAY) { 
		PHALCON_ALLOC_ZVAL_MM(i1);
	...
	p4[1] = v5;
	p4[2] = v0;
	PHALCON_CALL_FUNC_PARAMS(r8, "array_slice", 3, p4, 0x012);
...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, getPaginate){
	...
	Z_ADDREF_P(r6);
	PHALCON_CALL_FUNC_PARAMS_1(r4, "ceil", r6, 0x002);
	Z_DELREF_P(r6);
	PHALCON_CPY_WRT(v6, r4);
	if (Z_TYPE_P(v1) != IS_OBJECT) {
		PHALCON_ALLOC_ZVAL_MM(i1);
	...
	if (zend_is_true(r14)) {
		...
		if (zend_is_true(r17)) {
			...
			Z_ADDREF_P(r19);
			PHALCON_CALL_FUNC_PARAMS_1(r18, "intval", r19, 0x033);
			Z_DELREF_P(r19);
			PHALCON_INIT_VAR(t9);
			ZVAL_LONG(t9, 1);
			PHALCON_ALLOC_ZVAL_MM(r20);
	...
	if (zend_is_true(r24)) {
		...
		Z_ADDREF_P(r26);
		PHALCON_CALL_FUNC_PARAMS_1(r25, "intval", r26, 0x033);
		Z_DELREF_P(r26);
		PHALCON_INIT_VAR(t12);
		ZVAL_LONG(t12, 1);
		PHALCON_ALLOC_ZVAL_MM(r27);
...
PHP_METHOD(Phalcon_Request, isSoapRequested){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_2(r0, "strpos", r1, c0, 0x00F);
			PHALCON_INIT_VAR(t0);
			ZVAL_BOOL(t0, 0);
			PHALCON_INIT_VAR(r2);
...
PHP_METHOD(Phalcon_Request, getRawBody){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "file_get_contents", c0, 0x008);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Request, getServerAddress){
	...
	if (eval_int) {
		...
		PHALCON_CALL_FUNC_PARAMS_1(r1, "gethostbyname", c0, 0x034);
		PHALCON_RETURN_DZVAL(r1);
	}
	PHALCON_MM_RESTORE();
	RETURN_NULL();
...
PHP_METHOD(Phalcon_Request, hasFiles){
	...
	if (zend_is_true(g0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "count", g0, 0x001);
		PHALCON_INIT_VAR(t0);
		ZVAL_LONG(t0, 0);
		PHALCON_INIT_VAR(r2);
...
PHP_METHOD(Phalcon_Request, getAcceptableContent){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_STRING(c0, "/,\\s*/", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r1, "preg_split", c0, v0, 0x035);
	PHALCON_CPY_WRT(v1, r1);
	PHALCON_INIT_VAR(a0);
	array_init(a0);
	PHALCON_CPY_WRT(v2, a0);
	if (Z_TYPE_P(v1) != IS_ARRAY) {
		...
		PHALCON_INIT_VAR(c1);
		ZVAL_STRING(c1, ";", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r2, "explode", c1, v3, 0x010);
		PHALCON_CPY_WRT(v4, r2);
		...
		if (eval_int) {
			...
			PHALCON_INIT_VAR(c2);
			ZVAL_LONG(c2, 2);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "substr", r4, c2, 0x02D);
			Z_DELREF_P(r4);
			PHALCON_CPY_WRT(v5, r3);
		} else {
			PHALCON_INIT_VAR(v5);
...
PHP_METHOD(Phalcon_Response, setStatusCode){
	...
	if (eval_int) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_BOOL(c0, 1);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("header", r0, c0, 0x036);
		Z_DELREF_P(r0);
		PHALCON_ALLOC_ZVAL_MM(r3);
		...
		PHALCON_INIT_VAR(c1);
		ZVAL_BOOL(c1, 1);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("header", r2, c1, 0x036);
		Z_DELREF_P(r2);
	}
	PHALCON_MM_RESTORE();
	RETURN_NULL();
...
PHP_METHOD(Phalcon_Response, setRawHeader){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("header", v0, c0, 0x036);
	Z_DELREF_P(v0);
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Router_Rewrite, handle){
	...
	if (zend_is_true(v0)) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, "/", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "explode", c0, v0, 0x010);
		PHALCON_CPY_WRT(v1, r1);
		eval_int = phalcon_array_isset_long(v1, 0);
		if (eval_int) {
			PHALCON_ALLOC_ZVAL_MM(r2);
		...
		PHALCON_CPY_WRT(v2, a0);
		PHALCON_ALLOC_ZVAL_MM(r6);
		PHALCON_CALL_FUNC_PARAMS_1(r6, "count", v1, 0x001);
		PHALCON_CPY_WRT(v3, r6);
		PHALCON_INIT_VAR(v4);
		ZVAL_LONG(v4, 2);
		fs53:
...
PHP_METHOD(Phalcon_Session, start){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "session_start", 0x037);
	PG(display_errors) = silence;
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Session, getId){
	...
	PHALCON_MM_GROW();
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "session_id", 0x038);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Tag, setDefault){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_scalar", v1, 0x039);
	Z_DELREF_P(v1);
	if (!zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Tag, _getValueFromAction){
	...
	if (zend_is_true(t1)) {
		...
		if (eval_int) {
			PHALCON_ALLOC_ZVAL_MM(r0);
			PHALCON_CALL_FUNC(r0, "get_magic_quotes_gpc", 0x03A);
			if (!zend_is_true(r0)) {
				PHALCON_ALLOC_ZVAL_MM(r1);
				...
				phalcon_array_fetch(&r3, g0, v0, PHALCON_NOISY_FETCH TSRMLS_CC);
				Z_ADDREF_P(r3);
				PHALCON_CALL_FUNC_PARAMS_1(r2, "stripslashes", r3, 0x03B);
				Z_DELREF_P(r3);
				PHALCON_RETURN_DZVAL(r2);
			}
		}
...
PHP_METHOD(Phalcon_Tag, form){
	...
	PHALCON_CALL_FUNC_PARAMS_2(r1, "join", c0, r2, 0x011);
	PHALCON_CPY_WRT(v3, r1);
	eval_int = phalcon_array_isset_long(v1, 0);
	PHALCON_INIT_VAR(r3);
	ZVAL_BOOL(r3, eval_int);
...
PHP_METHOD(Phalcon_Test, nice){
	...
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("print_r", v1, 0x03C);
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Transaction_Manager, get){
	...
	if (zend_is_true(t0)) {
		...
		PHALCON_CALL_FUNC_PARAMS_1_NORETURN("register_shutdown_function", a0, 0x03D);
		PHALCON_INIT_VAR(t1);
		ZVAL_BOOL(t1, 1);
...
PHP_METHOD(Phalcon_Transaction, commit){
	...
	if (!PHALCON_COMPARE_STRING(t0, "")) {
		...
		add_next_index_zval(a1, this_ptr);
		Z_ADDREF_P(a1);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("call_user_func_array", a0, a1, 0x004);
		Z_DELREF_P(a0);
		Z_DELREF_P(a1);
	}
	PHALCON_ALLOC_ZVAL_MM(r0);
...
PHP_METHOD(Phalcon_Utils, camelize){
	...
	ZVAL_STRING(p2[1], " ", 1);
	PHALCON_ALLOC_ZVAL_MM(r3);
	PHALCON_CALL_FUNC_PARAMS_1(r3, "strtolower", v0, 0x040);
	p2[2] = r3;
	PHALCON_CALL_FUNC_PARAMS(r2, "str_replace", 3, p2, 0x02B);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "ucwords", r2, 0x03F);
	p0[2] = r1;
	PHALCON_CALL_FUNC_PARAMS(r0, "str_replace", 3, p0, 0x02B);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Utils, uncamelize){
	...
	if (Z_TYPE_P(v1) != IS_ARRAY) {
		...
		Z_ADDREF_P(v3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "preg_match", v3, v0, 0x031);
		Z_DELREF_P(v3);
		Z_DELREF_P(v0);
		if (zend_is_true(r0)) {
			PHALCON_INIT_VAR(r1);
			...
			p2[1] = v2;
			p2[2] = v0;
			PHALCON_CALL_FUNC_PARAMS(r2, "preg_replace", 3, p2, 0x041);
			PHALCON_CALL_FUNC_PARAMS_1(r1, "strtolower", r2, 0x040);
			PHALCON_RETURN_DZVAL(r1);
		}
		zend_hash_move_forward_ex(ah0, &hp0);
		goto fes75;
...
PHP_METHOD(Phalcon_Utils, lcfirst){
	...
	PHALCON_INIT_VAR(p1[2]);
	ZVAL_LONG(p1[2], 1);
	PHALCON_CALL_FUNC_PARAMS(r1, "substr", 3, p1, 0x02D);
	Z_DELREF_P(p1[0]);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "strtolower", r1, 0x040);
	PHALCON_ALLOC_ZVAL_MM(r2);
	Z_ADDREF_P(v0);
	PHALCON_INIT_VAR(c0);
	ZVAL_LONG(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2(r2, "substr", v0, c0, 0x02D);
	Z_DELREF_P(v0);
	PHALCON_ALLOC_ZVAL_MM(r3);
...
PHP_METHOD(Phalcon_View, render){
	...
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC(r1, "ob_get_contents", 0x00A);
		...
		if (zend_is_true(r2)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				PHALCON_CALL_FUNC_NORETURN("ob_clean", 0x042);
				phalcon_require(v7 TSRMLS_CC);
				if (EG(exception) || EG(exit_status) == 255) {
					return;
				}
				PHALCON_ALLOC_ZVAL_MM(r6);
				PHALCON_CALL_FUNC(r6, "ob_get_contents", 0x00A);
			...
			if (Z_TYPE_P(v8) == IS_ARRAY) { 
				...
				if (Z_TYPE_P(v8) != IS_ARRAY) {
					...
					if (phalcon_file_exists(v10 TSRMLS_CC) == SUCCESS) {
						...
						PHALCON_INIT_VAR(r11);
						PHALCON_CALL_FUNC(r11, "ob_get_contents", 0x00A);
		...
		if (zend_is_true(r13)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_ALLOC_ZVAL_MM(r17);
				PHALCON_CALL_FUNC(r17, "ob_get_contents", 0x00A);
			...
			if (Z_TYPE_P(v11) == IS_ARRAY) { 
				...
				if (Z_TYPE_P(v11) != IS_ARRAY) {
					...
					if (phalcon_file_exists(v10 TSRMLS_CC) == SUCCESS) {
						...
						PHALCON_INIT_VAR(r22);
						PHALCON_CALL_FUNC(r22, "ob_get_contents", 0x00A);
		...
		if (zend_is_true(r24)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_ALLOC_ZVAL_MM(r26);
				PHALCON_CALL_FUNC(r26, "ob_get_contents", 0x00A);
...
PHP_METHOD(Phalcon_View, url){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		PHALCON_CALL_FUNC_PARAMS_1_NORETURN("print_r", v0, 0x03C);
	} else {
		PHALCON_ALLOC_ZVAL_MM(r0);
		Z_ADDREF_P(v0);
		p1[0] = v0;
...
PHP_MINIT_FUNCTION(phalcon){
	...
	INIT_CLASS_ENTRY(ce0, "Phalcon_Acl_Adapter_Memory", phalcon_acl_adapter_memory_functions);
	phalcon_acl_adapter_memory_class_entry = zend_register_internal_class(&ce0 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce1, "Phalcon_Acl_Resource", phalcon_acl_resource_functions);
	phalcon_acl_resource_class_entry = zend_register_internal_class(&ce1 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce2, "Phalcon_Acl_Role", phalcon_acl_role_functions);
	phalcon_acl_role_class_entry = zend_register_internal_class(&ce2 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce3, "Phalcon_Acl", phalcon_acl_functions);
	phalcon_acl_class_entry = zend_register_internal_class(&ce3 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce4, "Phalcon_Cache_Adapter_File", phalcon_cache_adapter_file_functions);
	phalcon_cache_adapter_file_class_entry = zend_register_internal_class(&ce4 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce6, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce6 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce7, "Phalcon_Controller_Front", phalcon_controller_front_functions);
	phalcon_controller_front_class_entry = zend_register_internal_class(&ce7 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce8, "Phalcon_Controller", phalcon_controller_functions);
	phalcon_controller_class_entry = zend_register_internal_class(&ce8 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce9, "Phalcon_Db_Dialect_Mysql", phalcon_db_dialect_mysql_functions);
	phalcon_db_dialect_mysql_class_entry = zend_register_internal_class(&ce9 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce10, "Phalcon_Db_Pool", phalcon_db_pool_functions);
	phalcon_db_pool_class_entry = zend_register_internal_class(&ce10 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce13, "Phalcon_Dispatcher", phalcon_dispatcher_functions);
	phalcon_dispatcher_class_entry = zend_register_internal_class(&ce13 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce14, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_class_entry = zend_register_internal_class(&ce14 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce17, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_class_entry = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce20, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Model_Query", phalcon_model_query_functions);
	phalcon_model_query_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce23, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce23 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce24, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_class_entry = zend_register_internal_class(&ce24 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce25, "Phalcon_Model_Sanitize", phalcon_model_sanitize_functions);
	phalcon_model_sanitize_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce26, "Phalcon_Model_Validator", phalcon_model_validator_functions);
	phalcon_model_validator_class_entry = zend_register_internal_class(&ce26 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce27, "Phalcon_Paginator_Adapter_Array", phalcon_paginator_adapter_array_functions);
	phalcon_paginator_adapter_array_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Paginator_Adapter_Model", phalcon_paginator_adapter_model_functions);
	phalcon_paginator_adapter_model_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce29, "Phalcon_Paginator", phalcon_paginator_functions);
	phalcon_paginator_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce30, "Phalcon_Request", phalcon_request_functions);
	phalcon_request_class_entry = zend_register_internal_class(&ce30 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce31, "Phalcon_Response", phalcon_response_functions);
	phalcon_response_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce32, "Phalcon_Router_Rewrite", phalcon_router_rewrite_functions);
	phalcon_router_rewrite_class_entry = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Session_Namespace", phalcon_session_namespace_functions);
	phalcon_session_namespace_class_entry = zend_register_internal_class(&ce33 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce34, "Phalcon_Session", phalcon_session_functions);
	phalcon_session_class_entry = zend_register_internal_class(&ce34 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce36, "Phalcon_Test", phalcon_test_functions);
	phalcon_test_class_entry = zend_register_internal_class(&ce36 TSRMLS_CC);
	zend_declare_property_null(phalcon_test_class_entry, "p", sizeof("p")-1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	INIT_CLASS_ENTRY(ce37, "Phalcon_Transaction_Manager", phalcon_transaction_manager_functions);
	phalcon_transaction_manager_class_entry = zend_register_internal_class(&ce37 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce39, "Phalcon_Utils", phalcon_utils_functions);
	phalcon_utils_class_entry = zend_register_internal_class(&ce39 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce40, "Phalcon_View", phalcon_view_functions);
	phalcon_view_class_entry = zend_register_internal_class(&ce40 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce41, "Phalcon_Exception", phalcon_exception_functions);
	phalcon_exception_class_entry = zend_register_internal_class_ex(&ce41, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce42, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce42 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce43, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce43 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_descriptor", sizeof("_descriptor")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_fetchMode", sizeof("_fetchMode")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_autoCommit", sizeof("_autoCommit")-1, 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_idConnection", sizeof("_idConnection")-1, 0, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce44, "Phalcon_Model_Validator", phalcon_model_validator_functions);
	phalcon_model_validator_class_entry = zend_register_internal_class(&ce44 TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_record", sizeof("_record")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_fieldName", sizeof("_fieldName")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_value", sizeof("_value")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_options", sizeof("_options")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce45, "Phalcon_Acl_Exception", phalcon_acl_exception_functions);
	phalcon_acl_exception_class_entry = zend_register_internal_class_ex(&ce45, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_acl_exception_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Exception' not found when registering class 'Phalcon_Acl_Exception'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce46, "Phalcon_Cache_Exception", phalcon_cache_exception_functions);
	phalcon_cache_exception_class_entry = zend_register_internal_class_ex(&ce46, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce47, "Phalcon_Config_Adapter_Ini", phalcon_config_adapter_ini_functions);
	phalcon_config_adapter_ini_class_entry = zend_register_internal_class_ex(&ce47, NULL, "phalcon_config" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce48, "Phalcon_Config_Exception", phalcon_config_exception_functions);
	phalcon_config_exception_class_entry = zend_register_internal_class_ex(&ce48, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce49, "Phalcon_Db_Exception", phalcon_db_exception_functions);
	phalcon_db_exception_class_entry = zend_register_internal_class_ex(&ce49, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce50, "Phalcon_Db_Mysql", phalcon_db_mysql_functions);
	phalcon_db_mysql_class_entry = zend_register_internal_class_ex(&ce50, NULL, "phalcon_db" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce51, "Phalcon_Model_Exception", phalcon_model_exception_functions);
	phalcon_model_exception_class_entry = zend_register_internal_class_ex(&ce51, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce52, "Phalcon_Model_Validator_Email", phalcon_model_validator_email_functions);
	phalcon_model_validator_email_class_entry = zend_register_internal_class_ex(&ce52, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_email_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Email'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce53, "Phalcon_Model_Validator_Exclusionin", phalcon_model_validator_exclusionin_functions);
	phalcon_model_validator_exclusionin_class_entry = zend_register_internal_class_ex(&ce53, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_exclusionin_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Exclusionin'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce54, "Phalcon_Model_Validator_Inclusionin", phalcon_model_validator_inclusionin_functions);
	phalcon_model_validator_inclusionin_class_entry = zend_register_internal_class_ex(&ce54, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_inclusionin_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Inclusionin'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce55, "Phalcon_Model_Validator_Numericality", phalcon_model_validator_numericality_functions);
	phalcon_model_validator_numericality_class_entry = zend_register_internal_class_ex(&ce55, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_numericality_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Numericality'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce56, "Phalcon_Model_Validator_Regex", phalcon_model_validator_regex_functions);
	phalcon_model_validator_regex_class_entry = zend_register_internal_class_ex(&ce56, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_regex_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Regex'");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce57, "Phalcon_Model_Validator_Uniqueness", phalcon_model_validator_uniqueness_functions);
	phalcon_model_validator_uniqueness_class_entry = zend_register_internal_class_ex(&ce57, NULL, "phalcon_model_validator" TSRMLS_CC);
	if(!phalcon_model_validator_uniqueness_class_entry){
		fprintf(stderr, "Phalcon Error: Extended class 'Phalcon_Model_Validator' not found when registering class 'Phalcon_Model_Validator_Uniqueness'");
		return FAILURE;
	}
	...
	INIT_CLASS_ENTRY(ce59, "Phalcon_Tag_Exception", phalcon_tag_exception_functions);
	phalcon_tag_exception_class_entry = zend_register_internal_class_ex(&ce59, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce60, "Phalcon_Transaction_Failed", phalcon_transaction_failed_functions);
	phalcon_transaction_failed_class_entry = zend_register_internal_class_ex(&ce60, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce61, "Phalcon_View_Exception", phalcon_view_exception_functions);
	phalcon_view_exception_class_entry = zend_register_internal_class_ex(&ce61, NULL, "phalcon_exception" TSRMLS_CC);
