...
PHP_METHOD(Phalcon_Cache_Backend_File, __construct){
	...
	if (eval_int) {
		...
		Z_ADDREF_P(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "is_writable", r1, 0x016);
		Z_DELREF_P(r1);
		if (!zend_is_true(r0)) {
			PHALCON_ALLOC_ZVAL_MM(i0);
			object_init_ex(i0, phalcon_cache_exception_class_entry);
...
PHP_METHOD(Phalcon_Cache_Backend_File, start){
	...
	if (phalcon_file_exists(v2 TSRMLS_CC) == SUCCESS) {
		PHALCON_ALLOC_ZVAL_MM(r2);
		PHALCON_CALL_FUNC(r2, "time", 0x017);
		PHALCON_CPY_WRT(v4, r2);
		PHALCON_ALLOC_ZVAL_MM(r3);
		...
		PHALCON_ALLOC_ZVAL_MM(r5);
		Z_ADDREF_P(v2);
		PHALCON_CALL_FUNC_PARAMS_1(r5, "filemtime", v2, 0x018);
		Z_DELREF_P(v2);
		PHALCON_INIT_VAR(r6);
		is_smaller_function(r6, r4, r5 TSRMLS_CC);
		if (zend_is_true(r6)) {
			PHALCON_ALLOC_ZVAL_MM(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "file_get_contents", v2, 0x006);
...
PHP_METHOD(Phalcon_Cache_Backend_File, save){
	...
	Z_ADDREF_P(v5);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("file_put_contents", v5, v1, 0x019);
	Z_DELREF_P(v5);
	Z_DELREF_P(v1);
	if (zend_is_true(v2)) {
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed){
	...
	phalcon_read_property(&t0, this_ptr, "_resourcesNames", sizeof("_resourcesNames")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "in_array", v1, t0, 0x021);
	Z_DELREF_P(v1);
	Z_DELREF_P(t0);
	if (!zend_is_true(r0)) {
		PHALCON_MM_RESTORE();
...
PHP_METHOD(Phalcon_Db_Profiler, startProfile){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "microtime", c0, 0x022);
	Z_ADDREF_P(r0);
	p2[0] = r0;
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, connect){
	...
	if (!zend_is_true(v1)) {
		...
		ZVAL_BOOL(p0[3], 1);
		p0[4] = v6;
		PHALCON_CALL_FUNC_PARAMS(r7, "mysql_connect", 5, p0, 0x023);
		...
		p1[2] = v4;
		p1[3] = v6;
		PHALCON_CALL_FUNC_PARAMS(r8, "mysql_pconnect", 4, p1, 0x024);
	...
	if (zend_is_true(t20)) {
		...
		if (zend_is_true(r10)) {
			...
			PHALCON_CALL_FUNC_PARAMS_2(r11, "mysql_select_db", v7, t25, 0x025);
			if (!zend_is_true(r11)) {
				PHALCON_ALLOC_ZVAL_MM(i0);
				object_init_ex(i0, phalcon_db_exception_class_entry);
				PHALCON_ALLOC_ZVAL_MM(r12);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, query){
	...
	Z_DELREF_P(p1[0]);
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_query", v0, v1, 0x026);
	PHALCON_CPY_WRT(v2, r0);
	if (zend_is_true(v2)) {
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, close){
	...
	if (zend_is_true(t0)) {
		...
		phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		Z_ADDREF_P(t1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_close", t1, 0x027);
		Z_DELREF_P(t1);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, fetchArray){
	...
	Z_ADDREF_P(t2);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_fetch_array", v0, t2, 0x028);
	Z_DELREF_P(v0);
	Z_DELREF_P(t2);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, numRows){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_num_rows", v0, 0x029);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, dataSeek){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_data_seek", v1, v0, 0x02A);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v2, r0);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, affectedRows){
	...
	PHALCON_ALLOC_ZVAL_MM(t0);
	phalcon_read_property(&t0, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_affected_rows", t0, 0x02B);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
	if (Z_TYPE_P(v1) != IS_BOOL || (Z_TYPE_P(v1) == IS_BOOL && Z_BVAL_P(v1))) {
		PHALCON_RETURN_CHECK_CTOR(v1);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, setFetchMode){
	...
	PHALCON_ALLOC_ZVAL_MM(t0);
	phalcon_get_class_constant(t0, phalcon_db_adapter_mysql_class_entry, "DB_ASSOC", strlen("DB_ASSOC") TSRMLS_CC);
	PHALCON_ALLOC_ZVAL_MM(r0);
	...
	PHALCON_ALLOC_ZVAL_MM(t2);
	phalcon_get_class_constant(t2, phalcon_db_adapter_mysql_class_entry, "DB_BOTH", strlen("DB_BOTH") TSRMLS_CC);
	PHALCON_ALLOC_ZVAL_MM(r1);
	...
	PHALCON_ALLOC_ZVAL_MM(t4);
	phalcon_get_class_constant(t4, phalcon_db_adapter_mysql_class_entry, "DB_NUM", strlen("DB_NUM") TSRMLS_CC);
	PHALCON_ALLOC_ZVAL_MM(r2);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, error){
	...
	if (!zend_is_true(t0)) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC(r0, "mysql_error", 0x02C);
		PHALCON_CPY_WRT(v2, r0);
	} else {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_ALLOC_ZVAL_MM(t1);
		phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "mysql_error", t1, 0x02C);
		PHALCON_CPY_WRT(v2, r1);
	}
	if (zend_is_true(v2)) {
		PHALCON_ALLOC_ZVAL_MM(r3);
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, noError){
	...
	phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_errno", t1, 0x02D);
	Z_DELREF_P(t1);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, lastInsertId){
	...
	PHALCON_ALLOC_ZVAL_MM(t1);
	phalcon_read_property(&t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_insert_id", t1, 0x02E);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Db_Adapter_Mysql, limit){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_numeric", v1, 0x02F);
	if (zend_is_true(r0)) {
		convert_to_long(v1);
		PHALCON_ALLOC_ZVAL_MM(r1);
...
PHP_METHOD(Phalcon_Filter, _sanitize){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_INIT_VAR(t1);
		ZVAL_LONG(t1, 517);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "filter_var", v0, t1, 0x030);
		PHALCON_RETURN_DZVAL(r1);
	}
	PHALCON_INIT_VAR(t2);
	...
	if (zend_is_true(r2)) {
		...
		PHALCON_INIT_VAR(t3);
		ZVAL_LONG(t3, 519);
		PHALCON_CALL_FUNC_PARAMS_2(r3, "filter_var", v0, t3, 0x030);
		PHALCON_RETURN_DZVAL(r3);
	}
	PHALCON_INIT_VAR(t4);
	...
	if (zend_is_true(r4)) {
		...
		PHALCON_INIT_VAR(t5);
		ZVAL_LONG(t5, 513);
		PHALCON_CALL_FUNC_PARAMS_2(r5, "filter_var", v0, t5, 0x030);
	...
	if (zend_is_true(r6)) {
		...
		p3[2] = a0;
		PHALCON_CALL_FUNC_PARAMS(r7, "filter_var", 3, p3, 0x030);
		PHALCON_RETURN_DZVAL(r7);
	}
	if (!zend_is_true(v2)) {
		PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Filter, _filter){
	...
	if (zend_is_true(r2)) {
		PHALCON_ALLOC_ZVAL_MM(r3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r3, "strip_tags", v0, 0x031);
		Z_DELREF_P(v0);
		PHALCON_RETURN_DZVAL(r3);
	}
	if (!zend_is_true(v2)) {
...
PHP_METHOD(Phalcon_Loader, register){
	...
	Z_ADDREF_P(a0);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("spl_autoload_register", a0, 0x032);
	Z_DELREF_P(a0);
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Loader, autoLoad){
	...
	if (Z_TYPE_P(t0) != IS_ARRAY) {
		...
		ZVAL_ZVAL(v1, *hd, 1, 0);
		PHALCON_INIT_VAR(r0);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "strlen", v0, 0x033);
		PHALCON_INIT_VAR(r1);
		...
		if (zend_is_true(r1)) {
			...
			ZVAL_LONG(p1[1], 0);
			PHALCON_INIT_VAR(r3);
			PHALCON_CALL_FUNC_PARAMS_1(r3, "strlen", v2, 0x033);
			Z_ADDREF_P(r3);
			p1[2] = r3;
...
PHP_METHOD(Phalcon_Logger_Adapter_File, __construct){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r1);
	PHALCON_CALL_FUNC_PARAMS_2(r1, "fopen", v0, v2, 0x034);
	PG(display_errors) = silence;
...
PHP_METHOD(Phalcon_Logger_Adapter_File, _applyFormat){
	...
	if (!zend_is_true(v2)) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC(r0, "time", 0x017);
		PHALCON_CPY_WRT(v2, r0);
	}
	PHALCON_ALLOC_ZVAL_MM(t0);
	...
	Z_ADDREF_P(t1);
	Z_ADDREF_P(v2);
	PHALCON_CALL_FUNC_PARAMS_2(r2, "date", t1, v2, 0x035);
	Z_DELREF_P(t1);
	Z_DELREF_P(v2);
	PG(display_errors) = silence;
	p1[1] = r2;
	p1[2] = v3;
	PHALCON_CALL_FUNC_PARAMS(r1, "str_replace", 3, p1, 0x01A);
	PHALCON_CPY_WRT(v3, r1);
	PHALCON_ALLOC_ZVAL_MM(r3);
	PHALCON_INIT_VAR(p3[0]);
	...
	p3[1] = r4;
	p3[2] = v3;
	PHALCON_CALL_FUNC_PARAMS(r3, "str_replace", 3, p3, 0x01A);
	...
	p5[1] = v0;
	p5[2] = v3;
	PHALCON_CALL_FUNC_PARAMS(r5, "str_replace", 3, p5, 0x01A);
	PHALCON_CPY_WRT(v3, r5);
	PHALCON_RETURN_CHECK_CTOR(v3);
}
...
PHP_METHOD(Phalcon_Logger_Adapter_File, log){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	Z_ADDREF_P(v0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_scalar", v0, 0x036);
	Z_DELREF_P(v0);
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_INIT_VAR(c0);
		ZVAL_BOOL(c0, 1);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "print_r", v0, c0, 0x015);
		PHALCON_CPY_WRT(v2, r1);
	}
	PHALCON_ALLOC_ZVAL_MM(t1);
	...
	if (zend_is_true(t1)) {
		...
		Z_ADDREF_P(r4);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("fputs", t3, r4, 0x037);
		Z_DELREF_P(t3);
		Z_DELREF_P(r4);
	}
	PHALCON_MM_RESTORE();
...
PHP_METHOD(Phalcon_Logger_Adapter_File, commit){
	...
	if (Z_TYPE_P(t1) != IS_ARRAY) {
		...
		Z_ADDREF_P(r4);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("fputs", t2, r4, 0x037);
		Z_DELREF_P(t2);
		Z_DELREF_P(r4);
		zend_hash_move_forward_ex(ah0, &hp0);
		goto fes_654f_1;
...
PHP_METHOD(Phalcon_Logger_Adapter_File, close){
	...
	phalcon_read_property(&t0, this_ptr, "_fileHandler", sizeof("_fileHandler")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "fclose", t0, 0x038);
	Z_DELREF_P(t0);
	PG(display_errors) = silence;
	PHALCON_RETURN_CHECK_CTOR(r0);
}
...
PHP_METHOD(Phalcon_Logger_Adapter_File, __wakeup){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_STRING(c0, "ab", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "fopen", t0, c0, 0x034);
	PG(display_errors) = silence;
...
PHP_METHOD(Phalcon_Transaction, getConnection){
	...
	if (zend_is_true(t0)) {
		PHALCON_ALLOC_ZVAL_MM(r0);
		PHALCON_CALL_FUNC(r0, "connection_aborted", 0x039);
		if (zend_is_true(r0)) {
			PHALCON_INIT_VAR(p1[0]);
...
PHP_METHOD(Phalcon_Transaction_Manager, get){
	...
	if (zend_is_true(t0)) {
		...
		PHALCON_CALL_FUNC_PARAMS_1_NORETURN("register_shutdown_function", a0, 0x03A);
		PHALCON_INIT_VAR(t1);
		ZVAL_BOOL(t1, 1);
...
PHP_METHOD(Phalcon_Session, start){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "session_start", 0x03B);
	PG(display_errors) = silence;
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Session, getId){
	...
	PHALCON_MM_GROW();
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "session_id", 0x03C);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, __construct){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "parse_ini_file", v0, c0, 0x03D);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v2, r0);
	if (Z_TYPE_P(v2) == IS_BOOL && !Z_BVAL_P(v2)) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "basename", v0, 0x03E);
		Z_DELREF_P(v0);
		PHALCON_ALLOC_ZVAL_MM(r2);
...
PHP_METHOD(Phalcon_Controller, __get){
	...
	if (PHALCON_COMPARE_STRING(v0, "session")) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", this_ptr, 0x03F);
		Z_ADDREF_P(r1);
		p2[0] = r1;
		PHALCON_CALL_METHOD_PARAMS_NORETURN(i1, "__construct", 1, p2, PHALCON_CALL_CHECK);
		Z_DELREF_P(p2[0]);
...
PHP_METHOD(Phalcon_Model_Manager, __construct){
	...
	Z_ADDREF_P(a5);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("spl_autoload_register", a5, 0x032);
	Z_DELREF_P(a5);
	PHALCON_MM_RESTORE();
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Model_Manager, addHasOne){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "get_class", v0, 0x03F);
	PHALCON_CPY_WRT(v4, r0);
	PHALCON_ALLOC_ZVAL_MM(t0);
...
PHP_METHOD(Phalcon_Model_MetaData, _initializeMetaData){
	...
	if (!zend_is_true(t1)) {
		...
		if (!zend_is_true(v5)) {
			...
			PHALCON_ALLOC_ZVAL_MM(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "get_class", v0, 0x03F);
			PHALCON_ALLOC_ZVAL_MM(r4);
...
PHP_METHOD(Phalcon_Model_Base, __construct){
	...
	PHALCON_ALLOC_ZVAL_MM(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "get_class", this_ptr, 0x03F);
	PHALCON_CPY_WRT(v1, r2);
	PHALCON_ALLOC_ZVAL_MM(t1);
...
PHP_METHOD(Phalcon_Model_Base, _createSQLSelectMulti){
	...
	if (eval_int) {
		...
		Z_DELREF_P(p4[0]);
		PHALCON_CALL_FUNC_PARAMS_2(r5, "join", c0, r6, 0x00F);
		PHALCON_ALLOC_ZVAL_MM(r7);
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_1(r17, "is_numeric", r18, 0x02F);
			if (zend_is_true(r17)) {
	...
	if (Z_TYPE_P(v4) == IS_ARRAY) { 
		...
		if (eval_int) {
			...
			if (eval_int) {
				...
				PHALCON_CALL_FUNC_PARAMS_1(r6, "is_numeric", r7, 0x02F);
				if (zend_is_true(r6)) {
					PHALCON_ALLOC_ZVAL_MM(r9);
		...
		PHALCON_ALLOC_ZVAL_MM(r31);
		PHALCON_CALL_FUNC_PARAMS_1(r31, "strlen", v4, 0x033);
		PHALCON_INIT_VAR(t1);
		ZVAL_LONG(t1, 0);
		...
		if (zend_is_true(r32)) {
			PHALCON_ALLOC_ZVAL_MM(r33);
			PHALCON_CALL_FUNC_PARAMS_1(r33, "is_numeric", v4, 0x02F);
			if (zend_is_true(r33)) {
				PHALCON_ALLOC_ZVAL_MM(r35);
...
PHP_METHOD(Phalcon_Model_Base, find){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC(r0, "get_called_class", 0x040);
	PHALCON_CPY_WRT(v1, r0);
	ce0 = zend_fetch_class(Z_STRVAL_P(v1), Z_STRLEN_P(v1), ZEND_FETCH_CLASS_DEFAULT TSRMLS_CC);
	PHALCON_ALLOC_ZVAL_MM(i0);
	object_init_ex(i0, ce0);
...
PHP_METHOD(Phalcon_Model_Base, findFirst){
	...
	if (eval_int) {
		...
		Z_DELREF_P(p9[0]);
		PHALCON_CALL_FUNC_PARAMS_2(r7, "join", c0, r8, 0x00F);
		PHALCON_ALLOC_ZVAL_MM(r10);
	...
	if (!zend_is_true(t0)) {
		...
		if (zend_is_true(r7)) {
			...
			if (zend_is_true(r16)) {
				...
				PHALCON_INIT_VAR(c0);
				ZVAL_STRING(c0, " AND ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r17, "join", c0, v4, 0x00F);
		...
		if (zend_is_true(r24)) {
			...
			if (zend_is_true(r33)) {
				...
				PHALCON_CALL_FUNC_PARAMS_2(r34, "join", c1, v4, 0x00F);
...
PHP_METHOD(Phalcon_Model_Base, count){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CPY_WRT(v10, r18);
			PHALCON_ALLOC_ZVAL_MM(r19);
			PHALCON_CALL_FUNC_PARAMS_1(r19, "is_numeric", v10, 0x02F);
			if (zend_is_true(r19)) {
				PHALCON_ALLOC_ZVAL_MM(r20);
				PHALCON_ALLOC_ZVAL_MM(r21);
...
PHP_METHOD(Phalcon_Model_Base, appendMessage){
	...
	if (Z_TYPE_P(v0) == IS_OBJECT) {
		...
		if (!PHALCON_COMPARE_STRING(r0, "Phalcon_Model_Message")) {
			...
			object_init_ex(i0, phalcon_model_exception_class_entry);
			PHALCON_ALLOC_ZVAL_MM(r1);
			PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", v0, 0x03F);
			PHALCON_ALLOC_ZVAL_MM(r2);
		...
		PHALCON_ALLOC_ZVAL_MM(r3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r3, "gettype", v0, 0x041);
		Z_DELREF_P(v0);
		PHALCON_ALLOC_ZVAL_MM(r4);
...
PHP_METHOD(Phalcon_Model_Base, validate){
	...
	PHALCON_ALLOC_ZVAL_MM(r5);
	Z_ADDREF_P(v3);
	PHALCON_CALL_FUNC_PARAMS_1(r5, "is_array", v3, 0x042);
	Z_DELREF_P(v3);
	PHALCON_INIT_VAR(t0);
	ZVAL_BOOL(t0, 0);
	PHALCON_ALLOC_ZVAL_MM(r6);
...
PHP_METHOD(Phalcon_Model_Base, _preSave){
	...
	if (Z_TYPE_P(v3) == IS_ARRAY) { 
		...
		if (!zend_is_true(r8)) {
			...
			PHALCON_INIT_VAR(r12);
			PHALCON_CALL_FUNC_PARAMS_1(r12, "is_numeric", v10, 0x02F);
			if (!zend_is_true(r12)) {
				PHALCON_INIT_VAR(v8);
				ZVAL_BOOL(v8, 1);
			}
		...
		if (zend_is_true(r13)) {
			...
			ZVAL_STRING(p10[1], "", 1);
			p10[2] = v9;
			PHALCON_CALL_FUNC_PARAMS(r17, "str_replace", 3, p10, 0x01A);
...
PHP_METHOD(Phalcon_Model_Base, _doLowInsert){
	...
	if (eval_int) {
		...
		PHALCON_ALLOC_ZVAL_MM(r9);
		Z_ADDREF_P(v10);
		PHALCON_CALL_FUNC_PARAMS_1(r9, "is_null", v10, 0x043);
		Z_DELREF_P(v10);
		PHALCON_INIT_VAR(t7);
		ZVAL_STRING(t7, "", 1);
		PHALCON_INIT_VAR(r10);
...
PHP_METHOD(Phalcon_Model_Base, delete){
	...
	if (zend_is_true(r3)) {
		...
		PHALCON_INIT_VAR(c0);
		ZVAL_STRING(c0, " AND ", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r10, "join", c0, v3, 0x00F);
...
PHP_METHOD(Phalcon_Model_Base, __call){
	...
	if (PHALCON_COMPARE_STRING(r0, "get")) {
		...
		Z_DELREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r2, "ucfirst", r3, 0x044);
		PHALCON_CPY_WRT(v3, r2);
		t0 = zend_read_static_property(phalcon_model_base_class_entry, "_manager", sizeof("_manager")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
		...
		if (zend_is_true(r4)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r6, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r6);
		...
		if (zend_is_true(r7)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r9, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r9);
		...
		if (zend_is_true(r10)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r12, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r12);
	...
	if (PHALCON_COMPARE_STRING(r13, "count")) {
		PHALCON_ALLOC_ZVAL_MM(r14);
		PHALCON_CALL_FUNC_PARAMS_1(r14, "get_class", this_ptr, 0x03F);
		...
		Z_DELREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r15, "ucfirst", r16, 0x044);
		...
		if (zend_is_true(r17)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r19, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r19);
		...
		if (zend_is_true(r20)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r22, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r22);
		...
		if (zend_is_true(r23)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r25, "array_merge", v5, v1, 0x045);
			Z_DELREF_P(v5);
			Z_DELREF_P(v1);
			Z_ADDREF_P(r25);
	...
	PHALCON_ALLOC_ZVAL_MM(r28);
	PHALCON_CALL_FUNC_PARAMS_1(r28, "get_class", this_ptr, 0x03F);
	PHALCON_ALLOC_ZVAL_MM(r26);
...
PHP_METHOD(Phalcon_Model_Validator_Inclusionin, checkOptions){
	...
	Z_ADDREF_P(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "is_array", r2, 0x042);
	Z_DELREF_P(r2);
	if (!zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL_MM(i1);
		object_init_ex(i1, phalcon_model_exception_class_entry);
...
PHP_METHOD(Phalcon_Model_Validator_Inclusionin, validate){
	...
	if (zend_is_true(r0)) {
		...
		if (zend_is_true(r1)) {
			...
			Z_ADDREF_P(r4);
			Z_ADDREF_P(v0);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "in_array", r4, v0, 0x021);
			Z_DELREF_P(r4);
			Z_DELREF_P(v0);
			if (!zend_is_true(r3)) {
				PHALCON_ALLOC_ZVAL_MM(r5);
...
PHP_METHOD(Phalcon_Model_Validator_Numericality, validate){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_CALL_FUNC_PARAMS_1(r1, "is_numeric", r2, 0x02F);
		if (!zend_is_true(r1)) {
			PHALCON_ALLOC_ZVAL_MM(r3);
...
PHP_METHOD(Phalcon_Model_Resultset, count){
	...
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_null", t1, 0x043);
	Z_DELREF_P(t1);
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_ALLOC_ZVAL_MM(t2);
...
PHP_METHOD(Phalcon_Model_Query, getConditions){
	...
	if (Z_TYPE_P(t2) != IS_ARRAY) {
		...
		if (Z_TYPE_P(t4) != IS_ARRAY) {
			...
			Z_ADDREF_P(v10);
			Z_ADDREF_P(v5);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "in_array", v10, v5, 0x021);
			Z_DELREF_P(v10);
			Z_DELREF_P(v5);
			if (zend_is_true(r8)) {
				PHALCON_INIT_VAR(t5);
...
PHP_METHOD(Phalcon_Tag, setDefault){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_scalar", v1, 0x036);
	Z_DELREF_P(v1);
	if (!zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL_MM(i0);
...
PHP_METHOD(Phalcon_Tag, _getValueFromAction){
	...
	if (zend_is_true(t1)) {
		...
		if (eval_int) {
			PHALCON_ALLOC_ZVAL_MM(r0);
			PHALCON_CALL_FUNC(r0, "get_magic_quotes_gpc", 0x046);
			if (!zend_is_true(r0)) {
				PHALCON_ALLOC_ZVAL_MM(r1);
				...
				phalcon_array_fetch(&r3, g0, v0, PHALCON_NOISY_FETCH TSRMLS_CC);
				Z_ADDREF_P(r3);
				PHALCON_CALL_FUNC_PARAMS_1(r2, "stripslashes", r3, 0x047);
				Z_DELREF_P(r3);
				PHALCON_RETURN_DZVAL(r2);
			}
		}
...
PHP_MINIT_FUNCTION(phalcon){
	...
	zend_class_entry ce60, ce61, ce62, ce63, ce64, ce65, ce66, ce67, ce68;
	...
	INIT_CLASS_ENTRY(ce15, "Phalcon_Acl_Adapter_Memory", phalcon_acl_adapter_memory_functions);
	phalcon_acl_adapter_memory_class_entry = zend_register_internal_class(&ce15 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce16, "Phalcon_Acl_Role", phalcon_acl_role_functions);
	phalcon_acl_role_class_entry = zend_register_internal_class(&ce16 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce17, "Phalcon_Acl_Resource", phalcon_acl_resource_functions);
	phalcon_acl_resource_class_entry = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce18, "Phalcon_Router_Rewrite", phalcon_router_rewrite_functions);
	phalcon_router_rewrite_class_entry = zend_register_internal_class(&ce18 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce19, "Phalcon_Db_Profiler", phalcon_db_profiler_functions);
	phalcon_db_profiler_class_entry = zend_register_internal_class(&ce19 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce20, "Phalcon_Db_Profiler_Item", phalcon_db_profiler_item_functions);
	phalcon_db_profiler_item_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce21, "Phalcon_Db_Pool", phalcon_db_pool_functions);
	phalcon_db_pool_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Db_Dialect_Mysql", phalcon_db_dialect_mysql_functions);
	phalcon_db_dialect_mysql_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce24, "Phalcon_Flash", phalcon_flash_functions);
	phalcon_flash_class_entry = zend_register_internal_class(&ce24 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce25, "Phalcon_Paginator", phalcon_paginator_functions);
	phalcon_paginator_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce26, "Phalcon_Logger", phalcon_logger_functions);
	phalcon_logger_class_entry = zend_register_internal_class(&ce26 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce27, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce28, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce29, "Phalcon_Loader", phalcon_loader_functions);
	phalcon_loader_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce30, "Phalcon_Logger_Adapter_File", phalcon_logger_adapter_file_functions);
	phalcon_logger_adapter_file_class_entry = zend_register_internal_class(&ce30 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce31, "Phalcon_Logger_Item", phalcon_logger_item_functions);
	phalcon_logger_item_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce32, "Phalcon_Transaction", phalcon_transaction_functions);
	phalcon_transaction_class_entry = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Transaction_Manager", phalcon_transaction_manager_functions);
	phalcon_transaction_manager_class_entry = zend_register_internal_class(&ce33 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce35, "Phalcon_Controller", phalcon_controller_functions);
	phalcon_controller_class_entry = zend_register_internal_class(&ce35 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce37, "Phalcon_Model_Manager", phalcon_model_manager_functions);
	phalcon_model_manager_class_entry = zend_register_internal_class(&ce37 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce38, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_class_entry = zend_register_internal_class(&ce38 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce39, "Phalcon_Model_Validator", phalcon_model_validator_functions);
	phalcon_model_validator_class_entry = zend_register_internal_class(&ce39 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce40, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_class_entry = zend_register_internal_class(&ce40 TSRMLS_CC);
	...
	phalcon_model_base_class_entry = zend_register_internal_class(&ce41 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce42, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce42 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce43, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce43 TSRMLS_CC);
	...
	phalcon_model_sanitize_class_entry = zend_register_internal_class(&ce44 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce45, "Phalcon_Model_Query", phalcon_model_query_functions);
	phalcon_model_query_class_entry = zend_register_internal_class(&ce45 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce46, "Phalcon_Tag", phalcon_tag_functions);
	phalcon_tag_class_entry = zend_register_internal_class(&ce46 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce47, "Phalcon_Exception", phalcon_exception_functions);
	phalcon_exception_class_entry = zend_register_internal_class_ex(&ce47, NULL, "exception" TSRMLS_CC);
	if(!phalcon_exception_class_entry){
		phalcon_inherit_not_found("Exception", "Phalcon_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce48, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce48 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_descriptor", sizeof("_descriptor")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_fetchMode", sizeof("_fetchMode")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_autoCommit", sizeof("_autoCommit")-1, 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_idConnection", sizeof("_idConnection")-1, 0, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce49, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce49 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce50, "Phalcon_Model_Validator", phalcon_model_validator_functions);
	phalcon_model_validator_class_entry = zend_register_internal_class(&ce50 TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_record", sizeof("_record")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_fieldName", sizeof("_fieldName")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_value", sizeof("_value")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_class_entry, "_options", sizeof("_options")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce51, "Phalcon_Paginator_Exception", phalcon_paginator_exception_functions);
	phalcon_paginator_exception_class_entry = zend_register_internal_class_ex(&ce51, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_paginator_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Paginator_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce52, "Phalcon_Cache_Exception", phalcon_cache_exception_functions);
	phalcon_cache_exception_class_entry = zend_register_internal_class_ex(&ce52, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_cache_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Cache_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce53, "Phalcon_Acl_Exception", phalcon_acl_exception_functions);
	phalcon_acl_exception_class_entry = zend_register_internal_class_ex(&ce53, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_acl_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Acl_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce54, "Phalcon_Tag_Exception", phalcon_tag_exception_functions);
	phalcon_tag_exception_class_entry = zend_register_internal_class_ex(&ce54, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_tag_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Tag_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce55, "Phalcon_Db_Adapter_Mysql", phalcon_db_adapter_mysql_functions);
	phalcon_db_adapter_mysql_class_entry = zend_register_internal_class_ex(&ce55, NULL, "phalcon_db" TSRMLS_CC);
	if(!phalcon_db_adapter_mysql_class_entry){
		phalcon_inherit_not_found("Phalcon_Db", "Phalcon_Db_Adapter_Mysql");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce56, "Phalcon_Db_Exception", phalcon_db_exception_functions);
	phalcon_db_exception_class_entry = zend_register_internal_class_ex(&ce56, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_db_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Db_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce57, "Phalcon_Logger_Exception", phalcon_logger_exception_functions);
	phalcon_logger_exception_class_entry = zend_register_internal_class_ex(&ce57, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_logger_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Logger_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce58, "Phalcon_Transaction_Failed", phalcon_transaction_failed_functions);
	phalcon_transaction_failed_class_entry = zend_register_internal_class_ex(&ce58, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce60, "Phalcon_Config_Exception", phalcon_config_exception_functions);
	phalcon_config_exception_class_entry = zend_register_internal_class_ex(&ce60, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_config_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Config_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce61, "Phalcon_Model_Validator_Uniqueness", phalcon_model_validator_uniqueness_functions);
	phalcon_model_validator_uniqueness_class_entry = zend_register_internal_class_ex(&ce61, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce62, "Phalcon_Model_Validator_Regex", phalcon_model_validator_regex_functions);
	phalcon_model_validator_regex_class_entry = zend_register_internal_class_ex(&ce62, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce63, "Phalcon_Model_Validator_Inclusionin", phalcon_model_validator_inclusionin_functions);
	phalcon_model_validator_inclusionin_class_entry = zend_register_internal_class_ex(&ce63, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce64, "Phalcon_Model_Validator_Exclusionin", phalcon_model_validator_exclusionin_functions);
	phalcon_model_validator_exclusionin_class_entry = zend_register_internal_class_ex(&ce64, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce65, "Phalcon_Model_Validator_Numericality", phalcon_model_validator_numericality_functions);
	phalcon_model_validator_numericality_class_entry = zend_register_internal_class_ex(&ce65, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce66, "Phalcon_Model_Validator_Email", phalcon_model_validator_email_functions);
	phalcon_model_validator_email_class_entry = zend_register_internal_class_ex(&ce66, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce67, "Phalcon_Model_Exception", phalcon_model_exception_functions);
	phalcon_model_exception_class_entry = zend_register_internal_class_ex(&ce67, NULL, "phalcon_exception" TSRMLS_CC);
	if(!phalcon_model_exception_class_entry){
		phalcon_inherit_not_found("Phalcon_Exception", "Phalcon_Model_Exception");
		return FAILURE;
	}

	INIT_CLASS_ENTRY(ce68, "Phalcon_View_Exception", phalcon_view_exception_functions);
	phalcon_view_exception_class_entry = zend_register_internal_class_ex(&ce68, NULL, "phalcon_exception" TSRMLS_CC);
