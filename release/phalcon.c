...
PHP_METHOD(Phalcon_Cache_Adapter_File, __construct){
	...
	if (eval_int) {
		...
		Z_ADDREF_P(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "is_writable", r1, 0x000);
		if (!zend_is_true(r0)) {
...
PHP_METHOD(Phalcon_Cache_Adapter_File, start){
	...
	if (phalcon_file_exists(v3 TSRMLS_CC) == SUCCESS) {
		...
		PHALCON_CALL_FUNC(r2, "time", 0x001);
		...
		Z_ADDREF_P(v3);
		PHALCON_CALL_FUNC_PARAMS_1(r5, "filemtime", v3, 0x002);
		PHALCON_ALLOC_ZVAL(r6);
		is_smaller_function(r6, r4, r5 TSRMLS_CC);
		if (zend_is_true(r6)) {
			PHALCON_ALLOC_ZVAL(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "file_get_contents", v3, 0x003);
			RETURN_ZVAL(r7, 1, 0);
		} else {
			PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastKey", v0);
			PHALCON_CALL_FUNC_NORETURN("ob_start", 0x004);
			RETURN_NULL();
		}
	} else {
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastKey", v0);
...
PHP_METHOD(Phalcon_Cache_Adapter_File, save){
	...
	PHALCON_ALLOC_ZVAL(r2);
	PHALCON_CALL_FUNC(r2, "ob_get_contents", 0x005);
	PHALCON_CPY_WRT(v5, r2);
	Z_ADDREF_P(v4);
	Z_ADDREF_P(v5);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("file_put_contents", v4, v5, 0x006);
	if (zend_is_true(v0)) {
		PHALCON_CALL_FUNC_NORETURN("ob_end_clean", 0x007);
	}
...
PHP_METHOD(Phalcon_Cache, factory){
	...
	PHALCON_ALLOC_ZVAL(r1);
	Z_ADDREF_P(v3);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v3, 0x008);
	if (!zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL(i0);
		object_init_ex(i0, phalcon_cache_exception_class_entry);
		PHALCON_ALLOC_ZVAL(r2);
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, __construct){
	...
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "parse_ini_file", v0, c0, 0x009);
	FREE_ZVAL(c0);
	...
	if (Z_TYPE_P(v2) == IS_BOOL && !Z_BVAL_P(v2)) {
		...
		PHALCON_ALLOC_ZVAL(r1);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "basename", v0, 0x00A);
		PHALCON_ALLOC_ZVAL(r2);
	...
	FOREACH_KV(v2, ac0, fes0, fee0, ah0, hp0, v4, v3)
		FOREACH_KV(v3, ac1, fes1, fee1, ah1, hp1, v6, v5)
			PHALCON_INIT_RESULT(r3);
			PHALCON_INIT_VARTYPE(c1, IS_STRING);
			ZVAL_STRING(c1, ".", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "strpos", v6, c1, 0x00B);
			if (Z_TYPE_P(r3) != IS_BOOL || (Z_TYPE_P(r3) == IS_BOOL && Z_BVAL_P(r3))) {
				PHALCON_INIT_RESULT(r4);
				PHALCON_INIT_VARTYPE(c2, IS_STRING);
				ZVAL_STRING(c2, ".", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r4, "explode", c2, v6, 0x00C);
		...
		END_FOREACH(ac1, fes1, fee1, ah1, hp1);
	END_FOREACH(ac0, fes0, fee0, ah0, hp0);
	Z_ADDREF_P(v1);
	p5[0] = v1;
...
PHP_METHOD(Phalcon_Config, __construct){
	...
	FOREACH_KV(v0, ac0, fes2, fee2, ah0, hp0, v2, v1)
		if (Z_TYPE_P(v1) == IS_ARRAY) { 
			PHALCON_INIT_VAR(i0);
...
PHP_METHOD(Phalcon_Controller_Front, getBaseUri){
	...
	if (!zend_is_true(t0)) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_1(r3, "dirname", r4, 0x00F);
			PHALCON_CALL_FUNC_PARAMS_2(r2, "explode", c0, r3, 0x00C);
			FREE_ZVAL(c0);
			p1[0] = r2;
			...
			p1[2] = r5;
			PHALCON_CALL_FUNC_PARAMS(r1, "array_slice", 3, p1, 0x00E);
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, tableExists){
	...
	if (zend_is_true(v1)) {
		PHALCON_ALLOC_ZVAL(r0);
		Z_ADDREF_P(v1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "addslashes", v1, 0x010);
...
PHP_METHOD(Phalcon_Db_Mysql, connect){
	...
	if (!zend_is_true(v1)) {
		...
		ZVAL_BOOL(p0[3], 1);
		p0[4] = v6;
		PHALCON_CALL_FUNC_PARAMS(r7, "mysql_connect", 5, p0, 0x011);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_idConnection", r7);
	} else {
		PHALCON_ALLOC_ZVAL(r8);
		p1[0] = v5;
		p1[1] = v3;
		p1[2] = v4;
		p1[3] = v6;
		PHALCON_CALL_FUNC_PARAMS(r8, "mysql_pconnect", 4, p1, 0x012);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_idConnection", r8);
	}
	...
	if (zend_is_true(t17)) {
		...
		if (zend_is_true(r10)) {
			...
			PHALCON_CALL_FUNC_PARAMS_2(r11, "mysql_select_db", v7, t21, 0x013);
			if (!zend_is_true(r11)) {
				PHALCON_ALLOC_ZVAL(i0);
		...
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_autoCommit", v8);
		PHALCON_ALLOC_ZVAL(t24);
		ZVAL_LONG(t24, 3);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", t24);
		Z_ADDREF_P(v0);
		p6[0] = v0;
...
PHP_METHOD(Phalcon_Db_Mysql, query){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastQuery", v0);
	Z_ADDREF_P(v0);
	p1[0] = v0;
	PHALCON_CALL_METHOD_PARAMS_NORETURN(this_ptr, "_beforequery", 1, p1, PHALCON_CALL_DEFAULT);
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_query", v0, v1, 0x014);
	PHALCON_CPY_WRT(v2, r0);
	if (zend_is_true(v2)) {
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastResultQuery", v2);
...
PHP_METHOD(Phalcon_Db_Mysql, close){
	...
	if (zend_is_true(t0)) {
		...
		phalcon_read_property(t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		Z_ADDREF_P(t1);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_close", t1, 0x015);
		PG(display_errors) = silence;
		PHALCON_CPY_WRT_PARAM(v0, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, fetchArray){
	...
	Z_ADDREF_P(t2);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_fetch_array", v0, t2, 0x016);
	RETURN_ZVAL(r0, 1, 0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, numRows){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_num_rows", v0, 0x017);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, dataSeek){
	...
	PG(display_errors) = 0;
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mysql_data_seek", v1, v0, 0x018);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v2, r0);
...
PHP_METHOD(Phalcon_Db_Mysql, affectedRows){
	...
	PHALCON_ALLOC_ZVAL(t0);
	phalcon_read_property(t0, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_affected_rows", t0, 0x019);
	PG(display_errors) = silence;
	PHALCON_CPY_WRT(v1, r0);
	if (Z_TYPE_P(v1) != IS_BOOL || (Z_TYPE_P(v1) == IS_BOOL && Z_BVAL_P(v1))) {
		PHALCON_RETURN_CHECK_CTOR(v1);
...
PHP_METHOD(Phalcon_Db_Mysql, setFetchMode){
	...
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL(t1);
		ZVAL_LONG(t1, 1);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", t1);
	}
	PHALCON_ALLOC_ZVAL(t2);
	...
	if (zend_is_true(r1)) {
		PHALCON_ALLOC_ZVAL(t3);
		ZVAL_LONG(t3, 3);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", t3);
	}
	PHALCON_ALLOC_ZVAL(t4);
	...
	if (zend_is_true(r2)) {
		PHALCON_ALLOC_ZVAL(t5);
		ZVAL_LONG(t5, 2);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", t5);
	}
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Db_Mysql, error){
	...
	if (!zend_is_true(t0)) {
		PHALCON_ALLOC_ZVAL(r0);
		PHALCON_CALL_FUNC(r0, "mysql_error", 0x01A);
		PHALCON_CPY_WRT(v2, r0);
	} else {
		PHALCON_ALLOC_ZVAL(r1);
		PHALCON_ALLOC_ZVAL(t1);
		phalcon_read_property(t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "mysql_error", t1, 0x01A);
	...
	if (zend_is_true(v2)) {
		...
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastError", r2);
	} else {
		PHALCON_ALLOC_ZVAL(r4);
		PHALCON_CONCAT_BOTH(r4,  "[Unknown MySQL error: ", v0, "]");
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_lastError", r4);
	}
	PHALCON_ALLOC_ZVAL(t2);
...
PHP_METHOD(Phalcon_Db_Mysql, noError){
	...
	phalcon_read_property(t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_errno", t1, 0x01B);
	RETURN_ZVAL(r0, 1, 0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, lastInsertId){
	...
	PHALCON_ALLOC_ZVAL(t1);
	phalcon_read_property(t1, this_ptr, "_idConnection", sizeof("_idConnection")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_insert_id", t1, 0x01C);
	RETURN_ZVAL(r0, 1, 0);
}
...
PHP_METHOD(Phalcon_Db_Mysql, limit){
	...
	PHALCON_ALLOC_ZVAL(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_numeric", v1, 0x01D);
	if (zend_is_true(r0)) {
		convert_to_long(v1);
		PHALCON_ALLOC_ZVAL(r1);
...
PHP_METHOD(Phalcon_Db_Mysql, tableExists){
	...
	PHALCON_ALLOC_ZVAL(r0);
	Z_ADDREF_P(v0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "addslashes", v0, 0x010);
	PHALCON_CPY_WRT_PARAM(v0, r0);
	PHALCON_ALLOC_ZVAL(r1);
	Z_ADDREF_P(v0);
	p1[0] = v0;
	...
	PHALCON_CPY_WRT(v4, r2);
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", v3);
	PHALCON_ALLOC_ZVAL(r3);
...
PHP_METHOD(Phalcon_Db_Mysql, describeTable){
	...
	PHALCON_ALLOC_ZVAL(t0);
	ZVAL_LONG(t0, 1);
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", t0);
	PHALCON_ALLOC_ZVAL(r1);
	Z_ADDREF_P(v2);
	p1[0] = v2;
...
PHP_METHOD(Phalcon_Db_Mysql, listTables){
	...
	FOREACH_V(v3, ac0, fes3, fee3, ah0, hp0, v5)
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_fetchMode", v2);
...
PHP_METHOD(Phalcon_Db_Pool, setDefaultDescriptor){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		...
		object_init(i1);
		PHALCON_CPY_WRT(v1, i1);
		FOREACH_KV(v0, ac0, fes4, fee4, ah0, hp0, v3, v2)
...
PHP_METHOD(Phalcon_Db, insert){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		PHALCON_ALLOC_ZVAL(r0);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "count", v1, 0x01E);
		PHALCON_ALLOC_ZVAL(t0);
		ZVAL_LONG(t0, 0);
		PHALCON_ALLOC_ZVAL(r1);
		...
		if (zend_is_true(r1)) {
			...
			if (zend_is_true(v3)) {
				FOREACH_KV(v1, ac0, fes6, fee6, ah0, hp0, v6, v5)
					PHALCON_INIT_RESULT(r3);
					...
					if (Z_TYPE_P(r3) == IS_OBJECT) {
						...
						if (zend_is_true(r5)) {
							...
							Z_ADDREF_P(r7);
							PHALCON_CALL_FUNC_PARAMS_1(r6, "addslashes", r7, 0x010);
							{
								zval *copy;
								ALLOC_ZVAL(copy);
							...
							Z_ADDREF_P(r10);
							PHALCON_CALL_FUNC_PARAMS_1(r9, "addslashes", r10, 0x010);
						...
						Z_ADDREF_P(r13);
						PHALCON_CALL_FUNC_PARAMS_1(r12, "addslashes", r13, 0x010);
...
PHP_METHOD(Phalcon_Db, update){
	...
	PHALCON_ALLOC_ZVAL(r1);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "count", v1, 0x01E);
	PHALCON_ALLOC_ZVAL(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "count", v2, 0x01E);
	PHALCON_ALLOC_ZVAL(r3);
	...
	FOREACH_V(v1, ac0, fes7, fee7, ah0, hp0, v8)
		if (zend_is_true(v4)) {
			PHALCON_INIT_RESULT(r4);
			...
			if (Z_TYPE_P(r4) == IS_OBJECT) {
				...
				if (zend_is_true(r6)) {
					...
					Z_ADDREF_P(r8);
					PHALCON_CALL_FUNC_PARAMS_1(r7, "addslashes", r8, 0x010);
					{
						zval *copy;
						ALLOC_ZVAL(copy);
					...
					Z_ADDREF_P(r11);
					PHALCON_CALL_FUNC_PARAMS_1(r10, "addslashes", r11, 0x010);
					PHALCON_INIT_RESULT(r12);
				...
				Z_ADDREF_P(r14);
				PHALCON_CALL_FUNC_PARAMS_1(r13, "addslashes", r14, 0x010);
...
PHP_METHOD(Phalcon_Db, delete){
	...
	PHALCON_ALLOC_ZVAL(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "trim", v1, 0x01F);
...
PHP_METHOD(Phalcon_Db, factory){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		...
		FOREACH_KV(v1, ac0, fes8, fee8, ah0, hp0, v5, v4)
	...
	PHALCON_ALLOC_ZVAL(r1);
	Z_ADDREF_P(v7);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v7, 0x008);
	if (zend_is_true(r1)) {
...
PHP_METHOD(Phalcon_Dispatcher, dispatch){
	...
	if (!eval_int) {
		...
		ZVAL_BOOL(c0, 0);
		PHALCON_CALL_FUNC_PARAMS_2(r4, "class_exists", v10, c0, 0x008);
		if (!zend_is_true(r4)) {
			PHALCON_INIT_RESULT(r5);
			...
			ZVAL_BOOL(c1, 0);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "class_exists", v10, c1, 0x008);
			if (!zend_is_true(r8)) {
				PHALCON_INIT_VAR(i1);
	...
	if (phalcon_method_exists(v6, v14 TSRMLS_CC) == SUCCESS) {
		...
		Z_ADDREF_P(a0);
		Z_ADDREF_P(v12);
		PHALCON_CALL_FUNC_PARAMS_2(r13, "call_user_func_array", a0, v12, 0x020);
		...
		if (phalcon_method_exists_ex(v6, "notfoundaction", strlen("notfoundaction") TSRMLS_CC) == SUCCESS) {
			...
			Z_ADDREF_P(a1);
			Z_ADDREF_P(v12);
			PHALCON_CALL_FUNC_PARAMS_2(r14, "call_user_func_array", a1, v12, 0x020);
...
PHP_METHOD(Phalcon_Dispatcher, forward){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		...
		PHALCON_ALLOC_ZVAL(c0);
		ZVAL_STRING(c0, "/", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "explode", c0, v0, 0x00C);
		FREE_ZVAL(c0);
		PHALCON_CPY_WRT(v1, r0);
	}
	...
	FOREACH_KV(v1, ac0, fes10, fee10, ah0, hp0, v4, v3)
...
PHP_METHOD(Phalcon_Filter, sanitize){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		if (zend_is_true(v0)) {
			FOREACH_V(v1, ac0, fes11, fee11, ah0, hp0, v2)
...
PHP_METHOD(Phalcon_Filter, _sanitize){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_ALLOC_ZVAL(t1);
		ZVAL_LONG(t1, 517);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "filter_var", v0, t1, 0x022);
		RETURN_ZVAL(r1, 1, 0);
	}
	PHALCON_ALLOC_ZVAL(t2);
	...
	if (zend_is_true(r2)) {
		...
		PHALCON_ALLOC_ZVAL(t3);
		ZVAL_LONG(t3, 519);
		PHALCON_CALL_FUNC_PARAMS_2(r3, "filter_var", v0, t3, 0x022);
		RETURN_ZVAL(r3, 1, 0);
	}
	PHALCON_ALLOC_ZVAL(t4);
	...
	if (zend_is_true(r4)) {
		...
		PHALCON_ALLOC_ZVAL(t5);
		ZVAL_LONG(t5, 513);
		PHALCON_CALL_FUNC_PARAMS_2(r5, "filter_var", v0, t5, 0x022);
		RETURN_ZVAL(r5, 1, 0);
	}
	PHALCON_ALLOC_ZVAL(t6);
	...
	if (zend_is_true(r6)) {
		...
		p3[2] = a0;
		PHALCON_CALL_FUNC_PARAMS(r7, "filter_var", 3, p3, 0x022);
		RETURN_ZVAL(r7, 1, 0);
	}
	PHALCON_ALLOC_ZVAL(i0);
	object_init_ex(i0, phalcon_exception_class_entry);
...
PHP_METHOD(Phalcon_Flash, _showMessage){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		FOREACH_V(v0, ac0, fes13, fee13, ah0, hp0, v3)
			PHALCON_INIT_RESULT(r3);
...
PHP_METHOD(Phalcon_Model_Base, __construct){
	...
	PHALCON_ALLOC_ZVAL(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "get_class", this_ptr, 0x023);
...
PHP_METHOD(Phalcon_Model_Base, dump){
	...
	PHALCON_CALL_METHOD_PARAMS(r0, r1, "getattributes", 1, p0, PHALCON_CALL_DEFAULT);
	PHALCON_CPY_WRT_PARAM(v0, r0);
	FOREACH_V(v0, ac0, fes14, fee14, ah0, hp0, v1)
...
PHP_METHOD(Phalcon_Model_Base, _createSQLSelectMulti){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			Z_ADDREF_P(r18);
			PHALCON_CALL_FUNC_PARAMS_1(r17, "is_numeric", r18, 0x01D);
			if (zend_is_true(r17)) {
	...
	if (Z_TYPE_P(v4) == IS_ARRAY) { 
		...
		if (eval_int) {
			...
			if (eval_int) {
				...
				Z_ADDREF_P(r7);
				PHALCON_CALL_FUNC_PARAMS_1(r6, "is_numeric", r7, 0x01D);
				if (zend_is_true(r6)) {
					PHALCON_ALLOC_ZVAL(r9);
		...
		PHALCON_ALLOC_ZVAL(r31);
		PHALCON_CALL_FUNC_PARAMS_1(r31, "strlen", v4, 0x024);
		if (!phalcon_is_smaller_strict_long(r31, 0)) {
			PHALCON_ALLOC_ZVAL(r32);
			Z_ADDREF_P(v4);
			PHALCON_CALL_FUNC_PARAMS_1(r32, "is_numeric", v4, 0x01D);
			if (zend_is_true(r32)) {
				PHALCON_ALLOC_ZVAL(r34);
...
PHP_METHOD(Phalcon_Model_Base, getSource){
	...
	if (PHALCON_COMPARE_STRING(t0, "")) {
		...
		t1 = zend_read_static_property(phalcon_model_base_class_entry, "_manager", sizeof("_manager")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
		PHALCON_ALLOC_ZVAL(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", this_ptr, 0x023);
		Z_ADDREF_P(r1);
		p0[0] = r1;
...
PHP_METHOD(Phalcon_Model_Base, dumpResult){
	...
	if (Z_TYPE_P(v1) == IS_ARRAY) { 
		FOREACH_KV(v1, ac0, fes15, fee15, ah0, hp0, v4, v3)
...
PHP_METHOD(Phalcon_Model_Base, find){
	...
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_CALL_FUNC(r0, "get_called_class", 0x025);
	PHALCON_CPY_WRT(v1, r0);
...
PHP_METHOD(Phalcon_Model_Base, _exists){
	...
	if (!zend_is_true(t0)) {
		...
		PHALCON_CPY_WRT(v6, r5);
		PHALCON_ALLOC_ZVAL(r6);
		PHALCON_CALL_FUNC_PARAMS_1(r6, "count", v5, 0x01E);
		if (!phalcon_is_smaller_strict_long(r6, 0)) {
			FOREACH_V(v5, ac0, fes16, fee16, ah0, hp0, v7)
				PHALCON_INIT_VAR(t1);
			...
			PHALCON_ALLOC_ZVAL(r15);
			PHALCON_CALL_FUNC_PARAMS_1(r15, "count", v4, 0x01E);
			if (zend_is_true(r15)) {
				PHALCON_ALLOC_ZVAL(r16);
				PHALCON_ALLOC_ZVAL(c0);
				ZVAL_STRING(c0, " AND ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r16, "join", c0, v4, 0x00D);
				FREE_ZVAL(c0);
		...
		PHALCON_ALLOC_ZVAL(r22);
		PHALCON_CALL_FUNC_PARAMS_1(r22, "count", v5, 0x01E);
		if (!phalcon_is_smaller_strict_long(r22, 0)) {
			FOREACH_V(v5, ac1, fes17, fee17, ah1, hp1, v7)
				PHALCON_INIT_VAR(t9);
			...
			END_FOREACH(ac1, fes17, fee17, ah1, hp1);
			PHALCON_ALLOC_ZVAL(r31);
			PHALCON_CALL_FUNC_PARAMS_1(r31, "count", v4, 0x01E);
			if (zend_is_true(r31)) {
				PHALCON_ALLOC_ZVAL(r32);
				PHALCON_ALLOC_ZVAL(c1);
				ZVAL_STRING(c1, " AND ", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r32, "join", c1, v4, 0x00D);
				FREE_ZVAL(c1);
...
PHP_METHOD(Phalcon_Model_Base, count){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_ALLOC_ZVAL(r19);
			Z_ADDREF_P(v9);
			PHALCON_CALL_FUNC_PARAMS_1(r19, "is_numeric", v9, 0x01D);
			if (zend_is_true(r19)) {
				PHALCON_ALLOC_ZVAL(r20);
				PHALCON_ALLOC_ZVAL(r21);
...
PHP_METHOD(Phalcon_Model_Base, appendMessage){
	...
	if (Z_TYPE_P(v0) == IS_OBJECT) {
		PHALCON_ALLOC_ZVAL(r0);
		PHALCON_CALL_FUNC_PARAMS_1(r0, "get_class", v0, 0x023);
		if (!PHALCON_COMPARE_STRING(r0, "Phalcon_Model_Message")) {
			PHALCON_ALLOC_ZVAL(i0);
			object_init_ex(i0, phalcon_model_exception_class_entry);
			PHALCON_ALLOC_ZVAL(r1);
			PHALCON_CALL_FUNC_PARAMS_1(r1, "get_class", v0, 0x023);
			PHALCON_ALLOC_ZVAL(r2);
		...
		PHALCON_ALLOC_ZVAL(r3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_1(r3, "gettype", v0, 0x026);
		PHALCON_ALLOC_ZVAL(r4);
...
PHP_METHOD(Phalcon_Model_Base, save){
	...
	if (Z_TYPE_P(v3) == IS_ARRAY) { 
		...
		ZVAL_BOOL(v5, 0);
		PHALCON_ALLOC_ZVAL(r6);
		PHALCON_CALL_FUNC_PARAMS_1(r6, "count", v3, 0x01E);
		PHALCON_CPY_WRT(v6, r6);
		PHALCON_ALLOC_ZVAL(v7);
		ZVAL_LONG(v7, 0);
		fs18:
		...
		if (!eval_int) {
			...
			PHALCON_INIT_RESULT(r12);
			Z_ADDREF_P(v10);
			PHALCON_CALL_FUNC_PARAMS_1(r12, "is_numeric", v10, 0x01D);
			if (!zend_is_true(r12)) {
				PHALCON_INIT_VARTYPE(v8, IS_BOOL);
				ZVAL_BOOL(v8, 1);
			}
		...
		if (zend_is_true(r13)) {
			...
			ZVAL_STRING(p12[1], "", 1);
			p12[2] = v9;
			PHALCON_CALL_FUNC_PARAMS(r17, "str_replace", 3, p12, 0x027);
	...
	if (zend_is_true(v0)) {
		...
		FOREACH_V(v21, ac0, fes19, fee19, ah0, hp0, v9)
			{
				zval *copy;
				ALLOC_ZVAL(copy);
		...
		FOREACH_V(v23, ac1, fes20, fee20, ah1, hp1, v9)
		...
		END_FOREACH(ac1, fes20, fee20, ah1, hp1);
		...
		if (eval_int) {
			...
			Z_ADDREF_P(t21);
			PHALCON_CALL_FUNC_PARAMS_1(r51, "is_null", t21, 0x028);
			PHALCON_ALLOC_ZVAL(t22);
...
PHP_METHOD(Phalcon_Model_Base, delete){
	...
	PHALCON_CPY_WRT(v1, r1);
	PHALCON_ALLOC_ZVAL(r2);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "count", v1, 0x01E);
	PHALCON_ALLOC_ZVAL(t5);
	ZVAL_LONG(t5, 1);
	PHALCON_ALLOC_ZVAL(r3);
	...
	if (zend_is_true(r3)) {
		...
		FOREACH_V(v1, ac0, fes21, fee21, ah0, hp0, v4)
			PHALCON_INIT_VAR(t7);
...
PHP_METHOD(Phalcon_Model_Base, __call){
	...
	PHALCON_ALLOC_ZVAL(p0[2]);
	ZVAL_LONG(p0[2], 3);
	PHALCON_CALL_FUNC_PARAMS(r0, "substr", 3, p0, 0x029);
	if (PHALCON_COMPARE_STRING(r0, "get")) {
		...
		PHALCON_ALLOC_ZVAL(c0);
		ZVAL_LONG(c0, 3);
		PHALCON_CALL_FUNC_PARAMS_2(r3, "substr", v0, c0, 0x029);
		FREE_ZVAL(c0);
		PHALCON_CALL_FUNC_PARAMS_1(r2, "ucfirst", r3, 0x02A);
		PHALCON_CPY_WRT(v3, r2);
		t0 = zend_read_static_property(phalcon_model_base_class_entry, "_manager", sizeof("_manager")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
		...
		if (zend_is_true(r4)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r6, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r6);
			PHALCON_CALL_FUNC_PARAMS_2(r5, "call_user_func_array", a1, r6, 0x020);
			RETURN_ZVAL(r5, 1, 0);
		}
		PHALCON_ALLOC_ZVAL(r7);
		Z_ADDREF_P(v2);
		...
		if (zend_is_true(r7)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r9, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r9);
			PHALCON_CALL_FUNC_PARAMS_2(r8, "call_user_func_array", a3, r9, 0x020);
			RETURN_ZVAL(r8, 1, 0);
		}
		PHALCON_ALLOC_ZVAL(r10);
		Z_ADDREF_P(v2);
		...
		if (zend_is_true(r10)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r12, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r12);
			PHALCON_CALL_FUNC_PARAMS_2(r11, "call_user_func_array", a5, r12, 0x020);
			RETURN_ZVAL(r11, 1, 0);
		}
	}
	PHALCON_ALLOC_ZVAL(r13);
	...
	ZVAL_LONG(p13[2], 5);
	PHALCON_CALL_FUNC_PARAMS(r13, "substr", 3, p13, 0x029);
	if (PHALCON_COMPARE_STRING(r13, "count")) {
		PHALCON_ALLOC_ZVAL(r14);
		PHALCON_CALL_FUNC_PARAMS_1(r14, "get_class", this_ptr, 0x023);
		...
		PHALCON_ALLOC_ZVAL(c1);
		ZVAL_LONG(c1, 5);
		PHALCON_CALL_FUNC_PARAMS_2(r16, "substr", v0, c1, 0x029);
		FREE_ZVAL(c1);
		PHALCON_CALL_FUNC_PARAMS_1(r15, "ucfirst", r16, 0x02A);
		...
		if (zend_is_true(r17)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r19, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r19);
			PHALCON_CALL_FUNC_PARAMS_2(r18, "call_user_func_array", a7, r19, 0x020);
			RETURN_ZVAL(r18, 1, 0);
		}
		PHALCON_ALLOC_ZVAL(r20);
		Z_ADDREF_P(v2);
		...
		if (zend_is_true(r20)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r22, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r22);
			PHALCON_CALL_FUNC_PARAMS_2(r21, "call_user_func_array", a9, r22, 0x020);
			RETURN_ZVAL(r21, 1, 0);
		}
		PHALCON_ALLOC_ZVAL(r23);
		Z_ADDREF_P(v2);
		...
		if (zend_is_true(r23)) {
			...
			Z_ADDREF_P(v5);
			Z_ADDREF_P(v1);
			PHALCON_CALL_FUNC_PARAMS_2(r25, "array_merge", v5, v1, 0x02B);
			Z_ADDREF_P(r25);
			PHALCON_CALL_FUNC_PARAMS_2(r24, "call_user_func_array", a11, r25, 0x020);
			RETURN_ZVAL(r24, 1, 0);
		}
	}
	PHALCON_ALLOC_ZVAL(i0);
	...
	PHALCON_ALLOC_ZVAL(r28);
	PHALCON_CALL_FUNC_PARAMS_1(r28, "get_class", this_ptr, 0x023);
	PHALCON_ALLOC_ZVAL(r26);
...
PHP_METHOD(Phalcon_Model_Manager, __construct){
	...
	Z_ADDREF_P(a4);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("spl_autoload_register", a4, 0x02C);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Model_Manager, isModel){
	...
	if (eval_int) {
		...
		PHALCON_ALLOC_ZVAL(c0);
		ZVAL_BOOL(c0, 0);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "class_exists", v0, c0, 0x008);
		FREE_ZVAL(c0);
		if (!zend_is_true(r0)) {
			PHALCON_ALLOC_ZVAL(t1);
			phalcon_read_property(t1, this_ptr, "_modelsDir", sizeof("_modelsDir")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	...
	if (!eval_int) {
		...
		if (!zend_is_true(r0)) {
			...
			if (phalcon_file_exists(v1 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_ALLOC_ZVAL(c1);
				ZVAL_BOOL(c1, 0);
				PHALCON_CALL_FUNC_PARAMS_2(r3, "class_exists", v0, c1, 0x008);
				FREE_ZVAL(c1);
				if (!zend_is_true(r3)) {
					PHALCON_ALLOC_ZVAL(i0);
					object_init_ex(i0, phalcon_model_exception_class_entry);
...
PHP_METHOD(Phalcon_Model_Manager, addHasOne){
	...
	if (!eval_int) {
		if (Z_TYPE_P(v3) == IS_ARRAY) { 
			...
			PHALCON_CALL_FUNC_PARAMS_1(r2, "count", v1, 0x01E);
			PHALCON_ALLOC_ZVAL(r3);
			PHALCON_CALL_FUNC_PARAMS_1(r3, "count", v3, 0x01E);
			PHALCON_ALLOC_ZVAL(r4);
...
PHP_METHOD(Phalcon_Model_Manager, _getRelationRecords){
	...
	if (Z_TYPE_P(r0) != IS_ARRAY) { 
		...
		FOREACH_V(r6, ac0, fes22, fee22, ah0, hp0, v7)
			PHALCON_INIT_RESULT(r7);
			PHALCON_INIT_RESULT(r8);
	...
	Z_ADDREF_P(a2);
	Z_ADDREF_P(v8);
	PHALCON_CALL_FUNC_PARAMS_2(r18, "call_user_func_array", a2, v8, 0x020);
	RETURN_ZVAL(r18, 1, 0);
}
...
PHP_METHOD(Phalcon_Model_MetaData, __construct){
	...
	PHALCON_ALLOC_ZVAL(r1);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "class_exists", v1, 0x008);
	if (zend_is_true(r1)) {
		ce0 = zend_fetch_class(Z_STRVAL_P(v1), Z_STRLEN_P(v1), ZEND_FETCH_CLASS_DEFAULT TSRMLS_CC);
		PHALCON_ALLOC_ZVAL(i0);
		object_init_ex(i0, ce0);
		PHALCON_CALL_METHOD_NORETURN(i0, "__construct", PHALCON_CALL_CHECK);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_adapter", i0);
	}
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Model_MetaData, _initializeMetaData){
	...
	if (!zend_is_true(t1)) {
		...
		if (!zend_is_true(v5)) {
			...
			PHALCON_ALLOC_ZVAL(r7);
			PHALCON_CALL_FUNC_PARAMS_1(r7, "get_class", v0, 0x023);
			PHALCON_ALLOC_ZVAL(r4);
			...
			FOREACH_V(v6, ac0, fes23, fee23, ah0, hp0, v13)
				PHALCON_INIT_RESULT(r10);
				...
				PHALCON_CALL_FUNC_PARAMS_2(r13, "strpos", v15, c0, 0x00B);
				if (Z_TYPE_P(r13) != IS_BOOL || (Z_TYPE_P(r13) == IS_BOOL && Z_BVAL_P(r13))) {
					PHALCON_INIT_VARTYPE(t3, IS_BOOL);
					ZVAL_BOOL(t3, 1);
					{
						zval *copy;
						ALLOC_ZVAL(copy);
					...
					PHALCON_CALL_FUNC_PARAMS_2(r14, "strpos", v15, c1, 0x00B);
					if (Z_TYPE_P(r14) != IS_BOOL || (Z_TYPE_P(r14) == IS_BOOL && Z_BVAL_P(r14))) {
						PHALCON_INIT_VARTYPE(t4, IS_BOOL);
						ZVAL_BOOL(t4, 1);
						{
							zval *copy;
							ALLOC_ZVAL(copy);
...
PHP_METHOD(Phalcon_Model_Resultset, __construct){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_model", v0);
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_resultResource", v1);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Model_Resultset, valid){
	...
	if (zend_is_true(v2)) {
		...
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_activeRow", r2);
		RETURN_TRUE;
	} else {
		PHALCON_ALLOC_ZVAL(t4);
...
PHP_METHOD(Phalcon_Model_Resultset, seek){
	...
	convert_to_long(v0);
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_pointer", v0);
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_ALLOC_ZVAL(t0);
	phalcon_read_property(t0, this_ptr, "_model", sizeof("_model")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
...
PHP_METHOD(Phalcon_Model_Resultset, count){
	...
	Z_ADDREF_P(t1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_null", t1, 0x028);
	if (zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL(r1);
		PHALCON_ALLOC_ZVAL(t2);
		phalcon_read_property(t2, this_ptr, "_model", sizeof("_model")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
		...
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_count", r2);
	}
	PHALCON_ALLOC_ZVAL(t4);
...
PHP_METHOD(Phalcon_Model_Row, dumpResult){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "count", t0, 0x01E);
	PHALCON_ALLOC_ZVAL(t1);
	ZVAL_LONG(t1, 0);
	PHALCON_ALLOC_ZVAL(r1);
	...
	if (zend_is_true(r1)) {
		...
		array_init(a0);
		PHALCON_CPY_WRT(v2, a0);
		FOREACH_KV(v0, ac0, fes24, fee24, ah0, hp0, v4, v3)
			PHALCON_INIT_VARTYPE(t2, IS_BOOL);
			ZVAL_BOOL(t2, 1);
			{
				zval *copy;
				ALLOC_ZVAL(copy);
			...
			PHALCON_UPDATE_PROPERTY_CPY(v1, Z_STRVAL_P(v4), v3);
		END_FOREACH(ac0, fes24, fee24, ah0, hp0);
		PHALCON_UPDATE_PROPERTY_CPY(v1, "_columns", v2);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_columns", v2);
	} else {
		FOREACH_KV(v0, ac1, fes25, fee25, ah1, hp1, v4, v3)
			PHALCON_UPDATE_PROPERTY_CPY(v1, Z_STRVAL_P(v4), v3);
		...
		PHALCON_UPDATE_PROPERTY_CPY(v1, "_columns", t3);
	}
	PHALCON_RETURN_CHECK_CTOR(v1);
}
...
PHP_METHOD(Phalcon_Request, setFilter){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_filter", v0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Request, getFilter){
	...
	if (!zend_is_true(t0)) {
		...
		object_init_ex(i0, phalcon_filter_class_entry);
		PHALCON_CALL_METHOD_NORETURN(i0, "__construct", PHALCON_CALL_CHECK);
		PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_filter", i0);
	}
	PHALCON_ALLOC_ZVAL(t1);
...
PHP_METHOD(Phalcon_Request, isSoapRequested){
	...
	if (eval_int) {
		...
		if (eval_int) {
			...
			PHALCON_CALL_FUNC_PARAMS_2(r0, "strpos", r1, c0, 0x00B);
			FREE_ZVAL(c0);
			PHALCON_ALLOC_ZVAL(t0);
			ZVAL_BOOL(t0, 0);
			PHALCON_ALLOC_ZVAL(r2);
...
PHP_METHOD(Phalcon_Request, getRawBody){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "file_get_contents", c0, 0x003);
	FREE_ZVAL(c0);
	RETURN_ZVAL(r0, 1, 0);
}
...
PHP_METHOD(Phalcon_Request, getServerAddress){
	...
	if (eval_int) {
		...
		PHALCON_CALL_FUNC_PARAMS_1(r1, "gethostbyname", c0, 0x02D);
		FREE_ZVAL(c0);
		RETURN_ZVAL(r1, 1, 0);
	}
	RETURN_NULL();
...
PHP_METHOD(Phalcon_Request, hasFiles){
	...
	if (zend_is_true(a0)) {
		PHALCON_ALLOC_ZVAL(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "count", a0, 0x01E);
		PHALCON_ALLOC_ZVAL(t0);
		ZVAL_LONG(t0, 0);
		PHALCON_ALLOC_ZVAL(r2);
...
PHP_METHOD(Phalcon_Request, getUploadedFiles){
	...
	if (zend_is_true(a0)) {
		...
		array_init(a1);
		PHALCON_CPY_WRT_PARAM(v0, a1);
		FOREACH_V(a0, ac0, fes26, fee26, ah0, hp0, v1)
...
PHP_METHOD(Phalcon_Request, getAcceptableContent){
	...
	PHALCON_ALLOC_ZVAL(c0);
	ZVAL_STRING(c0, "/,\\s*/", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r1, "preg_split", c0, v0, 0x02E);
	FREE_ZVAL(c0);
	PHALCON_CPY_WRT(v1, r1);
	PHALCON_ALLOC_ZVAL(a0);
	array_init(a0);
	PHALCON_CPY_WRT(v2, a0);
	FOREACH_V(v1, ac0, fes27, fee27, ah0, hp0, v3)
		PHALCON_INIT_RESULT(r2);
		PHALCON_INIT_VARTYPE(c1, IS_STRING);
		ZVAL_STRING(c1, ";", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r2, "explode", c1, v3, 0x00C);
		PHALCON_CPY_WRT(v4, r2);
		...
		if (eval_int) {
			...
			Z_ADDREF_P(r4);
			PHALCON_INIT_VARTYPE(c2, IS_LONG);
			ZVAL_LONG(c2, 2);
			PHALCON_CALL_FUNC_PARAMS_2(r3, "substr", r4, c2, 0x029);
			PHALCON_CPY_WRT(v5, r3);
		} else {
			PHALCON_INIT_VARTYPE(v5, IS_DOUBLE);
			ZVAL_DOUBLE(v5, 1);
		}
		PHALCON_INIT_VARTYPE(a1, IS_ARRAY);
		array_init(a1);
...
PHP_METHOD(Phalcon_Request, getBestQualityAccept){
	...
	FOREACH_V(r0, ac0, fes28, fee28, ah0, hp0, v3)
...
PHP_METHOD(Phalcon_Request, getClientCharsets){
	...
	array_init(a0);
	PHALCON_CPY_WRT(v2, a0);
	FOREACH_V(v1, ac0, fes29, fee29, ah0, hp0, v3)
		PHALCON_INIT_RESULT(r2);
		PHALCON_INIT_VARTYPE(c1, IS_STRING);
		ZVAL_STRING(c1, ";", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r2, "explode", c1, v3, 0x00C);
...
PHP_METHOD(Phalcon_Request, getBestQualityCharset){
	...
	FOREACH_V(r0, ac0, fes30, fee30, ah0, hp0, v3)
		PHALCON_INIT_VARTYPE(t0, IS_LONG);
		ZVAL_LONG(t0, 0);
		if (!r1) {
			PHALCON_ALLOC_ZVAL(r1);
...
PHP_METHOD(Phalcon_Response, setHeader){
	...
	PHALCON_ALLOC_ZVAL(c0);
	ZVAL_BOOL(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("header", r0, c0, 0x02F);
	FREE_ZVAL(c0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Router_Rewrite, handle){
	...
	if (zend_is_true(v0)) {
		...
		PHALCON_ALLOC_ZVAL(c0);
		ZVAL_STRING(c0, "/", 1);
		PHALCON_CALL_FUNC_PARAMS_2(r1, "explode", c0, v0, 0x00C);
		FREE_ZVAL(c0);
		PHALCON_CPY_WRT(v1, r1);
		eval_int = phalcon_array_isset_long(v1, 0);
		if (eval_int) {
			...
			PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_controller", r3);
			PHALCON_ALLOC_ZVAL(t0);
		...
		if (eval_int) {
			...
			PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_action", r5);
			PHALCON_ALLOC_ZVAL(t1);
		...
		PHALCON_CPY_WRT(v2, a0);
		PHALCON_ALLOC_ZVAL(r6);
		PHALCON_CALL_FUNC_PARAMS_1(r6, "count", v1, 0x01E);
		PHALCON_CPY_WRT(v3, r6);
		PHALCON_ALLOC_ZVAL(v4);
		ZVAL_LONG(v4, 2);
		fs31:
...
PHP_METHOD(Phalcon_Tag, displayTo){
	...
	PHALCON_ALLOC_ZVAL(r0);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_scalar", v1, 0x032);
	if (!zend_is_true(r0)) {
		PHALCON_ALLOC_ZVAL(i0);
...
PHP_METHOD(Phalcon_Tag, _getValueFromAction){
	...
	if (zend_is_true(t1)) {
		...
		if (eval_int) {
			PHALCON_ALLOC_ZVAL(r0);
			PHALCON_CALL_FUNC(r0, "get_magic_quotes_gpc", 0x033);
			if (!zend_is_true(r0)) {
				PHALCON_ALLOC_ZVAL(r1);
				...
				phalcon_array_fetch(r3, a0, v0, PHALCON_NOISY_FETCH TSRMLS_CC);
				Z_ADDREF_P(r3);
				PHALCON_CALL_FUNC_PARAMS_1(r2, "stripslashes", r3, 0x034);
				RETURN_ZVAL(r2, 1, 0);
			}
		}
	}
...
PHP_METHOD(Phalcon_Tag, linkTo){
	...
	if (!PHALCON_COMPARE_STRING(v2, "")) {
		...
		FOREACH_KV(v0, ac0, fes32, fee32, ah0, hp0, v5, v4)
...
PHP_METHOD(Phalcon_Tag, textField){
	...
	FOREACH_KV(v0, ac0, fes33, fee33, ah0, hp0, v3, v1)
...
PHP_METHOD(Phalcon_Tag, submitButton){
	...
	PHALCON_CPY_WRT(v2, r2);
	FOREACH_KV(v0, ac0, fes34, fee34, ah0, hp0, v3, v1)
		if (Z_TYPE_P(v3) != IS_LONG) {
			PHALCON_INIT_RESULT(r3);
...
PHP_METHOD(Phalcon_Tag, selectStatic){
	...
	FOREACH_KV(v0, ac0, fes35, fee35, ah0, hp0, v7, v6)
	...
	if (eval_int) {
		...
		if (Z_TYPE_P(r19) == IS_ARRAY) { 
			...
			FOREACH_KV(r20, ac1, fes36, fee36, ah1, hp1, v9, v8)
				if (!r21) {
					PHALCON_ALLOC_ZVAL(r21);
				} else {
			...
			END_FOREACH(ac1, fes36, fee36, ah1, hp1);
		} else {
			PHALCON_ALLOC_ZVAL(i0);
			object_init_ex(i0, phalcon_tag_exception_class_entry);
			PHALCON_ALLOC_ZVAL(p1[0]);
...
PHP_METHOD(Phalcon_Tag, select){
	...
	PHALCON_CPY_WRT(v3, r7);
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		FOREACH_KV(v0, ac0, fes37, fee37, ah0, hp0, v4, v2)
			if (Z_TYPE_P(v4) != IS_LONG) {
				if (Z_TYPE_P(v2) != IS_ARRAY) { 
					PHALCON_INIT_RESULT(r8);
					PHALCON_CONCAT_VBOTH(r8, v4, "='", v2);
		...
		if (zend_is_true(r19)) {
			...
			if (Z_TYPE_P(r20) == IS_OBJECT) {
				...
				if (Z_TYPE_P(r45) == IS_ARRAY) { 
					...
					FOREACH_V(r46, ac1, fes39, fee39, ah1, hp1, v9)
						PHALCON_INIT_VARTYPE(t7, IS_STRING);
						ZVAL_STRING(t7, "\t", 1);
						PHALCON_INIT_RESULT(r50);
...
PHP_METHOD(Phalcon_Tag, textArea){
	...
	FOREACH_KV(v0, ac0, fes40, fee40, ah0, hp0, v4, v3)
		if (Z_TYPE_P(v4) != IS_LONG) {
			PHALCON_INIT_RESULT(r9);
...
PHP_METHOD(Phalcon_Tag, form){
	...
	PHALCON_CPY_WRT(v4, r20);
	FOREACH_KV(v0, ac0, fes41, fee41, ah0, hp0, v6, v5)
...
PHP_METHOD(Phalcon_Tag, stylesheetLink){
	...
	FOREACH_KV(v0, ac0, fes42, fee42, ah0, hp0, v4, v3)
		if (Z_TYPE_P(v4) != IS_LONG) {
			PHALCON_INIT_RESULT(r6);
...
PHP_METHOD(Phalcon_Tag, image){
	...
	FOREACH_KV(v0, ac0, fes43, fee43, ah0, hp0, v3, v2)
		if (Z_TYPE_P(v3) != IS_LONG) {
			PHALCON_INIT_RESULT(r4);
...
PHP_METHOD(Phalcon_Test, nice){
	...
	PHALCON_CPY_WRT(v1, a0);
	FOREACH_KV(v1, ac0, fes44, fee44, ah0, hp0, v3, v2)
		PHALCON_INIT_RESULT(r0);
	...
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("print_r", v1, 0x035);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Transaction_Manager, get){
	...
	if (zend_is_true(t0)) {
		...
		PHALCON_CALL_FUNC_PARAMS_1_NORETURN("register_shutdown_function", a0, 0x036);
		PHALCON_ALLOC_ZVAL(t1);
		ZVAL_BOOL(t1, 1);
...
PHP_METHOD(Phalcon_Transaction_Manager, commit){
	...
	FOREACH_V(t0, ac0, fes45, fee45, ah0, hp0, v0)
		PHALCON_INIT_RESULT(r0);
		PHALCON_CALL_METHOD(r0, v0, "getconnection", PHALCON_CALL_DEFAULT);
		PHALCON_CPY_WRT(v1, r0);
		PHALCON_INIT_RESULT(r1);
...
PHP_METHOD(Phalcon_Transaction_Manager, rollback){
	...
	t0 = zend_read_static_property(phalcon_transaction_manager_class_entry, "_transactions", sizeof("_transactions")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
	FOREACH_V(t0, ac0, fes46, fee46, ah0, hp0, v1)
		PHALCON_INIT_RESULT(r0);
...
PHP_METHOD(Phalcon_Transaction_Manager, _collectTransaction){
	...
	if (!phalcon_is_smaller_strict_long(r0, 0)) {
		...
		FOREACH_V(t1, ac0, fes47, fee47, ah0, hp0, v2)
			if (!r1) {
				PHALCON_ALLOC_ZVAL(r1);
			} else {
				if (Z_REFCOUNT_P(r1) > 1){ 
		...
		FOREACH_V(t3, ac1, fes48, fee48, ah1, hp1, v2)
			{
				zval *copy;
				ALLOC_ZVAL(copy);
				ZVAL_ZVAL(copy, v2, 1, 0);
...
PHP_METHOD(Phalcon_Transaction_Manager, collectTransactions){
	...
	if (!phalcon_is_smaller_strict_long(r0, 0)) {
		...
		ZVAL_LONG(v0, 0);
		t1 = zend_read_static_property(phalcon_transaction_manager_class_entry, "_transactions", sizeof("_transactions")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
		FOREACH_V(t1, ac0, fes49, fee49, ah0, hp0, v1)
			t2 = zend_read_static_property(phalcon_transaction_manager_class_entry, "_number", sizeof("_number")-1, (zend_bool) ZEND_FETCH_CLASS_SILENT TSRMLS_CC);
			PHALCON_SEPARATE(t2);
			decrement_function(t2);
			zend_update_static_property(phalcon_transaction_manager_class_entry, "_number", sizeof("_number")-1, t2 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Transaction, __construct){
	...
	PHALCON_CPY_WRT(v1, r0);
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_connection", v1);
	PHALCON_ALLOC_ZVAL(t0);
	ZVAL_BOOL(t0, 1);
	PHALCON_ALLOC_ZVAL(r1);
	is_equal_function(r1, v0, t0 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Transaction, setTransactionManager){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_manager", v0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Transaction, commit){
	...
	if (!PHALCON_COMPARE_STRING(t0, "")) {
		...
		Z_ADDREF_P(a1);
		PHALCON_CALL_FUNC_PARAMS_2_NORETURN("call_user_func_array", a0, a1, 0x020);
	}
	PHALCON_ALLOC_ZVAL(r0);
	PHALCON_ALLOC_ZVAL(t2);
...
PHP_METHOD(Phalcon_Transaction, rollback){
	...
	if (zend_is_true(r1)) {
		...
		if (zend_is_true(v1)) {
			PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_rollbackRecord", v1);
		}
		PHALCON_ALLOC_ZVAL(i0);
...
PHP_METHOD(Phalcon_Transaction, getConnection){
	...
	if (zend_is_true(t0)) {
		PHALCON_ALLOC_ZVAL(r0);
		PHALCON_CALL_FUNC(r0, "connection_aborted", 0x037);
		if (zend_is_true(r0)) {
			PHALCON_ALLOC_ZVAL(p1[0]);
...
PHP_METHOD(Phalcon_Transaction, setIsNewTransaction){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_isNewTransaction", v0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Transaction, setRollbackOnAbort){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_rollbackOnAbort", v0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Transaction, save){
	...
	FOREACH_V(t0, ac0, fes50, fee50, ah0, hp0, v0)
		...
		if (zend_is_true(r1)) {
			...
			PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_messages", r2);
			RETURN_FALSE;
		}
...
PHP_METHOD(Phalcon_Transaction, setRollbackedRecord){
	...
	PHALCON_UPDATE_PROPERTY_CPY(this_ptr, "_rollbackRecord", v0);
	RETURN_NULL();
}
...
PHP_METHOD(Phalcon_Utils, camelize){
	...
	ZVAL_STRING(p2[1], " ", 1);
	PHALCON_ALLOC_ZVAL(r3);
	PHALCON_CALL_FUNC_PARAMS_1(r3, "strtolower", v0, 0x039);
	p2[2] = r3;
	PHALCON_CALL_FUNC_PARAMS(r2, "str_replace", 3, p2, 0x027);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "ucwords", r2, 0x038);
	p0[2] = r1;
	PHALCON_CALL_FUNC_PARAMS(r0, "str_replace", 3, p0, 0x027);
	RETURN_ZVAL(r0, 1, 0);
}
...
PHP_METHOD(Phalcon_Utils, uncamelize){
	...
	PHALCON_CPY_WRT(v1, a0);
	FOREACH_KV(v1, ac0, fes51, fee51, ah0, hp0, v3, v2)
		PHALCON_INIT_RESULT(r0);
		Z_ADDREF_P(v3);
		Z_ADDREF_P(v0);
		PHALCON_CALL_FUNC_PARAMS_2(r0, "preg_match", v3, v0, 0x03A);
		if (zend_is_true(r0)) {
			PHALCON_INIT_RESULT(r1);
			PHALCON_INIT_RESULT(r2);
			Z_ADDREF_P(v3);
			...
			Z_ADDREF_P(v0);
			p2[2] = v0;
			PHALCON_CALL_FUNC_PARAMS(r2, "preg_replace", 3, p2, 0x03B);
			PHALCON_CALL_FUNC_PARAMS_1(r1, "strtolower", r2, 0x039);
			RETURN_ZVAL(r1, 1, 0);
		}
...
PHP_METHOD(Phalcon_Utils, lcfirst){
	...
	PHALCON_ALLOC_ZVAL(p1[2]);
	ZVAL_LONG(p1[2], 1);
	PHALCON_CALL_FUNC_PARAMS(r1, "substr", 3, p1, 0x029);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "strtolower", r1, 0x039);
	PHALCON_ALLOC_ZVAL(r2);
	Z_ADDREF_P(v0);
	PHALCON_ALLOC_ZVAL(c0);
	ZVAL_LONG(c0, 1);
	PHALCON_CALL_FUNC_PARAMS_2(r2, "substr", v0, c0, 0x029);
	FREE_ZVAL(c0);
	PHALCON_ALLOC_ZVAL(r3);
...
PHP_METHOD(Phalcon_View, render){
	...
	if (phalcon_is_smaller_strict_long(v4, 6)) {
		PHALCON_ALLOC_ZVAL(r0);
		PHALCON_CALL_FUNC(r0, "ob_get_contents", 0x005);
		...
		FOREACH_KV(t3, ac0, fes52, fee52, ah0, hp0, v6, v5)
			{
				zval *copy;
				ALLOC_ZVAL(copy);
				ZVAL_ZVAL(copy, v5, 1, 0);
		...
		if (phalcon_is_smaller_or_equal_strict_long(v4, 1)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				PHALCON_CALL_FUNC_NORETURN("ob_clean", 0x03C);
				phalcon_require(v7 TSRMLS_CC);
				if (EG(exception) || EG(exit_status) == 255) {
					return;
				}
				PHALCON_ALLOC_ZVAL(r4);
				PHALCON_CALL_FUNC(r4, "ob_get_contents", 0x005);
		...
		if (phalcon_is_smaller_or_equal_strict_long(v4, 2)) {
			...
			if (Z_TYPE_P(v8) == IS_ARRAY) { 
				...
				PHALCON_CPY_WRT(v7, r5);
				FOREACH_V(v8, ac1, fes53, fee53, ah1, hp1, v9)
					PHALCON_INIT_RESULT(r6);
					...
					if (phalcon_file_exists(v10 TSRMLS_CC) == SUCCESS) {
						...
						PHALCON_INIT_RESULT(r8);
						PHALCON_CALL_FUNC(r8, "ob_get_contents", 0x005);
		...
		if (phalcon_is_smaller_or_equal_strict_long(v4, 3)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_ALLOC_ZVAL(r13);
				PHALCON_CALL_FUNC(r13, "ob_get_contents", 0x005);
		...
		if (phalcon_is_smaller_or_equal_strict_long(v4, 4)) {
			...
			if (Z_TYPE_P(v11) == IS_ARRAY) { 
				...
				FOREACH_V(v11, ac2, fes54, fee54, ah2, hp2, v12)
					PHALCON_INIT_RESULT(r15);
					...
					if (phalcon_file_exists(v10 TSRMLS_CC) == SUCCESS) {
						...
						PHALCON_INIT_RESULT(r17);
						PHALCON_CALL_FUNC(r17, "ob_get_contents", 0x005);
				...
				END_FOREACH(ac2, fes54, fee54, ah2, hp2);
			}
		}
		if (phalcon_is_smaller_or_equal_strict_long(v4, 5)) {
			...
			if (phalcon_file_exists(v7 TSRMLS_CC) == SUCCESS) {
				...
				PHALCON_ALLOC_ZVAL(r20);
				PHALCON_CALL_FUNC(r20, "ob_get_contents", 0x005);
...
PHP_METHOD(Phalcon_View, partial){
	...
	PHALCON_ALLOC_ZVAL(t0);
	phalcon_read_property(t0, this_ptr, "_params", sizeof("_params")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	FOREACH_KV(t0, ac0, fes55, fee55, ah0, hp0, v2, v1)
		{
			zval *copy;
			ALLOC_ZVAL(copy);
			ZVAL_ZVAL(copy, v1, 1, 0);
...
PHP_METHOD(Phalcon_View, url){
	...
	if (Z_TYPE_P(v0) == IS_ARRAY) { 
		PHALCON_CALL_FUNC_PARAMS_1_NORETURN("print_r", v0, 0x035);
	} else {
		PHALCON_ALLOC_ZVAL(r0);
		Z_ADDREF_P(v0);
		p1[0] = v0;
...
PHP_MINIT_FUNCTION(phalcon){
	...
	zend_class_entry ce0, ce1, ce2, ce3, ce4, ce5, ce6, ce7, ce8, ce9, ce10, ce11, ce12, ce13, ce14, ce15, ce16, ce17, ce18, ce19, ce20, ce21, ce22, ce23, ce24, ce25, ce26, ce27, ce28, ce29, ce30, ce31, ce32, ce33, ce34, ce35, ce36, ce37, ce38, ce39, ce40, ce41;
	...
	INIT_CLASS_ENTRY(ce0, "Phalcon_Cache_Adapter_File", phalcon_cache_adapter_file_functions);
	phalcon_cache_adapter_file_class_entry = zend_register_internal_class(&ce0 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce1, "Phalcon_Cache", phalcon_cache_functions);
	phalcon_cache_class_entry = zend_register_internal_class(&ce1 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce2, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce2 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce4, "Phalcon_Controller", phalcon_controller_functions);
	phalcon_controller_class_entry = zend_register_internal_class(&ce4 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce5, "Phalcon_Db_Dialect_Mysql", phalcon_db_dialect_mysql_functions);
	phalcon_db_dialect_mysql_class_entry = zend_register_internal_class(&ce5 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce6, "Phalcon_Db_Pool", phalcon_db_pool_functions);
	phalcon_db_pool_class_entry = zend_register_internal_class(&ce6 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce7, "Phalcon_Db_RawValue", phalcon_db_rawvalue_functions);
	phalcon_db_rawvalue_class_entry = zend_register_internal_class(&ce7 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_rawvalue_class_entry, "_value", sizeof("_value")-1, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce8, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce8 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce9, "Phalcon_Dispatcher", phalcon_dispatcher_functions);
	phalcon_dispatcher_class_entry = zend_register_internal_class(&ce9 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce10, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_class_entry = zend_register_internal_class(&ce10 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce11, "Phalcon_Flash", phalcon_flash_functions);
	phalcon_flash_class_entry = zend_register_internal_class(&ce11 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce12, "Phalcon_Logger", phalcon_logger_functions);
	phalcon_logger_class_entry = zend_register_internal_class(&ce12 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce13, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_class_entry = zend_register_internal_class(&ce13 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce14, "Phalcon_Model_Manager", phalcon_model_manager_functions);
	phalcon_model_manager_class_entry = zend_register_internal_class(&ce14 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce15, "Phalcon_Model_Message", phalcon_model_message_functions);
	phalcon_model_message_class_entry = zend_register_internal_class(&ce15 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce16, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce16 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce17, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_class_entry = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce18, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce18 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce19, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_class_entry = zend_register_internal_class(&ce19 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce20, "Phalcon_Request", phalcon_request_functions);
	phalcon_request_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce21, "Phalcon_Response", phalcon_response_functions);
	phalcon_response_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Router_Rewrite", phalcon_router_rewrite_functions);
	phalcon_router_rewrite_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce23, "Phalcon_Session", phalcon_session_functions);
	phalcon_session_class_entry = zend_register_internal_class(&ce23 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce24, "Phalcon_Tag", phalcon_tag_functions);
	phalcon_tag_class_entry = zend_register_internal_class(&ce24 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce25, "Phalcon_Test", phalcon_test_functions);
	phalcon_test_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);
	zend_declare_property_null(phalcon_test_class_entry, "p", sizeof("p")-1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	INIT_CLASS_ENTRY(ce26, "Phalcon_Transaction_Manager", phalcon_transaction_manager_functions);
	phalcon_transaction_manager_class_entry = zend_register_internal_class(&ce26 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce27, "Phalcon_Transaction", phalcon_transaction_functions);
	phalcon_transaction_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Utils", phalcon_utils_functions);
	phalcon_utils_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce29, "Phalcon_View", phalcon_view_functions);
	phalcon_view_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce30, "Phalcon_Exception", phalcon_exception_functions);
	phalcon_exception_class_entry = zend_register_internal_class_ex(&ce30, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce31, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Cache_Exception", phalcon_cache_exception_functions);
	phalcon_cache_exception_class_entry = zend_register_internal_class_ex(&ce33, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce38, "Phalcon_Model_Exception", phalcon_model_exception_functions);
	phalcon_model_exception_class_entry = zend_register_internal_class_ex(&ce38, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce39, "Phalcon_Tag_Exception", phalcon_tag_exception_functions);
	phalcon_tag_exception_class_entry = zend_register_internal_class_ex(&ce39, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce40, "Phalcon_Transaction_Failed", phalcon_transaction_failed_functions);
	phalcon_transaction_failed_class_entry = zend_register_internal_class_ex(&ce40, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce41, "Phalcon_View_Exception", phalcon_view_exception_functions);
	phalcon_view_exception_class_entry = zend_register_internal_class_ex(&ce41, NULL, "phalcon_exception" TSRMLS_CC);
