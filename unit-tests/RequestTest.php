...
class RequestTest extends PHPUnit_Framework_TestCase
{
	...
	public function testGetAuth()
	{
		...
		$_SERVER = array(
			'PHP_AUTH_DIGEST' => 'Digest username="myleft", realm="myleft", qop="auth", algorithm="MD5", uri="http://localhost/", nonce="nonce", nc=nc, cnonce="cnonce", opaque="opaque", response="response"'
		);

		$data = array('username' => 'myleft', 'realm' => 'myleft', 'qop' => 'auth', 'algorithm' => 'MD5', 'uri' => 'http://localhost/', 'nonce' => 'nonce', 'nc' => 'nc', 'cnonce' => 'cnonce', 'opaque' => 'opaque', 'response' => 'response');
