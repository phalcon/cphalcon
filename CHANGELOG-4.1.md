...
- Changed methods internally to use `mbstring` equivalent ones (`strtolower`, etc.) making `mbstring` a prerequisite [#14723](https://github.com/phalcon/cphalcon/issues/14723)
