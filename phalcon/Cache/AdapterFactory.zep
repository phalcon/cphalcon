    ...
    public function __construct(<SerializerFactory> factory, array! services = [])
    {
        ...
        let helpers = [
            "apcu"         : function (factory, options = []) {
                return new \Phalcon\Cache\Adapter\Apcu(factory, options);
            },
            "libmemcached" : function (factory, options = []) {
                return new \Phalcon\Cache\Adapter\Libmemcached(factory, options);
            },
            "memory"       : function (factory, options = []) {
                return new \Phalcon\Cache\Adapter\Memory(factory, options);
            },
            "redis"        : function (factory, options = []) {
                return new \Phalcon\Cache\Adapter\Redis(factory, options);
            },
            "stream"       : function (factory, options = []) {
                return new \Phalcon\Cache\Adapter\Stream(factory, options);
            }
        ];
