...
abstract class Adapter implements AdapterInterface, EventsAwareInterface
{
	 ...
	 */
	public function setEventsManager(<ManagerInterface> eventsManager) -> <Adapter>
	{
	 ...
	 */
	public function setRoleCallback(var callback) -> <Adapter>
	{
	...
	*/
	...
	protected function callRoleCallback() -> void
	{
		var roleCallback, role, identity;

		let roleCallback = this->_roleCallback;

		let identity = roleCallback();
	...
	public function setCache(<BackendInterface> cache) -> <Adapter>
	{
