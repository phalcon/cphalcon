...
class Manager implements ManagerInterface
{
	 ...
	 * @param int priority
	 */
	public function attach(string! eventType, var handler, int! priority = Manager::DEFAULT_PRIORITY)
	{
		var priorityQueue;
		...
		if !this->_enablePriorities {
			let priority = Manager::DEFAULT_PRIORITY;
		}
	 ...
	 * @return mixed
	 */
	public final function fireQueue(<PriorityQueue> queue, <EventInterface> event)
	{
	...
	{
		var events, fireEvents, priorityQueue, listeners;
