...
- Added new feature in `Phalcon\Assets\Collection`, when you add the same resource will not occur its duplication in the collection [#10938](https://github.com/phalcon/cphalcon/issues/10938)
