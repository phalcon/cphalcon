...
- `Phalcon\Mvc\Model\Resultset::valid()` reporting no row for a resultset restored from cache; `Phalcon\Mvc\Model\Resultset\Complex` stores rows that are already hydrated, so they are objects and not arrays. [#17574](https://github.com/phalcon/cphalcon/issues/17574) [[doc]](https://docs.phalcon.io/5.20/db-models/)
