...
PHP_METHOD(Phalcon_Exception, __construct){
	...
	phalcon_step_over("Phalcon_Exception::__construct (If) File=Library/Phalcon/Exception.php Line=19");
	...
	if (zend_is_true(r0)) {
		phalcon_step_over("Phalcon_Exception::__construct (Block) File=Library/Phalcon/Exception.php Line=19");
		phalcon_step_over("Phalcon_Exception::__construct (StaticMethodCall) File=Library/Phalcon/Exception.php Line=20");
		//$message
		Z_ADDREF_P(v0);
		p1[0] = v0;
		...
		phalcon_step_over("Phalcon_Exception::__construct (Block) File=Library/Phalcon/Exception.php Line=21");
		phalcon_step_over("Phalcon_Exception::__construct (StaticMethodCall) File=Library/Phalcon/Exception.php Line=22");
		//$message
		Z_ADDREF_P(v0);
		p2[0] = v0;
		phalcon_debug_param(v0 TSRMLS_CC);
