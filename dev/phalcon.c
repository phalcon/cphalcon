...
PHP_MINIT_FUNCTION(phalcon){
	...
	zend_class_entry ce0, ce1, ce2, ce3, ce4, ce5, ce6, ce7, ce8, ce9, ce10, ce11, ce12, ce13, ce14, ce15, ce16, ce17, ce18, ce19, ce20, ce21, ce22, ce23, ce24, ce25, ce26, ce27, ce28, ce29, ce30, ce31, ce32, ce33, ce34, ce35, ce36, ce37, ce38, ce39, ce40, ce41, ce42, ce43, ce44, ce45, ce46, ce47, ce48, ce49, ce50, ce51, ce52, ce53;
	...
	INIT_CLASS_ENTRY(ce13, "Phalcon_Internal_TestTemp", phalcon_internal_testtemp_functions);
	phalcon_internal_testtemp_class_entry = zend_register_internal_class(&ce13 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce14, "Phalcon_Internal_TestDummy", phalcon_internal_testdummy_functions);
	phalcon_internal_testdummy_class_entry = zend_register_internal_class(&ce14 TSRMLS_CC);
	...
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce15 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_class_entry, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce16, "Phalcon_Router_Rewrite", phalcon_router_rewrite_functions);
	phalcon_router_rewrite_class_entry = zend_register_internal_class(&ce16 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce17, "Phalcon_Db_Pool", phalcon_db_pool_functions);
	phalcon_db_pool_class_entry = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce18, "Phalcon_Db_Dialect_Mysql", phalcon_db_dialect_mysql_functions);
	phalcon_db_dialect_mysql_class_entry = zend_register_internal_class(&ce18 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce19, "Phalcon_Db_RawValue", phalcon_db_rawvalue_functions);
	phalcon_db_rawvalue_class_entry = zend_register_internal_class(&ce19 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_rawvalue_class_entry, "_value", sizeof("_value")-1, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce20, "Phalcon_Flash", phalcon_flash_functions);
	phalcon_flash_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce21, "Phalcon_Paginator", phalcon_paginator_functions);
	phalcon_paginator_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce22, "Phalcon_Logger", phalcon_logger_functions);
	phalcon_logger_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce23, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce23 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce24, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_class_entry = zend_register_internal_class(&ce24 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce25, "Phalcon_Transaction", phalcon_transaction_functions);
	phalcon_transaction_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce27, "Phalcon_Session", phalcon_session_functions);
	phalcon_session_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Controller", phalcon_controller_functions);
	phalcon_controller_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce29, "Phalcon_Model_Message", phalcon_model_message_functions);
	phalcon_model_message_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce30, "Phalcon_Model_Manager", phalcon_model_manager_functions);
	phalcon_model_manager_class_entry = zend_register_internal_class(&ce30 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce31, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce32, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_class_entry = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_class_entry = zend_register_internal_class(&ce33 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce34, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce34 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce35, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce35 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce36, "Phalcon_Model_Sanitize", phalcon_model_sanitize_functions);
	phalcon_model_sanitize_class_entry = zend_register_internal_class(&ce36 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce37, "Phalcon_Model_Query", phalcon_model_query_functions);
	phalcon_model_query_class_entry = zend_register_internal_class(&ce37 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce39, "Phalcon_Exception", phalcon_exception_functions);
	phalcon_exception_class_entry = zend_register_internal_class_ex(&ce39, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce40, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce40 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_class_entry, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce41, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce41 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_descriptor", sizeof("_descriptor")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_fetchMode", sizeof("_fetchMode")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_autoCommit", sizeof("_autoCommit")-1, 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_idConnection", sizeof("_idConnection")-1, 0, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce43, "Phalcon_Paginator_Exception", phalcon_paginator_exception_functions);
	phalcon_paginator_exception_class_entry = zend_register_internal_class_ex(&ce43, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce44, "Phalcon_Cache_Exception", phalcon_cache_exception_functions);
	phalcon_cache_exception_class_entry = zend_register_internal_class_ex(&ce44, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce45, "Phalcon_Internal_Test", phalcon_internal_test_functions);
	phalcon_internal_test_class_entry = zend_register_internal_class_ex(&ce45, NULL, "phalcon_internal_testparent" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce46, "Phalcon_Tag_Exception", phalcon_tag_exception_functions);
	phalcon_tag_exception_class_entry = zend_register_internal_class_ex(&ce46, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce47, "Phalcon_Db_Exception", phalcon_db_exception_functions);
	phalcon_db_exception_class_entry = zend_register_internal_class_ex(&ce47, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce48, "Phalcon_Db_Mysql", phalcon_db_mysql_functions);
	phalcon_db_mysql_class_entry = zend_register_internal_class_ex(&ce48, NULL, "phalcon_db" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce49, "Phalcon_Transaction_Failed", phalcon_transaction_failed_functions);
	phalcon_transaction_failed_class_entry = zend_register_internal_class_ex(&ce49, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce50, "Phalcon_Config_Adapter_Ini", phalcon_config_adapter_ini_functions);
	phalcon_config_adapter_ini_class_entry = zend_register_internal_class_ex(&ce50, NULL, "phalcon_config" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce51, "Phalcon_Config_Exception", phalcon_config_exception_functions);
	phalcon_config_exception_class_entry = zend_register_internal_class_ex(&ce51, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce52, "Phalcon_Model_Exception", phalcon_model_exception_functions);
	phalcon_model_exception_class_entry = zend_register_internal_class_ex(&ce52, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce53, "Phalcon_View_Exception", phalcon_view_exception_functions);
	phalcon_view_exception_class_entry = zend_register_internal_class_ex(&ce53, NULL, "phalcon_exception" TSRMLS_CC);
