...
PHP_MINIT_FUNCTION(phalcon){
	...
	phalcon_test_ce = zend_register_internal_class(&ce02 TSRMLS_CC);
	...
	phalcon_router_rewrite_ce = zend_register_internal_class(&ce03 TSRMLS_CC);
	...
	phalcon_db_ce = zend_register_internal_class(&ce04 TSRMLS_CC);
	...
	phalcon_logger_ce = zend_register_internal_class(&ce05 TSRMLS_CC);
	...
	phalcon_cache_frontend_output_ce = zend_register_internal_class(&ce06 TSRMLS_CC);
	...
	phalcon_cache_backend_file_ce = zend_register_internal_class(&ce07 TSRMLS_CC);
	...
	phalcon_acl_adapter_memory_ce = zend_register_internal_class(&ce08 TSRMLS_CC);
	...
	phalcon_acl_role_ce = zend_register_internal_class(&ce09 TSRMLS_CC);
	...
	phalcon_acl_resource_ce = zend_register_internal_class(&ce10 TSRMLS_CC);
	...
	phalcon_cache_ce = zend_register_internal_class(&ce11 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce12, "Phalcon_View", phalcon_view_functions);
	phalcon_view_ce = zend_register_internal_class(&ce12 TSRMLS_CC);
	...
	phalcon_paginator_adapter_array_ce = zend_register_internal_class(&ce13 TSRMLS_CC);
	...
	phalcon_paginator_adapter_model_ce = zend_register_internal_class(&ce14 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce15, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_ce = zend_register_internal_class(&ce15 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_ce, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce16, "Phalcon_Internal_TestTemp", phalcon_internal_testtemp_functions);
	phalcon_internal_testtemp_ce = zend_register_internal_class(&ce16 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce17, "Phalcon_Internal_TestDummy", phalcon_internal_testdummy_functions);
	phalcon_internal_testdummy_ce = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	phalcon_controller_ce = zend_register_internal_class(&ce18 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce19, "Phalcon_Paginator", phalcon_paginator_functions);
	phalcon_paginator_ce = zend_register_internal_class(&ce19 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce20, "Phalcon_Utils", phalcon_utils_functions);
	phalcon_utils_ce = zend_register_internal_class(&ce20 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce21, "Phalcon_Dispatcher", phalcon_dispatcher_functions);
	phalcon_dispatcher_ce = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Db_Pool", phalcon_db_pool_functions);
	phalcon_db_pool_ce = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce23, "Phalcon_Db_Profiler", phalcon_db_profiler_functions);
	phalcon_db_profiler_ce = zend_register_internal_class(&ce23 TSRMLS_CC);
	...
	phalcon_db_reference_ce = zend_register_internal_class(&ce24 TSRMLS_CC);
	...
	phalcon_db_profiler_item_ce = zend_register_internal_class(&ce25 TSRMLS_CC);
	...
	phalcon_db_rawvalue_ce = zend_register_internal_class(&ce26 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_rawvalue_ce, "_value", sizeof("_value")-1, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce27, "Phalcon_Db_Column", phalcon_db_column_functions);
	phalcon_db_column_ce = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Db_Index", phalcon_db_index_functions);
	phalcon_db_index_ce = zend_register_internal_class(&ce28 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_index_ce, "_indexName", sizeof("_indexName")-1, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce29, "Phalcon_Db_Dialect_Mysql", phalcon_db_dialect_mysql_functions);
	phalcon_db_dialect_mysql_ce = zend_register_internal_class(&ce29 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce30, "Phalcon_Model_Query", phalcon_model_query_functions);
	phalcon_model_query_ce = zend_register_internal_class(&ce30 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce31, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_ce = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce32, "Phalcon_Model_Validator", phalcon_model_validator_functions);
	phalcon_model_validator_ce = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_ce = zend_register_internal_class(&ce33 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce34, "Phalcon_Model_Sanitize", phalcon_model_sanitize_functions);
	phalcon_model_sanitize_ce = zend_register_internal_class(&ce34 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce35, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_ce = zend_register_internal_class(&ce35 TSRMLS_CC);
	...
	phalcon_model_message_ce = zend_register_internal_class(&ce36 TSRMLS_CC);
	...
	phalcon_model_manager_ce = zend_register_internal_class(&ce37 TSRMLS_CC);
	...
	phalcon_model_metadata_memory_ce = zend_register_internal_class(&ce38 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce39, "Phalcon_Model_MetaData_Session", phalcon_model_metadata_session_functions);
	phalcon_model_metadata_session_ce = zend_register_internal_class(&ce39 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce40, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_ce = zend_register_internal_class(&ce40 TSRMLS_CC);
	...
	phalcon_tag_ce = zend_register_internal_class(&ce41 TSRMLS_CC);
	zend_declare_property_null(phalcon_tag_ce, "_displayValues", sizeof("_displayValues")-1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);
	zend_declare_property_string(phalcon_tag_ce, "_documentTitle", sizeof("_documentTitle")-1, "", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);
	zend_declare_property_null(phalcon_tag_ce, "_dispatcher", sizeof("_dispatcher")-1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	INIT_CLASS_ENTRY(ce42, "Phalcon_Response", phalcon_response_functions);
	phalcon_response_ce = zend_register_internal_class(&ce42 TSRMLS_CC);
	...
	phalcon_request_ce = zend_register_internal_class(&ce43 TSRMLS_CC);
	zend_declare_property_null(phalcon_request_ce, "_filter", sizeof("_filter")-1, ZEND_ACC_PRIVATE TSRMLS_CC);
	...
	phalcon_transaction_manager_ce = zend_register_internal_class(&ce44 TSRMLS_CC);
	...
	phalcon_controller_front_ce = zend_register_internal_class(&ce45 TSRMLS_CC);
	...
	phalcon_session_ce = zend_register_internal_class(&ce46 TSRMLS_CC);
	...
	phalcon_flash_ce = zend_register_internal_class(&ce47 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce48, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_ce = zend_register_internal_class(&ce48 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce49, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_ce = zend_register_internal_class(&ce49 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce50, "Phalcon_Acl", phalcon_acl_functions);
	phalcon_acl_ce = zend_register_internal_class(&ce50 TSRMLS_CC);
	...
	phalcon_logger_adapter_file_ce = zend_register_internal_class(&ce51 TSRMLS_CC);
	...
	phalcon_logger_item_ce = zend_register_internal_class(&ce52 TSRMLS_CC);
	...
	phalcon_transaction_ce = zend_register_internal_class(&ce53 TSRMLS_CC);
	...
	phalcon_exception_ce = zend_register_internal_class_ex(&ce54, NULL, "exception" TSRMLS_CC);
	...
	phalcon_config_ce = zend_register_internal_class(&ce55 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce56, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_ce = zend_register_internal_class(&ce56 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_ce, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce57, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_ce = zend_register_internal_class(&ce57 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_ce, "_descriptor", sizeof("_descriptor")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_db_ce, "_fetchMode", sizeof("_fetchMode")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_ce, "_autoCommit", sizeof("_autoCommit")-1, 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_ce, "_idConnection", sizeof("_idConnection")-1, 0, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	phalcon_model_validator_ce = zend_register_internal_class(&ce58 TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_ce, "_record", sizeof("_record")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_ce, "_fieldName", sizeof("_fieldName")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_ce, "_value", sizeof("_value")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_model_validator_ce, "_options", sizeof("_options")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	phalcon_config_exception_ce = zend_register_internal_class_ex(&ce59, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_config_adapter_ini_ce = zend_register_internal_class_ex(&ce60, NULL, "phalcon_config" TSRMLS_CC);
	...
	phalcon_cache_exception_ce = zend_register_internal_class_ex(&ce61, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_acl_exception_ce = zend_register_internal_class_ex(&ce62, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_view_exception_ce = zend_register_internal_class_ex(&ce63, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_paginator_exception_ce = zend_register_internal_class_ex(&ce64, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_tag_exception_ce = zend_register_internal_class_ex(&ce65, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_internal_test_ce = zend_register_internal_class_ex(&ce66, NULL, "phalcon_internal_testparent" TSRMLS_CC);
	...
	phalcon_db_exception_ce = zend_register_internal_class_ex(&ce67, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_db_adapter_mysql_ce = zend_register_internal_class_ex(&ce68, NULL, "phalcon_db" TSRMLS_CC);
	...
	phalcon_model_validator_uniqueness_ce = zend_register_internal_class_ex(&ce69, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_validator_exclusionin_ce = zend_register_internal_class_ex(&ce70, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_validator_regex_ce = zend_register_internal_class_ex(&ce71, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_validator_inclusionin_ce = zend_register_internal_class_ex(&ce72, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_validator_numericality_ce = zend_register_internal_class_ex(&ce73, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_validator_email_ce = zend_register_internal_class_ex(&ce74, NULL, "phalcon_model_validator" TSRMLS_CC);
	...
	phalcon_model_exception_ce = zend_register_internal_class_ex(&ce75, NULL, "phalcon_exception" TSRMLS_CC);
	...
	phalcon_transaction_failed_ce = zend_register_internal_class_ex(&ce76, NULL, "exception" TSRMLS_CC);
	...
	phalcon_logger_exception_ce = zend_register_internal_class_ex(&ce77, NULL, "phalcon_exception" TSRMLS_CC);
