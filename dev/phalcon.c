...
PHP_MINIT_FUNCTION(phalcon){
	...
	phalcon_internal_testtemp_class_entry = zend_register_internal_class(&ce16 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce17, "Phalcon_Internal_TestDummy", phalcon_internal_testdummy_functions);
	phalcon_internal_testdummy_class_entry = zend_register_internal_class(&ce17 TSRMLS_CC);
	...
	phalcon_paginator_class_entry = zend_register_internal_class(&ce19 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce20, "Phalcon_Utils", phalcon_utils_functions);
	phalcon_utils_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce21, "Phalcon_Dispatcher", phalcon_dispatcher_functions);
	phalcon_dispatcher_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	phalcon_db_profiler_class_entry = zend_register_internal_class(&ce23 TSRMLS_CC);
	...
	phalcon_db_column_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	phalcon_db_index_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);
	...
	phalcon_db_dialect_mysql_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce30, "Phalcon_Model_Query", phalcon_model_query_functions);
	phalcon_model_query_class_entry = zend_register_internal_class(&ce30 TSRMLS_CC);
	...
	phalcon_model_base_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	phalcon_model_validator_class_entry = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	phalcon_model_row_class_entry = zend_register_internal_class(&ce33 TSRMLS_CC);
	...
	phalcon_model_sanitize_class_entry = zend_register_internal_class(&ce34 TSRMLS_CC);
