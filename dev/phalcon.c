...
PHP_MINIT_FUNCTION(phalcon){
	...
	zend_declare_property_null(phalcon_controller_front_class_entry, "_controllerDir", sizeof("_controllerDir")-1, ZEND_ACC_PRIVATE TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce9, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce9 TSRMLS_CC);
	...
	phalcon_controller_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce21, "Phalcon_Model_Message", phalcon_model_message_functions);
	phalcon_model_message_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Model_Manager", phalcon_model_manager_functions);
	phalcon_model_manager_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce23, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_class_entry = zend_register_internal_class(&ce23 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce25, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce26, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce26 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce27, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Tag", phalcon_tag_functions);
	phalcon_tag_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce29, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_class_entry, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Internal_Test", phalcon_internal_test_functions);
	phalcon_internal_test_class_entry = zend_register_internal_class_ex(&ce33, NULL, "phalcon_internal_testparent" TSRMLS_CC);
