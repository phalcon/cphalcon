...
PHP_MINIT_FUNCTION(phalcon){
	...
	zend_class_entry ce0, ce1, ce2, ce3, ce4, ce5, ce6, ce7, ce8, ce9, ce10, ce11, ce12, ce13, ce14, ce15, ce16, ce17, ce18, ce19, ce20, ce21, ce22, ce23, ce24, ce25, ce26, ce27, ce28, ce29, ce30, ce31, ce32, ce33, ce34, ce35, ce36, ce37, ce38, ce39, ce40, ce41, ce42, ce43, ce44, ce45, ce46;
	...
	INIT_CLASS_ENTRY(ce3, "Phalcon_Cache", phalcon_cache_functions);
	phalcon_cache_class_entry = zend_register_internal_class(&ce3 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce4, "Phalcon_Controller_Front", phalcon_controller_front_functions);
	phalcon_controller_front_class_entry = zend_register_internal_class(&ce4 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce7, "Phalcon_Test", phalcon_test_functions);
	phalcon_test_class_entry = zend_register_internal_class(&ce7 TSRMLS_CC);
	zend_declare_property_null(phalcon_test_class_entry, "p", sizeof("p")-1, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	INIT_CLASS_ENTRY(ce8, "Phalcon_Utils", phalcon_utils_functions);
	phalcon_utils_class_entry = zend_register_internal_class(&ce8 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce9, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce9 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce10, "Phalcon_Internal_TestTemp", phalcon_internal_testtemp_functions);
	phalcon_internal_testtemp_class_entry = zend_register_internal_class(&ce10 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce11, "Phalcon_Internal_TestDummy", phalcon_internal_testdummy_functions);
	phalcon_internal_testdummy_class_entry = zend_register_internal_class(&ce11 TSRMLS_CC);
	zend_declare_property_null(phalcon_internal_testdummy_class_entry, "_d1", sizeof("_d1")-1, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce12, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce12 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce18, "Phalcon_Logger", phalcon_logger_functions);
	phalcon_logger_class_entry = zend_register_internal_class(&ce18 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce19, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce19 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce20, "Phalcon_Filter", phalcon_filter_functions);
	phalcon_filter_class_entry = zend_register_internal_class(&ce20 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce21, "Phalcon_Transaction", phalcon_transaction_functions);
	phalcon_transaction_class_entry = zend_register_internal_class(&ce21 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce22, "Phalcon_Transaction_Manager", phalcon_transaction_manager_functions);
	phalcon_transaction_manager_class_entry = zend_register_internal_class(&ce22 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce24, "Phalcon_Controller", phalcon_controller_functions);
	phalcon_controller_class_entry = zend_register_internal_class(&ce24 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce25, "Phalcon_Model_Message", phalcon_model_message_functions);
	phalcon_model_message_class_entry = zend_register_internal_class(&ce25 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce27, "Phalcon_Model_MetaData", phalcon_model_metadata_functions);
	phalcon_model_metadata_class_entry = zend_register_internal_class(&ce27 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce28, "Phalcon_Model_Row", phalcon_model_row_functions);
	phalcon_model_row_class_entry = zend_register_internal_class(&ce28 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce29, "Phalcon_Model_Base", phalcon_model_base_functions);
	phalcon_model_base_class_entry = zend_register_internal_class(&ce29 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce30, "Phalcon_Model_MetaData_Memory", phalcon_model_metadata_memory_functions);
	phalcon_model_metadata_memory_class_entry = zend_register_internal_class(&ce30 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce31, "Phalcon_Model_Resultset", phalcon_model_resultset_functions);
	phalcon_model_resultset_class_entry = zend_register_internal_class(&ce31 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce32, "Phalcon_Tag", phalcon_tag_functions);
	phalcon_tag_class_entry = zend_register_internal_class(&ce32 TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce33, "Phalcon_Exception", phalcon_exception_functions);
	phalcon_exception_class_entry = zend_register_internal_class_ex(&ce33, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce34, "Phalcon_Internal_TestParent", phalcon_internal_testparent_functions);
	phalcon_internal_testparent_class_entry = zend_register_internal_class(&ce34 TSRMLS_CC);
	zend_declare_property_long(phalcon_internal_testparent_class_entry, "_pp0", sizeof("_pp0")-1, 0, ZEND_ACC_PRIVATE TSRMLS_CC);

	INIT_CLASS_ENTRY(ce35, "Phalcon_Db", phalcon_db_functions);
	phalcon_db_class_entry = zend_register_internal_class(&ce35 TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_descriptor", sizeof("_descriptor")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_null(phalcon_db_class_entry, "_fetchMode", sizeof("_fetchMode")-1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_autoCommit", sizeof("_autoCommit")-1, 1, ZEND_ACC_PROTECTED TSRMLS_CC);
	zend_declare_property_bool(phalcon_db_class_entry, "_idConnection", sizeof("_idConnection")-1, 0, ZEND_ACC_PROTECTED TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce36, "Phalcon_Config", phalcon_config_functions);
	phalcon_config_class_entry = zend_register_internal_class(&ce36 TSRMLS_CC);

	INIT_CLASS_ENTRY(ce37, "Phalcon_Cache_Exception", phalcon_cache_exception_functions);
	phalcon_cache_exception_class_entry = zend_register_internal_class_ex(&ce37, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce38, "Phalcon_Internal_Test", phalcon_internal_test_functions);
	phalcon_internal_test_class_entry = zend_register_internal_class_ex(&ce38, NULL, "phalcon_internal_testparent" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce40, "Phalcon_Db_Exception", phalcon_db_exception_functions);
	phalcon_db_exception_class_entry = zend_register_internal_class_ex(&ce40, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce41, "Phalcon_Db_Mysql", phalcon_db_mysql_functions);
	phalcon_db_mysql_class_entry = zend_register_internal_class_ex(&ce41, NULL, "phalcon_db" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce42, "Phalcon_Transaction_Failed", phalcon_transaction_failed_functions);
	phalcon_transaction_failed_class_entry = zend_register_internal_class_ex(&ce42, NULL, "exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce43, "Phalcon_Config_Adapter_Ini", phalcon_config_adapter_ini_functions);
	phalcon_config_adapter_ini_class_entry = zend_register_internal_class_ex(&ce43, NULL, "phalcon_config" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce44, "Phalcon_Config_Exception", phalcon_config_exception_functions);
	phalcon_config_exception_class_entry = zend_register_internal_class_ex(&ce44, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce45, "Phalcon_Model_Exception", phalcon_model_exception_functions);
	phalcon_model_exception_class_entry = zend_register_internal_class_ex(&ce45, NULL, "phalcon_exception" TSRMLS_CC);
	...
	INIT_CLASS_ENTRY(ce46, "Phalcon_View_Exception", phalcon_view_exception_functions);
	phalcon_view_exception_class_entry = zend_register_internal_class_ex(&ce46, NULL, "phalcon_exception" TSRMLS_CC);
