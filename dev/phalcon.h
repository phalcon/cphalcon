...
extern zend_class_entry *phalcon_mvc_user_ce;
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, tableOptions);
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_user_setdi, 0, 0, 1)
	ZEND_ARG_INFO(0, dependencyInjector)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_user_seteventsmanager, 0, 0, 1)
	ZEND_ARG_INFO(0, eventsManager)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_user___get, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_pdo_sqlite_tableoptions, 0, 0, 1)
	ZEND_ARG_INFO(0, tableName)
	ZEND_ARG_INFO(0, schemaName)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_dialect_sqlite__describeindexes, 0, 0, 1)
	ZEND_ARG_INFO(0, indexName)
ZEND_END_ARG_INFO()
...
PHALCON_INIT_FUNCS(phalcon_mvc_user_method_entry){
	PHP_ME(Phalcon_Mvc_User, setDI, arginfo_phalcon_mvc_user_setdi, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_User, getDI, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_User, setEventsManager, arginfo_phalcon_mvc_user_seteventsmanager, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_User, getEventsManager, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_User, __get, arginfo_phalcon_mvc_user___get, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_FUNCS(phalcon_mvc_dispatcher_method_entry){
	...
	PHP_ME(Phalcon_Mvc_Dispatcher, getEventsManager, NULL, ZEND_ACC_PUBLIC)
...
PHALCON_INIT_FUNCS(phalcon_mvc_model_resultset_complex_method_entry){
	...
	PHP_ME(Phalcon_Mvc_Model_Resultset_Complex, current, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_FUNCS(phalcon_mvc_model_resultset_simple_method_entry){
	...
	PHP_ME(Phalcon_Mvc_Model_Resultset_Simple, current, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_FUNCS(phalcon_db_adapter_pdo_sqlite_method_entry){
	...
	PHP_ME(Phalcon_Db_Adapter_Pdo_Sqlite, tableOptions, arginfo_phalcon_db_adapter_pdo_sqlite_tableoptions, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
...
PHALCON_INIT_FUNCS(phalcon_db_dialect_postgresql_method_entry){
	...
	PHP_ME(Phalcon_Db_Dialect_Postgresql, createTable, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
...
PHALCON_INIT_FUNCS(phalcon_db_dialect_sqlite_method_entry){
	PHP_ME(Phalcon_Db_Dialect_Sqlite, getColumnList, arginfo_phalcon_db_dialect_sqlite_getcolumnlist, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, getColumnDefinition, arginfo_phalcon_db_dialect_sqlite_getcolumndefinition, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, addColumn, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, modifyColumn, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, dropColumn, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, addIndex, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, dropIndex, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, addPrimaryKey, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, dropPrimaryKey, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, addForeignKey, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, dropForeignKey, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, _getTableOptions, NULL, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, createTable, NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, dropTable, arginfo_phalcon_db_dialect_sqlite_droptable, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, tableExists, arginfo_phalcon_db_dialect_sqlite_tableexists, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, describeColumns, arginfo_phalcon_db_dialect_sqlite_describecolumns, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, listTables, arginfo_phalcon_db_dialect_sqlite_listtables, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, describeIndexes, arginfo_phalcon_db_dialect_sqlite_describeindexes, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, _describeIndexes, arginfo_phalcon_db_dialect_sqlite__describeindexes, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, describeReferences, arginfo_phalcon_db_dialect_sqlite_describereferences, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Db_Dialect_Sqlite, tableOptions, arginfo_phalcon_db_dialect_sqlite_tableoptions, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_FE_END
};
