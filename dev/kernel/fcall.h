...
extern int phalcon_call_method_params(zval *return_value, zval *object, char *method_name, int method_len, int param_count, zval *params[], int check, int noreturn TSRMLS_DC);
...
extern int phalcon_call_parent_func_params(zval *return_value, zval *object, char *active_class, int active_class_len, char *method_name, int method_len, int param_count, zval *params[], int noreturn TSRMLS_DC);

extern int phalcon_call_self_func(zval *return_value, zval *object, char *method_name, int method_len, int noreturn TSRMLS_DC);
extern int phalcon_call_self_func_params(zval *return_value, zval *object, char *method_name, int method_len, int param_count, zval *params[], int noreturn TSRMLS_DC);
...
extern int phalcon_call_static_func_params(zval *return_value, char *class_name, int class_name_len, char *method_name, int method_len, int param_count, zval *params[], int noreturn TSRMLS_DC);
extern int phalcon_call_static_zval_func_params(zval *return_value, zval *mixed_name, char *method_name, int method_len, int param_count, zval *params[], int noreturn TSRMLS_DC);
