	...
	FOREACH_KV(v1, ac0, fes28, fee28, ah0, hp0, v3, v2)
		...
		if (Z_TYPE_P(v2) == IS_ARRAY) { 
			...
			if (zend_is_true(r1)) {
				...
				p1[1] = v2;
				phalcon_debug_param(v2 TSRMLS_CC);
				PHALCON_CALL_FUNC_PARAMS(r2, "explode", strlen("explode"), 2, p1);
...
PHP_METHOD(Phalcon_Internal_Test, f1){
	...
	PHALCON_CALL_FUNC_PARAMS(r0, "strlen", strlen("strlen"), 1, p0);
...
PHP_METHOD(Phalcon_Internal_Test, f2){
	...
	ZVAL_STRING(p0[1], "\t", 1);
	PHALCON_CALL_FUNC_PARAMS(r0, "rtrim", strlen("rtrim"), 2, p0);
...
PHP_METHOD(Phalcon_Internal_Test, f4){
	...
	PHALCON_CALL_FUNC_PARAMS(r1, "strlen", strlen("strlen"), 1, p1);
	phalcon_debug_vdump("strlen > ", r1 TSRMLS_CC);
	p0[1] = r1;
	phalcon_debug_param(r1 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS(r0, "str_repeat", strlen("str_repeat"), 2, p0);
...
PHP_METHOD(Phalcon_Internal_Test, f5){
	...
	PHALCON_CALL_FUNC_PARAMS_NORETURN("asort", strlen("asort"), 1, p0);
	phalcon_debug_vdump("Returning > ", v0 TSRMLS_CC);
	phalcon_step_out_entry();
	{
		zend_uchar is_ref = Z_ISREF_P(return_value);
...
PHP_METHOD(Phalcon_Internal_Test, f6){
	...
	PHALCON_CALL_FUNC_PARAMS(r0, "mt_rand", strlen("mt_rand"), 2, p0);
	...
	PHALCON_CALL_FUNC_PARAMS(r2, "fopen", strlen("fopen"), 2, p1);
	...
	PHALCON_CALL_FUNC_PARAMS_NORETURN("fwrite", strlen("fwrite"), 2, p2);
	phalcon_step_over("Phalcon_Internal_Test::f6 (FunctionCall) File=/Internal/Test Line=651");
	Z_ADDREF_P(v1);
	p3[0] = v1;
	phalcon_debug_param(v1 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_NORETURN("fclose", strlen("fclose"), 1, p3);
	phalcon_step_over("Phalcon_Internal_Test::f6 (Assignment) File=/Internal/Test Line=652");
	PHALCON_ALLOC_ZVAL(r3);
	p4[0] = v0;
	phalcon_debug_param(v0 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS(r3, "file_get_contents", strlen("file_get_contents"), 1, p4);
	...
	p5[0] = v0;
	phalcon_debug_param(v0 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_NORETURN("unlink", strlen("unlink"), 1, p5);
	phalcon_debug_vdump("Returning > ", v2 TSRMLS_CC);
	phalcon_step_out_entry();
...
PHP_METHOD(Phalcon_Internal_Test, f7){
	...
	PHALCON_CALL_FUNC_PARAMS(r0, "sqrt", strlen("sqrt"), 1, p0);
...
PHP_METHOD(Phalcon_Internal_Test, f9){
	...
	p0[0] = v0;
	phalcon_debug_param(v0 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS(r2, "abs", strlen("abs"), 1, p0);
...
PHP_METHOD(Phalcon_Internal_Test, t4){
	...
	if (zend_is_true(r0)) {
		...
		p0[0] = v1;
		phalcon_debug_param(v1 TSRMLS_CC);
		PHALCON_CALL_FUNC_PARAMS(r1, "sqrt", strlen("sqrt"), 1, p0);
...
PHP_METHOD(Phalcon_Internal_Test, t9){
	...
	p1[2] = v4;
	phalcon_debug_param(v4 TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS(r3, "str_replace", strlen("str_replace"), 3, p1);
...
PHP_METHOD(Phalcon_Internal_Test, t11){
	...
	phalcon_step_over("Phalcon_Internal_Test::t11 (Echo) File=/Internal/Test Line=1446");
	if (!t1) {
		PHALCON_ALLOC_ZVAL(t1);
	} else {
		if (Z_REFCOUNT_P(t1) > 1) {
	...
	phalcon_step_over("Phalcon_Internal_Test::t11 (If) File=/Internal/Test Line=1447");
	if (!t3) {
		PHALCON_ALLOC_ZVAL(t3);
	} else {
		if (Z_REFCOUNT_P(t3) > 1) {
	...
	if (zend_is_true(r1)) {
		phalcon_step_over("Phalcon_Internal_Test::t11 (Block) File=/Internal/Test Line=1447");
		phalcon_step_over("Phalcon_Internal_Test::t11 (MethodCall) File=/Internal/Test Line=1448");
		phalcon_assert_class(this_ptr, "Phalcon_Internal_Test" TSRMLS_CC);
	...
	phalcon_step_over("Phalcon_Internal_Test::t11 (PostIncDecOp) File=/Internal/Test Line=1450");
	{
		zval *orig_ptr = v0;
		if (Z_REFCOUNT_P(orig_ptr) > 1) {
			ALLOC_ZVAL(v0);
	...
	phalcon_step_over("Phalcon_Internal_Test::t11 (If) File=/Internal/Test Line=1451");
	if (!t4) {
		PHALCON_ALLOC_ZVAL(t4);
	} else {
		if (Z_REFCOUNT_P(t4) > 1) {
	...
	if (zend_is_true(r2)) {
		phalcon_step_over("Phalcon_Internal_Test::t11 (Block) File=/Internal/Test Line=1451");
		phalcon_step_over("Phalcon_Internal_Test::t11 (Assignment) File=/Internal/Test Line=1452");
