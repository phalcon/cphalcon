...
PHP_METHOD(Phalcon_Internal_Test, a4){
	...
	if (Z_REFCOUNT_P(t1) > 1) {
		phalcon_array_update_long(&b, 1, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t1);
	if (Z_TYPE_P(t1) != IS_ARRAY) {
		convert_to_array(t1);
		phalcon_array_update_long(&b, 1, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t1) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t2);
	...
	if (Z_REFCOUNT_P(t2) > 1) {
		phalcon_array_update_string(&t1, "LOL", strlen("LOL"), t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t2);
	if (Z_TYPE_P(t2) != IS_ARRAY) {
		convert_to_array(t2);
		phalcon_array_update_string(&t1, "LOL", strlen("LOL"), t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t2) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t3);
	...
	if (Z_REFCOUNT_P(t3) > 1) {
		phalcon_array_update_long(&t2, 5, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t3);
	if (Z_TYPE_P(t3) != IS_ARRAY) {
		convert_to_array(t3);
		phalcon_array_update_long(&t2, 5, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, a6){
	...
	if (Z_REFCOUNT_P(t1) > 1) {
		phalcon_array_update_long(&a, 1, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t1);
	if (Z_TYPE_P(t1) != IS_ARRAY) {
		convert_to_array(t1);
		phalcon_array_update_long(&a, 1, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, a7){
	...
	if (Z_REFCOUNT_P(t2) > 1) {
		phalcon_array_update_long(&a, 1, t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t2);
	if (Z_TYPE_P(t2) != IS_ARRAY) {
		convert_to_array(t2);
		phalcon_array_update_long(&a, 1, t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (Z_REFCOUNT_P(t7) > 1) {
		phalcon_array_update_long(&b, 1, t7, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t7);
	if (Z_TYPE_P(t7) != IS_ARRAY) {
		convert_to_array(t7);
		phalcon_array_update_long(&b, 1, t7, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (Z_REFCOUNT_P(t8) > 1) {
		phalcon_array_update_long(&c, 0, t8, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t8);
	if (Z_TYPE_P(t8) != IS_ARRAY) {
		convert_to_array(t8);
		phalcon_array_update_long(&c, 0, t8, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (Z_REFCOUNT_P(t9) > 1) {
		phalcon_array_update_long(&c, 0, t9, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t9);
	if (Z_TYPE_P(t9) != IS_ARRAY) {
		convert_to_array(t9);
		phalcon_array_update_long(&c, 0, t9, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t9) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t10);
	...
	if (Z_REFCOUNT_P(t10) > 1) {
		phalcon_array_update_long(&t9, 0, t10, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t10);
	if (Z_TYPE_P(t10) != IS_ARRAY) {
		convert_to_array(t10);
		phalcon_array_update_long(&t9, 0, t10, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (Z_REFCOUNT_P(t12) > 1) {
		phalcon_array_update_long(&c, 0, t12, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t12);
	if (Z_TYPE_P(t12) != IS_ARRAY) {
		convert_to_array(t12);
		phalcon_array_update_long(&c, 0, t12, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t12) == IS_ARRAY) {
	...
	if (Z_REFCOUNT_P(t13) > 1) {
		phalcon_array_update_long(&t12, 0, t13, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t13);
	if (Z_TYPE_P(t13) != IS_ARRAY) {
		convert_to_array(t13);
		phalcon_array_update_long(&t12, 0, t13, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t13) == IS_ARRAY) {
	...
	if (Z_REFCOUNT_P(t14) > 1) {
		phalcon_array_update_long(&t13, 0, t14, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t14);
	if (Z_TYPE_P(t14) != IS_ARRAY) {
		convert_to_array(t14);
		phalcon_array_update_long(&t13, 0, t14, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
		...
		if (Z_TYPE_P(v) == IS_ARRAY) { 
			if (phalcon_valid_foreach(v TSRMLS_CC)) {
				...
				if (Z_REFCOUNT_P(t0) > 1) {
					phalcon_array_update(&f, k, t0, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
				}
				Z_ADDREF_P(t0);
				if (Z_TYPE_P(t0) != IS_ARRAY) {
					convert_to_array(t0);
					phalcon_array_update(&f, k, t0, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
				}
...
PHP_METHOD(Phalcon_Internal_Test, a17){
	...
	phalcon_array_update_string(&a2, "1", strlen("1"), a4, PHALCON_SEPARATE_PLZ, PHALCON_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	PHALCON_INIT_VAR(a5);
	array_init(a5);
	add_next_index_stringl(a5, "hello3", strlen("hello3"), 1);
	phalcon_array_update_string(&a2, "2", strlen("2"), a5, PHALCON_SEPARATE_PLZ, PHALCON_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	PHALCON_CPY_WRT(b, a2);
...
PHP_METHOD(Phalcon_Internal_Test, a18){
	...
	if (Z_REFCOUNT_P(t1) > 1) {
		phalcon_array_update_long(&c, 0, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t1);
	if (Z_TYPE_P(t1) != IS_ARRAY) {
		convert_to_array(t1);
		phalcon_array_update_long(&c, 0, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, a21){
	...
	if (Z_REFCOUNT_P(t3) > 1) {
		phalcon_array_update(&a, b, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t3);
	if (Z_TYPE_P(t3) != IS_ARRAY) {
		convert_to_array(t3);
		phalcon_array_update(&a, b, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t3) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t4);
	...
	if (Z_REFCOUNT_P(t4) > 1) {
		phalcon_array_update(&t3, c, t4, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t4);
	if (Z_TYPE_P(t4) != IS_ARRAY) {
		convert_to_array(t4);
		phalcon_array_update(&t3, c, t4, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t4) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t5);
	...
	if (Z_REFCOUNT_P(t5) > 1) {
		phalcon_array_update(&t4, d, t5, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t5);
	if (Z_TYPE_P(t5) != IS_ARRAY) {
		convert_to_array(t5);
		phalcon_array_update(&t4, d, t5, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t5) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t6);
	...
	if (Z_REFCOUNT_P(t6) > 1) {
		phalcon_array_update(&t5, e, t6, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t6);
	if (Z_TYPE_P(t6) != IS_ARRAY) {
		convert_to_array(t6);
		phalcon_array_update(&t5, e, t6, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t6) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t7);
	...
	if (Z_REFCOUNT_P(t7) > 1) {
		phalcon_array_update(&t6, f, t7, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t7);
	if (Z_TYPE_P(t7) != IS_ARRAY) {
		convert_to_array(t7);
		phalcon_array_update(&t6, f, t7, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t7) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t8);
	...
	if (Z_REFCOUNT_P(t8) > 1) {
		phalcon_array_update(&t7, g, t8, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t8);
	if (Z_TYPE_P(t8) != IS_ARRAY) {
		convert_to_array(t8);
		phalcon_array_update(&t7, g, t8, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, a23){
	...
	if (phalcon_valid_foreach(e TSRMLS_CC)) {
		...
		if (Z_TYPE_P(v) == IS_ARRAY) { 
			...
			PHALCON_INIT_VAR(c0);
			ZVAL_STRING(c0, ".", 1);
			PHALCON_CALL_FUNC_PARAMS_2(r0, "strpos", c0, v, 0x00A);
			if (Z_TYPE_P(r0) != IS_BOOL || (Z_TYPE_P(r0) == IS_BOOL && Z_BVAL_P(r0))) {
				PHALCON_INIT_VAR(r1);
				PHALCON_INIT_VAR(c1);
				ZVAL_STRING(c1, ".", 1);
				PHALCON_CALL_FUNC_PARAMS_2(r1, "explode", c1, v, 0x005);
				...
				if (Z_REFCOUNT_P(t1) > 1) {
					phalcon_array_update(&f, k, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
				}
				Z_ADDREF_P(t1);
				if (Z_TYPE_P(t1) != IS_ARRAY) {
					convert_to_array(t1);
					phalcon_array_update(&f, k, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
				}
				PHALCON_INIT_VAR(r3);
...
PHP_METHOD(Phalcon_Internal_Test, a25){
	...
	if (Z_REFCOUNT_P(t1) > 1) {
		phalcon_array_update(&t0, a, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t1);
	if (Z_TYPE_P(t1) != IS_ARRAY) {
		convert_to_array(t1);
		phalcon_array_update(&t0, a, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, sa4){
	...
	if (Z_REFCOUNT_P(t3) > 1) {
		phalcon_array_update_long(&t2, 0, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t3);
	if (Z_TYPE_P(t3) != IS_ARRAY) {
		convert_to_array(t3);
		phalcon_array_update_long(&t2, 0, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (Z_REFCOUNT_P(t6) > 1) {
		phalcon_array_update_long(&t5, 0, t6, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t6);
	if (Z_TYPE_P(t6) != IS_ARRAY) {
		convert_to_array(t6);
		phalcon_array_update_long(&t5, 0, t6, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Internal_Test, sa5){
	...
	if (Z_REFCOUNT_P(t2) > 1) {
		phalcon_array_update_long(&t1, 1, t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t2);
	if (Z_TYPE_P(t2) != IS_ARRAY) {
		convert_to_array(t2);
		phalcon_array_update_long(&t1, 1, t2, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	if (Z_TYPE_P(t2) == IS_ARRAY) {
		PHALCON_ALLOC_ZVAL_MM(t3);
	...
	if (Z_REFCOUNT_P(t3) > 1) {
		phalcon_array_update_long(&t2, 2, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
	}
	Z_ADDREF_P(t3);
	if (Z_TYPE_P(t3) != IS_ARRAY) {
		convert_to_array(t3);
		phalcon_array_update_long(&t2, 2, t3, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
	}
	...
	if (phalcon_valid_foreach(e TSRMLS_CC)) {
		...
		if (Z_TYPE_P(v) == IS_ARRAY) { 
			if (phalcon_valid_foreach(v TSRMLS_CC)) {
				...
				if (Z_REFCOUNT_P(t1) > 1) {
					phalcon_array_update(&t0, k, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_CTOR TSRMLS_CC);
				}
				Z_ADDREF_P(t1);
				if (Z_TYPE_P(t1) != IS_ARRAY) {
					convert_to_array(t1);
					phalcon_array_update(&t0, k, t1, PHALCON_NO_SEPARATE_THX, PHALCON_NO_COPY, PHALCON_NO_CTOR TSRMLS_CC);
				}
...
PHP_METHOD(Phalcon_Internal_Test, f2){
	...
	PHALCON_INIT_VAR(c1);
	ZVAL_STRING(c1, "\t", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "rtrim", c0, c1, 0x01D);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f4){
	...
	PHALCON_CALL_FUNC_PARAMS_2(r0, "str_repeat", c0, r1, 0x01E);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f5){
	...
	PHALCON_CPY_WRT(e, a0);
	Z_SET_ISREF_P(e);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("asort", e, 0x01F);
	Z_UNSET_ISREF_P(e);
	PHALCON_RETURN_CTOR(e);
}
...
PHP_METHOD(Phalcon_Internal_Test, f6){
	...
	PHALCON_INIT_VAR(c1);
	ZVAL_LONG(c1, 100);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mt_rand", c0, c1, 0x020);
	PHALCON_ALLOC_ZVAL_MM(r1);
	...
	PHALCON_INIT_VAR(c2);
	ZVAL_STRING(c2, "w", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r2, "fopen", file, c2, 0x021);
	PHALCON_CPY_WRT(fp, r2);
	Z_ADDREF_P(fp);
	PHALCON_INIT_VAR(c3);
	ZVAL_STRING(c3, "morelol\n", 1);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("fwrite", fp, c3, 0x022);
	Z_DELREF_P(fp);
	Z_ADDREF_P(fp);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("fclose", fp, 0x023);
	Z_DELREF_P(fp);
	PHALCON_ALLOC_ZVAL_MM(r3);
	PHALCON_CALL_FUNC_PARAMS_1(r3, "file_get_contents", file, 0x016);
	PHALCON_CPY_WRT(content, r3);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("unlink", file, 0x024);
...
PHP_METHOD(Phalcon_Internal_Test, f7){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "sqrt", c0, 0x025);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f9){
	...
	PHALCON_ALLOC_ZVAL_MM(r2);
	Z_ADDREF_P(e);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "abs", e, 0x026);
	Z_DELREF_P(e);
...
PHP_METHOD(Phalcon_Internal_Test, f10){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	phalcon_array_fetch_long(&r1, a, 0, PHALCON_NOISY TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_numeric", r1, 0x027);
	if (zend_is_true(r0)) {
		PHALCON_MM_RESTORE();
		RETURN_TRUE;
	} else {
...
PHP_METHOD(Phalcon_Internal_Test, t4){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "sqrt", b, 0x025);
		PHALCON_ALLOC_ZVAL_MM(r2);
		phalcon_add_function(r2, r1, a TSRMLS_CC);
		PHALCON_RETURN_CTOR(r2);
	}
...
PHP_METHOD(Phalcon_Internal_Test, t9){
	...
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "count", not_null, 0x007);
...
PHP_METHOD(Phalcon_Internal_Test, t12){
	...
	PHALCON_INIT_VAR(c0);
	ZVAL_STRING(c0, "/", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "explode", c0, uri, 0x005);
...
PHP_METHOD(Phalcon_Internal_Test, t17){
	...
	PHALCON_INIT_VAR(c2);
	ZVAL_STRING(c2, "", 1);
	PHALCON_CALL_FUNC_PARAMS_3_NORETURN("mysql_connect", c0, c1, c2, 0x02A);
	PHALCON_INIT_VAR(c3);
	ZVAL_STRING(c3, "phalcon_test", 1);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("mysql_select_db", c3, 0x02B);
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_INIT_VAR(c4);
	ZVAL_STRING(c4, "SELECT * FROM robots", 1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_query", c4, 0x02C);
	PHALCON_CPY_WRT(result_query, r0);
	ws_fdd7_33:
	PHALCON_INIT_VAR(r1);
	Z_ADDREF_P(result_query);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "mysql_fetch_array", result_query, 0x02D);
