...
PHP_METHOD(Phalcon_Internal_Test, f1){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "strlen", c0, 0x01F);
...
PHP_METHOD(Phalcon_Internal_Test, f2){
	...
	PHALCON_INIT_VAR(c1);
	ZVAL_STRING(c1, "\t", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "rtrim", c0, c1, 0x020);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f4){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r1, "strlen", c1, 0x01F);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "str_repeat", c0, r1, 0x021);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f5){
	...
	PHALCON_CPY_WRT(v0, a0);
	Z_SET_ISREF_P(v0);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("asort", v0, 0x022);
	Z_UNSET_ISREF_P(v0);
	PHALCON_RETURN_CTOR(v0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f6){
	...
	PHALCON_INIT_VAR(c1);
	ZVAL_LONG(c1, 100);
	PHALCON_CALL_FUNC_PARAMS_2(r0, "mt_rand", c0, c1, 0x023);
	PHALCON_ALLOC_ZVAL_MM(r1);
	...
	PHALCON_INIT_VAR(c2);
	ZVAL_STRING(c2, "w", 1);
	PHALCON_CALL_FUNC_PARAMS_2(r2, "fopen", v0, c2, 0x024);
	PHALCON_CPY_WRT(v1, r2);
	Z_ADDREF_P(v1);
	PHALCON_INIT_VAR(c3);
	ZVAL_STRING(c3, "morelol\n", 1);
	PHALCON_CALL_FUNC_PARAMS_2_NORETURN("fwrite", v1, c3, 0x025);
	Z_DELREF_P(v1);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("fclose", v1, 0x026);
	Z_DELREF_P(v1);
	PHALCON_ALLOC_ZVAL_MM(r3);
	PHALCON_CALL_FUNC_PARAMS_1(r3, "file_get_contents", v0, 0x006);
	PHALCON_CPY_WRT(v2, r3);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("unlink", v0, 0x027);
...
PHP_METHOD(Phalcon_Internal_Test, f7){
	...
	PHALCON_CALL_FUNC_PARAMS_1(r0, "sqrt", c0, 0x028);
	PHALCON_RETURN_DZVAL(r0);
}
...
PHP_METHOD(Phalcon_Internal_Test, f9){
	...
	PHALCON_ALLOC_ZVAL_MM(r2);
	Z_ADDREF_P(v0);
	PHALCON_CALL_FUNC_PARAMS_1(r2, "abs", v0, 0x029);
	Z_DELREF_P(v0);
...
PHP_METHOD(Phalcon_Internal_Test, f10){
	...
	PHALCON_ALLOC_ZVAL_MM(r1);
	phalcon_array_fetch_long(&r1, v0, 0, PHALCON_NOISY_FETCH TSRMLS_CC);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "is_numeric", r1, 0x02A);
	if (zend_is_true(r0)) {
		PHALCON_MM_RESTORE();
		RETURN_TRUE;
	} else {
...
PHP_METHOD(Phalcon_Internal_Test, t4){
	...
	if (zend_is_true(r0)) {
		...
		PHALCON_ALLOC_ZVAL_MM(r1);
		PHALCON_CALL_FUNC_PARAMS_1(r1, "sqrt", v1, 0x028);
		PHALCON_ALLOC_ZVAL_MM(r2);
		phalcon_add_function(r2, r1, v0 TSRMLS_CC);
		PHALCON_RETURN_CTOR(r2);
	}
...
PHP_METHOD(Phalcon_Internal_Test, t9){
	...
	ZVAL_STRING(p1[1], "", 1);
	p1[2] = v4;
	PHALCON_CALL_FUNC_PARAMS(r3, "str_replace", 3, p1, 0x018);
...
PHP_METHOD(Phalcon_Internal_Test, t17){
	...
	PHALCON_INIT_VAR(p0[2]);
	ZVAL_STRING(p0[2], "", 1);
	PHALCON_CALL_FUNC_PARAMS_NORETURN("mysql_connect", 3, p0, 0x02D);
	PHALCON_INIT_VAR(c0);
	ZVAL_STRING(c0, "phalcon_test", 1);
	PHALCON_CALL_FUNC_PARAMS_1_NORETURN("mysql_select_db", c0, 0x02E);
	PHALCON_ALLOC_ZVAL_MM(r0);
	PHALCON_INIT_VAR(c1);
	ZVAL_STRING(c1, "SELECT * FROM robots", 1);
	PHALCON_CALL_FUNC_PARAMS_1(r0, "mysql_query", c1, 0x02F);
	PHALCON_CPY_WRT(v1, r0);
	ws51:
	PHALCON_INIT_VAR(r1);
	Z_ADDREF_P(v1);
	PHALCON_CALL_FUNC_PARAMS_1(r1, "mysql_fetch_array", v1, 0x030);
	Z_DELREF_P(v1);
	PHALCON_CPY_WRT(v2, r1);
	if (!zend_is_true(v2)) {
		goto we51;
