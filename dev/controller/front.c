...
PHP_METHOD(Phalcon_Controller_Front, dispatchLoop){
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (If) File=/Controller/Front Line=381");
	PHALCON_ALLOC_ZVAL(t0);
	phalcon_read_property(t0, this_ptr, "_dispatcher", sizeof("_dispatcher")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	if (!zend_is_true(t0)) {
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Block) File=/Controller/Front Line=381");
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=382");
		PHALCON_ALLOC_ZVAL(i0);
		...
		phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (MethodCall) File=/Controller/Front Line=384");
		phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
		...
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Block) File=/Controller/Front Line=385");
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=386");
		PHALCON_ALLOC_ZVAL(t3);
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (If) File=/Controller/Front Line=389");
	PHALCON_ALLOC_ZVAL(t4);
	phalcon_read_property(t4, this_ptr, "_request", sizeof("_request")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	if (!zend_is_true(t4)) {
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Block) File=/Controller/Front Line=389");
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=390");
		PHALCON_ALLOC_ZVAL(r0);
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (If) File=/Controller/Front Line=392");
	PHALCON_ALLOC_ZVAL(t5);
	phalcon_read_property(t5, this_ptr, "_response", sizeof("_response")-1, PHALCON_NOISY_FETCH TSRMLS_CC);
	if (!zend_is_true(t5)) {
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Block) File=/Controller/Front Line=392");
		phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=393");
		PHALCON_ALLOC_ZVAL(r1);
	...
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (MethodCall) File=/Controller/Front Line=410");
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=413");
	{
		zval *copy;
		ALLOC_ZVAL(copy);
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (Assignment) File=/Controller/Front Line=415");
	...
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (MethodCall) File=/Controller/Front Line=417");
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	...
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (MethodCall) File=/Controller/Front Line=420");
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	phalcon_debug_method_call(v2, "finish" TSRMLS_CC);
	PHALCON_CALL_METHOD_NORETURN(v2, "finish", PHALCON_CALL_DEFAULT);
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
	phalcon_step_over("Phalcon_Controller_Front::dispatchLoop (MethodCall) File=/Controller/Front Line=422");
	phalcon_assert_class(this_ptr, "Phalcon_Controller_Front" TSRMLS_CC);
