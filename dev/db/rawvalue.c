...
PHP_METHOD(Phalcon_Db_RawValue, __construct){
	...
	phalcon_step_over("Phalcon_Db_RawValue::__construct (Assignment) File=Library/Phalcon/Db/RawValue.php Line=13");
	//$value
	//$this
	{
		zval *copy;
	...
	RETURN_NULL();
	phalcon_step_over("Phalcon_Db_RawValue::__construct (Method) File=Library/Phalcon/Db/RawValue.php Line=16");
}
...
PHP_METHOD(Phalcon_Db_RawValue, getValue){
	...
	return;
	phalcon_step_out_entry();
	phalcon_step_over("Phalcon_Db_RawValue::getValue (Method) File=Library/Phalcon/Db/RawValue.php Line=23");
}
