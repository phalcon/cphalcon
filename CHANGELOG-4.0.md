...
- Fixed `Phalcon\Cli\Task::getEventsManager` and `Phalcon\Cli\Task::setEventsManager` added missing methods caused by `Phalcon\Di\Injectable` changes [#14445](https://github.com/phalcon/cphalcon/pull/14445)
