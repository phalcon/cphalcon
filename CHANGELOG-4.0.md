...
- Fixed `Phalcon\Db\Column` to recognize `tinyint`, `smallint`, `mediumint`, `int` as valid autoIncrement columns. [#14102](https://github.com/phalcon/cphalcon/issues/14102)
