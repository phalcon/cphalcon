...
static PHP_METHOD(Phalcon_Forms_Element, setOption);
static PHP_METHOD(Phalcon_Forms_Element, getOption);
static PHP_METHOD(Phalcon_Forms_Element, setOptions);
static PHP_METHOD(Phalcon_Forms_Element, getOptions);
