...
zend_class_entry *phalcon_utils_adapterinterface_ce;
...
zend_class_entry *phalcon_utils_adapter_ce;
...
static PHP_MINIT_FUNCTION(phalcon)
{
	...
	ZEPHIR_INIT(Phalcon_Utils_AdapterInterface);
	...
	ZEPHIR_INIT(Phalcon_Utils_Adapter);
	...
	ZEPHIR_INIT(Phalcon_Utils);
	ZEPHIR_INIT(Phalcon_Utils_Exception);
	ZEPHIR_INIT(Phalcon_Utils_Slug);
