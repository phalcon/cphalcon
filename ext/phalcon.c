...
zend_class_entry *phalcon_http_jwt_signer_signerinterface_ce;
...
zend_class_entry *phalcon_http_jwt_token_abstractitem_ce;
...
zend_class_entry *phalcon_http_jwt_signer_abstractsigner_ce;
...
zend_class_entry *phalcon_http_jwt_builder_ce;
zend_class_entry *phalcon_http_jwt_exceptions_unsupportedalgorithmexception_ce;
zend_class_entry *phalcon_http_jwt_exceptions_validatorexception_ce;
zend_class_entry *phalcon_http_jwt_signer_hmac_ce;
zend_class_entry *phalcon_http_jwt_signer_none_ce;
zend_class_entry *phalcon_http_jwt_token_enum_ce;
zend_class_entry *phalcon_http_jwt_token_item_ce;
zend_class_entry *phalcon_http_jwt_token_parser_ce;
zend_class_entry *phalcon_http_jwt_token_signature_ce;
zend_class_entry *phalcon_http_jwt_token_token_ce;
zend_class_entry *phalcon_http_jwt_validator_ce;
...
static PHP_MINIT_FUNCTION(phalcon)
{
	...
	ZEPHIR_INIT(Phalcon_Http_JWT_Signer_SignerInterface);
	...
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_AbstractItem);
	...
	ZEPHIR_INIT(Phalcon_Http_JWT_Signer_AbstractSigner);
	...
	ZEPHIR_INIT(Phalcon_Http_JWT_Builder);
	ZEPHIR_INIT(Phalcon_Http_JWT_Exceptions_UnsupportedAlgorithmException);
	ZEPHIR_INIT(Phalcon_Http_JWT_Exceptions_ValidatorException);
	ZEPHIR_INIT(Phalcon_Http_JWT_Signer_Hmac);
	ZEPHIR_INIT(Phalcon_Http_JWT_Signer_None);
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_Enum);
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_Item);
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_Parser);
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_Signature);
	ZEPHIR_INIT(Phalcon_Http_JWT_Token_Token);
	ZEPHIR_INIT(Phalcon_Http_JWT_Validator);
