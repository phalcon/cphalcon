...
ZEPHIR_INIT_CLASS(Phalcon_DI_FactoryDefault_Cli) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\DI\\FactoryDefault, Cli, phalcon_di_factorydefault_cli, "phalcon\\di\\factorydefault", phalcon_di_factorydefault_cli_method_entry, 0);
...
PHP_METHOD(Phalcon_DI_FactoryDefault_Cli, __construct) {
	...
	ZEPHIR_CALL_PARENT_NORETURN("Phalcon\\DI\\FactoryDefault\\Cli", "__construct");
	shared = 1;
	ZEPHIR_INIT_VAR(_0);
	array_init(_0);
	ZEPHIR_INIT_VAR(_1);
