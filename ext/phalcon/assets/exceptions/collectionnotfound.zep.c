...
PHP_METHOD(Phalcon_Assets_Exceptions_CollectionNotFound, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "The collection does not exist in the manager");
	ZEPHIR_CALL_PARENT(NULL, phalcon_assets_exceptions_collectionnotfound_ce, getThis(), "__construct", NULL, 0, &_0);
