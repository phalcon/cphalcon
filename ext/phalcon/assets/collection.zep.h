...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addcss, 0, 1, MAY_BE_STATIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addfilter, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_OBJ_INFO(0, filter, Phalcon\\Assets\\FilterInterface, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addinline, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_OBJ_INFO(0, code, Phalcon\\Assets\\Inline, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addinlinecss, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, content, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, filter, _IS_BOOL, 0, "true")
ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, attributes, IS_ARRAY, 0, "[]")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addinlinejs, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, content, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, filter, _IS_BOOL, 0, "true")
ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, attributes, IS_ARRAY, 0, "[]")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_addjs, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, path, IS_STRING, 0)
	ZEND_ARG_INFO(0, isLocal)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, filter, _IS_BOOL, 0, "true")
ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, attributes, IS_ARRAY, 0, "[]")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_setattributes, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_ARRAY_INFO(0, attributes, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_setautoversion, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, flag, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_setfilters, 0, 1, MAY_BE_STATIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_processadd, 0, 2, MAY_BE_STATIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_processaddinline, 0, 2, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, className, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, content, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, filter, _IS_BOOL, 0, "true")
ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, attributes, IS_ARRAY, 0, "[]")
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_phpfgetcsv, 0, 1, MAY_BE_ARRAY|MAY_BE_FALSE)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_collection_phpfileexists, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_phpfilegetcontents, 0, 1, MAY_BE_FALSE|MAY_BE_STRING)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_phpfileputcontents, 0, 2, MAY_BE_FALSE|MAY_BE_LONG)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_assets_collection_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, mode, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_assets_collection_phpfwrite, 0, 2, MAY_BE_FALSE|MAY_BE_LONG)
	ZEND_ARG_INFO(0, handle)
...
ZEPHIR_INIT_FUNCS(phalcon_assets_collection_method_entry) {
	...
	PHP_ME(Phalcon_Assets_Collection, phpFclose, arginfo_phalcon_assets_collection_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFgetCsv, arginfo_phalcon_assets_collection_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFileExists, arginfo_phalcon_assets_collection_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFileGetContents, arginfo_phalcon_assets_collection_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFilePutContents, arginfo_phalcon_assets_collection_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFopen, arginfo_phalcon_assets_collection_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpFwrite, arginfo_phalcon_assets_collection_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpIsWritable, arginfo_phalcon_assets_collection_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Assets_Collection, phpUnlink, arginfo_phalcon_assets_collection_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
