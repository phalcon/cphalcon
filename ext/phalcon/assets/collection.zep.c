...
PHP_METHOD(Phalcon_Assets_Collection, add)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 353, asset);
...
PHP_METHOD(Phalcon_Assets_Collection, addCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processadd", NULL, 354, &_0, &path_zv, isLocal, &_1, &attributes, &version_zv, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInline)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 353, code);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInlineCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processaddinline", NULL, 355, &_0, &content_zv, &_1, &attributes);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, processAdd)
{
	...
	ZEPHIR_CALL_METHOD(&attrs, this_ptr, "processattributes", NULL, 356, &attributes);
	zephir_check_call_status();
