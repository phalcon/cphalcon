...
PHP_METHOD(Phalcon_Assets_Collection, setAttributes)
{
	...
	zephir_get_arrval(&attributes, attributes_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 403, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setFilters)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 405, &filters);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 406, &prefix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetIsLocal)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &flag_param);
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 407, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 407, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setVersion)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 408, &version_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, processAdd)
{
	...
	zephir_read_property_cached(&flag, this_ptr, _zephir_prop_0, 409, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, processAttributes)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&attributes)) {
		...
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 403, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, getAttributes)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 403, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, setSourcePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 410, &sourcePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetPath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 401, &targetPath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 411, &targetUri_zv);
	RETURN_THISW();
}
