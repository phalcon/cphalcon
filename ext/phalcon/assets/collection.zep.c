...
PHP_METHOD(Phalcon_Assets_Collection, add)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 313, asset);
...
PHP_METHOD(Phalcon_Assets_Collection, addCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processadd", NULL, 314, &_0, &path_zv, isLocal, &_1, &attributes, &version_zv, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInline)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 313, code);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInlineCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processaddinline", NULL, 315, &_0, &content_zv, &_1, &attributes);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, join)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 362, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 362, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setAttributes)
{
	...
	zephir_get_arrval(&attributes, attributes_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 363, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setAutoVersion)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &flag_param);
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 364, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 364, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setFilters)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 365, &filters);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 366, &prefix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetIsLocal)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &flag_param);
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 367, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 367, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setVersion)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 368, &version_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, processAdd)
{
	...
	zephir_read_property_cached(&flag, this_ptr, _zephir_prop_0, 369, PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&attrs, this_ptr, "processattributes", NULL, 316, &attributes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Collection, processAttributes)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&attributes)) {
		...
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 363, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, getAttributes)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 363, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, setIsLocal)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &flag_param);
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 369, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 369, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setSourcePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 370, &sourcePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetPath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 361, &targetPath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 371, &targetUri_zv);
	RETURN_THISW();
}
