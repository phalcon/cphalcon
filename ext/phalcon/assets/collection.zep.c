...
PHP_METHOD(Phalcon_Assets_Collection, add)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 305, asset);
...
PHP_METHOD(Phalcon_Assets_Collection, addCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processadd", NULL, 306, &_0, &path_zv, isLocal, &_1, &attributes, &version_zv, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInline)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 305, code);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, addInlineCss)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processaddinline", NULL, 307, &_0, &content_zv, &_1, &attributes);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Collection, join)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 354, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 354, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setAttributes)
{
	...
	zephir_get_arrval(&attributes, attributes_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 355, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setFilters)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 357, &filters);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetIsLocal)
{
	...
	zephir_fetch_params_without_memory_grow(1, 0, &flag_param);
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 359, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 359, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setVersion)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 360, &version_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, processAdd)
{
	...
	zephir_read_property_cached(&flag, this_ptr, _zephir_prop_0, 361, PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(&attrs, this_ptr, "processattributes", NULL, 308, &attributes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Collection, processAttributes)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&attributes)) {
		...
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 355, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, getAttributes)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 355, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Assets_Collection, setSourcePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 362, &sourcePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetPath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 353, &targetPath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Collection, setTargetUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 363, &targetUri_zv);
	RETURN_THISW();
}
