...
PHP_METHOD(Phalcon_Assets_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 372, tagFactory);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 373, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Assets_Manager, addAssetByType)
{
	...
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "checkandcreatecollection", NULL, 317, &type_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Manager, addCss)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 318, &path_zv, &_1, &_2, &attributes, &version_zv, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "css");
...
PHP_METHOD(Phalcon_Assets_Manager, addInlineCss)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 319, &content_zv, &_1, &attributes);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "css");
...
PHP_METHOD(Phalcon_Assets_Manager, addInlineJs)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 320, &content_zv, &_1, &attributes);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "js");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addinlinecodebytype", NULL, 0, &_2, &_0);
...
PHP_METHOD(Phalcon_Assets_Manager, addJs)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 321, &path_zv, &_1, &_2, &attributes, &version_zv, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "js");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addassetbytype", NULL, 0, &_4, &_0);
...
PHP_METHOD(Phalcon_Assets_Manager, collection)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "checkandcreatecollection", NULL, 317, &name_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Manager, get)
{
	...
	if (UNEXPECTED(1 != zephir_array_isset_value(&_0, &name_zv))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 322, &name_zv);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Assets/Manager.zep", 299);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 374, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, getCss)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "css");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "checkandcreatecollection", NULL, 317, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Manager, output)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&filters)) {
		...
		if (!(zephir_is_true(&join))) {
			if (1 == ZEPHIR_IS_EMPTY(&completeTargetPath)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$9, "__construct", NULL, 323, &completeTargetPath);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_3$$9, "phalcon/Assets/Manager.zep", 467);
				ZEPHIR_MM_RESTORE();
				return;
			}
			ZEPHIR_CALL_FUNCTION(&_4$$8, "is_dir", NULL, 288, &completeTargetPath);
			zephir_check_call_status();
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_4$$8)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_5$$10, "__construct", NULL, 324, &completeTargetPath);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&assets) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&assets), _6)
		{
			...
			if (1 != ZEPHIR_IS_EMPTY(&filters)) {
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_7$$12)) {
					...
					if (1 == ZEPHIR_IS_EMPTY(&sourcePath)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_8$$14, "__construct", &_9, 325, &sourcePath);
						zephir_check_call_status();
				...
				if (1 == ZEPHIR_IS_EMPTY(&targetPath)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &_10$$15, "__construct", &_12, 326, &_11$$15);
					zephir_check_call_status();
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$12)) {
					if (ZEPHIR_IS_IDENTICAL(&targetPath, &sourcePath)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_14$$17, "__construct", &_15, 327, &targetPath);
						zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&prefixedPath, this_ptr, "calculateprefixedpath", &_22, 328, collection, &_20$$21, &_21$$21);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_23$$21, &asset, "getattributes", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_24$$21, &asset, "islocal", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&html, this_ptr, "docallback", &_25, 329, &callback, &_23$$21, &prefixedPath, &_24$$21);
				zephir_check_call_status();
				zephir_read_property_cached(&_26$$21, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
			...
			if (filterNeeded) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&filteredContent, this_ptr, "applyfilters", &_27, 330, &content, &filters, &mustFilter);
				zephir_check_call_status();
				if (zephir_is_true(&join)) {
			...
			if (!zephir_is_true(&join)) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&prefixedPath, this_ptr, "calculateprefixedpath", &_22, 328, collection, &_31$$28, &_32$$28);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_33$$28, collection, "getattributes", &_34, 0);
				zephir_check_call_status();
				ZVAL_BOOL(&_35$$28, 1);
				ZEPHIR_CALL_METHOD(&html, this_ptr, "docallback", &_25, 329, &callback, &_33$$28, &prefixedPath, &_35$$28);
				zephir_check_call_status();
				zephir_read_property_cached(&_35$$28, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (1 != ZEPHIR_IS_EMPTY(&filters)) {
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_38$$32)) {
						...
						if (1 == ZEPHIR_IS_EMPTY(&sourcePath)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_39$$34, "__construct", &_9, 325, &sourcePath);
							zephir_check_call_status();
					...
					if (1 == ZEPHIR_IS_EMPTY(&targetPath)) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(NULL, &_40$$35, "__construct", &_12, 326, &_41$$35);
						zephir_check_call_status();
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_42$$32)) {
						if (ZEPHIR_IS_IDENTICAL(&targetPath, &sourcePath)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_43$$37, "__construct", &_15, 327, &targetPath);
							zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&prefixedPath, this_ptr, "calculateprefixedpath", &_22, 328, collection, &_47$$41, &_48$$41);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_49$$41, &asset, "getattributes", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_50$$41, &asset, "islocal", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&html, this_ptr, "docallback", &_25, 329, &callback, &_49$$41, &prefixedPath, &_50$$41);
					zephir_check_call_status();
					zephir_read_property_cached(&_51$$41, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
				...
				if (!zephir_is_true(&join)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&prefixedPath, this_ptr, "calculateprefixedpath", &_22, 328, collection, &_54$$48, &_55$$48);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_56$$48, collection, "getattributes", &_34, 0);
					zephir_check_call_status();
					ZVAL_BOOL(&_57$$48, 1);
					ZEPHIR_CALL_METHOD(&html, this_ptr, "docallback", &_25, 329, &callback, &_56$$48, &prefixedPath, &_57$$48);
					zephir_check_call_status();
					zephir_read_property_cached(&_57$$48, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
	...
	if (_58) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&html, this_ptr, "docallback", &_25, 329, &callback, &_60$$51, &prefixedPath, &_61$$51);
		zephir_check_call_status();
		zephir_read_property_cached(&_62$$51, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
	...
	if (1 != ZEPHIR_IS_EMPTY(&codes)) {
		...
		if (Z_TYPE_P(&codes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&codes), _0$$3)
			{
				...
				zephir_check_call_status();
				ZVAL_BOOL(&_2$$4, 1);
				ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "applyfilters", &_3, 330, &content, &filters, &_2$$4);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(&content, &_1$$4);
				if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
					zephir_concat_self(&joinedContent, &content);
				} else {
					zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_0, 372, PH_NOISY_CC | PH_READONLY);
					ZVAL_BOOL(&_6$$6, 1);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZVAL_BOOL(&_12$$7, 1);
					ZEPHIR_CALL_METHOD(&_11$$7, this_ptr, "applyfilters", &_3, 330, &content, &filters, &_12$$7);
					zephir_check_call_status();
					ZEPHIR_CPY_WRT(&content, &_11$$7);
					if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
						zephir_concat_self(&joinedContent, &content);
					} else {
						zephir_read_property_cached(&_13$$9, this_ptr, _zephir_prop_0, 372, PH_NOISY_CC | PH_READONLY);
						ZVAL_BOOL(&_15$$9, 1);
		...
		ZEPHIR_INIT_NVAR(&code);
		if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
			zephir_read_property_cached(&_18$$10, this_ptr, _zephir_prop_0, 372, PH_NOISY_CC | PH_READONLY);
			ZVAL_BOOL(&_20$$10, 1);
		...
		zephir_read_property_cached(&_23$$3, this_ptr, _zephir_prop_1, 375, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 373, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Manager, useImplicitOutput)
{
	...
	if (implicitOutput) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 375, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 375, &__$false);
	}
	RETURN_THISW();
}
	...
	if (Z_TYPE_P(&filters) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&filters), _0)
		{
			...
			if (UNEXPECTED(_1$$4)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", &_3, 331);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(_7$$6)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_8$$7, "__construct", &_3, 331);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Manager, cssLink)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "href");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processparameters", NULL, 332, parameters, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Assets_Manager, processParameters)
{
	...
	if (local) {
		zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
		_9$$11 = Z_TYPE_P(&_8$$11) != IS_NULL;
		if (_9$$11) {
			zephir_read_property_cached(&_10$$11, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
		...
		if (_9$$11) {
			zephir_read_property_cached(&_13$$12, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_1, 372, PH_NOISY_CC | PH_READONLY);
