	...
	if (1 != ZEPHIR_IS_EMPTY(&filters)) {
		...
		if (!(zephir_is_true(&join))) {
			if (1 == ZEPHIR_IS_EMPTY(&completeTargetPath)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$9, "__construct", NULL, 38, &_4$$9);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_5$$8)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_6$$10, "__construct", NULL, 38, &_7$$10);
				zephir_check_call_status();
			...
			if (1 != ZEPHIR_IS_EMPTY(&filters)) {
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_10$$12)) {
					...
					if (1 == ZEPHIR_IS_EMPTY(&sourcePath)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_11$$14, "__construct", NULL, 38, &_12$$14);
						zephir_check_call_status();
				...
				if (1 == ZEPHIR_IS_EMPTY(&targetPath)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_13$$15, "__construct", NULL, 38, &_14$$15);
					zephir_check_call_status();
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_15$$12)) {
					if (ZEPHIR_IS_IDENTICAL(&targetPath, &sourcePath)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_16$$17, "__construct", NULL, 38, &_17$$17);
						zephir_check_call_status();
				...
				if (1 != ZEPHIR_IS_EMPTY(&filters)) {
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_35$$40)) {
						...
						if (1 == ZEPHIR_IS_EMPTY(&sourcePath)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_36$$42, "__construct", NULL, 38, &_37$$42);
							zephir_check_call_status();
					...
					if (1 == ZEPHIR_IS_EMPTY(&targetPath)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_38$$43, "__construct", NULL, 38, &_39$$43);
						zephir_check_call_status();
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_40$$40)) {
						if (ZEPHIR_IS_IDENTICAL(&targetPath, &sourcePath)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_41$$45, "__construct", NULL, 38, &_42$$45);
							zephir_check_call_status();
