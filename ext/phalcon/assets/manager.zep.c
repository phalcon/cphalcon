...
PHP_METHOD(Phalcon_Assets_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 415, tagFactory);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 416, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Assets_Manager, get)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 417, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, output)
{
	...
	if (Z_TYPE_P(&assets) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&assets), _6)
		{
			...
			if (1 != ZEPHIR_IS_EMPTY(&filters)) {
				...
				zephir_check_call_status();
				zephir_read_property_cached(&_26$$21, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
			...
			if (!zephir_is_true(&join)) {
				...
				zephir_check_call_status();
				zephir_read_property_cached(&_35$$28, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (1 != ZEPHIR_IS_EMPTY(&filters)) {
					...
					zephir_check_call_status();
					zephir_read_property_cached(&_51$$41, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
				...
				if (!zephir_is_true(&join)) {
					...
					zephir_check_call_status();
					zephir_read_property_cached(&_57$$48, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
	...
	if (_58) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_62$$51, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, outputInline)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&codes)) {
		...
		if (Z_TYPE_P(&codes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&codes), _0$$3)
			{
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
					...
					zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_0, 415, PH_NOISY_CC | PH_READONLY);
					ZVAL_BOOL(&_6$$6, 1);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
						...
						zephir_read_property_cached(&_13$$9, this_ptr, _zephir_prop_0, 415, PH_NOISY_CC | PH_READONLY);
						ZVAL_BOOL(&_15$$9, 1);
		...
		ZEPHIR_INIT_NVAR(&code);
		if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
			zephir_read_property_cached(&_18$$10, this_ptr, _zephir_prop_0, 415, PH_NOISY_CC | PH_READONLY);
			ZVAL_BOOL(&_20$$10, 1);
		...
		zephir_read_property_cached(&_23$$3, this_ptr, _zephir_prop_1, 418, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 416, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Manager, processParameters)
{
	...
	if (local) {
		zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_0, 419, PH_NOISY_CC | PH_READONLY);
		_9$$11 = Z_TYPE_P(&_8$$11) != IS_NULL;
		if (_9$$11) {
			zephir_read_property_cached(&_10$$11, this_ptr, _zephir_prop_0, 419, PH_NOISY_CC | PH_READONLY);
		...
		if (_9$$11) {
			zephir_read_property_cached(&_13$$12, this_ptr, _zephir_prop_0, 419, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_1, 415, PH_NOISY_CC | PH_READONLY);
