...
PHP_METHOD(Phalcon_Assets_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 432, tagFactory);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 433, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Assets_Manager, get)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 434, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, outputInline)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&codes)) {
		...
		if (Z_TYPE_P(_0$$3) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_0$$3), _2$$3)
			{
				...
				if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
					...
					zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_0, 432, PH_NOISY_CC | PH_READONLY);
					ZVAL_BOOL(&_8$$6, 1);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
						...
						zephir_read_property_cached(&_15$$9, this_ptr, _zephir_prop_0, 432, PH_NOISY_CC | PH_READONLY);
						ZVAL_BOOL(&_17$$9, 1);
		...
		ZEPHIR_INIT_NVAR(&code);
		if (ZEPHIR_IS_TRUE_IDENTICAL(&join)) {
			zephir_read_property_cached(&_20$$10, this_ptr, _zephir_prop_0, 432, PH_NOISY_CC | PH_READONLY);
			ZVAL_BOOL(&_22$$10, 1);
		...
		zephir_read_property_cached(&_25$$3, this_ptr, _zephir_prop_1, 435, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Assets_Manager, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 433, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Assets_Manager, useImplicitOutput)
{
	...
	if (implicitOutput) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 435, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 435, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Manager, processParameters)
{
	...
	if (local) {
		zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_0, 436, PH_NOISY_CC | PH_READONLY);
		_9$$11 = Z_TYPE_P(&_8$$11) != IS_NULL;
		if (_9$$11) {
			zephir_read_property_cached(&_10$$11, this_ptr, _zephir_prop_0, 436, PH_NOISY_CC | PH_READONLY);
		...
		if (_9$$11) {
			zephir_read_property_cached(&_13$$12, this_ptr, _zephir_prop_0, 436, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_19, this_ptr, _zephir_prop_1, 432, PH_NOISY_CC | PH_READONLY);
