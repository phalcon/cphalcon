...
PHP_METHOD(Phalcon_Assets_Traits_SourceTargetTrait, setSourcePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 420, &sourcePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Assets_Traits_SourceTargetTrait, setTargetUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 422, &targetUri_zv);
	RETURN_THISW();
}
