...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, paginate)
{
	...
	ZEPHIR_CALL_CE_STATIC(&parameters, phalcon_helper_arr_ce, "get", &_4, 81, &config, &_6, &_5, &_7);
	...
	ZEPHIR_CALL_FUNCTION(&_9, "call_user_func", NULL, 289, &_8, &parameters);
	zephir_check_call_status();
	...
	if (rowcount > 0) {
		...
		ZEPHIR_CALL_FUNCTION(&_14$$6, "call_user_func", NULL, 289, &_12$$6, &parameters);
		zephir_check_call_status();
