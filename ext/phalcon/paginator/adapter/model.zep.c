...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, paginate)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1209, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1211, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_0, 1209, PH_NOISY_CC);
