...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, paginate)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1166, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&config, &_1);
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1167, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_0, 1165, PH_NOISY_CC);
