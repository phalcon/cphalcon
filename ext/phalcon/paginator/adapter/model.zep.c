...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, paginate)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1201, PH_NOISY_CC);
	limit = zephir_get_intval(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1202, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&config, &_1);
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1203, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_0, 1201, PH_NOISY_CC);
