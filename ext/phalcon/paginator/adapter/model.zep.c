...
PHP_METHOD(Phalcon_Paginator_Adapter_Model, paginate)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1229, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&config, &_1);
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1230, PH_NOISY_CC);
	pageNumber = zephir_get_intval(&_2);
	zephir_memory_observe(&_3);
	zephir_array_fetch_string(&_3, &config, SL("model"), PH_NOISY, "phalcon/Paginator/Adapter/Model.zep", 117);
	...
	ZEPHIR_OBS_NVAR(&_3);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1228, PH_NOISY_CC);
