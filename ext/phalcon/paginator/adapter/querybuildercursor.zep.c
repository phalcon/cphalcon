...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilderCursor, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1227, &cursorColumn);
	zephir_memory_observe(&cursor);
	if (zephir_array_isset_string_fetch(&cursor, &config, SL("cursor"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1228, &cursor);
	}
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilderCursor, getCurrentPage)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1228, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		RETURN_MM_LONG(0);
	}
	zephir_memory_observe(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1228, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilderCursor, paginate)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1229, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1230, PH_NOISY_CC);
	limit = zephir_get_intval(&_2);
	zephir_memory_observe(&currentCursor);
	zephir_read_property_cached(&currentCursor, this_ptr, _zephir_prop_2, 1228, PH_NOISY_CC);
	...
	if (Z_TYPE_P(&currentCursor) != IS_NULL) {
		zephir_read_property_cached(&_3$$5, this_ptr, _zephir_prop_3, 1227, PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_fast_count_int(&items) > limit) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_pop", NULL, 342, &items);
		ZEPHIR_UNREF(&items);
		zephir_check_call_status();
		...
		zephir_read_property_cached(&_8$$6, this_ptr, _zephir_prop_3, 1227, PH_NOISY_CC);
		zephir_array_fetch(&_7$$6, &lastItem, &_8$$6, PH_NOISY | PH_READONLY, "phalcon/Paginator/Adapter/QueryBuilderCursor.zep", 226);
		if (UNEXPECTED(!(zephir_is_numeric(&_7$$6)))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_9$$7, "phalcon/Paginator/Adapter/QueryBuilderCursor.zep", 227);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_memory_observe(&_10$$6);
		zephir_memory_observe(&_11$$6);
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_3, 1227, PH_NOISY_CC);
		zephir_array_fetch(&_10$$6, &lastItem, &_11$$6, PH_NOISY, "phalcon/Paginator/Adapter/QueryBuilderCursor.zep", 230);
	...
	zephir_read_property_cached(&_13, this_ptr, _zephir_prop_1, 1230, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilderCursor, setCursor)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1228, cursor);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilderCursor, setQueryBuilder)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1229, builder);
	RETURN_THISW();
}
