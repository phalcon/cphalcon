...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilder, __construct)
{
	...
	if (zephir_array_isset_string_fetch(&columns, &config, SL("columns"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1177, &columns);
	}
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilder, paginate)
{
	...
	zephir_read_property_cached(&originalBuilder, this_ptr, _zephir_prop_0, 1178, PH_NOISY_CC);
	...
	zephir_read_property_cached(&limit, this_ptr, _zephir_prop_2, 1179, PH_NOISY_CC);
	zephir_memory_observe(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 1180, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_44, this_ptr, _zephir_prop_2, 1179, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Paginator_Adapter_QueryBuilder, setQueryBuilder)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1178, builder);
	RETURN_THISW();
}
