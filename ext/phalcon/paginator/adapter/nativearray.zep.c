...
PHP_METHOD(Phalcon_Paginator_Adapter_NativeArray, paginate)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1202, PH_NOISY_CC);
	show = zephir_get_intval(&_2);
	zephir_memory_observe(&_3);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1203, PH_NOISY_CC);
	...
	ZVAL_LONG(&_5, show);
	ZEPHIR_CALL_FUNCTION(&_6, "array_slice", NULL, 264, &items, &_0, &_5);
	zephir_check_call_status();
	...
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_1, 1202, PH_NOISY_CC);
