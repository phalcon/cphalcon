...
PHP_METHOD(Phalcon_Paginator_Adapter_NativeArray, paginate)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1165, PH_NOISY_CC);
	show = zephir_get_intval(&_2);
	zephir_memory_observe(&_3);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1166, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_1, 1165, PH_NOISY_CC);
