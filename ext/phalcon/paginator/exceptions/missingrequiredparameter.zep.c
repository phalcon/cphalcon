...
ZEPHIR_INIT_CLASS(Phalcon_Paginator_Exceptions_MissingRequiredParameter)
{
...

	{
		zval _zc0;
		ZVAL_UNDEF(&_zc0);
		zephir_declare_typed_property(phalcon_paginator_exceptions_missingrequiredparameter_ce, SL("parameter"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_STRING, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Paginator_Exceptions_MissingRequiredParameter, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1238, &parameter_zv);
	ZEPHIR_INIT_VAR(&_0);
