...
PHP_METHOD(Phalcon_Paginator_PaginatorFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1237, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Paginator_PaginatorFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1238, PH_NOISY_CC | PH_READONLY);
