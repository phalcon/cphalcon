...
PHP_METHOD(Phalcon_Paginator_PaginatorFactory, newInstance) {
	...
	if (!(zephir_array_isset(&_0, &name))) {
		...
		zephir_array_fetch(&definition, &_1$$3, &name, PH_NOISY, "phalcon/Paginator/PaginatorFactory.zep", 71 TSRMLS_CC);
	...
	zephir_array_fetch(&_5, &_4, &name, PH_NOISY | PH_READONLY, "phalcon/Paginator/PaginatorFactory.zep", 80 TSRMLS_CC);
	RETURN_CTOR(&_5);
