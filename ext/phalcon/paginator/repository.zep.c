...
PHP_METHOD(Phalcon_Paginator_Repository, __get)
{
	...
	ZEPHIR_CALL_FUNCTION(NULL, "trigger_error", NULL, 11, &_3);
	zephir_check_call_status();
	RETURN_MM_NULL();
}
...
PHP_METHOD(Phalcon_Paginator_Repository, setAliases)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1259, &aliases);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Paginator_Repository, setProperties)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1260, &properties);
	RETURN_THIS();
}
