...
PHP_METHOD(Phalcon_Auth_Access_Acl, isAllowed)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 432, PH_NOISY_CC);
	_3 = !(ZEPHIR_IS_EMPTY(&_2));
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 432, PH_NOISY_CC | PH_READONLY);
	...
	if (_6) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_7$$5, "__construct", NULL, 393);
		zephir_check_call_status();
	...
	if (_8) {
		zephir_read_property_cached(&_9$$6, this_ptr, _zephir_prop_2, 430, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_3, 428, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Access_Acl, resolveRole)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 394, &_1, &_2);
	zephir_check_call_status();
