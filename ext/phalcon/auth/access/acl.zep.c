...
PHP_METHOD(Phalcon_Auth_Access_Acl, isAllowed)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "in_array", NULL, 85, &actionName_zv, &_0, &__$true);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		RETURN_MM_BOOL(1);
	}
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 426, PH_NOISY_CC);
	_3 = !(ZEPHIR_IS_EMPTY(&_2));
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 426, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_5, "in_array", NULL, 85, &actionName_zv, &_4, &__$true);
		zephir_check_call_status();
	...
	if (_8) {
		zephir_read_property_cached(&_9$$6, this_ptr, _zephir_prop_2, 424, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_3, 422, PH_NOISY_CC | PH_READONLY);
