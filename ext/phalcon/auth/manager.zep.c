...
PHP_METHOD(Phalcon_Auth_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 460, accessFactory);
}
...
PHP_METHOD(Phalcon_Auth_Manager, access)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 461, &_4);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Auth_Manager, addAccessList)
{
	...
	if (Z_TYPE_P(&accessList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&accessList), _1, _2, _0)
		{
			...
			zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 460, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_0, 460, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Manager, addGuard)
{
	...
	if (isDefault) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 462, guard);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Auth_Manager, guard)
{
	...
	if (ZEPHIR_IS_NULL(&name_zv)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 462, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 463, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 463, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Manager, setAccess)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 461, access);
	RETURN_THISW();
}
