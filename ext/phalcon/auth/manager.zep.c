...
PHP_METHOD(Phalcon_Auth_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 410, accessFactory);
}
...
PHP_METHOD(Phalcon_Auth_Manager, access)
{
	...
	if (!zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 358, &accessName_zv);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Auth/Manager.zep", 68);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 410, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_4, &_3, "newinstance", NULL, 0, &accessName_zv);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 411, &_4);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Auth_Manager, addAccessList)
{
	...
	if (Z_TYPE_P(&accessList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&accessList), _1, _2, _0)
		{
			...
			zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 410, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_0, 410, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Manager, addGuard)
{
	...
	if (isDefault) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 412, guard);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Auth_Manager, attempt)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requirestatefulguard", NULL, 359);
	zephir_check_call_status();
	if (remember) {
		ZVAL_BOOL(&_1, 1);
	} else {
...
PHP_METHOD(Phalcon_Auth_Manager, except)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requireactiveaccess", NULL, 360);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, guard)
{
	...
	if (ZEPHIR_IS_NULL(&name_zv)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 412, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 413, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_value(&_2, &name_zv))) {
		ZEPHIR_INIT_VAR(&_3$$5);
		object_init_ex(&_3$$5, phalcon_auth_exceptions_guardnotdefined_ce);
		ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 362, &name_zv);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$5, "phalcon/Auth/Manager.zep", 169);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 413, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Manager, setAccess)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 411, access);
	RETURN_THISW();
}
