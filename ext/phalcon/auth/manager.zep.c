...
PHP_METHOD(Phalcon_Auth_Manager, access)
{
	...
	if (!zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 405, &accessName_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, attempt)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requirestatefulguard", NULL, 406);
	zephir_check_call_status();
	if (remember) {
		ZVAL_BOOL(&_1, 1);
	} else {
...
PHP_METHOD(Phalcon_Auth_Manager, except)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requireactiveaccess", NULL, 407);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, guard)
{
	...
	if (ZEPHIR_IS_NULL(&name_zv)) {
		...
		if (Z_TYPE_P(&_0$$3) == IS_NULL) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 408);
			zephir_check_call_status();
	...
	if (!(zephir_array_isset_value(&_2, &name_zv))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 409, &name_zv);
		zephir_check_call_status();
