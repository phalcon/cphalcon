...
PHP_METHOD(Phalcon_Auth_Manager, access)
{
	...
	if (!zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 422, &accessName_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, attempt)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requirestatefulguard", NULL, 423);
	zephir_check_call_status();
	if (remember) {
		ZVAL_BOOL(&_1, 1);
	} else {
...
PHP_METHOD(Phalcon_Auth_Manager, except)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "requireactiveaccess", NULL, 424);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, guard)
{
	...
	if (ZEPHIR_IS_NULL(&name_zv)) {
		...
		if (Z_TYPE_P(&_0$$3) == IS_NULL) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 425);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Manager, requireActiveAccess)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 427);
		zephir_check_call_status();
