...
PHP_METHOD(Phalcon_Auth_ManagerFactory, load)
{
	...
	if (Z_TYPE_P(&guards) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&guards), _3, _4, _2)
		{
			...
			ZVAL_COPY(&gconf, _2);
			zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 462, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_2, 463, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_23$$4, this_ptr, _zephir_prop_1, 462, PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
				zephir_read_property_cached(&_27$$4, this_ptr, _zephir_prop_2, 463, PH_NOISY_CC | PH_READONLY);
