...
PHP_METHOD(Phalcon_Auth_ManagerFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 468, container);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 469, hasher);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 470, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 471, &_1);
	ZEPHIR_INIT_VAR(&_2);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 472, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Auth_ManagerFactory, load)
{
	...
	if (Z_TYPE_P(_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_2), _5, _6, _4)
		{
			...
			ZVAL_COPY(&gconf, _4);
			zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_1, 470, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_13$$3, this_ptr, _zephir_prop_2, 471, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_25$$4, this_ptr, _zephir_prop_1, 470, PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
				zephir_read_property_cached(&_29$$4, this_ptr, _zephir_prop_2, 471, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_ManagerFactory, buildAdapter)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 469, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_5);
