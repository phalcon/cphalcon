...
PHP_METHOD(Phalcon_Auth_Guard_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 410, request);
...
PHP_METHOD(Phalcon_Auth_Guard_Token, fromOptions)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 360, &_5, &_6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 361, adapter, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Token, getTokenForRequest)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 411, PH_NOISY_CC | PH_READONLY);
	...
	if (_9) {
		...
		ZEPHIR_CALL_FUNCTION(&bearer, "mb_substr", NULL, 290, &header, &_10$$4, &__$null, &_11$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Token, user)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 413, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_2);
	zephir_create_array(&_2, 1, 0);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 411, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&found) != IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 412, &found);
	}
	RETURN_MM_MEMBER(getThis(), "user");
}
...
PHP_METHOD(Phalcon_Auth_Guard_Token, validate)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 411, PH_NOISY_CC | PH_READONLY);
