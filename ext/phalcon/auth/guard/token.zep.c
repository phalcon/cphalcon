...
PHP_METHOD(Phalcon_Auth_Guard_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 471, request);
...
PHP_METHOD(Phalcon_Auth_Guard_Token, setRequest)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 471, request);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 473, &__$null);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Token, user)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_2);
