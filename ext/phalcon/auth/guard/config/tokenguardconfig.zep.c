...
PHP_METHOD(Phalcon_Auth_Guard_Config_TokenGuardConfig, __construct)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 439, &inputKey_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 440, &storageKey_zv);
	ZEPHIR_MM_RESTORE();
}
