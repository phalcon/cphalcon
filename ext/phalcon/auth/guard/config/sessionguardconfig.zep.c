...
PHP_METHOD(Phalcon_Auth_Guard_Config_SessionGuardConfig, __construct)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "validatenonempty", NULL, 389, &_0, &suffix_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "name");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "validatenonempty", NULL, 389, &_0, &name_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "rememberName");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "validatenonempty", NULL, 389, &_0, &rememberName_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	if (Z_TYPE_P(&name_zv) != IS_NULL) {
		...
		ZEPHIR_INIT_NVAR(&_0);
		ZVAL_STRING(&_0, "auth");
		ZEPHIR_CALL_METHOD(&_1, this_ptr, "derive", NULL, 390, &_0, &suffix_zv);
		zephir_check_call_status();
	}
	...
	if (Z_TYPE_P(&rememberName_zv) != IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "derive", NULL, 390, &_0, &suffix_zv);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_IDENTICAL(&_4, &_5)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_6$$3, "__construct", NULL, 391);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Config_SessionGuardConfig, validateNonEmpty)
{
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(&value_zv, "")) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 375, &_1$$4, &param_zv);
		zephir_check_call_status();
