...
PHP_METHOD(Phalcon_Auth_Guard_Config_SessionGuardConfig, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 437, &_1);
	ZEPHIR_INIT_VAR(&_2);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 438, &_2);
	ZEPHIR_INIT_VAR(&_3);
	if (0 != rememberTtl) {
		ZEPHIR_INIT_NVAR(&_3);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 439, &_3);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 437, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 438, PH_NOISY_CC | PH_READONLY);
