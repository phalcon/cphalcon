...
PHP_METHOD(Phalcon_Auth_Guard_UserRemember, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 475, &_5);
	ZEPHIR_INIT_VAR(&_7);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 476, &_7);
	ZEPHIR_INIT_VAR(&_10);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 477, &_10);
	ZEPHIR_MM_RESTORE();
}
