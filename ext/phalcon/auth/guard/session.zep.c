...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	if (Z_TYPE_P(config) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, config, "__construct", NULL, 399);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &config, "__construct", NULL, 399, &_0, &_2, &_3, &_4);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 400, adapter, &_5, &_9, &_10, &config);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_3) {
		ZEPHIR_CALL_METHOD(&token, &recaller, "gettoken", NULL, 401);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	if (Z_TYPE_P(&raw) == IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 402, &raw);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	ZEPHIR_CALL_METHOD(&id, recaller, "getid", NULL, 403);
	zephir_check_call_status();
	if (Z_TYPE_P(&id) == IS_NULL) {
		RETURN_MM_NULL();
	}
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 443, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, recaller, "gettoken", NULL, 401);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, recaller, "getuseragent", NULL, 404);
	zephir_check_call_status();
