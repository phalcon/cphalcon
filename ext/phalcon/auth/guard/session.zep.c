...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	if (Z_TYPE_P(config) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, config, "__construct", NULL, 405);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &config, "__construct", NULL, 405, &_0, &_2, &_3, &_4);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 406, adapter, &_6, &_10, &_11, &config);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_3) {
		ZEPHIR_CALL_METHOD(&token, &recaller, "gettoken", NULL, 407);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	if (Z_TYPE_P(&raw) == IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 408, &raw);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	ZEPHIR_CALL_METHOD(&id, recaller, "getid", NULL, 409);
	zephir_check_call_status();
	if (Z_TYPE_P(&id) == IS_NULL) {
		RETURN_MM_NULL();
	}
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 447, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, recaller, "gettoken", NULL, 407);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, recaller, "getuseragent", NULL, 410);
	zephir_check_call_status();
