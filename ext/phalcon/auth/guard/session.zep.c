...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	if (Z_TYPE_P(config) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, config, "__construct", NULL, 312);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, fromOptions)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &config, "__construct", NULL, 312, &_0, &_2, &_3);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 313, adapter, &_4, &_8, &_10, &config);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, login)
{
	...
	if (remember) {
		...
		if (!(zephir_instance_of_ev(&_4$$3, phalcon_contracts_auth_adapter_rememberadapter_ce))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 299, &_6$$4, &_7$$4);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_2) {
		ZEPHIR_CALL_METHOD(&token, &recaller, "gettoken", NULL, 314);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	if (Z_TYPE_P(&raw) == IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 315, &raw);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	ZEPHIR_CALL_METHOD(&id, recaller, "getid", NULL, 316);
	zephir_check_call_status();
	if (Z_TYPE_P(&id) == IS_NULL) {
		RETURN_MM_NULL();
	}
	zephir_read_property(&_1, this_ptr, ZEND_STRL("adapter"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, recaller, "gettoken", NULL, 314);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, recaller, "getuseragent", NULL, 317);
	zephir_check_call_status();
