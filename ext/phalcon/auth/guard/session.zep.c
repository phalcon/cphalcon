...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 438, cookies);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 439, session);
	if (Z_TYPE_P(config) == IS_NULL) {
		ZEPHIR_INIT_NVAR(config);
		object_init_ex(config, phalcon_auth_guard_config_sessionguardconfig_ce);
		ZEPHIR_CALL_METHOD(NULL, config, "__construct", NULL, 378);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 440, clock);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &config, "__construct", NULL, 378, &_0, &_2, &_3, &_4);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 379, adapter, &_5, &_9, &_10, &config);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, attempt)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 441, PH_NOISY_CC | PH_READONLY);
	if (remember) {
		ZVAL_BOOL(&_2, 1);
	} else {
		ZVAL_BOOL(&_2, 0);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, login)
{
	...
	zephir_check_call_status();
	if (remember) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 443, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_3) {
		ZEPHIR_CALL_METHOD(&token, &recaller, "gettoken", NULL, 380);
		zephir_check_call_status();
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 438, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "getremembername", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_5$$3, &_4$$3, "has", NULL, 0, &_6$$3);
		zephir_check_call_status();
		if (zephir_is_true(&_5$$3)) {
			zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 438, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 439, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 444, &__$null);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, onceBasic)
{
	...
	zephir_check_call_status();
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 444, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, user)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 439, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 443, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_5$$4, &_4$$4, "retrievebyid", NULL, 0, &id);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 444, &_5$$4);
	}
	ZEPHIR_CALL_METHOD(&recaller, this_ptr, "recaller", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 444, PH_NOISY_CC | PH_READONLY);
	...
	if (_7) {
		...
		if (Z_TYPE_P(&fromRecaller) != IS_NULL) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 444, &fromRecaller);
			zephir_read_property_cached(&_8$$6, this_ptr, _zephir_prop_1, 439, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, validate)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 441, &resolved);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 438, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&raw) == IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 381, &raw);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, rememberUser)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 438, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getremembername", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 440, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_8, &_7, "now", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_9, &_8, "gettimestamp", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_3, 442, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 443, PH_NOISY_CC);
	if (!(zephir_instance_of_ev(&_0, phalcon_contracts_auth_adapter_rememberadapter_ce))) {
		RETURN_MM_NULL();
	}
	ZEPHIR_CALL_METHOD(&id, recaller, "getid", NULL, 382);
	zephir_check_call_status();
	if (Z_TYPE_P(&id) == IS_NULL) {
		RETURN_MM_NULL();
	}
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 443, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, recaller, "gettoken", NULL, 380);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, recaller, "getuseragent", NULL, 383);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&resolved, &_1, "retrievebytoken", NULL, 0, &id, &_2, &_3);
	zephir_check_call_status();
	if (Z_TYPE_P(&resolved) != IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 445, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 445, &__$false);
	}
	RETURN_CCTOR(&resolved);
}
