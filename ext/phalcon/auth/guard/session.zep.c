...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 444, cookies);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 445, session);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 446, clock);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, login)
{
	...
	zephir_check_call_status();
	if (remember) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 449, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_3) {
		...
		if (zephir_is_true(&_5$$3)) {
			zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 444, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 445, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 450, &__$null);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, onceBasic)
{
	...
	zephir_check_call_status();
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 450, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, user)
{
	...
	if (_3) {
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 449, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_5$$4, &_4$$4, "retrievebyid", NULL, 0, &id);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 450, &_5$$4);
	}
	ZEPHIR_CALL_METHOD(&recaller, this_ptr, "recaller", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 450, PH_NOISY_CC | PH_READONLY);
	...
	if (_7) {
		...
		if (Z_TYPE_P(&fromRecaller) != IS_NULL) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 450, &fromRecaller);
			zephir_read_property_cached(&_8$$6, this_ptr, _zephir_prop_1, 445, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, validate)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 447, &resolved);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, rememberUser)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 444, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getremembername", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 446, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_8, &_7, "now", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_9, &_8, "gettimestamp", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_3, 448, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 449, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 449, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	if (Z_TYPE_P(&resolved) != IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 451, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 451, &__$false);
	}
	RETURN_CCTOR(&resolved);
}
