...
ZEPHIR_INIT_CLASS(Phalcon_Auth_Guard_Session)
{
	 ...
	 * @var ClockInterface
	 */
	zend_declare_property_null(phalcon_auth_guard_session_ce, SL("clock"), ZEND_ACC_PROTECTED);
	/**
...
PHP_METHOD(Phalcon_Auth_Guard_Session, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 394, request);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 395, cookies);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 396, session);
	if (Z_TYPE_P(config) == IS_NULL) {
		ZEPHIR_INIT_NVAR(config);
		object_init_ex(config, phalcon_auth_guard_config_sessionguardconfig_ce);
		ZEPHIR_CALL_METHOD(NULL, config, "__construct", NULL, 347);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 397, clock);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, fromOptions)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval options;
	zval *adapter, adapter_sub, *container, container_sub, *options_param = NULL, config, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10;
	...
	if (zephir_array_isset_value_string(&options, SL("rememberTtl"))) {
		ZEPHIR_OBS_NVAR(&_4);
		zephir_array_fetch_string(&_4, &options, SL("rememberTtl"), PH_NOISY, "phalcon/Auth/Guard/Session.zep", 100);
	} else {
		ZEPHIR_INIT_NVAR(&_4);
		ZVAL_NULL(&_4);
	}
	ZEPHIR_CALL_METHOD(NULL, &config, "__construct", NULL, 347, &_0, &_2, &_3, &_4);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, "Session guard");
	ZEPHIR_CALL_CE_STATIC(&_5, phalcon_auth_internal_containerresolver_ce, "resolvecandidate", NULL, 0, container, &options, &_1, &_6, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	...
	ZEPHIR_INIT_NVAR(&_8);
	ZVAL_STRING(&_8, "Session guard");
	ZEPHIR_CALL_CE_STATIC(&_9, phalcon_auth_internal_containerresolver_ce, "resolvecandidate", NULL, 0, container, &options, &_1, &_6, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	...
	ZEPHIR_INIT_NVAR(&_8);
	ZVAL_STRING(&_8, "Session guard");
	ZEPHIR_CALL_CE_STATIC(&_10, phalcon_auth_internal_containerresolver_ce, "resolvecandidate", NULL, 0, container, &options, &_1, &_6, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 348, adapter, &_5, &_9, &_10, &config);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, attempt)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 398, PH_NOISY_CC | PH_READONLY);
	if (remember) {
		ZVAL_BOOL(&_2, 1);
	} else {
		ZVAL_BOOL(&_2, 0);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, login)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 396, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	if (remember) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 400, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, loginById)
{
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_ce_type_error, "The parameter must be 'int' or 'string'", "phalcon/Auth/Guard/Session.zep", 203);
		return;
	}
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 400, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, logout)
{
	...
	if (_3) {
		ZEPHIR_CALL_METHOD(&token, &recaller, "gettoken", NULL, 349);
		zephir_check_call_status();
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 395, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "getremembername", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_5$$3, &_4$$3, "has", NULL, 0, &_6$$3);
		zephir_check_call_status();
		if (zephir_is_true(&_5$$3)) {
			zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 395, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 396, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 401, &__$null);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, once)
{
	...
	if (zephir_is_true(&_3)) {
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 398, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, onceBasic)
{
	...
	zephir_check_call_status();
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 401, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, user)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 396, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 400, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_5$$4, &_4$$4, "retrievebyid", NULL, 0, &id);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 401, &_5$$4);
	}
	ZEPHIR_CALL_METHOD(&recaller, this_ptr, "recaller", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 401, PH_NOISY_CC | PH_READONLY);
	...
	if (_7) {
		...
		if (Z_TYPE_P(&fromRecaller) != IS_NULL) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 401, &fromRecaller);
			zephir_read_property_cached(&_8$$6, this_ptr, _zephir_prop_1, 396, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, validate)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 398, &resolved);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, basicCredentials)
{
	...
	zephir_array_fetch_string(&_1, &basic, SL("username"), PH_NOISY, "phalcon/Auth/Guard/Session.zep", 362);
	zephir_array_update_zval(return_value, &field_zv, &_1, PH_COPY);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_array_fetch_string(&_1, &basic, SL("password"), PH_NOISY, "phalcon/Auth/Guard/Session.zep", 364);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, recaller)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 395, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&raw) == IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 350, &raw);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Auth_Guard_Session, rememberUser)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 395, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getremembername", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 397, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_8, &_7, "now", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_9, &_8, "gettimestamp", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_3, 399, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Auth_Guard_Session, userFromRecaller)
{
	...
	ZEPHIR_CALL_METHOD(&id, recaller, "getid", NULL, 351);
	zephir_check_call_status();
	if (Z_TYPE_P(&id) == IS_NULL) {
		RETURN_MM_NULL();
	}
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 400, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, recaller, "gettoken", NULL, 349);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, recaller, "getuseragent", NULL, 352);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&resolved, &_1, "retrievebytoken", NULL, 0, &id, &_2, &_3);
	zephir_check_call_status();
	if (Z_TYPE_P(&resolved) != IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 402, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 402, &__$false);
	}
	RETURN_CCTOR(&resolved);
}
