...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_auth_adapter_config_streamadapterconfig_getmodel, 0, 0, IS_STRING, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_auth_adapter_config_streamadapterconfig_method_entry) {
	...
	PHP_ME(Phalcon_Auth_Adapter_Config_StreamAdapterConfig, getModel, arginfo_phalcon_auth_adapter_config_streamadapterconfig_getmodel, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
