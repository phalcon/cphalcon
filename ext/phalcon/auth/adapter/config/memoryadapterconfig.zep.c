...
ZEPHIR_INIT_CLASS(Phalcon_Auth_Adapter_Config_MemoryAdapterConfig)
{
...

	{
		...
		zephir_declare_typed_property(phalcon_auth_adapter_config_memoryadapterconfig_ce, SL("users"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Auth_Adapter_Config_MemoryAdapterConfig, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 430, &users);
