...
ZEPHIR_INIT_CLASS(Phalcon_Auth_Adapter_Config_AbstractAdapterConfig)
{
...

	{
		zval _zc0;
		ZVAL_NULL(&_zc0);
		zephir_declare_typed_property(phalcon_auth_adapter_config_abstractadapterconfig_ce, SL("model"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING|MAY_BE_NULL, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Auth_Adapter_Config_AbstractAdapterConfig, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 104, &model_zv);
	ZEPHIR_MM_RESTORE();
}
