...
PHP_METHOD(Phalcon_Auth_Adapter_Model, createRememberToken)
{
	...
	ZVAL_LONG(&_3, 30);
	ZEPHIR_CALL_FUNCTION(&_4, "random_bytes", NULL, 310, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveByCredentials)
{
	...
	if (_11) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_12$$8, "__construct", NULL, 147, &_13$$8, &_14$$8);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveById)
{
	...
	if (_7) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$4, "__construct", NULL, 147, &_9$$4, &_10$$4);
		zephir_check_call_status();
