...
PHP_METHOD(Phalcon_Auth_Adapter_Model, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 390, &_1, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 391, hasher, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, createRememberToken)
{
	...
	zephir_check_call_status();
	ZVAL_LONG(&_3, 30);
	ZEPHIR_CALL_FUNCTION(&_4, "random_bytes", NULL, 322, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveByCredentials)
{
	...
	ZEPHIR_CALL_METHOD(&found, this_ptr, "findfirstasauthuser", NULL, 392, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveById)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "findfirstasauthuser", NULL, 392, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
