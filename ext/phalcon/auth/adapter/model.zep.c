...
PHP_METHOD(Phalcon_Auth_Adapter_Model, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 366, &_1, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 367, hasher, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveByCredentials)
{
	...
	ZEPHIR_CALL_METHOD(&found, this_ptr, "findfirstasauthuser", NULL, 368, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveById)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "findfirstasauthuser", NULL, 368, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
