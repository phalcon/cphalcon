...
PHP_METHOD(Phalcon_Auth_Adapter_Model, fromOptions)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 317, &_1, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 318, hasher, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveByCredentials)
{
	...
	if (_11) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_12$$8, "__construct", NULL, 153, &_13$$8, &_14$$8);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Auth_Adapter_Model, retrieveById)
{
	...
	if (_7) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$4, "__construct", NULL, 153, &_9$$4, &_10$$4);
		zephir_check_call_status();
