...
PHP_METHOD(Phalcon_Security, getSaltBytes) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "openssl_random_pseudo_bytes", &_3, 379, _1);
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_5, "sprintf", &_6, 152, &_3, &_4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_7);
		ZEPHIR_CONCAT_SVSVSV(_7, "$2", variant, "$", _5, "$", saltBytes);
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_8, 380, password, _7);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, checkHash) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "crypt", &_2, 380, password, passwordHash);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	zephir_fcall_cache_entry *_3 = NULL, *_5 = NULL;
	zval *numberBytes_param = NULL, *safeBytes, *dependencyInjector = NULL, *session = NULL, *_0, *_1 = NULL, *_2 = NULL, *_4 = NULL, *_6 = NULL;
	int numberBytes, ZEPHIR_LAST_CALL_STATUS;
	...
	ZEPHIR_CALL_METHOD(&_6, dependencyInjector, "getshared", NULL, 0, _1);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(session, _6);
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	zval *numberBytes_param = NULL, *token = NULL, *dependencyInjector = NULL, *session = NULL, *_0 = NULL, *_2 = NULL, *_4;
	int numberBytes, ZEPHIR_LAST_CALL_STATUS;
	...
	ZEPHIR_CALL_FUNCTION(&token, "openssl_random_pseudo_bytes", &_1, 379, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "base64_encode", &_3, 45, token);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(token, _2);
	ZEPHIR_INIT_NVAR(_0);
	...
	_4 = zephir_fetch_nproperty_this(this_ptr, SL("_tokenValueSessionID"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(NULL, session, "set", NULL, 0, _4, token);
	zephir_check_call_status();
	RETURN_CCTOR(token);
...
PHP_METHOD(Phalcon_Security, computeHmac) {
	...
	zend_bool raw;
	zval *data, *key, *algo, *raw_param = NULL, *hmac = NULL, *_1, *_2;
	...
	ZEPHIR_CALL_FUNCTION(&hmac, "hash_hmac", &_0, 381, algo, data, key, (raw ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	if (!(zephir_is_true(hmac))) {
		ZEPHIR_INIT_VAR(_1);
		object_init_ex(_1, phalcon_security_exception_ce);
		ZEPHIR_INIT_VAR(_2);
		ZEPHIR_CONCAT_SV(_2, "Unknown hashing algorithm: %s", algo);
		ZEPHIR_CALL_METHOD(NULL, _1, "__construct", &_3, 2, _2);
		zephir_check_call_status();
		zephir_throw_exception_debug(_1, "phalcon/security.zep", 434 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(hmac);
