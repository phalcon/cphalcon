...
PHP_METHOD(Phalcon_Security, getSaltBytes) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_4, "base64_encode", &_5, 110, _2);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		if (hash == 8) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_4, 398, password, _3);
			zephir_check_call_status();
			RETURN_MM();
		}
		ZEPHIR_INIT_NVAR(_1);
		...
		ZEPHIR_CALL_FUNCTION(&_7, "sprintf", NULL, 184, &_5, &_6);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "base64_encode", NULL, 110, _2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "base64_encode", NULL, 110, token);
	zephir_check_call_status();
