...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_11$$17, "sprintf", NULL, 196, &_10$$17, &_9$$17);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_12$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_12$$17, "$2", &variant, "$", &_11$$17, "$", &saltBytes, "$");
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 421, &password, &_12$$17);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, checkToken) {
	...
	zval *tokenKey = NULL, tokenKey_sub, *tokenValue = NULL, tokenValue_sub, *destroyIfValid_param = NULL, __$null, dependencyInjector, session, request, token, _0, _1, _2, _3$$4, _4$$6;
	ZEPHIR_INIT_THIS();
