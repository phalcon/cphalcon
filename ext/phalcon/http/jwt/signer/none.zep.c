...
ZEPHIR_INIT_CLASS(Phalcon_Http_JWT_Signer_None) {
	...
	ZEPHIR_REGISTER_CLASS(Phalcon\\Http\\JWT\\Signer, None, phalcon, http_jwt_signer_none, phalcon_http_jwt_signer_none_method_entry, 0);

	zend_class_implements(phalcon_http_jwt_signer_none_ce, 1, phalcon_http_jwt_signer_signerinterface_ce);
	return SUCCESS;
