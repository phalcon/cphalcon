...
ZEPHIR_INIT_CLASS(Phalcon_Http_JWT_Token_Item) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Http\\JWT\\Token, Item, phalcon, http_jwt_token_item, phalcon_http_jwt_token_abstractitem_ce, phalcon_http_jwt_token_item_method_entry, 0);
...
PHP_METHOD(Phalcon_Http_JWT_Token_Item, get) {
	...
	zephir_array_fetch_string(&_2, &_1, SL("payload"), PH_NOISY | PH_READONLY, "phalcon/Http/JWT/Token/Item.zep", 42);
	zephir_array_fetch(&_3, &_2, &name, PH_NOISY | PH_READONLY, "phalcon/Http/JWT/Token/Item.zep", 42);
	RETURN_CTOR(&_3);
...
PHP_METHOD(Phalcon_Http_JWT_Token_Item, getPayload) {
	...
	zephir_array_fetch_string(&_1, &_0, SL("payload"), PH_NOISY | PH_READONLY, "phalcon/Http/JWT/Token/Item.zep", 50);
	RETURN_CTORW(&_1);
...
PHP_METHOD(Phalcon_Http_JWT_Token_Item, has) {
	...
	zephir_read_property(&_0, this_ptr, SL("data"), PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch_string(&_1, &_0, SL("payload"), PH_READONLY, "phalcon/Http/JWT/Token/Item.zep", 60);
