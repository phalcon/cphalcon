...
ZEPHIR_INIT_CLASS(Phalcon_Http_JWT_Token_Signature) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Http\\JWT\\Token, Signature, phalcon, http_jwt_token_signature, phalcon_http_jwt_token_abstractitem_ce, phalcon_http_jwt_token_signature_method_entry, 0);
...
PHP_METHOD(Phalcon_Http_JWT_Token_Signature, getHash) {
	...
	zephir_array_fetch_string(&_1, &_0, SL("hash"), PH_NOISY | PH_READONLY, "phalcon/Http/JWT/Token/Signature.zep", 35);
	RETURN_CTORW(&_1);
