...
ZEPHIR_INIT_CLASS(Phalcon_Http_JWT_Builder) {
	...
	ZEPHIR_REGISTER_CLASS(Phalcon\\Http\\JWT, Builder, phalcon, http_jwt_builder, phalcon_http_jwt_builder_method_entry, 0);

	/**
	 * @var Collection
	 */
	zend_declare_property_null(phalcon_http_jwt_builder_ce, SL("claims"), ZEND_ACC_PRIVATE);

	/**
	 * @var Collection
	 */
	zend_declare_property_null(phalcon_http_jwt_builder_ce, SL("jose"), ZEND_ACC_PRIVATE);

	/**
	 * @var string
	 */
	zend_declare_property_null(phalcon_http_jwt_builder_ce, SL("passphrase"), ZEND_ACC_PRIVATE);

	/**
	 * @var SignerInterface
	 */
	zend_declare_property_null(phalcon_http_jwt_builder_ce, SL("signer"), ZEND_ACC_PRIVATE);
...
PHP_METHOD(Phalcon_Http_JWT_Builder, getToken) {
	...
	if (ZEPHIR_IS_EMPTY(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_jwt_exceptions_validatorexception_ce, "Invalid passphrase (empty)", "phalcon/Http/JWT/Builder.zep", 182);
		return;
	}
	...
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&encodedClaims, phalcon_helper_base64_ce, "encodeurl", &_1, 288, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&claims);
	object_init_ex(&claims, phalcon_http_jwt_token_item_ce);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getclaims", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &claims, "__construct", NULL, 289, &_5, &encodedClaims);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_6, phalcon_helper_json_ce, "encode", &_3, 14, &_7);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&encodedHeaders, phalcon_helper_base64_ce, "encodeurl", &_1, 288, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&headers);
	object_init_ex(&headers, phalcon_http_jwt_token_item_ce);
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &headers, "__construct", NULL, 289, &_8, &encodedHeaders);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&encodedSignature, phalcon_helper_base64_ce, "encodeurl", &_1, 288, &signatureHash);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&signature);
	object_init_ex(&signature, phalcon_http_jwt_token_signature_ce);
	ZEPHIR_CALL_METHOD(NULL, &signature, "__construct", NULL, 290, &signatureHash, &encodedSignature);
	zephir_check_call_status();
	object_init_ex(return_value, phalcon_http_jwt_token_token_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 291, &headers, &claims, &signature);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setAudience) {
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_jwt_exceptions_validatorexception_ce, "Invalid Audience", "phalcon/Http/JWT/Builder.zep", 232);
		return;
	}
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "aud");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_1, &aud);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setExpirationTime) {
	...
	if (ZEPHIR_GT_LONG(&_0, timestamp)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_jwt_exceptions_validatorexception_ce, "Invalid Expiration Time", "phalcon/Http/JWT/Builder.zep", 277);
		return;
	}
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "exp");
	ZVAL_LONG(&_2, timestamp);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setId) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "jti");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_0, &id);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setIssuedAt) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setIssuer) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "iss");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_0, &issuer);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setNotBefore) {
	...
	if (ZEPHIR_LT_LONG(&_0, timestamp)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_jwt_exceptions_validatorexception_ce, "Invalid Not Before", "phalcon/Http/JWT/Builder.zep", 351);
		return;
	}
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "nbf");
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setSubject) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "sub");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setclaim", NULL, 292, &_0, &subject);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_JWT_Builder, setPassphrase) {
	...
	if (!(zephir_is_true(&_2))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_jwt_exceptions_validatorexception_ce, "Invalid passphrase (too weak)", "phalcon/Http/JWT/Builder.zep", 389);
		return;
	}
