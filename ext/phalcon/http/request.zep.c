...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	if (trustForwardedHeader) {
		...
		if (!(ZEPHIR_IS_EMPTY(&forwarded))) {
			...
			zephir_fast_explode_str(&_5$$8, SL(","), &forwarded, ZEND_LONG_MAX);
			...
			if (Z_TYPE_P(_7$$8) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_7$$8), _8$$8)
				{
					...
					zephir_read_property_cached(&_9$$9, this_ptr, _zephir_prop_1, 883, PH_NOISY_CC);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						zephir_read_property_cached(&_15$$12, this_ptr, _zephir_prop_1, 883, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Http_Request, getDigestAuth)
{
	...
	if (zephir_array_isset_string_fetch(&digest, &server, SL("PHP_AUTH_DIGEST"), 0)) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3$$3), _5$$3)
		{
			...
			zephir_array_fetch_long(&_6$$5, &match, 3, PH_NOISY, "phalcon/Http/Request.zep", 341);
...
PHP_METHOD(Phalcon_Http_Request, getJsonRawBody)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(&_0, "__invoke", NULL, 411, &rawBody, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getUploadedFiles)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *onlySuccessful_param = NULL, *namedKeys_param = NULL, _FILES, superFiles, prefix, input, smoothInput, file, dataFile, *_0$$3, _1$$3, *_2$$3, _5$$4, _6$$5, _7$$5, _8$$5, _9$$5, _10$$5, *_12$$5, _13$$5, *_14$$5, _21$$5, _16$$6, _17$$7, _18$$7, _19$$7, _24$$8, _25$$9, _26$$9, _27$$9, _28$$9, _30$$10, _31$$11, _32$$11;
	zend_bool onlySuccessful, namedKeys, _22$$5, _15$$6, _23$$8, _29$$10;
	zval *this_ptr = getThis();
			...
			if (Z_TYPE_P(&_5$$4) == IS_ARRAY) {
				...
				if (Z_TYPE_P(_12$$5) == IS_ARRAY) {
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_21$$5, _12$$5, "valid", NULL, 0);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 193, &_1, &serverValue, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _5)
		{
			...
			ZVAL_LONG(&_8$$3, -1);
			ZVAL_LONG(&_9$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 193, &_7$$3, &_6$$3, &_8$$3, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_34$$14, -1);
				ZVAL_LONG(&_35$$14, 1);
				ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 193, &_33$$14, &_32$$14, &_34$$14, &_35$$14);
				zephir_check_call_status();
				if (Z_TYPE_P(&headerSplit) == IS_STRING) {
					ZEPHIR_INIT_NVAR(&_33$$14);
...
PHP_METHOD(Phalcon_Http_Request, getFormData)
{
	...
	if (Z_TYPE_P(_9) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_9), _10)
		{
			...
			ZVAL_LONG(&_12$$4, 2);
			ZEPHIR_CALL_FUNCTION(&splited$$4, "preg_split", NULL, 193, &_11$$4, &bodyPart, &_12$$4);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_12$$4, -1);
			ZVAL_LONG(&_14$$4, 1);
			ZEPHIR_CALL_FUNCTION(&headerParts$$4, "preg_split", NULL, 193, &_11$$4, &_13$$4, &_12$$4, &_14$$4);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(_15$$4) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_15$$4), _16$$4)
				{
					...
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&_23$$6)) {
						...
						zephir_fast_explode_str(&explodedHeader$$8, SL(";"), &headerValue$$6, ZEND_LONG_MAX);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_44$$13)) {
							...
							zephir_fast_explode_str(&explodedHeader$$15, SL(";"), &headerValue$$13, ZEND_LONG_MAX);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_60$$22, 2);
				ZEPHIR_CALL_FUNCTION(&splited$$22, "preg_split", NULL, 193, &_59$$22, &bodyPart, &_60$$22);
				zephir_check_call_status();
				...
				ZVAL_LONG(&_60$$22, -1);
				ZVAL_LONG(&_62$$22, 1);
				ZEPHIR_CALL_FUNCTION(&headerParts$$22, "preg_split", NULL, 193, &_59$$22, &_61$$22, &_60$$22, &_62$$22);
				zephir_check_call_status();
				...
				if (Z_TYPE_P(_63$$22) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_63$$22), _64$$22)
					{
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_71$$24)) {
							...
							zephir_fast_explode_str(&explodedHeader$$26, SL(";"), &headerValue$$24, ZEND_LONG_MAX);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (!ZEPHIR_IS_FALSE_IDENTICAL(&_91$$31)) {
								...
								zephir_fast_explode_str(&explodedHeader$$33, SL(";"), &headerValue$$31, ZEND_LONG_MAX);
...
PHP_METHOD(Phalcon_Http_Request, fireManagerEvent)
{
	...
	if (Z_TYPE_P(&_0) != IS_NULL) {
		...
		if (_1$$3) {
			...
			zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 891, PH_NOISY_CC);
			_1$$3 = zephir_instance_of_ev(&_2$$3, phalcon_events_manager_ce);
		}
		if (_1$$3) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 891, PH_NOISY_CC | PH_READONLY);
			if (cancellable) {
				ZVAL_BOOL(&_4$$4, 1);
			} else {
				ZVAL_BOOL(&_4$$4, 0);
		...
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 891, PH_NOISY_CC | PH_READONLY);
		if (cancellable) {
			ZVAL_BOOL(&_7$$3, 1);
		} else {
			ZVAL_BOOL(&_7$$3, 0);
