...
PHP_METHOD(Phalcon_Http_Request, get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 339, &_REQUEST, &name, filters, defaultValue, &_0, &_1);
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualityheader", NULL, 340, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getBasicAuth) {
	...
	if (!(_2)) {
		...
		ZEPHIR_CALL_METHOD(&_3, this_ptr, "hasserver", NULL, 341, &_1);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "accept");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getbestquality", NULL, 342, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getClientAddress) {
	...
	ZVAL_NULL(&address);
	ZEPHIR_CALL_METHOD(&server, this_ptr, "getserverarray", NULL, 343);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getMethod) {
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &returnMethod)) {
		...
		ZEPHIR_CALL_METHOD(&overridedMethod, this_ptr, "getheader", NULL, 345, &_1$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 339, &_POST, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getPut) {
	...
	if (Z_TYPE_P(&put) != IS_ARRAY) {
		...
		if (_0$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_2$$3, "stripos", NULL, 346, &contentType, &_1$$3);
			zephir_check_call_status();
		...
		if (_0$$3) {
			...
			zephir_check_call_status();
			ZEPHIR_MAKE_REF(&put);
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 305, &_4$$6, &put);
			ZEPHIR_UNREF(&put);
			zephir_check_call_status();
		}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 339, &put, &name, filters, defaultValue, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getQuery) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 339, &_GET, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
		...
		if (Z_TYPE_P(&superFiles) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&superFiles), _2$$3, _3$$3, _0$$3)
			{
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 348, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &prefix);
					zephir_check_call_status();
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _11$$5)
						{
							...
							if (_13$$6) {
								...
								if (namedKeys == 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_16$$8, "__construct", &_18, 349, &dataFile, &_17$$8);
									zephir_check_call_status();
									...
									ZEPHIR_CALL_METHOD(NULL, &_20$$9, "__construct", &_18, 349, &dataFile, &_21$$9);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (_22$$10) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_26$$12, "__construct", &_18, 349, &dataFile, &_27$$12);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_29$$13, "__construct", &_18, 349, &dataFile, &_30$$13);
										zephir_check_call_status();
					...
					if (_31$$14) {
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_33$$16, "__construct", &_18, 349, &input, &prefix);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_34$$17, "__construct", &_18, 349, &input, &prefix);
							zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&_35$$18) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 348, &_36$$19, &_37$$19, &_38$$19, &_39$$19, &_40$$19, &prefix);
						zephir_check_call_status();
						zephir_is_iterable(&smoothInput, 0, "phalcon/Http/Request.zep", 822);
						if (Z_TYPE_P(&smoothInput) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _41$$19)
							{
								...
								if (_43$$20) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_47$$22, "__construct", &_18, 349, &dataFile, &_48$$22);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_50$$23, "__construct", &_18, 349, &dataFile, &_51$$23);
										zephir_check_call_status();
								...
								zephir_check_call_status();
									...
									if (_52$$24) {
										...
										if (namedKeys == 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_56$$26, "__construct", &_18, 349, &dataFile, &_57$$26);
											zephir_check_call_status();
											...
											ZEPHIR_CALL_METHOD(NULL, &_59$$27, "__construct", &_18, 349, &dataFile, &_60$$27);
											zephir_check_call_status();
						...
						if (_61$$28) {
							if (namedKeys == 1) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", &_18, 349, &input, &prefix);
								zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &_64$$31, "__construct", &_18, 349, &input, &prefix);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isConnect) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 350);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isMethod) {
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 350);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 351, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 351, &method, &_10$$8);
					zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
		{
			...
			if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
				...
				if (Z_TYPE_P(&error) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "hasfilehelper", &_5, 352, &error, &_4$$8);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
					...
					if (Z_TYPE_P(&error) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&_7$$13, this_ptr, "hasfilehelper", &_5, 352, &error, &_8$$13);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setParameterFilters) {
	...
	ZEPHIR_CALL_METHOD(&filterService, this_ptr, "getfilterservice", NULL, 353);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "hasserver", NULL, 341, &_9);
	zephir_check_call_status();
	_10 = zephir_is_true(&_0);
	if (_10) {
		ZEPHIR_INIT_NVAR(&_9);
		ZVAL_STRING(&_9, "PHP_AUTH_PW");
		ZEPHIR_CALL_METHOD(&_11, this_ptr, "hasserver", NULL, 341, &_9);
		zephir_check_call_status();
	...
	if (_10) {
		...
		ZEPHIR_CALL_METHOD(&_15$$8, this_ptr, "hasserver", NULL, 341, &_16$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_16$$8);
		ZVAL_STRING(&_16$$8, "REDIRECT_HTTP_AUTHORIZATION");
		ZEPHIR_CALL_METHOD(&_17$$8, this_ptr, "hasserver", NULL, 341, &_16$$8);
		zephir_check_call_status();
		...
		if (zephir_is_true(&authHeader)) {
			...
			ZEPHIR_CALL_FUNCTION(&_21$$11, "stripos", NULL, 346, &authHeader, &_20$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_20$$11);
			ZVAL_STRING(&_20$$11, "digest ");
			ZEPHIR_CALL_FUNCTION(&_22$$11, "stripos", NULL, 346, &authHeader, &_20$$11);
			zephir_check_call_status();
			_23$$11 = ZEPHIR_IS_LONG_IDENTICAL(&_22$$11, 0);
			if (_23$$11) {
				ZEPHIR_INIT_NVAR(&_20$$11);
				ZVAL_STRING(&_20$$11, "PHP_AUTH_DIGEST");
				ZEPHIR_CALL_METHOD(&_24$$11, this_ptr, "hasserver", NULL, 341, &_20$$11);
				zephir_check_call_status();
				_23$$11 = !zephir_is_true(&_24$$11);
			}
			ZEPHIR_INIT_NVAR(&_20$$11);
			ZVAL_STRING(&_20$$11, "bearer ");
			ZEPHIR_CALL_FUNCTION(&_25$$11, "stripos", NULL, 346, &authHeader, &_20$$11);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 348, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 348, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/Http/Request.zep", 1487);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
