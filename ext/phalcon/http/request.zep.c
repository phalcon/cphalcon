...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 744)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 492, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 133, &_1, &serverValue, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_LONG(&_7$$3, -1);
			ZVAL_LONG(&_8$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 133, &_6$$3, &_5$$3, &_7$$3, &_8$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_32$$14, -1);
				ZVAL_LONG(&_33$$14, 1);
				ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 133, &_31$$14, &_30$$14, &_32$$14, &_33$$14);
				zephir_check_call_status();
				zephir_is_iterable(&headerSplit, 0, "phalcon/Http/Request.zep", 1602);
				if (Z_TYPE_P(&headerSplit) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strncmp", NULL, 342, &ipBits, &subnetBits, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_20$$11, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$12, "base64_decode", NULL, 472, &_26$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_value_string(&headers, SL("Authorization")))) {
		if (zephir_array_isset_value_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$17, "base64_encode", NULL, 475, &_32$$17);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getFormData)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&bodyParts, "preg_split", NULL, 133, &_6, &_7);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&bodyParts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&bodyParts), _8)
		{
			...
			ZVAL_LONG(&_10$$3, 2);
			ZEPHIR_CALL_FUNCTION(&splited$$3, "preg_split", NULL, 133, &_9$$3, &bodyPart, &_10$$3);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_10$$3, -1);
			ZVAL_LONG(&_12$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerParts$$3, "preg_split", NULL, 133, &_9$$3, &_11$$3, &_10$$3, &_12$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_55$$19, 2);
				ZEPHIR_CALL_FUNCTION(&splited$$19, "preg_split", NULL, 133, &_54$$19, &bodyPart, &_55$$19);
				zephir_check_call_status();
				...
				ZVAL_LONG(&_55$$19, -1);
				ZVAL_LONG(&_57$$19, 1);
				ZEPHIR_CALL_FUNCTION(&headerParts$$19, "preg_split", NULL, 133, &_54$$19, &_56$$19, &_55$$19, &_57$$19);
				zephir_check_call_status();
