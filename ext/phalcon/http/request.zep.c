...
PHP_METHOD(Phalcon_Http_Request, get)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 378, &_REQUEST, &name, filters, defaultValue, &_0, &_1);
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualityheader", NULL, 379, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getBasicAuth)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "hasserver", NULL, 380, &_1);
	zephir_check_call_status();
	_2 = !zephir_is_true(&_0);
	if (!(_2)) {
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "PHP_AUTH_PW");
		ZEPHIR_CALL_METHOD(&_3, this_ptr, "hasserver", NULL, 380, &_1);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "accept");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getbestquality", NULL, 381, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	ZVAL_NULL(&address);
	ZEPHIR_CALL_METHOD(&server, this_ptr, "getserverarray", NULL, 382);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&server) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&server), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 273, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 273, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 273, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 273, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 383, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getMethod)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &returnMethod)) {
		...
		ZEPHIR_CALL_METHOD(&overridedMethod, this_ptr, "getheader", NULL, 384, &_1$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 635)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 120, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 378, &_POST, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getPut)
{
	...
	if (Z_TYPE_P(&put) == IS_NULL) {
		...
		if (_0$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_2$$3, "stripos", NULL, 385, &contentType, &_1$$3);
			zephir_check_call_status();
		...
		if (_0$$3) {
			...
			zephir_check_call_status();
			ZEPHIR_MAKE_REF(&put);
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 344, &_4$$6, &put);
			ZEPHIR_UNREF(&put);
			zephir_check_call_status();
		}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 378, &put, &name, filters, defaultValue, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getQuery)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 378, &_GET, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress)
{
	...
	if (Z_TYPE_P(&serverAddr) == IS_NULL) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 386, &_1$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
		...
		if (Z_TYPE_P(&superFiles) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&superFiles), _2$$3, _3$$3, _0$$3)
			{
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 387, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &prefix);
					zephir_check_call_status();
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _11$$5)
						{
							...
							if (_13$$6) {
								...
								if (namedKeys == 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_16$$8, "__construct", &_18, 388, &dataFile, &_17$$8);
									zephir_check_call_status();
									...
									ZEPHIR_CALL_METHOD(NULL, &_20$$9, "__construct", &_18, 388, &dataFile, &_21$$9);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (_22$$10) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_26$$12, "__construct", &_18, 388, &dataFile, &_27$$12);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_29$$13, "__construct", &_18, 388, &dataFile, &_30$$13);
										zephir_check_call_status();
					...
					if (_31$$14) {
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_33$$16, "__construct", &_18, 388, &input, &prefix);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_34$$17, "__construct", &_18, 388, &input, &prefix);
							zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&_35$$18) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 387, &_36$$19, &_37$$19, &_38$$19, &_39$$19, &_40$$19, &prefix);
						zephir_check_call_status();
						zephir_is_iterable(&smoothInput, 0, "phalcon/Http/Request.zep", 891);
						if (Z_TYPE_P(&smoothInput) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _41$$19)
							{
								...
								if (_43$$20) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_47$$22, "__construct", &_18, 388, &dataFile, &_48$$22);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_50$$23, "__construct", &_18, 388, &dataFile, &_51$$23);
										zephir_check_call_status();
								...
								zephir_check_call_status();
									...
									if (_52$$24) {
										...
										if (namedKeys == 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_56$$26, "__construct", &_18, 388, &dataFile, &_57$$26);
											zephir_check_call_status();
											...
											ZEPHIR_CALL_METHOD(NULL, &_59$$27, "__construct", &_18, 388, &dataFile, &_60$$27);
											zephir_check_call_status();
						...
						if (_61$$28) {
							if (namedKeys == 1) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", &_18, 388, &input, &prefix);
								zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &_64$$31, "__construct", &_18, 388, &input, &prefix);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, hasHeader)
{
	...
	ZEPHIR_INIT_VAR(&name);
	zephir_fast_strtoupper(&name, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "hasserver", NULL, 380, &name);
	zephir_check_call_status();
	_4 = zephir_is_true(&_3);
	if (!(_4)) {
		ZEPHIR_INIT_VAR(&_6);
		ZEPHIR_CONCAT_SV(&_6, "HTTP_", &name);
		ZEPHIR_CALL_METHOD(&_5, this_ptr, "hasserver", NULL, 380, &_6);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isConnect)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 389);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isMethod)
{
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 389);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 390, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 390, &method, &_10$$8);
					zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
		{
			...
			if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
				...
				if (Z_TYPE_P(&error) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "hasfilehelper", &_5, 391, &error, &_4$$8);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
					...
					if (Z_TYPE_P(&error) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&_7$$13, this_ptr, "hasfilehelper", &_5, 391, &error, &_8$$13);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setParameterFilters)
{
	...
	ZEPHIR_CALL_METHOD(&filterService, this_ptr, "getfilterservice", NULL, 392);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
		{
			...
			if (Z_TYPE_P(&value) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "hasfilehelper", &_5, 391, &value, &_4$$7);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_7$$11, this_ptr, "hasfilehelper", &_5, 391, &value, &_8$$11);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 104, &_1, &_0, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_LONG(&_8$$3, -1);
			ZVAL_LONG(&_9$$3, 1);
			ZEPHIR_CALL_FUNCTION(&_10$$3, "preg_split", NULL, 104, &_7$$3, &_6$$3, &_8$$3, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_31$$14, -1);
				ZVAL_LONG(&_32$$14, 1);
				ZEPHIR_CALL_FUNCTION(&_33$$14, "preg_split", NULL, 104, &_30$$14, &_29$$14, &_31$$14, &_32$$14);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "hasserver", NULL, 380, &_9);
	zephir_check_call_status();
	_10 = zephir_is_true(&_0);
	if (_10) {
		ZEPHIR_INIT_NVAR(&_9);
		ZVAL_STRING(&_9, "PHP_AUTH_PW");
		ZEPHIR_CALL_METHOD(&_11, this_ptr, "hasserver", NULL, 380, &_9);
		zephir_check_call_status();
	...
	if (_10) {
		...
		ZEPHIR_CALL_METHOD(&_15$$8, this_ptr, "hasserver", NULL, 380, &_16$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_16$$8);
		ZVAL_STRING(&_16$$8, "REDIRECT_HTTP_AUTHORIZATION");
		ZEPHIR_CALL_METHOD(&_17$$8, this_ptr, "hasserver", NULL, 380, &_16$$8);
		zephir_check_call_status();
		...
		if (zephir_is_true(&authHeader)) {
			...
			ZEPHIR_CALL_FUNCTION(&_21$$11, "stripos", NULL, 385, &authHeader, &_20$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_20$$11);
			ZVAL_STRING(&_20$$11, "digest ");
			ZEPHIR_CALL_FUNCTION(&_22$$11, "stripos", NULL, 385, &authHeader, &_20$$11);
			zephir_check_call_status();
			_23$$11 = ZEPHIR_IS_LONG_IDENTICAL(&_22$$11, 0);
			if (_23$$11) {
				ZEPHIR_INIT_NVAR(&_20$$11);
				ZVAL_STRING(&_20$$11, "PHP_AUTH_DIGEST");
				ZEPHIR_CALL_METHOD(&_24$$11, this_ptr, "hasserver", NULL, 380, &_20$$11);
				zephir_check_call_status();
				_23$$11 = !zephir_is_true(&_24$$11);
			}
			ZEPHIR_INIT_NVAR(&_20$$11);
			ZVAL_STRING(&_20$$11, "bearer ");
			ZEPHIR_CALL_FUNCTION(&_25$$11, "stripos", NULL, 385, &authHeader, &_20$$11);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG_IDENTICAL(&_21$$11, 0)) {
				ZVAL_LONG(&_26$$12, 6);
				ZEPHIR_INIT_VAR(&_27$$12);
				zephir_substr(&_27$$12, &authHeader, 6 , 0, ZEPHIR_SUBSTR_NO_LENGTH);
				ZEPHIR_CALL_FUNCTION(&_28$$12, "base64_decode", NULL, 224, &_27$$12);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 387, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 387, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/Http/Request.zep", 1564);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
