...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 744)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 508, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&ipBits, "unpack", NULL, 444, &_3, &ipBin);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&subnetBits, "unpack", NULL, 444, &_3, &subnetBin);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strncmp", NULL, 346, &ipBits, &subnetBits, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_20$$11, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$12, "base64_decode", NULL, 488, &_26$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_value_string(&headers, SL("Authorization")))) {
		if (zephir_array_isset_value_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$17, "base64_encode", NULL, 491, &_32$$17);
			zephir_check_call_status();
