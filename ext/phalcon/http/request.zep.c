...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	if (trustForwardedHeader) {
		...
		if (!(ZEPHIR_IS_EMPTY(&forwarded))) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&reverseForwardedIps, "array_reverse", NULL, 198, &forwardedIps);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (zephir_memnstr_str(&cleanHost, SL(":"), "phalcon/Http/Request.zep", 581)) {
			...
			ZVAL_STRING(&_6$$6, "");
			ZEPHIR_CALL_FUNCTION(&_7$$6, "preg_replace", NULL, 78, &_5$$6, &_6$$6, &cleanHost);
			zephir_check_call_status();
		...
		ZVAL_STRING(&_9$$5, "");
		ZEPHIR_CALL_FUNCTION(&_10$$5, "preg_replace", NULL, 78, &_8$$5, &_9$$5, &cleanHost);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getJsonRawBody)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(&_0, "__invoke", NULL, 305, &rawBody, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 744)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 503, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 134, &_1, &serverValue, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_LONG(&_7$$3, -1);
			ZVAL_LONG(&_8$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 134, &_6$$3, &_5$$3, &_7$$3, &_8$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_32$$14, -1);
				ZVAL_LONG(&_33$$14, 1);
				ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 134, &_31$$14, &_30$$14, &_32$$14, &_33$$14);
				zephir_check_call_status();
				zephir_is_iterable(&headerSplit, 0, "phalcon/Http/Request.zep", 1602);
				if (Z_TYPE_P(&headerSplit) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&ipBits, "unpack", NULL, 439, &_3, &ipBin);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&subnetBits, "unpack", NULL, 439, &_3, &subnetBin);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_20$$11, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$12, "base64_decode", NULL, 483, &_26$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_value_string(&headers, SL("Authorization")))) {
		if (zephir_array_isset_value_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$17, "base64_encode", NULL, 486, &_32$$17);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getFormData)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&bodyParts, "preg_split", NULL, 134, &_6, &_7);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&bodyParts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&bodyParts), _8)
		{
			...
			ZVAL_LONG(&_10$$3, 2);
			ZEPHIR_CALL_FUNCTION(&splited$$3, "preg_split", NULL, 134, &_9$$3, &bodyPart, &_10$$3);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_10$$3, -1);
			ZVAL_LONG(&_12$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerParts$$3, "preg_split", NULL, 134, &_9$$3, &_11$$3, &_10$$3, &_12$$3);
			zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&headerParts$$3), _13$$3)
				{
					...
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&_20$$5)) {
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&explodedHeader$$7), _21$$7)
						{
							...
							ZVAL_STRING(&_24$$8, "");
							ZEPHIR_CALL_FUNCTION(&part$$7, "preg_replace", &_25, 78, &_23$$8, &_24$$8, &_22$$8);
							zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_39$$12)) {
							...
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&explodedHeader$$14), _40$$14)
							{
								...
								ZVAL_STRING(&_43$$15, "");
								ZEPHIR_CALL_FUNCTION(&part$$14, "preg_replace", &_25, 78, &_42$$15, &_43$$15, &_41$$15);
								zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_55$$19, 2);
				ZEPHIR_CALL_FUNCTION(&splited$$19, "preg_split", NULL, 134, &_54$$19, &bodyPart, &_55$$19);
				zephir_check_call_status();
				...
				ZVAL_LONG(&_55$$19, -1);
				ZVAL_LONG(&_57$$19, 1);
				ZEPHIR_CALL_FUNCTION(&headerParts$$19, "preg_split", NULL, 134, &_54$$19, &_56$$19, &_55$$19, &_57$$19);
				zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&headerParts$$19), _58$$19)
					{
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&_65$$21)) {
							...
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&explodedHeader$$23), _66$$23)
							{
								...
								ZVAL_STRING(&_69$$24, "");
								ZEPHIR_CALL_FUNCTION(&part$$23, "preg_replace", &_25, 78, &_68$$24, &_69$$24, &_67$$24);
								zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (!ZEPHIR_IS_FALSE_IDENTICAL(&_83$$28)) {
								...
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&explodedHeader$$30), _84$$30)
								{
									...
									ZVAL_STRING(&_87$$31, "");
									ZEPHIR_CALL_FUNCTION(&part$$30, "preg_replace", &_25, 78, &_86$$31, &_87$$31, &_85$$31);
									zephir_check_call_status();
