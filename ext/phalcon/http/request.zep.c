...
PHP_METHOD(Phalcon_Http_Request, get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 213, _REQUEST, name, filters, defaultValue, (notAllowEmpty ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)), (noRecursive ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
...
PHP_METHOD(Phalcon_Http_Request, getPost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 213, _POST, name, filters, defaultValue, (notAllowEmpty ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)), (noRecursive ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getPut) {
	...
	if (Z_TYPE_P(put) != IS_ARRAY) {
		...
		Z_SET_ISREF_P(put);
		ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 214, _0, put);
		Z_UNSET_ISREF_P(put);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_putCache"), put TSRMLS_CC);
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 213, put, name, filters, defaultValue, (notAllowEmpty ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)), (noRecursive ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getQuery) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 213, _GET, name, filters, defaultValue, (notAllowEmpty ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)), (noRecursive ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getHeader) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_STRING(&_1, "_", 0);
	ZEPHIR_CALL_FUNCTION(&_2, "strtr", NULL, 52, header, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(name);
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 215, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, isMethod) {
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 216);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isPost) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 216);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_array_isset_string_fetch(&error, file, SS("error"), 0 TSRMLS_CC)) {
			...
			if (Z_TYPE_P(error) == IS_ARRAY) {
				ZEPHIR_CALL_METHOD(&_4, this_ptr, "hasfilehelper", &_5, 217, error, (onlySuccessful ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, hasFileHelper) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (Z_TYPE_P(value) == IS_ARRAY) {
			ZEPHIR_CALL_METHOD(&_4, this_ptr, "hasfilehelper", &_5, 217, value, (onlySuccessful ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
			zephir_check_call_status();
			numberFiles += zephir_get_numberval(_4);
		}
	}
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1, &_0)
			...
			if (Z_TYPE_P(_3) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_9, 218, _4, _5, _6, _7, _8, prefix);
				zephir_check_call_status();
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_11, &_10)
					...
					if (_13) {
						...
						ZEPHIR_CALL_METHOD(NULL, _16, "__construct", &_18, 219, dataFile, _17);
						zephir_check_call_status();
				...
				if (_13) {
					ZEPHIR_INIT_NVAR(_16);
					object_init_ex(_16, phalcon_http_request_file_ce);
					ZEPHIR_CALL_METHOD(NULL, _16, "__construct", &_18, 219, input, prefix);
					zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (Z_TYPE_P(name) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_10, 218, _5, _6, _7, _8, _9, p);
			zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_start_with_str(name, SL("HTTP_"))) {
			...
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_9, 220, _3);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, _getQualityHeader) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&_4, "preg_split", &_5, 221, &_1, _0, &_2, &_3);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_7, &_6)
		...
		ZVAL_LONG(&_3, 1);
		ZEPHIR_CALL_FUNCTION(&_10, "preg_split", &_5, 221, &_1, _9, &_2, &_3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualityheader", NULL, 222, _0, _1);
	zephir_check_temp_parameter(_0);
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept) {
	...
	ZEPHIR_INIT_VAR(_1);
	ZVAL_STRING(_1, "accept", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getbestquality", NULL, 223, _0, _1);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getDigestAuth) {
	...
	if (zephir_array_isset_string_fetch(&digest, _SERVER, SS("PHP_AUTH_DIGEST"), 0 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "preg_match_all", NULL, 26, _0, digest, matches, _1);
		zephir_check_temp_parameter(_0);
