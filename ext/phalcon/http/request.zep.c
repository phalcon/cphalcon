...
PHP_METHOD(Phalcon_Http_Request, get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 321, _REQUEST, &name, filters, defaultValue, &_0, &_1);
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualityheader", NULL, 322, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "accept");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getbestquality", NULL, 323, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getHeaders) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_SERVER), _1, _2, _0)
	{
		...
		if (zephir_start_with_str(&name, SL("HTTP_"))) {
			...
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_9, 212, &_3$$4);
			zephir_check_call_status();
		...
		if (zephir_array_isset(&contentHeaders, &name)) {
			...
			ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_9, 212, &_14$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost) {
	...
	if (_3) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 324, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getMethod) {
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &returnMethod)) {
		...
		ZEPHIR_CALL_METHOD(&overridedMethod, this_ptr, "getheader", NULL, 325, &_1$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPort) {
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 583)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 144, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 321, _POST, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getPut) {
	...
	if (Z_TYPE_P(&put) != IS_ARRAY) {
		...
		if (_0$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_2$$3, "stripos", NULL, 326, &contentType, &_1$$3);
			zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 321, &put, &name, filters, defaultValue, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getQuery) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 321, _GET, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress) {
	...
	if (!(zephir_array_isset_string_fetch(&serverAddr, _SERVER, SL("SERVER_ADDR"), 0))) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 328, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (zephir_fast_count_int(&superFiles TSRMLS_CC) > 0) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&superFiles), _1$$3, _2$$3, _0$$3)
		{
			...
			if (Z_TYPE_P(&_3$$4) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_9, 329, &_4$$5, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &prefix);
				zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _10$$5)
				{
					...
					if (_11$$6) {
						...
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_14$$8, "__construct", &_16, 330, &dataFile, &_15$$8);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_18$$9, "__construct", &_16, 330, &dataFile, &_19$$9);
							zephir_check_call_status();
				...
				if (_20$$10) {
					if (namedKeys == 1) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_22$$12, "__construct", &_16, 330, &input, &prefix);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(NULL, &_23$$13, "__construct", &_16, 330, &input, &prefix);
						zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
	{
		...
		if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
			...
			if (Z_TYPE_P(&error) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_2$$8, this_ptr, "hasfilehelper", &_4, 331, &error, &_3$$8);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isConnect) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 332);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isMethod) {
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 332);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
		{
			...
			ZEPHIR_CALL_METHOD(&_5$$6, this_ptr, "ismethod", &_7, 333, &method, &_6$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setParameterFilters) {
	...
	ZEPHIR_CALL_METHOD(&filterLocator, this_ptr, "getfilterlocatorservice", NULL, 334);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, hasFileHelper) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
	{
		...
		if (Z_TYPE_P(&value) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "hasfilehelper", &_4, 331, &value, &_3$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders) {
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			ZEPHIR_CALL_FUNCTION(&_13$$11, "stripos", NULL, 326, &authHeader, &_12$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_12$$11);
			ZVAL_STRING(&_12$$11, "digest ");
			ZEPHIR_CALL_FUNCTION(&_14$$11, "stripos", NULL, 326, &authHeader, &_12$$11);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_16$$11, "stripos", NULL, 326, &authHeader, &_12$$11);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG_IDENTICAL(&_13$$11, 0)) {
				ZVAL_LONG(&_17$$12, 6);
				ZEPHIR_INIT_VAR(&_18$$12);
				zephir_substr(&_18$$12, &authHeader, 6 , 0, ZEPHIR_SUBSTR_NO_LENGTH);
				ZEPHIR_CALL_FUNCTION(&_19$$12, "base64_decode", NULL, 150, &_18$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_string(&headers, SL("Authorization")))) {
		...
		if (zephir_array_isset_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_25$$17, "base64_encode", NULL, 153, &_24$$17);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, smoothFiles) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _1, _2, _0)
	{
		...
		if (Z_TYPE_P(&name) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_10, 329, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &p);
			zephir_check_call_status();
