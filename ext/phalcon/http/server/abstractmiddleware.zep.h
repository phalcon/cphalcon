...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_http_server_abstractmiddleware_process, 0, 2, PsrExt\\Http\\Message\\ResponseInterface, 0)
	ZEND_ARG_OBJ_INFO(0, request, PsrExt\\Http\\Message\\ServerRequestInterface, 0)
	ZEND_ARG_OBJ_INFO(0, handler, PsrExt\\Http\\Server\\RequestHandlerInterface, 0)
ZEND_END_ARG_INFO()
