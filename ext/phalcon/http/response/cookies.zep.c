...
PHP_METHOD(Phalcon_Http_Response_Cookies, __construct)
{
	...
	if (useEncryption) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 924, &__$true);
	} else {
...
PHP_METHOD(Phalcon_Http_Response_Cookies, send)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 925, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&cookie);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 928, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 928, &__$false);
	}
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Http_Response_Cookies, set)
{
	...
	zephir_memory_observe(&encryption);
	zephir_read_property_cached(&encryption, this_ptr, _zephir_prop_0, 924, PH_NOISY_CC);
	zephir_memory_observe(&cookie);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 925, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&cookie, &_0, &name_zv, 0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 926, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_10)) {
		...
		if (1) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 929, &__$false);
		}
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Cookies, setSignKey)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 927, &signKey_zv);
	RETURN_THIS();
}
