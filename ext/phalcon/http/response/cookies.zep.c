...
PHP_METHOD(Phalcon_Http_Response_Cookies, delete)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 902, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&cookie, &_0, &name_zv, 0))) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 903, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_1$$3) != IS_NULL) {
			zephir_read_property_cached(&_2$$5, this_ptr, _zephir_prop_1, 903, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response_Cookies, get)
{
	...
	zephir_read_property_cached(&encryption, this_ptr, _zephir_prop_1, 901, PH_NOISY_CC);
	if (zephir_is_true(&encryption)) {
		ZEPHIR_CALL_METHOD(NULL, &cookie, "useencryption", NULL, 0, &encryption);
		zephir_check_call_status();
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 904, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response_Cookies, reset)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 902, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Cookies, send)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 902, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&cookie);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 905, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 905, &__$false);
	}
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Http_Response_Cookies, set)
{
	...
	zephir_memory_observe(&encryption);
	zephir_read_property_cached(&encryption, this_ptr, _zephir_prop_0, 901, PH_NOISY_CC);
	zephir_memory_observe(&cookie);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 902, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&cookie, &_0, &name_zv, 0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 903, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 903, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &cookie, "setdi", NULL, 0, &_5$$3);
		zephir_check_call_status();
		if (zephir_is_true(&encryption)) {
			ZEPHIR_CALL_METHOD(NULL, &cookie, "useencryption", NULL, 0, &encryption);
			zephir_check_call_status();
			zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_3, 904, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_9$$5, this_ptr, _zephir_prop_3, 904, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &cookie, "setsignkey", NULL, 0, &_9$$5);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_4, 906, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_10)) {
		...
		zephir_check_call_status();
		if (1) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 906, &__$true);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 906, &__$false);
		}
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Cookies, setSignKey)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 904, &signKey_zv);
	RETURN_THIS();
}
