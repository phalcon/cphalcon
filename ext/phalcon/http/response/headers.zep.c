...
PHP_METHOD(Phalcon_Http_Response_Headers, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 892, &headers);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Headers, send)
{
	zend_string *_6;
	zend_ulong _5;
	zend_bool _1, _15, _9$$6, _17$$11;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_8 = NULL;
	zval __$true, __$false, header, value, _0, _2, _3, *_4, _14, _7$$5, _10$$6, _11$$6, _12$$6, _13$$8, _16$$10, _18$$11, _19$$11, _20$$11, _21$$13;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	if (!(_1)) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 893, PH_NOISY_CC | PH_READONLY);
		_1 = ZEPHIR_IS_TRUE_IDENTICAL(&_2);
	}
	if (_1) {
		RETURN_MM_BOOL(0);
	}
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 892, PH_NOISY_CC | PH_READONLY);
	zephir_is_iterable(&_3, 0, "phalcon/Http/Response/Headers.zep", 126);
	if (Z_TYPE_P(&_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_3), _5, _6, _4)
		{
			ZEPHIR_INIT_NVAR(&header);
			if (_6 != NULL) { 
				ZVAL_STR_COPY(&header, _6);
			} else {
				ZVAL_LONG(&header, _5);
			}
			...
			if (Z_TYPE_P(&value) != IS_NULL) {
				...
				ZEPHIR_CONCAT_VSV(&_7$$5, &header, ": ", &value);
				ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &_7$$5, &__$true);
				zephir_check_call_status();
			} else {
				_9$$6 = zephir_memnstr_str(&header, SL(":"), "phalcon/Http/Response/Headers.zep", 118);
				if (!(_9$$6)) {
					ZVAL_LONG(&_10$$6, 0);
					ZVAL_LONG(&_11$$6, 5);
					ZEPHIR_INIT_NVAR(&_12$$6);
					zephir_substr(&_12$$6, &header, 0 , 5 , 0);
					_9$$6 = ZEPHIR_IS_STRING(&_12$$6, "HTTP/");
				}
				if (_9$$6) {
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &header, &__$true);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&_13$$8);
					ZEPHIR_CONCAT_VS(&_13$$8, &header, ": ");
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &_13$$8, &__$true);
					zephir_check_call_status();
				}
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&value) != IS_NULL) {
					...
					ZEPHIR_CONCAT_VSV(&_16$$10, &header, ": ", &value);
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &_16$$10, &__$true);
					zephir_check_call_status();
				} else {
					_17$$11 = zephir_memnstr_str(&header, SL(":"), "phalcon/Http/Response/Headers.zep", 118);
					if (!(_17$$11)) {
						ZVAL_LONG(&_18$$11, 0);
						ZVAL_LONG(&_19$$11, 5);
						ZEPHIR_INIT_NVAR(&_20$$11);
						zephir_substr(&_20$$11, &header, 0 , 5 , 0);
						_17$$11 = ZEPHIR_IS_STRING(&_20$$11, "HTTP/");
					}
					if (_17$$11) {
						ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &header, &__$true);
						zephir_check_call_status();
						...
						ZEPHIR_CONCAT_VS(&_21$$13, &header, ": ");
						ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 217, &_21$$13, &__$true);
						zephir_check_call_status();
					}
				}
		}
