...
PHP_METHOD(Phalcon_Http_Response_Headers, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 889, &headers);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Headers, send)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 889, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_3), _5, _6, _4)
		{
			...
			if (Z_TYPE_P(&value) != IS_NULL) {
				...
				ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 0, &_7$$5, &__$true);
				zephir_check_call_status();
			} else {
				...
				if (_9$$6) {
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 0, &header, &__$true);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&_13$$8);
					ZEPHIR_CONCAT_VS(&_13$$8, &header, ": ");
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 0, &_13$$8, &__$true);
					zephir_check_call_status();
				}
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&value) != IS_NULL) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 0, &_16$$10, &__$true);
					zephir_check_call_status();
				} else {
					...
					if (_17$$11) {
						...
						ZEPHIR_CALL_FUNCTION(NULL, "header", &_8, 0, &_21$$13, &__$true);
						zephir_check_call_status();
					}
				}
		}
