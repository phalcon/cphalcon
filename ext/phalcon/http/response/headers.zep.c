...
PHP_METHOD(Phalcon_Http_Response_Headers, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 855, &headers);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response_Headers, send)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 855, PH_NOISY_CC | PH_READONLY);
