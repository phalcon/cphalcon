...
PHP_METHOD(Phalcon_Http_Response, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 839, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 840, &_1);
...
PHP_METHOD(Phalcon_Http_Response, getContent)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 841, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Http_Response, getDI)
{
	...
	if (Z_TYPE_P(&container) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 842, &container);
	}
...
PHP_METHOD(Phalcon_Http_Response, send)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 841, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&content, &_2);
	if (Z_TYPE_P(&content) != IS_NULL) {
		zend_print_zval(&content, 0);
	} else {
		zephir_read_property_cached(&_3$$5, this_ptr, _zephir_prop_2, 844, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response, sendHeaders)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 846, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 841, &content_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Http_Response, setCookies)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 845, cookies);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Http_Response, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 846, eventsManager);
}
...
PHP_METHOD(Phalcon_Http_Response, setFileToSend)
{
	...
	if (zephir_is_true(attachment)) {
		...
		if (!ZEPHIR_IS_STRING(&basePathEncoding, "ASCII")) {
			...
			ZEPHIR_CALL_FUNCTION(&_8$$8, "addcslashes", NULL, 469, &basePath, &_7$$8);
			zephir_check_call_status();
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 844, &filePath_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Response, setHeaders)
{
	...
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _1, _2, _0)
		{
			...
			ZVAL_COPY(&value, _0);
			zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response, setStatusCode)
{
	...
	if (Z_TYPE_P(&currentHeadersRaw) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&currentHeadersRaw), _3, _4, _2)
		{
			...
			if (_5$$3) {
				zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_12$$5) {
					zephir_read_property_cached(&_15$$6, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_17, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_18);
	ZVAL_LONG(&_18, code);
	ZEPHIR_INIT_VAR(&_19);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_21);
	ZVAL_LONG(&_21, code);
	ZEPHIR_INIT_VAR(&_22);
