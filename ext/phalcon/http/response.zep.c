...
PHP_METHOD(Phalcon_Http_Response, setHeaders)
{
	...
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _1, _2, _0)
		{
			...
			ZVAL_COPY(&value, _0);
			zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 900, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_0, 900, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Response, setStatusCode)
{
	...
	if (Z_TYPE_P(&currentHeadersRaw) == IS_ARRAY) {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_12$$5) {
					zephir_read_property_cached(&_15$$6, this_ptr, _zephir_prop_0, 900, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_17, this_ptr, _zephir_prop_0, 900, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_18);
	ZVAL_LONG(&_18, code);
	ZEPHIR_INIT_VAR(&_19);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_0, 900, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_21);
	ZVAL_LONG(&_21, code);
	ZEPHIR_INIT_VAR(&_22);
