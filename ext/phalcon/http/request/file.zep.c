...
PHP_METHOD(Phalcon_Http_Request_File, __construct) {
	...
	if (zephir_array_isset_string_fetch(&name, &file, SL("name"), 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_1$$3, "defined", NULL, 121, &_0$$3);
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("tmp"), &_4);
	ZEPHIR_INIT_NVAR(&_6);
	ZVAL_STRING(&_6, "size");
	ZEPHIR_CALL_CE_STATIC(&_7, phalcon_helper_arr_ce, "get", &_5, 15, &file, &_6);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("size"), &_7);
	ZEPHIR_INIT_NVAR(&_6);
	ZVAL_STRING(&_6, "type");
	ZEPHIR_CALL_CE_STATIC(&_8, phalcon_helper_arr_ce, "get", &_5, 15, &file, &_6);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("type"), &_8);
	ZEPHIR_INIT_NVAR(&_6);
