...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 274, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, count)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 274, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, get)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *key = NULL, key_sub, *defaultValue = NULL, defaultValue_sub, __$null, value, _0, _1;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 274, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&value, &_1, key, 0)) {
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, getArray)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval defaultValue;
	zval *key = NULL, key_sub, *defaultValue_param = NULL, value, _0, _1;
	zval *this_ptr = getThis();
	...
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 1, &key, &defaultValue_param);
	ZEPHIR_SEPARATE_PARAM(key);
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, getString)
{
	...
	zval *key = NULL, key_sub, defaultValue_zv, value, _0, _1;
	zval *this_ptr = getThis();
	...
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	key = ZEND_CALL_ARG(execute_data, 1);
	ZEPHIR_SEPARATE_PARAM(key);
	if (!defaultValue) {
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, set)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *value;
	zval *key = NULL, key_sub, value_sub, _0;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Http_Request_Bag_AbstractBag, normalizeKey)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 0, &key);
	_0 = Z_TYPE_P(key) == IS_LONG;
	if (!(_0)) {
		_0 = Z_TYPE_P(key) == IS_STRING;
	}
	if (_0) {
		RETVAL_ZVAL(key, 1, 0);
		RETURN_MM();
	}
	zephir_cast_to_string(&_1, key);
	RETURN_CTOR(&_1);
}
