...
ZEPHIR_INIT_CLASS(Phalcon_Http_Message_AbstractMessage) {
	 ...
	 * @var <StreamInterface>
	 */
	zend_declare_property_null(phalcon_http_message_abstractmessage_ce, SL("body"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var <Collection>
	 */
	zend_declare_property_null(phalcon_http_message_abstractmessage_ce, SL("headers"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_string(phalcon_http_message_abstractmessage_ce, SL("protocolVersion"), "1.1", ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var UriInterface
	 */
	zend_declare_property_null(phalcon_http_message_abstractmessage_ce, SL("uri"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, getHeaderLine) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, ",");
	zephir_fast_join(return_value, &_0, &header TSRMLS_CC);
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, withAddedHeader) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", NULL, 24, name);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getheadervalue", NULL, 25, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 10, &headers, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, withBody) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "w+b");
	ZEPHIR_CALL_METHOD(&newBody, this_ptr, "processbody", NULL, 26, body, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "body");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 10, &newBody, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, withHeader) {
	...
	ZEPHIR_CPY_WRT(&headers, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getheadervalue", NULL, 25, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 10, &headers, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, withProtocolVersion) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processprotocol", NULL, 27, version);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "protocolVersion");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 10, version, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, withoutHeader) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 10, &headers, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, checkHeaderHost) {
	...
	if (UNEXPECTED(_4)) {
		...
		ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 28, &_8$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, checkHeaderName) {
	...
	if (UNEXPECTED(_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$3, "__construct", NULL, 29, &_6$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$3, "phalcon/Http/Message/AbstractMessage.zep", 336 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, checkHeaderValue) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_invalidargumentexception_ce, "Invalid header value", "phalcon/Http/Message/AbstractMessage.zep", 390);
		return;
	}
	...
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "#(?:(?:(?<!\r)\n)|(?:\r(?!\n))|(?:\r\n(?![ \t])))#");
	zephir_preg_match(&_4, &_5, value, &_2, 0, 0 , 0  TSRMLS_CC);
	...
	if (!(_6)) {
		...
		zephir_preg_match(&_9, &_10, value, &_7, 0, 0 , 0  TSRMLS_CC);
		_6 = zephir_is_true(&_9);
	}
	if (UNEXPECTED(_6)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_invalidargumentexception_ce, "Invalid header value", "phalcon/Http/Message/AbstractMessage.zep", 397);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, getHeaderValue) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&valueArray))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Http/Message/AbstractMessage.zep", 421 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&valueData);
	array_init(&valueData);
	zephir_is_iterable(&valueArray, 0, "phalcon/Http/Message/AbstractMessage.zep", 431);
	if (Z_TYPE_P(&valueArray) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&valueArray), _3)
		{
			ZEPHIR_INIT_NVAR(&value);
			ZVAL_COPY(&value, _3);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadervalue", &_5, 30, &value);
			zephir_check_call_status();
			zephir_get_strval(&_6$$5, &value);
			zephir_array_append(&valueData, &_6$$5, PH_SEPARATE, "phalcon/Http/Message/AbstractMessage.zep", 428);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadervalue", &_5, 30, &value);
				zephir_check_call_status();
				zephir_get_strval(&_7$$6, &value);
				zephir_array_append(&valueData, &_7$$6, PH_SEPARATE, "phalcon/Http/Message/AbstractMessage.zep", 428);
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, populateHeaderCollection) {
	...
	object_init_ex(&collection, phalcon_collection_collection_ce);
	ZEPHIR_CALL_METHOD(NULL, &collection, "__construct", NULL, 11);
	zephir_check_call_status();
	zephir_is_iterable(&headers, 0, "phalcon/Http/Message/AbstractMessage.zep", 475);
	if (Z_TYPE_P(&headers) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&headers), _2, _3, _0)
		{
			...
			ZEPHIR_INIT_NVAR(&value);
			ZVAL_COPY(&value, _0);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", &_4, 24, &name);
			zephir_check_call_status();
			zephir_get_strval(&_5$$3, &name);
			ZEPHIR_CPY_WRT(&name, &_5$$3);
			ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "getheadervalue", &_7, 25, &value);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&value, &_6$$3);
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_8, 31, &name, &value);
			zephir_check_call_status();
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", &_4, 24, &name);
				zephir_check_call_status();
				zephir_get_strval(&_9$$4, &name);
				ZEPHIR_CPY_WRT(&name, &_9$$4);
				ZEPHIR_CALL_METHOD(&_10$$4, this_ptr, "getheadervalue", &_7, 25, &value);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, processBody) {
	...
	if (_0) {
		_0 = zephir_is_instance_of(body, SL("Psr\\Http\\Message\\StreamInterface") TSRMLS_CC);
	}
	if (UNEXPECTED(_0)) {
	...
	if (UNEXPECTED(_1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_invalidargumentexception_ce, "Invalid stream passed as a parameter", "phalcon/Http/Message/AbstractMessage.zep", 495);
		return;
	}
	object_init_ex(return_value, phalcon_http_message_stream_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 32, body, &mode);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, processHeaders) {
	...
	if (EXPECTED(Z_TYPE_P(headers) == IS_ARRAY)) {
		ZEPHIR_CALL_METHOD(&collection, this_ptr, "populateheadercollection", NULL, 33, headers);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "checkheaderhost", NULL, 34, &collection);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&collection, &_0$$3);
	} else {
		_1$$4 = Z_TYPE_P(headers) == IS_OBJECT;
		if (_1$$4) {
			_1$$4 = zephir_instance_of_ev(headers, phalcon_collection_collection_ce TSRMLS_CC);
		}
		if (UNEXPECTED(!(_1$$4))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_invalidargumentexception_ce, "Headers needs to be either an array or instance of Phalcon\\Collection\\Collection", "phalcon/Http/Message/AbstractMessage.zep", 519);
			return;
		}
...
PHP_METHOD(Phalcon_Http_Message_AbstractMessage, processProtocol) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_invalidargumentexception_ce, "Invalid protocol value", "phalcon/Http/Message/AbstractMessage.zep", 547);
		return;
	}
	if (UNEXPECTED(!(zephir_array_isset(&protocols, protocol)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 29, &_2$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Http/Message/AbstractMessage.zep", 553 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
