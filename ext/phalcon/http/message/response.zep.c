...
PHP_METHOD(Phalcon_Http_Message_Response, __construct) {
	...
	ZVAL_LONG(&_0, code);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processcode", NULL, 281, &_0);
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "w+b");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processbody", NULL, 34, body, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Response, checkCodeValue) {
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$3, "__construct", NULL, 37, &_7$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Response, processCode) {
	...
	ZEPHIR_CALL_METHOD(&phrases, this_ptr, "getphrases", NULL, 283);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodetype", NULL, 284, code);
	zephir_check_call_status();
	_0 = zephir_get_intval(code);
	ZEPHIR_INIT_NVAR(code);
	ZVAL_LONG(code, _0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodevalue", NULL, 285, code);
	zephir_check_call_status();
