...
ZEPHIR_INIT_CLASS(Phalcon_Http_Message_Response) {
	 ...
	 * @var string
	 */
	zend_declare_property_string(phalcon_http_message_response_ce, SL("reasonPhrase"), "", ZEND_ACC_PRIVATE);
	 ...
	 * @var int
	 */
	zend_declare_property_long(phalcon_http_message_response_ce, SL("statusCode"), 200, ZEND_ACC_PRIVATE);
...
PHP_METHOD(Phalcon_Http_Message_Response, __construct) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processheaders", NULL, 277, &headers);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("headers"), &_1);
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "w+b");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processbody", NULL, 35, body, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Response, checkCodeValue) {
	...
	ZVAL_LONG(&_3, 100);
	ZVAL_LONG(&_4, 599);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 280, &_2, &_3, &_4);
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$3, "__construct", NULL, 38, &_7$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Response, processCode) {
	...
	ZEPHIR_CALL_METHOD(&phrases, this_ptr, "getphrases", NULL, 281);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodetype", NULL, 282, code);
	zephir_check_call_status();
	_0 = zephir_get_intval(code);
	ZEPHIR_INIT_NVAR(code);
	ZVAL_LONG(code, _0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkcodevalue", NULL, 283, code);
	zephir_check_call_status();
