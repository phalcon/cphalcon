...
PHP_METHOD(Phalcon_Http_Message_Request, __construct) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processheaders", NULL, 242, headers);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("headers"), &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processuri", NULL, 243, uri);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uri"), &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "processmethod", NULL, 244, &method);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("method"), &_3);
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "w+b");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "processbody", NULL, 245, body, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Request, withMethod) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processmethod", NULL, 244, method);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_Request, withProtocolVersion) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processprotocol", NULL, 249, version);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_Request, getHeaderValue) {
	...
	if (Z_TYPE_P(values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(values), _1)
		{
			...
			ZVAL_COPY(&value, _1);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadervalue", &_3, 252, &value);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Request, processHeaders) {
	...
	if (Z_TYPE_P(headers) == IS_ARRAY) {
		...
		if (_13$$3) {
			...
			ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 250, &_17$$6);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(headers, phalcon_collection_ce TSRMLS_CC)) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Headers needs to be either an array or instance of Phalcon\\Collection", "phalcon/Http/Message/Request.zep", 599);
			return;
		}
	}
