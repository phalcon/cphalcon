...
PHP_METHOD(Phalcon_Http_Message_Request, __construct) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processuri", NULL, 276, uri);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uri"), &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processheaders", NULL, 277, headers);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("headers"), &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "processmethod", NULL, 100, &method);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("method"), &_3);
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "w+b");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "processbody", NULL, 35, body, &_5);
	zephir_check_call_status();
