...
PHP_METHOD(Phalcon_Http_Message_Request, __construct) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processheaders", NULL, 262, headers);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("headers"), &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processuri", NULL, 263, uri);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uri"), &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "processmethod", NULL, 264, &method);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("method"), &_3);
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "w+b");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "processbody", NULL, 265, body, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Request, withAddedHeader) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", NULL, 266, name);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getheadervalue", NULL, 267, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, &headers, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withBody) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "w+b");
	ZEPHIR_CALL_METHOD(&newBody, this_ptr, "processbody", NULL, 265, body, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "body");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, &newBody, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withHeader) {
	...
	ZEPHIR_CPY_WRT(&headers, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getheadervalue", NULL, 267, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, &headers, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withMethod) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processmethod", NULL, 264, method);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "method");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, method, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withProtocolVersion) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processprotocol", NULL, 269, version);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "protocolVersion");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, version, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withRequestTarget) {
	...
	if (UNEXPECTED(zephir_is_true(&_2))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid request target: cannot contain whitespace", "phalcon/Http/Message/Request.zep", 343);
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "requestTarget");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, requestTarget, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, withUri) {
	...
	if (!(_6)) {
		ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 270, uri);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Request, withoutHeader) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 268, &headers, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Request, checkHeaderName) {
	...
	if (UNEXPECTED(_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$3, "phalcon/Http/Message/Request.zep", 427 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_Request, checkHeaderValue) {
	...
	if (UNEXPECTED(_1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value", "phalcon/Http/Message/Request.zep", 479);
		return;
	}
	...
	if (UNEXPECTED(_7)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value", "phalcon/Http/Message/Request.zep", 486);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_Request, getHeaderValue) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(values))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value: must be a string or array of strings; cannot be an empty array", "phalcon/Http/Message/Request.zep", 521);
		return;
	}
	...
	if (Z_TYPE_P(values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(values), _1)
		{
			...
			ZVAL_COPY(&value, _1);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadervalue", &_3, 272, &value);
			zephir_check_call_status();
			zephir_get_strval(&_4$$5, &value);
			zephir_array_append(&valueData, &_4$$5, PH_SEPARATE, "phalcon/Http/Message/Request.zep", 529);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&valueData, &_5$$6, PH_SEPARATE, "phalcon/Http/Message/Request.zep", 529);
...
PHP_METHOD(Phalcon_Http_Message_Request, processBody) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid stream passed as a parameter", "phalcon/Http/Message/Request.zep", 563);
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_Request, processHeaders) {
	...
	if (Z_TYPE_P(headers) == IS_ARRAY) {
		...
		zephir_check_call_status();
		zephir_is_iterable(headers, 0, "phalcon/Http/Message/Request.zep", 588);
		if (Z_TYPE_P(headers) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(headers), _2$$3, _3$$3, _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", &_4, 266, &name);
				zephir_check_call_status();
				zephir_get_strval(&_5$$4, &name);
				ZEPHIR_CPY_WRT(&name, &_5$$4);
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "getheadervalue", &_7, 267, &value);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "getheadervalue", &_7, 267, &value);
					zephir_check_call_status();
		...
		if (_13$$3) {
			...
			ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 270, &_17$$6);
			zephir_check_call_status();
		...
		if (UNEXPECTED(!((zephir_instance_of_ev(headers, phalcon_collection_ce TSRMLS_CC))))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Headers needs to be either an array or instance of Phalcon\\Collection", "phalcon/Http/Message/Request.zep", 597);
			return;
		}
...
PHP_METHOD(Phalcon_Http_Message_Request, processMethod) {
	...
	if (UNEXPECTED(!(_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Http/Message/Request.zep", 628 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_Request, processProtocol) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid protocol value", "phalcon/Http/Message/Request.zep", 649);
		return;
	}
	if (UNEXPECTED(!(zephir_array_isset(&protocols, protocol)))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Http/Message/Request.zep", 655 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_Request, processUri) {
	...
	if (zephir_is_instance_of(uri, SL("Psr\\Http\\Message\\UriInterface") TSRMLS_CC)) {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid uri passed as a parameter", "phalcon/Http/Message/Request.zep", 675);
		return;
	}
