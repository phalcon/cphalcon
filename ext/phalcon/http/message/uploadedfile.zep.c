...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, __construct) {
	...
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstream", NULL, 321, stream, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkerror", NULL, 322, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getStream) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_0, 0))) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "geterrordescription", NULL, 323, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_LONG_IDENTICAL(&_1, 0))) {
		...
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "geterrordescription", NULL, 323, &_4$$4);
		zephir_check_call_status();
	...
	_6 = _5;
	if (_6) {
		ZEPHIR_CALL_FUNCTION(&_7, "dirname", NULL, 324, targetPath);
		zephir_check_call_status();
	...
	_9 = _6;
	if (_9) {
		ZEPHIR_CALL_FUNCTION(&_10, "dirname", NULL, 324, targetPath);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_11, "is_writable", NULL, 325, &_10);
		zephir_check_call_status();
	...
	if (UNEXPECTED(_16)) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "storefile", NULL, 326, targetPath);
		zephir_check_call_status();
	} else {
		zephir_read_property(&_17$$7, this_ptr, SL("fileName"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_18$$7, "move_uploaded_file", NULL, 327, &_17$$7, targetPath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError) {
	...
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 8);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 286, &_2, &_3, &_4);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, storeFile) {
	...
	ZEPHIR_CALL_METHOD(&stream, this_ptr, "getstream", NULL, 328);
	zephir_check_call_status();
