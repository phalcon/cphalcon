...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, __construct) {
	...
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstream", NULL, 302, stream, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkerror", NULL, 303, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getStream) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_2))) {
		...
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "geterrordescription", NULL, 304, &_5$$3);
		zephir_check_call_status();
	...
	if (!(zephir_is_instance_of(&_7, SL("Psr\\Http\\Message\\StreamInterface") TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$5, "__construct", NULL, 272, &_9$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_2, &_3))) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "geterrordescription", NULL, 304, &_6$$4);
		zephir_check_call_status();
	...
	_10 = _8;
	if (_10) {
		ZEPHIR_CALL_FUNCTION(&_11, "is_writable", NULL, 305, &dirname);
		zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "storefile", NULL, 306, targetPath);
		zephir_check_call_status();
	} else {
		zephir_read_property(&_15$$7, this_ptr, SL("fileName"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_16$$7, "move_uploaded_file", NULL, 307, &_15$$7, targetPath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError) {
	...
	zephir_check_call_status();
	ZVAL_LONG(&_5, error);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 308, &_5, &_3, &_4);
	zephir_check_call_status();
	if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_1, error)) {
		do {
			...
			if (_2$$3 == (1 == Z_TYPE_P(stream) == IS_RESOURCE)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 272, stream);
				zephir_check_call_status();
