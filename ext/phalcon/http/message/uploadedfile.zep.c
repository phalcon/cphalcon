...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, __construct) {
	...
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstream", NULL, 304, stream, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkerror", NULL, 305, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getStream) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 95, &_1);
	zephir_check_call_status();
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &_2))) {
		...
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "geterrordescription", NULL, 306, &_5$$3);
		zephir_check_call_status();
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_6))) {
	...
	if (!(zephir_is_instance_of(&_7, SL("Psr\\Http\\Message\\StreamInterface") TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$5, "__construct", NULL, 274, &_9$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_2, &_3))) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "geterrordescription", NULL, 306, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 1, &_5$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "phalcon/Http/Message/UploadedFile.zep", 215 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_FUNCTION(&dirname, "dirname", NULL, 106, targetPath);
	zephir_check_call_status();
	...
	_8 = _7;
	if (_8) {
		ZEPHIR_CALL_FUNCTION(&_9, "is_dir", NULL, 98, &dirname);
		zephir_check_call_status();
		_8 = zephir_is_true(&_9);
	}
	_10 = _8;
	if (_10) {
		ZEPHIR_CALL_FUNCTION(&_11, "is_writable", NULL, 307, &dirname);
		zephir_check_call_status();
		_10 = zephir_is_true(&_11);
	}
	if (UNEXPECTED(!(_10))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_ce, "Target folder is empty string, not a folder or not writable", "phalcon/Http/Message/UploadedFile.zep", 226);
		return;
	}
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "PHP_SAPI");
	ZEPHIR_CALL_FUNCTION(&sapi, "constant", NULL, 95, &_1);
	zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "storefile", NULL, 308, targetPath);
		zephir_check_call_status();
	} else {
		zephir_read_property(&_15$$7, this_ptr, SL("fileName"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_16$$7, "move_uploaded_file", NULL, 309, &_15$$7, targetPath);
		zephir_check_call_status();
		if (UNEXPECTED(!zephir_is_true(&_16$$7))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_ce, "The file cannot be moved to the target folder", "phalcon/Http/Message/UploadedFile.zep", 240);
			return;
		}
	}
	if (1) {
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 95, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "UPLOAD_ERR_EXTENSION");
	ZEPHIR_CALL_FUNCTION(&_4, "constant", NULL, 95, &_2);
	zephir_check_call_status();
	ZVAL_LONG(&_5, error);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 310, &_5, &_3, &_4);
	zephir_check_call_status();
	if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_ce, "Invalid 'error'. Must be one of the UPLOAD_ERR_* constants", "phalcon/Http/Message/UploadedFile.zep", 255);
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkStream) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "constant", NULL, 95, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG_IDENTICAL(&_1, error)) {
		do {
			...
			if (_2$$3 == (1 == Z_TYPE_P(stream) == IS_RESOURCE)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 274, stream);
				zephir_check_call_status();
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_http_message_exception_ce, "Invalid stream or file passed", "phalcon/Http/Message/UploadedFile.zep", 278);
			return;
		} while(0);
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getErrorDescription) {
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_4, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_5, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_6, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_7, "constant", NULL, 95, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_8, "constant", NULL, 95, &_0);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, storeFile) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "w+b");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 61, &targetPath, &_0);
	zephir_check_call_status();
