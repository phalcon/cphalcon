...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, __construct) {
	...
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstream", NULL, 284, stream, &_0);
	zephir_check_call_status();
	ZVAL_LONG(&_0, error);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkerror", NULL, 285, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getStream) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 286, &_1);
	zephir_check_call_status();
	if (!ZEPHIR_IS_IDENTICAL(&_0, &_2)) {
		...
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "geterrordescription", NULL, 287, &_5$$3);
		zephir_check_call_status();
	...
	if (!(zephir_is_instance_of(&_7, SL("Psr\\Http\\Message\\StreamInterface") TSRMLS_CC))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$5, "__construct", NULL, 253, &_9$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo) {
	...
	if (!ZEPHIR_IS_IDENTICAL(&_2, &_3)) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "geterrordescription", NULL, 287, &_6$$4);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&dirname, "dirname", NULL, 288, targetPath);
	zephir_check_call_status();
	...
	_8 = _7;
	if (_8) {
		ZEPHIR_CALL_FUNCTION(&_9, "is_dir", NULL, 113, &dirname);
		zephir_check_call_status();
		_8 = zephir_is_true(&_9);
	}
	_10 = _8;
	if (_10) {
		ZEPHIR_CALL_FUNCTION(&_11, "is_writable", NULL, 289, &dirname);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&sapi, "constant", NULL, 286, &_1);
	zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "storefile", NULL, 290, targetPath);
		zephir_check_call_status();
	} else {
		zephir_read_property(&_15$$7, this_ptr, SL("fileName"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_16$$7, "move_uploaded_file", NULL, 291, &_15$$7, targetPath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 286, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "UPLOAD_ERR_EXTENSION");
	ZEPHIR_CALL_FUNCTION(&_4, "constant", NULL, 286, &_2);
	zephir_check_call_status();
	ZVAL_LONG(&_5, error);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 292, &_5, &_3, &_4);
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkStream) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "constant", NULL, 286, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG_IDENTICAL(&_1, error)) {
		do {
			...
			if (_2$$3 == (1 == Z_TYPE_P(stream) == IS_RESOURCE)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", NULL, 253, stream);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, getErrorDescription) {
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_4, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_5, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_6, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_7, "constant", NULL, 286, &_0);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_8, "constant", NULL, 286, &_0);
		zephir_check_call_status();
