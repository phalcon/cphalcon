...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, moveTo)
{
	...
	if (_6) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_8, "is_dir", NULL, 136, &_7);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&sapi, "constant", NULL, 128, &_12);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_UploadedFile, checkError)
{
	...
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 8);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_number_ce, "between", &_1, 290, &_2, &_3, &_4);
	zephir_check_call_status();
