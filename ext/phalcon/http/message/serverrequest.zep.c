...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, __construct) {
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, body)) {
		...
		ZEPHIR_CALL_METHOD(NULL, body, "__construct", NULL, 262);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkuploadedfiles", NULL, 291, &uploadFiles);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processprotocol", NULL, 292, &protocol);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("protocolVersion"), &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processmethod", NULL, 293, &method);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("method"), &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "processheaders", NULL, 294, headers);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("headers"), &_3);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "processuri", NULL, 295, uri);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uri"), &_4);
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "w+b");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "processbody", NULL, 296, body, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_6, "__construct", NULL, 92);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withAddedHeader) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", NULL, 297, name);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("headers"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getheadervalue", NULL, 298, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &headers, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withAttribute) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &attributes, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withBody) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "w+b");
	ZEPHIR_CALL_METHOD(&newBody, this_ptr, "processbody", NULL, 296, body, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "body");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &newBody, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withCookieParams) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &cookies, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withHeader) {
	...
	ZEPHIR_CPY_WRT(&headers, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getheadervalue", NULL, 298, value);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &headers, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withMethod) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processmethod", NULL, 293, method);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "method");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, method, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withParsedBody) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, data, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withProtocolVersion) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processprotocol", NULL, 292, version);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "protocolVersion");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, version, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withQueryParams) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &query, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withRequestTarget) {
	...
	if (UNEXPECTED(zephir_is_true(&_2))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid request target: cannot contain whitespace", "phalcon/Http/Message/ServerRequest.zep", 580);
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "requestTarget");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, requestTarget, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withUploadedFiles) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkuploadedfiles", NULL, 291, &uploadedFiles);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "uploadedFiles");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &uploadedFiles, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withUri) {
	...
	if (!(_6)) {
		ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 300, uri);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withoutHeader) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 299, &headers, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, checkHeaderName) {
	...
	if (UNEXPECTED(_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$3, "__construct", NULL, 272, &_6$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$3, "phalcon/Http/Message/ServerRequest.zep", 701 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, checkHeaderValue) {
	...
	if (UNEXPECTED(_1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value", "phalcon/Http/Message/ServerRequest.zep", 753);
		return;
	}
	...
	if (UNEXPECTED(_7)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value", "phalcon/Http/Message/ServerRequest.zep", 760);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, checkUploadedFiles) {
	...
	zephir_is_iterable(&files, 0, "phalcon/Http/Message/ServerRequest.zep", 781);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
	{
		ZEPHIR_INIT_NVAR(&file);
		ZVAL_COPY(&file, _0);
		if (Z_TYPE_P(&file) == IS_ARRAY) {
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkuploadedfiles", &_1, 291, &file);
			zephir_check_call_status();
		} else {
			_2$$5 = Z_TYPE_P(&file) == IS_OBJECT;
			if (_2$$5) {
				_2$$5 = zephir_is_instance_of(&file, SL("Psr\\Http\\Message\\UploadedFileInterface") TSRMLS_CC);
			}
			if (UNEXPECTED(!(_2$$5))) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid uploaded file", "phalcon/Http/Message/ServerRequest.zep", 776);
				return;
			}
		}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, getHeaderValue) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(values))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid header value: must be a string or array of strings; cannot be an empty array", "phalcon/Http/Message/ServerRequest.zep", 814);
		return;
	}
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(values), _0)
	{
		...
		ZVAL_COPY(&value, _0);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadervalue", &_1, 301, &value);
		zephir_check_call_status();
		zephir_get_strval(&_2$$5, &value);
		zephir_array_append(&valueData, &_2$$5, PH_SEPARATE, "phalcon/Http/Message/ServerRequest.zep", 822);
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&value);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, processBody) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid stream passed as a parameter", "phalcon/Http/Message/ServerRequest.zep", 856);
		return;
	}
	object_init_ex(return_value, phalcon_http_message_stream_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 274, body, &mode);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, processHeaders) {
	...
	if (Z_TYPE_P(headers) == IS_ARRAY) {
		...
		zephir_check_call_status();
		zephir_is_iterable(headers, 0, "phalcon/Http/Message/ServerRequest.zep", 881);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(headers), _1$$3, _2$$3, _0$$3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkheadername", &_3, 297, &name);
			zephir_check_call_status();
			zephir_get_strval(&_4$$4, &name);
			ZEPHIR_CPY_WRT(&name, &_4$$4);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "getheadervalue", &_6, 298, &value);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&value, &_5$$4);
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_7, 275, &name, &value);
			zephir_check_call_status();
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&value);
		ZEPHIR_INIT_NVAR(&name);
		...
		ZEPHIR_CALL_METHOD(&_8$$3, &collection, "has", NULL, 276, &_9$$3);
		zephir_check_call_status();
		...
		if (_10$$3) {
			...
			ZEPHIR_CALL_METHOD(&host, this_ptr, "geturihost", NULL, 300, &_14$$5);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_7, 275, &_16$$5, &_15$$5);
			zephir_check_call_status();
		}
	} else {
		if (zephir_instance_of_ev(headers, phalcon_collection_ce TSRMLS_CC)) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Headers need to be either an array or instance of Phalcon\\Collection", "phalcon/Http/Message/ServerRequest.zep", 892);
			return;
		}
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, processMethod) {
	...
	if (UNEXPECTED(!(_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 272, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Http/Message/ServerRequest.zep", 921 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, processProtocol) {
	...
	if (UNEXPECTED(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid protocol value", "phalcon/Http/Message/ServerRequest.zep", 942);
		return;
	}
	if (UNEXPECTED(!(zephir_array_isset(&protocols, protocol)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 272, &_2$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Http/Message/ServerRequest.zep", 948 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, processUri) {
	...
	if (zephir_is_instance_of(uri, SL("Psr\\Http\\Message\\UriInterface") TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &localUri, "__construct", NULL, 277, uri);
		zephir_check_call_status();
	} else {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "Invalid uri passed as a parameter", "phalcon/Http/Message/ServerRequest.zep", 968);
		return;
	}
