...
PHP_METHOD(Phalcon_Http_Message_Uri, __construct)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &uri))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "filterfragment", NULL, 336, &_2$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_9$$3, "rawurlencode", NULL, 236, &_8$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "filterpath", NULL, 337, &_11$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_12$$3, this_ptr, "filterport", NULL, 338, &_13$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_15$$3, this_ptr, "filterquery", NULL, 339, &_16$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_17$$3, this_ptr, "filterscheme", NULL, 340, &_18$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_20$$3, "rawurlencode", NULL, 236, &_19$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, __toString)
{
	...
	ZEPHIR_CALL_METHOD(&authority, this_ptr, "getauthority", NULL, 341);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, ":");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "checkvalue", NULL, 342, &_0, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "//");
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "checkvalue", NULL, 342, &authority, &_7);
	zephir_check_call_status();
	zephir_read_property(&_11, this_ptr, ZEND_STRL("query"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "?");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "checkvalue", NULL, 342, &_11, &_7);
	zephir_check_call_status();
	zephir_read_property(&_13, this_ptr, ZEND_STRL("fragment"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "#");
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "checkvalue", NULL, 342, &_13, &_7);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&uri);
...
PHP_METHOD(Phalcon_Http_Message_Uri, getAuthority)
{
	...
	ZEPHIR_CALL_METHOD(&userInfo, this_ptr, "getuserinfo", NULL, 343);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "");
...
PHP_METHOD(Phalcon_Http_Message_Uri, withFragment)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterfragment", NULL, 336, fragment);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPath)
{
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "filterpath", NULL, 337, path);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPort)
{
	...
	if (UNEXPECTED(Z_TYPE_P(port) != IS_NULL)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "filterport", NULL, 338, port);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withQuery)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "filterquery", NULL, 339, query);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withScheme)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterscheme", NULL, 340, scheme);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(scheme, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "scheme");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 344, scheme, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Message_Uri, withUserInfo)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "rawurlencode", NULL, 236, user);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(user, &_0);
	if (UNEXPECTED(Z_TYPE_P(password) != IS_NULL)) {
		ZEPHIR_CALL_FUNCTION(&_1$$4, "rawurlencode", NULL, 236, password);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withHost)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "host");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 344, host, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterFragment)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 236, &fragment);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterPath)
{
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _4, _5, _2)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$4, "rawurlencode", &_7, 236, &element);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_8$$5, "rawurlencode", &_7, 236, &element);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterQuery)
{
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _5, _6, _3)
		{
			...
			ZVAL_COPY(&part, _3);
			ZEPHIR_CALL_METHOD(&split, this_ptr, "splitqueryvalue", &_7, 345, &part);
			zephir_check_call_status();
			...
			if (UNEXPECTED(Z_TYPE_P(&_8$$4) == IS_NULL)) {
				...
				ZEPHIR_CALL_FUNCTION(&_10$$5, "rawurlencode", &_11, 236, &_9$$5);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_13$$4, "rawurlencode", &_11, 236, &_12$$4);
			zephir_check_call_status();
			zephir_array_fetch_long(&_14$$4, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 594);
			ZEPHIR_CALL_FUNCTION(&_15$$4, "rawurlencode", &_11, 236, &_14$$4);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(Z_TYPE_P(&_17$$6) == IS_NULL)) {
					...
					ZEPHIR_CALL_FUNCTION(&_19$$7, "rawurlencode", &_11, 236, &_18$$7);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_21$$6, "rawurlencode", &_11, 236, &_20$$6);
				zephir_check_call_status();
				zephir_array_fetch_long(&_22$$6, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 594);
				ZEPHIR_CALL_FUNCTION(&_23$$6, "rawurlencode", &_11, 236, &_22$$6);
				zephir_check_call_status();
