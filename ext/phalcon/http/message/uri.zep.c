...
PHP_METHOD(Phalcon_Http_Message_Uri, __construct) {
	...
	if (!ZEPHIR_IS_IDENTICAL(&_0, &uri)) {
		ZEPHIR_CALL_FUNCTION(&urlParts, "parse_url", NULL, 243, &uri);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(&urlParts)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_InvalidArgumentException, "The source URI string appears to be malformed", "phalcon/http/message/uri.zep", 117);
			return;
		}
		...
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&scheme, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "host");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&host, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "port");
		ZVAL_NULL(&_4$$3);
		ZEPHIR_CALL_CE_STATIC(&port, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "user");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&user, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "pass");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&pass, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "path");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&path, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "query");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&query, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "fragment");
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "");
		ZEPHIR_CALL_CE_STATIC(&fragment, phalcon_helper_arr_ce, "get", &_1, 73, &urlParts, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "filterscheme", NULL, 244, &scheme);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "filterport", NULL, 245, &port);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("port"), &_6$$3);
		ZEPHIR_CALL_FUNCTION(&_7$$3, "rawurlencode", NULL, 193, &user);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("user"), &_7$$3);
		ZEPHIR_CALL_FUNCTION(&_8$$3, "rawurlencode", NULL, 193, &pass);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("pass"), &_8$$3);
		ZEPHIR_CALL_METHOD(&_9$$3, this_ptr, "filterpath", NULL, 246, &path);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("path"), &_9$$3);
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "filterquery", NULL, 247, &query);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("query"), &_10$$3);
		ZEPHIR_CALL_METHOD(&_11$$3, this_ptr, "filterfragment", NULL, 248, &fragment);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withFragment) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 249, fragment, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withHost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 249, host, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPath) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, path, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "?");
	ZEPHIR_INIT_NVAR(&_1);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 235, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/http/message/uri.zep", 333 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_4);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_5)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_6$$4, "__construct", NULL, 235, &_7$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_6$$4, "phalcon/http/message/uri.zep", 339 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "filterpath", NULL, 246, path);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(path, &_8);
	ZEPHIR_INIT_VAR(&_9);
	ZVAL_STRING(&_9, "path");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 251, path, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPort) {
	...
	if (Z_TYPE_P(port) != IS_NULL) {
		...
		if (!(_0$$3)) {
			ZEPHIR_CALL_FUNCTION(&_1$$3, "is_float", NULL, 183, port);
			zephir_check_call_status();
		...
		if (_0$$3) {
			...
			if (Z_TYPE_P(port) != IS_STRING) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$7, "__construct", NULL, 235, &_3$$7);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_2$$7, "phalcon/http/message/uri.zep", 376 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "filterport", NULL, 245, port);
		zephir_check_call_status();
	...
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_7$$8, "__construct", NULL, 235, &_8$$8);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_7$$8, "phalcon/http/message/uri.zep", 384 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_9);
	ZVAL_STRING(&_9, "port");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 251, port, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withQuery) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, query, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "#");
	ZEPHIR_INIT_NVAR(&_1);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 235, &_3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/http/message/uri.zep", 410 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "filterquery", NULL, 247, query);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(query, &_4);
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "query");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 251, query, &_5);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withScheme) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, scheme, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "filterscheme", NULL, 244, scheme);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Uri:withScheme");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 249, scheme, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withUserInfo) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, user, &_0, &_1);
	zephir_check_call_status();
	if (Z_TYPE_P(password) != IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, user, &_2$$3, &_3$$3);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&_4, "rawurlencode", NULL, 193, user);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(user, &_4);
	if (Z_TYPE_P(password) != IS_NULL) {
		ZEPHIR_CALL_FUNCTION(&_5$$4, "rawurlencode", NULL, 193, password);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, checkStringParameter) {
	...
	if (Z_TYPE_P(element) != IS_STRING) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$5, "__construct", NULL, 235, &_1$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterFragment) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 193, &fragment);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterPath) {
	...
	zephir_is_iterable(&parts, 1, "phalcon/http/message/uri.zep", 574);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _3, _4, _2)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_5$$4, "rawurlencode", &_6, 193, &element);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterQuery) {
	...
	zephir_is_iterable(&parts, 1, "phalcon/http/message/uri.zep", 647);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _4, _5, _3)
	{
		...
		if (1 != zephir_array_isset_long(&split, 1)) {
			zephir_array_append(&split, &__$null, PH_SEPARATE, "phalcon/http/message/uri.zep", 636);
		}
		zephir_array_fetch_long(&_6$$5, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/message/uri.zep", 639 TSRMLS_CC);
		if (Z_TYPE_P(&_6$$5) == IS_NULL) {
			zephir_array_fetch_long(&_7$$7, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/message/uri.zep", 640 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_8$$7, "rawurlencode", &_9, 193, &_7$$7);
			zephir_check_call_status();
			zephir_array_update_zval(&parts, &key, &_8$$7, PH_COPY | PH_SEPARATE);
			continue;
		} else {
			zephir_array_fetch_long(&_10$$8, &split, 0, PH_NOISY | PH_READONLY, "phalcon/http/message/uri.zep", 643 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_11$$8, "rawurlencode", &_9, 193, &_10$$8);
			zephir_check_call_status();
			zephir_array_fetch_long(&_12$$8, &split, 1, PH_NOISY | PH_READONLY, "phalcon/http/message/uri.zep", 643 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_13$$8, "rawurlencode", &_9, 193, &_12$$8);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterScheme) {
	...
	if (1 != zephir_array_isset(&schemes, &filtered)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 235, &_6$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "phalcon/http/message/uri.zep", 674 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CTOR(&scheme);
...
PHP_METHOD(Phalcon_Http_Message_Uri, processWith) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 250, element, &property, &method);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 251, element, &property);
	zephir_check_call_status();
	RETURN_MM();
