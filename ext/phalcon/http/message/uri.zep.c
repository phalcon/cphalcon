...
PHP_METHOD(Phalcon_Http_Message_Uri, __construct)
{
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &uri))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_9$$3, "rawurlencode", NULL, 261, &_8$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "filterpath", NULL, 365, &_11$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_12$$3, this_ptr, "filterport", NULL, 366, &_13$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_15$$3, this_ptr, "filterquery", NULL, 367, &_16$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_17$$3, this_ptr, "filterscheme", NULL, 368, &_18$$3);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_20$$3, "rawurlencode", NULL, 261, &_19$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withUserInfo)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "rawurlencode", NULL, 261, user);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(user, &_0);
	if (UNEXPECTED(Z_TYPE_P(password) != IS_NULL)) {
		ZEPHIR_CALL_FUNCTION(&_1$$4, "rawurlencode", NULL, 261, password);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterFragment)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 261, &fragment);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterPath)
{
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _4, _5, _2)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$4, "rawurlencode", &_7, 261, &element);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_8$$5, "rawurlencode", &_7, 261, &element);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _5, _6, _3)
		{
			...
			if (UNEXPECTED(Z_TYPE_P(&_8$$4) == IS_NULL)) {
				...
				ZEPHIR_CALL_FUNCTION(&_10$$5, "rawurlencode", &_11, 261, &_9$$5);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_13$$4, "rawurlencode", &_11, 261, &_12$$4);
			zephir_check_call_status();
			zephir_array_fetch_long(&_14$$4, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 594);
			ZEPHIR_CALL_FUNCTION(&_15$$4, "rawurlencode", &_11, 261, &_14$$4);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(Z_TYPE_P(&_17$$6) == IS_NULL)) {
					...
					ZEPHIR_CALL_FUNCTION(&_19$$7, "rawurlencode", &_11, 261, &_18$$7);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_21$$6, "rawurlencode", &_11, 261, &_20$$6);
				zephir_check_call_status();
				zephir_array_fetch_long(&_22$$6, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 594);
				ZEPHIR_CALL_FUNCTION(&_23$$6, "rawurlencode", &_11, 261, &_22$$6);
				zephir_check_call_status();
