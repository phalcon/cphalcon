...
PHP_METHOD(Phalcon_Http_Message_Stream, getContents) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 76);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkreadable", NULL, 77);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "stream_get_contents", NULL, 78, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, getMetadata) {
	...
	ZEPHIR_CALL_FUNCTION(&metadata, "stream_get_meta_data", NULL, 79, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, getSize) {
	...
	if (EXPECTED(Z_TYPE_P(&_0) != IS_NULL)) {
		zephir_read_property(&_1$$3, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&stats, "fstat", NULL, 80, &_1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, isReadable) {
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "r+");
	ZEPHIR_CALL_FUNCTION(&_3, "strpbrk", NULL, 81, &mode, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, read) {
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "fread", NULL, 82, &_0, length);
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&data))) {
...
PHP_METHOD(Phalcon_Http_Message_Stream, seek) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 76);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkseekable", NULL, 83);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&seeker, "fseek", NULL, 84, &_0, offset, whence);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, setStream) {
	...
	if (EXPECTED(Z_TYPE_P(stream) == IS_STRING)) {
		...
		ZVAL_LONG(&_1$$3, 2);
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 85, &_0$$3, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 86, stream, &mode);
		zephir_check_call_status();
	...
	_3 = _2;
	if (!(_3)) {
		ZEPHIR_CALL_FUNCTION(&_4, "get_resource_type", NULL, 88, &handle);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_5);
...
PHP_METHOD(Phalcon_Http_Message_Stream, tell) {
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&position, "ftell", NULL, 89, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, write) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 76);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkwritable", NULL, 90);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
