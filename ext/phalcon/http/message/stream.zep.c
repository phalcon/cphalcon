...
PHP_METHOD(Phalcon_Http_Message_Stream, getContents)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 79);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkreadable", NULL, 80);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "stream_get_contents", NULL, 81, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, getMetadata)
{
	...
	ZEPHIR_CALL_FUNCTION(&metadata, "stream_get_meta_data", NULL, 82, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getarrval", NULL, 83, &metadata, key, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Message_Stream, getSize)
{
	...
	if (EXPECTED(Z_TYPE_P(&_0) != IS_NULL)) {
		zephir_read_property(&_1$$3, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&stats, "fstat", NULL, 84, &_1$$3);
		zephir_check_call_status();
		if (EXPECTED(!ZEPHIR_IS_FALSE_IDENTICAL(&stats))) {
			ZEPHIR_INIT_VAR(&_2$$4);
			ZVAL_STRING(&_2$$4, "size");
			ZVAL_NULL(&_3$$4);
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getarrval", NULL, 83, &stats, &_2$$4, &_3$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
...
PHP_METHOD(Phalcon_Http_Message_Stream, isReadable)
{
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "r+");
	ZEPHIR_CALL_FUNCTION(&_3, "strpbrk", NULL, 85, &mode, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, read)
{
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "fread", NULL, 86, &_0, length);
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&data))) {
...
PHP_METHOD(Phalcon_Http_Message_Stream, seek)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 79);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkseekable", NULL, 87);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&seeker, "fseek", NULL, 88, &_0, offset, whence);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, setStream)
{
	...
	if (EXPECTED(Z_TYPE_P(stream) == IS_STRING)) {
		...
		ZVAL_STRING(&_1$$3, ">=");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "version_compare", NULL, 90, &version, &_0$$3, &_1$$3);
		zephir_check_call_status();
		if (zephir_is_true(&_2$$3)) {
			...
			ZVAL_LONG(&_4$$4, 2);
			ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 91, &_3$$4, &_4$$4);
			zephir_check_call_status();
		} else {
			...
			ZVAL_LONG(&_6$$5, 2);
			ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 91, &_5$$5, &_6$$5);
			zephir_check_call_status();
		}
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 92, stream, &mode);
		zephir_check_call_status();
	...
	_8 = _7;
	if (!(_8)) {
		ZEPHIR_CALL_FUNCTION(&_9, "get_resource_type", NULL, 94, &handle);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_10);
...
PHP_METHOD(Phalcon_Http_Message_Stream, tell)
{
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&position, "ftell", NULL, 95, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, write)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 79);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkwritable", NULL, 96);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, ZEND_STRL("handle"), PH_NOISY_CC | PH_READONLY);
