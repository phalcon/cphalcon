...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, createServerRequest) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 292, &method, uri, &serverParams);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, load) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checknullarray", NULL, 293, &server, &_SERVER);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&server, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checknullarray", NULL, 293, &files, &_FILES);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&files, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", NULL, 293, &cookies, &_COOKIE);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&cookies, &_2);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", NULL, 293, &get, &_GET);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&get, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "checknullarray", NULL, 293, &post, &_POST);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&post, &_3);
	ZEPHIR_CALL_METHOD(&serverCollection, this_ptr, "parseserver", NULL, 294, &server);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_4);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&headers, this_ptr, "parseheaders", NULL, 295, &serverCollection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&filesCollection, this_ptr, "parseuploadedfiles", NULL, 296, &files);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_6)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&cookies, this_ptr, "parsecookieheader", NULL, 297, &_8$$3);
		zephir_check_call_status();
	}
	object_init_ex(return_value, phalcon_http_message_serverrequest_ce);
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "parseuri", NULL, 298, &serverCollection, &headers);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 292, &method, &_10, &_11, &_4, &_12, &cookies, &get, &_13, &post, &protocol);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriPath) {
	...
	if (UNEXPECTED(Z_TYPE_P(&requestUri) != IS_NULL)) {
		...
		ZVAL_STRING(&_6$$4, "");
		ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 38, &_5$$4, &_6$$4, &requestUri);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseCookieHeader) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "strtr", NULL, 80, &cookieHeader, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseHeaders) {
	...
	object_init_ex(&headers, phalcon_collection_collection_ce);
	ZEPHIR_CALL_METHOD(NULL, &headers, "__construct", NULL, 11);
	zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&serverArray), _2, _3, _0)
		{
			...
			if (EXPECTED(!ZEPHIR_IS_IDENTICAL(&_4$$3, &value))) {
				...
				if (EXPECTED(ZEPHIR_IS_LONG_IDENTICAL(&_12$$4, 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &headers, "set", &_18, 31, &name, &value);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseServer) {
	...
	ZEPHIR_CALL_METHOD(NULL, &collection, "__construct", NULL, 11, &server);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_2)) {
		...
		object_init_ex(&headersCollection, phalcon_collection_collection_ce);
		ZEPHIR_CALL_METHOD(NULL, &headersCollection, "__construct", NULL, 11, &headers);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		...
		if (UNEXPECTED(zephir_is_true(&_3$$3))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", NULL, 31, &_6$$4, &_5$$4);
			zephir_check_call_status();
		}
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUploadedFiles) {
	...
	if (Z_TYPE_P(&files) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&files), _2, _3, _0)
		{
			...
			if (UNEXPECTED(_5$$3)) {
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 31, &key, &file);
				zephir_check_call_status();
				continue;
			}
			...
			if (EXPECTED(_7$$3)) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 31, &key, &_8$$5);
				zephir_check_call_status();
				continue;
			}
			if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
				ZEPHIR_CALL_METHOD(&data, this_ptr, "parseuploadedfiles", &_10, 296, &file);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_11$$6, &data, "toarray", &_12, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 31, &key, &_11$$6);
				zephir_check_call_status();
				continue;
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (EXPECTED(_15$$7)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 31, &key, &_16$$9);
					zephir_check_call_status();
					continue;
				}
				if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 31, &key, &_17$$10);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUri) {
	...
	ZEPHIR_CALL_METHOD(NULL, &uri, "__construct", NULL, 93);
	zephir_check_call_status();
