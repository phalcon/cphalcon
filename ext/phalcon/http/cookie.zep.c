...
PHP_METHOD(Phalcon_Http_Cookie, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 867, &name_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 868, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 869, &path_zv);
	if (secure) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 870, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 870, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 871, &domain_zv);
	if (httpOnly) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 872, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 872, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 873, &options);
...
PHP_METHOD(Phalcon_Http_Cookie, getValue)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 875, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 876, PH_NOISY_CC | PH_READONLY);
		if (zephir_is_true(&_1$$3)) {
			zephir_read_property_cached(&_2$$5, this_ptr, _zephir_prop_3, 877, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_2$$5, this_ptr, _zephir_prop_4, 878, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 874, &decryptedValue);
		if (Z_TYPE_P(filters) != IS_NULL) {
			zephir_read_property_cached(&_7$$11, this_ptr, _zephir_prop_6, 879, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CPY_WRT(&filter, &_7$$11);
			if (Z_TYPE_P(&filter) != IS_OBJECT) {
				if (Z_TYPE_P(&container) == IS_NULL) {
					zephir_read_property_cached(&_8$$13, this_ptr, _zephir_prop_3, 877, PH_NOISY_CC | PH_READONLY);
				...
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 879, &filter);
			}
...
PHP_METHOD(Phalcon_Http_Cookie, restore)
{
	...
	if (!(zephir_is_true(&_0))) {
		...
		if (Z_TYPE_P(&session) != IS_NULL) {
			...
			zephir_check_call_status();
			zephir_memory_observe(&expire);
			if (zephir_array_isset_string_fetch(&expire, &definition, SL("expire"), 0)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 868, &expire);
			}
			zephir_memory_observe(&domain);
			if (zephir_array_isset_string_fetch(&domain, &definition, SL("domain"), 0)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 871, &domain);
			}
			zephir_memory_observe(&path);
			if (zephir_array_isset_string_fetch(&path, &definition, SL("path"), 0)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 869, &path);
			}
			zephir_memory_observe(&secure);
			if (zephir_array_isset_string_fetch(&secure, &definition, SL("secure"), 0)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 870, &secure);
			}
			zephir_memory_observe(&httpOnly);
			if (zephir_array_isset_string_fetch(&httpOnly, &definition, SL("httpOnly"), 0)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 872, &httpOnly);
			}
...
PHP_METHOD(Phalcon_Http_Cookie, send)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&name, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 874, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&value, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 868, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&expire, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 871, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&domain, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 869, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&path, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_5, 870, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&secure, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_6, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&httpOnly, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_7, 873, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&options, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_8, 877, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_9, 876, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		...
		zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_10, 878, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_11, this_ptr, _zephir_prop_2, 868, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Cookie, setDomain)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkrestored", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 871, &domain_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setExpiration)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 868, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 873, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setPath)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkrestored", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 869, &path_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setSignKey)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 878, &signKey_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setValue)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 874, value);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Http_Cookie, getCookieOptions)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 871, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_2);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 869, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "path");
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 870, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_2);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_4, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_2);
