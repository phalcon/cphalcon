...
PHP_METHOD(Phalcon_Http_Cookie, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 860, &name_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 861, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 862, &path_zv);
	if (secure) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 863, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 863, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 864, &domain_zv);
	if (httpOnly) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 865, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 865, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 866, &options);
...
PHP_METHOD(Phalcon_Http_Cookie, delete)
{
	...
	ZEPHIR_CALL_METHOD(&domain, this_ptr, "getdomain", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&path, this_ptr, "getpath", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&secure, this_ptr, "getsecure", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&httpOnly, this_ptr, "gethttponly", NULL, 0);
	zephir_check_call_status();
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 867, &__$null);
...
PHP_METHOD(Phalcon_Http_Cookie, getValue)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 869, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_3, 870, PH_NOISY_CC | PH_READONLY);
		if (zephir_is_true(&_2$$4)) {
			zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_4, 871, PH_NOISY_CC | PH_READONLY);
			...
			if (UNEXPECTED(Z_TYPE_P(&crypt) != IS_OBJECT)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_7$$8, "phalcon/Http/Cookie.zep", 274);
				ZEPHIR_MM_RESTORE();
				return;
			}
			zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_5, 872, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 867, &decryptedValue);
		if (Z_TYPE_P(filters) != IS_NULL) {
			zephir_read_property_cached(&_8$$12, this_ptr, _zephir_prop_7, 873, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CPY_WRT(&filter, &_8$$12);
			if (Z_TYPE_P(&filter) != IS_OBJECT) {
				if (Z_TYPE_P(&container) == IS_NULL) {
					zephir_read_property_cached(&_9$$14, this_ptr, _zephir_prop_4, 871, PH_NOISY_CC | PH_READONLY);
					...
					if (Z_TYPE_P(&container) == IS_NULL) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$15, "phalcon/Http/Cookie.zep", 313);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
				...
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 873, &filter);
			}
	...
	if (!(zephir_is_true(&_0))) {
		...
		if (Z_TYPE_P(&session) != IS_NULL) {
			...
			if (zephir_array_isset_string_fetch(&expire, &definition, SL("expire"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 861, &expire);
			}
			if (zephir_array_isset_string_fetch(&domain, &definition, SL("domain"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 864, &domain);
			}
			if (zephir_array_isset_string_fetch(&path, &definition, SL("path"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 862, &path);
			}
			if (zephir_array_isset_string_fetch(&secure, &definition, SL("secure"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 863, &secure);
			}
			if (zephir_array_isset_string_fetch(&httpOnly, &definition, SL("httpOnly"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 865, &httpOnly);
			}
...
PHP_METHOD(Phalcon_Http_Cookie, send)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 860, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&name, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 867, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&value, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 861, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&expire, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 864, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&domain, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 862, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&path, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_5, 863, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&secure, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_6, 865, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&httpOnly, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_7, 866, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&options, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_8, 871, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_9, 870, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		if (Z_TYPE_P(&container) == IS_NULL) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_4$$6, "phalcon/Http/Cookie.zep", 429);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (UNEXPECTED(Z_TYPE_P(&crypt) != IS_OBJECT)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_7$$7, "phalcon/Http/Cookie.zep", 435);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_10, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Http_Cookie, setDomain)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 864, &domain_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setExpiration)
{
	...
	ZVAL_UNDEF(&_1);
	ZVAL_LONG(&_1, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 861, &_1);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setHttpOnly)
{
	...
	if (httpOnly) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 865, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 865, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 866, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setPath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 862, &path_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setSecure)
{
	...
	if (secure) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 863, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 863, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setSignKey)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 872, &signKey_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setValue)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 867, value);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 869, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 869, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Http_Cookie, assertSignKeyIsLongEnough)
{
	...
	if (UNEXPECTED(ZEPHIR_LT_LONG(&length, 32))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Http/Cookie.zep", 609);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
