...
PHP_METHOD(Phalcon_Http_Cookie, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 852, &name_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 853, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 854, &path_zv);
	if (secure) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 855, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 855, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 856, &domain_zv);
	if (httpOnly) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 857, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 857, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 858, &options);
...
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$null, domain, httpOnly, name, options, path, secure, session, _0, _2, _3, _4, _5, _6, _7, _8, _1$$3;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 856, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&domain, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 854, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&path, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 855, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&secure, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 857, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&httpOnly, &_0);
	ZEPHIR_CALL_METHOD(&session, this_ptr, "getstartedsession", NULL, 0);
	zephir_check_call_status();
	if (Z_TYPE_P(&session) != IS_NULL) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "getsessionkey", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &session, "remove", NULL, 0, &_1$$3);
		zephir_check_call_status();
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 859, &__$null);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_6, 858, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getarrval", NULL, 0, &options, &_4, &_0);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("expires"), &_2, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "domain");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "getarrval", NULL, 0, &options, &_4, &domain);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("domain"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "path");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "getarrval", NULL, 0, &options, &_4, &path);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("path"), &_6, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "secure");
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "getarrval", NULL, 0, &options, &_4, &secure);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("secure"), &_7, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "httponly");
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "getarrval", NULL, 0, &options, &_4, &httpOnly);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("httponly"), &_8, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "");
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 0, &name, &_4, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Http_Cookie, getValue)
{
	...
	if (UNEXPECTED(!_zephir_prop_2)) {
		_zephir_prop_2 = zend_string_init("isRead", 6, 1);
	}
	if (UNEXPECTED(!_zephir_prop_3)) {
		_zephir_prop_3 = zend_string_init("useEncryption", 13, 1);
	}
	if (UNEXPECTED(!_zephir_prop_4)) {
		_zephir_prop_4 = zend_string_init("container", 9, 1);
	}
	if (UNEXPECTED(!_zephir_prop_5)) {
		_zephir_prop_5 = zend_string_init("signKey", 7, 1);
	}
	if (UNEXPECTED(!_zephir_prop_6)) {
		_zephir_prop_6 = zend_string_init("value", 5, 1);
	}
	if (UNEXPECTED(!_zephir_prop_7)) {
		_zephir_prop_7 = zend_string_init("filter", 6, 1);
	}
	...
	ZVAL_NULL(&container);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 852, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&name, &_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 861, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_3, 862, PH_NOISY_CC | PH_READONLY);
		if (zephir_is_true(&_2$$4)) {
			zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_4, 863, PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&container) == IS_NULL) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_4$$7, "phalcon/Http/Cookie.zep", 262);
				ZEPHIR_MM_RESTORE();
				return;
			}
			...
			if (UNEXPECTED(Z_TYPE_P(&crypt) != IS_OBJECT)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_7$$8, "phalcon/Http/Cookie.zep", 268);
				ZEPHIR_MM_RESTORE();
				return;
			}
			zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_5, 864, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 859, &decryptedValue);
		if (Z_TYPE_P(filters) != IS_NULL) {
			zephir_read_property_cached(&_8$$12, this_ptr, _zephir_prop_7, 865, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CPY_WRT(&filter, &_8$$12);
			if (Z_TYPE_P(&filter) != IS_OBJECT) {
				if (Z_TYPE_P(&container) == IS_NULL) {
					zephir_read_property_cached(&_9$$14, this_ptr, _zephir_prop_4, 863, PH_NOISY_CC | PH_READONLY);
					...
					if (Z_TYPE_P(&container) == IS_NULL) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$15, "phalcon/Http/Cookie.zep", 307);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
				...
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 865, &filter);
			}
	...
	if (!(zephir_is_true(&_0))) {
		...
		if (Z_TYPE_P(&session) != IS_NULL) {
			...
			if (zephir_array_isset_string_fetch(&expire, &definition, SL("expire"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 853, &expire);
			}
			if (zephir_array_isset_string_fetch(&domain, &definition, SL("domain"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 856, &domain);
			}
			if (zephir_array_isset_string_fetch(&path, &definition, SL("path"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 854, &path);
			}
			if (zephir_array_isset_string_fetch(&secure, &definition, SL("secure"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 855, &secure);
			}
			if (zephir_array_isset_string_fetch(&httpOnly, &definition, SL("httpOnly"), 1)) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 857, &httpOnly);
			}
		...
		if (1) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 860, &__$true);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 860, &__$false);
		}
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, send)
{
	zval _9$$8, _10$$9;
	zend_bool _3;
	zval container, crypt, definition, encryptValue, expire, domain, httpOnly, name, options, path, secure, session, signKey, value, _0, _1, _11, _12, _13, _14, _15, _2$$4, _4$$6, _5$$5, _6$$5, _8$$5, _7$$7;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 852, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&name, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 859, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&value, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 853, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&expire, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 856, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&domain, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 854, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&path, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_5, 855, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&secure, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_6, 857, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&httpOnly, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_7, 858, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&options, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_8, 863, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_9, 862, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		if (Z_TYPE_P(&container) == IS_NULL) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_4$$6, "phalcon/Http/Cookie.zep", 423);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (UNEXPECTED(Z_TYPE_P(&crypt) != IS_OBJECT)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_7$$7, "phalcon/Http/Cookie.zep", 429);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_10, 864, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_11);
	ZVAL_STRING(&_11, "expires");
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getarrval", NULL, 0, &options, &_11, &expire);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("expires"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_11);
	ZVAL_STRING(&_11, "domain");
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "getarrval", NULL, 0, &options, &_11, &domain);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("domain"), &_12, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_11);
	ZVAL_STRING(&_11, "path");
	ZEPHIR_CALL_METHOD(&_13, this_ptr, "getarrval", NULL, 0, &options, &_11, &path);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("path"), &_13, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_11);
	ZVAL_STRING(&_11, "secure");
	ZEPHIR_CALL_METHOD(&_14, this_ptr, "getarrval", NULL, 0, &options, &_11, &secure);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("secure"), &_14, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_11);
	ZVAL_STRING(&_11, "httponly");
	ZEPHIR_CALL_METHOD(&_15, this_ptr, "getarrval", NULL, 0, &options, &_11, &httpOnly);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("httponly"), &_15, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Http_Cookie, setDomain)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 856, &domain_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setExpiration)
{
	...
	ZVAL_UNDEF(&_1);
	ZVAL_LONG(&_1, expire);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 853, &_1);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setHttpOnly)
{
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("httpOnly", 8, 1);
	}
	...
	if (httpOnly) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 857, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 857, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setOptions)
{
	...
	zephir_get_arrval(&options, options_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 858, &options);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setPath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 854, &path_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setSecure)
{
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("secure", 6, 1);
	}
	...
	if (secure) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 855, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 855, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setSignKey)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 864, &signKey_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Http_Cookie, setValue)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 859, value);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 861, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 861, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Http_Cookie, assertSignKeyIsLongEnough)
{
	...
	if (UNEXPECTED(ZEPHIR_LT_LONG(&length, 32))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Http/Cookie.zep", 603);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
