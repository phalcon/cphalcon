...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_http_request_getclientaddress, 0, 0, MAY_BE_STRING|MAY_BE_BOOL)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_phalcon_http_request_getjsonrawbody, 0, 0, stdClass, MAY_BE_ARRAY|MAY_BE_BOOL)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_http_request_processfiles, 0, 4, IS_ARRAY, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_http_request_phpfgetcsv, 0, 1, MAY_BE_ARRAY|MAY_BE_FALSE)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_http_request_phpfileexists, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_http_request_phpfilegetcontents, 0, 1, MAY_BE_FALSE|MAY_BE_STRING)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_http_request_phpfileputcontents, 0, 2, MAY_BE_FALSE|MAY_BE_LONG)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	ZEND_ARG_INFO(0, data)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_http_request_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, mode, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_http_request_phpfwrite, 0, 2, MAY_BE_FALSE|MAY_BE_LONG)
	ZEND_ARG_INFO(0, handle)
...
ZEPHIR_INIT_FUNCS(phalcon_http_request_method_entry) {
	...
	PHP_ME(Phalcon_Http_Request, phpFclose, arginfo_phalcon_http_request_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFgetCsv, arginfo_phalcon_http_request_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFileExists, arginfo_phalcon_http_request_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFileGetContents, arginfo_phalcon_http_request_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFilePutContents, arginfo_phalcon_http_request_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFopen, arginfo_phalcon_http_request_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpFwrite, arginfo_phalcon_http_request_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpIsWritable, arginfo_phalcon_http_request_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Http_Request, phpUnlink, arginfo_phalcon_http_request_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
