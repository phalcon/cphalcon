...
PHP_METHOD(Phalcon_Debug, onUncaughtException) {
	...
	if (zephir_is_true(&showBackTrace)) {
		...
		zephir_concat_self(&html, &_9$$5 TSRMLS_CC);
		...
		if (Z_TYPE_P(&_10$$5) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_10$$5), _13$$5, _14$$5, _11$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_15$$7, this_ptr, "showtraceitem", &_16, 201, &n, &traceItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_17$$8, this_ptr, "showtraceitem", &_16, 201, &n, &traceItem);
					zephir_check_call_status();
					zephir_concat_self(&html, &_17$$8 TSRMLS_CC);
		...
		zephir_concat_self(&html, &_18$$5 TSRMLS_CC);
		...
		ZEPHIR_CALL_CE_STATIC(&blacklist, phalcon_helper_arr_ce, "get", &_19, 12, &_37$$5, &_38$$5, &_22$$5);
		zephir_check_call_status();
		...
		zephir_concat_self(&html, &_50$$5 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_51$$5, "get_included_files", NULL, 203);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&_51$$5) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_51$$5), _54$$5, _55$$5, _52$$5)
			{
				...
				ZEPHIR_INIT_LNVAR(_56$$21);
				ZEPHIR_CONCAT_SVSVS(&_56$$21, "<tr><td>", &keyFile, "</th><td>", &value, "</td></tr>");
				zephir_concat_self(&html, &_56$$21 TSRMLS_CC);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_57$$22);
					ZEPHIR_CONCAT_SVSVS(&_57$$22, "<tr><td>", &keyFile, "</th><td>", &value, "</td></tr>");
					zephir_concat_self(&html, &_57$$22 TSRMLS_CC);
		...
		ZEPHIR_INIT_NVAR(&keyFile);
		zephir_concat_self_str(&html, SL("</table></div>") TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_58$$5, "memory_get_usage", NULL, 204, &__$true);
		zephir_check_call_status();
		...
		zephir_concat_self(&html, &_59$$5 TSRMLS_CC);
		if (Z_TYPE_P(&dataVars) == IS_ARRAY) {
			...
			zephir_concat_self(&html, &_60$$23 TSRMLS_CC);
			...
			if (Z_TYPE_P(&dataVars) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&dataVars), _63$$23, _64$$23, _61$$23)
				{
					...
					zephir_array_fetch_long(&_66$$24, &dataVar, 0, PH_NOISY | PH_READONLY, "phalcon/Debug.zep", 365 TSRMLS_CC);
					...
					zephir_concat_self(&html, &_67$$24 TSRMLS_CC);
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						zephir_array_fetch_long(&_69$$25, &dataVar, 0, PH_NOISY | PH_READONLY, "phalcon/Debug.zep", 365 TSRMLS_CC);
						ZEPHIR_CALL_METHOD(&_68$$25, this_ptr, "getvardump", &_45, 0, &_69$$25);
						zephir_check_call_status();
						ZEPHIR_INIT_LNVAR(_70$$25);
						ZEPHIR_CONCAT_SVSVS(&_70$$25, "<tr><td class='key'>", &keyVar, "</td><td>", &_68$$25, "</td></tr>");
						zephir_concat_self(&html, &_70$$25 TSRMLS_CC);
	...
	zephir_concat_self(&html, &_72 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Debug, onUncaughtLowSeverity) {
	...
	if (UNEXPECTED(zephir_is_true(&_1))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Debug.zep", 398 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Debug, showTraceItem) {
	...
	if (zephir_array_isset_string_fetch(&className, &trace, SL("class"), 0)) {
		...
		if (zephir_is_true(&_4$$3)) {
			...
			zephir_fast_explode_str(&parts, SL("\\"), &className, LONG_MAX TSRMLS_CC);
			zephir_array_fetch_long(&_6$$4, &parts, 0, PH_NOISY | PH_READONLY, "phalcon/Debug.zep", 633 TSRMLS_CC);
			zephir_array_fetch_long(&_7$$4, &parts, 1, PH_NOISY | PH_READONLY, "phalcon/Debug.zep", 633 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_13$$3, &trace, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Debug.zep", 666 TSRMLS_CC);
		zephir_concat_self(&html, &_13$$3 TSRMLS_CC);
	}
	ZEPHIR_OBS_VAR(&functionName);
	zephir_array_fetch_string(&functionName, &trace, SL("function"), PH_NOISY, "phalcon/Debug.zep", 672 TSRMLS_CC);
	...
	if (zephir_array_isset_string_fetch(&filez, &trace, SL("file"), 0)) {
		...
		zephir_array_fetch_string(&_27$$17, &trace, SL("line"), PH_NOISY, "phalcon/Debug.zep", 732 TSRMLS_CC);
		...
		if (zephir_is_true(&showFiles)) {
			...
			while (1) {
				...
				zephir_array_fetch(&currentLine, &lines, &linePosition, PH_NOISY, "phalcon/Debug.zep", 805 TSRMLS_CC);
				if (zephir_is_true(&showFileFragment)) {
