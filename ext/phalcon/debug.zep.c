...
PHP_METHOD(Phalcon_Debug, listenExceptions) {
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 153, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, listenLowSeverity) {
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 154, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 153, &_2);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, onUncaughtException) {
	...
	if (zephir_is_true(&showBackTrace)) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_11$$5), _13$$5, _14$$5, _12$$5)
		{
			...
			ZEPHIR_CALL_METHOD(&_15$$7, this_ptr, "showtraceitem", &_16, 156, &n, &traceItem);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_CE_STATIC(&blacklist, phalcon_helper_arr_ce, "get", &_17, 157, &_18$$5, &_20$$5, &_19$$5);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_REQUEST), _22$$5, _23$$5, _21$$5)
		{
			...
			if (1 != zephir_array_isset(&blacklist, &_24$$8)) {
				if (Z_TYPE_P(&value) != IS_ARRAY) {
					...
					ZEPHIR_CALL_FUNCTION(&_26$$11, "print_r", &_27, 158, &value, &__$true);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_CE_STATIC(&blacklist, phalcon_helper_arr_ce, "get", &_17, 157, &_29$$5, &_30$$5, &_20$$5);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_38$$5, "get_included_files", NULL, 159);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_43$$5, "memory_get_usage", NULL, 160, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, setBlacklist) {
	...
	ZEPHIR_CALL_CE_STATIC(&area, phalcon_helper_arr_ce, "get", &_0, 157, &blacklist, &_2, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&area, phalcon_helper_arr_ce, "get", &_0, 157, &blacklist, &_5, &_2);
	zephir_check_call_status();
