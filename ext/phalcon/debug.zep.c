		...
		if (zephir_is_true(&showFiles)) {
			...
			while (1) {
				...
				if (_38$$24) {
					...
					ZEPHIR_CALL_FUNCTION(&_44$$29, "htmlentities", &_45, 161, &_39$$29, &_42$$29, &_43$$29);
					zephir_check_call_status();
	...
	if (zephir_is_true(&showBackTrace)) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_REQUEST), _17$$5, _18$$5, _16$$5)
		{
			...
			if (Z_TYPE_P(&value) != IS_ARRAY) {
				...
				ZEPHIR_CALL_FUNCTION(&_20$$10, "print_r", &_21, 173, &value, &__$true);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_34$$5, "memory_get_usage", NULL, 175, &__$true);
		zephir_check_call_status();
