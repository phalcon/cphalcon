...
PHP_METHOD(Phalcon_Di_FactoryDefault_Cli, __construct)
{
	...
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 150, &_2, &_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	object_init_ex(&_1, phalcon_di_service_ce);
	ZEPHIR_CALL_METHOD(&_4, &filter, "newinstance", NULL, 186);
	zephir_check_call_status();
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 150, &_4, &_3);
	zephir_check_call_status();
	...
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 150, &_5, &_3);
	zephir_check_call_status();
