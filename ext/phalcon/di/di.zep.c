...
PHP_METHOD(Phalcon_Di_Di, __call)
{
	...
	if (zephir_start_with_str(&method_zv, SL("get"))) {
		...
		ZEPHIR_CALL_FUNCTION(&possibleService, "lcfirst", NULL, 175, &_1$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 164, PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_start_with_str(&method_zv, SL("set"))) {
		...
		if (zephir_array_isset_long_fetch(&definition, &arguments, 0, 0)) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$6, "lcfirst", NULL, 175, &_4$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di_Di, attempt)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 164, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 176, definition, &_2);
	zephir_check_call_status();
	zephir_update_property_array(this_ptr, SL("services"), &name_zv, &_1);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 164, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Di_Di, get)
{
	...
	ZVAL_NULL(&service);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "resolvealias", NULL, 177, &name);
	zephir_check_call_status();
	zephir_get_strval(&name, &_0);
	ZEPHIR_OBS_NVAR(&service);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 164, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&service, &_1, &name, 0)) {
		...
		if (_2$$3) {
			zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_1, 165, PH_NOISY_CC | PH_READONLY);
			_2$$3 = zephir_array_isset_value(&_3$$3, &name);
		}
		if (_2$$3) {
			zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_1, 165, PH_NOISY_CC | PH_READONLY);
			zephir_array_fetch(&_5$$4, &_4$$4, &name, PH_NOISY | PH_READONLY, "phalcon/Di/Di.zep", 195);
			RETURN_CTOR(&_5$$4);
		}
	}
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 166, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_6) != IS_NULL) {
		zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_2, 166, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&service) != IS_NULL) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_10$$7, phalcon_di_exception_serviceresolutionexception_ce)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", NULL, 178, &name);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_12$$9, "phalcon/Di/Di.zep", 220);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
			...
			if (UNEXPECTED(!(zephir_class_exists(&name, 1)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_13$$12, "phalcon/Di/Di.zep", 233);
				ZEPHIR_MM_RESTORE();
				return;
			}
	...
	zephir_read_property_cached(&_15, this_ptr, _zephir_prop_2, 166, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_15) != IS_NULL) {
		zephir_read_property_cached(&_16$$18, this_ptr, _zephir_prop_2, 166, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Di_Di, getAlias)
{
	...
	ZVAL_STR_COPY(&name_zv, name);
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 167, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_value(&_1, &name_zv)) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 167, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_NVAR(&_0);
...
PHP_METHOD(Phalcon_Di_Di, getShared)
{
	...
	zephir_check_call_status();
	zephir_get_strval(&name, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 165, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 165, PH_NOISY_CC | PH_READONLY);
...
{
	zend_bool _8, _3$$3, _9$$4;
	zend_string *_2;
	zend_ulong _1;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_6 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *config, config_sub, services, name, service, *_0, _7, _4$$3, _5$$3, _10$$4, _11$$4;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&services) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&services), _1, _2, _0)
		{
			...
			_3$$3 = zephir_array_isset_value_string(&service, SL("shared"));
			if (_3$$3) {
				ZEPHIR_OBS_NVAR(&_4$$3);
				zephir_array_fetch_string(&_4$$3, &service, SL("shared"), PH_NOISY, "phalcon/Di/Di.zep", 374);
		...
		while (1) {
			...
			zephir_check_call_status();
				_9$$4 = zephir_array_isset_value_string(&service, SL("shared"));
				if (_9$$4) {
					ZEPHIR_OBS_NVAR(&_10$$4);
					zephir_array_fetch_string(&_10$$4, &service, SL("shared"), PH_NOISY, "phalcon/Di/Di.zep", 374);
					_9$$4 = zephir_is_true(&_10$$4);
				}
				ZVAL_BOOL(&_11$$4, _9$$4);
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "set", &_6, 0, &name, &service, &_11$$4);
				zephir_check_call_status();
		}
	}
	ZEPHIR_INIT_NVAR(&service);
...
PHP_METHOD(Phalcon_Di_Di, loadFromPhp)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &services, "__construct", NULL, 179, &filePath_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di_Di, loadFromYaml)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &services, "__construct", NULL, 180, &filePath_zv, &callbacks);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadfromconfig", NULL, 0, &services);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Di_Di, remove)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *name_param = NULL, alias, aliases, services, sharedInstances, target, _0, _1, *_2, _6, _5$$3, _8$$5;
	zval name;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 164, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&services, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 165, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sharedInstances, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "resolvealias", NULL, 177, &name);
	zephir_check_call_status();
	zephir_get_strval(&name, &_1);
	zephir_array_unset(&services, &name, PH_SEPARATE);
	zephir_array_unset(&sharedInstances, &name, PH_SEPARATE);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 167, PH_NOISY_CC | PH_READONLY);
	zephir_is_iterable(&_0, 0, "phalcon/Di/Di.zep", 587);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _3, _4, _2)
		{
			...
			ZVAL_COPY(&target, _2);
			ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "resolvealias", NULL, 177, &target);
			zephir_check_call_status();
			if (ZEPHIR_IS_IDENTICAL(&name, &_5$$3)) {
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&alias, &_0, "key", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&target, &_0, "current", NULL, 0);
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_8$$5, this_ptr, "resolvealias", NULL, 177, &target);
				zephir_check_call_status();
				if (ZEPHIR_IS_IDENTICAL(&name, &_8$$5)) {
					zephir_array_unset(&aliases, &alias, PH_SEPARATE);
				}
		}
	}
	ZEPHIR_INIT_NVAR(&target);
	ZEPHIR_INIT_NVAR(&alias);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 167, &aliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 164, &services);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 165, &sharedInstances);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Di_Di, removeShared)
{
	...
	zephir_fetch_params(1, 1, 0, &name_param);
	zephir_get_strval(&name, name_param);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 165, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sharedInstances, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "resolvealias", NULL, 177, &name);
	zephir_check_call_status();
	zephir_get_strval(&name, &_1);
	zephir_array_unset(&sharedInstances, &name, PH_SEPARATE);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 165, &sharedInstances);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 164, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_value(&_0, &name)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 164, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&service);
		zephir_array_fetch(&service, &_2$$3, &name, PH_NOISY, "phalcon/Di/Di.zep", 617);
		ZVAL_NULL(&_3$$3);
...
PHP_METHOD(Phalcon_Di_Di, set)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 164, PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch(&_4, &_3, &name, PH_NOISY | PH_READONLY, "phalcon/Di/Di.zep", 642);
	RETURN_CTOR(&_4);
}
...
{
	zend_bool _11, _6$$5, _13$$8;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL, *_9 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval name_zv, *aliases, aliases_sub, alias, currentAliases, localAliases, _0, *_3, _10, _1$$3, _2$$4, _4$$6, _7$$5, _8$$7, _12$$9, _14$$8, _15$$10;
	zend_string *name = NULL;
	zval *this_ptr = getThis();
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Di/Di.zep", 659);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_memory_observe(&currentAliases);
	zephir_read_property_cached(&currentAliases, this_ptr, _zephir_prop_0, 167, PH_NOISY_CC);
	...
	zephir_is_iterable(&localAliases, 0, "phalcon/Di/Di.zep", 680);
	if (Z_TYPE_P(&localAliases) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&localAliases), _3)
		{
			...
			if (Z_TYPE_P(&alias) != IS_STRING) {
				...
				object_init_ex(&_4$$6, phalcon_di_exceptions_aliasnamemustbestring_ce);
				ZEPHIR_CALL_METHOD(NULL, &_4$$6, "__construct", &_5, 181);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_4$$6, "phalcon/Di/Di.zep", 670);
				ZEPHIR_MM_RESTORE();
				return;
			}
			_6$$5 = 1 == zephir_array_isset_value(&currentAliases, &alias);
			if (!(_6$$5)) {
				ZEPHIR_CALL_METHOD(&_7$$5, this_ptr, "has", NULL, 0, &alias);
				zephir_check_call_status();
				_6$$5 = ZEPHIR_IS_TRUE_IDENTICAL(&_7$$5);
			}
			if (_6$$5) {
				ZEPHIR_INIT_NVAR(&_8$$7);
				object_init_ex(&_8$$7, phalcon_di_exceptions_aliasalreadyinuse_ce);
				ZEPHIR_CALL_METHOD(NULL, &_8$$7, "__construct", &_9, 182, &alias);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_8$$7, "phalcon/Di/Di.zep", 674);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_10, &localAliases, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_10)) {
				break;
			}
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&alias) != IS_STRING) {
					...
					object_init_ex(&_12$$9, phalcon_di_exceptions_aliasnamemustbestring_ce);
					ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", &_5, 181);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_12$$9, "phalcon/Di/Di.zep", 670);
					ZEPHIR_MM_RESTORE();
					return;
				}
				_13$$8 = 1 == zephir_array_isset_value(&currentAliases, &alias);
				if (!(_13$$8)) {
					ZEPHIR_CALL_METHOD(&_14$$8, this_ptr, "has", NULL, 0, &alias);
					zephir_check_call_status();
					_13$$8 = ZEPHIR_IS_TRUE_IDENTICAL(&_14$$8);
				}
				if (_13$$8) {
					ZEPHIR_INIT_NVAR(&_15$$10);
					object_init_ex(&_15$$10, phalcon_di_exceptions_aliasalreadyinuse_ce);
					ZEPHIR_CALL_METHOD(NULL, &_15$$10, "__construct", &_9, 182, &alias);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_15$$10, "phalcon/Di/Di.zep", 674);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_update_zval(&currentAliases, &alias, &name_zv, PH_COPY | PH_SEPARATE);
	...
	ZEPHIR_INIT_NVAR(&alias);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 167, &currentAliases);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Di_Di, setInternalEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 166, eventsManager);
}
...
PHP_METHOD(Phalcon_Di_Di, resolveAlias)
{
	...
	while (1) {
		...
		if (zephir_array_isset_value(&seen, &current)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", &_2, 183, &name_zv);
			zephir_check_call_status();
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 167, PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_4$$3, &_3$$3, &current, PH_NOISY | PH_READONLY, "phalcon/Di/Di.zep", 739);
