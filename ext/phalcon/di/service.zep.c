...
PHP_METHOD(Phalcon_Di_Service, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 653, definition);
	if (shared) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 654, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 654, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Di_Service, getParameter)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 653, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Di_Service, resolve)
{
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 655, PH_NOISY_CC | PH_READONLY);
	...
	ZVAL_NULL(&instance);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 653, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 654, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_3)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 655, &instance);
	}
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 656, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 656, &__$false);
	}
...
PHP_METHOD(Phalcon_Di_Service, setShared)
{
	...
	if (shared) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 654, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 654, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Di_Service, setSharedInstance)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 655, sharedInstance);
}
