...
PHP_METHOD(Phalcon_Di_Service, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 615, definition);
	if (shared) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 616, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 616, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Di_Service, getParameter)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 615, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 615, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Di_Service, resolve)
{
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 617, PH_NOISY_CC | PH_READONLY);
	...
	ZVAL_NULL(&instance);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 615, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&definition) == IS_STRING) {
		...
		if (Z_TYPE_P(&definition) == IS_OBJECT) {
			...
			if (Z_TYPE_P(&definition) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&instance, &builder, "build", NULL, 507, container, &definition, parameters);
				zephir_check_call_status();
			} else {
				found = 0;
			}
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 616, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_3)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 617, &instance);
	}
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 618, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 618, &__$false);
	}
...
PHP_METHOD(Phalcon_Di_Service, setShared)
{
	...
	if (shared) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 616, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 616, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Di_Service, setSharedInstance)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 617, sharedInstance);
}
