...
PHP_METHOD(Phalcon_Di_Service, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 665, definition);
	if (shared) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 666, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 666, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Di_Service, getParameter)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 665, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 665, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Di_Service, resolve)
{
	...
	ZVAL_NULL(&instance);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 665, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&definition) == IS_STRING) {
		...
		if (Z_TYPE_P(&definition) == IS_OBJECT) {
			...
			if (Z_TYPE_P(&definition) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&instance, &builder, "build", NULL, 0, container, &definition, parameters);
				zephir_check_call_status();
			} else {
				found = 0;
			}
	...
	if (zephir_is_true(&_3)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 667, &instance);
	}
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 668, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 668, &__$false);
	}
...
PHP_METHOD(Phalcon_Di_Service, setSharedInstance)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 667, sharedInstance);
}
