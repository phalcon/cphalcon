...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Di\\Exceptions, UnknownServiceType, phalcon, di_exceptions_unknownservicetype, phalcon_di_exception_ce, phalcon_di_exceptions_unknownservicetype_method_entry, 0);
...
PHP_METHOD(Phalcon_Di_Exceptions_UnknownServiceType, __construct)
{
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_di_exceptions_unknownservicetype_ce, getThis(), "__construct", NULL, 0, &_1);
