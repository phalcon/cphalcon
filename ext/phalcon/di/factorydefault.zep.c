...
PHP_METHOD(Phalcon_Di_FactoryDefault, __construct)
{
	...
	zephir_array_update_string(&_7, SL("arguments"), &_8, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "tag");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "set", NULL, 0, &_2, &_7);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
