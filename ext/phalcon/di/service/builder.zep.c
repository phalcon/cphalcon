...
PHP_METHOD(Phalcon_Di_Service_Builder, _buildParameters) {
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&arguments), _2, _3, _0)
		{
			...
			ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "_buildparameter", &_5, 172, dependencyInjector, &position, &argument);
			zephir_check_call_status();
			zephir_array_append(&buildArguments, &_4$$3, PH_SEPARATE, "phalcon/di/service/builder.zep", 105);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "_buildparameter", &_5, 172, dependencyInjector, &position, &argument);
				zephir_check_call_status();
				zephir_array_append(&buildArguments, &_6$$4, PH_SEPARATE, "phalcon/di/service/builder.zep", 105);
		...
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _3$$10, _4$$10, _1$$10)
			{
				...
				if (Z_TYPE_P(&method) != IS_ARRAY) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_5$$14, "phalcon/di/service/builder.zep", 181 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$15, "phalcon/di/service/builder.zep", 188 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
					if (Z_TYPE_P(&arguments) != IS_ARRAY) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$17, "phalcon/di/service/builder.zep", 199 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					if (zephir_fast_count_int(&arguments TSRMLS_CC)) {
						ZEPHIR_INIT_NVAR(&_12$$18);
						ZEPHIR_CALL_METHOD(&_13$$18, this_ptr, "_buildparameters", NULL, 173, dependencyInjector, &arguments);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&method) != IS_ARRAY) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_15$$20, "phalcon/di/service/builder.zep", 181 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&methodName);
					if (!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$21, "phalcon/di/service/builder.zep", 188 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
						if (Z_TYPE_P(&arguments) != IS_ARRAY) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_20$$23, "phalcon/di/service/builder.zep", 199 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						if (zephir_fast_count_int(&arguments TSRMLS_CC)) {
							ZEPHIR_INIT_NVAR(&_22$$24);
							ZEPHIR_CALL_METHOD(&_23$$24, this_ptr, "_buildparameters", NULL, 173, dependencyInjector, &arguments);
							zephir_check_call_status();
		...
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _27$$25, _28$$25, _25$$25)
			{
				...
				if (Z_TYPE_P(&property) != IS_ARRAY) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_29$$29, "phalcon/di/service/builder.zep", 247 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_31$$30, "phalcon/di/service/builder.zep", 254 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_33$$31, "phalcon/di/service/builder.zep", 261 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_CALL_METHOD(&_35$$28, this_ptr, "_buildparameter", &_36, 172, dependencyInjector, &propertyPosition, &propertyValue);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&property) != IS_ARRAY) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_37$$33, "phalcon/di/service/builder.zep", 247 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyName);
					if (!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_39$$34, "phalcon/di/service/builder.zep", 254 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&propertyValue);
					if (!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_41$$35, "phalcon/di/service/builder.zep", 261 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_CALL_METHOD(&_43$$32, this_ptr, "_buildparameter", &_36, 172, dependencyInjector, &propertyPosition, &propertyValue);
					zephir_check_call_status();
