...
PHP_METHOD(Phalcon_Di_Service_Builder, build)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&className, &definition, SL("className"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 451);
	...
	if (Z_TYPE_P(parameters) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&arguments, &definition, SL("arguments"), 0)) {
			ZEPHIR_CALL_METHOD(&_1$$8, this_ptr, "buildparameters", NULL, 452, container, &arguments);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&instance);
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("calls"), 0)) {
		if (UNEXPECTED(Z_TYPE_P(&instance) != IS_OBJECT)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_2$$11, "__construct", NULL, 453);
			zephir_check_call_status();
		...
		if (UNEXPECTED(Z_TYPE_P(&paramCalls) != IS_ARRAY)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$12, "__construct", NULL, 454);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _5$$10, _6$$10, _4$$10)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&method) != IS_ARRAY)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_7$$14, "__construct", &_8, 455, &methodPosition);
					zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_9$$15, "__construct", &_10, 456, &methodPosition);
					zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
					if (UNEXPECTED(Z_TYPE_P(&arguments) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_11$$17, "__construct", &_13, 457, &_12$$17);
						zephir_check_call_status();
					...
					if (zephir_fast_count_int(&arguments)) {
						...
						ZEPHIR_CALL_METHOD(&_15$$18, this_ptr, "buildparameters", NULL, 452, container, &arguments);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&method) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_19$$20, "__construct", &_8, 455, &methodPosition);
						zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&methodName, &method, SL("method"), 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_20$$21, "__construct", &_10, 456, &methodPosition);
						zephir_check_call_status();
					...
					if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
						if (UNEXPECTED(Z_TYPE_P(&arguments) != IS_ARRAY)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_22$$23, "__construct", &_13, 457, &_23$$23);
							zephir_check_call_status();
						...
						if (zephir_fast_count_int(&arguments)) {
							...
							ZEPHIR_CALL_METHOD(&_25$$24, this_ptr, "buildparameters", NULL, 452, container, &arguments);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("properties"), 0)) {
		if (UNEXPECTED(Z_TYPE_P(&instance) != IS_OBJECT)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_27$$26, "__construct", NULL, 458);
			zephir_check_call_status();
		...
		if (UNEXPECTED(Z_TYPE_P(&paramCalls) != IS_ARRAY)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_28$$27, "__construct", NULL, 454);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _30$$25, _31$$25, _29$$25)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&property) != IS_ARRAY)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_32$$29, "__construct", &_33, 459, &propertyPosition);
					zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_34$$30, "__construct", &_35, 460, &propertyPosition);
					zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_36$$31, "__construct", &_37, 461, &propertyPosition);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_36$$31, "phalcon/Di/Service/Builder.zep", 179);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_CALL_METHOD(&_38$$28, this_ptr, "buildparameter", &_39, 462, container, &propertyPosition, &propertyValue);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&property) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_42$$33, "__construct", &_33, 459, &propertyPosition);
						zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyName, &property, SL("name"), 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_43$$34, "__construct", &_35, 460, &propertyPosition);
						zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_string_fetch(&propertyValue, &property, SL("value"), 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_44$$35, "__construct", &_37, 461, &propertyPosition);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_44$$35, "phalcon/Di/Service/Builder.zep", 179);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_CALL_METHOD(&_45$$32, this_ptr, "buildparameter", &_39, 462, container, &propertyPosition, &propertyValue);
					zephir_check_call_status();
	...
	do {
		if (ZEPHIR_IS_STRING(&type, "service")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&name, &argument, SL("name"), 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", NULL, 464, &_3$$5, &_4$$5);
				zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(&type, "parameter")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&value, &argument, SL("value"), 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_5$$7, "__construct", NULL, 464, &_6$$7, &_7$$7);
				zephir_check_call_status();
		...
		if (ZEPHIR_IS_STRING(&type, "instance")) {
			...
			if (UNEXPECTED(!(zephir_array_isset_string_fetch(&name, &argument, SL("className"), 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_8$$9, "__construct", NULL, 464, &_9$$9, &_10$$9);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$11, "__construct", NULL, 465, &_12$$11);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di_Service_Builder, buildParameters)
{
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&arguments), _1, _2, _0)
		{
			...
			ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "buildparameter", &_4, 462, container, &position, &argument);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "buildparameter", &_4, 462, container, &position, &argument);
				zephir_check_call_status();
