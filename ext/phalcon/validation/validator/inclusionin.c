...
PHP_METHOD(Phalcon_Validation_Validator_InclusionIn, validate) {
	...
	zval *validation, *field, *value, *domain, *message = NULL, *label = NULL, *replacePairs, *_0, *_1, *_2 = NULL, *_3, *_4;
	...
	if (!(zephir_is_true(_1))) {
		...
		array_init_size(replacePairs, Resource id #1734);
