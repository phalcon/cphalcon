...
PHP_METHOD(Phalcon_Validation_Validator_Numericality, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *message = NULL, *label = NULL, *replacePairs = NULL, *code = NULL, *_0, *_1, _2, *_4$$3 = NULL, *_5$$3 = NULL, *_6$$3;
	...
	if (!(_3)) {
		_3 = !(zephir_is_numeric(value));
	}
	if (_3) {
		ZEPHIR_CALL_METHOD(&label, this_ptr, "preparelabel", NULL, 0, validation, field);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_4$$3);
		ZVAL_STRING(_4$$3, "Numericality", ZEPHIR_TEMP_PARAM_COPY);
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "strtr", NULL, 27, message, replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_6$$3);
		ZVAL_STRING(_6$$3, "Numericality", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _4$$3, "__construct", NULL, 478, _5$$3, field, _6$$3, code);
