...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value, *message = NULL, *replacePairs = NULL, *types, *byteUnits, *maxSize, *matches, *bytes, *tmp, *width, *height, *minResolution, *maxResolution, *minWidth = NULL, *maxWidth, *minHeight = NULL, *maxHeight, *_0, *_1, *_2 = NULL, *_3 = NULL, *_4, *_5, *_6 = NULL, *_7 = NULL, *_8, _9 = zval_used_for_init, *_10, *_11, *_12, *_13 = NULL, *_14 = NULL, *_15 = NULL, *_16 = NULL, _17 = zval_used_for_init, *_18 = NULL, *_19;
	...
	if (((((!zephir_array_isset_string(value, SS("error")) || !zephir_array_isset_string(value, SS("name"))) || !zephir_array_isset_string(value, SS("type"))) || !zephir_array_isset_string(value, SS("tmp_name"))) || !zephir_array_isset_string(value, SS("size")))) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			...
			ZVAL_STRING(message, "File :field is not valid", 1);
		}
		ZEPHIR_INIT_BNVAR(_1);
	...
	if ((!ZEPHIR_IS_LONG(_4, 0) || !zephir_is_true(_2))) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			ZEPHIR_INIT_NVAR(message);
			ZVAL_STRING(message, "File :field must not be empty", 1);
		}
		ZEPHIR_INIT_NVAR(_3);
	...
	if (ZEPHIR_IS_LONG(_8, 1)) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			ZEPHIR_INIT_NVAR(message);
			ZVAL_STRING(message, "The uploaded file exceeds the max filesize", 1);
		}
		ZEPHIR_INIT_NVAR(_2);
	...
	if (zephir_is_true(_2)) {
		...
		zephir_array_fetch_long(&_12, byteUnits, (0 == 1), PH_NOISY | PH_READONLY TSRMLS_CC);
		ZEPHIR_SINIT_NVAR(_9);
		ZVAL_LONG(&_9, 2);
		ZEPHIR_INIT_NVAR(_7);
		zephir_call_func_p2(_7, "pow", &_9, _12);
		ZEPHIR_INIT_VAR(bytes);
		mul_function(bytes, _11, _7 TSRMLS_CC);
		zephir_array_fetch_string(&_11, value, SL("size"), PH_NOISY | PH_READONLY TSRMLS_CC);
		ZEPHIR_INIT_NVAR(_7);
		zephir_call_func_p1(_7, "intval", _11);
		ZEPHIR_INIT_VAR(_13);
		zephir_call_func_p1(_13, "intval", bytes);
		if (ZEPHIR_GT(_7, _13)) {
			ZEPHIR_INIT_VAR(_14);
			ZVAL_STRING(_14, "messageSize", 1);
			ZEPHIR_INIT_NVAR(message);
			...
			if (ZEPHIR_IS_EMPTY(message)) {
				ZEPHIR_INIT_NVAR(message);
				ZVAL_STRING(message, "Max filesize of file :field is :max", 1);
			}
			ZEPHIR_INIT_NVAR(_14);
			object_init_ex(_14, phalcon_validation_message_ce);
			ZEPHIR_INIT_VAR(_15);
			zephir_call_func_p2(_15, "strtr", message, replacePairs);
			ZEPHIR_INIT_VAR(_16);
			ZVAL_STRING(_16, "FileSize", 1);
			zephir_call_method_p3_noret(_14, "__construct", _15, field, _16);
			zephir_call_method_p1_noret(validation, "appendmessage", _14);
			RETURN_MM_BOOL(0);
		}
	}
	ZEPHIR_INIT_NVAR(_2);
	...
	if (zephir_is_true(_2)) {
		...
		if (!(zephir_is_true(_7))) {
			...
			if (ZEPHIR_IS_EMPTY(message)) {
				ZEPHIR_INIT_NVAR(message);
				ZVAL_STRING(message, "Type of :field is not valid", 1);
			}
			ZEPHIR_INIT_NVAR(_13);
			...
			ZVAL_STRING(_15, "FileType", 1);
			zephir_call_method_p3_noret(_13, "__construct", _14, field, _15);
	...
	if (zephir_is_true(&_9)) {
		...
		if (zephir_is_true(_6)) {
			...
			zephir_call_func_p2(minResolution, "explode", &_17, _7);
		...
		if ((ZEPHIR_LT(width, minWidth) || ZEPHIR_LT(height, minHeight))) {
			...
			zephir_call_method_p1(_13, this_ptr, "getoption", _14);
			zephir_array_update_string(&replacePairs, SL(":min"), &_13, PH_COPY | PH_SEPARATE);
			if (ZEPHIR_IS_EMPTY(message)) {
				ZEPHIR_INIT_NVAR(message);
				ZVAL_STRING(message, "Min resolution of :field is :min", 1);
			}
			ZEPHIR_INIT_NVAR(_13);
			object_init_ex(_13, phalcon_validation_message_ce);
			ZEPHIR_INIT_NVAR(_14);
			zephir_call_func_p2(_14, "strtr", message, replacePairs);
			ZEPHIR_INIT_NVAR(_15);
			ZVAL_STRING(_15, "FileMinResolution", 1);
			zephir_call_method_p3_noret(_13, "__construct", _14, field, _15);
			zephir_call_method_p1_noret(validation, "appendmessage", _13);
			RETURN_MM_BOOL(0);
		}
		ZEPHIR_INIT_NVAR(_14);
		ZEPHIR_INIT_NVAR(_15);
		ZVAL_STRING(_15, "maxResolution", 1);
		zephir_call_method_p1(_14, this_ptr, "issetoption", _15);
		if (zephir_is_true(_14)) {
			ZEPHIR_INIT_NVAR(_15);
			ZEPHIR_INIT_NVAR(_16);
			ZVAL_STRING(_16, "maxResolution", 1);
			zephir_call_method_p1(_15, this_ptr, "getoption", _16);
			ZEPHIR_SINIT_NVAR(_17);
			ZVAL_STRING(&_17, "x", 0);
			ZEPHIR_INIT_VAR(maxResolution);
			zephir_call_func_p2(maxResolution, "explode", &_17, _15);
			...
			if ((ZEPHIR_GT(width, maxWidth) || ZEPHIR_GT(height, maxHeight))) {
				ZEPHIR_INIT_NVAR(_16);
				ZVAL_STRING(_16, "messageMaxResolution", 1);
				ZEPHIR_INIT_NVAR(message);
				...
				zephir_array_update_string(&replacePairs, SL(":max"), &_16, PH_COPY | PH_SEPARATE);
				if (ZEPHIR_IS_EMPTY(message)) {
					ZEPHIR_INIT_NVAR(message);
					ZVAL_STRING(message, "Max resolution of :field is :max", 1);
				}
				ZEPHIR_INIT_NVAR(_16);
				object_init_ex(_16, phalcon_validation_message_ce);
				ZEPHIR_INIT_NVAR(_18);
				zephir_call_func_p2(_18, "strtr", message, replacePairs);
				ZEPHIR_INIT_VAR(_19);
				ZVAL_STRING(_19, "FileMaxResolution", 1);
				zephir_call_method_p3_noret(_16, "__construct", _18, field, _19);
				zephir_call_method_p1_noret(validation, "appendmessage", _16);
				RETURN_MM_BOOL(0);
			}
		}
	}
