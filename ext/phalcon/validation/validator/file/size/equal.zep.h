...
extern zend_class_entry *phalcon_validation_validator_file_size_equal_ce;
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_validation_validator_file_size_equal_validate, 0, 2, _IS_BOOL, NULL, 0)
#endif
