...
PHP_METHOD(Phalcon_Validation_Validator_StringLength, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, isSetMin, isSetMax, value, length, message, minimum, maximum, label, replacePairs, _0, _2$$7, _3$$8, _5$$8, _7$$8, _8$$8, _4$$9, _10$$10, _11$$11, _13$$11, _14$$11, _15$$11, _12$$12;
	ZEPHIR_INIT_THIS();
	...
	if (zephir_is_true(&isSetMax)) {
		...
		if (ZEPHIR_GT(&length, &maximum)) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$8, "strtr", &_6, 55, &message, &replacePairs);
			zephir_check_call_status();
			...
			ZVAL_STRING(&_8$$8, "TooLong");
			ZEPHIR_CALL_METHOD(NULL, &_3$$8, "__construct", &_9, 461, &_5$$8, &field, &_8$$8, &_7$$8);
			zephir_check_call_status();
	...
	if (zephir_is_true(&isSetMin)) {
		...
		if (ZEPHIR_LT(&length, &minimum)) {
			...
			ZEPHIR_CALL_FUNCTION(&_13$$11, "strtr", &_6, 55, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_15$$11);
			ZVAL_STRING(&_15$$11, "code");
			ZEPHIR_CALL_METHOD(&_14$$11, this_ptr, "getoption", NULL, 0, &_15$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_15$$11);
			ZVAL_STRING(&_15$$11, "TooShort");
			ZEPHIR_CALL_METHOD(NULL, &_11$$11, "__construct", &_9, 461, &_13$$11, &field, &_15$$11, &_14$$11);
			zephir_check_call_status();
