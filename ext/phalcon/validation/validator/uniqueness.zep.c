...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, getColumnNameReal) {
	...
	if (_7) {
		...
		zephir_array_fetch(&_10$$4, &_9$$4, &field, PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 144);
		RETURN_CTOR(&_10$$4);
	}
	RETURN_CTOR(&field);
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, isUniqueness) {
	...
	if (Z_TYPE_P(field) != IS_ARRAY) {
		...
		array_init(field);
		zephir_array_append(field, &singleField, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 162);
	}
	...
	zephir_check_call_status();
	zephir_is_iterable(field, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 172);
	if (Z_TYPE_P(field) == IS_ARRAY) {
	...
	if (Z_TYPE_P(&convert) != IS_NULL) {
		...
		if (UNEXPECTED(!(Z_TYPE_P(&values) == IS_ARRAY))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Value conversion must return an array", "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 176);
			return;
		}
	}
	ZEPHIR_INIT_NVAR(&_0);
	...
	if (_7) {
		...
		if (UNEXPECTED(ZEPHIR_IS_EMPTY(&record))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Model of record must be set to property \"model\"", "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 189);
			return;
		}
	}
	...
	if (isModel) {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "The uniqueness validator works only with Phalcon\\Mvc\\Model", "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 209);
		return;
	}
...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, isUniquenessModel) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&field, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 401);
	if (Z_TYPE_P(&field) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			ZEPHIR_INIT_NVAR(&singleField);
			...
			zephir_array_fetch(&value, &values, &singleField, PH_NOISY, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 319);
			...
			if (zephir_is_true(&except)) {
				...
				if (_9$$6) {
					...
					ZEPHIR_CALL_FUNCTION(&_13$$6, "range", &_14, 279, &_11$$6, &_12$$6);
					zephir_check_call_status();
					_9$$6 = !ZEPHIR_IS_IDENTICAL(&_10$$6, &_13$$6);
				}
				if (_9$$6) {
					zephir_is_iterable(&except, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 354);
					if (Z_TYPE_P(&except) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&except), _17$$7, _18$$7, _15$$7)
						{
							...
							if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
								zephir_is_iterable(&fieldExcept, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 347);
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _21$$9)
									{
										...
										zephir_array_append(&notInValues, &_24$$10, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_26$$11, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
								...
								zephir_array_append(&exceptConditions, &_28$$9, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 347);
							} else {
								ZEPHIR_INIT_NVAR(&_29$$12);
								ZVAL_LONG(&_29$$12, index);
								ZEPHIR_INIT_NVAR(&_30$$12);
								ZEPHIR_CONCAT_VSV(&_30$$12, &attribute, " <> ?", &_29$$12);
								zephir_array_append(&exceptConditions, &_30$$12, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 349);
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _33$$14)
										{
											...
											zephir_array_append(&notInValues, &_36$$15, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_38$$16, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_40$$14, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 347);
								} else {
									ZEPHIR_INIT_NVAR(&_41$$17);
									ZVAL_LONG(&_41$$17, index);
									ZEPHIR_INIT_NVAR(&_42$$17);
									ZEPHIR_CONCAT_VSV(&_42$$17, &attribute, " <> ?", &_41$$17);
									zephir_array_append(&exceptConditions, &_42$$17, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 349);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
					...
					zephir_array_fetch_long(&_44$$18, &field, 0, PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 357);
					...
					zephir_check_call_status();
					if (Z_TYPE_P(&except) == IS_ARRAY) {
						zephir_is_iterable(&except, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 367);
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _46$$19)
							{
								...
								zephir_array_append(&notInValues, &_49$$20, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 362);
								zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
								index++;
							} ZEND_HASH_FOREACH_END();
						} else {
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									zephir_array_append(&notInValues, &_51$$21, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 362);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
								ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
								zephir_check_call_status();
						...
						zephir_array_append(&exceptConditions, &_53$$19, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 367);
					} else {
					...
					zephir_is_iterable(&field, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 394);
					if (Z_TYPE_P(&field) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _56$$23)
						{
							...
							zephir_check_call_status();
							if (Z_TYPE_P(&except) == IS_ARRAY) {
								zephir_is_iterable(&except, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 387);
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _60$$25)
									{
										...
										zephir_array_append(&notInValues, &_63$$26, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
									} ZEND_HASH_FOREACH_END();
								} else {
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_65$$27, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
										zephir_check_call_status();
								...
								zephir_array_append(&exceptConditions, &_67$$25, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 387);
							} else {
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _72$$30)
										{
											...
											zephir_array_append(&notInValues, &_75$$31, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_77$$32, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_79$$30, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 387);
								} else {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&except)) {
					...
					if (_87$$37) {
						...
						ZEPHIR_CALL_FUNCTION(&_91$$37, "range", &_14, 279, &_89$$37, &_90$$37);
						zephir_check_call_status();
					...
					if (_87$$37) {
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _98$$40)
										{
											...
											zephir_array_append(&notInValues, &_101$$41, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_103$$42, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_105$$40, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 347);
								} else {
									ZEPHIR_INIT_NVAR(&_106$$43);
									ZVAL_LONG(&_106$$43, index);
									ZEPHIR_INIT_NVAR(&_107$$43);
									ZEPHIR_CONCAT_VSV(&_107$$43, &attribute, " <> ?", &_106$$43);
									zephir_array_append(&exceptConditions, &_107$$43, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 349);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
							} ZEND_HASH_FOREACH_END();
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										...
										if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fieldExcept), _110$$45)
											{
												...
												zephir_array_append(&notInValues, &_113$$46, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_115$$47, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 342);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
												ZEPHIR_CALL_METHOD(NULL, &fieldExcept, "next", NULL, 0);
												zephir_check_call_status();
										...
										zephir_array_append(&exceptConditions, &_117$$45, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 347);
									} else {
										ZEPHIR_INIT_NVAR(&_118$$48);
										ZVAL_LONG(&_118$$48, index);
										ZEPHIR_INIT_NVAR(&_119$$48);
										ZEPHIR_CONCAT_VSV(&_119$$48, &attribute, " <> ?", &_118$$48);
										zephir_array_append(&exceptConditions, &_119$$48, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 349);
										zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
										index++;
									}
								ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
						...
						zephir_array_fetch_long(&_121$$49, &field, 0, PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 357);
						...
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							...
							if (Z_TYPE_P(&except) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _123$$50)
								{
									...
									zephir_array_append(&notInValues, &_126$$51, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 362);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
								} ZEND_HASH_FOREACH_END();
							} else {
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										zephir_array_append(&notInValues, &_128$$52, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 362);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
									ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
									zephir_check_call_status();
							...
							zephir_array_append(&exceptConditions, &_130$$50, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 367);
						} else {
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _137$$56)
										{
											...
											zephir_array_append(&notInValues, &_140$$57, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_142$$58, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
											zephir_check_call_status();
									...
									zephir_array_append(&exceptConditions, &_144$$56, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 387);
								} else {
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										...
										if (Z_TYPE_P(&except) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&except), _149$$61)
											{
												...
												zephir_array_append(&notInValues, &_152$$62, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_154$$63, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 382);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
												ZEPHIR_CALL_METHOD(NULL, &except, "next", NULL, 0);
												zephir_check_call_status();
										...
										zephir_array_append(&exceptConditions, &_156$$61, PH_SEPARATE, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 387);
									} else {
	...
	if (ZEPHIR_IS_LONG(&_159, 0)) {
		...
		zephir_check_call_status();
		zephir_is_iterable(&_162$$65, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 413);
	...
	ZEPHIR_INIT_NVAR(&_0);
	zephir_array_fetch_string(&_177, &params, SL("conditions"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Validation/Validator/Uniqueness.zep", 422);
