...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_6) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_12, 340, _9, field, _11);
	...
	if (_20) {
		...
		ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 340, _22, field, _23);
	...
	if (_25) {
		...
		ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 340, _9, field, _23);
		zephir_check_temp_parameter(_23);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, _11);
		zephir_check_call_status();
	...
	if (zephir_is_true(_9)) {
		...
		if (ZEPHIR_GT(_22, _34)) {
			...
			ZEPHIR_CALL_METHOD(NULL, _30, "__construct", &_12, 340, _35, field, _36);
	...
	if (_37) {
		...
		if (_38) {
			...
			ZEPHIR_CALL_METHOD(NULL, _11, "__construct", &_12, 340, _35, field, _23);
			zephir_check_temp_parameter(_23);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, validation, "appendmessage", NULL, 0, _11);
			zephir_check_call_status();
		...
		if (zephir_is_true(_35)) {
			...
			if (_40) {
				...
				ZEPHIR_CALL_METHOD(NULL, _23, "__construct", &_12, 340, _41, field, _26);
