...
PHP_METHOD(Phalcon_Validation_Validator_File, isAllowEmpty) {
	...
	if (!(_0)) {
		...
		if (_1) {
			zephir_array_fetch_string(&_2, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 96 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, _SERVER, SL("REQUEST_METHOD"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 113 TSRMLS_CC);
	...
	_3 = _2;
	if (_3) {
		zephir_array_fetch_string(&_4, _SERVER, SL("CONTENT_LENGTH"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 113 TSRMLS_CC);
	...
	if (!(_5)) {
		...
		if (_6) {
			zephir_array_fetch_string(&_7, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 113 TSRMLS_CC);
	...
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 361, &_10$$3, field, &_9$$3, &code);
		zephir_check_call_status();
	...
	_12 = _11;
	if (!(_12)) {
		zephir_array_fetch_string(&_13, &value, SL("error"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 129 TSRMLS_CC);
		_12 = !ZEPHIR_IS_LONG_IDENTICAL(&_13, 0);
	}
	_14 = _12;
	if (!(_14)) {
		zephir_array_fetch_string(&_15, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 129 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 293, &_15);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_17$$4, "__construct", NULL, 361, &_19$$4, field, &_18$$4, &code);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_22$$5, "__construct", NULL, 361, &_24$$5, field, &_23$$5, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_25)) {
		...
		if (Z_TYPE_P(&maxSize) == IS_ARRAY) {
			zephir_array_fetch(&_28$$7, &maxSize, field, PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 169 TSRMLS_CC);
		...
		if (zephir_array_isset_long(&matches, 2)) {
			...
			zephir_array_fetch_long(&unit, &matches, 2, PH_NOISY, "phalcon/Validation/Validator/File.zep", 175 TSRMLS_CC);
		}
		zephir_array_fetch_long(&_32$$6, &matches, 1, PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 178 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 385, &_32$$6);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_34$$6);
		zephir_array_fetch(&_35$$6, &byteUnits, &unit, PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 178 TSRMLS_CC);
		ZVAL_LONG(&_36$$6, 2);
		zephir_pow_function(&_34$$6, &_36$$6, &_35$$6);
		ZEPHIR_INIT_VAR(&bytes);
		mul_function(&bytes, &_33$$6, &_34$$6 TSRMLS_CC);
		zephir_array_fetch_string(&_37$$6, &value, SL("size"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 180 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 385, &_37$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_38$$6, "floatval", NULL, 385, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_33$$6, &_38$$6)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_39$$9, "__construct", NULL, 361, &_41$$9, field, &_40$$9, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_42)) {
		...
		if (Z_TYPE_P(&types) != IS_ARRAY) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Option 'allowedTypes' must be an array", "phalcon/Validation/Validator/File.zep", 206);
			return;
		}
		if ((zephir_function_exists_ex(SL("finfo_open") TSRMLS_CC) == SUCCESS)) {
			ZVAL_LONG(&_44$$13, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 290, &_44$$13);
			zephir_check_call_status();
			zephir_array_fetch_string(&_45$$13, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 211 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 291, &tmp, &_45$$13);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 292, &tmp);
			zephir_check_call_status();
		} else {
			ZEPHIR_OBS_NVAR(&mime);
			zephir_array_fetch_string(&mime, &value, SL("type"), PH_NOISY, "phalcon/Validation/Validator/File.zep", 215 TSRMLS_CC);
		}
		if (!(zephir_fast_in_array(&mime, &types TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_46$$15, "__construct", NULL, 361, &_48$$15, field, &_47$$15, &code);
			zephir_check_call_status();
	...
	if (_50) {
		zephir_array_fetch_string(&_52$$16, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 236 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 299, &_52$$16);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(&width);
		zephir_array_fetch_long(&width, &tmp, 0, PH_NOISY, "phalcon/Validation/Validator/File.zep", 237 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&height);
		zephir_array_fetch_long(&height, &tmp, 1, PH_NOISY, "phalcon/Validation/Validator/File.zep", 238 TSRMLS_CC);
		...
		if (zephir_is_true(&_53$$16)) {
			...
			if (Z_TYPE_P(&minResolution) == IS_ARRAY) {
				zephir_array_fetch(&_56$$18, &minResolution, field, PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 243 TSRMLS_CC);
			...
			zephir_array_fetch_long(&minWidth, &minResolutionArray, 0, PH_NOISY, "phalcon/Validation/Validator/File.zep", 246 TSRMLS_CC);
			ZEPHIR_OBS_VAR(&minHeight);
			zephir_array_fetch_long(&minHeight, &minResolutionArray, 1, PH_NOISY, "phalcon/Validation/Validator/File.zep", 247 TSRMLS_CC);
		} else {
		...
		if (_57$$16) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_58$$20, "__construct", NULL, 361, &_60$$20, field, &_59$$20, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_61$$16)) {
			...
			if (Z_TYPE_P(&maxResolution) == IS_ARRAY) {
				zephir_array_fetch(&_63$$22, &maxResolution, field, PH_NOISY | PH_READONLY, "phalcon/Validation/Validator/File.zep", 273 TSRMLS_CC);
			...
			zephir_array_fetch_long(&maxWidth, &maxResolutionArray, 0, PH_NOISY, "phalcon/Validation/Validator/File.zep", 276 TSRMLS_CC);
			ZEPHIR_OBS_VAR(&maxHeight);
			zephir_array_fetch_long(&maxHeight, &maxResolutionArray, 1, PH_NOISY, "phalcon/Validation/Validator/File.zep", 277 TSRMLS_CC);
			...
			if (_64$$21) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_65$$23, "__construct", NULL, 361, &_67$$23, field, &_66$$23, &code);
				zephir_check_call_status();
