...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 336, &_10$$3, field, &_9$$3, &code);
		zephir_check_call_status();
	...
	if (!(_14)) {
		...
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 268, &_15);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_17$$4, "__construct", NULL, 336, &_19$$4, field, &_18$$4, &code);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_22$$5, "__construct", NULL, 336, &_24$$5, field, &_23$$5, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_25)) {
		...
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 360, &_32$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 360, &_37$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_38$$6, "floatval", NULL, 360, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_33$$6, &_38$$6)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_39$$9, "__construct", NULL, 336, &_41$$9, field, &_40$$9, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_42)) {
		...
		if ((zephir_function_exists_ex(SL("finfo_open") TSRMLS_CC) == SUCCESS)) {
			ZVAL_LONG(&_44$$13, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 265, &_44$$13);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 266, &tmp, &_45$$13);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 267, &tmp);
			zephir_check_call_status();
		} else {
		...
		if (!(zephir_fast_in_array(&mime, &types TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_46$$15, "__construct", NULL, 336, &_48$$15, field, &_47$$15, &code);
			zephir_check_call_status();
	...
	if (_50) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 277, &_52$$16);
		zephir_check_call_status();
		...
		if (_57$$16) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_58$$20, "__construct", NULL, 336, &_60$$20, field, &_59$$20, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_61$$16)) {
			...
			if (_64$$21) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_65$$23, "__construct", NULL, 336, &_67$$23, field, &_66$$23, &code);
				zephir_check_call_status();
