...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (!(_14)) {
		...
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 225, &_15);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_25)) {
		...
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 302, &_32$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_33$$6, "floatval", NULL, 302, &_37$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_38$$6, "floatval", NULL, 302, &bytes);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_42)) {
		...
		if ((zephir_function_exists_ex(SL("finfo_open") TSRMLS_CC) == SUCCESS)) {
			ZVAL_LONG(&_44$$13, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 222, &_44$$13);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 223, &tmp, &_45$$13);
			zephir_check_call_status();
