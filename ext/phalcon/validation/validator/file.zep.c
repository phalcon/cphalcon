...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (!(_20)) {
		...
		ZEPHIR_CALL_FUNCTION(&_9, "is_uploaded_file", NULL, 212, _21);
		zephir_check_call_status();
	...
	if (zephir_is_true(_9)) {
		...
		ZEPHIR_CALL_FUNCTION(&_22, "floatval", &_29, 298, _28);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_30);
		...
		ZEPHIR_CALL_FUNCTION(&_22, "floatval", &_29, 298, _33);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_34, "floatval", &_29, 298, bytes);
		zephir_check_call_status();
	...
	if (_37) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 234, _28);
		zephir_check_call_status();
