...
PHP_METHOD(Phalcon_Validation_Validator_Identical, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *message = NULL, *label = NULL, *replacePairs, *value = NULL, *_0 = NULL, *_1 = NULL, *_3 = NULL, *_4 = NULL, *_5;
