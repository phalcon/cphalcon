...
PHP_METHOD(Phalcon_Validation_Validator_Between, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, minimum, maximum, message, label, replacePairs, _0, _2$$3, _4$$3, _5$$3, _6$$3, _3$$5;
	ZEPHIR_INIT_THIS();
