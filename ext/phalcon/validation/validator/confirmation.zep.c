...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, fieldWith, value, valueWith, message, label, labelWith, replacePairs, _0, _1, _2$$3, _4$$3, _5$$3, _6$$3, _3$$6;
	ZEPHIR_INIT_THIS();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "compare", NULL, 464, &value, &valueWith);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		...
		ZVAL_STRING(&_6$$3, "Confirmation");
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 461, &_4$$3, &field, &_6$$3, &_5$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, compare) {
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "mb_strtolower", &_5, 203, &a, &_3$$3);
		zephir_check_call_status();
		zephir_get_strval(&a, &_4$$3);
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "utf-8");
		ZEPHIR_CALL_FUNCTION(&_6$$3, "mb_strtolower", &_5, 203, &b, &_3$$3);
		zephir_check_call_status();
