...
PHP_METHOD(Phalcon_Validation_Validator_Alnum, validate) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "ctype_alnum", NULL, 464, value);
	zephir_check_call_status();
	if (!(zephir_is_true(_0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "strtr", NULL, 55, message, replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_7$$3);
		ZVAL_STRING(_7$$3, "Alnum", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "__construct", NULL, 463, _6$$3, field, _7$$3, code);
