...
PHP_METHOD(Phalcon_Validation_Validator_PresenceOf, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, message, label, replacePairs, _1$$3, _3$$3, _4$$3, _5$$3, _2$$5;
	ZEPHIR_INIT_THIS();
