...
PHP_METHOD(Phalcon_Validation_Validator_Email, validate) {
	...
	zval field;
	zval *validation, validation_sub, *field_param = NULL, value, message, label, replacePairs, _0, _1, _2$$3, _4$$3, _5$$3, _6$$3, _3$$5;
	ZEPHIR_INIT_THIS();
	...
	ZVAL_LONG(&_0, 274);
	ZEPHIR_CALL_FUNCTION(&_1, "filter_var", NULL, 200, &value, &_0);
	zephir_check_call_status();
