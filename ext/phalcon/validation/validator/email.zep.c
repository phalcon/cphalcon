...
PHP_METHOD(Phalcon_Validation_Validator_Email, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *message = NULL, *label = NULL, *replacePairs, *_0 = NULL, *_1 = NULL, _3, *_4 = NULL, *_6 = NULL, *_8;
	...
	if (!(zephir_is_true(_4))) {
		...
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_8);
		ZVAL_STRING(_8, "Email", ZEPHIR_TEMP_PARAM_COPY);
