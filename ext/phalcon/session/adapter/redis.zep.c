...
PHP_METHOD(Phalcon_Session_Adapter_Redis, __construct) {
	...
	ZEPHIR_CALL_CE_STATIC(&_2, phalcon_utility_ce, "arraygetdefault", &_3, 0, &_4, &options, &_5);
	zephir_check_call_status();
	zephir_array_update_string(&params, SL("host"), &_2, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "port");
	ZVAL_LONG(&_1, 6379);
	ZEPHIR_CALL_CE_STATIC(&_6, phalcon_utility_ce, "arraygetdefault", &_3, 0, &_4, &options, &_1);
	zephir_check_call_status();
	zephir_array_update_string(&params, SL("port"), &_6, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "index");
	ZVAL_LONG(&_1, 0);
	ZEPHIR_CALL_CE_STATIC(&_7, phalcon_utility_ce, "arraygetdefault", &_3, 0, &_4, &options, &_1);
	zephir_check_call_status();
	zephir_array_update_string(&params, SL("index"), &_7, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "persistent");
	ZVAL_BOOL(&_1, 0);
	ZEPHIR_CALL_CE_STATIC(&_8, phalcon_utility_ce, "arraygetdefault", &_3, 0, &_4, &options, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_4);
	ZVAL_STRING(&_4, "ttl");
	ZEPHIR_CALL_CE_STATIC(&_9, phalcon_utility_ce, "arraygetdefault", &_3, 0, &_4, &options, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 351, &_5, &params);
	zephir_check_call_status();
