...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, __construct) {
	...
	zval *_4, *_6, *_7, *_8, *_9, *_10, *_11;
	zval *options = NULL, *_0 = NULL, *_1, *_2, *_3, *_5;
	...
	if (zephir_array_isset_string(options, SS("lifetime"))) {
		zephir_array_fetch_string(&_1, options, SL("lifetime"), PH_NOISY | PH_READONLY TSRMLS_CC);
		zephir_update_property_this(this_ptr, SL("_lifetime"), _1 TSRMLS_CC);
	}
	ZEPHIR_INIT_VAR(_2);
	object_init_ex(_2, phalcon_cache_backend_memcache_ce);
	ZEPHIR_INIT_VAR(_3);
	...
	ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, _3, options);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_memcache"), _2 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_6);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, _6, _7, _8, _9, _10, _11);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_memcache_ce, this_ptr, "__construct", &_12, options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
