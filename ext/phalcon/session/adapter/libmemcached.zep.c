...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 432, &lifetime, &_0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 331, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 332, &_3, &_6);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_libmemcached_ce, this_ptr, "__construct", &_14, 434, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, destroy) {
	...
	zend_ulong _2;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *sessionId_param = NULL, _SESSION, id, key, _0, *_1, _4;
	zval sessionId;
	ZEPHIR_INIT_THIS();
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_is_iterable(&_SESSION, 1, "phalcon/session/adapter/libmemcached.zep", 161);
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZEPHIR_INIT_NVAR(&key);
	zephir_read_property(&_4, this_ptr, SL("_libmemcached"), PH_NOISY_CC | PH_READONLY);
