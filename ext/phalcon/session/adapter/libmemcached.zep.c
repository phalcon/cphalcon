...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 449, lifetime, _0);
	...
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 351, _2, _5);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_libmemcached_ce, getThis(), "__construct", &_13, 451, options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
