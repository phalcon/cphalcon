...
PHP_METHOD(Phalcon_Session_Adapter_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "min", NULL, 434, &lifetime, &_0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 332, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_METHOD(NULL, &_2, "__construct", NULL, 333, &_3, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 435, &_7, &_9, &_10, &_11, &_12, &_13);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_libmemcached_ce, this_ptr, "__construct", &_14, 436, &options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
