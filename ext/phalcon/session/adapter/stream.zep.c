...
ZEPHIR_INIT_CLASS(Phalcon_Session_Adapter_Stream)
{
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_session_adapter_stream_ce, SL("options"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_session_adapter_stream_ce, SL("prefix"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		ZVAL_STRINGL(&_zc0, "", sizeof("") - 1);
		zephir_declare_typed_property(phalcon_session_adapter_stream_ce, SL("path"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_STRING, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1323, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1324, &options);
	ZEPHIR_INIT_NVAR(&_1);
	...
	if (UNEXPECTED(1 == ZEPHIR_IS_EMPTY(&path))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$3, "phalcon/Session/Adapter/Stream.zep", 92);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(!ZEPHIR_IS_TRUE_IDENTICAL(&_5))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_6$$4, "phalcon/Session/Adapter/Stream.zep", 96);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "todirseparator", NULL, 0, &path);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1325, &_7);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, destroy)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1325, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		ZEPHIR_CALL_FUNCTION(&_4, "is_file", NULL, 455, &file);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, gc)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1325, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1323, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&glob)) {
		...
		if (zephir_array_isset_value_string(&last, SL("message"))) {
			zephir_array_fetch_string(&_3$$4, &last, SL("message"), PH_NOISY | PH_READONLY, "phalcon/Session/Adapter/Stream.zep", 134);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$3, "phalcon/Session/Adapter/Stream.zep", 138);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (!(ZEPHIR_IS_EMPTY(&glob))) {
		zephir_is_iterable(&glob, 0, "phalcon/Session/Adapter/Stream.zep", 149);
		if (Z_TYPE_P(&glob) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&glob), _5$$6)
			{
				...
				if (_8$$7) {
					ZEPHIR_CALL_FUNCTION(&_9$$7, "is_file", &_10, 455, &file);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_17$$9) {
						ZEPHIR_CALL_FUNCTION(&_18$$9, "is_file", &_10, 455, &file);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, read)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval id_zv, data, name, pointer, _0, _1, _2, _3$$3, _4$$3, _5$$3;
	zend_string *id = NULL;
	zval *this_ptr = getThis();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_2)) {
		...
		zephir_check_call_status();
		ZVAL_LONG(&_4$$3, 1);
		ZEPHIR_CALL_FUNCTION(&_5$$3, "flock", NULL, 296, &pointer, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, write)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval id_zv, data_zv, name, _0, _1, _2, _3;
	zend_string *id = NULL, *data = NULL;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, getPrefixedName)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1323, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, phpIniGet)
{
	...
	ZEPHIR_CALL_FUNCTION(&value, "ini_get", NULL, 453, &input_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Adapter_Stream, phpParseIniFile)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("parse_ini_file", NULL, 454, &filename_zv, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
