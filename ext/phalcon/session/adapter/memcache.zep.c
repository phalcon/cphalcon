...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _0, "__construct", NULL, 323, _1, options);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_memcache_ce, this_ptr, "__construct", &_11, 413, options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
