...
PHP_METHOD(Phalcon_Session_Exceptions_InvalidSessionName, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "The name contains non alphanum characters");
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_exceptions_invalidsessionname_ce, getThis(), "__construct", NULL, 0, &_0);
