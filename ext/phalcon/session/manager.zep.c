...
PHP_METHOD(Phalcon_Session_Manager, getName)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_1, &_0)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1267, &_2$$3);
	}
...
PHP_METHOD(Phalcon_Session_Manager, setAdapter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1268, adapter);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Session_Manager, setName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1267, &name_zv);
...
PHP_METHOD(Phalcon_Session_Manager, setOptions)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1270, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Session_Manager, start)
{
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 1268, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 1268, PH_NOISY_CC | PH_READONLY);
