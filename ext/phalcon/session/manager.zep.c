...
PHP_METHOD(Phalcon_Session_Manager, getName)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_1, &_0)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1312, &_2$$3);
	}
...
PHP_METHOD(Phalcon_Session_Manager, setAdapter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1313, adapter);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Session_Manager, setName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1312, &name_zv);
...
PHP_METHOD(Phalcon_Session_Manager, start)
{
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 1313, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 1313, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Manager, getUniqueKey)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1314, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Session_Manager, phpHeadersSent)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("headers_sent", NULL, 217);
	zephir_check_call_status();
	RETURN_MM();
}
