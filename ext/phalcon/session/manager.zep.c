...
PHP_METHOD(Phalcon_Session_Manager, getName)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_1, &_0)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1346, &_2$$3);
	}
...
PHP_METHOD(Phalcon_Session_Manager, setAdapter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1347, adapter);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Session_Manager, setId)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Session/Manager.zep", 275);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	if (UNEXPECTED(!zephir_is_true(&_4))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_6$$4, "phalcon/Session/Manager.zep", 279);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Session_Manager, setName)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Session/Manager.zep", 300);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	if (UNEXPECTED(_6)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_11$$4, "phalcon/Session/Manager.zep", 307);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1346, &name_zv);
...
PHP_METHOD(Phalcon_Session_Manager, setOptions)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("uniqueId", 8, 1);
	}
...
PHP_METHOD(Phalcon_Session_Manager, start)
{
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 1347, PH_NOISY_CC);
	if (UNEXPECTED(!(zephir_is_instance_of(&_6, SL("SessionHandlerInterface"))))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_7$$7, "phalcon/Session/Manager.zep", 365);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 1347, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Manager, getUniqueKey)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1348, PH_NOISY_CC);
	if (1 != ZEPHIR_IS_EMPTY(&_0)) {
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1348, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Session_Manager, phpHeadersSent)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("headers_sent", NULL, 228);
	zephir_check_call_status();
	RETURN_MM();
}
