...
PHP_METHOD(Phalcon_Session_Adapter, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 401, name);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter, getName) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_name", NULL, 401);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 402);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, setId) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 402, id);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Session_Adapter, destroy) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_destroy", NULL, 403);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Adapter, status) {
	...
	if (!(zephir_is_php_version(50300))) {
		ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 404);
		zephir_check_call_status();
		do {
