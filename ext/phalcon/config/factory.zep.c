...
PHP_METHOD(Phalcon_Config_Factory, loadClass) {
	...
	zend_bool _3;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *namespaceClass_param = NULL, *config = NULL, config_sub, adapter, className, mode, callbacks, filePath, extension, oldConfig, _0$$3, _1$$3, _2$$3, _4$$5, _5$$8, _6$$8, _7$$8, _14$$8, _8$$9, _9$$9, _10$$11, _12$$13;
	zval namespaceClass;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(config) == IS_STRING) {
		...
		ZVAL_STRING(&_0$$3, ".");
		ZEPHIR_CALL_FUNCTION(&_1$$3, "strrchr", NULL, 120, config, &_0$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_2$$3, 1);
	...
	if (zephir_array_isset_string_fetch(&adapter, config, SL("adapter"), 0)) {
		...
		ZEPHIR_CONCAT_VSV(&className, &namespaceClass, "\\", &_5$$8);
