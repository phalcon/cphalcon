...
PHP_METHOD(Phalcon_Config_Factory, loadClass) {
	...
	zend_bool _3;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *namespaceClass_param = NULL, *config = NULL, config_sub, adapter, className, mode, callbacks, filePath, extension, oldConfig, _5, _6, _7, _14, _0$$3, _1$$3, _2$$3, _4$$5, _8$$9, _9$$9, _10$$11, _12$$13;
	zval namespaceClass;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(config) == IS_STRING) {
		...
		ZVAL_STRING(&_0$$3, ".");
		ZEPHIR_CALL_FUNCTION(&_1$$3, "strrchr", NULL, 144, config, &_0$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_2$$3, 1);
	...
	ZEPHIR_CONCAT_VSV(&className, &namespaceClass, "\\", &_5);
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, ".");
	ZEPHIR_INIT_VAR(&_7);
