...
{
	zend_bool _2$$3, _19$$11;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_3 = NULL, *_6 = NULL, *_8 = NULL, *_13 = NULL, *_15 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_string *defaultAdapter = NULL;
	zval *arrayConfig_param = NULL, defaultAdapter_zv, configArray, configInstance, configName, _0, *_1, _18, _10$$3, _11$$3, _4$$5, _9$$5, _5$$6, _7$$6, _12$$9, _14$$8, _16$$10, _17$$10, _24$$11, _25$$11, _20$$13, _23$$13, _21$$14, _22$$14, _26$$17, _27$$16, _28$$18, _29$$18;
	zval arrayConfig;
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arrayConfig), _1)
		{
			...
			if (_2$$3) {
				...
				if (ZEPHIR_IS_IDENTICAL(&_4$$5, &defaultAdapter_zv)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$6, "__construct", &_6, 309);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_7$$6, &_5$$6, "load", &_8, 310, &configName);
					zephir_check_call_status();
			...
			if (ZEPHIR_IS_IDENTICAL(&_11$$3, &_10$$3)) {
				if (!(zephir_array_isset_value_string(&configInstance, SL("config")))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", &_13, 311);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_16$$10, "__construct", &_6, 309);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_17$$10, &_16$$10, "load", &_8, 310, &configInstance);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_19$$11) {
					...
					if (ZEPHIR_IS_IDENTICAL(&_20$$13, &defaultAdapter_zv)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_21$$14, "__construct", &_6, 309);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_22$$14, &_21$$14, "load", &_8, 310, &configName);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(NULL, this_ptr, "merge", &_3, 0, &_22$$14);
						zephir_check_call_status();
						continue;
					}
				...
				if (ZEPHIR_IS_IDENTICAL(&_25$$11, &_24$$11)) {
					if (!(zephir_array_isset_value_string(&configInstance, SL("config")))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_26$$17, "__construct", &_13, 311);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &configInstance, "__construct", &_15, 41, &configArray, &_27$$16);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&_28$$18);
					object_init_ex(&_28$$18, phalcon_config_configfactory_ce);
					ZEPHIR_CALL_METHOD(NULL, &_28$$18, "__construct", &_6, 309);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_29$$18, &_28$$18, "load", &_8, 310, &configInstance);
					zephir_check_call_status();
