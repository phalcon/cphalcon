		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arrayConfig), _2)
		{
			...
			if (zephir_is_instance_of(&configName, SL("Phalcon\\Config"))) {
				...
				if (ZEPHIR_IS_IDENTICAL(&_5$$5, &defaultAdapter)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_6$$6, "__construct", &_7, 160);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_8$$6, &_6$$6, "load", &_9, 161, &configName);
					zephir_check_call_status();
			...
			if (ZEPHIR_IS_IDENTICAL(&_12$$3, &_11$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &configInstance, "__construct", &_16, 20, &configArray);
				zephir_check_call_status();
			} else {
				ZEPHIR_INIT_NVAR(&_17$$10);
				object_init_ex(&_17$$10, phalcon_config_configfactory_ce);
				ZEPHIR_CALL_METHOD(NULL, &_17$$10, "__construct", &_7, 160);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_18$$10, &_17$$10, "load", &_9, 161, &configInstance);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_instance_of(&configName, SL("Phalcon\\Config"))) {
					...
					if (ZEPHIR_IS_IDENTICAL(&_19$$13, &defaultAdapter)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_20$$14, "__construct", &_7, 160);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_21$$14, &_20$$14, "load", &_9, 161, &configName);
						zephir_check_call_status();
				...
				if (ZEPHIR_IS_IDENTICAL(&_24$$11, &_23$$11)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_27$$18, "__construct", &_7, 160);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_28$$18, &_27$$18, "load", &_9, 161, &configInstance);
					zephir_check_call_status();
