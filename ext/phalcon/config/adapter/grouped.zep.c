		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arrayConfig), _1)
		{
			...
			if (_2$$3) {
				...
				if (ZEPHIR_IS_IDENTICAL(&_4$$5, &defaultAdapter_zv)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$6, "__construct", &_6, 312);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_7$$6, &_5$$6, "load", &_8, 313, &configName);
					zephir_check_call_status();
			...
			if (ZEPHIR_IS_IDENTICAL(&_11$$3, &_10$$3)) {
				if (!(zephir_array_isset_value_string(&configInstance, SL("config")))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", &_13, 314);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_16$$10, "__construct", &_6, 312);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_17$$10, &_16$$10, "load", &_8, 313, &configInstance);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_20$$11) {
					...
					if (ZEPHIR_IS_IDENTICAL(&_21$$13, &defaultAdapter_zv)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_22$$14, "__construct", &_6, 312);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_23$$14, &_22$$14, "load", &_8, 313, &configName);
						zephir_check_call_status();
				...
				if (ZEPHIR_IS_IDENTICAL(&_26$$11, &_25$$11)) {
					if (!(zephir_array_isset_value_string(&configInstance, SL("config")))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_27$$17, "__construct", &_13, 314);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &_29$$18, "__construct", &_6, 312);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_30$$18, &_29$$18, "load", &_8, 313, &configInstance);
					zephir_check_call_status();
