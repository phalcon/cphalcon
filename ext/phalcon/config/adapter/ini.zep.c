...
PHP_METHOD(Phalcon_Config_Adapter_Ini, __construct) {
	...
	zval *filePath_param = NULL, *mode = NULL, mode_sub, __$true, __$null, iniConfig, section, sections, directives, path, lastValue, *_3, _0$$4, _1$$4, _2$$4, *_6$$6, _9$$7, _12$$8, _13$$8, _14$$9;
	zval filePath, _10$$7;
	...
	ZEPHIR_CALL_FUNCTION(&iniConfig, "parse_ini_file", NULL, 138, &filePath, &__$true, mode);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&iniConfig), _4, _5, _3)
	{
		...
		if (Z_TYPE_P(&directives) == IS_ARRAY) {
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&directives), _7$$6, _8$$6, _6$$6)
			{
				...
				ZEPHIR_CALL_METHOD(&_9$$7, this_ptr, "parseinistring", &_11, 0, &_10$$7, &lastValue);
				zephir_check_call_status();
				zephir_array_append(&sections, &_9$$7, PH_SEPARATE, "phalcon/Config/Adapter/Ini.zep", 91);
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, cast) {
	...
	zend_string *_2$$3;
	zend_ulong _1$$3;
	zend_bool _5, _6, _8, _9, _11;
	zephir_fcall_cache_entry *_4 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *ini, ini_sub, key, val, _7, _10, *_0$$3, _3$$4, _12$$8, _13$$8, _14$$8, _15$$8;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(ini) == IS_ARRAY) {
		zephir_is_iterable(ini, 1, "phalcon/Config/Adapter/Ini.zep", 123);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(ini), _1$$3, _2$$3, _0$$3)
		{
			...
			ZVAL_COPY(&val, _0$$3);
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "cast", &_4, 139, &val);
			zephir_check_call_status();
	...
	_5 = ZEPHIR_IS_STRING_IDENTICAL(ini, "true");
	if (!(_5)) {
		_5 = ZEPHIR_IS_STRING_IDENTICAL(ini, "yes");
	}
	_6 = _5;
	if (!(_6)) {
		ZEPHIR_INIT_VAR(&_7);
		zephir_fast_strtolower(&_7, ini);
		_6 = ZEPHIR_IS_STRING_IDENTICAL(&_7, "on");
	}
	if (_6) {
		RETURN_MM_BOOL(1);
	}
	_8 = ZEPHIR_IS_STRING_IDENTICAL(ini, "false");
	if (!(_8)) {
		_8 = ZEPHIR_IS_STRING_IDENTICAL(ini, "no");
	}
	_9 = _8;
	if (!(_9)) {
		ZEPHIR_INIT_VAR(&_10);
		zephir_fast_strtolower(&_10, ini);
		_9 = ZEPHIR_IS_STRING_IDENTICAL(&_10, "off");
	}
	if (_9) {
		RETURN_MM_BOOL(0);
	}
	...
	_11 = Z_TYPE_P(ini) == IS_STRING;
	if (_11) {
		_11 = zephir_is_numeric(ini);
	}
	if (_11) {
		...
		ZVAL_STRING(&_15$$8, "/[.]+/");
		zephir_preg_match(&_14$$8, &_15$$8, ini, &_12$$8, 0, 0 , 0  TSRMLS_CC);
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, parseIniString) {
	...
	zephir_create_array(return_value, 1, 0 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "parseinistring", NULL, 140, &path, value);
	zephir_check_call_status();
