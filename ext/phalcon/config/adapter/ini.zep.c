...
{
	zval _13$$6, _16$$7, _26$$11, _28$$12;
	zend_ulong _6, _10$$5, _23$$10;
	zval config;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_14 = NULL, *_20 = NULL;
	zend_long mode, ZEPHIR_LAST_CALL_STATUS;
	zval filePath_zv, *mode_param = NULL, directives, iniConfig, lastValue, path, section, sections, _0, _1, *_4, _5, _2$$3, _3$$3, *_8$$5, _9$$5, _12$$6, _15$$7, _17$$8, _18$$8, _19$$4, *_21$$10, _22$$10, _25$$11, _27$$12, _29$$13, _30$$13, _31$$9;
	zend_string *filePath = NULL, *_7, *_11$$5, *_24$$10;
	...
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&iniConfig))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 307, &_3$$3);
		zephir_check_call_status();
			...
			if (Z_TYPE_P(&directives) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&directives) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&directives), _10$$5, _11$$5, _8$$5)
					{
						...
						zephir_check_call_status();
						zephir_array_append(&sections, &_12$$6, PH_SEPARATE, "phalcon/Config/Adapter/Ini.zep", 90);
				...
				if (Z_TYPE_P(&directives) == IS_ARRAY) {
					...
					if (Z_TYPE_P(&directives) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&directives), _23$$10, _24$$10, _21$$10)
						{
							...
							zephir_check_call_status();
							zephir_array_append(&sections, &_25$$11, PH_SEPARATE, "phalcon/Config/Adapter/Ini.zep", 90);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &directives, "rewind", NULL, 0);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, parseIniString)
{
	...
	ZEPHIR_CALL_METHOD(&result, this_ptr, "parseinistring", NULL, 308, &path, &castValue);
	zephir_check_call_status();
	zephir_create_array(return_value, 1, 0);
...
PHP_METHOD(Phalcon_Config_Adapter_Ini, phpParseIniFile)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("parse_ini_file", NULL, 309, &filename_zv, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
