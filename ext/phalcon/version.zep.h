...
PHP_METHOD(Phalcon_Version, getHex);
PHP_METHOD(Phalcon_Version, getHexForString);
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_version_gethexforstring, 0, 0, 1)
	ZEND_ARG_INFO(0, str)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_version_method_entry) {
	...
	PHP_ME(Phalcon_Version, getHex, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Version, getHexForString, arginfo_phalcon_version_gethexforstring, ZEND_ACC_PUBLIC)
  PHP_FE_END
};
