...
PHP_METHOD(Phalcon_Image_Adapter, resize) {
	...
	ZEPHIR_INIT_VAR(_25);
	ZVAL_LONG(_25, 1);
	ZEPHIR_CALL_FUNCTION(&_26, "max", &_27, 71, _23, _25);
	...
	ZEPHIR_INIT_VAR(_29);
	ZVAL_LONG(_29, 1);
	ZEPHIR_CALL_FUNCTION(&_30, "max", &_27, 71, _25, _29);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, text) {
	...
	ZEPHIR_SINIT_VAR(_9);
	ZVAL_LONG(&_9, 2);
	ZEPHIR_CALL_FUNCTION(&_10, "str_split", NULL, 72, color, &_9);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_9);
	ZVAL_STRING(&_9, "hexdec", 0);
	ZEPHIR_CALL_FUNCTION(&colors, "array_map", NULL, 73, &_9, _10);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter, render) {
	...
	if (!(!(!ext) && Z_STRLEN_P(ext))) {
		...
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 74, _0$$3, &_1$$3);
		zephir_check_call_status();
