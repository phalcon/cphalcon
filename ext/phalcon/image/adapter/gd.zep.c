...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText)
{
	...
	if (!(ZEPHIR_IS_EMPTY(&fontfile))) {
		...
		ZEPHIR_CALL_FUNCTION(&_9$$3, "abs", NULL, 240, &_3$$3);
		zephir_check_call_status();
		width = (zephir_get_numberval(&_9$$3) + 10);
		ZVAL_LONG(&_3$$3, (topRightY - bottomLeftY));
		ZEPHIR_CALL_FUNCTION(&_10$$3, "abs", NULL, 240, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 376, &_3$$3, &_4$$3, &_13$$3, &_14$$3, &_15$$3);
		zephir_check_call_status();
		angle = 0;
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", NULL, 405, &_4$$3, &_13$$3, &_14$$3, &_15$$3, &_16$$3, &color, &fontfile, &text);
		zephir_check_call_status();
	} else {
		ZVAL_LONG(&_17$$8, size);
		ZEPHIR_CALL_FUNCTION(&_18$$8, "imagefontwidth", NULL, 406, &_17$$8);
		zephir_check_call_status();
		width = (zephir_get_intval(&_18$$8) * zephir_fast_strlen_ev(&text));
		ZVAL_LONG(&_17$$8, size);
		ZEPHIR_CALL_FUNCTION(&_19$$8, "imagefontheight", NULL, 407, &_17$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 376, &_17$$8, &_22$$8, &_23$$8, &_24$$8, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagestring", NULL, 408, &_22$$8, &_23$$8, &_24$$8, &_25$$8, &text, &color);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
