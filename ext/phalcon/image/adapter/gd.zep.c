...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct)
{
	...
	zval file_zv, *width_param = NULL, *height_param = NULL, __$true, image, imageInfo, _0, _1, _2$$3, _3$$3, _5$$3, _12$$3, _21$$3, _6$$4, _7$$4, _8$$4, _9$$4, _10$$5, _11$$5, _13$$6, _14$$7, _15$$8, _16$$9, _17$$10, _18$$11, _19$$12, _20$$12, _25$$13, _26$$13, _27$$13, _28$$13, _29$$13, _23$$14, _24$$14;
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 914, &file_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_0);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "realpath", NULL, 158, &_2$$3);
		zephir_check_call_status();
		zephir_cast_to_string(&_4$$3, &_3$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 916, &_4$$3);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&imageInfo, "getimagesize", NULL, 0, &_5$$3);
		zephir_check_call_status();
		if (!ZEPHIR_IS_FALSE_IDENTICAL(&imageInfo)) {
			zephir_array_fetch_long(&_6$$4, &imageInfo, 0, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/Gd.zep", 84);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 917, &_6$$4);
			zephir_array_fetch_long(&_7$$4, &imageInfo, 1, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/Gd.zep", 85);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 918, &_7$$4);
			zephir_array_fetch_long(&_8$$4, &imageInfo, 2, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/Gd.zep", 86);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_8$$4);
			zephir_array_fetch_string(&_9$$4, &imageInfo, SL("mime"), PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/Gd.zep", 87);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 919, &_9$$4);
		} else {
			ZEPHIR_INIT_VAR(&_10$$5);
			object_init_ex(&_10$$5, phalcon_image_exceptions_imageloadfailed_ce);
			zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_10$$5, "__construct", NULL, 0, &_11$$5);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_10$$5, "phalcon/Image/Adapter/Gd.zep", 89);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_memory_observe(&_12$$3);
		zephir_read_property_cached(&_12$$3, this_ptr, _zephir_prop_1, 915, PH_NOISY_CC);
		do {
			if (ZEPHIR_IS_LONG(&_12$$3, 1)) {
				zephir_read_property_cached(&_13$$6, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromgif", NULL, 0, &_13$$6);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 2) || ZEPHIR_IS_LONG(&_12$$3, 9)) {
				zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromjpeg", NULL, 0, &_14$$7);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 3)) {
				zephir_read_property_cached(&_15$$8, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefrompng", NULL, 0, &_15$$8);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 18)) {
				zephir_read_property_cached(&_16$$9, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromwebp", NULL, 0, &_16$$9);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 15)) {
				zephir_read_property_cached(&_17$$10, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromwbmp", NULL, 0, &_17$$10);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 16)) {
				zephir_read_property_cached(&_18$$11, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromxbm", NULL, 0, &_18$$11);
				zephir_check_call_status();
				break;
			}
			ZEPHIR_INIT_VAR(&_19$$12);
			object_init_ex(&_19$$12, phalcon_image_exceptions_unsupportedimagetype_ce);
			zephir_read_property_cached(&_20$$12, this_ptr, _zephir_prop_5, 919, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_19$$12, "__construct", NULL, 0, &_20$$12);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_19$$12, "phalcon/Image/Adapter/Gd.zep", 119);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);

		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 920, &image);
		zephir_read_property_cached(&_21$$3, this_ptr, _zephir_prop_6, 920, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 0, &_21$$3, &__$true);
		zephir_check_call_status();
	} else {
		_22$$13 = 0 == width;
		if (!(_22$$13)) {
		...
		if (_22$$13) {
			...
			object_init_ex(&_23$$14, phalcon_image_exceptions_imageloadfailed_ce);
			zephir_read_property_cached(&_24$$14, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_23$$14, "__construct", NULL, 0, &_24$$14);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_23$$14, "phalcon/Image/Adapter/Gd.zep", 128);
			ZEPHIR_MM_RESTORE();
			return;
		}
		ZVAL_LONG(&_25$$13, width);
		ZVAL_LONG(&_26$$13, height);
		ZEPHIR_CALL_FUNCTION(&image, "imagecreatetruecolor", NULL, 0, &_25$$13, &_26$$13);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 920, &image);
		zephir_read_property_cached(&_25$$13, this_ptr, _zephir_prop_6, 920, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 0, &_25$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_26$$13, this_ptr, _zephir_prop_6, 920, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 0, &_26$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_27$$13, this_ptr, _zephir_prop_0, 914, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 916, &_27$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 917, &_28$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, height);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 918, &_28$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, 3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_28$$13);
		ZEPHIR_INIT_VAR(&_29$$13);
		ZEPHIR_INIT_NVAR(&_29$$13);
		ZVAL_STRING(&_29$$13, "image/png");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 919, &_29$$13);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, getVersion)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exceptions_extensionnotloaded_ce, "GD", "phalcon/Image/Adapter/Gd.zep", 179);
		return;
	}
	...
	if (zephir_is_true(&_2)) {
		...
		zephir_array_fetch_string(&reported, &info, SL("GD Version"), PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 191);
		...
		if (zephir_is_true(&_4$$5)) {
			...
			zephir_array_fetch_long(&version, &matches, 0, PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 200);
		}
	}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBackground)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 920, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&image, &_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	ZVAL_LONG(&_9, 0);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 920, &background);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processCrop)
{
	...
	zephir_read_property_cached(&current, this_ptr, _zephir_prop_0, 920, PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&image, "imagecrop", NULL, 0, &current, &rect);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 920, &image);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 918, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processMask)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
	_9 = !ZEPHIR_IS_LONG_IDENTICAL(&_5, maskWidth);
	if (!(_9)) {
		zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		_9 = !ZEPHIR_IS_LONG_IDENTICAL(&_6, maskHeight);
	}
	if (_9) {
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&width, &_10$$3);
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&height, &_10$$3);
		ZEPHIR_CALL_FUNCTION(&tempImage, "imagecreatetruecolor", NULL, 0, &width, &height);
		zephir_check_call_status();
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_12$$3, 0);
		ZVAL_LONG(&_13$$3, 0);
		ZVAL_LONG(&_14$$3, 0);
		ZVAL_LONG(&_15$$3, 0);
	...
	x = 0;
	while (1) {
		zephir_read_property_cached(&_7, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		if (!(ZEPHIR_GT_LONG(&_7, x))) {
			break;
		}
		y = 0;
		while (1) {
			zephir_read_property_cached(&_18$$4, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
			zephir_array_fetch_string(&_23$$5, &color, SL("red"), PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/Gd.zep", 393);
			...
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&red);
			zephir_array_fetch_string(&red, &color, SL("red"), PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 398);
			ZEPHIR_OBS_NVAR(&green);
			zephir_array_fetch_string(&green, &color, SL("green"), PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 399);
			ZEPHIR_OBS_NVAR(&blue);
			zephir_array_fetch_string(&blue, &color, SL("blue"), PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 400);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 920, &newImage);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processPixelate)
{
	...
	x = 0;
	while (1) {
		zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		if (!(ZEPHIR_GT_LONG(&_0, x))) {
			break;
		}
		y = 0;
		while (1) {
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
			if (!(ZEPHIR_GT_LONG(&_1$$3, y))) {
				break;
			}
			x1 = ((x + (zephir_safe_div_long_long(amount, 2))));
			y1 = ((y + (zephir_safe_div_long_long(amount, 2))));
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
			_3$$4 = ZEPHIR_LE_LONG(&_2$$4, x1);
			if (!(_3$$4)) {
				zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processReflection)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_10$$5, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		sourceY = ((zephir_get_numberval(&_10$$5) - offset) - 1);
		zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_16$$5, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_17$$5, 1);
		ZEPHIR_CALL_METHOD(&line, this_ptr, "processcreate", NULL, 0, &_16$$5, &_17$$5);
		zephir_check_call_status();
		zephir_read_property_cached(&_17$$5, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_18$$5, 0);
		ZVAL_LONG(&_19$$5, 0);
		ZVAL_LONG(&_20$$5, 0);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_18$$5, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_19$$5, 0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 920, &reflection);
	ZEPHIR_CALL_FUNCTION(&_25, "imagesx", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 917, &_25);
	ZEPHIR_CALL_FUNCTION(&_26, "imagesy", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 918, &_26);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRender)
{
	...
	do {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$9, "phalcon/Image/Adapter/Gd.zep", 586);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processResize)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_2, 0);
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 0);
	ZVAL_LONG(&_5, 0);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 917, &_8);
	ZEPHIR_CALL_FUNCTION(&_9, "imagesy", NULL, 0, &image);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 918, &_9);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRotate)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 920, &image);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 917, &width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 918, &height);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave)
{
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			ZVAL_UNDEF(&_5$$4);
			ZVAL_LONG(&_5$$4, 1);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_5$$4);
		...
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			ZVAL_UNDEF(&_6$$5);
			ZVAL_LONG(&_6$$5, 2);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_6$$5);
			if (quality >= 0) {
		...
		if (ZEPHIR_IS_STRING(&extension, "png")) {
			ZVAL_UNDEF(&_10$$8);
			ZVAL_LONG(&_10$$8, 3);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_10$$8);
		...
		if (ZEPHIR_IS_STRING(&extension, "wbmp")) {
			ZVAL_UNDEF(&_11$$9);
			ZVAL_LONG(&_11$$9, 15);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_11$$9);
		...
		if (ZEPHIR_IS_STRING(&extension, "webp")) {
			ZVAL_UNDEF(&_12$$10);
			ZVAL_LONG(&_12$$10, 18);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_12$$10);
		...
		if (ZEPHIR_IS_STRING(&extension, "xbm")) {
			ZVAL_UNDEF(&_13$$11);
			ZVAL_LONG(&_13$$11, 16);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 915, &_13$$11);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_14$$12, "phalcon/Image/Adapter/Gd.zep", 712);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);

	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 915, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&_15, "image_type_to_mime_type", NULL, 0, &_0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &_15);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSharpen)
{
	...
	zephir_array_fast_append(&_3, &_4);
	zephir_array_fast_append(&matrix, &_3);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 920, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&result)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 917, &_7$$3);
		ZEPHIR_CALL_FUNCTION(&_8$$3, "imagesy", NULL, 0, &image);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 918, &_8$$3);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&fontFile_zv)) {
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(&space)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_7$$4, "phalcon/Image/Adapter/Gd.zep", 783);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (1 == zephir_array_isset_value_long(&space, 0)) {
			zephir_memory_observe(&_8$$5);
			zephir_array_fetch_long(&_8$$5, &space, 0, PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 787);
			bottomLeftX = zephir_get_intval(&_8$$5);
			zephir_memory_observe(&_9$$5);
			zephir_array_fetch_long(&_9$$5, &space, 1, PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 788);
			bottomLeftY = zephir_get_intval(&_9$$5);
			zephir_memory_observe(&_10$$5);
			zephir_array_fetch_long(&_10$$5, &space, 4, PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 789);
			topRightX = zephir_get_intval(&_10$$5);
			zephir_memory_observe(&_11$$5);
			zephir_array_fetch_long(&_11$$5, &space, 5, PH_NOISY, "phalcon/Image/Adapter/Gd.zep", 790);
		...
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_14$$6, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_17$$7, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_24$$9, this_ptr, _zephir_prop_1, 917, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_27$$10, this_ptr, _zephir_prop_2, 918, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, check)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_2)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$3, "phalcon/Image/Adapter/Gd.zep", 924);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
