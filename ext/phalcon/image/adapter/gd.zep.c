...
PHP_METHOD(Phalcon_Image_Adapter_Gd, check) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "defined", NULL, 237, &_1);
	...
	ZEPHIR_SINIT_VAR(_6);
	ZVAL_STRING(&_6, ">=", 0);
	ZEPHIR_CALL_FUNCTION(&_7, "version_compare", NULL, 248, version, &_1, &_6);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	if ((zephir_file_exists(_1 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&imageinfo, "getimagesize", NULL, 249, _4$$4);
		zephir_check_call_status();
		...
		do {
			if (ZEPHIR_IS_LONG(_9$$4, 1)) {
				...
				ZEPHIR_CALL_FUNCTION(&_11$$6, "imagecreatefromgif", NULL, 250, _10$$6);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(_9$$4, 2)) {
				...
				ZEPHIR_CALL_FUNCTION(&_13$$7, "imagecreatefromjpeg", NULL, 251, _12$$7);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(_9$$4, 3)) {
				...
				ZEPHIR_CALL_FUNCTION(&_15$$8, "imagecreatefrompng", NULL, 252, _14$$8);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(_9$$4, 15)) {
				...
				ZEPHIR_CALL_FUNCTION(&_17$$9, "imagecreatefromwbmp", NULL, 253, _16$$9);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(_9$$4, 16)) {
				...
				ZEPHIR_CALL_FUNCTION(&_19$$10, "imagecreatefromxbm", NULL, 254, _18$$10);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_25, 255, _24$$4, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
	} else {
		_26$$14 = !width;
		if (!(_26$$14)) {
		...
		ZEPHIR_CALL_FUNCTION(&_32$$14, "imagecreatetruecolor", NULL, 256, &_30$$14, &_31$$14);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 257, _33$$14, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
		_34$$14 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_25, 255, _34$$14, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _resize) {
	...
	if (ZEPHIR_LT_LONG(_2, 0)) {
		...
		if (_4$$3) {
			...
			ZVAL_LONG(&_16$$4, 0);
			ZEPHIR_CALL_FUNCTION(&_17$$4, "imagecopyresized", NULL, 258, image, _10$$4, &_13$$4, &_14$$4, &_15$$4, &_16$$4, pre_width, pre_height, _11$$4, _12$$4);
			zephir_check_call_status();
			if (zephir_is_true(_17$$4)) {
				_18$$6 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
				ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_19, 259, _18$$6);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_29$$3, "imagecopyresampled", NULL, 260, image, _22$$3, &_23$$3, &_24$$3, &_25$$3, &_26$$3, &_27$$3, &_28$$3, pre_width, pre_height);
		zephir_check_call_status();
		if (zephir_is_true(_29$$3)) {
			_30$$7 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_19, 259, _30$$7);
			zephir_check_call_status();
			zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_31$$7, "imagesx", &_32, 261, image);
			zephir_check_call_status();
			zephir_update_property_this(this_ptr, SL("_width"), _31$$7 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_33$$7, "imagesy", &_34, 262, image);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&image, "imagescale", NULL, 263, _35$$8, &_36$$8, &_37$$8);
		zephir_check_call_status();
		_38$$8 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_19, 259, _38$$8);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_39$$8, "imagesx", &_32, 261, image);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_width"), _39$$8 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_40$$8, "imagesy", &_34, 262, image);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _crop) {
	...
	if (ZEPHIR_LT_LONG(_2, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_14$$3, "imagecopyresampled", NULL, 260, image, _5$$3, &_6$$3, &_7$$3, &_8$$3, &_9$$3, &_10$$3, &_11$$3, &_12$$3, &_13$$3);
		zephir_check_call_status();
		if (zephir_is_true(_14$$3)) {
			_15$$4 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_16, 259, _15$$4);
			zephir_check_call_status();
			zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_17$$4, "imagesx", &_18, 261, image);
			zephir_check_call_status();
			zephir_update_property_this(this_ptr, SL("_width"), _17$$4 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_19$$4, "imagesy", &_20, 262, image);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&image, "imagecrop", NULL, 264, _22$$5, rect);
		zephir_check_call_status();
		_23$$5 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_16, 259, _23$$5);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_24$$5, "imagesx", &_18, 261, image);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_width"), _24$$5 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_25$$5, "imagesy", &_20, 262, image);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _rotate) {
	...
	if (zephir_is_true(_8)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 259, _9$$3);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
	...
	if (ZEPHIR_LT_LONG(_2, 0)) {
		...
		if (direction == 11) {
			...
			while (1) {
				...
				ZVAL_LONG(&_13$$5, 1);
				ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_14, 268, image, _6$$5, &_9$$5, &_10$$5, &_11$$5, &_12$$5, &_13$$5, _8$$5);
				zephir_check_call_status();
			}
		} else {
			x = 0;
			while (1) {
				...
				ZVAL_LONG(&_23$$7, 1);
				ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_14, 268, image, _16$$7, &_19$$7, &_20$$7, &_21$$7, &_22$$7, _18$$7, &_23$$7);
				zephir_check_call_status();
			}
		}
		_24$$3 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 259, _24$$3);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_image"), image TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_25$$3, "imagesx", NULL, 261, image);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_width"), _25$$3 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_26$$3, "imagesy", NULL, 262, image);
		zephir_check_call_status();
		...
		if (direction == 11) {
			...
			ZVAL_LONG(&_28$$9, 1);
			ZEPHIR_CALL_FUNCTION(NULL, "imageflip", &_29, 269, _27$$9, &_28$$9);
			zephir_check_call_status();
		} else {
			_30$$10 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_SINIT_VAR(_31$$10);
			ZVAL_LONG(&_31$$10, 2);
			ZEPHIR_CALL_FUNCTION(NULL, "imageflip", &_29, 269, _30$$10, &_31$$10);
			zephir_check_call_status();
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _sharpen) {
	...
	if (zephir_is_true(_8)) {
		_9$$3 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(&_10$$3, "imagesx", NULL, 261, _9$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_12$$3, "imagesy", NULL, 262, _11$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _reflection) {
	...
	while (1) {
		...
		ZVAL_LONG(&_28$$5, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_13, 268, line, _22$$5, &_24$$5, &_25$$5, &_26$$5, &_27$$5, _23$$5, &_28$$5);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_24$$5);
		ZVAL_LONG(&_24$$5, 4);
		ZEPHIR_SINIT_NVAR(_25$$5);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagefilter", &_29, 271, line, &_24$$5, &_25$$5, &_26$$5, &_27$$5, &_28$$5);
		zephir_check_call_status();
		...
		ZEPHIR_SINIT_NVAR(_28$$5);
		ZVAL_LONG(&_28$$5, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_13, 268, reflection, line, &_24$$5, &_25$$5, &_26$$5, &_27$$5, _30$$5, &_28$$5);
		zephir_check_call_status();
		offset++;
	}
	_31 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 259, _31);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_image"), reflection TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_32, "imagesx", NULL, 261, reflection);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("_width"), _32 TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_33, "imagesy", NULL, 262, reflection);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	if (opacity < 100) {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 265, overlay, &_4$$3, &_6$$3, &_7$$3, &_8$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_4$$3);
		ZVAL_LONG(&_4$$3, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "imagelayereffect", NULL, 273, overlay, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_4$$3);
		ZVAL_LONG(&_4$$3, 0);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagefilledrectangle", NULL, 274, overlay, &_4$$3, &_6$$3, &_7$$3, &_8$$3, color);
		zephir_check_call_status();
	}
	...
	ZEPHIR_CALL_FUNCTION(&_17, "imagecopy", NULL, 268, _10, overlay, &_11, &_12, &_13, &_14, &_15, &_16);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (!(!fontfile) && Z_STRLEN_P(fontfile)) {
		...
		ZVAL_LONG(&_5$$3, 0);
		ZEPHIR_CALL_FUNCTION(&space, "imagettfbbox", NULL, 275, &_4$$3, &_5$$3, fontfile, text);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_20, 265, _17$$3, &_4$$3, &_5$$3, &_18$$3, &_19$$3);
		zephir_check_call_status();
		angle = 0;
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", NULL, 276, _21$$3, &_4$$3, &_5$$3, &_18$$3, &_19$$3, color, fontfile, text);
		zephir_check_call_status();
	} else {
		ZEPHIR_SINIT_VAR(_22$$8);
		ZVAL_LONG(&_22$$8, size);
		ZEPHIR_CALL_FUNCTION(&_23$$8, "imagefontwidth", NULL, 277, &_22$$8);
		zephir_check_call_status();
		width = (zephir_get_intval(_23$$8) * zephir_fast_strlen_ev(text));
		ZEPHIR_SINIT_NVAR(_22$$8);
		ZVAL_LONG(&_22$$8, size);
		ZEPHIR_CALL_FUNCTION(&_24$$8, "imagefontheight", NULL, 278, &_22$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_20, 265, _27$$8, &_22$$8, &_28$$8, &_29$$8, &_30$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagestring", NULL, 279, _31$$8, &_22$$8, &_28$$8, &_29$$8, text, color);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _mask) {
	...
	if (_12) {
		...
		ZEPHIR_CALL_FUNCTION(&tempImage, "imagecreatetruecolor", NULL, 256, _14$$3, _15$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopyresampled", NULL, 260, tempImage, maskImage, &_18$$3, &_19$$3, &_20$$3, &_21$$3, _16$$3, _17$$3, &_22$$3, &_23$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_24, 259, maskImage);
		zephir_check_call_status();
	...
	while (1) {
		...
		while (1) {
			...
			ZEPHIR_SINIT_NVAR(_28$$5);
			ZVAL_LONG(&_28$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_29, 281, maskImage, &_27$$5, &_28$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_30, 282, maskImage, index);
			zephir_check_call_status();
			...
			ZEPHIR_SINIT_NVAR(_28$$5);
			ZVAL_LONG(&_28$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_29, 281, _33$$5, &_27$$5, &_28$$5);
			zephir_check_call_status();
			_34$$5 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_30, 282, _34$$5, index);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(r);
			...
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_10, 265, newimage, r, g, b, &_27$$5);
			zephir_check_call_status();
			ZEPHIR_SINIT_NVAR(_27$$5);
			ZVAL_LONG(&_27$$5, x);
			ZEPHIR_SINIT_NVAR(_28$$5);
			ZVAL_LONG(&_28$$5, y);
			ZEPHIR_CALL_FUNCTION(NULL, "imagesetpixel", &_35, 283, newimage, &_27$$5, &_28$$5, color);
			zephir_check_call_status();
			y++;
		}
		x++;
	...
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_24, 259, _36);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_24, 259, maskImage);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _background) {
	...
	if (zephir_is_true(_9)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 259, _10$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _blur) {
	...
	while (1) {
		...
		ZVAL_LONG(&_1$$3, 7);
		ZEPHIR_CALL_FUNCTION(NULL, "imagefilter", &_2, 271, _0$$3, &_1$$3);
		zephir_check_call_status();
		i++;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _pixelate) {
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_4$$4, y1);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorat", &_5, 281, _2$$4, &_3$$4, &_4$$4);
			zephir_check_call_status();
			x2 = (x + amount);
			y2 = (y + amount);
			...
			ZVAL_LONG(&_8$$4, y2);
			ZEPHIR_CALL_FUNCTION(NULL, "imagefilledrectangle", &_9, 274, _6$$4, &_3$$4, &_4$$4, &_7$$4, &_8$$4, color);
			zephir_check_call_status();
			y += amount;
		}
		x += amount;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _save) {
	...
	if (!(zephir_is_true(ext))) {
		...
		ZEPHIR_CALL_FUNCTION(&ext, "image_type_to_extension", NULL, 284, _1$$3, ZEPHIR_GLOBAL(global_false));
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(_2);
	...
	ZEPHIR_CALL_FUNCTION(&_3, "strcmp", &_4, 285, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_3, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$4, "image_type_to_mime_type", &_7, 286, _5$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagegif", NULL, 287, _8$$4, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "jpg", 0);
	ZEPHIR_CALL_FUNCTION(&_9, "strcmp", &_4, 285, ext, &_0);
	zephir_check_call_status();
	_10 = ZEPHIR_IS_LONG(_9, 0);
	if (!(_10)) {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "jpeg", 0);
		ZEPHIR_CALL_FUNCTION(&_11, "strcmp", &_4, 285, ext, &_0);
		zephir_check_call_status();
	...
	if (_10) {
		...
		ZEPHIR_CALL_FUNCTION(&_13$$5, "image_type_to_mime_type", &_7, 286, _12$$5);
		zephir_check_call_status();
		...
		if (quality >= 0) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", &_16, 288, _14$$6, file, &_15$$6);
			zephir_check_call_status();
		} else {
			_17$$9 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", &_16, 288, _17$$9, file);
			zephir_check_call_status();
		}
		RETURN_MM_BOOL(1);
	}
	...
	ZEPHIR_CALL_FUNCTION(&_18, "strcmp", &_4, 285, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_18, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$10, "image_type_to_mime_type", &_7, 286, _19$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagepng", NULL, 289, _21$$10, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "wbmp", 0);
	ZEPHIR_CALL_FUNCTION(&_22, "strcmp", &_4, 285, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_22, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_24$$11, "image_type_to_mime_type", &_7, 286, _23$$11);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagewbmp", NULL, 290, _25$$11, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "xbm", 0);
	ZEPHIR_CALL_FUNCTION(&_26, "strcmp", &_4, 285, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_26, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_28$$12, "image_type_to_mime_type", &_7, 286, _27$$12);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagexbm", NULL, 291, _29$$12, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_INIT_NVAR(_2);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _render) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "strcmp", &_3, 285, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_2, 0)) {
		_4$$3 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagegif", NULL, 287, _4$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 292);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_SINIT_NVAR(_1);
	ZVAL_STRING(&_1, "jpg", 0);
	ZEPHIR_CALL_FUNCTION(&_6, "strcmp", &_3, 285, ext, &_1);
	zephir_check_call_status();
	_7 = ZEPHIR_IS_LONG(_6, 0);
	if (!(_7)) {
		ZEPHIR_SINIT_NVAR(_1);
		ZVAL_STRING(&_1, "jpeg", 0);
		ZEPHIR_CALL_FUNCTION(&_8, "strcmp", &_3, 285, ext, &_1);
		zephir_check_call_status();
	...
	if (_7) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 288, _9$$4, ZEPHIR_GLOBAL(global_null), &_10$$4);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 292);
		zephir_check_call_status();
		RETURN_MM();
	...
	ZEPHIR_CALL_FUNCTION(&_11, "strcmp", &_3, 285, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_11, 0)) {
		_12$$5 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagepng", NULL, 289, _12$$5);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 292);
		zephir_check_call_status();
		RETURN_MM();
	...
	ZEPHIR_CALL_FUNCTION(&_13, "strcmp", &_3, 285, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_13, 0)) {
		_14$$6 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagewbmp", NULL, 290, _14$$6);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 292);
		zephir_check_call_status();
		RETURN_MM();
	...
	ZEPHIR_CALL_FUNCTION(&_15, "strcmp", &_3, 285, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_15, 0)) {
		_16$$7 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_CALL_FUNCTION(NULL, "imagexbm", NULL, 291, _16$$7, ZEPHIR_GLOBAL(global_null));
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 292);
		zephir_check_call_status();
		RETURN_MM();
