...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "check", NULL, 358);
	...
	if (1 == (zephir_file_exists(&_0) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&imageInfo, "getimagesize", NULL, 310, &_3$$3);
		zephir_check_call_status();
		...
		do {
			if (ZEPHIR_IS_LONG(&_8$$3, 1)) {
				...
				ZEPHIR_CALL_FUNCTION(&_10$$5, "imagecreatefromgif", NULL, 359, &_9$$5);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_8$$3, 2) || ZEPHIR_IS_LONG(&_8$$3, 9)) {
				...
				ZEPHIR_CALL_FUNCTION(&_12$$6, "imagecreatefromjpeg", NULL, 360, &_11$$6);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_8$$3, 3)) {
				...
				ZEPHIR_CALL_FUNCTION(&_14$$7, "imagecreatefrompng", NULL, 361, &_13$$7);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_8$$3, 18)) {
				...
				ZEPHIR_CALL_FUNCTION(&_16$$8, "imagecreatefromwebp", NULL, 362, &_15$$8);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_8$$3, 15)) {
				...
				ZEPHIR_CALL_FUNCTION(&_18$$9, "imagecreatefromwbmp", NULL, 363, &_17$$9);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&_8$$3, 16)) {
				...
				ZEPHIR_CALL_FUNCTION(&_20$$10, "imagecreatefromxbm", NULL, 364, &_19$$10);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 365, &_25$$3, &__$true);
		zephir_check_call_status();
	} else {
		_26$$13 = 0 == width;
		if (!(_26$$13)) {
		...
		ZEPHIR_CALL_FUNCTION(&_32$$13, "imagecreatetruecolor", NULL, 366, &_30$$13, &_31$$13);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 367, &_30$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property(&_31$$13, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 365, &_31$$13, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBackground)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "abs", NULL, 280, &_1);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_8, 0);
	ZVAL_LONG(&_9, 0);
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopy", NULL, 371, &background, &image, &_6, &_7, &_8, &_9, &_4, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processMask)
{
	...
	while (1) {
		...
		while (1) {
			...
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 370, &newImage, &red, &green, &blue, &_27$$5);
			zephir_check_call_status();
			ZVAL_LONG(&_27$$5, x);
			ZVAL_LONG(&_28$$5, y);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processPixelate)
{
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_7$$4, x);
			ZVAL_LONG(&_9$$4, y);
			ZEPHIR_CALL_FUNCTION(NULL, "imagefilledrectangle", &_10, 383, &_6$$4, &_7$$4, &_9$$4, &x2, &y2, &color);
			zephir_check_call_status();
			y += amount;
		}
		x += amount;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRender)
{
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagegif", NULL, 385, &_1$$3);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRotate)
{
	...
	ZEPHIR_CALL_FUNCTION(&image, "imagerotate", NULL, 393, &_1, &_2, &transparent);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 365, &image, &__$true);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 100);
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopymerge", NULL, 394, &_2, &image, &_3, &_4, &_5, &_6, &width, &height, &_7);
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_read_property(&_8$$3, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 368, &_8$$3);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("image"), &image);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&extension)) {
		...
		ZEPHIR_CALL_FUNCTION(&extension, "image_type_to_extension", NULL, 395, &_1$$3, &__$false);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagegif", NULL, 385, &_3$$4, &file);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			...
			if (quality >= 0) {
				...
				ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 386, &_6$$6, &file, &_7$$6);
				zephir_check_call_status();
			} else {
				zephir_read_property(&_8$$7, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 386, &_8$$7, &file);
				zephir_check_call_status();
			}
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "png")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagepng", NULL, 387, &_9$$8, &file);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "wbmp")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagewbmp", NULL, 388, &_10$$9, &file);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "webp")) {
		...
		if (ZEPHIR_IS_STRING(&extension, "xbm")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "imagexbm", NULL, 390, &_12$$11, &file);
			zephir_check_call_status();
			break;
		}
	...
	ZEPHIR_CALL_FUNCTION(&_15, "image_type_to_mime_type", NULL, 396, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSharpen)
{
	...
	ZVAL_LONG(&_7, 0);
	ZEPHIR_CALL_FUNCTION(&result, "imageconvolution", NULL, 397, &_5, &matrix, &_6, &_7);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&result)) {
		zephir_read_property(&_8$$3, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_9$$3, "imagesx", NULL, 374, &_8$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_11$$3, "imagesy", NULL, 375, &_10$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "abs", NULL, 280, &_3);
	zephir_check_call_status();
	...
	if (1 != ZEPHIR_IS_EMPTY(&fontFile)) {
		ZVAL_LONG(&_5$$3, size);
		ZVAL_LONG(&_6$$3, 0);
		ZEPHIR_CALL_FUNCTION(&space, "imagettfbbox", NULL, 398, &_5$$3, &_6$$3, &fontFile, &text);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_11$$3, "abs", NULL, 280, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&width, (zephir_get_numberval(&_11$$3) + 10));
		ZVAL_LONG(&_5$$3, (topRightY - bottomLeftY));
		ZEPHIR_CALL_FUNCTION(&_12$$3, "abs", NULL, 280, &_5$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 370, &_5$$3, &_6$$3, &_19$$3, &_20$$3, &_21$$3);
		zephir_check_call_status();
		angle = 0;
		zephir_read_property(&_6$$3, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_19$$3, size);
		ZVAL_LONG(&_20$$3, angle);
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", NULL, 399, &_6$$3, &_19$$3, &_20$$3, offsetX, offsetY, &color, &fontFile, &text);
		zephir_check_call_status();
	} else {
		ZVAL_LONG(&_22$$8, size);
		ZEPHIR_CALL_FUNCTION(&_23$$8, "imagefontwidth", NULL, 400, &_22$$8);
		zephir_check_call_status();
		ZVAL_LONG(&width, (zephir_get_numberval(&_23$$8) * zephir_fast_strlen_ev(&text)));
		ZVAL_LONG(&_22$$8, size);
		ZEPHIR_CALL_FUNCTION(&height, "imagefontheight", NULL, 401, &_22$$8);
		zephir_check_call_status();
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 370, &_22$$8, &_30$$8, &_31$$8, &_32$$8, &_33$$8);
		zephir_check_call_status();
		zephir_read_property(&_30$$8, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_31$$8, size);
		ZEPHIR_CALL_FUNCTION(NULL, "imagestring", NULL, 402, &_30$$8, &_31$$8, offsetX, offsetY, &text, &color);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processWatermark)
{
	...
	if (opacity < 100) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "abs", NULL, 280, &_4$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopy", NULL, 371, &_10, &overlay, &_11, &_12, &_13, &_14, &_15, &_16);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, check)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, ">=");
	ZEPHIR_CALL_FUNCTION(&_2, "version_compare", NULL, 130, &version, &_0, &_1);
	zephir_check_call_status();
