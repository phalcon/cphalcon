...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 915, &file_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_0);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "realpath", NULL, 158, &_2$$3);
		zephir_check_call_status();
		zephir_cast_to_string(&_4$$3, &_3$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 917, &_4$$3);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_12$$3, this_ptr, _zephir_prop_1, 916, PH_NOISY_CC);
		do {
			if (ZEPHIR_IS_LONG(&_12$$3, 1)) {
				zephir_read_property_cached(&_13$$6, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromgif", NULL, 0, &_13$$6);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 2) || ZEPHIR_IS_LONG(&_12$$3, 9)) {
				zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromjpeg", NULL, 0, &_14$$7);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 3)) {
				zephir_read_property_cached(&_15$$8, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefrompng", NULL, 0, &_15$$8);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 18)) {
				zephir_read_property_cached(&_16$$9, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromwebp", NULL, 0, &_16$$9);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 15)) {
				zephir_read_property_cached(&_17$$10, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&image, "imagecreatefromwbmp", NULL, 0, &_17$$10);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&_12$$3, 16)) {
				zephir_read_property_cached(&_18$$11, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_20$$12, this_ptr, _zephir_prop_5, 920, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 921, &image);
		zephir_read_property_cached(&_21$$3, this_ptr, _zephir_prop_6, 921, PH_NOISY_CC | PH_READONLY);
		...
		if (_22$$13) {
			...
			zephir_read_property_cached(&_24$$14, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 921, &image);
		zephir_read_property_cached(&_25$$13, this_ptr, _zephir_prop_6, 921, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 0, &_25$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_26$$13, this_ptr, _zephir_prop_6, 921, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 0, &_26$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_27$$13, this_ptr, _zephir_prop_0, 915, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 917, &_27$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 918, &_28$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, height);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 919, &_28$$13);
		ZVAL_UNDEF(&_28$$13);
		ZVAL_LONG(&_28$$13, 3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_28$$13);
		ZEPHIR_INIT_VAR(&_29$$13);
		ZEPHIR_INIT_NVAR(&_29$$13);
		ZVAL_STRING(&_29$$13, "image/png");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 920, &_29$$13);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __destruct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &__$null);
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBackground)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&image, &_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	ZVAL_LONG(&_9, 0);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &background);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processCrop)
{
	...
	zephir_read_property_cached(&current, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&image, "imagecrop", NULL, 0, &current, &rect);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &image);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processMask)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
	_9 = !ZEPHIR_IS_LONG_IDENTICAL(&_5, maskWidth);
	if (!(_9)) {
		zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	...
	if (_9) {
		...
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&height, &_10$$3);
		ZEPHIR_CALL_FUNCTION(&tempImage, "imagecreatetruecolor", NULL, 0, &width, &height);
		zephir_check_call_status();
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_12$$3, 0);
		ZVAL_LONG(&_13$$3, 0);
		ZVAL_LONG(&_14$$3, 0);
		ZVAL_LONG(&_15$$3, 0);
	...
	x = 0;
	while (1) {
		zephir_read_property_cached(&_7, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		if (!(ZEPHIR_GT_LONG(&_7, x))) {
			break;
		}
		y = 0;
		while (1) {
			zephir_read_property_cached(&_18$$4, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &newImage);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processPixelate)
{
	...
	while (1) {
		...
		y = 0;
		while (1) {
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
			...
			if (!(_3$$4)) {
				zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processReflection)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_10$$5, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
		sourceY = ((zephir_get_numberval(&_10$$5) - offset) - 1);
		zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_16$$5, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_17$$5, 1);
		ZEPHIR_CALL_METHOD(&line, this_ptr, "processcreate", NULL, 0, &_16$$5, &_17$$5);
		zephir_check_call_status();
		zephir_read_property_cached(&_17$$5, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_18$$5, 0);
		ZVAL_LONG(&_19$$5, 0);
		ZVAL_LONG(&_20$$5, 0);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_18$$5, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_19$$5, 0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &reflection);
	ZEPHIR_CALL_FUNCTION(&_25, "imagesx", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 918, &_25);
	ZEPHIR_CALL_FUNCTION(&_26, "imagesy", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &_26);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processResize)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_2, 0);
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 0);
	ZVAL_LONG(&_5, 0);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 918, &_8);
	ZEPHIR_CALL_FUNCTION(&_9, "imagesy", NULL, 0, &image);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &_9);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRotate)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &image);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 918, &width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &height);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave)
{
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			ZVAL_UNDEF(&_5$$4);
			ZVAL_LONG(&_5$$4, 1);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_5$$4);
		...
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			ZVAL_UNDEF(&_6$$5);
			ZVAL_LONG(&_6$$5, 2);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_6$$5);
			if (quality >= 0) {
		...
		if (ZEPHIR_IS_STRING(&extension, "png")) {
			ZVAL_UNDEF(&_10$$8);
			ZVAL_LONG(&_10$$8, 3);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_10$$8);
		...
		if (ZEPHIR_IS_STRING(&extension, "wbmp")) {
			ZVAL_UNDEF(&_11$$9);
			ZVAL_LONG(&_11$$9, 15);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_11$$9);
		...
		if (ZEPHIR_IS_STRING(&extension, "webp")) {
			ZVAL_UNDEF(&_12$$10);
			ZVAL_LONG(&_12$$10, 18);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_12$$10);
		...
		if (ZEPHIR_IS_STRING(&extension, "xbm")) {
			ZVAL_UNDEF(&_13$$11);
			ZVAL_LONG(&_13$$11, 16);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 916, &_13$$11);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 916, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&_15, "image_type_to_mime_type", NULL, 0, &_0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 920, &_15);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSharpen)
{
	...
	zephir_array_fast_append(&_3, &_4);
	zephir_array_fast_append(&matrix, &_3);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&result)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 918, &_7$$3);
		ZEPHIR_CALL_FUNCTION(&_8$$3, "imagesy", NULL, 0, &image);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 919, &_8$$3);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&fontFile_zv)) {
		...
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_14$$6, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_17$$7, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_24$$9, this_ptr, _zephir_prop_1, 918, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_27$$10, this_ptr, _zephir_prop_2, 919, PH_NOISY_CC | PH_READONLY);
