...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	zval *file_param = NULL, *width_param = NULL, *height_param = NULL, *imageinfo = NULL, *_0, *_1, *_2, *_3 = NULL, *_5, *_7, *_8, *_9, *_10, *_11, *_12, *_13 = NULL, *_14 = NULL, *_15, *_16 = NULL, *_17 = NULL, *_19;
	zval *file = NULL;
	...
	if ((zephir_file_exists(_1 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_INIT_VAR(_17);
		ZVAL_BOOL(_17, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, _12, _17);
		zephir_check_call_status();
	} else {
		_18 = !width;
		if (!(_18)) {
		...
		ZEPHIR_CALL_FUNCTION(&_3, "imagecreatetruecolor", NULL, _17, _19);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(_17);
		ZVAL_BOOL(_17, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, _11, _17);
		zephir_check_call_status();
		_12 = zephir_fetch_nproperty_this(this_ptr, SL("_file"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _resize) {
	...
	zval *width_param = NULL, *height_param = NULL, *image = NULL, *pre_width = NULL, *pre_height = NULL, *reduction_width = NULL, *reduction_height = NULL, *_0, _1 = zval_used_for_init, *_2 = NULL, *_4, *_6, *_9, *_10, *_11, *_12 = NULL, *_13 = NULL, *_14 = NULL, *_15 = NULL, *_16 = NULL, *_17, *_18, *_19, *_20 = NULL, *_21 = NULL;
	int width, height, ZEPHIR_LAST_CALL_STATUS;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _crop) {
	...
	zval *width_param = NULL, *height_param = NULL, *offset_x_param = NULL, *offset_y_param = NULL, *image = NULL, *rect, *_0, _1, *_2 = NULL, *_4 = NULL, *_5 = NULL, *_6, *_7, *_8, *_9, *_10, *_11, *_12, *_13 = NULL, *_14, *_15 = NULL, *_16 = NULL;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	zval *watermark, *offset_x_param = NULL, *offset_y_param = NULL, *opacity_param = NULL, *overlay = NULL, *color = NULL, *_0 = NULL, *_1, *_2 = NULL, *_3 = NULL, _4 = zval_used_for_init, *_5 = NULL, *_7 = NULL, _9, _10, _11, *_12 = NULL, *_13 = NULL, *_14 = NULL, *_15 = NULL, *_16, *_17, *_18, *_19;
	...
	if (opacity < 100) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_7, "round", &_8, _5);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, overlay, &_4, &_9, &_10, &_11);
		zephir_check_call_status();
		ZEPHIR_INIT_BNVAR(_1);
		ZEPHIR_GET_CONSTANT(_1, "IMG_EFFECT_OVERLAY");
		ZEPHIR_CALL_FUNCTION(NULL, "imagelayereffect", NULL, overlay, _1);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_12);
		ZVAL_LONG(_12, 0);
		ZEPHIR_INIT_VAR(_13);
	...
	ZEPHIR_INIT_VAR(_19);
	ZVAL_LONG(_19, height);
	ZEPHIR_CALL_FUNCTION(&_5, "imagecopy", NULL, _17, overlay, _12, _13, _14, _15, _18, _19);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (fontfile && Z_STRLEN_P(fontfile)) {
		...
		if (zephir_array_isset_long(space, 0)) {
			ZEPHIR_OBS_VAR(_7);
			zephir_array_fetch_long(&_7, space, 0, PH_NOISY, "phalcon/image/adapter/gd.zep", 345 TSRMLS_CC);
			s0 = zephir_get_intval(_7);
			ZEPHIR_OBS_VAR(_8);
			zephir_array_fetch_long(&_8, space, 1, PH_NOISY, "phalcon/image/adapter/gd.zep", 346 TSRMLS_CC);
			s1 = zephir_get_intval(_8);
			ZEPHIR_OBS_VAR(_9);
			zephir_array_fetch_long(&_9, space, 4, PH_NOISY, "phalcon/image/adapter/gd.zep", 347 TSRMLS_CC);
			s4 = zephir_get_intval(_9);
			ZEPHIR_OBS_VAR(_10);
			zephir_array_fetch_long(&_10, space, 5, PH_NOISY, "phalcon/image/adapter/gd.zep", 348 TSRMLS_CC);
	...
	while (1) {
		...
		while (1) {
			...
			if (zephir_array_isset_string(color, SS("red"))) {
				zephir_array_fetch_string(&_25, color, SL("red"), PH_NOISY | PH_READONLY, "phalcon/image/adapter/gd.zep", 425 TSRMLS_CC);
				ZEPHIR_SINIT_NVAR(_6);
				ZVAL_LONG(&_6, (zephir_get_numberval(_25) / 2));
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _render) {
	...
	int quality, ZEPHIR_LAST_CALL_STATUS;
	zval *ext_param = NULL, *quality_param = NULL, _1 = zval_used_for_init, *_2 = NULL, *_4, *_6 = NULL, *_9 = NULL, *_10 = NULL, *_11, *_12 = NULL, *_13 = NULL, *_14 = NULL, *_15;
	zval *ext = NULL, *_16;
