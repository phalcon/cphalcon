...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processReflection) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "abs", NULL, 228, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRender) {
	...
	if (ZEPHIR_IS_LONG(&_2, 0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_15$$8, "phalcon/Image/Adapter/Gd.zep", 451 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave) {
	...
	ZVAL_LONG(&_0, 4);
	ZEPHIR_CALL_FUNCTION(&ext, "pathinfo", NULL, 95, &file, &_0);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "phalcon/Image/Adapter/Gd.zep", 573 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText) {
	...
	if (!(Z_TYPE_P(&fontfile) == IS_UNDEF) && Z_STRLEN_P(&fontfile)) {
		...
		ZEPHIR_CALL_FUNCTION(&_12$$3, "abs", NULL, 228, &_3$$3);
		zephir_check_call_status();
		width = (zephir_get_numberval(&_12$$3) + 10);
		ZVAL_LONG(&_3$$3, (s5 - s1));
		ZEPHIR_CALL_FUNCTION(&_13$$3, "abs", NULL, 228, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processWatermark) {
	...
	if (opacity < 100) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "abs", NULL, 228, &_4$$3);
		zephir_check_call_status();
