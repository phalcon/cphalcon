...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	if ((zephir_file_exists(&_1 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_25, 258, &_24$$4, &__$true);
		zephir_check_call_status();
	} else {
		_26$$14 = !width;
		if (!(_26$$14)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 260, &_30$$14, &__$true);
		zephir_check_call_status();
		zephir_read_property(&_31$$14, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_25, 258, &_31$$14, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _resize) {
	...
	if (ZEPHIR_LT_LONG(&_2, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_27$$3, "imagecopyresampled", NULL, 263, &image, &_20$$3, &_21$$3, &_22$$3, &_23$$3, &_24$$3, &_25$$3, &_26$$3, &pre_width, &pre_height);
		zephir_check_call_status();
		if (zephir_is_true(&_27$$3)) {
			zephir_read_property(&_28$$7, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_19, 262, &_28$$7);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_image"), &image);
			ZEPHIR_CALL_FUNCTION(&_29$$7, "imagesx", &_30, 264, &image);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_width"), &_29$$7);
			ZEPHIR_CALL_FUNCTION(&_31$$7, "imagesy", &_32, 265, &image);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&image, "imagescale", NULL, 266, &_33$$8, &_34$$8, &_35$$8);
		zephir_check_call_status();
		zephir_read_property(&_34$$8, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_19, 262, &_34$$8);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("_image"), &image);
		ZEPHIR_CALL_FUNCTION(&_36$$8, "imagesx", &_30, 264, &image);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("_width"), &_36$$8);
		ZEPHIR_CALL_FUNCTION(&_37$$8, "imagesy", &_32, 265, &image);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _crop) {
	...
	if (ZEPHIR_LT_LONG(&_2, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_12$$3, "imagecopyresampled", NULL, 263, &image, &_3$$3, &_4$$3, &_5$$3, &_6$$3, &_7$$3, &_8$$3, &_9$$3, &_10$$3, &_11$$3);
		zephir_check_call_status();
		if (zephir_is_true(&_12$$3)) {
			zephir_read_property(&_13$$4, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_14, 262, &_13$$4);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_image"), &image);
			ZEPHIR_CALL_FUNCTION(&_15$$4, "imagesx", &_16, 264, &image);
			zephir_check_call_status();
			zephir_update_property_zval(this_ptr, SL("_width"), &_15$$4);
			ZEPHIR_CALL_FUNCTION(&_17$$4, "imagesy", &_18, 265, &image);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&image, "imagecrop", NULL, 267, &_20$$5, &rect);
		zephir_check_call_status();
		zephir_read_property(&_21$$5, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_14, 262, &_21$$5);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("_image"), &image);
		ZEPHIR_CALL_FUNCTION(&_22$$5, "imagesx", &_16, 264, &image);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("_width"), &_22$$5);
		ZEPHIR_CALL_FUNCTION(&_23$$5, "imagesy", &_18, 265, &image);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _rotate) {
	...
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&image, "imagerotate", NULL, 269, &_1, &_2, &transparent, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 258, &image, &__$true);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 100);
	ZEPHIR_CALL_FUNCTION(&_8, "imagecopymerge", NULL, 270, &_2, &image, &_3, &_4, &_5, &_6, &width, &height, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _reflection) {
	...
	ZVAL_LONG(&_10, 0);
	ZVAL_LONG(&_11, 0);
	ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_12, 271, &reflection, &_4, &_8, &_9, &_10, &_11, &_6, &_7);
	zephir_check_call_status();
	offset = 0;
	while (1) {
		if (!(height >= offset)) {
		...
		ZVAL_LONG(&_26$$5, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_12, 271, &line, &_20$$5, &_22$$5, &_23$$5, &_24$$5, &_25$$5, &_21$$5, &_26$$5);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$5, 4);
		ZVAL_LONG(&_23$$5, 0);
		ZVAL_LONG(&_24$$5, 0);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagefilter", &_27, 274, &line, &_22$$5, &_23$$5, &_24$$5, &_25$$5, &_26$$5);
		zephir_check_call_status();
		...
		ZVAL_LONG(&_26$$5, 0);
		ZVAL_LONG(&_28$$5, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopy", &_12, 271, &reflection, &line, &_23$$5, &_24$$5, &_25$$5, &_26$$5, &_22$$5, &_28$$5);
		zephir_check_call_status();
		offset++;
	}
	zephir_read_property(&_8, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", NULL, 262, &_8);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("_image"), &reflection);
	ZEPHIR_CALL_FUNCTION(&_29, "imagesx", NULL, 264, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("_width"), &_29);
	ZEPHIR_CALL_FUNCTION(&_30, "imagesy", NULL, 265, &reflection);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 258, &overlay, &__$true);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 260, &_9, &__$true);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (!(Z_TYPE_P(&fontfile) == IS_UNDEF) && Z_STRLEN_P(&fontfile)) {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_20, 268, &_4$$3, &_5$$3, &_17$$3, &_18$$3, &_19$$3);
		zephir_check_call_status();
		angle = 0;
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", NULL, 279, &_5$$3, &_17$$3, &_18$$3, &_19$$3, &_21$$3, &color, &fontfile, &text);
		zephir_check_call_status();
	} else {
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_20, 268, &_22$$8, &_27$$8, &_28$$8, &_29$$8, &_30$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagestring", NULL, 282, &_27$$8, &_28$$8, &_29$$8, &_30$$8, &text, &color);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _mask) {
	...
	alpha = 127;
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_3, 258, &maskImage, &__$true);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", &_3, 258, &newimage, &__$true);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	...
	if (_11) {
		...
		ZEPHIR_CALL_FUNCTION(&tempImage, "imagecreatetruecolor", NULL, 259, &_12$$3, &_13$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagecopyresampled", NULL, 263, &tempImage, &maskImage, &_16$$3, &_17$$3, &_18$$3, &_19$$3, &_14$$3, &_15$$3, &_20$$3, &_21$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_22, 262, &maskImage);
		zephir_check_call_status();
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_24$$5, x);
			ZVAL_LONG(&_25$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_26, 284, &maskImage, &_24$$5, &_25$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_27, 285, &maskImage, &index);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_25$$5, x);
			ZVAL_LONG(&_30$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_26, 284, &_24$$5, &_25$$5, &_30$$5);
			zephir_check_call_status();
			zephir_read_property(&_25$$5, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_27, 285, &_25$$5, &index);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&r);
			...
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_10, 268, &newimage, &r, &g, &b, &_30$$5);
			zephir_check_call_status();
			ZVAL_LONG(&_30$$5, x);
			ZVAL_LONG(&_31$$5, y);
			ZEPHIR_CALL_FUNCTION(NULL, "imagesetpixel", &_32, 286, &newimage, &_30$$5, &_31$$5, &color);
			zephir_check_call_status();
			y++;
		}
		x++;
	...
	zephir_read_property(&_9, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_22, 262, &_9);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagedestroy", &_22, 262, &maskImage);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _background) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 260, &background, &__$true);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
	...
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	ZEPHIR_CALL_FUNCTION(&_9, "imagecopy", NULL, 271, &background, &_2, &_5, &_6, &_7, &_8, &_3, &_4);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _pixelate) {
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_7$$4, x2);
			ZVAL_LONG(&_8$$4, y2);
			ZEPHIR_CALL_FUNCTION(NULL, "imagefilledrectangle", &_9, 277, &_3$$4, &_4$$4, &_6$$4, &_7$$4, &_8$$4, &color);
			zephir_check_call_status();
			y += amount;
		}
		x += amount;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _save) {
	...
	if (!(zephir_is_true(&ext))) {
		...
		ZEPHIR_CALL_FUNCTION(&ext, "image_type_to_extension", NULL, 287, &_1$$3, &__$false);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "gif");
	ZEPHIR_CALL_FUNCTION(&_3, "strcmp", &_4, 288, &ext, &_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "jpg");
	ZEPHIR_CALL_FUNCTION(&_9, "strcmp", &_4, 288, &ext, &_2);
	zephir_check_call_status();
	_10 = ZEPHIR_IS_LONG(&_9, 0);
	if (!(_10)) {
		ZEPHIR_INIT_NVAR(&_2);
		ZVAL_STRING(&_2, "jpeg");
		ZEPHIR_CALL_FUNCTION(&_11, "strcmp", &_4, 288, &ext, &_2);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "png");
	ZEPHIR_CALL_FUNCTION(&_18, "strcmp", &_4, 288, &ext, &_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "wbmp");
	ZEPHIR_CALL_FUNCTION(&_22, "strcmp", &_4, 288, &ext, &_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "xbm");
	ZEPHIR_CALL_FUNCTION(&_26, "strcmp", &_4, 288, &ext, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _render) {
	...
	if (_7) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 291, &_9$$4, &__$null, &_10$$4);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 295);
		zephir_check_call_status();
		RETURN_MM();
	...
	if (ZEPHIR_IS_LONG(&_15, 0)) {
		zephir_read_property(&_16$$7, this_ptr, SL("_image"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagexbm", NULL, 294, &_16$$7, &__$null);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 295);
		zephir_check_call_status();
		RETURN_MM();
	...
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 9, &_17);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _create) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 260, &image, &__$false);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 258, &image, &__$true);
	zephir_check_call_status();
	RETURN_CCTOR(image);
