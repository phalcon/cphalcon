...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 864, &file_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 865, &_0);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_3$$3, "realpath", NULL, 157, &_2$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 866, &_3$$3);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_1, 865, PH_NOISY_CC);
		do {
			if (ZEPHIR_IS_LONG(&_11$$3, 1)) {
				zephir_read_property_cached(&_12$$6, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_13$$6, "imagecreatefromgif", NULL, 0, &_12$$6);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_13$$6);
				break;
			}
			if (ZEPHIR_IS_LONG(&_11$$3, 2) || ZEPHIR_IS_LONG(&_11$$3, 9)) {
				zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_15$$7, "imagecreatefromjpeg", NULL, 0, &_14$$7);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_15$$7);
				break;
			}
			if (ZEPHIR_IS_LONG(&_11$$3, 3)) {
				zephir_read_property_cached(&_16$$8, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_17$$8, "imagecreatefrompng", NULL, 0, &_16$$8);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_17$$8);
				break;
			}
			if (ZEPHIR_IS_LONG(&_11$$3, 18)) {
				zephir_read_property_cached(&_18$$9, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_19$$9, "imagecreatefromwebp", NULL, 0, &_18$$9);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_19$$9);
				break;
			}
			if (ZEPHIR_IS_LONG(&_11$$3, 15)) {
				zephir_read_property_cached(&_20$$10, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_21$$10, "imagecreatefromwbmp", NULL, 0, &_20$$10);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_21$$10);
				break;
			}
			if (ZEPHIR_IS_LONG(&_11$$3, 16)) {
				zephir_read_property_cached(&_22$$11, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_FUNCTION(&_23$$11, "imagecreatefromxbm", NULL, 0, &_22$$11);
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_23$$11);
				break;
			}
			ZEPHIR_INIT_VAR(&_24$$12);
			object_init_ex(&_24$$12, phalcon_image_exceptions_unsupportedimagetype_ce);
			zephir_read_property_cached(&_25$$12, this_ptr, _zephir_prop_5, 869, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_26$$3, this_ptr, _zephir_prop_6, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (_27$$13) {
			...
			zephir_read_property_cached(&_29$$14, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 870, &_32$$13);
		zephir_read_property_cached(&_30$$13, this_ptr, _zephir_prop_6, 870, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 0, &_30$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_31$$13, this_ptr, _zephir_prop_6, 870, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 0, &_31$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_33$$13, this_ptr, _zephir_prop_0, 864, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 866, &_33$$13);
		ZVAL_UNDEF(&_34$$13);
		ZVAL_LONG(&_34$$13, width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 867, &_34$$13);
		ZVAL_UNDEF(&_34$$13);
		ZVAL_LONG(&_34$$13, height);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 868, &_34$$13);
		ZVAL_UNDEF(&_34$$13);
		ZVAL_LONG(&_34$$13, 3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 865, &_34$$13);
		ZEPHIR_INIT_VAR(&_35$$13);
		ZEPHIR_INIT_NVAR(&_35$$13);
		ZVAL_STRING(&_35$$13, "image/png");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 869, &_35$$13);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __destruct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 870, &__$null);
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBackground)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 867, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 868, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 867, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 868, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	ZVAL_LONG(&_9, 0);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 870, &background);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBlur)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_1$$3, 7);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processCrop)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 870, &image);
	ZEPHIR_CALL_FUNCTION(&_2, "imagesx", NULL, 0, &image);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 867, &_2);
	ZEPHIR_CALL_FUNCTION(&_3, "imagesy", NULL, 0, &image);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 868, &_3);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processFlip)
{
	...
	if (direction == 11) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_3$$4, 2);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processMask)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
	_9 = !ZEPHIR_IS_LONG_IDENTICAL(&_5, maskWidth);
	if (!(_9)) {
		zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		_9 = !ZEPHIR_IS_LONG_IDENTICAL(&_6, maskHeight);
	}
	if (_9) {
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&tempImage, "imagecreatetruecolor", NULL, 0, &_10$$3, &_11$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_12$$3, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_13$$3, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_14$$3, 0);
		ZVAL_LONG(&_15$$3, 0);
		ZVAL_LONG(&_16$$3, 0);
		ZVAL_LONG(&_17$$3, 0);
	...
	x = 0;
	while (1) {
		zephir_read_property_cached(&_7, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		if (!(ZEPHIR_GT_LONG(&_7, x))) {
			break;
		}
		y = 0;
		while (1) {
			zephir_read_property_cached(&_20$$4, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_21$$5, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
			ZVAL_LONG(&_22$$5, x);
			ZVAL_LONG(&_27$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_23, 0, &_21$$5, &_22$$5, &_27$$5);
			zephir_check_call_status();
			zephir_read_property_cached(&_22$$5, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 870, &newImage);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processPixelate)
{
	...
	while (1) {
		...
		y = 0;
		while (1) {
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
			if (!(ZEPHIR_GT_LONG(&_1$$3, y))) {
				break;
			}
			x1 = ((x + (zephir_safe_div_long_long(amount, 2))));
			y1 = ((y + (zephir_safe_div_long_long(amount, 2))));
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
			_3$$4 = ZEPHIR_LE_LONG(&_2$$4, x1);
			if (!(_3$$4)) {
				zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
				_3$$4 = ZEPHIR_LE_LONG(&_4$$4, y1);
			}
			if (_3$$4) {
				break;
			}
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
			ZVAL_LONG(&_6$$4, x1);
			ZVAL_LONG(&_7$$4, y1);
			...
			zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
			ZVAL_LONG(&_7$$4, x);
			ZVAL_LONG(&_9$$4, y);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processReflection)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, (zephir_get_numberval(&_3) + height));
	ZEPHIR_CALL_METHOD(&reflection, this_ptr, "processcreate", NULL, 0, &_1, &_4);
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_7, 0);
	ZVAL_LONG(&_8, 0);
	...
	while (1) {
		...
		zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		sourceY = ((zephir_get_numberval(&_11$$5) - offset) - 1);
		zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_17$$5, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_18$$5, 1);
		ZEPHIR_CALL_METHOD(&line, this_ptr, "processcreate", NULL, 0, &_17$$5, &_18$$5);
		zephir_check_call_status();
		zephir_read_property_cached(&_18$$5, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_19$$5, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_20$$5, 0);
		ZVAL_LONG(&_21$$5, 0);
		ZVAL_LONG(&_22$$5, 0);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_20$$5, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_21$$5, 0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 870, &reflection);
	ZEPHIR_CALL_FUNCTION(&_27, "imagesx", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 867, &_27);
	ZEPHIR_CALL_FUNCTION(&_28, "imagesy", NULL, 0, &reflection);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 868, &_28);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRender)
{
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "png")) {
			zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(NULL, "imagepng", NULL, 0, &_4$$5);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "wbmp")) {
			zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(NULL, "imagewbmp", NULL, 0, &_5$$6);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "webp")) {
			zephir_read_property_cached(&_6$$7, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(NULL, "imagewebp", NULL, 0, &_6$$7);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_STRING(&extension, "xbm")) {
			zephir_read_property_cached(&_7$$8, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processResize)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 867, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 868, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 0);
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 0);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 867, &_9);
	ZEPHIR_CALL_FUNCTION(&_10, "imagesy", NULL, 0, &image);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 868, &_10);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRotate)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 870, &image);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 867, &width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 868, &height);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&extension)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 865, PH_NOISY_CC | PH_READONLY);
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			ZVAL_UNDEF(&_3$$4);
			ZVAL_LONG(&_3$$4, 1);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_3$$4);
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			ZVAL_UNDEF(&_4$$5);
			ZVAL_LONG(&_4$$5, 2);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_4$$5);
			if (quality >= 0) {
				...
				zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
				ZVAL_LONG(&_7$$6, quality);
				ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 0, &_6$$6, &file_zv, &_7$$6);
				zephir_check_call_status();
			} else {
				zephir_read_property_cached(&_8$$7, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "png")) {
			ZVAL_UNDEF(&_9$$8);
			ZVAL_LONG(&_9$$8, 3);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_9$$8);
			zephir_read_property_cached(&_9$$8, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "wbmp")) {
			ZVAL_UNDEF(&_10$$9);
			ZVAL_LONG(&_10$$9, 15);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_10$$9);
			zephir_read_property_cached(&_10$$9, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "webp")) {
			ZVAL_UNDEF(&_11$$10);
			ZVAL_LONG(&_11$$10, 18);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_11$$10);
			zephir_read_property_cached(&_11$$10, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "xbm")) {
			ZVAL_UNDEF(&_12$$11);
			ZVAL_LONG(&_12$$11, 16);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 865, &_12$$11);
			zephir_read_property_cached(&_12$$11, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 869, &_14);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSharpen)
{
	...
	zephir_array_fast_append(&_3, &_4);
	zephir_array_fast_append(&matrix, &_3);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&result)) {
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_9$$3, "imagesx", NULL, 0, &_8$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 867, &_9$$3);
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_11$$3, "imagesy", NULL, 0, &_10$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 868, &_11$$3);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText)
{
	...
	if (1 != ZEPHIR_IS_EMPTY(&fontFile_zv)) {
		...
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_14$$6, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_17$$7, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_6$$3, red);
		...
		zephir_check_call_status();
		angle = 0;
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_25$$9, this_ptr, _zephir_prop_0, 867, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_28$$10, this_ptr, _zephir_prop_1, 868, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_23$$8, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_31$$8, red);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_31$$8, this_ptr, _zephir_prop_2, 870, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processWatermark)
{
	...
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 0, &_9, &__$true);
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 870, PH_NOISY_CC | PH_READONLY);
