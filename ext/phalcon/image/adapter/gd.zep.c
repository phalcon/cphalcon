...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	if ((zephir_file_exists(_1 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 242, _33$$14, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	if (opacity < 100) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "abs", NULL, 193, &_5$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 243, overlay, &_5$$3, &_7$$3, &_8$$3, &_9$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_10$$3);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 242, _15, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (!(!fontfile) && Z_STRLEN_P(fontfile)) {
		...
		ZEPHIR_CALL_FUNCTION(&_14$$3, "abs", &_3, 193, &_13$$3);
		zephir_check_call_status();
		width = (zephir_get_numberval(_14$$3) + 10);
		ZEPHIR_SINIT_NVAR(_13$$3);
		ZVAL_LONG(&_13$$3, (s5 - s1));
		ZEPHIR_CALL_FUNCTION(&_15$$3, "abs", &_3, 193, &_13$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_22, 243, _18$$3, &_13$$3, &_19$$3, &_20$$3, &_21$$3);
		zephir_check_call_status();
		angle = 0;
		_23$$3 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(_4$$3);
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_22, 243, _31$$8, &_32$$8, &_33$$8, &_34$$8, &_35$$8);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _mask) {
	...
	ZEPHIR_SINIT_VAR(_9);
	ZVAL_LONG(&_9, alpha);
	ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_10, 243, newimage, &_6, &_7, &_8, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_3);
	ZVAL_LONG(_3, 0);
	ZEPHIR_INIT_VAR(_11);
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_28$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_29, 244, maskImage, &_27$$5, &_28$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_30, 245, maskImage, index);
			zephir_check_call_status();
			...
			ZEPHIR_SINIT_NVAR(_28$$5);
			ZVAL_LONG(&_28$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_29, 244, _33$$5, &_27$$5, &_28$$5);
			zephir_check_call_status();
			_34$$5 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_30, 245, _34$$5, index);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(r);
			...
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", &_10, 243, newimage, r, g, b, &_27$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _pixelate) {
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_4$$4, y1);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorat", &_5, 244, _2$$4, &_3$$4, &_4$$4);
			zephir_check_call_status();
			x2 = (x + amount);
			y2 = (y + amount);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _save) {
	...
	if (!(zephir_is_true(ext))) {
		...
		ZEPHIR_CALL_FUNCTION(&ext, "image_type_to_extension", NULL, 246, _1$$3, ZEPHIR_GLOBAL(global_false));
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(_2);
	...
	ZEPHIR_CALL_FUNCTION(&_3, "strcmp", &_4, 247, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_3, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$4, "image_type_to_mime_type", &_7, 248, _5$$4);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strcmp", &_4, 247, ext, &_0);
	zephir_check_call_status();
	_10 = ZEPHIR_IS_LONG(_9, 0);
	if (!(_10)) {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "jpeg", 0);
		ZEPHIR_CALL_FUNCTION(&_11, "strcmp", &_4, 247, ext, &_0);
		zephir_check_call_status();
	...
	if (_10) {
		...
		ZEPHIR_CALL_FUNCTION(&_13$$5, "image_type_to_mime_type", &_7, 248, _12$$5);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagejpeg", NULL, 0, _14$$5, file, _15$$5);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "png", 0);
	ZEPHIR_CALL_FUNCTION(&_16, "strcmp", &_4, 247, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_16, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_18$$6, "image_type_to_mime_type", &_7, 248, _17$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagepng", NULL, 0, _19$$6, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "wbmp", 0);
	ZEPHIR_CALL_FUNCTION(&_20, "strcmp", &_4, 247, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_20, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_22$$7, "image_type_to_mime_type", &_7, 248, _21$$7);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagewbmp", NULL, 0, _23$$7, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "xbm", 0);
	ZEPHIR_CALL_FUNCTION(&_24, "strcmp", &_4, 247, ext, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_24, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_26$$8, "image_type_to_mime_type", &_7, 248, _25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagexbm", NULL, 0, _27$$8, file);
		zephir_check_call_status();
		RETURN_MM_BOOL(1);
	}
	ZEPHIR_INIT_NVAR(_2);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _render) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "strcmp", &_3, 247, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_2, 0)) {
		...
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", &_5, 249);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_SINIT_NVAR(_1);
	ZVAL_STRING(&_1, "jpg", 0);
	ZEPHIR_CALL_FUNCTION(&_6, "strcmp", &_3, 247, ext, &_1);
	zephir_check_call_status();
	_7 = ZEPHIR_IS_LONG(_6, 0);
	if (!(_7)) {
		ZEPHIR_SINIT_NVAR(_1);
		ZVAL_STRING(&_1, "jpeg", 0);
		ZEPHIR_CALL_FUNCTION(&_8, "strcmp", &_3, 247, ext, &_1);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_12, "strcmp", &_3, 247, ext, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "strcmp", &_3, 247, ext, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_16, "strcmp", &_3, 247, ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(_16, 0)) {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(_19, "phalcon/image/adapter/gd.zep", 572 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
