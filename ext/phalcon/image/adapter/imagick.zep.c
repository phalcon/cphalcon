...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	if ((zephir_file_exists(&_2) == SUCCESS)) {
		...
		if (!(zephir_is_true(&_12$$4))) {
			...
			ZEPHIR_CALL_FUNCTION(&_15$$6, "constant", NULL, 143, &_14$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	ZEPHIR_CALL_FUNCTION(&_3, "defined", NULL, 142, &_2);
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		ZEPHIR_INIT_VAR(&_4$$5);
		ZVAL_STRING(&_4$$5, "Imagick::IMAGICK_EXTNUM");
		ZEPHIR_CALL_FUNCTION(&_5$$5, "constant", NULL, 143, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBackground)
{
	...
	while (1) {
		...
		if (!(zephir_is_true(&_7$$3))) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 143, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 143, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 143, &_14$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 143, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processMask)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 143, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processReflection)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$7, "constant", &_21, 143, &_19$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_22$$7, 0);
		ZVAL_LONG(&_23$$7, 0);
		...
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_21, 143, &_19$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_19$$7);
		ZVAL_STRING(&_19$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_26$$7, "constant", &_21, 143, &_19$$7);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_37$$10, "constant", &_21, 143, &_36$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_45$$10, "constant", &_21, 143, &_36$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_46$$10, 0);
		ZVAL_LONG(&_47$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_51$$13, "constant", &_21, 143, &_50$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRender)
{
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_5, 0)) {
		...
		if (_8$$4) {
			...
			ZEPHIR_CALL_FUNCTION(&_11$$5, "constant", NULL, 143, &_10$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processSave)
{
	...
	if (_13) {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$4, "constant", NULL, 143, &_16$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processText)
{
	...
	if (((Z_TYPE_P(offsetX) == IS_TRUE || Z_TYPE_P(offsetX) == IS_FALSE) == 1)) {
		if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
			...
			ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_6$$7);
			zephir_check_call_status();
		} else {
			if (Z_TYPE_P(offsetY) == IS_LONG) {
				...
				if (zephir_is_true(offsetX)) {
					...
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_7$$11);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_8$$12);
						ZVAL_STRING(&_8$$12, "Imagick::GRAVITY_NORTHEAST");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_8$$12);
						zephir_check_call_status();
					}
				} else {
					ZEPHIR_INIT_NVAR(offsetX);
					if (y < 0) {
						...
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_9$$14);
						zephir_check_call_status();
					} else {
						ZVAL_LONG(offsetX, 0);
						ZEPHIR_INIT_VAR(&_10$$15);
						ZVAL_STRING(&_10$$15, "Imagick::GRAVITY_NORTH");
						ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_10$$15);
						zephir_check_call_status();
					}
				}
			}
				...
				if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
					if (zephir_is_true(offsetY)) {
						...
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_11$$21);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_12$$22);
							ZVAL_STRING(&_12$$22, "Imagick::GRAVITY_SOUTH");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_12$$22);
							zephir_check_call_status();
						}
					} else {
						ZEPHIR_INIT_NVAR(offsetY);
						if (x < 0) {
							...
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_13$$24);
							zephir_check_call_status();
						} else {
							ZVAL_LONG(offsetY, 0);
							ZEPHIR_INIT_VAR(&_14$$25);
							ZVAL_STRING(&_14$$25, "Imagick::GRAVITY_WEST");
							ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_14$$25);
							zephir_check_call_status();
						}
					}
				} else {
					if (Z_TYPE_P(offsetY) == IS_LONG) {
						...
						if (x < 0) {
							...
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_15$$29);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, (x * -1));
								ZEPHIR_INIT_VAR(&_16$$30);
								ZVAL_STRING(&_16$$30, "Imagick::GRAVITY_NORTHEAST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_16$$30);
								zephir_check_call_status();
							}
						} else {
							ZEPHIR_INIT_NVAR(offsetX);
							if (y < 0) {
								...
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_17$$32);
								zephir_check_call_status();
							} else {
								ZVAL_LONG(offsetX, 0);
								ZEPHIR_INIT_VAR(&_18$$33);
								ZVAL_STRING(&_18$$33, "Imagick::GRAVITY_NORTHWEST");
								ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 143, &_18$$33);
								zephir_check_call_status();
							}
						}
					}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processWatermark)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 143, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Imagick::CHANNEL_ALPHA");
	ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 143, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$3, "constant", NULL, 143, &_7$$3);
		zephir_check_call_status();
