...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 921, &file_zv);
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, zephir_get_internal_ce(SL("imagick")));
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 922, &_0);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "phpfileexists", NULL, 0, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "realpath", NULL, 158, &_3$$3);
		zephir_check_call_status();
		zephir_cast_to_string(&_5$$3, &_4$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 923, &_5$$3);
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_2, 923, PH_NOISY_CC | PH_READONLY);
		...
		if (!ZEPHIR_IS_TRUE_IDENTICAL(&_7$$3)) {
			...
			zephir_read_property_cached(&_10$$4, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_12$$3, &_11$$3, "getimagealphachannel", NULL, 0);
		zephir_check_call_status();
		if (!zephir_is_true(&_12$$3)) {
			zephir_read_property_cached(&_13$$5, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_16$$3, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_17$$3, &_16$$3, "getimagetype", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 924, &_17$$3);
		ZEPHIR_INIT_VAR(&_18$$3);
		zephir_read_property_cached(&_19$$3, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_IDENTICAL(&_21$$3, &_18$$3)) {
			zephir_read_property_cached(&_22$$6, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&image, &_22$$6, "coalesceimages", NULL, 0);
			zephir_check_call_status();
			zephir_read_property_cached(&_23$$6, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_23$$6, "clear", NULL, 0);
			zephir_check_call_status();
			zephir_read_property_cached(&_24$$6, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_24$$6, "destroy", NULL, 0);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 922, &image);
		}
	} else {
		_25$$7 = 0 == width;
		if (!(_25$$7)) {
		...
		if (_25$$7) {
			...
			zephir_read_property_cached(&_27$$8, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_28$$7, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_31$$7, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_30$$7);
		ZVAL_STRING(&_30$$7, "png");
		ZEPHIR_CALL_METHOD(NULL, &_31$$7, "setformat", NULL, 0, &_30$$7);
		zephir_check_call_status();
		zephir_read_property_cached(&_32$$7, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_30$$7);
		ZVAL_STRING(&_30$$7, "png");
		ZEPHIR_CALL_METHOD(NULL, &_32$$7, "setimageformat", NULL, 0, &_30$$7);
		zephir_check_call_status();
		zephir_read_property_cached(&_33$$7, this_ptr, _zephir_prop_0, 921, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 923, &_33$$7);
	}
	zephir_read_property_cached(&_34, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_35, &_34, "getimagewidth", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 925, &_35);
	zephir_read_property_cached(&_36, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_37, &_36, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 926, &_37);
	zephir_read_property_cached(&_38, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_39, &_38, "getimagetype", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 924, &_39);
	zephir_read_property_cached(&_40, this_ptr, _zephir_prop_1, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_41, &_40, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_42);
	ZEPHIR_CONCAT_SV(&_42, "image/", &_41);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 927, &_42);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __destruct)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 922, PH_NOISY_CC);
	if (zephir_is_instance_of(&_0, SL("Imagick"))) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 922, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, liquidRescale)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 925, &_10);
	ZEPHIR_CALL_METHOD(&_11, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 926, &_11);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBackground)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 925, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processCrop)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 925, &_9);
	ZEPHIR_CALL_METHOD(&_10, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 926, &_10);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processPixelate)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 926, PH_NOISY_CC | PH_READONLY);
	height = (int) (zephir_safe_div_zval_long(&_1, amount));
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 922, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processReflection)
{
	...
	zephir_memory_observe(&current);
	zephir_read_property_cached(&current, this_ptr, _zephir_prop_0, 922, PH_NOISY_CC);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 928, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_read_property_cached(&_31$$10, this_ptr, _zephir_prop_2, 925, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_48$$13, this_ptr, _zephir_prop_3, 926, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_49$$13, 0);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 925, &_55);
	ZEPHIR_CALL_METHOD(&_56, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 926, &_56);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRender)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 924, &_1);
	ZEPHIR_CALL_METHOD(&_2, &image, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	ZEPHIR_CONCAT_SV(&_3, "image/", &_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 927, &_3);
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processResize)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 925, &_6);
	ZEPHIR_CALL_METHOD(&_7, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 926, &_7);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRotate)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_2, 926, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_4$$3, 0);
		ZVAL_LONG(&_5$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	if (zephir_is_true(&_2)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 928, &_4$$4);
	}
	ZEPHIR_MM_RESTORE();
}
