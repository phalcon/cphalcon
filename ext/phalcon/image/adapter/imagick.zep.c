...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 871, &file_zv);
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, zephir_get_internal_ce(SL("imagick")));
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 872, &_0);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 871, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "phpfileexists", NULL, 0, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 871, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "realpath", NULL, 157, &_3$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 873, &_4$$3);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_2, 873, PH_NOISY_CC | PH_READONLY);
		...
		if (!ZEPHIR_IS_TRUE_IDENTICAL(&_6$$3)) {
			...
			zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_0, 871, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_11$$3, &_10$$3, "getimagealphachannel", NULL, 0);
		zephir_check_call_status();
		if (!zephir_is_true(&_11$$3)) {
			zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_15$$3, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_16$$3, &_15$$3, "getimagetype", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 874, &_16$$3);
		zephir_read_property_cached(&_17$$3, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_18$$3, &_17$$3, "getimagetype", NULL, 0);
		zephir_check_call_status();
		if (ZEPHIR_IS_LONG(&_18$$3, 1)) {
			zephir_read_property_cached(&_19$$6, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&image, &_19$$6, "coalesceimages", NULL, 0);
			zephir_check_call_status();
			zephir_read_property_cached(&_20$$6, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_20$$6, "clear", NULL, 0);
			zephir_check_call_status();
			zephir_read_property_cached(&_21$$6, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &_21$$6, "destroy", NULL, 0);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 872, &image);
		}
	} else {
		_22$$7 = 0 == width;
		if (!(_22$$7)) {
		...
		if (_22$$7) {
			...
			zephir_read_property_cached(&_24$$8, this_ptr, _zephir_prop_0, 871, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_25$$7, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_28$$7, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_27$$7);
		ZVAL_STRING(&_27$$7, "png");
		ZEPHIR_CALL_METHOD(NULL, &_28$$7, "setformat", NULL, 0, &_27$$7);
		zephir_check_call_status();
		zephir_read_property_cached(&_29$$7, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_27$$7);
		ZVAL_STRING(&_27$$7, "png");
		ZEPHIR_CALL_METHOD(NULL, &_29$$7, "setimageformat", NULL, 0, &_27$$7);
		zephir_check_call_status();
		zephir_read_property_cached(&_30$$7, this_ptr, _zephir_prop_0, 871, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 873, &_30$$7);
	}
	zephir_read_property_cached(&_31, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_32, &_31, "getimagewidth", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 875, &_32);
	zephir_read_property_cached(&_33, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_34, &_33, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 876, &_34);
	zephir_read_property_cached(&_35, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_36, &_35, "getimagetype", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 874, &_36);
	zephir_read_property_cached(&_37, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_38, &_37, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_39);
	ZEPHIR_CONCAT_SV(&_39, "image/", &_38);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 877, &_39);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __destruct)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC);
	if (zephir_is_instance_of(&_0, SL("Imagick"))) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, liquidRescale)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &_10);
	ZEPHIR_CALL_METHOD(&_11, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 876, &_11);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBackground)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 875, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 876, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_19$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_21$$3, &_19$$3, "getcolorspace", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &background, "setcolorspace", &_22, 0, &_21$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_23$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_16$$3);
		...
		zephir_read_property_cached(&_25$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_3, "destroy", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 872, &background);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBlur)
{
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processCrop)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &_9);
	ZEPHIR_CALL_METHOD(&_10, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 876, &_10);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processMask)
{
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processPixelate)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 876, PH_NOISY_CC | PH_READONLY);
	height = (int) (zephir_safe_div_zval_long(&_1, amount));
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 872, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_3, 0);
	...
	while (1) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_2, 872, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_5$$3, width);
		ZVAL_LONG(&_6$$3, height);
		ZEPHIR_CALL_METHOD(NULL, &_4$$3, "scaleimage", NULL, 0, &_5$$3, &_6$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 872, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 875, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_1, 876, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_5$$3, "scaleimage", NULL, 0, &_6$$3, &_7$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_2, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processReflection)
{
	...
	if (ZEPHIR_GE_LONG(&_0, 30100)) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_21$$7, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_read_property_cached(&_33$$10, this_ptr, _zephir_prop_2, 875, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_34$$10, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_39$$10, &_34$$10, "getcolorspace", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &image, "setcolorspace", &_40, 0, &_39$$10);
		zephir_check_call_status();
		zephir_read_property_cached(&_41$$10, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_42$$10, &_41$$10, "getimagedelay", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &image, "setimagedelay", &_43, 0, &_42$$10);
		zephir_check_call_status();
		zephir_read_property_cached(&_44$$10, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_36$$10);
		...
		zephir_read_property_cached(&_46$$10, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_53$$13, this_ptr, _zephir_prop_3, 876, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_54$$13, 0);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_32, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_32, "clear", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_60, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_60, "destroy", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 872, &image);
	zephir_read_property_cached(&_61, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_62, &_61, "getimagewidth", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 875, &_62);
	zephir_read_property_cached(&_63, this_ptr, _zephir_prop_1, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_64, &_63, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 876, &_64);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRender)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 874, &_1);
	ZEPHIR_CALL_METHOD(&_2, &image, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	ZEPHIR_CONCAT_SV(&_3, "image/", &_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 877, &_3);
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processResize)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &_6);
	ZEPHIR_CALL_METHOD(&_7, &image, "getimageheight", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 876, &_7);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processRotate)
{
	...
	while (1) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 875, &_9);
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processSave)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 874, &_3);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_5, &_4, "getimageformat", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	ZEPHIR_CONCAT_SV(&_6, "image/", &_5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 877, &_6);
	ZEPHIR_INIT_VAR(&_7);
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			zephir_read_property_cached(&_11$$4, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
	...
	if (quality >= 0) {
		...
		zephir_read_property_cached(&_15$$5, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_16$$5, quality);
		ZEPHIR_CALL_METHOD(NULL, &_15$$5, "setimagecompressionquality", NULL, 0, &_16$$5);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_17, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processText)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_18$$14, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_19$$14, 0);
		ZEPHIR_CALL_METHOD(NULL, &_18$$14, "annotateimage", NULL, 0, &draw, offsetX, offsetY, &_19$$14, &text_zv);
		zephir_check_call_status();
		zephir_read_property_cached(&_19$$14, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processWatermark)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_9$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	if (zephir_is_true(&_2)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 878, &_4$$4);
	}
	ZEPHIR_MM_RESTORE();
}
