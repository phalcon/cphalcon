...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	int width, height;
	zval *file_param = NULL, *width_param = NULL, *height_param = NULL, *imageinfo, *_0, *_1, *_2, *_3, *_4 = NULL, *_5, *_6, *_7, *_8, *_9, *_10 = NULL, *_11 = NULL, *_12 = NULL;
	zval *file = NULL;
	...
	if (zephir_is_true(_2)) {
		...
		zephir_call_func_p2(_12, "imagecreatetruecolor", _4, _10);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _resize) {
	...
	zval *width_param = NULL, *height_param = NULL, *image, *pre_width = NULL, *pre_height = NULL, *reduction_width, *reduction_height, _0 = zval_used_for_init, _1, *_2, *_3, *_4, *_5, *_6, *_7, *_8 = NULL, *_9 = NULL, *_10 = NULL, *_11 = NULL, *_12 = NULL, *_13, *_14, *_15;
	int width, height;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _rotate) {
	...
	zval *degrees_param = NULL, *image, *transparent, *width, *height, *_0, *_1, *_2, *_3, *_4, *_5, *_6, *_7, *_8, *_9;
	int degrees;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _flip) {
	...
	if (ZEPHIR_LT_LONG(_2, 0)) {
		...
		if ((direction == 11)) {
			_3 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			zephir_call_func_p2_noret("imageflip", _3, ZEPHIR_GLOBAL(global_null));
		} else {
			_4 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			zephir_call_func_p2_noret("imageflip", _4, ZEPHIR_GLOBAL(global_null));
		}
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _sharpen) {
	...
	zval *amount_param = NULL, *matrix, _0 = zval_used_for_init, *_1, *_2, *_3, *_4, *_5, *_6, *_7;
	int amount;
	...
	_4 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	ZEPHIR_INIT_BNVAR(_2);
	ZVAL_LONG(_2, (amount - 8));
	ZEPHIR_INIT_BNVAR(_3);
	ZVAL_LONG(_3, 0);
	ZEPHIR_INIT_VAR(_5);
	zephir_call_func_p4(_5, "imageconvolution", _4, matrix, _2, _3);
	if (zephir_is_true(_5)) {
		_6 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_BNVAR(_2);
		zephir_call_func_p1(_2, "imagesx", _6);
		zephir_update_property_this(this_ptr, SL("_width"), _2 TSRMLS_CC);
		_7 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_BNVAR(_3);
		zephir_call_func_p1(_3, "imagesy", _7);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _reflection) {
	...
	zend_bool fade_in;
	zval *height_param = NULL, *opacity_param = NULL, *fade_in_param = NULL, *reflection, *line = NULL, _0 = zval_used_for_init, *_1, *_2 = NULL, *_3, *_4, *_5, *_6, *_7, *_8 = NULL, *_9 = NULL, *_10 = NULL, *_11, *_12, *_13, *_15, *_16, *_17 = NULL, *_18;
	...
	ZEPHIR_INIT_VAR(_10);
	ZVAL_LONG(_10, 0);
	zephir_call_func_p8_noret("imagecopy", reflection, _5, _2, _8, _9, _10, _6, _7);
	offset = 0;
	while (1) {
		if (!((height >= offset))) {
			break;
		...
		ZVAL_LONG(_17, 1);
		zephir_call_func_p8_noret("imagecopy", line, _15, _2, _8, _9, _10, _16, _17);
		ZEPHIR_INIT_NVAR(_2);
		ZVAL_LONG(_2, 0);
		ZEPHIR_INIT_NVAR(_8);
		ZVAL_LONG(_8, 0);
		...
		ZVAL_LONG(_9, 0);
		ZEPHIR_INIT_NVAR(_10);
		ZVAL_LONG(_10, dst_opacity);
		zephir_call_func_p6_noret("imagefilter", line, ZEPHIR_GLOBAL(global_null), _2, _8, _9, _10);
		...
		ZEPHIR_INIT_NVAR(_17);
		ZVAL_LONG(_17, 1);
		zephir_call_func_p8_noret("imagecopy", reflection, line, _2, _8, _9, _10, _18, _17);
		offset++;
	}
	...
	zephir_call_func_p1(_8, "imagesy", reflection);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	zval *watermark, *offset_x_param = NULL, *offset_y_param = NULL, *opacity_param = NULL, *overlay, *color, *_0, *_1, _2, *_3 = NULL, *_4 = NULL, *_5 = NULL, *_6 = NULL, *_7, *_8, *_9, *_10, *_11;
	...
	if ((opacity < 100)) {
		...
		zephir_call_func_p5(color, "imagecolorallocatealpha", overlay, _3, _4, _5, _6);
		...
		ZEPHIR_INIT_NVAR(_6);
		ZVAL_LONG(_6, height);
		zephir_call_func_p6_noret("imagefilledrectangle", overlay, _3, _4, _5, _6, color);
	}
	_7 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	...
	ZVAL_LONG(_10, height);
	ZEPHIR_INIT_VAR(_11);
	zephir_call_func_p8(_11, "imagecopy", _8, overlay, _3, _4, _5, _6, _9, _10);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	zval *text_param = NULL, *offset_x_param = NULL, *offset_y_param = NULL, *opacity_param = NULL, *r_param = NULL, *g_param = NULL, *b_param = NULL, *size_param = NULL, *fontfile_param = NULL, *space, *color, _0 = zval_used_for_init, *_1, *_2, *_3 = NULL, *_4 = NULL, *_5, *_6 = NULL, *_7 = NULL, *_8 = NULL, *_9 = NULL, *_10, *_11;
	...
	if (fontfile && Z_STRLEN_P(fontfile)) {
		...
		zephir_call_func_p4(space, "imagettfbbox", _2, _3, fontfile, text);
		...
		if ((offset_x < 0)) {
			_5 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
			offset_x = ((zephir_get_numberval(_5) - width) + offset_x);
		}
		if ((offset_y < 0)) {
			_5 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
			offset_y = ((zephir_get_numberval(_5) - height) + offset_y);
		}
		_5 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(_6);
		ZVAL_LONG(_6, r);
		...
		zephir_call_func_p5(color, "imagecolorallocatealpha", _5, _6, _7, _8, _9);
		angle = 0;
		...
		zephir_call_func_p8_noret("imagettftext", _10, _6, _7, _8, _9, color, fontfile, text);
	} else {
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, size);
		ZEPHIR_INIT_NVAR(_6);
		zephir_call_func_p1(_6, "imagefontwidth", _3);
		width = (zephir_get_intval(_6) * zephir_fast_strlen_ev(text));
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, size);
		ZEPHIR_INIT_NVAR(_6);
		zephir_call_func_p1(_6, "imagefontheight", _3);
		height = zephir_get_intval(_6);
		if ((offset_x < 0)) {
		...
		zephir_call_func_p5(color, "imagecolorallocatealpha", _5, _3, _6, _7, _8);
		_11 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, size);
		ZEPHIR_INIT_NVAR(_6);
		...
		ZEPHIR_INIT_NVAR(_7);
		ZVAL_LONG(_7, offset_y);
		zephir_call_func_p6_noret("imagestring", _11, _3, _6, _7, text, color);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _mask) {
	...
	int mask_width, mask_height, x, y, _15;
	zval *mask, *maskImage = NULL, *newimage, *tempImage, *color = NULL, *index = NULL, *alpha = NULL, *_0, *_1 = NULL, *_2, *_3, *_4 = NULL, *_5, *_6, *_7, *_8, *_9, *_10, *_11, *_12, *_13, *_14, *_16, *_17, *_18, *_19;
	...
	ZVAL_LONG(_6, 127);
	ZEPHIR_INIT_VAR(color);
	zephir_call_func_p5(color, "imagecolorallocatealpha", newimage, _1, _4, _5, _6);
	ZEPHIR_INIT_BNVAR(_1);
	ZVAL_LONG(_1, 0);
	ZEPHIR_INIT_BNVAR(_4);
	ZVAL_LONG(_4, 0);
	zephir_call_func_p4_noret("imagefill", newimage, _1, _4, color);
	_7 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
	_8 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
	if ((!ZEPHIR_IS_LONG(_7, mask_width) || !ZEPHIR_IS_LONG(_8, mask_height))) {
		...
		zephir_call_func_p2(tempImage, "imagecreatetruecolor", _9, _10);
		...
		ZVAL_LONG(_6, 0);
		ZEPHIR_INIT_VAR(_13);
		ZVAL_LONG(_13, mask_width);
		ZEPHIR_INIT_VAR(_14);
		ZVAL_LONG(_14, mask_height);
		zephir_call_func_p10_noret("imagecopyresampled", tempImage, maskImage, _1, _4, _5, _6, _11, _12, _13, _14);
	...
	while (1) {
		_9 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
		if (!(ZEPHIR_LT_LONG(_9, x))) {
			break;
		}
		y = 0;
		while (1) {
			_10 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
			if (!(ZEPHIR_LT_LONG(_10, y))) {
				break;
			}
			ZEPHIR_INIT_NVAR(_1);
			ZVAL_LONG(_1, x);
			...
			zephir_call_func_p3(index, "imagecolorat", maskImage, _1, _4);
			...
			if (zephir_array_isset_string(color, SS("red"))) {
				zephir_array_fetch_string(&_11, alpha, SL("red"), PH_NOISY | PH_READONLY TSRMLS_CC);
				_15 = (127 - ((zephir_get_numberval(_11) / 2)));
			...
			ZVAL_LONG(_4, y);
			ZEPHIR_INIT_NVAR(index);
			zephir_call_func_p3(index, "imagecolorat", _12, _1, _4);
			_16 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_INIT_NVAR(color);
			zephir_call_func_p2(color, "imagecolorsforindex", _16, index);
			zephir_array_fetch_string(&_17, color, SL("red"), PH_NOISY | PH_READONLY TSRMLS_CC);
			zephir_array_fetch_string(&_18, color, SL("green"), PH_NOISY | PH_READONLY TSRMLS_CC);
			zephir_array_fetch_string(&_19, color, SL("blue"), PH_NOISY | PH_READONLY TSRMLS_CC);
			ZEPHIR_INIT_NVAR(color);
			zephir_call_func_p5(color, "imagecolorallocatealpha", newimage, _17, _18, _19, alpha);
			ZEPHIR_INIT_NVAR(_1);
			ZVAL_LONG(_1, x);
			ZEPHIR_INIT_NVAR(_4);
			ZVAL_LONG(_4, y);
			zephir_call_func_p4_noret("imagesetpixel", newimage, _1, _4, color);
			y++;
		}
		x++;
	}
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _background) {
	...
	zval *r_param = NULL, *g_param = NULL, *b_param = NULL, *opacity_param = NULL, *background, *color, *_0, *_1, *_2, *_3, *_4, *_5, *_6, *_7, *_8, *_9, *_10;
	int r, g, b, opacity;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _blur) {
	...
	while (1) {
		...
		_0 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
		zephir_call_func_p2_noret("imagefilter", _0, ZEPHIR_GLOBAL(global_null));
		i++;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _pixelate) {
	...
	zval *amount_param = NULL, *color = NULL, *_0, *_1, *_2, *_3 = NULL, *_4 = NULL, *_5, *_6 = NULL, *_7 = NULL;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _save) {
	...
	int quality;
	zval *file_param = NULL, *quality_param = NULL, *ext, _0 = zval_used_for_init, *_1, *_2, *_3 = NULL, *_4, *_5, *_6 = NULL, *_7, *_8;
	zval *file = NULL;
	...
	ZEPHIR_INIT_VAR(_8);
	ZEPHIR_CONCAT_SVS(_8, "Installed GD does not support '", ext, "' images");
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _render) {
	...
	ZEPHIR_INIT_VAR(_6);
	ZEPHIR_CONCAT_SVS(_6, "Installed GD does not support '", ext, "' images");
