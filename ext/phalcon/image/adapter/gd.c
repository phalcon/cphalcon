...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	int width, height;
	zval *file_param = NULL, *width_param = NULL, *height_param = NULL, *imageinfo, *_0, *_1, *_2, *_3 = NULL, *_4, *_5, *_6, *_7, *_8, *_9 = NULL, *_10 = NULL, *_11 = NULL, _12, _13;
	zval *file = NULL;
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (fontfile && Z_STRLEN_P(fontfile)) {
		...
		width = (zephir_get_numberval(_9) + 10);
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_LONG(&_0, (s5 - s1));
		ZEPHIR_INIT_VAR(_10);
		zephir_call_func_p1(_10, "abs", &_0);
		height = (zephir_get_numberval(_10) + 10);
		if ((offset_x < 0)) {
			_11 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
			offset_x = ((zephir_get_numberval(_11) - width) + offset_x);
		}
		if ((offset_y < 0)) {
			_11 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
			offset_y = ((zephir_get_numberval(_11) - height) + offset_y);
		}
		...
		zephir_call_func_p5(color, "imagecolorallocatealpha", _11, &_0, &_3, &_12, &_13);
		angle = 0;
		...
		zephir_call_func_p8_noret("imagettftext", _14, &_0, &_3, &_12, &_13, color, fontfile, text);
	} else {
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_LONG(&_0, size);
		ZEPHIR_INIT_NVAR(_9);
		zephir_call_func_p1(_9, "imagefontwidth", &_0);
		width = (zephir_get_intval(_9) * zephir_fast_strlen_ev(text));
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_LONG(&_0, size);
		ZEPHIR_INIT_NVAR(_10);
		zephir_call_func_p1(_10, "imagefontheight", &_0);
		...
		zephir_call_func_p6_noret("imagestring", _15, &_0, &_3, &_12, text, color);
	}
	ZEPHIR_MM_RESTORE();
