...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _watermark) {
	...
	zval *watermark, *offset_x_param = NULL, *offset_y_param = NULL, *opacity_param = NULL, *overlay, *color, *_0, *_1, _2 = zval_used_for_init, *_3 = NULL, _4, _5, _6, *_7 = NULL, *_8 = NULL, *_9 = NULL, *_10, *_11, *_12, *_13, *_14;
	...
	if ((opacity < 100)) {
		...
		ZEPHIR_INIT_VAR(_9);
		ZVAL_LONG(_9, height);
		zephir_call_func_p6_noret("imagefilledrectangle", overlay, _3, _7, _8, _9, color);
	}
	_10 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	zephir_call_func_p2_noret("imagealphablending", _10, ZEPHIR_GLOBAL(global_true));
	_11 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_3);
	...
	ZEPHIR_INIT_VAR(_14);
	zephir_call_func_p8(_14, "imagecopy", _11, overlay, _3, _7, _8, _9, _12, _13);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _text) {
	...
	if (fontfile && Z_STRLEN_P(fontfile)) {
		...
		zephir_call_func_p5(color, "imagecolorallocatealpha", _5, &_0, &_6, &_7, &_8);
		angle = 0;
		...
		ZEPHIR_INIT_VAR(_13);
		ZVAL_LONG(_13, offset_y);
		zephir_call_func_p8_noret("imagettftext", _9, _10, _11, _12, _13, color, fontfile, text);
	} else {
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, size);
		ZEPHIR_INIT_NVAR(_10);
		zephir_call_func_p1(_10, "imagefontwidth", _3);
		width = (zephir_get_intval(_10) * zephir_fast_strlen_ev(text));
		ZEPHIR_INIT_NVAR(_3);
		ZVAL_LONG(_3, size);
		ZEPHIR_INIT_NVAR(_10);
		zephir_call_func_p1(_10, "imagefontheight", _3);
		...
		zephir_call_func_p6_noret("imagestring", _14, _3, _10, _11, text, color);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, _mask) {
	...
	zval *mask, *maskImage = NULL, *newimage, *tempImage, *color = NULL, *index = NULL, *alpha = NULL, *_0, *_1 = NULL, *_2, *_3, _4 = zval_used_for_init, _5 = zval_used_for_init, _6, _7, *_8 = NULL, *_9, *_10, *_11, *_12, *_13, *_14, *_15, *_16, *_17, *_18, *_20, *_21, *_22, *_23;
	...
	ZEPHIR_INIT_VAR(_8);
	ZVAL_LONG(_8, 0);
	zephir_call_func_p4_noret("imagefill", newimage, _1, _8, color);
	_9 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
	_10 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
	if ((!ZEPHIR_IS_LONG(_9, mask_width) || !ZEPHIR_IS_LONG(_10, mask_height))) {
		_11 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
		_12 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
		ZEPHIR_INIT_VAR(tempImage);
		zephir_call_func_p2(tempImage, "imagecreatetruecolor", _11, _12);
		_13 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
		...
		ZVAL_LONG(_16, 0);
		ZEPHIR_INIT_VAR(_17);
		ZVAL_LONG(_17, mask_width);
		ZEPHIR_INIT_VAR(_18);
		ZVAL_LONG(_18, mask_height);
		zephir_call_func_p10_noret("imagecopyresampled", tempImage, maskImage, _1, _8, _15, _16, _13, _14, _17, _18);
	...
	while (1) {
		_11 = zephir_fetch_nproperty_this(this_ptr, SL("_width"), PH_NOISY_CC);
		if (!(ZEPHIR_LT_LONG(_11, x))) {
			break;
		}
		y = 0;
		while (1) {
			_12 = zephir_fetch_nproperty_this(this_ptr, SL("_height"), PH_NOISY_CC);
			if (!(ZEPHIR_LT_LONG(_12, y))) {
				break;
			}
			...
			if (zephir_array_isset_string(color, SS("red"))) {
				zephir_array_fetch_string(&_13, alpha, SL("red"), PH_NOISY | PH_READONLY TSRMLS_CC);
				_19 = (127 - ((zephir_get_numberval(_13) / 2)));
			...
			ZVAL_LONG(&_5, y);
			ZEPHIR_INIT_NVAR(index);
			zephir_call_func_p3(index, "imagecolorat", _14, &_4, &_5);
			_20 = zephir_fetch_nproperty_this(this_ptr, SL("_image"), PH_NOISY_CC);
			ZEPHIR_INIT_NVAR(color);
			zephir_call_func_p2(color, "imagecolorsforindex", _20, index);
			zephir_array_fetch_string(&_21, color, SL("red"), PH_NOISY | PH_READONLY TSRMLS_CC);
			zephir_array_fetch_string(&_22, color, SL("green"), PH_NOISY | PH_READONLY TSRMLS_CC);
			zephir_array_fetch_string(&_23, color, SL("blue"), PH_NOISY | PH_READONLY TSRMLS_CC);
			ZEPHIR_INIT_NVAR(color);
			zephir_call_func_p5(color, "imagecolorallocatealpha", newimage, _21, _22, _23, alpha);
			ZEPHIR_INIT_NVAR(_1);
			ZVAL_LONG(_1, x);
			ZEPHIR_INIT_NVAR(_8);
			ZVAL_LONG(_8, y);
			zephir_call_func_p4_noret("imagesetpixel", newimage, _1, _8, color);
			y++;
		}
		x++;
	}
