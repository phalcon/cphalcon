...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, background)
{
	...
	ZEPHIR_CALL_METHOD(&colors, this_ptr, "parsecolor", NULL, 196, &color_zv);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, render)
{
	...
	if (Z_TYPE_P(&extension) == IS_NULL) {
		...
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 197, &_0$$3, &_1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, resize)
{
	...
	ZVAL_LONG(&_1, height);
	ZVAL_LONG(&_2, master);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkresizeinput", NULL, 198, &_0, &_1, &_2);
	zephir_check_call_status();
	if (master != 7) {
		ZVAL_LONG(&_4$$3, width);
		ZVAL_LONG(&_5$$3, height);
		ZVAL_LONG(&_6$$3, master);
		ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "checkresizemaster", NULL, 199, &_4$$3, &_5$$3, &_6$$3);
		zephir_check_call_status();
	...
	ZVAL_LONG(&_1, 1);
	ZEPHIR_CALL_FUNCTION(&_29, "max", NULL, 200, &_28, &_1);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 1);
	ZEPHIR_CALL_FUNCTION(&_31, "max", NULL, 200, &_30, &_2);
	zephir_check_call_status();
	...
	do {
		if (master == 7 || master == 4 || master == 5 || master == 6) {
			...
			if (_0$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 202);
				zephir_check_call_status();
		...
		if (master == 2) {
			if (0 == width) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$6, "__construct", NULL, 203);
				zephir_check_call_status();
		...
		if (master == 3) {
			if (0 == height) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$8, "__construct", NULL, 204);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, parseColor)
{
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$4, "preg_replace", NULL, 88, &_6$$4, &_7$$4, &color);
		zephir_check_call_status();
