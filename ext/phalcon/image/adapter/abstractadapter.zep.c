...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, resize)
{
	...
	ZVAL_LONG(&_1, height);
	ZVAL_LONG(&_2, master);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkresizeinput", NULL, 200, &_0, &_1, &_2);
	zephir_check_call_status();
	if (master != 7) {
		ZVAL_LONG(&_4$$3, width);
		ZVAL_LONG(&_5$$3, height);
		ZVAL_LONG(&_6$$3, master);
		ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "checkresizemaster", NULL, 201, &_4$$3, &_5$$3, &_6$$3);
		zephir_check_call_status();
		master = zephir_get_numberval(&_3$$3);
		do {
			if (master == 2) {
				ZEPHIR_INIT_VAR(&_7$$4);
				zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 3) {
				...
				zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_13$$5, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 6) {
				zephir_read_property_cached(&_15$$6, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_16$$6, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
				...
				if ((zephir_safe_div_long_long(width, height)) > ratio) {
					...
					zephir_read_property_cached(&_19$$7, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_20$$7, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
					...
					zephir_read_property_cached(&_23$$8, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_24$$8, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 1) {
				...
				if (0 == width) {
					...
					zephir_read_property_cached(&_26$$9, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC);
				} else {
				...
				if (0 == height) {
					...
					zephir_read_property_cached(&_27$$9, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC);
				} else {
	...
	ZVAL_LONG(&_1, 1);
	ZEPHIR_CALL_FUNCTION(&_29, "max", NULL, 202, &_28, &_1);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_2, 1);
	ZEPHIR_CALL_FUNCTION(&_31, "max", NULL, 202, &_30, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, checkHighLow)
{
	...
	ZVAL_LONG(&_0, value);
	ZVAL_LONG(&_1, min);
	ZEPHIR_CALL_FUNCTION(&_2, "max", NULL, 202, &_0, &_1);
	zephir_check_call_status();
	ZVAL_LONG(&_0, max);
	ZEPHIR_RETURN_CALL_FUNCTION("min", NULL, 203, &_0, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
	...
	do {
		if (master == 7 || master == 4 || master == 5 || master == 6) {
			...
			if (_0$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 204);
				zephir_check_call_status();
		...
		if (master == 2) {
			if (0 == width) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$6, "__construct", NULL, 205);
				zephir_check_call_status();
		...
		if (master == 3) {
			if (0 == height) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$8, "__construct", NULL, 206);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, checkResizeMaster)
{
	...
	if (master == 4) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
	...
	if (master == 5) {
		...
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, parseColor)
{
	...
	if (!ZEPHIR_IS_LONG_IDENTICAL(&_11, 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_13$$5, "__construct", NULL, 207, &color);
		zephir_check_call_status();
	...
	ZVAL_LONG(&_14, 2);
	ZEPHIR_CALL_FUNCTION(&_15, "str_split", NULL, 208, &color, &_14);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_16);
