...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, background)
{
	...
	ZEPHIR_CALL_METHOD(&colors, this_ptr, "parsecolor", NULL, 170, &color_zv);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, render)
{
	...
	if (Z_TYPE_P(&extension) == IS_NULL) {
		...
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 171, &_0$$3, &_1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, resize)
{
	...
	do {
		if (master == 7 || master == 4 || master == 5 || master == 6) {
			...
			if (_0$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 172);
				zephir_check_call_status();
		...
		if (master == 2) {
			if (0 == width) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$6, "__construct", NULL, 173);
				zephir_check_call_status();
		...
		if (master == 3) {
			if (0 == height) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$8, "__construct", NULL, 174);
				zephir_check_call_status();
	...
	ZVAL_LONG(&_25, 1);
	ZEPHIR_CALL_FUNCTION(&_26, "max", NULL, 175, &_23, &_25);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_28, 1);
	ZEPHIR_CALL_FUNCTION(&_29, "max", NULL, 175, &_27, &_28);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, checkHighLow)
{
	...
	ZVAL_LONG(&_0, value);
	ZVAL_LONG(&_1, min);
	ZEPHIR_CALL_FUNCTION(&_2, "max", NULL, 175, &_0, &_1);
	zephir_check_call_status();
	ZVAL_LONG(&_0, max);
	ZEPHIR_RETURN_CALL_FUNCTION("min", NULL, 176, &_0, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, parseColor)
{
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$4, "preg_replace", NULL, 79, &_6$$4, &_7$$4, &color);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_LONG_IDENTICAL(&_11, 1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_13$$5, "__construct", NULL, 177, &color);
		zephir_check_call_status();
	...
	ZVAL_LONG(&_14, 2);
	ZEPHIR_CALL_FUNCTION(&_15, "str_split", NULL, 178, &color, &_14);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_16);
