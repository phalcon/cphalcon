...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, crop)
{
	...
	if (Z_TYPE_P(offsetX) == IS_NULL) {
		zephir_read_property_cached(&_2$$5, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(offsetX);
		ZVAL_DOUBLE(offsetX, (zephir_safe_div_long_long(((zephir_get_numberval(&_2$$5) - width)), 2)));
	} else {
		ZEPHIR_INIT_VAR(&_3$$6);
		if (ZEPHIR_LT_LONG(offsetX, 0)) {
			zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&_3$$6);
		zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_GT(offsetX, &_5$$6)) {
			ZEPHIR_OBS_NVAR(&_3$$6);
			zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC);
		} else {
			ZEPHIR_CPY_WRT(&_3$$6, offsetX);
		}
		ZEPHIR_CPY_WRT(offsetX, &_3$$6);
	...
	if (Z_TYPE_P(offsetY) == IS_NULL) {
		zephir_read_property_cached(&_6$$7, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(offsetY);
		ZVAL_DOUBLE(offsetY, (zephir_safe_div_long_long(((zephir_get_numberval(&_6$$7) - height)), 2)));
	} else {
		ZEPHIR_INIT_VAR(&_7$$8);
		if (ZEPHIR_LT_LONG(offsetY, 0)) {
			zephir_read_property_cached(&_8$$8, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&_7$$8);
		zephir_read_property_cached(&_9$$8, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_GT(offsetY, &_9$$8)) {
			ZEPHIR_OBS_NVAR(&_7$$8);
			zephir_read_property_cached(&_7$$8, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC);
		} else {
			ZEPHIR_CPY_WRT(&_7$$8, offsetY);
		}
		ZEPHIR_CPY_WRT(offsetY, &_7$$8);
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
	zephir_sub_function(&_11, &_10, offsetX);
	if (ZEPHIR_LT_LONG(&_11, width)) {
		zephir_read_property_cached(&_12$$9, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_13$$9);
		zephir_sub_function(&_13$$9, &_12$$9, offsetX);
		width = zephir_get_numberval(&_13$$9);
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_14);
	zephir_sub_function(&_14, &_10, offsetY);
	if (ZEPHIR_LT_LONG(&_14, height)) {
		zephir_read_property_cached(&_15$$10, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, reflection)
{
	...
	if (_0) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 225, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, render)
{
	...
	if (Z_TYPE_P(&extension) == IS_NULL) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 226, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_1$$3, 4);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, resize)
{
	...
	if (master != 7) {
		if (master == 4) {
			...
			zephir_read_property_cached(&_5$$10, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_6$$10, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
		...
		if (master == 5) {
			...
			zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_9$$11, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
		...
		do {
			if (master == 2) {
				...
				zephir_read_property_cached(&_11$$12, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_12$$12, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 3) {
				...
				zephir_read_property_cached(&_15$$13, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_16$$13, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 6) {
				zephir_read_property_cached(&_18$$14, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_19$$14, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
				...
				if ((zephir_safe_div_long_long(width, height)) > ratio) {
					...
					zephir_read_property_cached(&_22$$15, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_23$$15, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
					...
					zephir_read_property_cached(&_26$$16, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_27$$16, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
			...
			if (master == 1) {
				...
				if (0 == width) {
					...
					zephir_read_property_cached(&_29$$17, this_ptr, _zephir_prop_0, 224, PH_NOISY_CC);
				} else {
				...
				if (0 == height) {
					...
					zephir_read_property_cached(&_30$$17, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC);
				} else {
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, save)
{
	...
	if (Z_TYPE_P(&file) == IS_NULL) {
		...
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 227, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, watermark)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 225, PH_NOISY_CC | PH_READONLY);
