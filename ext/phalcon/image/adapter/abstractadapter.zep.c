...
ZEPHIR_INIT_CLASS(Phalcon_Image_Adapter_AbstractAdapter) {
	...
	zend_declare_property_bool(phalcon_image_adapter_abstractadapter_ce, SL("checked"), 0, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("file"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var int
	 */
	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("height"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("image"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var string
	 */
	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("mime"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("realpath"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var int
	 */
	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("type"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var int
	 */
	zend_declare_property_null(phalcon_image_adapter_abstractadapter_ce, SL("width"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_class_implements(phalcon_image_adapter_abstractadapter_ce TSRMLS_CC, 1, phalcon_image_adapter_adapterinterface_ce);
	return SUCCESS;
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, background) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$4, "preg_replace", NULL, 44, &_6$$4, &_7$$4, &color);
		zephir_check_call_status();
		zephir_get_strval(&color, &_8$$4);
	}
	ZVAL_LONG(&_9, 2);
	ZEPHIR_CALL_FUNCTION(&_10, "str_split", NULL, 99, &color, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_11);
	ZVAL_STRING(&_11, "hexdec");
	ZEPHIR_CALL_FUNCTION(&colors, "array_map", NULL, 93, &_11, &_10);
	zephir_check_call_status();
	zephir_array_fetch_long(&_12, &colors, 0, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 80 TSRMLS_CC);
	zephir_array_fetch_long(&_13, &colors, 1, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 80 TSRMLS_CC);
	zephir_array_fetch_long(&_14, &colors, 2, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 80 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, render) {
	...
	if (!(!(Z_TYPE_P(&ext) == IS_UNDEF) && Z_STRLEN_P(&ext))) {
		...
		ZVAL_LONG(&_1$$3, 4);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "pathinfo", NULL, 100, &_0$$3, &_1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, resize) {
	...
	if (master == 7) {
		...
		if (UNEXPECTED(_0$$3)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "width and height must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 250);
			return;
		}
	} else {
		if (master == 4) {
			...
			if (UNEXPECTED(_1$$6)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "width and height must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 257);
				return;
			}
		...
		if (master == 5) {
			...
			if (UNEXPECTED(_5$$8)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "width and height must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 266);
				return;
			}
		...
		do {
			if (master == 2) {
				if (UNEXPECTED(!width)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "width must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 276);
					return;
				}
			...
			if (master == 3) {
				if (UNEXPECTED(!height)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "height must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 285);
					return;
				}
			...
			if (master == 6) {
				...
				if (UNEXPECTED(_13$$14)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_image_exception_ce, "width and height must be specified", "phalcon/Image/Adapter/AbstractAdapter.zep", 296);
					return;
				}
	...
	ZVAL_LONG(&_25, 1);
	ZEPHIR_CALL_FUNCTION(&_26, "max", NULL, 101, &_23, &_25);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_28, 1);
	ZEPHIR_CALL_FUNCTION(&_29, "max", NULL, 101, &_27, &_28);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_AbstractAdapter, text) {
	...
	if (zephir_fast_strlen_ev(&color) == 3) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$7, "preg_replace", NULL, 44, &_6$$7, &_7$$7, &color);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&colors, "array_map", NULL, 93, &_11, &_10);
	zephir_check_call_status();
	zephir_array_fetch_long(&_12, &colors, 0, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 416 TSRMLS_CC);
	zephir_array_fetch_long(&_13, &colors, 1, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 417 TSRMLS_CC);
	zephir_array_fetch_long(&_14, &colors, 2, PH_NOISY | PH_READONLY, "phalcon/Image/Adapter/AbstractAdapter.zep", 418 TSRMLS_CC);
	ZVAL_LONG(&_9, opacity);
	ZVAL_LONG(&_15, size);
