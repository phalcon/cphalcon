...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_image_imagefactory_checkconfig, 0, 1, IS_ARRAY, 0)
	ZEND_ARG_INFO(0, config)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_image_imagefactory_checkconfigelement, 0, 2, IS_ARRAY, 0)
	ZEND_ARG_ARRAY_INFO(0, config, 0)
	ZEND_ARG_TYPE_INFO(0, element, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_image_imagefactory_getcachedinstance, 0, 1, MAY_BE_OBJECT)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_VARIADIC_INFO(0, arguments)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_image_imagefactory_getservice, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_image_imagefactory_init, 0, 0, IS_VOID, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_image_imagefactory_method_entry) {
	...
	PHP_ME(Phalcon_Image_ImageFactory, checkConfig, arginfo_phalcon_image_imagefactory_checkconfig, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Image_ImageFactory, checkConfigElement, arginfo_phalcon_image_imagefactory_checkconfigelement, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Image_ImageFactory, getCachedInstance, arginfo_phalcon_image_imagefactory_getcachedinstance, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Image_ImageFactory, getService, arginfo_phalcon_image_imagefactory_getservice, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Image_ImageFactory, init, arginfo_phalcon_image_imagefactory_init, ZEND_ACC_PROTECTED)
