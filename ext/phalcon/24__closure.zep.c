...
{
	ZEPHIR_REGISTER_CLASS(phalcon, 24__closure, phalcon, 24__closure, phalcon_24__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	zend_declare_property_null(phalcon_24__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(phalcon_24__closure, __invoke)
{
	...
	zephir_read_static_property_ce(&escaper, phalcon_24__closure_ce, SL("escaper"), PH_NOISY_CC);
