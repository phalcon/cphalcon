...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "openssl_get_cipher_methods", NULL, 143, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getAvailableCiphers) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_get_cipher_methods", NULL, 143, ZEPHIR_GLOBAL(global_true));
	zephir_check_call_status();
	RETURN_MM();
