	...
	if (_0) {
		...
		do {
			if (paddingType == 1) {
				...
				ZVAL_LONG(&_1$$5, 0);
				ZEPHIR_CALL_FUNCTION(&_2$$5, "chr", &_3, 136, &_1$$5);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_1$$5);
				ZVAL_LONG(&_1$$5, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_4$$5, "str_repeat", &_5, 137, _2$$5, &_1$$5);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_1$$5);
				ZVAL_LONG(&_1$$5, paddingSize);
				ZEPHIR_CALL_FUNCTION(&_6$$5, "chr", &_3, 136, &_1$$5);
				zephir_check_call_status();
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_8$$6, "chr", &_3, 136, &_7$$6);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_7$$6);
				ZVAL_LONG(&_7$$6, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 137, _8$$6, &_7$$6);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 3) {
				...
				if (_10$$7 <= _11$$7) {
					while (1) {
						...
						i = _10$$7;
						ZEPHIR_CALL_FUNCTION(&_12$$8, "rand", &_13, 116);
						zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_14$$8, "chr", &_3, 136, _12$$8);
						zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_16$$7, "chr", &_3, 136, &_15$$7);
				zephir_check_call_status();
			...
			if (paddingType == 4) {
				...
				ZEPHIR_CALL_FUNCTION(&_18$$9, "chr", &_3, 136, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_17$$9);
				ZVAL_LONG(&_17$$9, 0);
				ZEPHIR_CALL_FUNCTION(&_19$$9, "chr", &_3, 136, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_17$$9);
				ZVAL_LONG(&_17$$9, (paddingSize - 1));
				ZEPHIR_CALL_FUNCTION(&_20$$9, "str_repeat", &_5, 137, _19$$9, &_17$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(padding);
			...
			if (paddingType == 5) {
				...
				ZVAL_LONG(&_21$$10, 0);
				ZEPHIR_CALL_FUNCTION(&_22$$10, "chr", &_3, 136, &_21$$10);
				zephir_check_call_status();
				ZEPHIR_SINIT_NVAR(_21$$10);
				ZVAL_LONG(&_21$$10, paddingSize);
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 137, _22$$10, &_21$$10);
				zephir_check_call_status();
				break;
			}
			if (paddingType == 6) {
				...
				ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_5, 137, &_23$$11, &_24$$11);
				zephir_check_call_status();
				break;
			}
			paddingSize = 0;
	...
	if (_1) {
		do {
			if (paddingType == 1) {
				...
				ZEPHIR_CALL_FUNCTION(&_5$$4, "ord", &_6, 138, last);
				zephir_check_call_status();
				...
				if (ord <= blockSize) {
					...
					ZVAL_LONG(&_7$$5, 0);
					ZEPHIR_CALL_FUNCTION(&_8$$5, "chr", &_9, 136, &_7$$5);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_7$$5);
					ZVAL_LONG(&_7$$5, (paddingSize - 1));
					ZEPHIR_CALL_FUNCTION(&_10$$5, "str_repeat", &_11, 137, _8$$5, &_7$$5);
					zephir_check_call_status();
					ZEPHIR_INIT_VAR(padding);
			...
			if (paddingType == 2) {
				...
				ZEPHIR_CALL_FUNCTION(&_15$$7, "ord", &_6, 138, last);
				zephir_check_call_status();
				...
				if (ord <= blockSize) {
					...
					ZEPHIR_CALL_FUNCTION(&_17$$8, "chr", &_9, 136, &_16$$8);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_16$$8);
					ZVAL_LONG(&_16$$8, paddingSize);
					ZEPHIR_CALL_FUNCTION(&padding, "str_repeat", &_11, 137, _17$$8, &_16$$8);
					zephir_check_call_status();
					ZEPHIR_SINIT_NVAR(_16$$8);
			...
			if (paddingType == 3) {
				...
				ZEPHIR_CALL_FUNCTION(&_21$$10, "ord", &_6, 138, last);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, encrypt) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "-", 0);
	ZEPHIR_CALL_FUNCTION(&_1, "strrpos", NULL, 139, cipher, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_3, "openssl_get_cipher_methods", NULL, 140);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&ivSize, "openssl_cipher_iv_length", &_4, 141, cipher);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(ivSize, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_7$$9, "str_ireplace", NULL, 142, _5$$9, _6$$9, cipher);
		zephir_check_temp_parameter(_6$$9);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&blockSize, "openssl_cipher_iv_length", &_4, 141, _7$$9);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&iv, "openssl_random_pseudo_bytes", NULL, 143, ivSize);
	zephir_check_call_status();
	...
	ZVAL_LONG(&_10, 1);
	ZEPHIR_CALL_FUNCTION(&_11, "openssl_encrypt", NULL, 144, padded, cipher, encryptKey, &_10, iv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, decrypt) {
	...
	ZVAL_LONG(&_11, 1);
	ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 145, _8, cipher, decryptKey, &_11, _10);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(paddingType);
	zephir_read_property_this(&paddingType, this_ptr, SL("_padding"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Crypt, encryptBase64) {
	...
	if (safe == 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$3, "base64_encode", &_3, 121, _0$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", &_3, 121, _6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Crypt, decryptBase64) {
	...
	if (safe == 1) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_3$$3, "base64_decode", &_4, 122, _2$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "decrypt", &_5, 0, _3$$3, key);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_6, "base64_decode", &_4, 122, text);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Crypt, getAvailableCiphers) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_get_cipher_methods", NULL, 140);
	zephir_check_call_status();
	RETURN_MM();
