...
PHP_METHOD(Phalcon_Time_Clock_SystemClock, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1378, timezone);
}
...
PHP_METHOD(Phalcon_Time_Clock_SystemClock, fromSystemTimezone)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "date_default_timezone_get", NULL, 250);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 251, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
