...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_crypt_padfactory_getexceptionclass, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_crypt_padfactory_method_entry) {
	...
	PHP_ME(Phalcon_Crypt_PadFactory, getExceptionClass, arginfo_phalcon_crypt_padfactory_getexceptionclass, ZEND_ACC_PROTECTED)
