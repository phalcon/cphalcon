...
PHP_METHOD(Phalcon_Queue_QueueFactory, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 1)
		Z_PARAM_OPTIONAL
		Z_PARAM_OBJECT_OF_CLASS_OR_NULL(factory, zephir_get_internal_ce(SL("phalcon\\queue\\adapterfactory")))
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1314, factory);
	ZEPHIR_MM_RESTORE();
}
