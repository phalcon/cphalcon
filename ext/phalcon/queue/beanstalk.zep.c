...
PHP_METHOD(Phalcon_Queue_Beanstalk, connect) {
	...
	ZVAL_NULL(_3);
	ZEPHIR_MAKE_REF(_2);
	ZEPHIR_CALL_FUNCTION(&connection, "fsockopen", NULL, 349, _0, _1, _2, _3);
	ZEPHIR_UNREF(_2);
	zephir_check_call_status();
	if (Z_TYPE_P(connection) != IS_RESOURCE) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, -1);
	ZEPHIR_CALL_FUNCTION(NULL, "stream_set_timeout", NULL, 350, connection, &_4, ZEPHIR_GLOBAL(global_null));
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, put) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readstatus", NULL, 351);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, reserve) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 352, this_ptr, _1, _4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, stats) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, this_ptr, "readyaml", NULL, 353);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, peekReady) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 352, this_ptr, _2, _5);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, read) {
	...
	zval *length_param = NULL, *connection = NULL, *data = NULL, _3, _4, _0$$5 = zval_used_for_init, *_1$$5 = NULL, *_2$$5;
	...
	if (length) {
		...
		ZEPHIR_CALL_FUNCTION(&data, "fread", NULL, 354, connection, &_0$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1$$5, "stream_get_meta_data", NULL, 355, connection);
		zephir_check_call_status();
		zephir_array_fetch_string(&_2$$5, _1$$5, SL("timed_out"), PH_NOISY | PH_READONLY, "phalcon/queue/beanstalk.zep", 354 TSRMLS_CC);
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_STRING(&_4, "\r\n", 0);
	ZEPHIR_RETURN_CALL_FUNCTION("stream_get_line", NULL, 356, connection, &_3, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, write) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("fwrite", NULL, 357, connection, packet, &_1);
	zephir_check_call_status();
	RETURN_MM();
