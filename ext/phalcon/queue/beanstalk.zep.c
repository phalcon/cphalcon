...
PHP_METHOD(Phalcon_Queue_Beanstalk, connect) {
	...
	ZVAL_NULL(_3);
	ZEPHIR_MAKE_REF(_2);
	ZEPHIR_CALL_FUNCTION(&connection, "fsockopen", NULL, 379, _0, _1, _2, _3);
	ZEPHIR_UNREF(_2);
	zephir_check_call_status();
	if (Z_TYPE_P(connection) != IS_RESOURCE) {
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_LONG(&_4, -1);
	ZEPHIR_CALL_FUNCTION(NULL, "stream_set_timeout", NULL, 380, connection, &_4, ZEPHIR_GLOBAL(global_null));
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Beanstalk, read) {
	...
	if (length) {
		...
		ZEPHIR_CALL_FUNCTION(&data, "stream_get_line", &_1, 384, connection, &_0$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_2$$5, "stream_get_meta_data", NULL, 385, connection);
		zephir_check_call_status();
	...
	ZEPHIR_SINIT_VAR(_5);
	ZVAL_STRING(&_5, "\r\n", 0);
	ZEPHIR_RETURN_CALL_FUNCTION("stream_get_line", &_1, 384, connection, &_4, &_5);
	zephir_check_call_status();
	RETURN_MM();
