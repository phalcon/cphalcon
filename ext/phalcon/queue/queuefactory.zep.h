...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_queue_queuefactory_checkconfig, 0, 1, IS_ARRAY, 0)
	ZEND_ARG_INFO(0, config)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_queue_queuefactory_checkconfigelement, 0, 2, IS_ARRAY, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_queue_queuefactory_method_entry) {
	...
	PHP_ME(Phalcon_Queue_QueueFactory, checkConfig, arginfo_phalcon_queue_queuefactory_checkconfig, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_QueueFactory, checkConfigElement, arginfo_phalcon_queue_queuefactory_checkconfigelement, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
