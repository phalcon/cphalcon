...
PHP_METHOD(Phalcon_Queue_AdapterFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1295, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_AdapterFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1296, PH_NOISY_CC | PH_READONLY);
