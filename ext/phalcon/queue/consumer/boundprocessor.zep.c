...
PHP_METHOD(Phalcon_Queue_Consumer_BoundProcessor, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1299, queue);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1300, processor);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1301, consumer);
}
