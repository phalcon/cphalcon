...
ZEPHIR_INIT_CLASS(Phalcon_Queue_Consumer_BoundProcessor)
{
...

	{
		zval _zc0;
		ZVAL_UNDEF(&_zc0);
		zephir_declare_typed_property(phalcon_queue_consumer_boundprocessor_ce, SL("consumer"), &_zc0, ZEND_ACC_PROTECTED, 0, SL("Phalcon\\Contracts\\Queue\\Consumer"));
	}

	{
		zval _zc0;
		ZVAL_UNDEF(&_zc0);
		zephir_declare_typed_property(phalcon_queue_consumer_boundprocessor_ce, SL("processor"), &_zc0, ZEND_ACC_PROTECTED, 0, SL("Phalcon\\Contracts\\Queue\\Processor"));
	}

	{
		zval _zc0;
		ZVAL_UNDEF(&_zc0);
		zephir_declare_typed_property(phalcon_queue_consumer_boundprocessor_ce, SL("queue"), &_zc0, ZEND_ACC_PROTECTED, 0, SL("Phalcon\\Contracts\\Queue\\Queue"));
	}
...
PHP_METHOD(Phalcon_Queue_Consumer_BoundProcessor, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1292, queue);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1293, processor);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1294, consumer);
}
