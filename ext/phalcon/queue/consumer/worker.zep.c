...
PHP_METHOD(Phalcon_Queue_Consumer_Worker, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1249, consumer);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1250, options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Consumer_Worker, run)
{
	...
	zephir_check_call_status();
	while (1) {
		zephir_read_property_cached(&_10$$6, this_ptr, _zephir_prop_1, 1249, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_11$$6, &_10$$6, "isstoprequested", NULL, 0);
		zephir_check_call_status();
		if (zephir_is_true(&_11$$6)) {
			break;
		}
		zephir_read_property_cached(&_12$$6, this_ptr, _zephir_prop_1, 1249, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_1, 1249, PH_NOISY_CC | PH_READONLY);
