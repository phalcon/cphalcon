...
ZEPHIR_INIT_CLASS(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnectionFactory)
{
...

	{
		...
		zephir_declare_typed_property(phalcon_queue_adapter_beanstalk_beanstalkconnectionfactory_ce, SL("options"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnectionFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1243, &options);
	ZEPHIR_MM_RESTORE();
}
