...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkContext, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, ttr);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1250, &_0);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, pollInterval);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1251, &_0);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkContext, getConnection)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1252, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkContext, newConnection)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1248, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1249, PH_NOISY_CC | PH_READONLY);
