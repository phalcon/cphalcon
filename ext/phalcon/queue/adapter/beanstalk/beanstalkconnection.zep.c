...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1218, &host_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, port);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1219, &_0);
	if (persistent) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1220, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1220, &__$false);
	}
	ZEPHIR_INIT_VAR(&_1);
	zephir_create_array(&_1, 1, 0);
	zephir_array_update_string(&_1, SL("default"), &__$true, PH_COPY | PH_SEPARATE);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1221, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, connect)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_2, 1218, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_3, 1219, PH_NOISY_CC | PH_READONLY);
		ZVAL_NULL(&_3$$4);
		ZVAL_NULL(&_4$$4);
		...
		zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_2, 1218, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_6$$5, this_ptr, _zephir_prop_3, 1219, PH_NOISY_CC | PH_READONLY);
		ZVAL_NULL(&_7$$5);
		ZVAL_NULL(&_8$$5);
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, disconnect)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1222, &__$null);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, ignoreTube)
{
	...
	if (result) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 1221, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, useTube)
{
	...
	if (result) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1223, &tube_zv);
	}
	RETURN_MM_BOOL(result);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, restoreSession)
{
	...
	if (!ZEPHIR_IS_STRING(&_0, "default")) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1223, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_3);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1221, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&tube);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_1, 1221, PH_NOISY_CC | PH_READONLY);
