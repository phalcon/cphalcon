...
PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, connect, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_connect, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFclose, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFgetCsv, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFileExists, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFileGetContents, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFilePutContents, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFopen, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpFwrite, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpIsWritable, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Queue_Adapter_Beanstalk_BeanstalkConnection, phpUnlink, arginfo_phalcon_queue_adapter_beanstalk_beanstalkconnection_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
