...
ZEPHIR_INIT_CLASS(Phalcon_Queue_Adapter_AbstractMessage)
{
...

	{
		...
		zephir_declare_typed_property(phalcon_queue_adapter_abstractmessage_ce, SL("body"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_queue_adapter_abstractmessage_ce, SL("headers"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_queue_adapter_abstractmessage_ce, SL("properties"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_BOOL(&_zc0, 0);
		zephir_declare_typed_property(phalcon_queue_adapter_abstractmessage_ce, SL("redelivered"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_BOOL, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 91, &body_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 92, &properties);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 93, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, getHeader)
{
	...
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 93, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, getProperty)
{
	...
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 92, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&_2$$3);
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, setHeaders)
{
	...
	zephir_get_arrval(&headers, headers_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 93, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, setProperties)
{
	...
	zephir_get_arrval(&properties, properties_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 92, &properties);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractMessage, setRedelivered)
{
	...
	if (redelivered) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 94, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 94, &__$false);
	}
}
