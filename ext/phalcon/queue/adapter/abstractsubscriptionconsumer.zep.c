...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Queue\\Adapter, AbstractSubscriptionConsumer, phalcon, queue_adapter_abstractsubscriptionconsumer, phalcon_queue_adapter_abstractsubscriptionconsumer_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);
	 ...
	 */
	{
		zval _zc0;
		ZVAL_LONG(&_zc0, 200);
		zephir_declare_typed_property(phalcon_queue_adapter_abstractsubscriptionconsumer_ce, SL("pollInterval"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_LONG, NULL, 0);
	}
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_queue_adapter_abstractsubscriptionconsumer_ce, SL("subscriptions"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractSubscriptionConsumer, consume)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 90, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		...
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 89, PH_NOISY_CC);
		zephir_get_arrval(&_4$$4, &_3$$4);
		zephir_is_iterable(&_4$$4, 0, "phalcon/Queue/Adapter/Traits/SubscriptionConsumerTrait.zep", 72);
		if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4$$4), _5$$4)
			{
				...
				zephir_array_fetch_long(&consumer, &subscription, 0, PH_NOISY, "phalcon/Queue/Adapter/Traits/SubscriptionConsumerTrait.zep", 59);
				ZEPHIR_OBS_NVAR(&callback);
				zephir_array_fetch_long(&callback, &subscription, 1, PH_NOISY, "phalcon/Queue/Adapter/Traits/SubscriptionConsumerTrait.zep", 60);
				ZEPHIR_CALL_METHOD(&message, &consumer, "receivenowait", NULL, 0);
				zephir_check_call_status();
				if (Z_TYPE_P(&message) != IS_NULL) {
					ZEPHIR_CALL_FUNCTION(&result, "call_user_func", &_6, 78, &callback, &message, &consumer);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "usleep", &_12, 71, &_11$$4);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractSubscriptionConsumer, subscribe)
{
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "resolvequeuename", NULL, 79, consumer);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Adapter_AbstractSubscriptionConsumer, unsubscribe)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "resolvequeuename", NULL, 79, consumer);
	zephir_check_call_status();
	zephir_unset_property_array(this_ptr, ZEND_STRL("subscriptions"), &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 89, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "resolvequeuename", NULL, 79, consumer);
	zephir_check_call_status();
