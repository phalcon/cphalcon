...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryConsumer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1260, queue);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryConsumer, reject)
{
	...
	if (requeue) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1259, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1260, PH_NOISY_CC | PH_READONLY);
