...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryConsumer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1205, context);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1206, queue);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryConsumer, receiveNoWait)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1206, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryConsumer, reject)
{
	...
	if (requeue) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1205, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1206, PH_NOISY_CC | PH_READONLY);
