...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryProducer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1215, context);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Memory_MemoryProducer, send)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1215, PH_NOISY_CC | PH_READONLY);
