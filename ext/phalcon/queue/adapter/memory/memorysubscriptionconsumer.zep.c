...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Queue\\Adapter\\Memory, MemorySubscriptionConsumer, phalcon, queue_adapter_memory_memorysubscriptionconsumer, phalcon_queue_adapter_memory_memorysubscriptionconsumer_method_entry, 0);
	 ...
	 * @var int
	 */
	zend_declare_property_long(phalcon_queue_adapter_memory_memorysubscriptionconsumer_ce, SL("pollInterval"), 200, ZEND_ACC_PROTECTED);
	/**
	 * Subscriptions keyed by queue name: [consumer, callback].
	 *
	 * @var array
	 */
	zend_declare_property_null(phalcon_queue_adapter_memory_memorysubscriptionconsumer_ce, SL("subscriptions"), ZEND_ACC_PROTECTED);
	phalcon_queue_adapter_memory_memorysubscriptionconsumer_ce->create_object = zephir_init_properties_Phalcon_Queue_Adapter_Memory_MemorySubscriptionConsumer;

	zend_class_implements(phalcon_queue_adapter_memory_memorysubscriptionconsumer_ce, 1, phalcon_contracts_queue_subscriptionconsumer_ce);
	return SUCCESS;
}

/**
 * MemorySubscriptionConsumer constructor.
 */
