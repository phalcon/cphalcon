...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_rediscontext_createqueue, 0, 1, Phalcon\\Contracts\\Queue\\Queue, 0)
	ZEND_ARG_TYPE_INFO(0, queueName, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_rediscontext_createtemporaryqueue, 0, 0, Phalcon\\Contracts\\Queue\\Queue, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_rediscontext_createtopic, 0, 1, Phalcon\\Contracts\\Queue\\Topic, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_queue_adapter_redis_rediscontext_serializemessage, 0, 1, IS_STRING, 0)
	ZEND_ARG_OBJ_INFO(0, message, Phalcon\\Contracts\\Queue\\Message, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_rediscontext_unserializemessage, 0, 1, Phalcon\\Contracts\\Queue\\Message, 1)
...
ZEPHIR_INIT_FUNCS(phalcon_queue_adapter_redis_rediscontext_method_entry) {
	...
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisContext, createQueue, arginfo_phalcon_queue_adapter_redis_rediscontext_createqueue, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisContext, createTemporaryQueue, arginfo_phalcon_queue_adapter_redis_rediscontext_createtemporaryqueue, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisContext, createTopic, arginfo_phalcon_queue_adapter_redis_rediscontext_createtopic, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisContext, serializeMessage, arginfo_phalcon_queue_adapter_redis_rediscontext_serializemessage, ZEND_ACC_PRIVATE)
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisContext, unserializeMessage, arginfo_phalcon_queue_adapter_redis_rediscontext_unserializemessage, ZEND_ACC_PRIVATE)
	PHP_FE_END
};
