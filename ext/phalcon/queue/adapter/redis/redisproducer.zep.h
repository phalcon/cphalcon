...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_queue_adapter_redis_redisproducer_getpriority, 0, 0, IS_LONG, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_queue_adapter_redis_redisproducer_gettimetolive, 0, 0, IS_LONG, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_redisproducer_setpriority, 0, 0, Phalcon\\Contracts\\Queue\\Producer, 0)
	ZEND_ARG_INFO(0, priority)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_queue_adapter_redis_redisproducer_settimetolive, 0, 0, Phalcon\\Contracts\\Queue\\Producer, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_queue_adapter_redis_redisproducer_method_entry) {
	...
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisProducer, getPriority, arginfo_phalcon_queue_adapter_redis_redisproducer_getpriority, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisProducer, getTimeToLive, arginfo_phalcon_queue_adapter_redis_redisproducer_gettimetolive, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisProducer, setPriority, arginfo_phalcon_queue_adapter_redis_redisproducer_setpriority, ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Queue_Adapter_Redis_RedisProducer, setTimeToLive, arginfo_phalcon_queue_adapter_redis_redisproducer_settimetolive, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
