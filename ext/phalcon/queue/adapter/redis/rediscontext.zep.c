...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisContext, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1278, redis);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1279, &prefix_zv);
	ZVAL_UNDEF(&_0);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisContext, purgeQueue)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisContext, pushMessage)
{
	...
	if (delay > 0) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisContext, promote)
{
	...
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			ZVAL_COPY(&member, _5);
			zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
			...
			if (ZEPHIR_GT_LONG(&_7$$4, 0)) {
				...
				zephir_read_property_cached(&_10$$5, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_13$$6, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
				...
				if (ZEPHIR_GT_LONG(&_14$$6, 0)) {
					...
					zephir_read_property_cached(&_17$$7, this_ptr, _zephir_prop_0, 1278, PH_NOISY_CC | PH_READONLY);
