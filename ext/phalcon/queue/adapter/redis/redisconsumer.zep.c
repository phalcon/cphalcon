...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1278, queue);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, receive)
{
	...
	while (1) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 1277, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_3$$4, 1);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, reject)
{
	...
	if (requeue) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1277, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1278, PH_NOISY_CC | PH_READONLY);
