...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1211, context);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1212, queue);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, receive)
{
	...
	while (1) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 1211, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_3$$4, 1);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, receiveNoWait)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1212, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Redis_RedisConsumer, reject)
{
	...
	if (requeue) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1211, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1212, PH_NOISY_CC | PH_READONLY);
