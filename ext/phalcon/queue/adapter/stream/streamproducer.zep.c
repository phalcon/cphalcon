...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamProducer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1227, context);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamProducer, send)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1227, PH_NOISY_CC | PH_READONLY);
