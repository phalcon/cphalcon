...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Queue\\Adapter\\Stream, StreamProducer, phalcon, queue_adapter_stream_streamproducer, phalcon_queue_adapter_stream_streamproducer_method_entry, 0);

	/**
	 * @var StreamContext
	 */
	zend_declare_property_null(phalcon_queue_adapter_stream_streamproducer_ce, SL("context"), ZEND_ACC_PROTECTED);
	zend_class_implements(phalcon_queue_adapter_stream_streamproducer_ce, 1, phalcon_contracts_queue_producer_ce);
	return SUCCESS;
}
