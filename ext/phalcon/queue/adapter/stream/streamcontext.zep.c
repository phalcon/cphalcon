...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1258, &_2);
	ZVAL_UNDEF(&_3);
	ZVAL_LONG(&_3, pollInterval);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1259, &_3);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, createConsumer)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1259, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, popMessage)
{
	...
	ZVAL_LONG(&_2, 2);
	ZEPHIR_CALL_FUNCTION(&_3, "flock", NULL, 285, &pointer, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_EMPTY(&lines)) {
		ZVAL_LONG(&_5$$6, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "flock", NULL, 285, &pointer, &_5$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "phpfclose", NULL, 0, &pointer);
		zephir_check_call_status();
		RETURN_MM_NULL();
	...
	zephir_check_call_status();
	ZVAL_LONG(&_2, 3);
	ZEPHIR_CALL_FUNCTION(NULL, "flock", NULL, 285, &pointer, &_2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "phpfclose", NULL, 0, &pointer);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, ensureDir)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "is_dir", NULL, 288, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 1258, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_3$$3, 0777);
		ZEPHIR_CALL_FUNCTION(NULL, "mkdir", NULL, 289, &_2$$3, &_3$$3, &__$true);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
