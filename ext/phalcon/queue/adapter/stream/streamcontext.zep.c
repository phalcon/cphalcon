...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, createConsumer)
{
	...
	if (UNEXPECTED(!((zephir_instance_of_ev(destination, phalcon_contracts_queue_queue_ce))))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_queue_exceptions_invaliddestinationexception_ce, "The Stream transport can only consume from a Queue destination", "phalcon/Queue/Adapter/Stream/StreamContext.zep", 69);
		return;
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, createQueue)
{
	...
	object_init_ex(return_value, phalcon_queue_adapter_stream_streamqueue_ce);
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, createTopic)
{
	...
	object_init_ex(return_value, phalcon_queue_adapter_stream_streamtopic_ce);
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, popMessage)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "c+");
	ZEPHIR_CALL_FUNCTION(&pointer, "fopen", NULL, 251, &filepath, &_0);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&pointer)) {
		RETURN_MM_NULL();
	}
	ZVAL_LONG(&_1, 2);
	ZEPHIR_CALL_FUNCTION(&_2, "flock", NULL, 245, &pointer, &_1);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_EMPTY(&lines)) {
		ZVAL_LONG(&_4$$6, 3);
		ZEPHIR_CALL_FUNCTION(NULL, "flock", NULL, 245, &pointer, &_4$$6);
		zephir_check_call_status();
		zephir_fclose(&pointer);
		RETURN_MM_NULL();
	}
	...
	ZVAL_LONG(&_1, 3);
	ZEPHIR_CALL_FUNCTION(NULL, "flock", NULL, 245, &pointer, &_1);
	zephir_check_call_status();
	zephir_fclose(&pointer);
	ZEPHIR_CALL_FUNCTION(&_8, "base64_decode", NULL, 502, &line);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&data, "unserialize", NULL, 28, &_8);
	zephir_check_call_status();
	if (Z_TYPE_P(&data) != IS_ARRAY) {
		RETURN_MM_NULL();
	}
	object_init_ex(return_value, phalcon_queue_adapter_stream_streammessage_ce);
	zephir_array_fetch_string(&_9, &data, SL("body"), PH_NOISY | PH_READONLY, "phalcon/Queue/Adapter/Stream/StreamContext.zep", 161);
	zephir_array_fetch_string(&_10, &data, SL("properties"), PH_NOISY | PH_READONLY, "phalcon/Queue/Adapter/Stream/StreamContext.zep", 161);
	zephir_array_fetch_string(&_11, &data, SL("headers"), PH_NOISY | PH_READONLY, "phalcon/Queue/Adapter/Stream/StreamContext.zep", 161);
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, purgeQueue)
{
	...
	zephir_check_call_status();
	if ((zephir_file_exists(&filepath) == SUCCESS)) {
		ZEPHIR_CALL_FUNCTION(NULL, "unlink", NULL, 209, &filepath);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, pushMessage)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "base64_encode", NULL, 505, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	...
	ZVAL_LONG(&_3, (8 | 2));
	ZEPHIR_CALL_FUNCTION(NULL, "file_put_contents", NULL, 250, &filepath, &line, &_3);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamContext, ensureDir)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "is_dir", NULL, 248, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("storageDir"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_3$$3, 0777);
		ZEPHIR_CALL_FUNCTION(NULL, "mkdir", NULL, 249, &_2$$3, &_3$$3, &__$true);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
}
