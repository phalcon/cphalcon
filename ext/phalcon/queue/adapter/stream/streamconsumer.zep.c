...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamConsumer, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1257, &_0);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Stream_StreamConsumer, reject)
{
	...
	if (requeue) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1256, PH_NOISY_CC | PH_READONLY);
