...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1280, &body_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1281, &properties);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1282, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getHeader)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1282, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1282, PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_2$$3, &_1$$3, &name_zv, PH_NOISY | PH_READONLY, "phalcon/Queue/Adapter/Traits/MessageTrait.zep", 69);
		RETURN_CTORW(&_2$$3);
	}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getProperty)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1281, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1281, PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_2$$3, &_1$$3, &name_zv, PH_NOISY | PH_READONLY, "phalcon/Queue/Adapter/Traits/MessageTrait.zep", 105);
		RETURN_CTORW(&_2$$3);
	}
	RETVAL_ZVAL(defaultValue, 1, 0);
	return;
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, setHeaders)
{
	...
	zephir_get_arrval(&headers, headers_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1282, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, setProperties)
{
	...
	zephir_get_arrval(&properties, properties_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1281, &properties);
	ZEPHIR_MM_RESTORE();
}
