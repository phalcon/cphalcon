...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1274, &body_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1275, &properties);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1276, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getHeader)
{
	...
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1276, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getHeaders)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1276, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getProperties)
{
	...
	zephir_memory_observe(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1275, PH_NOISY_CC);
	zephir_get_arrval(&_1, &_0);
	RETURN_CTOR(&_1);
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, getProperty)
{
	...
	if (zephir_array_key_exists(&_0, &name_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1275, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, setHeaders)
{
	...
	zephir_get_arrval(&headers, headers_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1276, &headers);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, setProperties)
{
	...
	zephir_get_arrval(&properties, properties_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1275, &properties);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_MessageTrait, setRedelivered)
{
	...
	if (redelivered) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1277, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1277, &__$false);
	}
}
