...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_SubscriptionConsumerTrait, consume)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 1267, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_SubscriptionConsumerTrait, unsubscribe)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1267, PH_NOISY_CC | PH_READONLY);
