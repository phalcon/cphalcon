...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_SubscriptionConsumerTrait, consume)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 1230, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_SubscriptionConsumerTrait, unsubscribe)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1230, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Queue_Adapter_Traits_SubscriptionConsumerTrait, unsubscribeAll)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1230, &_0);
	ZEPHIR_MM_RESTORE();
}
