		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_9$$4, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
				...
				if (!ZEPHIR_IS_FALSE_IDENTICAL(&_10$$7)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 190 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	while (1) {
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_20$$12, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 230 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_60$$30, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 364 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, SL("beforeexecuteroute") TSRMLS_CC) == SUCCESS)) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_70$$35, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 381 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
			...
			if ((zephir_method_exists_ex(&handler, SL("initialize") TSRMLS_CC) == SUCCESS)) {
				...
				if (EG(exception)) {
					...
					if (zephir_instance_of_ev(&_76$$41, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
						...
						zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 424 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
			...
			if (zephir_is_true(&eventsManager)) {
				...
				if (EG(exception)) {
					...
					if (zephir_instance_of_ev(&_86$$45, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
						...
						zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 443 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_102$$10, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
				...
				zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 515 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_112$$61, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 531 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, SL("afterexecuteroute") TSRMLS_CC) == SUCCESS)) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_120$$66, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 548 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_127$$71, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
					...
					zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 565 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	if (hasEventsManager) {
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_133$$75, zend_exception_get_default(TSRMLS_C) TSRMLS_CC)) {
				...
				zephir_throw_exception_debug(&e, "phalcon/Dispatcher.zep", 582 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Phalcon_Dispatcher, forward) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_exception_ce, "Forwarding inside a controller's initialize() method is forbidden", "phalcon/Dispatcher.zep", 616);
		return;
	}
...
PHP_METHOD(Phalcon_Dispatcher, getHandlerClass) {
	...
	if (!(zephir_memnstr_str(&handlerName, SL("\\"), "phalcon/Dispatcher.zep", 880))) {
