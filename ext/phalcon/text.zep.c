...
PHP_METHOD(Phalcon_Text, endsWith)
{
	...
	ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_helper_str_ce, "endswith", &_0, 279, &text, &end, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Text, startsWith)
{
	...
	ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_helper_str_ce, "startswith", &_0, 11, &text, &start, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
