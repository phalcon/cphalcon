...
ZEPHIR_INIT_CLASS(phalcon_9__closure)
{
	...
	zend_declare_property_null(phalcon_9__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(phalcon_9__closure, __invoke)
{
	...
	zephir_read_static_property_ce(&escaper, phalcon_9__closure_ce, SL("escaper"), PH_NOISY_CC);
