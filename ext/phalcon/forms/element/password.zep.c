...
ZEPHIR_INIT_CLASS(Phalcon_Forms_Element_Password)
{
	...
	{
		zval _zc0;
		ZVAL_STRINGL(&_zc0, "inputPassword", sizeof("inputPassword") - 1);
		zephir_declare_typed_property(phalcon_forms_element_password_ce, SL("method"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
