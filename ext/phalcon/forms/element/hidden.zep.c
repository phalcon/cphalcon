...
ZEPHIR_INIT_CLASS(Phalcon_Forms_Element_Hidden)
{
	...
	{
		zval _zc0;
		ZVAL_STRINGL(&_zc0, "inputHidden", sizeof("inputHidden") - 1);
		zephir_declare_typed_property(phalcon_forms_element_hidden_ce, SL("method"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
