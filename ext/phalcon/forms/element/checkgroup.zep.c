...
PHP_METHOD(Phalcon_Forms_Element_CheckGroup, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 748, &options);
...
PHP_METHOD(Phalcon_Forms_Element_CheckGroup, render)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 750, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 748, PH_NOISY_CC | PH_READONLY);
