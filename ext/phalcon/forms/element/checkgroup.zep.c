...
PHP_METHOD(Phalcon_Forms_Element_CheckGroup, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 752, &options);
...
PHP_METHOD(Phalcon_Forms_Element_CheckGroup, render)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 754, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 752, PH_NOISY_CC | PH_READONLY);
