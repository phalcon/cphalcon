...
PHP_METHOD(Phalcon_Forms_Element_Select, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 754, options);
...
PHP_METHOD(Phalcon_Forms_Element_Select, render)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 754, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Forms_Element_Select, prepareAttributes)
{
	...
	zephir_read_property_cached(&defaultAttributes, this_ptr, _zephir_prop_1, 756, PH_NOISY_CC);
