...
PHP_METHOD(Phalcon_Forms_Element_Select, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 795, options);
...
PHP_METHOD(Phalcon_Forms_Element_Select, addOption)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		array_init(&_1$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 795, &_1$$3);
	}
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 795, PH_NOISY_CC);
