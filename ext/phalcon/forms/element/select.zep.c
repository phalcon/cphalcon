...
PHP_METHOD(Phalcon_Forms_Element_Select, addOption)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 779, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Forms_Element_Select, prepareAttributes)
{
	...
	zephir_read_property_cached(&defaultAttributes, this_ptr, _zephir_prop_1, 781, PH_NOISY_CC);
