...
ZEPHIR_INIT_CLASS(Phalcon_Forms_Element_TextArea)
{
	...
	{
		zval _zc0;
		ZVAL_STRINGL(&_zc0, "inputTextarea", sizeof("inputTextarea") - 1);
		zephir_declare_typed_property(phalcon_forms_element_textarea_ce, SL("method"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
