...
ZEPHIR_INIT_CLASS(Phalcon_Forms_Element_Text) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Forms\\Element, Text, phalcon, forms_element_text, phalcon_forms_element_abstractelement_ce, phalcon_forms_element_text_method_entry, 0);
