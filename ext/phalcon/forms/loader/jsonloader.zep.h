...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_forms_loader_jsonloader_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_forms_loader_jsonloader_method_entry) {
	...
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFclose, arginfo_phalcon_forms_loader_jsonloader_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFgetCsv, arginfo_phalcon_forms_loader_jsonloader_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFileExists, arginfo_phalcon_forms_loader_jsonloader_phpfileexists, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFilePutContents, arginfo_phalcon_forms_loader_jsonloader_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFopen, arginfo_phalcon_forms_loader_jsonloader_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpFwrite, arginfo_phalcon_forms_loader_jsonloader_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpIsWritable, arginfo_phalcon_forms_loader_jsonloader_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Forms_Loader_JsonLoader, phpUnlink, arginfo_phalcon_forms_loader_jsonloader_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
