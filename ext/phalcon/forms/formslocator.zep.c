...
PHP_METHOD(Phalcon_Forms_FormsLocator, get)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 773, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 774, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Forms_FormsLocator, getElement)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 772, PH_NOISY_CC | PH_READONLY);
