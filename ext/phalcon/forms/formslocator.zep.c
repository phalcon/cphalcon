...
PHP_METHOD(Phalcon_Forms_FormsLocator, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 775, &_0);
...
PHP_METHOD(Phalcon_Forms_FormsLocator, get)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 776, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 777, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Forms_FormsLocator, getElement)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 775, PH_NOISY_CC | PH_READONLY);
