...
PHP_METHOD(Phalcon_Forms_Manager, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 1)
		Z_PARAM_OPTIONAL
		Z_PARAM_OBJECT_OF_CLASS_OR_NULL(locator, zephir_get_internal_ce(SL("phalcon\\forms\\formslocator")))
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 802, locator);
	ZEPHIR_MM_RESTORE();
}
