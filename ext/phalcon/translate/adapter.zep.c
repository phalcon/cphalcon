...
ZEPHIR_INIT_CLASS(Phalcon_Translate_Adapter) {
	 ...
	 */
	zend_declare_property_null(phalcon_translate_adapter_ce, SL("interpolator"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Translate_Adapter, offsetUnset) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_translate_exception_ce, "Translate is an immutable ArrayAccess object", "phalcon/Translate/Adapter.zep", 80);
	return;
...
PHP_METHOD(Phalcon_Translate_Adapter, replacePlaceholders) {
	...
	zephir_read_property(&_0, this_ptr, SL("interpolator"), PH_NOISY_CC | PH_READONLY);
