 ...
 */
ZEPHIR_INIT_CLASS(Phalcon_Translate_Exceptions_MissingRequiredParameter)
{
...
PHP_METHOD(Phalcon_Translate_Exceptions_MissingRequiredParameter, __construct)
{
	zval _0;
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1388, &parameter_zv);
	ZEPHIR_INIT_VAR(&_0);
...
PHP_METHOD(Phalcon_Translate_Exceptions_MissingRequiredParameter, getParameter)
{
