...
PHP_METHOD(Phalcon_Translate_Adapter_NativeArray, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1370, &data);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Translate_Adapter_NativeArray, has)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1370, PH_NOISY_CC | PH_READONLY);
