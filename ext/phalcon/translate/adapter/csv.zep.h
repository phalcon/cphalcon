...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_translate_adapter_csv_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_translate_adapter_csv_method_entry) {
	...
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFclose, arginfo_phalcon_translate_adapter_csv_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFgetCsv, arginfo_phalcon_translate_adapter_csv_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFileExists, arginfo_phalcon_translate_adapter_csv_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFileGetContents, arginfo_phalcon_translate_adapter_csv_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFilePutContents, arginfo_phalcon_translate_adapter_csv_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFopen, arginfo_phalcon_translate_adapter_csv_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpFwrite, arginfo_phalcon_translate_adapter_csv_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpIsWritable, arginfo_phalcon_translate_adapter_csv_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Translate_Adapter_Csv, phpUnlink, arginfo_phalcon_translate_adapter_csv_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
