...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_translate_adapter_csv_ce, getThis(), "__construct", &_0, 462, options);
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "_load", NULL, 463, _1, _2, _3, _4);
...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, _load) {
	...
	while (1) {
		ZEPHIR_CALL_FUNCTION(&data, "fgetcsv", &_3, 464, fileHandler, length, delimiter, enclosure);
		zephir_check_call_status();
