...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_translate_adapter_csv_ce, this_ptr, "__construct", &_0, 447, options);
...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, _load) {
	...
	while (1) {
		ZEPHIR_CALL_FUNCTION(&data, "fgetcsv", &_3, 449, fileHandler, length, delimiter, enclosure);
		zephir_check_call_status();
