...
PHP_METHOD(Phalcon_Translate_Adapter_Csv, __construct) {
	...
	zephir_fcall_cache_entry *_5 = NULL, *_9 = NULL, *_12 = NULL;
	...
	ZEPHIR_SINIT_VAR(_4);
	ZVAL_STRING(&_4, "rb", 0);
	ZEPHIR_CALL_FUNCTION(&file, "fopen", &_5, 258, _3, &_4);
	...
	if (Z_TYPE_P(file) != IS_RESOURCE) {
		...
		ZEPHIR_CALL_METHOD(NULL, _6, "__construct", &_9, 2, _8);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&data, "fgetcsv", &_12, 401, file, _7, _10, _11);
		zephir_check_call_status();
