...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_translate_adapter_gettext_ce, this_ptr, "__construct", &_0, 391, options);
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, query) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "func_num_args", NULL, 386);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(_0, 2)) {
		ZEPHIR_SINIT_VAR(_1$$3);
		ZVAL_LONG(&_1$$3, 2);
		ZEPHIR_CALL_FUNCTION(&domain, "func_get_arg", NULL, 385, &_1$$3);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setDirectory) {
	...
	HashPosition _0$$4;
	int ZEPHIR_LAST_CALL_STATUS;
	zval *directory, *key = NULL, *value = NULL, **_2$$4, *_3$$6 = NULL;
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setLocale) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "putenv", NULL, 394, _4);
	zephir_check_call_status();
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("_locale"), PH_NOISY_CC);
	ZEPHIR_SINIT_VAR(_6);
	ZVAL_LONG(&_6, 6);
	ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 380, &_6, _5);
	zephir_check_call_status();
