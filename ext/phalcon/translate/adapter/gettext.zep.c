...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, __construct) {
	...
	if (UNEXPECTED(!((zephir_function_exists_ex(ZEND_STRL("gettext")) == SUCCESS)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_translate_exception_ce, "This class requires the gettext extension for PHP", "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 72);
		return;
	}
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setDirectory) {
	...
	if (Z_TYPE_P(directory) == IS_ARRAY) {
		zephir_is_iterable(directory, 0, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 183);
		if (Z_TYPE_P(directory) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, prepareOptions) {
	...
	if (UNEXPECTED(!(zephir_array_isset_string(&options, SL("locale"))))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_translate_exception_ce, "Parameter 'locale' is required", "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 244);
		return;
	}
	if (UNEXPECTED(!(zephir_array_isset_string(&options, SL("directory"))))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_translate_exception_ce, "Parameter 'directory' is required", "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 248);
		return;
	}
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_array_fetch_string(&_2, &options, SL("category"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 257);
	zephir_array_fetch_string(&_3, &options, SL("locale"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 259);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setlocale", NULL, 0, &_2, &_3);
	zephir_check_call_status();
	zephir_array_fetch_string(&_4, &options, SL("defaultDomain"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 263);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setdefaultdomain", NULL, 0, &_4);
	zephir_check_call_status();
	zephir_array_fetch_string(&_5, &options, SL("directory"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 267);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setdirectory", NULL, 0, &_5);
	zephir_check_call_status();
	zephir_array_fetch_string(&_6, &options, SL("defaultDomain"), PH_NOISY | PH_READONLY, "/home/nikos/Work/niden/cphalcon/phalcon/Translate/Adapter/Gettext.zep", 271);
