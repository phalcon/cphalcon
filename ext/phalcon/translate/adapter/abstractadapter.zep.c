...
PHP_METHOD(Phalcon_Translate_Adapter_AbstractAdapter, offsetSet)
{
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Translate/Adapter/AbstractAdapter.zep", 104);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Translate_Adapter_AbstractAdapter, offsetUnset)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 130);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Translate/Adapter/AbstractAdapter.zep", 117);
	ZEPHIR_MM_RESTORE();
	return;
}
