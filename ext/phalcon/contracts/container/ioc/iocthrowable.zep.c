...
{
	ZEPHIR_REGISTER_INTERFACE(Phalcon\\Contracts\\Container\\Ioc, IocThrowable, phalcon, contracts_container_ioc_iocthrowable, NULL);

	zend_class_implements(phalcon_contracts_container_ioc_iocthrowable_ce, 1, zend_ce_throwable);
	return SUCCESS;
}
