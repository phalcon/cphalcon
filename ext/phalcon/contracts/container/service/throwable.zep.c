...
{
	ZEPHIR_REGISTER_INTERFACE(Phalcon\\Contracts\\Container\\Service, Throwable, phalcon, contracts_container_service_throwable, NULL);

	zend_class_implements(phalcon_contracts_container_service_throwable_ce, 1, zend_ce_throwable);
	return SUCCESS;
}
