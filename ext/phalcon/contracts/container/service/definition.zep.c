...
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, getServiceName);
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, hasClass);
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, hasExtenders);
...
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, setLifetime);
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, unsetClass);
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, unsetExtenders);
ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Definition, unsetFactory);
