...
{
	ZEPHIR_REGISTER_INTERFACE(Phalcon\\Contracts\\Container\\Service, Provider, phalcon, contracts_container_service_provider, phalcon_contracts_container_service_provider_method_entry);

	return SUCCESS;
}

ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Service_Provider, provide);
