...
{
	ZEPHIR_REGISTER_INTERFACE(Phalcon\\Contracts\\Container\\Resolver, Resolvable, phalcon, contracts_container_resolver_resolvable, phalcon_contracts_container_resolver_resolvable_method_entry);

	return SUCCESS;
}

ZEPHIR_DOC_METHOD(Phalcon_Contracts_Container_Resolver_Resolvable, resolve);
