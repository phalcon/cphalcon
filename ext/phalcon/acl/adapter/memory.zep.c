...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponent)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &componentObject, "__construct", NULL, 242, componentValue);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_METHOD(&componentName, &componentObject, "getname", NULL, 243);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponentAccess)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 244, &_0, &componentName_zv, &_1);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 245);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(accessList) == IS_ARRAY) {
		...
		if (Z_TYPE_P(accessList) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(accessList), _4$$4)
			{
				...
				ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 246, &componentName_zv, &accessName);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 246, &componentName_zv, accessList);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addInherit)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 244, &_0, &roleName_zv, &_1, &_2);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&roleToInheritList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&roleToInheritList), _5)
		{
			...
			if (UNEXPECTED(!(zephir_array_isset_value(&_9$$6, &roleInheritName)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_10$$10, "__construct", &_11, 247, &roleInheritName);
				zephir_check_call_status();
			...
			if (zephir_array_isset_value(&_12$$6, &roleInheritName)) {
				...
				if (Z_TYPE_P(&_14$$12) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_14$$12), _15$$12)
					{
						...
						ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_16, 248, &checkRoleToInherits, &usedRoleToInherit);
				...
				while (1) {
					...
					if (UNEXPECTED(ZEPHIR_IS_EQUAL(&roleName_zv, &checkRoleToInherit))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_19$$17, "__construct", &_20, 249, &roleInheritName);
						zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_value(&_32$$21, &roleInheritName)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_33$$25, "__construct", &_11, 247, &roleInheritName);
					zephir_check_call_status();
				...
				if (zephir_array_isset_value(&_34$$21, &roleInheritName)) {
					...
					while (1) {
						...
						if (UNEXPECTED(ZEPHIR_IS_EQUAL(&roleName_zv, &checkRoleToInherit))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_40$$32, "__construct", &_20, 249, &roleInheritName);
							zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addRole)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &roleObject, "__construct", NULL, 250, role);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_1$$5);
		object_init_ex(&_1$$5, phalcon_acl_exceptions_invalidroletype_ce);
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 251);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$5, "phalcon/Acl/Adapter/Memory.zep", 409);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&roleName, &roleObject, "getname", NULL, 252);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allow)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&rolesArray), _2)
	{
		...
		ZVAL_COPY(&role, _2);
		ZVAL_LONG(&_3$$4, 1);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "allowordeny", &_4, 253, &role, &componentName_zv, access, &_3$$4, func);
		zephir_check_call_status();
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&role);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, dropComponentAccess)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&localAccess), _1)
	{
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_2, 246, &componentName_zv, &accessName);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "torolename", NULL, 254, roleName);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(roleName, &_2);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "tocomponentname", NULL, 255, componentName);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "canaccess", NULL, 256, roleName, componentName, &access_zv);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&haveAccess) == IS_NULL) {
		ZEPHIR_CALL_METHOD(&_11$$8, this_ptr, "buildkey", NULL, 257, roleName, componentName, &access_zv);
		zephir_check_call_status();
	...
	if (zephir_is_callable(&funcAccess)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &reflectionFunction, "__construct", NULL, 258, &funcAccess);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&reflectionParameters, &reflectionFunction, "getparameters", NULL, 259);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&numberOfRequiredParameters, &reflectionFunction, "getnumberofrequiredparameters", NULL, 260);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&reflectionParameters) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionParameters), _15$$9)
			{
				...
				if (_16$$11) {
					...
					ZEPHIR_CALL_METHOD(NULL, &reflectionClass, "__construct", &_17, 261, &className);
					zephir_check_call_status();
					_18$$12 = Z_TYPE_P(&roleObject) != IS_NULL;
					if (_18$$12) {
						ZEPHIR_CALL_METHOD(&_19$$12, &reflectionClass, "isinstance", &_20, 262, &roleObject);
						zephir_check_call_status();
					...
					if (_22$$12) {
						ZEPHIR_CALL_METHOD(&_23$$12, &reflectionClass, "isinstance", &_20, 262, &componentObject);
						zephir_check_call_status();
					...
					if (_27$$12) {
						...
						ZEPHIR_CALL_METHOD(&_28$$12, &reflectionClass, "isinstance", &_20, 262, &_29$$12);
						zephir_check_call_status();
					...
					if (UNEXPECTED(_27$$12)) {
						...
						ZEPHIR_CALL_METHOD(&_33$$15, &reflectionClass, "getname", &_34, 263);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_40$$17) {
						...
						if (_41$$18) {
							ZEPHIR_CALL_METHOD(&_42$$18, &reflectionClass, "isinstance", &_20, 262, &roleObject);
							zephir_check_call_status();
						...
						if (_44$$18) {
							ZEPHIR_CALL_METHOD(&_45$$18, &reflectionClass, "isinstance", &_20, 262, &componentObject);
							zephir_check_call_status();
						...
						if (_49$$18) {
							...
							ZEPHIR_CALL_METHOD(&_50$$18, &reflectionClass, "isinstance", &_20, 262, &_51$$18);
							zephir_check_call_status();
						...
						if (UNEXPECTED(_49$$18)) {
							...
							ZEPHIR_CALL_METHOD(&_55$$21, &reflectionClass, "getname", &_34, 263);
							zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allowOrDeny)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Role");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 244, &_0, &roleName_zv, &_1);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, ZEND_STRL("componentsNames"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Component");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 244, &_2, &componentName_zv, &_1);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(access) == IS_ARRAY) {
		...
		if (Z_TYPE_P(access) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(access), _4$$3)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_7, 264, &accessName, &componentName_zv);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_10$$7, "__construct", &_7, 264, &accessName, &componentName_zv);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(access) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(access), _11$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildkey", &_12, 257, &roleName_zv, &componentName_zv, &accessName);
				zephir_check_call_status();
		...
		if (!ZEPHIR_IS_STRING(access, "*")) {
			ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 246, &componentName_zv, access);
			zephir_check_call_status();
			if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
				ZEPHIR_INIT_VAR(&_15$$14);
				object_init_ex(&_15$$14, phalcon_acl_exceptions_accessrulenotfound_ce);
				ZEPHIR_CALL_METHOD(NULL, &_15$$14, "__construct", &_7, 264, access, &componentName_zv);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildkey", &_12, 257, &roleName_zv, &componentName_zv, access);
		zephir_check_call_status();
		zephir_update_property_array(this_ptr, SL("access"), &accessKey, action);
		if (Z_TYPE_P(func) != IS_NULL) {
			zephir_update_property_array(this_ptr, SL("functions"), &accessKey, func);
	...
	if (zephir_array_isset_value(&_0, &roleName_zv)) {
		...
		if (Z_TYPE_P(&_2$$6) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2$$6), _3$$6)
			{
				...
				ZEPHIR_MAKE_REF(&checkRoleToInherits);
				ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_4, 248, &checkRoleToInherits, &usedRoleToInherit);
				ZEPHIR_UNREF(&checkRoleToInherits);
				zephir_check_call_status();
			} ZEND_HASH_FOREACH_END();
		} else {
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toComponentName)
{
	...
	if (Z_TYPE_P(component) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 265);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toRoleName)
{
	...
	if (Z_TYPE_P(role) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 266);
		zephir_check_call_status();
