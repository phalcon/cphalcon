...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addInherit) {
	...
	zval *roleName_param = NULL, *roleToInherits, roleToInherits_sub, __$true, roleInheritName, rolesNames, roleToInherit, checkRoleToInherit, checkRoleToInherits, usedRoleToInherits, roleToInheritList, usedRoleToInherit, _0, *_4, _1$$3, _3$$4, _6$$7, _7$$7, _10$$7, _8$$11, _9$$11, _11$$13, _12$$13, *_13$$13, _16$$17, _17$$17, _18$$15, _19$$18, _20$$18, *_21$$18;
	zval roleName, _2$$3;
	zval *this_ptr = getThis();
	...
	if (!(zephir_array_isset(&rolesNames, &roleName))) {
		...
		zephir_throw_exception_debug(&_1$$3, "phalcon/Acl/Adapter/Memory.zep", 205 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_is_iterable(&roleToInheritList, 0, "phalcon/Acl/Adapter/Memory.zep", 276);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&roleToInheritList), _4)
	{
		...
		zephir_array_fetch(&_7$$7, &_6$$7, &roleName, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 231 TSRMLS_CC);
		...
		if (!(zephir_array_isset(&rolesNames, &roleInheritName))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_8$$11, "phalcon/Acl/Adapter/Memory.zep", 238 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (zephir_array_isset(&_10$$7, &roleInheritName)) {
			...
			zephir_array_fetch(&_12$$13, &_11$$13, &roleInheritName, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 249 TSRMLS_CC);
			zephir_is_iterable(&_12$$13, 0, "phalcon/Acl/Adapter/Memory.zep", 252);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_12$$13), _13$$13)
			{
				...
				ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_14, 85, &checkRoleToInherits, &usedRoleToInherit);
			...
			while (1) {
				...
				ZEPHIR_MAKE_REF(&checkRoleToInherits);
				ZEPHIR_CALL_FUNCTION(&checkRoleToInherit, "array_shift", &_15, 14, &checkRoleToInherits);
				ZEPHIR_UNREF(&checkRoleToInherits);
				zephir_check_call_status();
				...
				if (ZEPHIR_IS_EQUAL(&roleName, &checkRoleToInherit)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_16$$17, "phalcon/Acl/Adapter/Memory.zep", 261 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				if (zephir_array_isset(&_18$$15, &checkRoleToInherit)) {
					...
					zephir_array_fetch(&_20$$18, &_19$$18, &checkRoleToInherit, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 267 TSRMLS_CC);
					zephir_is_iterable(&_20$$18, 0, "phalcon/Acl/Adapter/Memory.zep", 270);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addRole) {
	...
	if (_0) {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_acl_exception_ce, "Role must be either an string or implement RoleInterface", "phalcon/Acl/Adapter/Memory.zep", 307);
		return;
	}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponentAccess) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *componentName_param = NULL, *accessList, accessList_sub, accessName, accessKey, _0, _1$$3, *_4$$5, _5$$6, _6$$7, _7$$8, _8$$9;
	...
	if (!(zephir_array_isset(&_0, &componentName))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 1, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Acl/Adapter/Memory.zep", 391 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (_3) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_acl_exception_ce, "Invalid value for accessList", "phalcon/Acl/Adapter/Memory.zep", 395);
		return;
	}
	exists = 1;
	if (Z_TYPE_P(accessList) == IS_ARRAY) {
		zephir_is_iterable(accessList, 0, "phalcon/Acl/Adapter/Memory.zep", 406);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allow) {
	...
	if (!ZEPHIR_IS_STRING(&roleName, "*")) {
		...
		zephir_is_iterable(&_1$$4, 0, "phalcon/Acl/Adapter/Memory.zep", 446);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1$$4), _4$$4, _5$$4, _3$$4)
		{
			...
			ZVAL_COPY(&_2$$4, _3$$4);
			ZVAL_LONG(&_6$$5, 1);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "allowordeny", NULL, 88, &innerRoleName, &componentName, access, &_6$$5, func);
			zephir_check_call_status();
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&_2$$4);
		ZEPHIR_INIT_NVAR(&innerRoleName);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, deny) {
	...
	if (!ZEPHIR_IS_STRING(&roleName, "*")) {
		...
		zephir_read_property(&_1$$4, this_ptr, SL("rolesNames"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_2$$4);
		zephir_is_iterable(&_1$$4, 0, "phalcon/Acl/Adapter/Memory.zep", 479);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1$$4), _4$$4, _5$$4, _3$$4)
		{
			ZEPHIR_INIT_NVAR(&innerRoleName);
			if (_5$$4 != NULL) { 
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, dropComponentAccess) {
	...
	zval *componentName_param = NULL, *accessList, accessList_sub, accessName, accessKey, *_0$$3, _1$$4, _2$$5, _3$$7, _4$$8;
	zval componentName;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(accessList) == IS_ARRAY) {
		zephir_is_iterable(accessList, 0, "phalcon/Acl/Adapter/Memory.zep", 498);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed) {
	...
	if (Z_TYPE_P(roleName) == IS_OBJECT) {
		if (zephir_instance_of_ev(roleName, phalcon_acl_roleaware_ce TSRMLS_CC)) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_acl_exception_ce, "Object passed as roleName must implement Phalcon\\Acl\\RoleAware or Phalcon\\Acl\\RoleInterface", "phalcon/Acl/Adapter/Memory.zep", 563);
			return;
		}
	}
	if (Z_TYPE_P(componentName) == IS_OBJECT) {
		if (zephir_instance_of_ev(componentName, phalcon_acl_componentaware_ce TSRMLS_CC)) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_acl_exception_ce, "Object passed as componentName must implement Phalcon\\Acl\\ComponentAware or Phalcon\\Acl\\ComponentInterface", "phalcon/Acl/Adapter/Memory.zep", 574);
			return;
		}
	}
	...
	if (zephir_is_callable(&funcAccess TSRMLS_CC)) {
		...
		zephir_is_iterable(&reflectionParameters, 0, "phalcon/Acl/Adapter/Memory.zep", 687);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionParameters), _12$$17)
		{
			...
			if (Z_TYPE_P(&reflectionClass) != IS_NULL) {
				...
				if (_15$$20) {
					hasRole = 1;
					zephir_array_append(&parametersForFunction, &roleObject, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 658);
				...
				if (_18$$20) {
					hasComponent = 1;
					zephir_array_append(&parametersForFunction, &componentObject, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 667);
					ZEPHIR_SEPARATE(&userParametersSizeShouldBe);
					zephir_decrement(&userParametersSizeShouldBe);
					continue;
				}
				...
				if (_19$$20) {
					...
					zephir_array_fetch(&_20$$20, &parameters, &parameterToCheck, PH_NOISY, "phalcon/Acl/Adapter/Memory.zep", 674 TSRMLS_CC);
					_19$$20 = Z_TYPE_P(&_20$$20) == IS_OBJECT;
				}
				_21$$20 = _19$$20;
				if (_21$$20) {
					zephir_array_fetch(&_23$$20, &parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 674 TSRMLS_CC);
				...
				if (_21$$20) {
					...
					zephir_array_fetch(&_26$$23, &parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 676 TSRMLS_CC);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_24$$23, "phalcon/Acl/Adapter/Memory.zep", 677 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
			if (zephir_array_isset(&parameters, &parameterToCheck)) {
				zephir_array_fetch(&_30$$24, &parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 683 TSRMLS_CC);
				zephir_array_append(&parametersForFunction, &_30$$24, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 683);
			}
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&reflectionParameter);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_40$$17, "phalcon/Acl/Adapter/Memory.zep", 721 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allowOrDeny) {
	...
	if (!(zephir_array_isset(&_0, &roleName))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 1, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Acl/Adapter/Memory.zep", 761 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (!(zephir_array_isset(&_3, &componentName))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "phalcon/Acl/Adapter/Memory.zep", 765 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(access) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(access), _7$$5)
		{
			...
			if (!(zephir_array_isset(&accessList, &accessKey))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_8$$7, "phalcon/Acl/Adapter/Memory.zep", 775 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&accessName);
		zephir_is_iterable(access, 0, "phalcon/Acl/Adapter/Memory.zep", 788);
		...
		if (!ZEPHIR_IS_STRING(access, "*")) {
			...
			if (!(zephir_array_isset(&accessList, &accessKey))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_11$$12, "phalcon/Acl/Adapter/Memory.zep", 793 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, canAccess) {
	...
	zval *roleName_param = NULL, *componentName_param = NULL, *access_param = NULL, __$true, accessList, accessKey, checkRoleToInherit, checkRoleToInherits, usedRoleToInherits, usedRoleToInherit, _1, _2$$6, _3$$6, *_4$$6, _7$$8, _8$$13, _9$$13, *_10$$13;
	...
	if (zephir_array_isset(&_1, &roleName)) {
		...
		zephir_array_fetch(&_3$$6, &_2$$6, &roleName, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 847 TSRMLS_CC);
		zephir_is_iterable(&_3$$6, 0, "phalcon/Acl/Adapter/Memory.zep", 850);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3$$6), _4$$6)
		{
			ZEPHIR_INIT_NVAR(&usedRoleToInherit);
			ZVAL_COPY(&usedRoleToInherit, _4$$6);
			ZEPHIR_MAKE_REF(&checkRoleToInherits);
			ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_5, 85, &checkRoleToInherits, &usedRoleToInherit);
			ZEPHIR_UNREF(&checkRoleToInherits);
			zephir_check_call_status();
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&usedRoleToInherit);
		...
		while (1) {
			...
			ZEPHIR_MAKE_REF(&checkRoleToInherits);
			ZEPHIR_CALL_FUNCTION(&checkRoleToInherit, "array_shift", &_6, 14, &checkRoleToInherits);
			ZEPHIR_UNREF(&checkRoleToInherits);
			zephir_check_call_status();
			if (zephir_array_isset(&usedRoleToInherits, &checkRoleToInherit)) {
				continue;
			...
			zephir_read_property(&_7$$8, this_ptr, SL("roleInherits"), PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset(&_7$$8, &checkRoleToInherit)) {
				zephir_read_property(&_8$$13, this_ptr, SL("roleInherits"), PH_NOISY_CC | PH_READONLY);
				zephir_array_fetch(&_9$$13, &_8$$13, &checkRoleToInherit, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 884 TSRMLS_CC);
				zephir_is_iterable(&_9$$13, 0, "phalcon/Acl/Adapter/Memory.zep", 887);
