...
ZEPHIR_INIT_CLASS(Phalcon_Acl_Adapter_Memory)
{
	 ...
	 */
	{
		zval _zc0;
		ZVAL_NULL(&_zc0);
		zephir_declare_typed_property(phalcon_acl_adapter_memory_ce, SL("activeKey"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING|MAY_BE_NULL, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 256, &accessKey);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 257, &funcAccess);
	if (Z_TYPE_P(&haveAccess) == IS_NULL) {
		ZEPHIR_CALL_METHOD(&_11$$8, this_ptr, "buildkey", NULL, 240, roleName, componentName, &access_zv);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 256, &_11$$8);
		zephir_read_property_cached(&_12$$8, this_ptr, _zephir_prop_9, 261, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, canAccess)
{
	...
	if (zephir_array_isset_value(&_0, &roleName_zv)) {
		...
		zephir_array_fetch(&_2$$6, &_1$$6, &roleName_zv, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 886);
		zephir_is_iterable(&_2$$6, 0, "phalcon/Acl/Adapter/Memory.zep", 890);
		...
		while (1) {
			...
			ZEPHIR_OBS_NVAR(&checkRoleToInherit);
			zephir_array_fetch_long(&checkRoleToInherit, &checkRoleToInherits, pendingIndex, PH_NOISY, "phalcon/Acl/Adapter/Memory.zep", 900);
			pendingIndex++;
			if (zephir_array_isset_value(&usedRoleToInherits, &checkRoleToInherit)) {
				continue;
			}
			...
			if (zephir_array_isset_value(&_9$$9, &checkRoleToInherit)) {
				...
				zephir_array_fetch(&_11$$14, &_10$$14, &checkRoleToInherit, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 942);
				zephir_is_iterable(&_11$$14, 0, "phalcon/Acl/Adapter/Memory.zep", 945);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, checkExists)
{
	...
	if (1 != zephir_array_isset_value(&collection, &element_zv)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Acl/Adapter/Memory.zep", 967);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, invokeRule)
{
	...
	zephir_is_iterable(&reflectionParameters, 0, "phalcon/Acl/Adapter/Memory.zep", 1078);
	if (Z_TYPE_P(&reflectionParameters) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionParameters), _2)
		{
			...
			if (_3$$4) {
				...
				if (_8$$5) {
					hasRole = 1;
					zephir_array_append(&parametersForFunction, roleObject, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 1031);
				...
				if (_11$$5) {
					hasComponent = 1;
					zephir_array_append(&parametersForFunction, componentObject, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 1043);
					SEPARATE_ZVAL(&userParametersSizeShouldBe);
					zephir_decrement(&userParametersSizeShouldBe);
					continue;
				}
				...
				if (_12$$5) {
					zephir_array_fetch(&_13$$5, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1054);
					_12$$5 = Z_TYPE_P(&_13$$5) == IS_OBJECT;
				}
				_14$$5 = _12$$5;
				if (_14$$5) {
					zephir_array_fetch(&_16$$5, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1055);
				...
				if (UNEXPECTED(_14$$5)) {
					...
					zephir_array_fetch(&_19$$8, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1062);
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_17$$8, "phalcon/Acl/Adapter/Memory.zep", 1065);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
			if (zephir_array_isset_value(parameters, &parameterToCheck)) {
				zephir_array_fetch(&_24$$9, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1074);
				zephir_array_append(&parametersForFunction, &_24$$9, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 1074);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_27$$10) {
					...
					if (_34$$11) {
						zephir_array_fetch(&_35$$11, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1054);
						_34$$11 = Z_TYPE_P(&_35$$11) == IS_OBJECT;
					}
					_36$$11 = _34$$11;
					if (_36$$11) {
						zephir_array_fetch(&_38$$11, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1055);
					...
					if (UNEXPECTED(_36$$11)) {
						...
						zephir_array_fetch(&_41$$14, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1062);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_39$$14, "phalcon/Acl/Adapter/Memory.zep", 1065);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
				if (zephir_array_isset_value(parameters, &parameterToCheck)) {
					zephir_array_fetch(&_44$$15, parameters, &parameterToCheck, PH_NOISY | PH_READONLY, "phalcon/Acl/Adapter/Memory.zep", 1074);
					zephir_array_append(&parametersForFunction, &_44$$15, PH_SEPARATE, "phalcon/Acl/Adapter/Memory.zep", 1074);
				}
		}
	}
	ZEPHIR_INIT_NVAR(&reflectionParameter);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_54, "phalcon/Acl/Adapter/Memory.zep", 1119);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toComponentName)
{
	...
	if (Z_TYPE_P(component) == IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Acl/Adapter/Memory.zep", 1140);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toRoleName)
{
	...
	if (Z_TYPE_P(role) == IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Acl/Adapter/Memory.zep", 1164);
		ZEPHIR_MM_RESTORE();
		return;
	}
