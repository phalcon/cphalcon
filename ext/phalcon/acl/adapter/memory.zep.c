...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, __construct)
{
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("components", 10, 1);
	}
	if (UNEXPECTED(!_zephir_prop_2)) {
		_zephir_prop_2 = zend_string_init("componentsNames", 15, 1);
	}
	if (UNEXPECTED(!_zephir_prop_3)) {
		_zephir_prop_3 = zend_string_init("functions", 9, 1);
	}
	if (UNEXPECTED(!_zephir_prop_4)) {
		_zephir_prop_4 = zend_string_init("roleInherits", 12, 1);
	}
	if (UNEXPECTED(!_zephir_prop_5)) {
		_zephir_prop_5 = zend_string_init("roles", 5, 1);
	}
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 245, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 246, &_1);
	ZEPHIR_INIT_VAR(&_2);
	zephir_create_array(&_2, 1, 0);
	zephir_array_update_string(&_2, SL("*"), &__$true, PH_COPY | PH_SEPARATE);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 247, &_2);
	ZEPHIR_INIT_VAR(&_3);
	array_init(&_3);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 248, &_3);
	ZEPHIR_INIT_VAR(&_4);
	array_init(&_4);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 249, &_4);
	ZEPHIR_INIT_VAR(&_5);
	array_init(&_5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 250, &_5);
	ZEPHIR_INIT_VAR(&_6);
	zephir_create_array(&_6, 1, 0);
	zephir_array_update_string(&_6, SL("*!*"), &__$true, PH_COPY | PH_SEPARATE);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 251, &_6);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponent)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &componentObject, "__construct", NULL, 221, componentValue);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_METHOD(&componentName, &componentObject, "getname", NULL, 222);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponentAccess)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 223, &_0, &componentName_zv, &_1);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 224);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(accessList) == IS_ARRAY) {
		...
		if (Z_TYPE_P(accessList) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(accessList), _4$$4)
			{
				...
				ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 225, &componentName_zv, &accessName);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 225, &componentName_zv, accessList);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addInherit)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 223, &_0, &roleName_zv, &_1, &_2);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&roleToInheritList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&roleToInheritList), _5)
		{
			...
			zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_9$$6, this_ptr, _zephir_prop_0, 250, PH_NOISY_CC | PH_READONLY);
			if (UNEXPECTED(!(zephir_array_isset_value(&_9$$6, &roleInheritName)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_10$$10, "__construct", &_11, 226, &roleInheritName);
				zephir_check_call_status();
			...
			zephir_read_property_cached(&_12$$6, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset_value(&_12$$6, &roleInheritName)) {
				ZEPHIR_INIT_NVAR(&checkRoleToInherits);
				array_init(&checkRoleToInherits);
				zephir_read_property_cached(&_13$$12, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
				...
				if (Z_TYPE_P(&_14$$12) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_14$$12), _15$$12)
					{
						...
						ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_16, 227, &checkRoleToInherits, &usedRoleToInherit);
				...
				while (1) {
					...
					if (UNEXPECTED(ZEPHIR_IS_EQUAL(&roleName_zv, &checkRoleToInherit))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_19$$17, "__construct", &_20, 228, &roleInheritName);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_19$$17, "phalcon/Acl/Adapter/Memory.zep", 368);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_read_property_cached(&_21$$15, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
					if (zephir_array_isset_value(&_21$$15, &checkRoleToInherit)) {
						zephir_read_property_cached(&_22$$18, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_30$$21, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_32$$21, this_ptr, _zephir_prop_0, 250, PH_NOISY_CC | PH_READONLY);
				if (UNEXPECTED(!(zephir_array_isset_value(&_32$$21, &roleInheritName)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_33$$25, "__construct", &_11, 226, &roleInheritName);
					zephir_check_call_status();
				...
				zephir_read_property_cached(&_34$$21, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
				if (zephir_array_isset_value(&_34$$21, &roleInheritName)) {
					ZEPHIR_INIT_NVAR(&checkRoleToInherits);
					array_init(&checkRoleToInherits);
					zephir_read_property_cached(&_35$$27, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
					...
					while (1) {
						...
						if (UNEXPECTED(ZEPHIR_IS_EQUAL(&roleName_zv, &checkRoleToInherit))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_40$$32, "__construct", &_20, 228, &roleInheritName);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_40$$32, "phalcon/Acl/Adapter/Memory.zep", 368);
							ZEPHIR_MM_RESTORE();
							return;
						}
						zephir_read_property_cached(&_41$$30, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
						if (zephir_array_isset_value(&_41$$30, &checkRoleToInherit)) {
							zephir_read_property_cached(&_42$$33, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addRole)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &roleObject, "__construct", NULL, 229, role);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_1$$5);
		object_init_ex(&_1$$5, phalcon_acl_exceptions_invalidroletype_ce);
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 230);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$5, "phalcon/Acl/Adapter/Memory.zep", 414);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&roleName, &roleObject, "getname", NULL, 222);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 250, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allow)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &roleName_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 250, PH_NOISY_CC | PH_READONLY);
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&rolesArray), _2)
	{
		...
		ZVAL_COPY(&role, _2);
		ZVAL_LONG(&_3$$4, 1);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "allowordeny", &_4, 231, &role, &componentName_zv, access, &_3$$4, func);
		zephir_check_call_status();
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&role);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, dropComponentAccess)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&localAccess), _1)
	{
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_2, 225, &componentName_zv, &accessName);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "torolename", NULL, 232, roleName);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(roleName, &_2);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "tocomponentname", NULL, 233, componentName);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(componentName, &_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 252, roleName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 253, componentName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 254, &access_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 255, &__$null);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 256, &__$null);
	zephir_memory_observe(&accessList);
	zephir_read_property_cached(&accessList, this_ptr, _zephir_prop_5, 245, PH_NOISY_CC);
	zephir_memory_observe(&funcList);
	zephir_read_property_cached(&funcList, this_ptr, _zephir_prop_6, 248, PH_NOISY_CC);
	ZVAL_UNDEF(&_3);
	ZVAL_LONG(&_3, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 257, &_3);
	ZEPHIR_INIT_VAR(&_4);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_8, 250, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_value(&_3, roleName))) {
		zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_9, 258, PH_NOISY_CC | PH_READONLY);
		RETURN_MM_BOOL((ZEPHIR_IS_LONG(&_6$$6, 1)));
	}
	ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "canaccess", NULL, 234, roleName, componentName, &access_zv);
	zephir_check_call_status();
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 259, &_8);
	ZEPHIR_INIT_VAR(&_9);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_10, 259, PH_NOISY_CC);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 255, &accessKey);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 256, &funcAccess);
	if (Z_TYPE_P(&haveAccess) == IS_NULL) {
		ZEPHIR_CALL_METHOD(&_11$$8, this_ptr, "buildkey", NULL, 235, roleName, componentName, &access_zv);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 255, &_11$$8);
		zephir_read_property_cached(&_12$$8, this_ptr, _zephir_prop_9, 258, PH_NOISY_CC | PH_READONLY);
		RETURN_MM_BOOL(ZEPHIR_IS_LONG(&_12$$8, 1));
	}
	if (zephir_is_callable(&funcAccess)) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "invokerule", NULL, 236, &funcAccess, &haveAccess, &parameters, &roleObject, &componentObject, roleName, componentName, &access_zv);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, setNoArgumentsDefaultAction)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 260, &_0);
}
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allowOrDeny)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Role");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 223, &_0, &roleName_zv, &_1);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 247, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Component");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 223, &_2, &componentName_zv, &_1);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(access) == IS_ARRAY) {
		...
		if (Z_TYPE_P(access) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(access), _4$$3)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_7, 237, &accessName, &componentName_zv);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_10$$7, "__construct", &_7, 237, &accessName, &componentName_zv);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(access) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(access), _11$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildkey", &_12, 235, &roleName_zv, &componentName_zv, &accessName);
				zephir_check_call_status();
		...
		if (!ZEPHIR_IS_STRING(access, "*")) {
			ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildaccesskey", &_5, 225, &componentName_zv, access);
			zephir_check_call_status();
			if (UNEXPECTED(!(zephir_array_isset_value(&accessList, &accessKey)))) {
				ZEPHIR_INIT_VAR(&_15$$14);
				object_init_ex(&_15$$14, phalcon_acl_exceptions_accessrulenotfound_ce);
				ZEPHIR_CALL_METHOD(NULL, &_15$$14, "__construct", &_7, 237, access, &componentName_zv);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "buildkey", &_12, 235, &roleName_zv, &componentName_zv, access);
		zephir_check_call_status();
		zephir_update_property_array(this_ptr, SL("access"), &accessKey, action);
		if (Z_TYPE_P(func) != IS_NULL) {
			zephir_update_property_array(this_ptr, SL("functions"), &accessKey, func);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, canAccess)
{
	...
	ZVAL_STR_COPY(&access_zv, access);
	zephir_memory_observe(&accessList);
	zephir_read_property_cached(&accessList, this_ptr, _zephir_prop_0, 245, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_value(&_0, &roleName_zv)) {
		ZEPHIR_INIT_VAR(&checkRoleToInherits);
		array_init(&checkRoleToInherits);
		zephir_read_property_cached(&_1$$6, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&_2$$6) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2$$6), _3$$6)
			{
				...
				ZEPHIR_MAKE_REF(&checkRoleToInherits);
				ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_4, 227, &checkRoleToInherits, &usedRoleToInherit);
				ZEPHIR_UNREF(&checkRoleToInherits);
				zephir_check_call_status();
			} ZEND_HASH_FOREACH_END();
		} else {
		...
		while (1) {
			...
			zephir_read_property_cached(&_9$$9, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset_value(&_9$$9, &checkRoleToInherit)) {
				zephir_read_property_cached(&_10$$14, this_ptr, _zephir_prop_1, 249, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, invokeRule)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &reflectionFunction, "__construct", NULL, 238, funcAccess);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&reflectionParameters, &reflectionFunction, "getparameters", NULL, 239);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&numberOfRequiredParameters, &reflectionFunction, "getnumberofrequiredparameters", NULL, 240);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&reflectionParameters) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionParameters), _2)
		{
			...
			if (_3$$4) {
				...
				ZEPHIR_CALL_METHOD(NULL, &reflectionClass, "__construct", &_4, 241, &className);
				zephir_check_call_status();
				_5$$5 = Z_TYPE_P(roleObject) != IS_NULL;
				if (_5$$5) {
					ZEPHIR_CALL_METHOD(&_6$$5, &reflectionClass, "isinstance", &_7, 242, roleObject);
					zephir_check_call_status();
				...
				if (_9$$5) {
					ZEPHIR_CALL_METHOD(&_10$$5, &reflectionClass, "isinstance", &_7, 242, componentObject);
					zephir_check_call_status();
				...
				if (_14$$5) {
					...
					ZEPHIR_CALL_METHOD(&_15$$5, &reflectionClass, "isinstance", &_7, 242, &_16$$5);
					zephir_check_call_status();
				...
				if (UNEXPECTED(_14$$5)) {
					...
					ZEPHIR_CALL_METHOD(&_20$$8, &reflectionClass, "getname", &_21, 243);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_27$$10) {
					...
					if (_28$$11) {
						ZEPHIR_CALL_METHOD(&_29$$11, &reflectionClass, "isinstance", &_7, 242, roleObject);
						zephir_check_call_status();
					...
					if (_31$$11) {
						ZEPHIR_CALL_METHOD(&_32$$11, &reflectionClass, "isinstance", &_7, 242, componentObject);
						zephir_check_call_status();
					...
					if (_36$$11) {
						...
						ZEPHIR_CALL_METHOD(&_37$$11, &reflectionClass, "isinstance", &_7, 242, &_38$$11);
						zephir_check_call_status();
					...
					if (UNEXPECTED(_36$$11)) {
						...
						ZEPHIR_CALL_METHOD(&_42$$14, &reflectionClass, "getname", &_21, 243);
						zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&reflectionParameter);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 257, &userParametersSizeShouldBe);
	...
	if (ZEPHIR_IS_EMPTY(&parametersForFunction)) {
		if (UNEXPECTED(ZEPHIR_GT_LONG(&numberOfRequiredParameters, 0))) {
			...
			_48$$18 = haveAccess == 1;
			if (_48$$18) {
				zephir_read_property_cached(&_49$$18, this_ptr, _zephir_prop_1, 260, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toComponentName)
{
	...
	if (Z_TYPE_P(component) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 244);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, toRoleName)
{
	...
	if (Z_TYPE_P(role) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 245);
		zephir_check_call_status();
