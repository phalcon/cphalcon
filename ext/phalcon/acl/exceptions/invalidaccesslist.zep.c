...
PHP_METHOD(Phalcon_Acl_Exceptions_InvalidAccessList, __construct)
{
	zval _0;
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "Invalid value for the accessList");
	ZEPHIR_CALL_PARENT(NULL, phalcon_acl_exceptions_invalidaccesslist_ce, getThis(), "__construct", NULL, 0, &_0);
