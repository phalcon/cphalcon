...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setException)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 669, exception);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setExtras)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 670, extras);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setInput)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 671, input);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setMessages)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 672, messages);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setOutput)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 673, output);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Domain_Payload_Payload, setStatus)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 674, status);
	RETURN_THISW();
}
