...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 927, &option);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 928, &facility);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, process)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 929, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 929, &__$false);
	}
