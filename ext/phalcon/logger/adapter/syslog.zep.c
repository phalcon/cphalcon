...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 952, &name_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 953, &option);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 954, &facility);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, process)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 954, PH_NOISY_CC | PH_READONLY);
	...
	if (!zephir_is_true(&result)) {
		...
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 954, PH_NOISY_CC | PH_READONLY);
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 955, &__$true);
	} else {
