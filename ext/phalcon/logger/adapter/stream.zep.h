...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_logger_adapter_stream_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_logger_adapter_stream_method_entry) {
	...
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpFgetCsv, arginfo_phalcon_logger_adapter_stream_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpFileExists, arginfo_phalcon_logger_adapter_stream_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpFileGetContents, arginfo_phalcon_logger_adapter_stream_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpFilePutContents, arginfo_phalcon_logger_adapter_stream_phpfileputcontents, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpIsWritable, arginfo_phalcon_logger_adapter_stream_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Logger_Adapter_Stream, phpUnlink, arginfo_phalcon_logger_adapter_stream_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
