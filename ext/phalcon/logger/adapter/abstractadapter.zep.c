...
ZEPHIR_INIT_CLASS(Phalcon_Logger_Adapter_AbstractAdapter)
{
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_logger_adapter_abstractadapter_ce, SL("defaultFormatter"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		ZVAL_NULL(&_zc0);
		zephir_declare_typed_property(phalcon_logger_adapter_abstractadapter_ce, SL("formatter"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_NULL, SL("Phalcon\\Logger\\Formatter\\FormatterInterface"));
	}
	 ...
	 */
	{
		zval _zc0;
		ZVAL_BOOL(&_zc0, 0);
		zephir_declare_typed_property(phalcon_logger_adapter_abstractadapter_ce, SL("inTransaction"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_BOOL, NULL, 0);
	}
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_logger_adapter_abstractadapter_ce, SL("queue"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		ZVAL_LONG(&_zc0, 0);
		zephir_declare_typed_property(phalcon_logger_adapter_abstractadapter_ce, SL("queueLimit"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_LONG, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, __destruct)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("inTransaction", 13, 1);
	}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, add)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("queueLimit", 10, 1);
	}
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 123, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 122, PH_NOISY_CC | PH_READONLY);
	...
	if (_1) {
		...
		if (Z_TYPE_P(&firstKey) != IS_NULL) {
			...
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_1, 123, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, begin)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 121, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 121, &__$false);
	}
	RETURN_THIS();
}
...
{
	zend_bool _6;
	zval item, queue, _0, *_1, _2, *_3, _5;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checktransaction", NULL, 138);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&queue) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_2);
		zephir_string_to_char_array(&_2, &queue);
		_1 = &_2;
	} else {
		_1 = &queue;
	}
	...
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			...
			ZVAL_COPY(&item, _3);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "process", &_4, 0, &item);
			zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&item);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "resettransaction", NULL, 139);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, getFormatter)
{
	...
	static zend_string *_zephir_prop_1 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("formatter", 9, 1);
	}
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("defaultFormatter", 16, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 124, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, setFormatter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 124, formatter);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, resetTransaction)
{
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("inTransaction", 13, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 123, &_0);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 121, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 121, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
