...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, add)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *item, item_sub, firstKey, _0, _2, _3, _4$$3;
	zval *this_ptr = getThis();
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 128, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 127, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, begin)
{
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 138);
		zephir_check_call_status();
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 126, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 126, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, getFormatter)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_1$$3);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 130, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_LAST_CALL_STATUS = zephir_create_instance(&_1$$3, &_2$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 129, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, setFormatter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 129, formatter);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, checkTransaction)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 141);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, resetTransaction)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 128, &_0);
	if (0) {
