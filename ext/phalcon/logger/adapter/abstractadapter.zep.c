...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, __unserialize)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 129);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, commit)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checktransaction", NULL, 131);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&item);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "resettransaction", NULL, 132);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_AbstractAdapter, checkTransaction)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 133);
		zephir_check_call_status();
