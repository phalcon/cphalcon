...
PHP_METHOD(Phalcon_Logger_Adapter_Stream, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 870, &name_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 871, &mode);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Stream, close)
{
	...
	if (Z_TYPE_P(&_0) != IS_NULL) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&handler, &_1$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 872, &__$null);
...
PHP_METHOD(Phalcon_Logger_Adapter_Stream, process)
{
	...
	if (!(Z_TYPE_P(&_0) == IS_RESOURCE)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_2, 871, PH_NOISY_CC | PH_READONLY);
		...
		if (!(Z_TYPE_P(&fileHandler) == IS_RESOURCE)) {
			...
			zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_1, 870, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_2, 871, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 872, &fileHandler);
	}
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 872, PH_NOISY_CC | PH_READONLY);
