...
PHP_METHOD(Phalcon_Logger_Item, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 927, &levelName_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, level);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 928, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 929, dateTime);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 930, &context);
	ZEPHIR_MM_RESTORE();
}
