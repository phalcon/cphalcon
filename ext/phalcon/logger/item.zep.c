...
PHP_METHOD(Phalcon_Logger_Item, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 886, &message_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 887, &levelName_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, level);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 888, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 889, dateTime);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 890, &context);
	ZEPHIR_MM_RESTORE();
}
