...
PHP_METHOD(Phalcon_Logger_Formatter_Line, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 919, &format_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 920, &dateFormat_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 921, &interpolatorLeft_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 922, &interpolatorRight_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Formatter_Line, format)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 921, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 921, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_8);
	ZEPHIR_CONCAT_VSV(&_8, &_6, "level", &_7);
	ZEPHIR_CALL_METHOD(&_5, item, "getlevelname", NULL, 0);
	zephir_check_call_status();
	zephir_array_update_zval(&_1, &_8, &_5, PH_COPY);
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_1, 921, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_2, 922, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
