...
PHP_METHOD(Phalcon_Logger_Formatter_Json, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 937, &dateFormat_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 938, &interpolatorLeft_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 939, &interpolatorRight_zv);
	ZEPHIR_MM_RESTORE();
}
