...
PHP_METHOD(Phalcon_Logger_Formatter_Json, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 938, &dateFormat_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 939, &interpolatorLeft_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 940, &interpolatorRight_zv);
	ZEPHIR_MM_RESTORE();
}
