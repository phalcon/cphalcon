...
PHP_METHOD(Phalcon_Logger_AdapterFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 930, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_AdapterFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 931, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_AdapterFactory, init)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 931, &_0);
	ZEPHIR_MM_RESTORE();
}
