...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Logger, AdapterFactory, phalcon, logger_adapterfactory, phalcon_logger_adapterfactory_method_entry, 0);
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_logger_adapterfactory_ce, SL("instances"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_logger_adapterfactory_ce, SL("mapper"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_ARRAY, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Logger_AdapterFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 934, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Logger_AdapterFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 935, PH_NOISY_CC | PH_READONLY);
