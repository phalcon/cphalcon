...
ZEPHIR_INIT_CLASS(phalcon_79__closure)
{
	ZEPHIR_REGISTER_CLASS(phalcon, 79__closure, phalcon, 79__closure, phalcon_79__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	zend_declare_property_null(phalcon_79__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC);
	zend_declare_property_null(phalcon_79__closure_ce, SL("__$zephir_this"), ZEND_ACC_PUBLIC);
	return SUCCESS;
}
