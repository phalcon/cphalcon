...
ZEPHIR_INIT_CLASS(phalcon_18__closure)
{
	...
	zend_declare_property_null(phalcon_18__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(phalcon_18__closure, __invoke)
{
	...
	zephir_read_static_property_ce(&escaper, phalcon_18__closure_ce, SL("escaper"), PH_NOISY_CC);
