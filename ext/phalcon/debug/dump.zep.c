...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _5$$4, _6$$4, _4$$4)
		{
			...
			ZVAL_LONG(&_7$$5, tab);
			ZEPHIR_CALL_FUNCTION(&_8$$5, "str_repeat", &_9, 144, &space, &_7$$5);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_23$$4, "str_repeat", &_9, 144, &space, &_22$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_25$$8, "strtr", NULL, 66, &_26$$8, &_24$$8);
		zephir_check_call_status();
		...
		if (zephir_is_true(&_27$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_29$$9, "strtr", NULL, 66, &_30$$9, &_28$$9);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_34$$10, "str_repeat", &_9, 144, &space, &_33$$10);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_36$$11), _38$$11, _39$$11, _37$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_41$$12, "str_repeat", &_9, 144, &space, &_40$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_43$$12, "strtr", NULL, 66, &_44$$12, &_42$$12);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&props$$13, &reflect$$13, "getproperties", NULL, 102, &_48$$13);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&props$$13), _49$$13)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_59$$14, "str_repeat", &_9, 144, &space, &_50$$14);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_61$$14, "strtr", NULL, 66, &_62$$14, &_60$$14);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_71$$8, "strtr", NULL, 66, &_26$$8, &_70$$8);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&_26$$8, &_68$$8 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_74$$15, "str_repeat", &_9, 144, &space, &_73$$15);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _76$$16)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_79$$18, "str_repeat", &_9, 144, &space, &_78$$18);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_81$$18, "strtr", NULL, 66, &_82$$18, &_80$$18);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_85$$19, "str_repeat", &_9, 144, &space, &_84$$19);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_87$$19, "strtr", NULL, 66, &_88$$19, &_86$$19);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_91$$16, "str_repeat", &_9, 144, &space, &_90$$16);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_94$$8, "str_repeat", &_9, 144, &space, &_93$$8);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_96$$20, "strtr", NULL, 66, &_97$$20, &_95$$20);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_103$$22, "strtr", NULL, 66, &_104$$22, &_102$$22);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_109$$23, "strtr", NULL, 66, &_107$$23, &_105$$23);
		zephir_check_call_status();
	...
	if ((Z_TYPE_P(variable) == IS_TRUE || Z_TYPE_P(variable) == IS_FALSE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_111$$24, "strtr", NULL, 66, &_112$$24, &_110$$24);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_115$$25, "strtr", NULL, 66, &_116$$25, &_114$$25);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_118, "strtr", NULL, 66, &_119, &_117);
	zephir_check_call_status();
