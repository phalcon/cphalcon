...
PHP_METHOD(Phalcon_Debug_Dump, all) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "func_get_args", NULL, 162);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$4, "strtr", &_6, 54, &_5$$4, _1$$4);
		zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_8$$4, &_7$$4)
			...
			ZEPHIR_CALL_FUNCTION(&_14$$5, "strtr", &_6, 54, &_10$$5, _13$$5);
			zephir_check_call_status();
			...
			if (_19$$5) {
				...
				ZEPHIR_CALL_METHOD(&_20$$7, this_ptr, "output", &_23, 163, value, _21$$7, _22$$7);
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_30$$8, "get_parent_class", &_31, 164, variable);
		zephir_check_call_status();
		if (zephir_is_true(_30$$8)) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$9, "get_parent_class", &_31, 164, variable);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_33$$9, "strtr", &_6, 54, &_35$$9, _32$$9);
			zephir_check_call_status();
		...
		if (!(zephir_is_true(_36$$8))) {
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_39$$10, &_38$$10)
				...
				ZEPHIR_CALL_METHOD(&_47$$11, this_ptr, "output", &_23, 163, value, _45$$11, _48$$11);
				zephir_check_temp_parameter(_45$$11);
				zephir_check_call_status();
			...
			do {
				...
				ZEPHIR_CALL_FUNCTION(&attr, "each", &_50, 165, variable);
				...
				ZEPHIR_MAKE_REF(key);
				ZEPHIR_CALL_FUNCTION(&_60$$13, "end", &_61, 166, key);
				ZEPHIR_UNREF(key);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_63$$13, this_ptr, "output", &_23, 163, value, _51$$13, _64$$13);
				zephir_check_temp_parameter(_51$$13);
				zephir_check_call_status();
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_75$$19, &_74$$19)
				...
				if (ZEPHIR_IS_STRING(value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_81$$21, "strtr", &_6, 54, &_78$$21, _80$$21);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_87$$22, "strtr", &_6, 54, &_84$$22, _86$$22);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_95$$23, "strtr", &_6, 54, &_97$$23, _94$$23);
		zephir_check_call_status();
	...
	if (zephir_is_true(_98)) {
		...
		ZEPHIR_CALL_FUNCTION(&_100$$24, "strtr", &_6, 54, &_102$$24, _99$$24);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_104$$25, "strtr", &_6, 54, &_106$$25, _103$$25);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_108$$26, "htmlentities", NULL, 148, variable, &_110$$26, &_111$$26);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_112$$26, "nl2br", NULL, 169, _108$$26);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_112$$26, "strtr", &_6, 54, &_110$$26, _107$$26);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_BOOL) {
		...
		ZEPHIR_CALL_FUNCTION(&_114$$27, "strtr", &_6, 54, &_117$$27, _113$$27);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_119$$28, "strtr", &_6, 54, &_121$$28, _118$$28);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_123, "strtr", &_6, 54, &_125, _122);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug_Dump, variables) {
	...
	ZEPHIR_INIT_VAR(output);
	ZVAL_STRING(output, "", 1);
	ZEPHIR_CALL_FUNCTION(&_0, "func_get_args", NULL, 162);
	zephir_check_call_status();
