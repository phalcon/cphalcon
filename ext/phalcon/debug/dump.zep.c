...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _5$$4, _6$$4, _4$$4)
		{
			...
			ZVAL_LONG(&_7$$5, tab);
			ZEPHIR_CALL_FUNCTION(&_8$$5, "str_repeat", &_9, 141, &space, &_7$$5);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_23$$4, "str_repeat", &_9, 141, &space, &_22$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_34$$10, "str_repeat", &_9, 141, &space, &_33$$10);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_36$$11), _38$$11, _39$$11, _37$$11)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_41$$12, "str_repeat", &_9, 141, &space, &_40$$12);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &reflect$$13, "__construct", NULL, 95, variable);
			zephir_check_call_status();
			ZVAL_LONG(&_48$$13, ((256 | 512) | 1024));
			ZEPHIR_CALL_METHOD(&props$$13, &reflect$$13, "getproperties", NULL, 99, &_48$$13);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&props$$13), _49$$13)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_59$$14, "str_repeat", &_9, 141, &space, &_50$$14);
				zephir_check_call_status();
		...
		if (zephir_fast_in_array(&_26$$8, &_68$$8 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_74$$15, "str_repeat", &_9, 141, &space, &_73$$15);
			zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _76$$16)
			{
				...
				if (ZEPHIR_IS_STRING(&value, "__construct")) {
					...
					ZEPHIR_CALL_FUNCTION(&_79$$18, "str_repeat", &_9, 141, &space, &_78$$18);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_85$$19, "str_repeat", &_9, 141, &space, &_84$$19);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_91$$16, "str_repeat", &_9, 141, &space, &_90$$16);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_94$$8, "str_repeat", &_9, 141, &space, &_93$$8);
		zephir_check_call_status();
