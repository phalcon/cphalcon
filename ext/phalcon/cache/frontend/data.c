...
ZEPHIR_INIT_CLASS(Phalcon_Cache_Frontend_Data) {
	...
	ZEPHIR_REGISTER_CLASS(Phalcon\\Cache\\Frontend, phalcon, Data, cache_frontend_data, phalcon_cache_frontend_data_method_entry, 0);

	zend_declare_property_null(phalcon_cache_frontend_data_ce, SL("_frontendOptions"), ZEND_ACC_PUBLIC TSRMLS_CC);
