...
PHP_METHOD(Phalcon_Cache_Backend_Redis, _connect) {
	...
	if (zephir_array_isset_string_fetch(&index, &options, SL("index"), 0)) {
...
PHP_METHOD(Phalcon_Cache_Backend_Redis, get) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *keyName, keyName_sub, *lifetime = NULL, lifetime_sub, __$null, redis, frontend, prefix, lastKey, cachedContent;
	ZEPHIR_INIT_THIS();
...
PHP_METHOD(Phalcon_Cache_Backend_Redis, save) {
	...
	zval *keyName = NULL, keyName_sub, *content = NULL, content_sub, *lifetime = NULL, lifetime_sub, *stopBuffer_param = NULL, __$true, __$false, __$null, prefixedKey, lastKey, prefix, frontend, redis, cachedContent, preparedContent, tmp, tt1, success, options, specialKey, isBuffering, _0$$3;
	ZEPHIR_INIT_THIS();
