...
PHP_METHOD(Phalcon_Cache_Backend_File, get) {
	...
	if ((zephir_file_exists(&cacheFile TSRMLS_CC) == SUCCESS) == 1) {
		...
		if (!(zephir_is_true(lifetime))) {
			...
			ZEPHIR_CALL_METHOD(&_5$$6, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_6$$6);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_10$$5);
		zephir_check_call_status();
		...
		if (!((zephir_get_numberval(&_10$$5) - ttl) > createdTime)) {
			...
			ZEPHIR_CALL_METHOD(&_13$$14, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_14$$14);
			zephir_check_call_status();
	...
	if (zephir_is_true(&lastKey)) {
		...
		if (cacheFileExists) {
			...
			if (!(lifetime)) {
				...
				ZEPHIR_CALL_METHOD(&_4$$7, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_5$$7);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_9$$6, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_10$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_File, increment) {
	...
	if ((zephir_file_exists(&cacheFile TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_6$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_9$$3, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_6$$3);
		zephir_check_call_status();
		...
		if (!((zephir_get_numberval(&_6$$3) - ttl) > modifiedTime)) {
			...
			ZEPHIR_CALL_METHOD(&_12$$10, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_13$$10);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cache_Backend_File, decrement) {
	...
	if ((zephir_file_exists(&cacheFile TSRMLS_CC) == SUCCESS)) {
		...
		if (!(lifetime)) {
			...
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_6$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_11$$3);
		zephir_check_call_status();
		...
		if (!((zephir_get_numberval(&_11$$3) - ttl) > modifiedTime)) {
			...
			ZEPHIR_CALL_METHOD(&_14$$12, this_ptr, "isvalidarray", NULL, 99, &cachedContent, &_15$$12);
			zephir_check_call_status();
