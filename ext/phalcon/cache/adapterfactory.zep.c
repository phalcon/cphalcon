...
PHP_METHOD(Phalcon_Cache_AdapterFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 486, serializerFactory);
...
PHP_METHOD(Phalcon_Cache_AdapterFactory, newInstance)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 486, PH_NOISY_CC);
