...
PHP_METHOD(Phalcon_Cache_AbstractCache, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 260, adapter);
}
...
PHP_METHOD(Phalcon_Cache_AbstractCache, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 261, eventsManager);
}
...
PHP_METHOD(Phalcon_Cache_AbstractCache, doGetMultiple)
{
	...
	zephir_read_property_cached(&adapterClass, this_ptr, _zephir_prop_0, 260, PH_NOISY_CC);
	if (zephir_instance_of_ev(&adapterClass, phalcon_cache_adapter_redis_ce)) {
		...
		ZEPHIR_INIT_NVAR(&element);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 260, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&serializer, &_5$$3, "getserializer", NULL, 0);
		zephir_check_call_status();
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 260, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_CALL_FUNCTION(&_9$$3, "array_combine", NULL, 244, &keysArray, &results);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&results, &_9$$3);
	} else {
...
PHP_METHOD(Phalcon_Cache_AbstractCache, fire)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 261, PH_NOISY_CC | PH_READONLY);
	ZVAL_BOOL(&_2, 0);
