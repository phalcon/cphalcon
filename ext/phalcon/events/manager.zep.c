...
PHP_METHOD(Phalcon_Events_Manager, clearSubscribers)
{
	...
	zephir_read_property_cached(&snapshot, this_ptr, _zephir_prop_0, 721, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Events_Manager, collectResponses)
{
	...
	if (collect) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 722, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 722, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Events_Manager, detach)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&queue, &_2, &eventType_zv, 0)) {
		...
		if (!(ZEPHIR_IS_EMPTY(&newQueue))) {
			...
			zephir_read_property_cached(&_8$$10, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, detachAll)
{
	...
	if (ZEPHIR_IS_NULL(&type_zv)) {
		...
		array_init(&_0$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 723, &_0$$3);
	} else {
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_value(&_1$$4, &type_zv)) {
			zephir_unset_property_array(this_ptr, ZEND_STRL("events"), &type_zv);
			zephir_read_property_cached(&_2$$5, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, dispatch)
{
	...
	if (_4) {
		zephir_memory_observe(&queue);
		zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 723, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, fire)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_EMPTY(&_3)) {
		zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_2, 726, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_3, 727, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	hasTypeQueue = zephir_array_isset_value(&_12, &type);
	zephir_read_property_cached(&_13, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	...
	if (_14) {
		zephir_read_property_cached(&_15$$10, this_ptr, _zephir_prop_2, 726, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&wasDepth, this_ptr, _zephir_prop_4, 728, PH_NOISY_CC);
	ZVAL_UNDEF(&_17);
	ZVAL_LONG(&_17, (zephir_get_numberval(&wasDepth) + 1));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 728, &_17);
	zephir_read_property_cached(&_17, this_ptr, _zephir_prop_5, 722, PH_NOISY_CC | PH_READONLY);
	collect = zephir_is_true(&_17);
	if (collect) {
		if (ZEPHIR_GT_LONG(&wasDepth, 0)) {
			zephir_memory_observe(&stashed);
			zephir_read_property_cached(&stashed, this_ptr, _zephir_prop_6, 729, PH_NOISY_CC);
		}
		ZEPHIR_INIT_VAR(&_18$$12);
		array_init(&_18$$12);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 729, &_18$$12);
	}
	...
	/* try_start_1: */
		...
		ZVAL_NULL(&status);
		if (hasTypeQueue) {
			zephir_read_property_cached(&_20$$15, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_23$$14, this_ptr, _zephir_prop_7, 730, PH_NOISY_CC);
		...
		if (_27$$14) {
			zephir_read_property_cached(&_30$$16, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_33, SL("Throwable"))) {
			...
			if (_34$$17) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 729, &stashed);
			}
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 728, &wasDepth);
...
PHP_METHOD(Phalcon_Events_Manager, fireAll)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_EMPTY(&_1)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_2, 726, PH_NOISY_CC | PH_READONLY);
	...
	zephir_memory_observe(&cached);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 727, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	hasTypeQueue = zephir_array_isset_value(&_10, &type);
	zephir_read_property_cached(&_11, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
	...
	if (_12) {
		zephir_read_property_cached(&_13$$9, this_ptr, _zephir_prop_2, 726, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 728, &_15);
	zephir_memory_observe(&stashed);
	zephir_read_property_cached(&stashed, this_ptr, _zephir_prop_5, 729, PH_NOISY_CC);
	ZEPHIR_INIT_VAR(&_16);
	array_init(&_16);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 729, &_16);
	...
	/* try_start_1: */
		...
		if (hasTypeQueue) {
			zephir_read_property_cached(&_18$$12, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
			zephir_memory_observe(&fireEvents);
		...
		zephir_read_property_cached(&_21$$11, this_ptr, _zephir_prop_6, 730, PH_NOISY_CC);
		...
		if (_25$$11) {
			zephir_read_property_cached(&_28$$13, this_ptr, _zephir_prop_1, 723, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_OBS_NVAR(&fireEvents);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_31, SL("Throwable"))) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 729, &stashed);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 728, &wasDepth);
	...
	zephir_read_property_cached(&_15, this_ptr, _zephir_prop_5, 729, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, fireQueue)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 722, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, removeSubscriber)
{
	...
	zephir_get_class(&className, subscriber, 0);
	zephir_memory_observe(&events);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 720, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, setStopOnFalse)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 730, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 730, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Events_Manager, runQueue)
{
	...
	if (queueSize == 1) {
		...
		if (ZEPHIR_IS_LONG(&type, 0)) {
			...
			zephir_read_property_cached(&_0$$6, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
			...
			if (!(zephir_array_isset_value(&_1$$6, &eventName_zv))) {
				zephir_read_property_cached(&_2$$7, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
				_3$$7 = !(zephir_array_isset_value(&_2$$7, &handlerClass));
				if (_3$$7) {
					zephir_read_property_cached(&_4$$7, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
					_3$$7 = ZEPHIR_GT_LONG(&_4$$7, 0);
				}
				_5$$7 = _3$$7;
				if (_5$$7) {
					zephir_read_property_cached(&_6$$7, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_7$$7, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
					_5$$7 = ZEPHIR_LE_LONG(&_7$$7, zephir_fast_count_int(&_6$$7));
				}
				if (_5$$7) {
					ZEPHIR_INIT_VAR(&_8$$8);
					array_init(&_8$$8);
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 732, &_8$$8);
				}
				ZEPHIR_INIT_VAR(&_9$$7);
			...
			zephir_read_property_cached(&_10$$6, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_2, 730, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&queue) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&queue), _17)
		{
			...
			if (ZEPHIR_IS_LONG(&type, 0)) {
				...
				zephir_read_property_cached(&_18$$16, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
				...
				if (!(zephir_array_isset_value(&_19$$16, &eventName_zv))) {
					zephir_read_property_cached(&_20$$17, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
					_21$$17 = !(zephir_array_isset_value(&_20$$17, &handlerClass));
					if (_21$$17) {
						zephir_read_property_cached(&_22$$17, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
						_21$$17 = ZEPHIR_GT_LONG(&_22$$17, 0);
					}
					_23$$17 = _21$$17;
					if (_23$$17) {
						zephir_read_property_cached(&_24$$17, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
						zephir_read_property_cached(&_25$$17, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
						_23$$17 = ZEPHIR_LE_LONG(&_25$$17, zephir_fast_count_int(&_24$$17));
					}
					if (_23$$17) {
						ZEPHIR_INIT_NVAR(&_26$$18);
						array_init(&_26$$18);
						zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 732, &_26$$18);
					}
				...
				zephir_read_property_cached(&_28$$16, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_32$$13, this_ptr, _zephir_prop_2, 730, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_LONG(&type, 0)) {
					...
					ZEPHIR_OBS_NVAR(&handlerClass);
					zephir_array_fetch_long(&handlerClass, &tuple, 3, PH_NOISY, "phalcon/Events/Manager.zep", 1076);
					zephir_read_property_cached(&_39$$28, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
					...
					if (!(zephir_array_isset_value(&_40$$28, &eventName_zv))) {
						zephir_read_property_cached(&_41$$29, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
						_42$$29 = !(zephir_array_isset_value(&_41$$29, &handlerClass));
						if (_42$$29) {
							zephir_read_property_cached(&_43$$29, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
							_42$$29 = ZEPHIR_GT_LONG(&_43$$29, 0);
						}
						_44$$29 = _42$$29;
						if (_44$$29) {
							zephir_read_property_cached(&_45$$29, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
							zephir_read_property_cached(&_46$$29, this_ptr, _zephir_prop_1, 731, PH_NOISY_CC | PH_READONLY);
							_44$$29 = ZEPHIR_LE_LONG(&_46$$29, zephir_fast_count_int(&_45$$29));
						}
						if (_44$$29) {
							ZEPHIR_INIT_NVAR(&_47$$30);
							array_init(&_47$$30);
							zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 732, &_47$$30);
						}
					...
					zephir_read_property_cached(&_49$$28, this_ptr, _zephir_prop_0, 732, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_53$$25, this_ptr, _zephir_prop_2, 730, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Events_Manager, insertHandlerEntry)
{
	...
	zephir_read_property_cached(&prioritiesOn, this_ptr, _zephir_prop_0, 724, PH_NOISY_CC);
