...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 729, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 730, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 731, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 732, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 732, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 733, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 733, &__$false);
	}
	RETURN_THIS();
}
