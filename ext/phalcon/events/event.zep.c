...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 716, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 717, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 718, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 719, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 719, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 718, data);
	RETURN_THISW();
}
