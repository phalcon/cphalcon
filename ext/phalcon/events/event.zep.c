...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 727, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 728, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 729, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 730, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 730, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 731, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 731, &__$false);
	}
	RETURN_THIS();
}
