...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 671, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 672, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 673, data);
	if (cancelable) {
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 673, data);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 675, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 675, &__$false);
	}
	RETURN_THIS();
}
