...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 678, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 679, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 680, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 681, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 681, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 680, data);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 682, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 682, &__$false);
	}
	RETURN_THIS();
}
