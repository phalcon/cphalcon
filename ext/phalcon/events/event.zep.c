...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 709, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 710, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 711, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 712, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 712, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 711, data);
	RETURN_THISW();
}
