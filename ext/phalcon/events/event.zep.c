...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 708, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 709, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 710, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 711, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 711, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 710, data);
	RETURN_THISW();
}
