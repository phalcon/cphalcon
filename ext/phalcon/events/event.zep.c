...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zval type_zv, *source = NULL, source_sub, *data = NULL, data_sub, *cancelable_param = NULL, __$true, __$false, __$null, _1$$3, _2$$3;
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 712, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 713, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 714, data);
	if (cancelable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 715, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 715, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 714, data);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 716, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 716, &__$false);
	}
	RETURN_THIS();
}
