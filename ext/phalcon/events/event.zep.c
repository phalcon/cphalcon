...
PHP_METHOD(Phalcon_Events_Event, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 672, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 673, source);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 674, data);
	if (cancelable) {
...
PHP_METHOD(Phalcon_Events_Event, setData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 674, data);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Events_Event, stop)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 676, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 676, &__$false);
	}
	RETURN_THIS();
}
