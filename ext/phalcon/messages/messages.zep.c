...
PHP_METHOD(Phalcon_Messages_Messages, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 974, &messages);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Messages_Messages, appendMessages)
{
	...
	if (_0) {
		...
		zephir_throw_exception_debug(&_2$$3, "phalcon/Messages/Messages.zep", 84);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_memory_observe(&currentMessages);
	zephir_read_property_cached(&currentMessages, this_ptr, _zephir_prop_0, 974, PH_NOISY_CC);
	if (Z_TYPE_P(messages) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&finalMessages);
		zephir_fast_array_merge(&finalMessages, &currentMessages, messages);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 974, &finalMessages);
	} else {
...
PHP_METHOD(Phalcon_Messages_Messages, filter)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/Messages/Messages.zep", 138);
...
PHP_METHOD(Phalcon_Messages_Messages, jsonSerialize)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/Messages/Messages.zep", 161);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_1), _3)
		{
			ZEPHIR_INIT_NVAR(&message);
...
PHP_METHOD(Phalcon_Messages_Messages, current)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 975, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Messages_Messages, valid)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 974, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 975, PH_NOISY_CC | PH_READONLY);
