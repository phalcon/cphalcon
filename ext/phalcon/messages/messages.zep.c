...
PHP_METHOD(Phalcon_Messages_Messages, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 943, &messages);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Messages_Messages, appendMessages)
{
	...
	zephir_read_property_cached(&currentMessages, this_ptr, _zephir_prop_0, 943, PH_NOISY_CC);
	if (Z_TYPE_P(messages) == IS_ARRAY) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 943, &finalMessages);
	} else {
...
PHP_METHOD(Phalcon_Messages_Messages, current)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 944, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Messages_Messages, rewind)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 944, &_0);
}
...
PHP_METHOD(Phalcon_Messages_Messages, valid)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 943, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 944, PH_NOISY_CC | PH_READONLY);
