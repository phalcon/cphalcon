...
PHP_METHOD(Phalcon_Messages_Message, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 933, &field_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 934, &type_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, code);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 935, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 936, &metaData);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Messages_Message, jsonSerialize)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 933, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("field"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 932, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("message"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 934, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("type"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 935, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("code"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 936, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Messages_Message, setField)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&field_zv, field);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 933, &field_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Messages_Message, setMetaData)
{
	...
	zephir_get_arrval(&metaData, metaData_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 936, &metaData);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Messages_Message, setType)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&type_zv, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 934, &type_zv);
	RETURN_THISW();
}
