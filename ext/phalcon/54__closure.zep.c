...
ZEPHIR_INIT_CLASS(phalcon_54__closure)
{
	...
	zend_declare_property_null(phalcon_54__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC);
	zend_declare_property_null(phalcon_54__closure_ce, SL("__$zephir_this"), ZEND_ACC_PUBLIC);
	return SUCCESS;
}
