...
PHP_METHOD(Phalcon_Flash_AbstractFlash, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 197, escaper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 198, session);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 199, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 200, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, clear)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 201, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, getEscaperService)
{
	...
	if (_2) {
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_1, 202, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_8$$4);
		ZVAL_STRING(&_8$$4, "escaper");
		ZEPHIR_CALL_METHOD(&_7$$4, &_6$$4, "getshared", NULL, 0, &_8$$4);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 197, &_7$$4);
		RETURN_MM_MEMBER(getThis(), "escaperService");
	}
	ZEPHIR_INIT_NVAR(&_5);
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, setAutomaticHtml)
{
	...
	if (automaticHtml) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 204, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 204, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, setCssClasses)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 200, &cssClasses);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, setCssIconClasses)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 205, &cssIconClasses);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, setCustomTemplate)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 206, &customTemplate_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, setEscaperService)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 197, escaperService);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, getTemplate)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 206, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 199, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, prepareHtmlMessage)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 200, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&cssClasses, this_ptr, "checkclasses", NULL, 193, &_1, &type_zv);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 205, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&cssIconClasses, this_ptr, "checkclasses", NULL, 193, &_2, &type_zv);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_3, 199, PH_NOISY_CC | PH_READONLY);
