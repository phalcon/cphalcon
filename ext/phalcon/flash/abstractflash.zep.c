...
PHP_METHOD(Phalcon_Flash_AbstractFlash, getEscaperService)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 195);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, outputMessage)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval type_zv, *message = NULL, message_sub, content, html, item, prepared, *_3, _4, *_5, _9, _1$$3, _2$$4, _8$$5, _11$$8;
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 196);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(message) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_4);
		zephir_string_to_char_array(&_4, message);
		_3 = &_4;
	} else {
		_3 = message;
	}
	zephir_is_iterable(_3, 0, "phalcon/Flash/AbstractFlash.zep", 227);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_0, 206, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&html, this_ptr, "preparehtmlmessage", &_7, 198, &type_zv, &prepared);
				zephir_check_call_status();
				zephir_read_property_cached(&_11$$8, this_ptr, _zephir_prop_0, 206, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Flash_AbstractFlash, prepareHtmlMessage)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 203, PH_NOISY_CC | PH_READONLY);
