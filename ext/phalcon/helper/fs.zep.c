...
PHP_METHOD(Phalcon_Helper_Fs, basename) {
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "@");
	ZEPHIR_CALL_FUNCTION(&_4, "preg_quote", NULL, 265, &_2, &_3);
	...
	if (zephir_is_true(&_2)) {
		...
		zephir_array_fetch_long(&filename, &matches, 0, PH_NOISY, "/home/nikos/Work/niden/cphalcon/phalcon/Helper/Fs.zep", 37);
	} else {
	...
	if (zephir_is_true(suffix)) {
		...
		ZVAL_STRING(&_6$$3, "@");
		ZEPHIR_CALL_FUNCTION(&_7$$3, "preg_quote", NULL, 265, suffix, &_6$$3);
		zephir_check_call_status();
