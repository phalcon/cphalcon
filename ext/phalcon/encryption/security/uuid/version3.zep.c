...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version3, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&hash, "md5", NULL, 289, &_1, &__$true);
	zephir_check_call_status();
	ZVAL_LONG(&_2, 6);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_INIT_VAR(&_4);
	zephir_substr(&_4, &hash, 6 , 1 , 0);
	ZEPHIR_CALL_FUNCTION(&_5, "ord", NULL, 247, &_4);
	zephir_check_call_status();
	ZVAL_LONG(&_6, (((int) (zephir_get_numberval(&_5)) & 0x0f) | 0x30));
	ZEPHIR_CALL_FUNCTION(&_7, "chr", NULL, 246, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 6);
	ZVAL_LONG(&_8, 1);
	ZEPHIR_CALL_FUNCTION(&_9, "substr_replace", NULL, 290, &hash, &_7, &_6, &_8);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "ord", NULL, 247, &_10);
	zephir_check_call_status();
	ZVAL_LONG(&_11, (((int) (zephir_get_numberval(&_9)) & 0x3f) | 0x80));
	ZEPHIR_CALL_FUNCTION(&_12, "chr", NULL, 246, &_11);
	zephir_check_call_status();
	ZVAL_LONG(&_11, 8);
	ZVAL_LONG(&_13, 1);
	ZEPHIR_CALL_FUNCTION(&_14, "substr_replace", NULL, 290, &hash, &_12, &_11, &_13);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&hash, &_14);
	ZEPHIR_CALL_FUNCTION(&_15, "bin2hex", NULL, 280, &hash);
	zephir_check_call_status();
