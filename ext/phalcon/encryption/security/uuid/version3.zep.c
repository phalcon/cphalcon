...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version3, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&_5, "ord", NULL, 495, &_4);
	zephir_check_call_status();
	ZVAL_LONG(&_6, (((int) (zephir_get_numberval(&_5)) & 0x0f) | 0x30));
	ZEPHIR_CALL_FUNCTION(&_7, "chr", NULL, 494, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 6);
	ZVAL_LONG(&_8, 1);
	...
	ZEPHIR_CALL_FUNCTION(&_9, "ord", NULL, 495, &_10);
	zephir_check_call_status();
	ZVAL_LONG(&_11, (((int) (zephir_get_numberval(&_9)) & 0x3f) | 0x80));
	ZEPHIR_CALL_FUNCTION(&_12, "chr", NULL, 494, &_11);
	zephir_check_call_status();
	ZVAL_LONG(&_11, 8);
	ZVAL_LONG(&_13, 1);
