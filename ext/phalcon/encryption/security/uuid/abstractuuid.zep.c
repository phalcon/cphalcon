...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_AbstractUuid, uuidTimestampToDateTime)
{
	...
	ZVAL_STRING(&_4, "0");
	ZVAL_LONG(&_2, 0);
	ZEPHIR_CALL_FUNCTION(&_5, "str_pad", NULL, 35, &usec, &_0, &_4, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
