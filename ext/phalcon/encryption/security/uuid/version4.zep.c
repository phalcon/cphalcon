...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version4, __construct)
{
	...
	ZVAL_LONG(&_0, 16);
	ZEPHIR_CALL_FUNCTION(&_1, "random_bytes", NULL, 334, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "N1a/n1b/n1c/n1d/n1e/N1f");
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 485, &_2, &_1);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 668, &_7);
	ZEPHIR_MM_RESTORE();
}
