...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version7, __construct)
{
	...
	ZVAL_LONG(&_2, 10);
	ZEPHIR_CALL_FUNCTION(&randBytes, "random_bytes", NULL, 453, &_2);
	zephir_check_call_status();
	ZVAL_LONG(&_2, 0);
	ZVAL_LONG(&_3, 2);
	ZEPHIR_INIT_VAR(&_4);
	zephir_substr(&_4, &randBytes, 0 , 2 , 0);
	ZEPHIR_CALL_FUNCTION(&_5, "bin2hex", NULL, 464, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "hexdec", NULL, 472, &_5);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_10, "bin2hex", NULL, 464, &_9);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_11, "hexdec", NULL, 472, &_10);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_15, "bin2hex", NULL, 464, &_14);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_16);
	ZVAL_STRING(&_16, "%08x-%04x-%04x-%04x-%s");
	ZEPHIR_CALL_FUNCTION(&_17, "sprintf", NULL, 125, &_16, &timeHigh32, &timeLow16, &verRandA, &varRandB, &_15);
	zephir_check_call_status();
