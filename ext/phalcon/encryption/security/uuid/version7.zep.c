...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version7, __construct)
{
	...
	ZVAL_LONG(&_2, 10);
	ZEPHIR_CALL_FUNCTION(&randBytes, "random_bytes", NULL, 324, &_2);
	zephir_check_call_status();
	ZVAL_LONG(&_2, 0);
	ZVAL_LONG(&_3, 2);
	ZEPHIR_INIT_VAR(&_4);
	zephir_substr(&_4, &randBytes, 0 , 2 , 0);
	ZEPHIR_CALL_FUNCTION(&_5, "bin2hex", NULL, 325, &_4);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_10, "bin2hex", NULL, 325, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_15, "bin2hex", NULL, 325, &_14);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_16);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 726, &_17);
	ZEPHIR_MM_RESTORE();
}
