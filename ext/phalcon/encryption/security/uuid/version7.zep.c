...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version7, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&_17, "sprintf", NULL, 147, &_16, &timeHigh32, &timeLow16, &verRandA, &varRandB, &_15);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 727, &_17);
	ZEPHIR_MM_RESTORE();
}
