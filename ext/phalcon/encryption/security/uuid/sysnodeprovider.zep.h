...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_encryption_security_uuid_sysnodeprovider_method_entry) {
	...
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFclose, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFgetCsv, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFileExists, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFileGetContents, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFilePutContents, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Encryption_Security_Uuid_SysNodeProvider, phpFopen, arginfo_phalcon_encryption_security_uuid_sysnodeprovider_phpfopen, ZEND_ACC_PROTECTED)
