...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version6, __construct)
{
	...
	ZVAL_LONG(&_3, 2);
	ZEPHIR_CALL_FUNCTION(&clockSeqBytes, "random_bytes", NULL, 448, &_3);
	zephir_check_call_status();
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_INIT_VAR(&_5);
	zephir_substr(&_5, &clockSeqBytes, 0 , 1 , 0);
	ZEPHIR_CALL_FUNCTION(&_6, "ord", NULL, 413, &_5);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&clockSeqLow, "ord", NULL, 413, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_12, "sprintf", NULL, 125, &_11, &timeHigh32, &timeMid16, &timeLow12, &clockSeqHiRes, &clockSeqLow, &nodeStr);
	zephir_check_call_status();
