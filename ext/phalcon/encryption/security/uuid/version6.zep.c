...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version6, __construct)
{
	...
	ZVAL_LONG(&_3, 2);
	ZEPHIR_CALL_FUNCTION(&clockSeqBytes, "random_bytes", NULL, 310, &_3);
	...
	ZEPHIR_CALL_FUNCTION(&_12, "sprintf", NULL, 133, &_11, &timeHigh32, &timeMid16, &timeLow12, &clockSeqHiRes, &clockSeqLow, &nodeStr);
	zephir_check_call_status();
