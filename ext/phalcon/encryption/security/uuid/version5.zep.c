...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version5, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&_8, "ord", NULL, 506, &_7);
	zephir_check_call_status();
	ZVAL_LONG(&_9, (((int) (zephir_get_numberval(&_8)) & 0x0f) | 0x50));
	ZEPHIR_CALL_FUNCTION(&_10, "chr", NULL, 505, &_9);
	zephir_check_call_status();
	ZVAL_LONG(&_9, 6);
	ZVAL_LONG(&_11, 1);
	...
	ZEPHIR_CALL_FUNCTION(&_12, "ord", NULL, 506, &_13);
	zephir_check_call_status();
	ZVAL_LONG(&_14, (((int) (zephir_get_numberval(&_12)) & 0x3f) | 0x80));
	ZEPHIR_CALL_FUNCTION(&_15, "chr", NULL, 505, &_14);
	zephir_check_call_status();
	ZVAL_LONG(&_14, 8);
	ZVAL_LONG(&_16, 1);
