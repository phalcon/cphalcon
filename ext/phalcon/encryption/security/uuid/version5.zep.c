...
PHP_METHOD(Phalcon_Encryption_Security_Uuid_Version5, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "sha1", NULL, 471, &_1, &__$true);
	zephir_check_call_status();
	ZVAL_LONG(&_3, 0);
	ZVAL_LONG(&_4, 16);
	...
	ZEPHIR_CALL_FUNCTION(&_8, "ord", NULL, 413, &_7);
	zephir_check_call_status();
	ZVAL_LONG(&_9, (((int) (zephir_get_numberval(&_8)) & 0x0f) | 0x50));
	ZEPHIR_CALL_FUNCTION(&_10, "chr", NULL, 412, &_9);
	zephir_check_call_status();
	ZVAL_LONG(&_9, 6);
	ZVAL_LONG(&_11, 1);
	ZEPHIR_CALL_FUNCTION(&_12, "substr_replace", NULL, 469, &hash, &_10, &_9, &_11);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_12, "ord", NULL, 413, &_13);
	zephir_check_call_status();
	ZVAL_LONG(&_14, (((int) (zephir_get_numberval(&_12)) & 0x3f) | 0x80));
	ZEPHIR_CALL_FUNCTION(&_15, "chr", NULL, 412, &_14);
	zephir_check_call_status();
	ZVAL_LONG(&_14, 8);
	ZVAL_LONG(&_16, 1);
	ZEPHIR_CALL_FUNCTION(&_17, "substr_replace", NULL, 469, &hash, &_15, &_14, &_16);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&hash, &_17);
	ZEPHIR_CALL_FUNCTION(&_18, "bin2hex", NULL, 459, &hash);
	zephir_check_call_status();
