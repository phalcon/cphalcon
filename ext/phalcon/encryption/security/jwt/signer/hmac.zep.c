...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Signer_Hmac, sign)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethash", NULL, 245, &payload, &passphrase);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Signer_Hmac, verify)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "gethash", NULL, 245, &payload, &passphrase);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Signer_Hmac, getHash)
{
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac", NULL, 221, &_0, &payload, &passphrase, &__$true);
	zephir_check_call_status();
	RETURN_MM();
}
