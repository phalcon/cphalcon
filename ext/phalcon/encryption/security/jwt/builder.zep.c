...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, __construct)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("signer", 6, 1);
	}
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("encode", 6, 1);
	}
	if (UNEXPECTED(!_zephir_prop_2)) {
		_zephir_prop_2 = zend_string_init("jose", 4, 1);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 656, signer);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 657, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 658, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 656, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, addClaim)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 659, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, addHeader)
{
	...
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("jose", 4, 1);
	}
	...
	zephir_memory_observe(&name_zv);
	ZVAL_STR_COPY(&name_zv, name);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 658, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_0, "set", NULL, 0, &name_zv, value);
	zephir_check_call_status();
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, getToken)
{
	...
	static zend_string *_zephir_prop_2 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("passphrase", 10, 1);
	}
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("encode", 6, 1);
	}
	if (UNEXPECTED(!_zephir_prop_2)) {
		_zephir_prop_2 = zend_string_init("signer", 6, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);

	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 660, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 657, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 657, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_2, 656, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
	ZEPHIR_CONCAT_VSV(&_11, &encodedHeaders, ".", &encodedClaims);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_0, 660, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, init)
{
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 660, &_0);
	ZEPHIR_INIT_NVAR(&_0);
	object_init_ex(&_0, phalcon_support_collection_ce);
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 41);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 659, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 658, &_1);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, setPassphrase)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 660, &passphrase_zv);
	RETURN_THIS();
}
