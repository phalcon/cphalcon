...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 690, signer);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 691, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 692, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, getToken)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 691, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_1, 691, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_2, 690, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
	ZEPHIR_CONCAT_VSV(&_11, &encodedHeaders, ".", &encodedClaims);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_0, 694, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Builder, setPassphrase)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 694, &passphrase_zv);
	RETURN_THIS();
}
