...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Validator, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 705, token);
	ZVAL_UNDEF(&_1);
	ZVAL_LONG(&_1, timeShift);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 706, &_1);
	ZEPHIR_INIT_VAR(&_2);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 707, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Validator, get)
{
	...
	if (zephir_array_isset_value(&_0, &claim_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 707, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Validator, validateAudience)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 705, PH_NOISY_CC | PH_READONLY);
