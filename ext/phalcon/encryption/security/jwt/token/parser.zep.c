...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Parser, decodeClaims)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "decodeurl", NULL, 265, &claims);
	zephir_check_call_status();
	ZVAL_BOOL(&_1, 1);
	ZEPHIR_CALL_METHOD(&decoded, this_ptr, "decode", NULL, 266, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Parser, decodeHeaders)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "decodeurl", NULL, 265, &headers);
	zephir_check_call_status();
	ZVAL_BOOL(&_1, 1);
	ZEPHIR_CALL_METHOD(&decoded, this_ptr, "decode", NULL, 266, &_0, &_1);
	zephir_check_call_status();
