...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 699, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 700, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 701, signature);
}
