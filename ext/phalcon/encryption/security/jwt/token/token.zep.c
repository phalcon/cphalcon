...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 706, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 707, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 708, signature);
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, getToken)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 708, PH_NOISY_CC | PH_READONLY);
