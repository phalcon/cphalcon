...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 708, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 709, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 710, signature);
}
