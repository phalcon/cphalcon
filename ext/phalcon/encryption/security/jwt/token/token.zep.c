...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 698, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 699, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 700, signature);
}
