...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 710, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 711, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 712, signature);
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, getPayload)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 711, PH_NOISY_CC | PH_READONLY);
