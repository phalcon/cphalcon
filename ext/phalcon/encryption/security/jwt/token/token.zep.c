...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 713, headers);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 714, claims);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 715, signature);
}
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Token, verify)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 715, PH_NOISY_CC | PH_READONLY);
