...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Item, get)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 656, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security_JWT_Token_Item, getPayload)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 656, PH_NOISY_CC | PH_READONLY);
