...
PHP_METHOD(Phalcon_Encryption_Security, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 677, request);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 678, session);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Encryption_Security, destroyToken)
{
	...
	if (UNEXPECTED(zephir_is_true(&session))) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 679, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &session, "remove", NULL, 0, &_2$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_1, 680, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &session, "remove", NULL, 0, &_3$$3);
		zephir_check_call_status();
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 681, &__$null);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 682, &__$null);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 683, &__$null);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Security, getSaltBytes)
{
	...
	if (!(numberBytes)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 684, PH_NOISY_CC | PH_READONLY);
		numberBytes = zephir_get_numberval(&_0$$3);
	}
	while (1) {
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_1, 676, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, getToken)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 681, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_1, 685, PH_NOISY_CC | PH_READONLY);
		_4$$3 = ZEPHIR_IS_FALSE_IDENTICAL(&_3$$3);
		if (_4$$3) {
			_4$$3 = Z_TYPE_P(&session) != IS_NULL;
		}
		if (_4$$3) {
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_2, 680, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&sessionToken, &session, "get", NULL, 0, &_5$$4);
			zephir_check_call_status();
			if (Z_TYPE_P(&sessionToken) != IS_NULL) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 681, &sessionToken);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 683, &sessionToken);
				RETURN_MM_MEMBER(getThis(), "token");
			}
		}
		ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "getsessiontoken", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 683, &_6$$3);
		zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_4, 676, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_9$$3, this_ptr, _zephir_prop_5, 684, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_8$$3, &_7$$3, "base64safe", NULL, 0, &_9$$3);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 681, &_8$$3);
		if (Z_TYPE_P(&session) != IS_NULL) {
			zephir_read_property_cached(&_10$$6, this_ptr, _zephir_prop_2, 680, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_0, 681, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, getTokenKey)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		if (Z_TYPE_P(&session) != IS_NULL) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 685, PH_NOISY_CC | PH_READONLY);
			if (ZEPHIR_IS_FALSE_IDENTICAL(&_3$$4)) {
				zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_2, 679, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CALL_METHOD(&sessionTokenKey, &session, "get", NULL, 0, &_4$$5);
				zephir_check_call_status();
				if (Z_TYPE_P(&sessionTokenKey) != IS_NULL) {
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 682, &sessionTokenKey);
					RETURN_MM_MEMBER(getThis(), "tokenKey");
				}
			}
			zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_3, 676, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_4, 684, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_6$$4, &_5$$4, "base64safe", NULL, 0, &_7$$4);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 682, &_6$$4);
			zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_2, 679, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_0, 682, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, hash)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 686, PH_NOISY_CC);
	do {
...
PHP_METHOD(Phalcon_Encryption_Security, refreshToken)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 676, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 684, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_1, &_0, "base64safe", NULL, 0, &_2);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 681, &_1);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 676, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 684, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_4, &_3, "base64safe", NULL, 0, &_5);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 682, &_4);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 683, &__$null);
	ZEPHIR_INIT_VAR(&_6);
	...
	zephir_check_call_status();
	if (Z_TYPE_P(&session) != IS_NULL) {
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_5, 680, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_9$$3, this_ptr, _zephir_prop_2, 681, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &session, "set", NULL, 0, &_8$$3, &_9$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_6, 679, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_3, 682, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, setAutoRefresh)
{
	...
	if (autoRefresh) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 685, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 685, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Security, setRandomBytes)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 684, &_0);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Security, getLocalService)
{
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 688, PH_NOISY_CC | PH_READONLY);
		_1 = Z_TYPE_P(&_2) != IS_NULL;
	}
	_3 = _1;
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 688, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_5, &_4, "has", NULL, 0, &name_zv);
		zephir_check_call_status();
		_3 = ZEPHIR_IS_TRUE_IDENTICAL(&_5);
	}
	if (_3) {
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 688, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, processAlgorithm)
{
	...
	if (ZEPHIR_IS_LONG_IDENTICAL(&_0, 10)) {
		...
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 686, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, processArgonOptions)
{
	...
	if (!(_1)) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 686, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Security, processCost)
{
	...
	if (!(zephir_array_isset_string_fetch(&cost, &options, SL("cost"), 0))) {
		...
		zephir_read_property_cached(&cost, this_ptr, _zephir_prop_0, 687, PH_NOISY_CC);
	}
...
PHP_METHOD(Phalcon_Encryption_Security, processTokenKey)
{
	...
	if (_2) {
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 679, PH_NOISY_CC | PH_READONLY);
