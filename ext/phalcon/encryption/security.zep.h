...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_encryption_security_getdefaulthash, 0, 0, IS_LONG, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_encryption_security_gettoken, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_encryption_security_gettokenkey, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_encryption_security_getlocalrequest, 0, 0, Phalcon\\Http\\RequestInterface, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_encryption_security_getlocalsession, 0, 0, Phalcon\\Session\\ManagerInterface, 1)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_encryption_security_method_entry) {
	...
	PHP_ME(Phalcon_Encryption_Security, getLocalRequest, arginfo_phalcon_encryption_security_getlocalrequest, ZEND_ACC_PRIVATE)
	PHP_ME(Phalcon_Encryption_Security, getLocalSession, arginfo_phalcon_encryption_security_getlocalsession, ZEND_ACC_PRIVATE)
	PHP_FE_END
};
