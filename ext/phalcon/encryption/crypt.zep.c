...
PHP_METHOD(Phalcon_Encryption_Crypt, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 667, padFactory);
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Encryption_Crypt, decrypt)
{
	...
	zephir_read_property_cached(&decryptKey, this_ptr, _zephir_prop_0, 669, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 670, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&cipher, &_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 671, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 672, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_memory_observe(&hashLength);
		zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_4, 673, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_3, 672, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Crypt, encrypt)
{
	...
	zephir_read_property_cached(&encryptKey, this_ptr, _zephir_prop_0, 669, PH_NOISY_CC);
	if (1 != ZEPHIR_IS_EMPTY(&key_zv)) {
...
PHP_METHOD(Phalcon_Encryption_Crypt, setAuthData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 674, &data_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setAuthTag)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&tag_zv, tag);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 675, &tag_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setAuthTagLength)
{
	...
	ZVAL_UNDEF(&_2);
	ZVAL_LONG(&_2, length);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 676, &_2);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setCipher)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 671, &_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 670, &cipher_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setKey)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&key_zv, key);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 669, &key_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setHashAlgorithm)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 668, &hashAlgorithm_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, useSigning)
{
	...
	if (useSigning) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 672, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 672, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, cryptPadText)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 667, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_6$$3, paddingType);
		ZEPHIR_CALL_METHOD(&service, &_5$$3, "padnumbertoservice", NULL, 0, &_6$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 667, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptGcmCcmAuth)
{
	...
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 674, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptGetPadded)
{
	...
	if (_1) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 677, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptGcmCcm)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_2, 675, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&authTag, &_4$$3);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_3, 676, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&authTagLength, &_4$$3);
		ZVAL_LONG(&_4$$3, 1);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 675, &authTag);
	} else {
		ZVAL_LONG(&_6$$5, 1);
...
PHP_METHOD(Phalcon_Encryption_Crypt, initializeAvailableCiphers)
{
	...
	ZEPHIR_INIT_NVAR(&cipher);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 678, &allowed);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getBlockSize)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 670, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
...
PHP_METHOD(Phalcon_Encryption_Crypt, getMode)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 670, PH_NOISY_CC | PH_READONLY);
