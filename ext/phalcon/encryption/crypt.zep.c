...
PHP_METHOD(Phalcon_Encryption_Crypt, decrypt)
{
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 304, &input_zv, &_1, &ivLength, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&digest, "mb_substr", NULL, 304, &input_zv, &ivLength, &hashLength, &_9$$6);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_10$$6);
		zephir_add_function(&_10$$6, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_9$$6);
		ZVAL_STRING(&_9$$6, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 304, &input_zv, &_10$$6, &__$null, &_9$$6);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_11$$8);
		ZVAL_STRING(&_11$$8, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 304, &input_zv, &ivLength, &__$null, &_11$$8);
		zephir_check_call_status();
	}
