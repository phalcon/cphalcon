...
PHP_METHOD(Phalcon_Encryption_Crypt, __construct)
{
	...
	if (Z_TYPE_P(padFactory) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, padFactory, "__construct", NULL, 497);
...
PHP_METHOD(Phalcon_Encryption_Crypt, decrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&decryptKey)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 498);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_3)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$5, "__construct", NULL, 499);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$5, "phalcon/Encryption/Crypt.zep", 230);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&mode, this_ptr, "getmode", NULL, 500);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&blockSize, this_ptr, "getblocksize", NULL, 501, &mode);
	zephir_check_call_status();
	ZVAL_LONG(&_1, 0);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 339, &input_zv, &_1, &ivLength, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		if (!(zephir_array_isset_fetch(&hashLength, &_5$$6, &hashAlgorithm, 0))) {
			...
			ZVAL_STRING(&_6$$7, "");
			ZEPHIR_CALL_FUNCTION(&_7$$7, "hash", NULL, 148, &hashAlgorithm, &_6$$7, &__$true);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&digest, "mb_substr", NULL, 339, &input_zv, &ivLength, &hashLength, &_8$$6);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_9$$6);
		zephir_add_function(&_9$$6, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_8$$6);
		ZVAL_STRING(&_8$$6, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 339, &input_zv, &_9$$6, &__$null, &_8$$6);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_10$$8);
		ZVAL_STRING(&_10$$8, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 339, &input_zv, &ivLength, &__$null, &_10$$8);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_11)) {
		...
		ZEPHIR_CALL_FUNCTION(&_13$$9, "hash_hmac", NULL, 502, &hashAlgorithm, &decrypted, &decryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptBase64)
{
	...
	ZEPHIR_CALL_FUNCTION(&_5, "base64_decode", NULL, 503, &input);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&encryptKey)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 504);
		zephir_check_call_status();
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_2, SL("ValueError"))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$6, "__construct", NULL, 505);
			zephir_check_call_status();
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&iv)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$7, "__construct", NULL, 505);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&digest, "hash_hmac", NULL, 502, &_6$$8, &padded, &encryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptBase64)
{
	...
	if (safe) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1$$3, "base64_encode", NULL, 506, &_0$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 506, &_5);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getAvailableHashAlgorithms)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac_algos", NULL, 507);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("hash_algos", NULL, 508);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setCipher)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getivlength", NULL, 510, &cipher_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, checkCipherHashIsAvailable)
{
	...
	if (1 != zephir_fast_in_array(&lower, &available)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 511, &type_zv, &cipher_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, getBlockSize)
{
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getivlength", NULL, 510, &_4);
	zephir_check_call_status();
	RETURN_MM();
}
