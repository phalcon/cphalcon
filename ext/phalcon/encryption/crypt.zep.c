...
PHP_METHOD(Phalcon_Encryption_Crypt, __construct)
{
	...
	if (Z_TYPE_P(padFactory) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, padFactory, "__construct", NULL, 482);
...
PHP_METHOD(Phalcon_Encryption_Crypt, decrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&decryptKey)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 483);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&mode, this_ptr, "getmode", NULL, 484);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&blockSize, this_ptr, "getblocksize", NULL, 485, &mode);
	zephir_check_call_status();
	ZVAL_LONG(&_1, 0);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 323, &input_zv, &_1, &ivLength, &_2);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&digest, "mb_substr", NULL, 323, &input_zv, &ivLength, &hashLength, &_6$$5);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_7$$5);
		zephir_add_function(&_7$$5, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_6$$5);
		ZVAL_STRING(&_6$$5, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 323, &input_zv, &_7$$5, &__$null, &_6$$5);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_8$$7);
		ZVAL_STRING(&_8$$7, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 323, &input_zv, &ivLength, &__$null, &_8$$7);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_9)) {
		...
		ZEPHIR_CALL_FUNCTION(&_11$$8, "hash_hmac", NULL, 486, &hashAlgorithm, &decrypted, &decryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptBase64)
{
	...
	ZEPHIR_CALL_FUNCTION(&_5, "base64_decode", NULL, 487, &input);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encrypt)
{
	...
	if (1 == ZEPHIR_IS_EMPTY(&encryptKey)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 488);
		zephir_check_call_status();
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_2, SL("ValueError"))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$6, "__construct", NULL, 489);
			zephir_check_call_status();
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&iv)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_5$$7, "__construct", NULL, 489);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&digest, "hash_hmac", NULL, 486, &_6$$8, &padded, &encryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptBase64)
{
	...
	if (safe) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1$$3, "base64_encode", NULL, 490, &_0$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 490, &_5);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getAvailableHashAlgorithms)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac_algos", NULL, 491);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("hash_algos", NULL, 492);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setCipher)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getivlength", NULL, 493, &cipher_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, checkCipherHashIsAvailable)
{
	...
	if (1 != zephir_fast_in_array(&lower, &available)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 494, &type_zv, &cipher_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, cryptPadText)
{
	...
	ZVAL_STRING(&_2, "ecb");
	zephir_array_fast_append(&_1, &_2);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checkismode", NULL, 495, &_1, &mode_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		if (_3$$3) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 496);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, cryptUnpadText)
{
	...
	if (_1) {
		...
		ZVAL_STRING(&_4, "ecb");
		zephir_array_fast_append(&_3, &_4);
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkismode", NULL, 495, &_3, &mode_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptGcmCcmAuth)
{
	...
	ZVAL_STRING(&_3, "gcm");
	zephir_array_fast_append(&_2, &_3);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checkismode", NULL, 495, &_2, &mode_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		ZVAL_LONG(&_4$$3, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 497, &encrypted, &cipher, &decryptKey_zv, &_4$$3, &iv_zv, &authTag, &authData);
		zephir_check_call_status();
	} else {
		ZVAL_LONG(&_6$$4, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 497, &cipherText_zv, &cipher, &decryptKey_zv, &_6$$4, &iv_zv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&decrypted)) {
		ZEPHIR_INIT_VAR(&_7$$5);
		object_init_ex(&_7$$5, phalcon_encryption_crypt_exception_decryptionfailed_ce);
		ZEPHIR_CALL_METHOD(NULL, &_7$$5, "__construct", NULL, 498);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptGcmCcm)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		if (1 == ZEPHIR_IS_EMPTY(&authData)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 499);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 500, &padded_zv, &cipher, &encryptKey_zv, &_4$$3, &iv_zv, &authTag, &authData, &authTagLength);
		ZEPHIR_UNREF(&authTag);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("authTag"), &authTag);
	} else {
		ZVAL_LONG(&_6$$5, 1);
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 500, &padded_zv, &cipher, &encryptKey_zv, &_6$$5, &iv_zv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&encrypted)) {
		ZEPHIR_INIT_VAR(&_7$$6);
		object_init_ex(&_7$$6, phalcon_encryption_crypt_exception_encryptionfailed_ce);
		ZEPHIR_CALL_METHOD(NULL, &_7$$6, "__construct", NULL, 501);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, initializeAvailableCiphers)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 502);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Encryption/Crypt.zep", 928);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_FUNCTION(&available, "openssl_get_cipher_methods", NULL, 503, &__$true);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, getBlockSize)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
	ZEPHIR_CALL_FUNCTION(&_4, "str_ireplace", NULL, 504, &_1, &_3, &_2);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getivlength", NULL, 493, &_4);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getIvLength)
{
	...
	zephir_memory_observe(&cipher_zv);
	ZVAL_STR_COPY(&cipher_zv, cipher);
	ZEPHIR_CALL_FUNCTION(&length, "openssl_cipher_iv_length", NULL, 505, &cipher_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&length)) {
		ZEPHIR_INIT_VAR(&_0$$3);
...
PHP_METHOD(Phalcon_Encryption_Crypt, getMode)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "-");
	ZEPHIR_CALL_FUNCTION(&_2, "strrpos", NULL, 507, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, phpOpensslCipherIvLength)
{
	...
	zephir_memory_observe(&cipher_zv);
	ZVAL_STR_COPY(&cipher_zv, cipher);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 505, &cipher_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, phpOpensslRandomPseudoBytes)
{
	...
	ZVAL_LONG(&_0, length);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 508, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
