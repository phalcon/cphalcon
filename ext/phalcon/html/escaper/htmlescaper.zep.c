...
PHP_METHOD(Phalcon_Html_Escaper_HtmlEscaper, escape)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 789, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 790, PH_NOISY_CC | PH_READONLY);
