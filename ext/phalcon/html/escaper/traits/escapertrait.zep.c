...
PHP_METHOD(Phalcon_Html_Escaper_Traits_EscaperTrait, detectEncoding)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _2)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_3$$5, "mb_detect_encoding", &_4, 40, &input_zv, &charset, &__$true);
	...
	ZEPHIR_INIT_NVAR(&charset);
	ZEPHIR_RETURN_CALL_FUNCTION("mb_detect_encoding", &_4, 40, &input_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper_Traits_EscaperTrait, normalizeEncoding)
{
	...
	zephir_memory_observe(&input_zv);
	ZVAL_STR_COPY(&input_zv, input);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "detectencoding", NULL, 0, &input_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "UTF-32");
...
PHP_METHOD(Phalcon_Html_Escaper_Traits_EscaperTrait, setDoubleEncode)
{
	...
	if (doubleEncode) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 809, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 809, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Escaper_Traits_EscaperTrait, setEncoding)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 810, &encoding_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Escaper_Traits_EscaperTrait, setFlags)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, flags);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 811, &_0);
	RETURN_THISW();
}
