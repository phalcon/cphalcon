...
ZEPHIR_INIT_FUNCS(phalcon_html_escaper_abstractescaper_method_entry) {
	...
	PHP_ME(Phalcon_Html_Escaper_AbstractEscaper, phpExtensionLoaded, arginfo_phalcon_html_escaper_abstractescaper_phpextensionloaded, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Html_Escaper_AbstractEscaper, phpFunctionExists, arginfo_phalcon_html_escaper_abstractescaper_phpfunctionexists, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_FE_END
};
