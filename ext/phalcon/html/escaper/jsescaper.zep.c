...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Html\\Escaper, JsEscaper, phalcon, html_escaper_jsescaper, phalcon_html_escaper_abstractescaper_ce, phalcon_html_escaper_jsescaper_method_entry, 0);
