...
ZEPHIR_INIT_CLASS(Phalcon_Html_Escaper_AbstractEscaper)
{
...

	{
		zval _zc0;
		ZVAL_BOOL(&_zc0, 1);
		zephir_declare_typed_property(phalcon_html_escaper_abstractescaper_ce, SL("doubleEncode"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_BOOL, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_STRINGL(&_zc0, "utf-8", sizeof("utf-8") - 1);
		zephir_declare_typed_property(phalcon_html_escaper_abstractescaper_ce, SL("encoding"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_STRING, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		ZVAL_LONG(&_zc0, 11);
		zephir_declare_typed_property(phalcon_html_escaper_abstractescaper_ce, SL("flags"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_LONG, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Html_Escaper_AbstractEscaper, setDoubleEncode)
{
	...
	if (doubleEncode) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 55, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 55, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Escaper_AbstractEscaper, setEncoding)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 56, &encoding_zv);
	RETURN_THISW();
}
