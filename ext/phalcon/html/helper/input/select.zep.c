...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, add)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 816, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, addPlaceholder)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 816, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, optGroup)
{
	...
	if (!(zephir_is_true(&_0))) {
		...
		ZVAL_LONG(&_2$$3, 1);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 818, PH_NOISY_CC);
		ZEPHIR_ADD_ASSIGN(&_5$$3, &_2$$3)
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 818, &_5$$3);
	} else {
		ZEPHIR_INIT_VAR(&_7$$4);
		ZVAL_LONG(&_7$$4, 1);
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_1, 818, PH_NOISY_CC);
		ZEPHIR_SUB_ASSIGN(&_6$$4, &_7$$4)
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 818, &_6$$4);
	...
	zephir_read_property_cached(&_11, this_ptr, _zephir_prop_0, 817, PH_NOISY_CC);
	if (!zephir_is_true(&_11)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 817, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 817, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, selected)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 819, &selected_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, strict)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 820, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 820, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_Select, processValue)
{
	...
	if (_0) {
		zephir_array_update_string(&attributes, SL("value"), &value_zv, PH_COPY | PH_SEPARATE);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 819, PH_NOISY_CC | PH_READONLY);
		if (!ZEPHIR_IS_STRING_IDENTICAL(&_1$$3, "")) {
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 820, PH_NOISY_CC | PH_READONLY);
			if (zephir_is_true(&_2$$4)) {
				zephir_read_property_cached(&_3$$5, this_ptr, _zephir_prop_0, 819, PH_NOISY_CC | PH_READONLY);
				matched = ZEPHIR_IS_IDENTICAL(&value_zv, &_3$$5);
			} else {
				zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_0, 819, PH_NOISY_CC | PH_READONLY);
