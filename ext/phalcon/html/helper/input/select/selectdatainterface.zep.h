...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_html_helper_input_select_selectdatainterface_getattributes, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_html_helper_input_select_selectdatainterface_method_entry) {
	PHP_ABSTRACT_ME(Phalcon_Html_Helper_Input_Select_SelectDataInterface, getAttributes, arginfo_phalcon_html_helper_input_select_selectdatainterface_getattributes)
