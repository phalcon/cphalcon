...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, __invoke)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 214, &name_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 215, &options);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 216, checked);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 217, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, __toString)
{
	...
	ZEPHIR_INIT_VAR(&_13);
	array_init(&_13);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 215, &_13);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 216, &__$null);
	ZEPHIR_INIT_VAR(&_14);
	array_init(&_14);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 217, &_14);
	ZEPHIR_INIT_VAR(&_15);
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, renderItem)
{
	...
	ZVAL_STRING(&_6, "");
	zephir_array_fast_append(&_7, &_6);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 214, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_1, 217, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_10);
	...
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_0, 214, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_12);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_2, 218, PH_NOISY_CC);
