...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, __invoke)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 221, &name_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 222, &options);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 223, checked);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 224, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, __toString)
{
	...
	ZEPHIR_INIT_VAR(&_15);
	array_init(&_15);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 222, &_15);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 223, &__$null);
	ZEPHIR_INIT_VAR(&_16);
	array_init(&_16);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 224, &_16);
	ZEPHIR_INIT_VAR(&_17);
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractGroup, renderItem)
{
	...
	ZVAL_STRING(&_6, "");
	zephir_array_fast_append(&_7, &_6);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 221, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_1, 224, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_10);
	...
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_0, 221, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_12);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_2, 225, PH_NOISY_CC);
