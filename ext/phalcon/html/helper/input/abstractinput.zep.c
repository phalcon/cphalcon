...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractInput, __invoke)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 60, PH_NOISY_CC);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 61, &_0);
	...
	ZEPHIR_INIT_VAR(&_4);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 61, PH_NOISY_CC | PH_READONLY);
	zephir_fast_array_merge(&_4, &_5, &attributes);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 61, &_4);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractInput, __toString)
{
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("doctype", 7, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	...
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 61, &_1);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 62, PH_NOISY_CC | PH_READONLY);
