...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 208, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, __toString)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 208, &_1);
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, label)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 208, &_4);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, processChecked)
{
	...
	if (Z_TYPE_P(&checked) != IS_NULL) {
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(&checked)) {
			...
			if (_1$$4) {
				...
				zephir_read_property_cached(&_3$$7, this_ptr, _zephir_prop_1, 210, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 209, &attributes);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, processUnchecked)
{
	...
	if (!(ZEPHIR_IS_EMPTY(&unchecked))) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 209, PH_NOISY_CC | PH_READONLY);
