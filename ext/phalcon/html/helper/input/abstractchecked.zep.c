...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, __toString)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 217, &_1);
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, label)
{
	...
	if (!(zephir_array_isset_string_fetch(&text, &attributes, SL("text"), 0))) {
		...
		zephir_read_property_cached(&_0$$4, this_ptr, _zephir_prop_0, 218, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 219, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 217, &_6);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, strict)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 220, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 220, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, processChecked)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 219, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&checked) != IS_NULL) {
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(&checked)) {
			...
			if (_1$$4) {
				...
				zephir_read_property_cached(&_3$$7, this_ptr, _zephir_prop_1, 220, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Html_Helper_Input_AbstractChecked, processUnchecked)
{
	...
	if (!(ZEPHIR_IS_EMPTY(&unchecked))) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 219, PH_NOISY_CC | PH_READONLY);
