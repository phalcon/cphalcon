...
PHP_METHOD(Phalcon_Html_Helper_AbstractList, __invoke)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 117, &attributes);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 118, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 119, &indent_zv);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 120, &_1);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_AbstractList, __toString)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 118, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 120, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 118, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 117, PH_NOISY_CC | PH_READONLY);
	ZVAL_BOOL(&_7, 1);
