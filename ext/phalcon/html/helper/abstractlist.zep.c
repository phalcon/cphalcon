...
PHP_METHOD(Phalcon_Html_Helper_AbstractList, __invoke)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 122, &attributes);
	ZEPHIR_INIT_VAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 123, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 124, &indent_zv);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 125, &_1);
	RETURN_THIS();
}
