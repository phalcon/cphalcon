...
ZEPHIR_INIT_CLASS(Phalcon_Html_Helper_TextArea) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Html\\Helper, TextArea, phalcon, html_helper_textarea, phalcon_html_helper_abstracthelper_ce, phalcon_html_helper_textarea_method_entry, 0);
