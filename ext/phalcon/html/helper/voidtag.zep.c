...
PHP_METHOD(Phalcon_Html_Helper_VoidTag, __invoke)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 855, PH_NOISY_CC | PH_READONLY);
	_1 = Z_TYPE_P(&_0) != IS_NULL;
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 855, PH_NOISY_CC | PH_READONLY);
