...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 820, url);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, render)
{
	...
	if (Z_TYPE_P(_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_2), _4)
		{
			...
			zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_1, 825, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_1, 825, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_1, 825, PH_NOISY_CC | PH_READONLY);
	zephir_memory_observe(&_17);
	zephir_array_fetch_string(&_17, &_16, SL("main"), PH_NOISY, "phalcon/Html/Helper/Breadcrumbs.zep", 243);
	ZEPHIR_INIT_VAR(&_18);
	zephir_create_array(&_18, 4, 0);
	zephir_read_property_cached(&_20, this_ptr, _zephir_prop_2, 824, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_21, this_ptr, _zephir_prop_3, 821, PH_NOISY_CC);
	zephir_array_update_string(&_18, SL("delimiter"), &_21, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_21);
	zephir_read_property_cached(&_21, this_ptr, _zephir_prop_4, 822, PH_NOISY_CC);
	zephir_array_update_string(&_18, SL("indent"), &_21, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(&_22);
	zephir_read_property_cached(&_23, this_ptr, _zephir_prop_4, 822, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_24, this_ptr, _zephir_prop_5, 826, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_25, this_ptr, _zephir_prop_3, 821, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_26);
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, getLink)
{
	...
	if (_0) {
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 820, PH_NOISY_CC | PH_READONLY);
		_0 = Z_TYPE_P(&_1) != IS_NULL;
	}
	if (_0) {
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 820, PH_NOISY_CC | PH_READONLY);
		...
		if (_2) {
			zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 827, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 822, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_10);
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_3, 828, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_3, 828, PH_NOISY_CC | PH_READONLY);
