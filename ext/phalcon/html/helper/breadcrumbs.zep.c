...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 836, url);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, __invoke)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 837, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 838, &indent_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, clearAttributes)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 840, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, remove)
{
	...
	zephir_read_property_cached(&elements, this_ptr, _zephir_prop_0, 839, PH_NOISY_CC);
	zephir_array_unset_long(&elements, index, PH_SEPARATE);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 839, &elements);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, render)
{
	...
	zephir_read_property_cached(&_21, this_ptr, _zephir_prop_3, 837, PH_NOISY_CC);
	zephir_array_update_string(&_18, SL("delimiter"), &_21, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_21);
	zephir_read_property_cached(&_21, this_ptr, _zephir_prop_4, 838, PH_NOISY_CC);
	zephir_array_update_string(&_18, SL("indent"), &_21, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(&_22);
	zephir_read_property_cached(&_23, this_ptr, _zephir_prop_4, 838, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_24, this_ptr, _zephir_prop_5, 842, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_25, this_ptr, _zephir_prop_3, 837, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_26);
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, setAttributes)
{
	...
	zephir_get_arrval(&attributes, attributes_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 840, &attributes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 843, &prefix_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 836, &__$null);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, setSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 842, &separator_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Html_Helper_Breadcrumbs, getLink)
{
	...
	if (_0) {
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 836, PH_NOISY_CC | PH_READONLY);
		...
		if (_2) {
			zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 843, PH_NOISY_CC | PH_READONLY);
			_2 = !(ZEPHIR_IS_EMPTY(&_3));
		}
		if (_2) {
			zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_1, 843, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 838, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_10);
	...
	zephir_read_property_cached(&_14, this_ptr, _zephir_prop_3, 844, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_3, 844, PH_NOISY_CC | PH_READONLY);
