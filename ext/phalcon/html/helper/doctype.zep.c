...
PHP_METHOD(Phalcon_Html_Helper_Doctype, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 826, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Helper_Doctype, __invoke)
{
	...
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 825, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 826, &delimiter_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Html_Helper_Doctype, __toString)
{
	...
	do {
		if (ZEPHIR_IS_LONG(&_0, 1)) {
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CONCAT_SV(return_value, "<!DOCTYPE html PUBLIC \"-//W3C//DTD HTML 3.2 Final//EN\">", &_1$$3);
			return;
		}
		if (ZEPHIR_IS_LONG(&_0, 2)) {
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 3)) {
			zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 4)) {
			zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 6)) {
			zephir_read_property_cached(&_8$$7, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_9$$7, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 7)) {
			zephir_read_property_cached(&_10$$8, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_11$$8, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 8)) {
			zephir_read_property_cached(&_12$$9, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_13$$9, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 9)) {
			zephir_read_property_cached(&_14$$10, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_15$$10, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_LONG(&_0, 10)) {
			zephir_read_property_cached(&_16$$11, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_17$$11, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_18, this_ptr, _zephir_prop_1, 826, PH_NOISY_CC | PH_READONLY);
