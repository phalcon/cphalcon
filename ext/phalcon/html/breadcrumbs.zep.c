...
PHP_METHOD(Phalcon_Html_Breadcrumbs, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 797, &elements);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Breadcrumbs, render)
{
	...
	array_init(&output);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 798, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_19);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 799, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_20);
...
PHP_METHOD(Phalcon_Html_Breadcrumbs, setSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 799, &separator_zv);
	RETURN_THISW();
}
