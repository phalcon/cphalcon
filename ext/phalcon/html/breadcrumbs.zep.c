...
PHP_METHOD(Phalcon_Html_Breadcrumbs, clear)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 802, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Breadcrumbs, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 802, &elements);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Html_Breadcrumbs, render)
{
	...
	ZEPHIR_INIT_VAR(&_33);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 804, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_34);
...
PHP_METHOD(Phalcon_Html_Breadcrumbs, setSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 804, &separator_zv);
	RETURN_THISW();
}
