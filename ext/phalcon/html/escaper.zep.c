...
PHP_METHOD(Phalcon_Html_Escaper, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 789, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 790, &_1);
	ZEPHIR_INIT_VAR(&_2);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 791, &_2);
	ZEPHIR_INIT_VAR(&_3);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 792, &_3);
	ZEPHIR_INIT_VAR(&_4);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 793, &_4);
	ZEPHIR_INIT_VAR(&_5);
...
PHP_METHOD(Phalcon_Html_Escaper, setDoubleEncode)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 790, PH_NOISY_CC | PH_READONLY);
	if (doubleEncode) {
		ZVAL_BOOL(&_3, 1);
	} else {
		ZVAL_BOOL(&_3, 0);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_2, 791, PH_NOISY_CC | PH_READONLY);
	if (doubleEncode) {
		ZVAL_BOOL(&_5, 1);
	} else {
		ZVAL_BOOL(&_5, 0);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_3, 792, PH_NOISY_CC | PH_READONLY);
	if (doubleEncode) {
		ZVAL_BOOL(&_7, 1);
	} else {
		ZVAL_BOOL(&_7, 0);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_4, 793, PH_NOISY_CC | PH_READONLY);
	if (doubleEncode) {
		ZVAL_BOOL(&_9, 1);
	} else {
		ZVAL_BOOL(&_9, 0);
...
PHP_METHOD(Phalcon_Html_Escaper, setEncoding)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 791, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_2, "setencoding", NULL, 0, &encoding_zv);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_3, 792, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &_3, "setencoding", NULL, 0, &encoding_zv);
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_4, 793, PH_NOISY_CC | PH_READONLY);
