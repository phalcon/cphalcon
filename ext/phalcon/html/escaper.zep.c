...
PHP_METHOD(Phalcon_Html_Escaper, attributes)
{
	...
	ZVAL_LONG(&_2, 3);
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 339, &input, &_2, &_0, &_1);
...
PHP_METHOD(Phalcon_Html_Escaper, css)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 341, &input);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "doescapecss", NULL, 342, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper, detectEncoding)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _2)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_4$$5, "mb_detect_encoding", &_5, 343, &input, &charset, &__$true);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_6$$7, "mb_detect_encoding", &_5, 343, &input, &charset, &__$true);
				zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&charset);
	ZEPHIR_RETURN_CALL_FUNCTION("mb_detect_encoding", &_5, 343, &input);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper, html)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("htmlspecialchars", NULL, 339, &input, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper, js)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "normalizeencoding", NULL, 341, &input);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "doescapejs", NULL, 344, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper, normalizeEncoding)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "detectencoding", NULL, 345, &input);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "UTF-32");
	ZEPHIR_RETURN_CALL_FUNCTION("mb_convert_encoding", NULL, 346, &input, &_1, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Escaper, url)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 347, &input);
	zephir_check_call_status();
	RETURN_MM();
}
