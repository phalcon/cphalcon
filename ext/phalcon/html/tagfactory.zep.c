...
PHP_METHOD(Phalcon_Html_TagFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 854, escaper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 855, response);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 856, url);
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, phalcon_html_helper_doctype_ce);
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 857, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getdefaultservices", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 858, &_1);
...
PHP_METHOD(Phalcon_Html_TagFactory, newInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 859, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_value(&_2, &name_zv))) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 858, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 859, PH_NOISY_CC | PH_READONLY);
