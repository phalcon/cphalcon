...
PHP_METHOD(Phalcon_Html_TagFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 844, escaper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 845, response);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 846, url);
	ZEPHIR_INIT_VAR(&_0);
	object_init_ex(&_0, phalcon_html_helper_doctype_ce);
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 847, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getdefaultservices", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 848, &_1);
...
PHP_METHOD(Phalcon_Html_TagFactory, newInstance)
{
	...
	if (!(zephir_array_isset_value(&_2, &name_zv))) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 848, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 849, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Html_TagFactory, getDefaultServices)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 845, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&response, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 846, PH_NOISY_CC | PH_READONLY);
