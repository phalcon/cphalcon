...
PHP_METHOD(Phalcon_Html_TagFactory, getDefaultServices)
{
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	zephir_create_closure_ex(&_1, NULL, phalcon_34__closure_ce, SL("__invoke"));
	zephir_update_static_property_ce(phalcon_34__closure_ce, ZEND_STRL("escaper"), &escaper);
	zephir_update_static_property_ce(phalcon_34__closure_ce, ZEND_STRL("url"), &url);
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	zephir_create_closure_ex(&_1, NULL, phalcon_42__closure_ce, SL("__invoke"));
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	zephir_create_closure_ex(&_1, NULL, phalcon_76__closure_ce, SL("__invoke"));
	zephir_update_static_property_ce(phalcon_76__closure_ce, ZEND_STRL("escaper"), &escaper);
	zephir_update_static_property_ce(phalcon_76__closure_ce, ZEND_STRL("response"), &response);
