...
PHP_METHOD(Phalcon_Html_Tag, button) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinput", NULL, 191, &_0, &name, &parameters);
...
PHP_METHOD(Phalcon_Html_Tag, element) {
	...
	ZVAL_BOOL(&_1, 0);
	ZEPHIR_CALL_METHOD(&useEol, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "onlyStart");
	ZVAL_BOOL(&_1, 0);
	ZEPHIR_CALL_METHOD(&onlyStart, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "selfClose");
	ZVAL_BOOL(&_1, 0);
	ZEPHIR_CALL_METHOD(&selfClose, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&output, this_ptr, "renderattributes", NULL, 193, &_2, &parameters);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, elementClose) {
	...
	if (zephir_is_true(&useEol)) {
		...
		ZEPHIR_CONCAT_SVSV(return_value, "</", &tag, ">", &_2$$3);
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Html_Tag, form) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "url");
	ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 194, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "method");
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "post");
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_2);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("method"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_CALL_METHOD(&_3, &service, "get", NULL, 0, &action);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("action"), &_3, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_VAR(&params);
	if (zephir_array_isset_string_fetch(&params, &parameters, SL("parameters"), 0)) {
		ZEPHIR_INIT_VAR(&_4$$3);
		ZEPHIR_CONCAT_SV(&_4$$3, "?", &params);
		zephir_array_update_string(&parameters, SL("action"), &_4$$3, PH_COPY | PH_SEPARATE);
		zephir_array_unset_string(&parameters, SL("parameters"), PH_SEPARATE);
	}
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<form");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VS(&output, &_5, ">");
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", NULL, 119, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		ZVAL_LONG(&_2$$3, 6);
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "en_US.UTF-8");
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", NULL, 195, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "iconv", NULL, 196, &_3$$3, &_4$$3, &text);
		zephir_check_call_status();
	...
	ZVAL_BOOL(&_6, 1);
	ZEPHIR_CALL_METHOD(&lowercase, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_6);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	array_init(&_0);
	ZEPHIR_INIT_VAR(&_7);
	ZVAL_STRING(&_7, "replace");
	ZEPHIR_CALL_METHOD(&replace, this_ptr, "arraygetdefault", NULL, 192, &_7, &parameters, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "separator");
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, "-");
	ZEPHIR_CALL_METHOD(&separator, this_ptr, "arraygetdefault", NULL, 192, &_7, &parameters, &_8);
	zephir_check_call_status();
	if (!(ZEPHIR_IS_EMPTY(&replace))) {
		...
		ZVAL_STRING(&_12$$4, " ");
		ZEPHIR_CALL_FUNCTION(&to, "array_fill", NULL, 197, &_10$$4, &_11$$4, &_12$$4);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_8);
	ZVAL_STRING(&_8, "");
	ZEPHIR_CALL_FUNCTION(&output, "preg_replace", NULL, 22, &_7, &_8, &text);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_14, "preg_replace", NULL, 22, &_7, &separator, &output);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "extension_loaded", NULL, 119, &_7);
	zephir_check_call_status();
	if (zephir_is_true(&_14)) {
		ZVAL_LONG(&_15$$9, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 195, &_15$$9, &locale);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, getTitle) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *prepend_param = NULL, *append_param = NULL, item, items, output, title, appendTitle, prependTitle, separator, escaper, _0, _1, _2, prependArray$$4, *_3$$4, _4$$5, *_6$$8, _7$$9;
	...
	ZEPHIR_CALL_METHOD(&escaper, this_ptr, "getservice", NULL, 194, &_0);
	zephir_check_call_status();
	...
	if (prepend) {
		...
		if (!(ZEPHIR_IS_EMPTY(&prependTitle))) {
			ZEPHIR_CALL_FUNCTION(&prependArray$$4, "array_reverse", NULL, 198, &prependTitle);
			zephir_check_call_status();
			zephir_is_iterable(&prependArray$$4, 0, "phalcon/html/tag.zep", 461);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&prependArray$$4), _3$$4)
			{
				...
				zephir_check_call_status();
				zephir_array_append(&items, &_4$$5, PH_SEPARATE, "phalcon/html/tag.zep", 459);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&item);
		}
	}
	if (!(ZEPHIR_IS_EMPTY(&title))) {
		zephir_array_append(&items, &title, PH_SEPARATE, "phalcon/html/tag.zep", 465);
	}
	if (append) {
		ZEPHIR_OBS_VAR(&appendTitle);
		zephir_read_property(&appendTitle, this_ptr, SL("append"), PH_NOISY_CC);
		if (!(ZEPHIR_IS_EMPTY(&appendTitle))) {
			zephir_is_iterable(&appendTitle, 0, "phalcon/html/tag.zep", 475);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&appendTitle), _6$$8)
			{
				...
				zephir_check_call_status();
				zephir_array_append(&items, &_7$$9, PH_SEPARATE, "phalcon/html/tag.zep", 473);
			} ZEND_HASH_FOREACH_END();
			ZEPHIR_INIT_NVAR(&item);
		}
	}
...
PHP_METHOD(Phalcon_Html_Tag, image) {
	...
	ZVAL_BOOL(&_1, 1);
	ZEPHIR_CALL_METHOD(&local, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "src");
	ZEPHIR_CALL_METHOD(&src, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &url);
	zephir_check_call_status();
	if (zephir_is_true(&local)) {
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "url");
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 194, &_2$$3);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<img");
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderclosetag", NULL, 199);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, inputCheckbox) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinputchecked", NULL, 200, &_0, &name, &parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Html_Tag, javascript) {
	...
	zend_bool local = 0, _6;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval parameters;
	zval *url_param = NULL, *parameters_param = NULL, service, output, _0, _1, _2, _5, _7, _8, _9, _3$$3, _4$$3;
	zval url;
	zval *this_ptr = getThis();
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "arraygetdefault", NULL, 192, &_1, &parameters, &_2);
	zephir_check_call_status();
	local = zephir_get_boolval(&_0);
	if (local == 1) {
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "url");
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 194, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_4$$3, &service, "getstatic", NULL, 0, &url);
		zephir_check_call_status();
		zephir_array_update_string(&parameters, SL("src"), &_4$$3, PH_COPY | PH_SEPARATE);
	} else {
	...
	ZVAL_STRING(&_1, "type");
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "text/javascript");
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "arraygetdefault", NULL, 192, &_1, &parameters, &_5);
	zephir_check_call_status();
	...
	_6 = ZEPHIR_GE_LONG(&_2, 5);
	if (_6) {
		zephir_array_fetch_string(&_7, &parameters, SL("type"), PH_NOISY | PH_READONLY, "phalcon/html/tag.zep", 996 TSRMLS_CC);
		ZEPHIR_SINIT_VAR(_8);
		ZVAL_STRING(&_8, "text/javascript");
		_6 = ZEPHIR_IS_EQUAL(&_8, &_7);
	}
	if (_6) {
	...
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "renderattributes", NULL, 193, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZEPHIR_GET_CONSTANT(&_1, "PHP_EOL");
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VSV(&output, &_9, "></script>", &_1);
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, link) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "url");
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &url);
	zephir_check_call_status();
	zephir_get_strval(&url, &_1);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "text");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &text);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&text, &_2);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "local");
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(&local, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "query");
	ZVAL_NULL(&_3);
	ZEPHIR_CALL_METHOD(&query, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<a");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VSVS(&output, &_4, ">", &text, "</a>");
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderTitle) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "gettitle", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_GET_CONSTANT(&_1, "PHP_EOL");
	ZEPHIR_CONCAT_SVSV(return_value, "<title>", &_0, "</title>", &_1);
	RETURN_MM();
...
PHP_METHOD(Phalcon_Html_Tag, select) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "id");
	ZEPHIR_CALL_METHOD(&id, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &name);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "name");
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &name);
	zephir_check_call_status();
	zephir_get_strval(&name, &_1);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "useEmpty");
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_METHOD(&useEmpty, this_ptr, "arraygetdefault", NULL, 192, &_0, &parameters, &_2);
	zephir_check_call_status();
	...
	if (_3) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_html_exception_ce, "The dataset must be either an array or a ResultsetInterface", "phalcon/html/tag.zep", 1190);
		return;
	}
	if (Z_TYPE_P(data) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(&using, this_ptr, "arraygetdefault", NULL, 192, &_5$$4, &parameters, &_4$$4);
		zephir_check_call_status();
		...
		if (_6$$4) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_html_exception_ce, "The 'using' parameter is not a valid array", "phalcon/html/tag.zep", 1201);
			return;
		}
	}
	if (zephir_is_true(&useEmpty)) {
		...
		ZEPHIR_CALL_METHOD(&emptyText, this_ptr, "arraygetdefault", NULL, 192, &_7$$7, &parameters, &_8$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_7$$7);
		ZVAL_STRING(&_7$$7, "emptyValue");
		ZEPHIR_INIT_NVAR(&_8$$7);
		ZVAL_STRING(&_8$$7, "");
		ZEPHIR_CALL_METHOD(&emptyValue, this_ptr, "arraygetdefault", NULL, 192, &_7$$7, &parameters, &_8$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_7$$7);
		ZEPHIR_GET_CONSTANT(&_7$$7, "PHP_EOL");
		ZEPHIR_INIT_VAR(&_9$$7);
		ZEPHIR_CONCAT_SV(&_9$$7, "\t<option value=\"%s\">%s</option>", &_7$$7);
		ZEPHIR_CALL_FUNCTION(&outputEmpty, "sprintf", NULL, 135, &_9$$7, &emptyValue, &emptyText);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<select");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZEPHIR_GET_CONSTANT(&_0, "PHP_EOL");
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VSVV(&output, &_10, ">", &_0, &outputEmpty);
	if (Z_TYPE_P(data) == IS_OBJECT) {
		ZEPHIR_INIT_VAR(&_12$$10);
		ZEPHIR_GET_CONSTANT(&_12$$10, "PHP_EOL");
		ZEPHIR_INIT_VAR(&_13$$10);
		ZEPHIR_CONCAT_SV(&_13$$10, "</option>", &_12$$10);
		ZEPHIR_CALL_METHOD(&_11$$10, this_ptr, "renderselectresultset", NULL, 201, data, &using, &value, &_13$$10);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_VAR(&_16$$11);
		ZEPHIR_CONCAT_SV(&_16$$11, "</option>", &_15$$11);
		ZEPHIR_CALL_METHOD(&_14$$11, this_ptr, "renderselectarray", NULL, 202, data, &value, &_16$$11);
		zephir_check_call_status();
		zephir_concat_self(&output, &_14$$11 TSRMLS_CC);
	} else {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_html_exception_ce, "Invalid data provided to SELECT helper", "phalcon/html/tag.zep", 1242);
		return;
	}
...
PHP_METHOD(Phalcon_Html_Tag, setAttribute) {
	...
	if (Z_TYPE_P(value) != IS_NULL) {
		...
		if (_0$$3) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_html_exception_ce, "Only scalar values can be assigned to UI components", "phalcon/html/tag.zep", 1269);
			return;
		}
	}
...
PHP_METHOD(Phalcon_Html_Tag, stylesheet) {
	...
	if (local == 1) {
		...
		ZEPHIR_CALL_METHOD(&_4$$3, &service, "getstatic", NULL, 0, &url);
		zephir_check_call_status();
		zephir_array_update_string(&parameters, SL("href"), &_4$$3, PH_COPY | PH_SEPARATE);
	} else {
	...
	if (!(zephir_array_isset_string(&parameters, SL("rel")))) {
		...
		zephir_array_update_string(&parameters, SL("rel"), &_5$$5, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "type");
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "text/css");
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "arraygetdefault", NULL, 192, &_1, &parameters, &_6);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("type"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<link");
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "renderattributes", NULL, 193, &_1, &parameters);
	zephir_check_call_status();
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "renderclosetag", NULL, 199, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VV(&output, &_7, &_8);
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, textArea) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval parameters;
	zval *name_param = NULL, *parameters_param = NULL, content, output, _0, _1, _2, _4, _5, _3$$4;
	zval name;
	zval *this_ptr = getThis();
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "id");
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "arraygetdefault", NULL, 192, &_1, &parameters, &name);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("id"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "name");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "arraygetdefault", NULL, 192, &_1, &parameters, &name);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("name"), &_2, PH_COPY | PH_SEPARATE);
	if (zephir_array_isset_string(&parameters, SL("value"))) {
		ZEPHIR_OBS_VAR(&content);
		zephir_array_fetch_string(&content, &parameters, SL("value"), PH_NOISY, "phalcon/html/tag.zep", 1472 TSRMLS_CC);
		zephir_array_unset_string(&parameters, SL("value"), PH_SEPARATE);
	} else {
		zephir_array_fetch_string(&_3$$4, &parameters, SL("id"), PH_NOISY | PH_READONLY, "phalcon/html/tag.zep", 1475 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&content, this_ptr, "getvalue", NULL, 0, &_3$$4, &parameters);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<textarea");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderattributes", NULL, 193, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "htmlspecialchars", NULL, 172, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VSVS(&output, &_4, ">", &_5, "</textarea>");
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, getService) {
	...
	if (Z_TYPE_P(&service) != IS_OBJECT) {
		...
		if (Z_TYPE_P(&container) != IS_OBJECT) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$6, "__construct", NULL, 3, &_2$$6);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$6, "phalcon/html/tag.zep", 1517 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Phalcon_Html_Tag, renderAttributes) {
	...
	ZEPHIR_CALL_FUNCTION(&intersect, "array_intersect_key", NULL, 203, &order, &attributes);
	zephir_check_call_status();
	...
	zephir_is_iterable(&attrs, 0, "phalcon/html/tag.zep", 1575);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&attrs), _2, _3, _1)
	{
		...
		if (_4$$3) {
			...
			if (_5$$4) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$5, "phalcon/html/tag.zep", 1564 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
...
PHP_METHOD(Phalcon_Html_Tag, renderInput) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getvalue", NULL, 0, &id, &parameters);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("value"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<input");
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "renderclosetag", NULL, 199);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
	ZEPHIR_CONCAT_VV(&output, &_2, &_3);
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderInputChecked) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval parameters;
	zval *type_param = NULL, name, *name_param = NULL, *parameters_param = NULL, currentValue, id, output, value, _0, _4, _5, _2$$4, _3$$6;
	zval type;
	zval *this_ptr = getThis();
	...
	if (zephir_array_isset_string_fetch(&currentValue, &parameters, SL("value"), 0)) {
		...
		if (_1$$3) {
			_1$$3 = ZEPHIR_IS_IDENTICAL(&currentValue, &value);
		}
		if (_1$$3) {
			ZEPHIR_INIT_VAR(&_2$$4);
			ZVAL_STRING(&_2$$4, "checked");
			zephir_array_update_string(&parameters, SL("checked"), &_2$$4, PH_COPY | PH_SEPARATE);
		}
		...
		if (Z_TYPE_P(&value) != IS_NULL) {
			...
			ZVAL_STRING(&_3$$6, "checked");
			zephir_array_update_string(&parameters, SL("checked"), &_3$$6, PH_COPY | PH_SEPARATE);
		}
	...
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderattributes", NULL, 193, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderclosetag", NULL, 199);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderSelectArray) {
	...
	ZEPHIR_INIT_VAR(&output);
	ZVAL_STRING(&output, "");
	zephir_is_iterable(&options, 0, "phalcon/html/tag.zep", 1704);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _1, _2, _0)
	{
		...
		ZEPHIR_CALL_FUNCTION(&label, "htmlspecialchars", &_3, 172, &optionValue);
		zephir_check_call_status();
		if (Z_TYPE_P(&optionText) == IS_ARRAY) {
			ZEPHIR_INIT_NVAR(&_4$$4);
			ZEPHIR_GET_CONSTANT(&_4$$4, "PHP_EOL");
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "renderselectarray", &_6, 202, &optionText, value, &closeOption);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, renderSelectResultset) {
	...
	if (Z_TYPE_P(using) == IS_ARRAY) {
		...
		zephir_array_fetch_long(&optionValue, using, 0, PH_NOISY, "phalcon/html/tag.zep", 1723 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&optionText);
		zephir_array_fetch_long(&optionText, using, 1, PH_NOISY, "phalcon/html/tag.zep", 1724 TSRMLS_CC);
	}
		...
		if (Z_TYPE_P(using) == IS_ARRAY) {
			if (Z_TYPE_P(&option) == IS_OBJECT) {
				...
				if (Z_TYPE_P(&option) == IS_ARRAY) {
					zephir_array_fetch(&_4$$10, &option, &optionValue, PH_NOISY | PH_READONLY, "phalcon/html/tag.zep", 1740 TSRMLS_CC);
					ZEPHIR_CPY_WRT(&optionValue, &_4$$10);
					zephir_array_fetch(&_4$$10, &option, &optionText, PH_NOISY | PH_READONLY, "phalcon/html/tag.zep", 1741 TSRMLS_CC);
					ZEPHIR_CPY_WRT(&optionText, &_4$$10);
				} else {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_html_exception_ce, "Resultset returned an invalid value", "phalcon/html/tag.zep", 1743);
					return;
				}
			}
