...
PHP_METHOD(Phalcon_Html_Tag, button) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinput", NULL, 213, &_0, &name, &parameters);
...
PHP_METHOD(Phalcon_Html_Tag, element) {
	...
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_CE_STATIC(&useEol, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "onlyStart");
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_CE_STATIC(&onlyStart, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "selfClose");
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_CE_STATIC(&selfClose, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &_2);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&output, this_ptr, "renderattributes", NULL, 214, &_3, &parameters);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, form) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "url");
	ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 215, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "method");
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "post");
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_utility_ce, "arraygetdefault", &_2, 0, &_0, &parameters, &_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<form");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "renderattributes", NULL, 214, &_0, &parameters);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", NULL, 137, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		ZVAL_LONG(&_2$$3, 6);
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "en_US.UTF-8");
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", NULL, 216, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "iconv", NULL, 217, &_3$$3, &_4$$3, &text);
		zephir_check_call_status();
	...
	ZVAL_BOOL(&_7, 1);
	ZEPHIR_CALL_CE_STATIC(&lowercase, phalcon_utility_ce, "arraygetdefault", &_6, 0, &_0, &parameters, &_7);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	array_init(&_0);
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, "replace");
	ZEPHIR_CALL_CE_STATIC(&replace, phalcon_utility_ce, "arraygetdefault", &_6, 0, &_8, &parameters, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_8);
	ZVAL_STRING(&_8, "separator");
	ZEPHIR_INIT_VAR(&_9);
	ZVAL_STRING(&_9, "-");
	ZEPHIR_CALL_CE_STATIC(&separator, phalcon_utility_ce, "arraygetdefault", &_6, 0, &_8, &parameters, &_9);
	zephir_check_call_status();
	if (!(ZEPHIR_IS_EMPTY(&replace))) {
		...
		ZVAL_STRING(&_13$$4, " ");
		ZEPHIR_CALL_FUNCTION(&to, "array_fill", NULL, 218, &_11$$4, &_12$$4, &_13$$4);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_15, "extension_loaded", NULL, 137, &_8);
	zephir_check_call_status();
	if (zephir_is_true(&_15)) {
		ZVAL_LONG(&_16$$9, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 216, &_16$$9, &locale);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, getTitle) {
	...
	ZEPHIR_CALL_METHOD(&escaper, this_ptr, "getservice", NULL, 215, &_0);
	zephir_check_call_status();
	...
	if (prepend) {
		...
		if (!(ZEPHIR_IS_EMPTY(&prependTitle))) {
			ZEPHIR_CALL_FUNCTION(&prependArray$$4, "array_reverse", NULL, 219, &prependTitle);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, image) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_CALL_CE_STATIC(&local, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "src");
	ZEPHIR_CALL_CE_STATIC(&src, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &url);
	zephir_check_call_status();
	if (zephir_is_true(&local)) {
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "url");
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 215, &_3$$3);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<img");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderattributes", NULL, 214, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderclosetag", NULL, 220);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, inputCheckbox) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinputchecked", NULL, 221, &_0, &name, &parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Html_Tag, javascript) {
	...
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_utility_ce, "arraygetdefault", &_1, 0, &_2, &parameters, &_3);
	zephir_check_call_status();
	local = zephir_get_boolval(&_0);
	if (local == 1) {
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "url");
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 215, &_4$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_utility_ce, "arraygetdefault", &_1, 0, &_2, &parameters, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "renderattributes", NULL, 214, &_2, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Phalcon_Html_Tag, link) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "url");
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_utility_ce, "arraygetdefault", &_2, 0, &_0, &parameters, &url);
	zephir_check_call_status();
	zephir_get_strval(&url, &_1);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "text");
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_utility_ce, "arraygetdefault", &_2, 0, &_0, &parameters, &text);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&text, &_3);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "local");
	ZVAL_BOOL(&_4, 1);
	ZEPHIR_CALL_CE_STATIC(&local, phalcon_utility_ce, "arraygetdefault", &_2, 0, &_0, &parameters, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "query");
	ZVAL_NULL(&_4);
	ZEPHIR_CALL_CE_STATIC(&query, phalcon_utility_ce, "arraygetdefault", &_2, 0, &_0, &parameters, &_4);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<a");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 214, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, select) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "id");
	ZEPHIR_CALL_CE_STATIC(&id, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &name);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "name");
	ZEPHIR_CALL_CE_STATIC(&_2, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &name);
	zephir_check_call_status();
	zephir_get_strval(&name, &_2);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "useEmpty");
	ZVAL_BOOL(&_3, 0);
	ZEPHIR_CALL_CE_STATIC(&useEmpty, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_1, &parameters, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_OBJECT) {
		...
		ZEPHIR_CALL_CE_STATIC(&using, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_6$$4, &parameters, &_5$$4);
		zephir_check_call_status();
	...
	if (zephir_is_true(&useEmpty)) {
		...
		ZEPHIR_CALL_CE_STATIC(&emptyText, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_8$$7, &parameters, &_9$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_8$$7);
		ZVAL_STRING(&_8$$7, "emptyValue");
		ZEPHIR_INIT_NVAR(&_9$$7);
		ZVAL_STRING(&_9$$7, "");
		ZEPHIR_CALL_CE_STATIC(&emptyValue, phalcon_utility_ce, "arraygetdefault", &_0, 0, &_8$$7, &parameters, &_9$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_8$$7);
		ZEPHIR_GET_CONSTANT(&_8$$7, "PHP_EOL");
		ZEPHIR_INIT_VAR(&_10$$7);
		ZEPHIR_CONCAT_SV(&_10$$7, "\t<option value=\"%s\">%s</option>", &_8$$7);
		ZEPHIR_CALL_FUNCTION(&outputEmpty, "sprintf", NULL, 153, &_10$$7, &emptyValue, &emptyText);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_11, this_ptr, "renderattributes", NULL, 214, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	...
	if (Z_TYPE_P(data) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(&_12$$10, this_ptr, "renderselectresultset", NULL, 222, data, &using, &value, &_14$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_15$$11, this_ptr, "renderselectarray", NULL, 223, data, &value, &_17$$11);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, stylesheet) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_utility_ce, "arraygetdefault", &_1, 0, &_2, &parameters, &_7);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("type"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "<link");
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "renderattributes", NULL, 214, &_2, &parameters);
	zephir_check_call_status();
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "renderclosetag", NULL, 220, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, textArea) {
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "id");
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_utility_ce, "arraygetdefault", &_1, 0, &_2, &parameters, &name);
	zephir_check_call_status();
	zephir_array_update_string(&parameters, SL("id"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "name");
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_utility_ce, "arraygetdefault", &_1, 0, &_2, &parameters, &name);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 214, &_2, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "htmlspecialchars", NULL, 190, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderInput) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "renderattributes", NULL, 214, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderclosetag", NULL, 220);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderInputChecked) {
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<input");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 214, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "renderclosetag", NULL, 220);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderSelectArray) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _1, _2, _0)
	{
		...
		ZEPHIR_CALL_FUNCTION(&label, "htmlspecialchars", &_3, 190, &optionValue);
		zephir_check_call_status();
		if (Z_TYPE_P(&optionText) == IS_ARRAY) {
			ZEPHIR_INIT_NVAR(&_4$$4);
			ZEPHIR_GET_CONSTANT(&_4$$4, "PHP_EOL");
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "renderselectarray", &_6, 223, &optionText, value, &closeOption);
			zephir_check_call_status();
