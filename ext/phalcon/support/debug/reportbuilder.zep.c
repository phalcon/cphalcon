...
PHP_METHOD(Phalcon_Support_Debug_ReportBuilder, build)
{
	...
	ZEPHIR_CALL_METHOD(&_16, &getter, "__invoke", NULL, 292, &blacklist, &_18, &_17);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_20, &getter, "__invoke", NULL, 292, &blacklist, &_21, &_18);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Support_Debug_ReportBuilder, resolveFunctionLink)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 219, &functionName_zv);
	zephir_check_call_status();
