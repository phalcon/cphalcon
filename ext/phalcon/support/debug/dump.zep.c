...
PHP_METHOD(Phalcon_Support_Debug_Dump, setStyles)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1345, &_1);
...
PHP_METHOD(Phalcon_Support_Debug_Dump, output)
{
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		if (_40$$9) {
			...
			zephir_read_property_cached(&_42$$9, this_ptr, _zephir_prop_0, 1344, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&_33$$9);
		zephir_get_class(&_33$$9, variable, 0);
		zephir_read_property_cached(&_95$$9, this_ptr, _zephir_prop_1, 1346, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Support_Debug_Dump, getTemplate)
{
	...
	ZVAL_STR_COPY(&name_zv, name);
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1347, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_value(&_1, &name_zv)) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1347, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_NVAR(&_0);
