...
PHP_METHOD(Phalcon_Support_Debug_Dump, __construct)
{
	...
	if (detailed) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1369, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Support_Debug_Dump, setDetailed)
{
	...
	if (flag) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1369, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1369, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Support_Debug_Dump, setStyles)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1370, &_1);
...
PHP_METHOD(Phalcon_Support_Debug_Dump, output)
{
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		if (Z_TYPE_P(_4$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_4$$4), _6$$4, _7$$4, _5$$4)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_13$$5, "htmlspecialchars", &_15, 200, &_14$$5, &_8$$5, &_11$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_28$$7, "htmlspecialchars", &_15, 200, &_29$$7, &_24$$7, &_26$$7);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		if (_44$$9) {
			...
			zephir_read_property_cached(&_46$$9, this_ptr, _zephir_prop_0, 1369, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&_37$$9);
		zephir_get_class(&_37$$9, variable, 0);
		zephir_read_property_cached(&_103$$9, this_ptr, _zephir_prop_1, 1371, PH_NOISY_CC | PH_READONLY);
