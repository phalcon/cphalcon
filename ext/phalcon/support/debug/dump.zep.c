...
PHP_METHOD(Phalcon_Support_Debug_Dump, output)
{
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		if (zephir_instance_of_ev(variable, phalcon_di_diinterface_ce)) {
			...
			if (_48$$9) {
				ZEPHIR_CALL_FUNCTION(&_52$$12, "get_object_vars", NULL, 335, variable);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &reflect, "__construct", NULL, 239, variable);
				zephir_check_call_status();
				ZVAL_LONG(&_76$$15, ((1 | 2) | 4));
				ZEPHIR_CALL_METHOD(&props, &reflect, "getproperties", NULL, 347, &_76$$15);
				zephir_check_call_status();
