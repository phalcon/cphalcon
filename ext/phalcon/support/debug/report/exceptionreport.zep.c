...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, __construct)
{
	...
	ZVAL_STR(&uri_zv, uri);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1364, &className_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1365, &message_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1366, &file_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, line);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1367, &_0);
	if (showBackTrace) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1368, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1368, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1369, &uri_zv);
}
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, hasVariables)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1370, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, setBacktrace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1371, &backtrace);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, setIncludedFiles)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1372, &includedFiles);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, setRequest)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1375, &request);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, setServer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1376, &server);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug_Report_ExceptionReport, setVariables)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1370, &variables);
	RETURN_THIS();
}
