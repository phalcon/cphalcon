...
PHP_METHOD(Phalcon_Support_Debug_Report_BacktraceItem, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1359, &functionName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1360, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1361, &className_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1362, &classLink_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1363, &functionLink_zv);
	if (hasArgs) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1364, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1364, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 1365, &args);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 1366, &file_zv);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, line);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 1367, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1368, fragment);
	ZEPHIR_MM_RESTORE();
}
