...
ZEPHIR_INIT_FUNCS(phalcon_support_debug_reportbuilder_method_entry) {
	...
	PHP_ME(Phalcon_Support_Debug_ReportBuilder, phpExtensionLoaded, arginfo_phalcon_support_debug_reportbuilder_phpextensionloaded, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Support_Debug_ReportBuilder, phpFunctionExists, arginfo_phalcon_support_debug_reportbuilder_phpfunctionexists, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
