...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Support\\Helper\\Json\\Exceptions, JsonDecodeError, phalcon, support_helper_json_exceptions_jsondecodeerror, spl_ce_InvalidArgumentException, phalcon_support_helper_json_exceptions_jsondecodeerror_method_entry, 0);
...
PHP_METHOD(Phalcon_Support_Helper_Json_Exceptions_JsonDecodeError, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_CONCAT_SV(&_0, "json_decode error: ", &message_zv);
	ZVAL_LONG(&_1, code);
	ZEPHIR_CALL_PARENT(NULL, phalcon_support_helper_json_exceptions_jsondecodeerror_ce, getThis(), "__construct", NULL, 0, &_0, &_1, previous);
