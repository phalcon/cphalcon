...
PHP_METHOD(Phalcon_Support_Helper_Json_Encode, __invoke)
{
	...
	zval *data, data_sub, *options_param = NULL, *depth_param = NULL, ex, _2, _0$$3, _1$$3, _3$$4, _4$$4, _5$$4;
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_2, SL("JsonException"))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$4, "phalcon/Support/Helper/Json/Encode.zep", 55);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
 ...
 * @link https://www.php.net/manual/en/function.json-encode.php
 */
PHP_METHOD(Phalcon_Support_Helper_Json_Encode, toEncode)
{
	zval _4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long options, depth, ZEPHIR_LAST_CALL_STATUS;
