...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_support_helper_str_startswith_tostartswith, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, haystack, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, needle, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, ignoreCase, _IS_BOOL, 0, "true")
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_support_helper_str_startswith_method_entry) {
	...
	PHP_ME(Phalcon_Support_Helper_Str_StartsWith, toStartsWith, arginfo_phalcon_support_helper_str_startswith_tostartswith, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_FE_END
};
