...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Support\\Helper\\Str, StartsWith, phalcon, support_helper_str_startswith, phalcon_support_helper_str_startswith_method_entry, 0);
 ...
 * @return bool
 */
PHP_METHOD(Phalcon_Support_Helper_Str_StartsWith, toStartsWith)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool ignoreCase;
