...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_support_helper_str_friendly_tolower, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, text, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_support_helper_str_friendly_method_entry) {
	...
	PHP_ME(Phalcon_Support_Helper_Str_Friendly, toLower, arginfo_phalcon_support_helper_str_friendly_tolower, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_FE_END
};
