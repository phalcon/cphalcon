...
PHP_METHOD(Phalcon_Support_Helper_Str_Uncamelize, __invoke)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "lcfirst", NULL, 166, &text_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "/[A-Z]/");
	ZEPHIR_CALL_FUNCTION(&_3, "preg_replace", NULL, 90, &_2, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 15, &_3);
	zephir_check_call_status();
	RETURN_MM();
}
