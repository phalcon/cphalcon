...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Support\\Helper\\Arr, ValidateAll, phalcon, support_helper_arr_validateall, phalcon_support_helper_arr_validateall_method_entry, 0);
 ...
 * @return array
 */
PHP_METHOD(Phalcon_Support_Helper_Arr_ValidateAll, toFilter)
{
	zend_bool _0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
