...
ZEPHIR_INIT_FUNCS(phalcon_support_helper_arr_group_method_entry) {
	...
	PHP_ME(Phalcon_Support_Helper_Arr_Group, phpExtensionLoaded, arginfo_phalcon_support_helper_arr_group_phpextensionloaded, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Support_Helper_Arr_Group, phpFunctionExists, arginfo_phalcon_support_helper_arr_group_phpfunctionexists, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
