...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Support\\Helper\\Arr, ValidateAny, phalcon, support_helper_arr_validateany, phalcon_support_helper_arr_validateany_method_entry, 0);
