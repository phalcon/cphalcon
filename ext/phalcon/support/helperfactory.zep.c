...
PHP_METHOD(Phalcon_Support_HelperFactory, newInstance)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1353, PH_NOISY_CC | PH_READONLY);
	zephir_array_fetch(&_4, &_3, &name_zv, PH_NOISY | PH_READONLY, "phalcon/Support/HelperFactory.zep", 118);
	RETURN_CTOR(&_4);
}
