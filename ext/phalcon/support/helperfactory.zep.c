...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Support, HelperFactory, phalcon, support_helperfactory, phalcon_support_helperfactory_method_entry, 0);
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_support_helperfactory_ce, SL("instances"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_support_helperfactory_ce, SL("mapper"), &_zc0, ZEND_ACC_PRIVATE, MAY_BE_ARRAY, NULL, 0);
	}
 ...
 * @throws Exception
 */
PHP_METHOD(Phalcon_Support_HelperFactory, getCachedInstance)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1384, PH_NOISY_CC | PH_READONLY);
 ...
 * @throws Exception
 */
PHP_METHOD(Phalcon_Support_HelperFactory, getService)
{
	zval _4$$3;
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1385, PH_NOISY_CC | PH_READONLY);
 ...
 */
PHP_METHOD(Phalcon_Support_HelperFactory, init)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1385, &_0);
	ZEPHIR_MM_RESTORE();
}
