...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_support_helperfactory_getcachedinstance, 0, 1, MAY_BE_OBJECT)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_VARIADIC_INFO(0, arguments)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_support_helperfactory_getservice, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_support_helperfactory_init, 0, 0, IS_VOID, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_support_helperfactory_method_entry) {
	...
	PHP_ME(Phalcon_Support_HelperFactory, getCachedInstance, arginfo_phalcon_support_helperfactory_getcachedinstance, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Support_HelperFactory, getService, arginfo_phalcon_support_helperfactory_getservice, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Support_HelperFactory, init, arginfo_phalcon_support_helperfactory_init, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
