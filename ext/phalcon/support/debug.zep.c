...
PHP_METHOD(Phalcon_Support_Debug, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1333, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Support_Debug, renderHtml)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1336, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1337, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_4, 1338, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_5, 1339, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_6, 1335, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_7, 1334, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Support_Debug, setBlacklist)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1336, &result);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug, setRenderer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1332, renderer);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFileFragment)
{
	...
	if (showFileFragment) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1339, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1339, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFiles)
{
	...
	if (showFiles) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1338, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1338, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setUri)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&uri_zv, uri);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1335, &uri_zv);
	RETURN_THISW();
}
