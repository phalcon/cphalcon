...
PHP_METHOD(Phalcon_Support_Debug, listenLowSeverity)
{
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 280, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
...
PHP_METHOD(Phalcon_Support_Debug, setBlacklist)
{
	...
	ZEPHIR_CALL_METHOD(&area, &getter, "__invoke", NULL, 295, &blacklist, &_1, &_0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&area, &getter, "__invoke", NULL, 295, &blacklist, &_10, &_1);
	zephir_check_call_status();
