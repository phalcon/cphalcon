...
PHP_METHOD(Phalcon_Support_Debug, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1361, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Support_Debug, clearVars)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1362, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug, renderHtml)
{
	...
	zephir_fetch_params(1, 1, 0, &exception);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1360, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1361, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1364, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1365, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_4, 1366, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_5, 1367, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_6, 1363, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_7, 1362, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Support_Debug, setBlacklist)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1364, &result);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug, setRenderer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1360, renderer);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowBackTrace)
{
	...
	if (showBackTrace) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1365, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1365, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFileFragment)
{
	...
	if (showFileFragment) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1367, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1367, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFiles)
{
	...
	if (showFiles) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1366, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1366, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setUri)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&uri_zv, uri);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1363, &uri_zv);
	RETURN_THISW();
}
