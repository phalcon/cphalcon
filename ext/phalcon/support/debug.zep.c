...
PHP_METHOD(Phalcon_Support_Debug, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1326, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Support_Debug, clearVars)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1327, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug, getCssSources)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1328, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Support_Debug, renderHtml)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1329, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1330, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_4, 1331, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_5, 1332, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_6, 1328, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_7, 1327, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Support_Debug, setBlacklist)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1329, &result);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Support_Debug, setRenderer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1325, renderer);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFileFragment)
{
	...
	if (showFileFragment) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1332, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1332, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setShowFiles)
{
	...
	if (showFiles) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1331, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1331, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Support_Debug, setUri)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&uri_zv, uri);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1328, &uri_zv);
	RETURN_THISW();
}
