...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_storage_adapterfactory_getcachedinstance, 0, 1, MAY_BE_OBJECT)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_VARIADIC_INFO(0, arguments)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_storage_adapterfactory_getservice, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_storage_adapterfactory_init, 0, 0, IS_VOID, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_storage_adapterfactory_method_entry) {
	...
	PHP_ME(Phalcon_Storage_AdapterFactory, getCachedInstance, arginfo_phalcon_storage_adapterfactory_getcachedinstance, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_AdapterFactory, getService, arginfo_phalcon_storage_adapterfactory_getservice, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_AdapterFactory, init, arginfo_phalcon_storage_adapterfactory_init, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
