...
PHP_METHOD(Phalcon_Storage_SerializerFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1342, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_SerializerFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1343, PH_NOISY_CC | PH_READONLY);
