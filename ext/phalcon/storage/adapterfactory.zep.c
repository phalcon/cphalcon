...
PHP_METHOD(Phalcon_Storage_AdapterFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1334, factory);
...
PHP_METHOD(Phalcon_Storage_AdapterFactory, newInstance)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1334, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Storage_AdapterFactory, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1335, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_AdapterFactory, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1336, PH_NOISY_CC | PH_READONLY);
