...
PHP_METHOD(Phalcon_Storage_AdapterFactory, newInstance) {
	...
	if (!(zephir_array_isset(&_0, &name))) {
		...
		zephir_array_fetch(&definition, &_1$$3, &name, PH_NOISY | PH_READONLY, "phalcon/Storage/AdapterFactory.zep", 44 TSRMLS_CC);
	...
	zephir_array_fetch(&_7, &_6, &name, PH_NOISY | PH_READONLY, "phalcon/Storage/AdapterFactory.zep", 48 TSRMLS_CC);
	RETURN_CTOR(&_7);
