...
PHP_METHOD(Phalcon_Storage_Serializer_Igbinary, unserialize)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, ">=");
	ZEPHIR_CALL_FUNCTION(&_2, "version_compare", NULL, 90, &version, &_0, &_1);
	zephir_check_call_status();
	if (zephir_is_true(&_2)) {
		ZEPHIR_INIT_VAR(&_3$$3);
		ZEPHIR_INIT_NVAR(&_3$$3);
		zephir_create_closure_ex(&_3$$3, NULL, phalcon_8__closure_ce, SL("__invoke"));
		ZVAL_LONG(&_4$$3, 2);
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 91, &_3$$3, &_4$$3);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_5$$4);
		ZEPHIR_INIT_NVAR(&_5$$4);
		zephir_create_closure_ex(&_5$$4, NULL, phalcon_9__closure_ce, SL("__invoke"));
		ZVAL_LONG(&_6$$4, 2);
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 91, &_5$$4, &_6$$4);
		zephir_check_call_status();
	}
