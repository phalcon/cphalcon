...
PHP_METHOD(Phalcon_Storage_Serializer_Igbinary, unserialize)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		if (zephir_is_true(&_3$$4)) {
			...
			zephir_create_closure_ex(&_4$$5, NULL, phalcon_5__closure_ce, SL("__invoke"));
			ZVAL_LONG(&_5$$5, 2);
			...
			zephir_create_closure_ex(&_6$$6, NULL, phalcon_6__closure_ce, SL("__invoke"));
			ZVAL_LONG(&_7$$6, 2);
...
PHP_METHOD(Phalcon_Storage_Serializer_Igbinary, phpIgbinarySerialize)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("igbinary_serialize", NULL, 163, value);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Serializer_Igbinary, doUnserialize)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("igbinary_unserialize", NULL, 164, value);
	zephir_check_call_status();
	RETURN_MM();
}
