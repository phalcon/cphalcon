...
PHP_METHOD(Phalcon_Storage_Serializer_Base64, serialize)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1309, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_Serializer_Base64, unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1309, &result);
	ZEPHIR_MM_RESTORE();
}
