...
PHP_METHOD(Phalcon_Storage_Serializer_Json, serialize) {
	...
	if (_1) {
		...
		zephir_throw_exception_debug(&_3$$3, "/home/nikos/Work/niden/cphalcon/phalcon/Storage/Serializer/Json.zep", 28);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Storage_Serializer_Json, unserialize) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_helper_json_ce, "decode", &_1, 177, data);
	zephir_check_call_status();
