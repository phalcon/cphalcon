...
PHP_METHOD(Phalcon_Storage_Serializer_Json, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1312, &_1);
...
PHP_METHOD(Phalcon_Storage_Serializer_Json, serialize)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1313, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "isserializable", NULL, 0, &_1);
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		RETURN_MM_MEMBER(getThis(), "data");
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1311, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1313, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_Serializer_Json, unserialize)
{
	...
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1313, data);
	} else {
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_1, 1312, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2$$4, &_1$$4, "__invoke", NULL, 0, data);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1313, &_2$$4);
	}
	ZEPHIR_MM_RESTORE();
}
