...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_storage_serializerfactory_getcachedinstance, 0, 1, MAY_BE_OBJECT)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
	ZEND_ARG_VARIADIC_INFO(0, arguments)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_storage_serializerfactory_getservice, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, name, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_storage_serializerfactory_init, 0, 0, IS_VOID, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_storage_serializerfactory_method_entry) {
	...
	PHP_ME(Phalcon_Storage_SerializerFactory, getCachedInstance, arginfo_phalcon_storage_serializerfactory_getcachedinstance, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_SerializerFactory, getService, arginfo_phalcon_storage_serializerfactory_getservice, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_SerializerFactory, init, arginfo_phalcon_storage_serializerfactory_init, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
