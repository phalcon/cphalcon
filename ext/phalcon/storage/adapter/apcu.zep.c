...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, clear)
{
	...
	if (EXPECTED(_1 != NULL)) {
		...
		zephir_array_fetch_string(&_3$$4, &item, SL("key"), PH_NOISY | PH_READONLY, "phalcon/Storage/Adapter/Apcu.zep", 69);
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, getKeys)
{
	...
	if (EXPECTED(_1 != NULL)) {
		...
		zephir_array_fetch_string(&_2$$4, &item, SL("key"), PH_NOISY | PH_READONLY, "phalcon/Storage/Adapter/Apcu.zep", 97);
		zephir_array_append(&results, &_2$$4, PH_SEPARATE, "phalcon/Storage/Adapter/Apcu.zep", 97);
	}
	zend_iterator_dtor(_1);
	}
	RETURN_CTOR(&results);
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, doDecrement)
{
	...
	zval key_zv, *value_param = NULL, result, _0, _1, _2;
	zend_string *key = NULL;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, doDeleteMultiple)
{
	...
	zephir_is_iterable(&keys, 0, "phalcon/Storage/Adapter/Apcu.zep", 152);
