...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, decrement) {
	...
	zephir_check_call_status();
	ZVAL_LONG(&_1, value);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_dec", NULL, 117, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, delete) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getprefixedkey", NULL, 0, &key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_delete", NULL, 116, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, get) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getprefixedkey", NULL, 0, &key);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&content, "apcu_fetch", NULL, 118, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, has) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getprefixedkey", NULL, 0, &key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_exists", NULL, 119, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, increment) {
	...
	zephir_check_call_status();
	ZVAL_LONG(&_1, value);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_inc", NULL, 120, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, set) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_store", NULL, 121, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
