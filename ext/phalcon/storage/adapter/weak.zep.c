...
PHP_METHOD(Phalcon_Storage_Adapter_Weak, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 325, &_1);
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 326, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 327, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Weak, doDelete)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 328, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_Adapter_Weak, doGet)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 329, &key_zv);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 328, PH_NOISY_CC | PH_READONLY);
	if (0 == zephir_array_isset_value(&_0, &key_zv)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 329, &__$null);
