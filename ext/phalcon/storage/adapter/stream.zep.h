...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_storage_adapter_stream_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_storage_adapter_stream_method_entry) {
	...
	PHP_ME(Phalcon_Storage_Adapter_Stream, phpFclose, arginfo_phalcon_storage_adapter_stream_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_Adapter_Stream, phpFgetCsv, arginfo_phalcon_storage_adapter_stream_phpfgetcsv, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Phalcon_Storage_Adapter_Stream, phpFwrite, arginfo_phalcon_storage_adapter_stream_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Storage_Adapter_Stream, phpIsWritable, arginfo_phalcon_storage_adapter_stream_phpiswritable, ZEND_ACC_PROTECTED)
