...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, delete)
{
	...
	ZEPHIR_CALL_METHOD(&filepath, this_ptr, "getfilepath", NULL, 149, &key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("unlink", NULL, 150, &filepath);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, phpUnlink)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("unlink", NULL, 150, &filename);
	zephir_check_call_status();
	RETURN_MM();
}
