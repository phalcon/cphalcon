...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, clear)
{
	...
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdirseparator", NULL, 140, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&iterator, this_ptr, "getiterator", NULL, 141, &directory);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&iterator) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&iterator), _1)
		{
			...
			if (_4$$3) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_6$$3, "unlink", &_7, 142, &_5$$3);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_9$$5) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_11$$5, "unlink", &_7, 142, &_10$$5);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, delete)
{
	...
	ZEPHIR_CALL_METHOD(&filepath, this_ptr, "getfilepath", NULL, 143, &key);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, get)
{
	...
	ZEPHIR_CALL_METHOD(&payload, this_ptr, "getpayload", NULL, 144, &filepath);
	zephir_check_call_status();
	_0 = ZEPHIR_IS_EMPTY(&payload);
	if (!(_0)) {
		ZEPHIR_CALL_METHOD(&_1, this_ptr, "isexpired", NULL, 145, &payload);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getKeys)
{
	...
	array_init(&files);
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdir", NULL, 146);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, has)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "isexpired", NULL, 145, &payload);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getDir)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getdirseparator", NULL, 140, &_6);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getFilepath)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getdir", NULL, 146, &key);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
