...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, __construct)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "getdirseparator", NULL, 138, &storageDir);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, clear)
{
	...
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdirseparator", NULL, 138, &_0);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&iterator) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&iterator), _1)
		{
			...
			if (_4$$3) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_6$$3, "unlink", &_7, 140, &_5$$3);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_9$$5) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_11$$5, "unlink", &_7, 140, &_10$$5);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, delete)
{
	...
	ZEPHIR_CALL_METHOD(&filepath, this_ptr, "getfilepath", NULL, 141, &key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("unlink", NULL, 140, &filepath);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, get)
{
	...
	ZEPHIR_CALL_METHOD(&payload, this_ptr, "getpayload", NULL, 142, &filepath);
	zephir_check_call_status();
	_0 = ZEPHIR_IS_EMPTY(&payload);
	if (!(_0)) {
		ZEPHIR_CALL_METHOD(&_1, this_ptr, "isexpired", NULL, 143, &payload);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getKeys)
{
	...
	array_init(&files);
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdir", NULL, 144);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, has)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "isexpired", NULL, 143, &payload);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, set)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "serialize", NULL, 14, &payload);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&payload, &_1);
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdir", NULL, 144, &key);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "is_dir", NULL, 145, &directory);
	zephir_check_call_status();
	if (!(zephir_is_true(&_2))) {
		ZVAL_LONG(&_3$$3, 0777);
		ZEPHIR_CALL_FUNCTION(NULL, "mkdir", NULL, 146, &directory, &_3$$3, &__$true);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_4);
	ZEPHIR_CONCAT_VV(&_4, &directory, &key);
	ZVAL_LONG(&_5, 2);
	ZEPHIR_CALL_FUNCTION(&_6, "file_put_contents", NULL, 147, &_4, &payload, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getDir)
{
	...
	ZEPHIR_CALL_METHOD(&dirPrefix, this_ptr, "getdirseparator", NULL, 138, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getdirseparator", NULL, 138, &_6);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getFilepath)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getdir", NULL, 144, &key);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
