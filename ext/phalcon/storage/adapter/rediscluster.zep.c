...
PHP_METHOD(Phalcon_Storage_Adapter_RedisCluster, getAdapter)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 321, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 322, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_14$$3, 2);
		ZEPHIR_CALL_METHOD(NULL, &connection, "setoption", NULL, 0, &_14$$3, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setserializer", NULL, 288, &connection);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 320, &connection);
	}
...
PHP_METHOD(Phalcon_Storage_Adapter_RedisCluster, setSerializer)
{
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 323, PH_NOISY_CC | PH_READONLY);
	...
	if (1 == zephir_array_isset_value(&map, &serializer)) {
		...
		ZVAL_STRING(&_11$$6, "");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 323, &_11$$6);
