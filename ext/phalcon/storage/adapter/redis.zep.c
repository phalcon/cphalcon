...
ZEPHIR_INIT_CLASS(Phalcon_Storage_Adapter_Redis) {
	 ...
	 * @var array
	 */
	zend_declare_property_null(phalcon_storage_adapter_redis_ce, SL("options"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Storage_Adapter_Redis, __construct) {
	...
	ZVAL_STRING(&_2, "port");
	ZVAL_LONG(&_5, 6379);
	ZEPHIR_CALL_CE_STATIC(&_4, phalcon_helper_arr_ce, "get", &_1, 5, &options, &_2, &_5);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_LONG(&_5, 0);
	ZEPHIR_CALL_CE_STATIC(&_6, phalcon_helper_arr_ce, "get", &_1, 5, &options, &_3, &_5);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("index"), &_6, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "persistent");
	ZVAL_BOOL(&_5, 0);
	ZEPHIR_CALL_CE_STATIC(&_7, phalcon_helper_arr_ce, "get", &_1, 5, &options, &_3, &_5);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_9);
	ZVAL_STRING(&_9, "");
	ZEPHIR_CALL_CE_STATIC(&_8, phalcon_helper_arr_ce, "get", &_1, 5, &options, &_3, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_9);
	ZVAL_STRING(&_9, "");
	ZEPHIR_CALL_CE_STATIC(&_10, phalcon_helper_arr_ce, "get", &_1, 5, &options, &_3, &_9);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Redis, getAdapter) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(&auth);
		zephir_array_fetch_string(&auth, &options, SL("auth"), PH_NOISY, "phalcon/Storage/Adapter/Redis.zep", 121 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&host);
		zephir_array_fetch_string(&host, &options, SL("host"), PH_NOISY, "phalcon/Storage/Adapter/Redis.zep", 122 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&index);
		zephir_array_fetch_string(&index, &options, SL("index"), PH_NOISY, "phalcon/Storage/Adapter/Redis.zep", 123 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&persistent);
		zephir_array_fetch_string(&persistent, &options, SL("persistent"), PH_NOISY, "phalcon/Storage/Adapter/Redis.zep", 124 TSRMLS_CC);
		ZEPHIR_OBS_VAR(&port);
		zephir_array_fetch_string(&port, &options, SL("port"), PH_NOISY, "phalcon/Storage/Adapter/Redis.zep", 125 TSRMLS_CC);
		...
		zephir_read_property(&_1$$3, this_ptr, SL("lifetime"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD_ZVAL(&result, &connection, &method, NULL, 0, &host, &port, &_1$$3);
		zephir_check_call_status();
		if (!(zephir_is_true(&result))) {
			ZEPHIR_INIT_VAR(&_2$$4);
			object_init_ex(&_2$$4, phalcon_storage_exception_ce);
			ZEPHIR_INIT_VAR(&_3$$4);
			ZEPHIR_CONCAT_SVSVS(&_3$$4, "Could not connect to the Redisd server [", &host, ":", &port, "]");
			ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", NULL, 1, &_3$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_2$$4, "phalcon/Storage/Adapter/Redis.zep", 133 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (_4$$3) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_storage_exception_ce, "Failed to authenticate with the Redis server", "phalcon/Storage/Adapter/Redis.zep", 137);
			return;
		}
		...
		if (_6$$3) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_storage_exception_ce, "Redis server selected database failed", "phalcon/Storage/Adapter/Redis.zep", 141);
			return;
		}
		zephir_read_property(&_8$$3, this_ptr, SL("prefix"), PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_9$$3, 2);
		ZEPHIR_CALL_METHOD(NULL, &connection, "setoption", NULL, 0, &_9$$3, &_8$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setserializer", NULL, 93, &connection);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Redis, setSerializer) {
	...
	if (zephir_array_isset(&map, &serializer)) {
		...
		zephir_array_fetch(&_9$$5, &map, &serializer, PH_NOISY | PH_READONLY, "phalcon/Storage/Adapter/Redis.zep", 242 TSRMLS_CC);
		ZVAL_LONG(&_10$$5, 1);
