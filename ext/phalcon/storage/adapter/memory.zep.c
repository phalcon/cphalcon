...
PHP_METHOD(Phalcon_Storage_Adapter_Memory, clear)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 311, &_0);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Memory, getKeys)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 311, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_Adapter_Memory, setMaxItems)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 312, &_0);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Memory, doDecrement)
{
	...
	if (EXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&result))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 311, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Storage_Adapter_Memory, doSet)
{
	...
	ZEPHIR_CALL_METHOD(&prefixedKey, this_ptr, "getprefixedkey", NULL, 0, &key_zv);
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 312, PH_NOISY_CC | PH_READONLY);
	_2 = ZEPHIR_GT_LONG(&_1, 0);
	if (_2) {
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 311, PH_NOISY_CC | PH_READONLY);
		_2 = !(zephir_array_key_exists(&_3, &prefixedKey));
	}
	_4 = _2;
	if (_4) {
		zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 311, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 312, PH_NOISY_CC | PH_READONLY);
		_4 = ZEPHIR_LE_LONG(&_6, zephir_fast_count_int(&_5));
	}
	if (_4) {
		zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_1, 311, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&firstKey) != IS_NULL) {
			...
			zephir_read_property_cached(&_8$$5, this_ptr, _zephir_prop_1, 311, PH_NOISY_CC | PH_READONLY);
