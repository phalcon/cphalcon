...
PHP_METHOD(Phalcon_Security_Random, hex) {
	...
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&_3);
	ZEPHIR_RETURN_CALL_FUNCTION("array_shift", NULL, 131, &_3);
	ZEPHIR_UNREF(&_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Security_Random, base64Safe) {
	...
	zend_bool padding;
	zval *len_param = NULL, *padding_param = NULL, s, _0, _1, _2, _3, _4$$3;
	int len, ZEPHIR_LAST_CALL_STATUS;
	ZEPHIR_INIT_THIS();
	...
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "#[^a-z0-9_=-]+#i");
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
	ZEPHIR_CALL_FUNCTION(&s, "preg_replace", NULL, 29, &_2, &_3, &_0);
	zephir_check_call_status();
	if (!(padding)) {
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "=");
		zephir_fast_trim(return_value, &s, &_4$$3, ZEPHIR_TRIM_BOTH TSRMLS_CC);
		RETURN_MM();
	}
	RETURN_CCTOR(s);
...
PHP_METHOD(Phalcon_Security_Random, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 426, &_2, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ary, "array_values", NULL, 223, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "H*");
	ZEPHIR_CALL_FUNCTION(&_7, "pack", NULL, 429, &_6, &hex);
	zephir_check_call_status();
	zephir_concat_self(&bin, &_7 TSRMLS_CC);
	_8 = ZEPHIR_STRING_OFFSET(&bin, 0);
	ZVAL_LONG(&_4, _8);
	ZEPHIR_CALL_FUNCTION(&mask, "ord", &_9, 143, &_4);
	zephir_check_call_status();
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$7, "ord", &_9, 143, &_16$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_18$$7);
		zephir_bitwise_and_function(&_18$$7, &_17$$7, &mask TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_17$$7, "chr", &_19, 141, &_18$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_20$$7, 0);
		ZVAL_LONG(&_21$$7, 1);
		ZEPHIR_CALL_FUNCTION(&_22$$7, "substr_replace", &_23, 430, &rnd, &_17$$7, &_20$$7, &_21$$7);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&rnd, &_22$$7);
	} while (ZEPHIR_LT(&bin, &rnd));
	ZEPHIR_INIT_NVAR(&_6);
	ZVAL_STRING(&_6, "H*");
	ZEPHIR_CALL_FUNCTION(&ret, "unpack", NULL, 426, &_6, &rnd);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&ret);
	ZEPHIR_CALL_FUNCTION(&_24, "array_shift", NULL, 131, &ret);
	ZEPHIR_UNREF(&ret);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("hexdec", NULL, 431, &_24);
	zephir_check_call_status();
	RETURN_MM();
