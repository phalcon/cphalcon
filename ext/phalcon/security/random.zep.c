...
PHP_METHOD(Phalcon_Security_Random, bytes) {
	...
	if ((zephir_function_exists_ex(SS("openssl_random_pseudo_bytes") TSRMLS_CC) == SUCCESS)) {
		...
		ZVAL_LONG(_2$$6, len);
		ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 144, _2$$6);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_SINIT_VAR(_3);
	...
	if ((zephir_file_exists(&_3 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 291, &_4$$7, &_5$$7);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, base64) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "bytes", NULL, 0, _1);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 122, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_SINIT_NVAR(_4);
	ZVAL_LONG(&_4, _7);
	ZEPHIR_CALL_FUNCTION(&mask, "ord", &_8, 139, &_4);
	zephir_check_call_status();
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_16$$7, "ord", &_8, 139, _12$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_17$$7);
		zephir_bitwise_and_function(&_17$$7, _16$$7, mask TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_16$$7, "chr", &_18, 137, &_17$$7);
		zephir_check_call_status();
