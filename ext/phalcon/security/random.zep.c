...
PHP_METHOD(Phalcon_Security_Random, bytes) {
	...
	if ((zephir_file_exists(&_3 TSRMLS_CC) == SUCCESS)) {
		...
		ZVAL_STRING(&_5$$7, "rb");
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 79, &_4$$7, &_5$$7);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 453, &_2, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ary, "array_values", NULL, 133, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_CALL_FUNCTION(&mask, "ord", NULL, 143, &_6);
	zephir_check_call_status();
	...
	do {
		...
		ZEPHIR_CALL_FUNCTION(&_16$$7, "ord", NULL, 143, &_15$$7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_17$$7);
		zephir_bitwise_and_function(&_17$$7, &_16$$7, &mask TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_16$$7, "chr", &_18, 141, &_17$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_19$$7, 0);
		ZVAL_LONG(&_20$$7, 1);
