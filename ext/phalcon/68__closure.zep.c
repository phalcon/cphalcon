...
ZEPHIR_INIT_CLASS(phalcon_68__closure)
{
	...
	zend_declare_property_null(phalcon_68__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC);
	zend_declare_property_null(phalcon_68__closure_ce, SL("__$zephir_this"), ZEND_ACC_PUBLIC);
	return SUCCESS;
}
