...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_cli_console_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_cli_console_method_entry) {
	...
	PHP_ME(Phalcon_Cli_Console, phpFclose, arginfo_phalcon_cli_console_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFgetCsv, arginfo_phalcon_cli_console_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFileExists, arginfo_phalcon_cli_console_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFileGetContents, arginfo_phalcon_cli_console_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFilePutContents, arginfo_phalcon_cli_console_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFopen, arginfo_phalcon_cli_console_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpFwrite, arginfo_phalcon_cli_console_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpIsWritable, arginfo_phalcon_cli_console_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Cli_Console, phpUnlink, arginfo_phalcon_cli_console_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
