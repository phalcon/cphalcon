...
PHP_METHOD(Phalcon_Cli_Router, __construct) {
	...
	if (defaultRoutes == 1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", &_3, 134, &_2$$3, &_1$$3);
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", &_3, 134, &_5$$3, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, handle) {
	...
	if (Z_TYPE_P(arguments) != IS_ARRAY) {
		...
		zephir_is_iterable(&_1$$3, 0, "phalcon/cli/router.zep", 302);
		ZEND_HASH_REVERSE_FOREACH_VAL(Z_ARRVAL_P(&_1$$3), _2$$3)
		{
			...
			if (zephir_is_true(&routeFound)) {
				...
				if (Z_TYPE_P(&matches) == IS_ARRAY) {
					...
					zephir_check_call_status();
					zephir_is_iterable(&paths, 0, "phalcon/cli/router.zep", 291);
	...
	if (zephir_array_isset_string_fetch(&params, &parts, SL("params"), 0)) {
		if (Z_TYPE_P(&params) != IS_ARRAY) {
			...
			if (zephir_is_true(&strParams)) {
				ZEPHIR_CALL_CE_STATIC(&_17$$31, phalcon_cli_router_route_ce, "getdelimiter", &_18, 133);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, getRouteById) {
	...
	zephir_is_iterable(&_0, 0, "phalcon/cli/router.zep", 480);
...
PHP_METHOD(Phalcon_Cli_Router, getRouteByName) {
	...
	zephir_read_property(&_0, this_ptr, SL("_routes"), PH_NOISY_CC | PH_READONLY);
	zephir_is_iterable(&_0, 0, "phalcon/cli/router.zep", 495);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		ZEPHIR_INIT_NVAR(&route);
		ZVAL_COPY(&route, _1);
