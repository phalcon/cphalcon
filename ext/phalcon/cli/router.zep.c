...
PHP_METHOD(Phalcon_Cli_Router, handle)
{
	...
	if (Z_TYPE_P(arguments) != IS_ARRAY) {
		...
		if (zephir_is_true(&routeFound)) {
			...
			zephir_read_property_cached(&_46$$47, this_ptr, _zephir_prop_4, 505, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 506, &_46$$47);
			zephir_read_property_cached(&_47$$47, this_ptr, _zephir_prop_6, 507, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 508, &_47$$47);
			zephir_read_property_cached(&_48$$47, this_ptr, _zephir_prop_8, 509, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 510, &_48$$47);
			zephir_read_property_cached(&_49$$47, this_ptr, _zephir_prop_10, 511, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 512, &_49$$47);
			RETURN_THIS();
		}
	} else {
