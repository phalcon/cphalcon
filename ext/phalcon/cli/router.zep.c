...
PHP_METHOD(Phalcon_Cli_Router, __construct)
{
	...
	if (defaultRoutes) {
		...
		ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 419, &_1$$3, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_2$$3, &route, "getrouteid", NULL, 420);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 419, &_1$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_4$$3, &route, "getrouteid", NULL, 420);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, add)
{
	...
	ZEPHIR_INIT_VAR(&route);
	object_init_ex(&route, phalcon_cli_router_route_ce);
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 419, &pattern_zv, paths);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &route, "getrouteid", NULL, 420);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, handle)
{
	...
	ZVAL_NULL(&matches);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 483, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 483, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 484, &__$null);
	if (Z_TYPE_P(arguments) != IS_ARRAY) {
		...
		if (UNEXPECTED(_0$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 421, &_2$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$4, "phalcon/Cli/Router.zep", 269);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_2, 482, PH_NOISY_CC | PH_READONLY);
			...
			ZEND_HASH_REVERSE_FOREACH_VAL(Z_ARRVAL_P(&_3$$3), _4$$3)
			{
				...
				if (zephir_is_true(&routeFound)) {
					...
					if (Z_TYPE_P(&beforeMatch) != IS_NULL) {
						if (UNEXPECTED(!(zephir_is_callable(&beforeMatch)))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(NULL, &_5$$10, "__construct", &_7, 422, &_6$$10);
							zephir_check_call_status();
				...
				if (zephir_is_true(&routeFound)) {
					...
					if (Z_TYPE_P(&matches) == IS_ARRAY) {
						...
						ZEPHIR_INIT_NVAR(&position);
						ZEPHIR_INIT_NVAR(&part);
						zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 485, &matches);
					}
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 484, &route);
					break;
				}
			} ZEND_HASH_FOREACH_END();
		} else {
					...
					if (zephir_is_true(&routeFound)) {
						...
						if (Z_TYPE_P(&beforeMatch) != IS_NULL) {
							if (UNEXPECTED(!(zephir_is_callable(&beforeMatch)))) {
								...
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(NULL, &_24$$30, "__construct", &_7, 422, &_25$$30);
								zephir_check_call_status();
		...
		if (zephir_is_true(&routeFound)) {
			...
			zephir_read_property_cached(&_40$$46, this_ptr, _zephir_prop_4, 486, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 487, &_40$$46);
			zephir_read_property_cached(&_41$$46, this_ptr, _zephir_prop_6, 488, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 489, &_41$$46);
			zephir_read_property_cached(&_42$$46, this_ptr, _zephir_prop_8, 490, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 491, &_42$$46);
			zephir_read_property_cached(&_43$$46, this_ptr, _zephir_prop_10, 492, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 493, &_43$$46);
			RETURN_THIS();
		}
	} else {
	...
	if (zephir_array_isset_string_fetch(&moduleName, &parts, SL("module"), 0)) {
		...
		ZEPHIR_OBS_NVAR(&moduleName);
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_4, 486, PH_NOISY_CC);
	}
	...
	if (zephir_array_isset_string_fetch(&taskName, &parts, SL("task"), 0)) {
		...
		ZEPHIR_OBS_NVAR(&taskName);
		zephir_read_property_cached(&taskName, this_ptr, _zephir_prop_6, 488, PH_NOISY_CC);
	}
	...
	if (zephir_array_isset_string_fetch(&actionName, &parts, SL("action"), 0)) {
		...
		ZEPHIR_OBS_NVAR(&actionName);
		zephir_read_property_cached(&actionName, this_ptr, _zephir_prop_8, 490, PH_NOISY_CC);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 487, &moduleName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 489, &taskName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 491, &actionName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 493, &params);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Cli_Router, setDefaultAction)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 490, &actionName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Cli_Router, setDefaultModule)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 486, &moduleName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Cli_Router, setDefaults)
{
	...
	if (zephir_array_isset_string_fetch(&module, &defaults, SL("module"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 486, &module);
	}
	zephir_memory_observe(&task);
	if (zephir_array_isset_string_fetch(&task, &defaults, SL("task"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 488, &task);
	}
	zephir_memory_observe(&action);
	if (zephir_array_isset_string_fetch(&action, &defaults, SL("action"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 490, &action);
	}
	zephir_memory_observe(&params);
	if (zephir_array_isset_string_fetch(&params, &defaults, SL("params"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 492, &params);
	}
	RETURN_THIS();
}
