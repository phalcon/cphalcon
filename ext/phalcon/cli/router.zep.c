...
PHP_METHOD(Phalcon_Cli_Router, __construct)
{
	...
	if (defaultRoutes) {
		...
		ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 432, &_1$$3, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_2$$3, &route, "getrouteid", NULL, 433);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 432, &_1$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_4$$3, &route, "getrouteid", NULL, 433);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, add)
{
	...
	ZEPHIR_INIT_VAR(&route);
	object_init_ex(&route, phalcon_cli_router_route_ce);
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 432, &pattern_zv, paths);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &route, "getrouteid", NULL, 433);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, handle)
{
	...
	if (Z_TYPE_P(arguments) != IS_ARRAY) {
		...
		if (UNEXPECTED(_0$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 434, &_2$$4);
			zephir_check_call_status();
				...
				if (zephir_is_true(&routeFound)) {
					...
					if (Z_TYPE_P(&beforeMatch) != IS_NULL) {
						if (UNEXPECTED(!(zephir_is_callable(&beforeMatch)))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(NULL, &_5$$10, "__construct", &_7, 435, &_6$$10);
							zephir_check_call_status();
					...
					if (zephir_is_true(&routeFound)) {
						...
						if (Z_TYPE_P(&beforeMatch) != IS_NULL) {
							if (UNEXPECTED(!(zephir_is_callable(&beforeMatch)))) {
								...
								zephir_check_call_status();
								ZEPHIR_CALL_METHOD(NULL, &_24$$30, "__construct", &_7, 435, &_25$$30);
								zephir_check_call_status();
