...
PHP_METHOD(Phalcon_Cli_Console, handle)
{
	...
	if (Z_TYPE_P(&_2) != IS_NULL) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_8);
	...
	if (_9) {
		zephir_read_property_cached(&_10, this_ptr, _zephir_prop_2, 487, PH_NOISY_CC | PH_READONLY);
		_9 = zephir_is_true(&_10);
	}
	if (_9) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_2, 487, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_3, 488, PH_NOISY_CC);
	}
	if (zephir_is_true(&moduleName)) {
		zephir_read_property_cached(&_12$$9, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_12$$9) != IS_NULL) {
			zephir_read_property_cached(&_13$$10, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&module) == IS_ARRAY) {
			...
			zephir_read_property_cached(&_21$$13, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_22$$13, &_21$$13, "get", NULL, 0, &className);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&moduleObject, &_22$$13);
			zephir_read_property_cached(&_23$$13, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &moduleObject, "registerautoloaders", NULL, 0, &_23$$13);
			zephir_check_call_status();
			zephir_read_property_cached(&_24$$13, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_28$$18, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC);
		...
		zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_29$$9) != IS_NULL) {
			zephir_read_property_cached(&_30$$20, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_33, this_ptr, _zephir_prop_0, 485, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_8);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_36, this_ptr, _zephir_prop_4, 489, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &dispatcher, "setoptions", NULL, 0, &_36);
	zephir_check_call_status();
	zephir_read_property_cached(&_37, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_37) != IS_NULL) {
		zephir_read_property_cached(&_38$$22, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_41, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_41) != IS_NULL) {
		zephir_read_property_cached(&_42$$24, this_ptr, _zephir_prop_1, 486, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Console, setArgument)
{
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_2$$5, "--");
				ZVAL_LONG(&_3$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_4$$5, "strncmp", &_5, 351, &arg, &_2$$5, &_3$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_4$$5, 0)) {
					...
					ZVAL_STRING(&_17$$9, "-");
					ZVAL_LONG(&_18$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_19$$9, "strncmp", &_5, 351, &arg, &_17$$9, &_18$$9);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_24$$14, "--");
					ZVAL_LONG(&_25$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_26$$14, "strncmp", &_5, 351, &arg, &_24$$14, &_25$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_26$$14, 0)) {
						...
						ZVAL_STRING(&_38$$18, "-");
						ZVAL_LONG(&_39$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_40$$18, "strncmp", &_5, 351, &arg, &_38$$18, &_39$$18);
						zephir_check_call_status();
	...
	if (str) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 487, &_43$$22);
	} else {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 487, &handleArgs);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 489, &opts);
	RETURN_THIS();
}
