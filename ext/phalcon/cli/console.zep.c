...
PHP_METHOD(Phalcon_Cli_Console, handle)
{
	...
	if (zephir_is_true(&moduleName)) {
		...
		if (UNEXPECTED(_16$$9)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_17$$12, "__construct", NULL, 422, &moduleName, &_18$$12);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&module) == IS_ARRAY) {
			...
			if (zephir_array_isset_string_fetch(&path, &module, SL("path"), 0)) {
				...
				if (UNEXPECTED(!zephir_is_true(&_19$$15))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_20$$16, "__construct", NULL, 423, &path);
					zephir_check_call_status();
			...
			if (UNEXPECTED(!((zephir_is_instance_of(&module, SL("Closure")))))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_25$$19, "__construct", NULL, 422, &moduleName, &_26$$19);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_2$$5, "--");
				ZVAL_LONG(&_3$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_4$$5, "strncmp", &_5, 331, &arg, &_2$$5, &_3$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_4$$5, 0)) {
					...
					ZVAL_STRING(&_17$$9, "-");
					ZVAL_LONG(&_18$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_19$$9, "strncmp", &_5, 331, &arg, &_17$$9, &_18$$9);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_24$$14, "--");
					ZVAL_LONG(&_25$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_26$$14, "strncmp", &_5, 331, &arg, &_24$$14, &_25$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_26$$14, 0)) {
						...
						ZVAL_STRING(&_38$$18, "-");
						ZVAL_LONG(&_39$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_40$$18, "strncmp", &_5, 331, &arg, &_38$$18, &_39$$18);
						zephir_check_call_status();
