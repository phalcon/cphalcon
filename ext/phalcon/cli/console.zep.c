...
PHP_METHOD(Phalcon_Cli_Console, handle)
{
	...
	if (zephir_is_true(&moduleName)) {
		...
		if (UNEXPECTED(!(zephir_array_isset_value(&modules, &moduleName)))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_17$$12, "__construct", NULL, 339, &moduleName);
			zephir_check_call_status();
		...
		if (UNEXPECTED(Z_TYPE_P(&module) != IS_ARRAY)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_18$$13, "__construct", NULL, 340);
			zephir_check_call_status();
		...
		if (zephir_array_isset_string_fetch(&path, &module, SL("path"), 0)) {
			if (UNEXPECTED(!((zephir_file_exists(&path) == SUCCESS)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_19$$16, "__construct", NULL, 341, &path);
				zephir_check_call_status();
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_2$$5, "--");
				ZVAL_LONG(&_3$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_4$$5, "strncmp", &_5, 342, &arg, &_2$$5, &_3$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_4$$5, 0)) {
					...
					ZVAL_STRING(&_17$$9, "-");
					ZVAL_LONG(&_18$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_19$$9, "strncmp", &_5, 342, &arg, &_17$$9, &_18$$9);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_24$$14, "--");
					ZVAL_LONG(&_25$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_26$$14, "strncmp", &_5, 342, &arg, &_24$$14, &_25$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_26$$14, 0)) {
						...
						ZVAL_STRING(&_38$$18, "-");
						ZVAL_LONG(&_39$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_40$$18, "strncmp", &_5, 342, &arg, &_38$$18, &_39$$18);
						zephir_check_call_status();
