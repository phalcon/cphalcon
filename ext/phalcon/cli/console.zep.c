...
PHP_METHOD(Phalcon_Cli_Console, handle)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 429);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Cli/Console.zep", 49);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_2) != IS_NULL) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	...
	if (_9) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_2, 475, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_3, 476, PH_NOISY_CC);
	}
	if (zephir_is_true(&moduleName)) {
		zephir_read_property_cached(&_12$$9, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_12$$9) != IS_NULL) {
			zephir_read_property_cached(&_13$$10, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(_16$$9)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_17$$12, "__construct", NULL, 430, &moduleName, &_18$$12);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&module) == IS_ARRAY) {
			...
			if (zephir_array_isset_string_fetch(&path, &module, SL("path"), 0)) {
				...
				if (UNEXPECTED(!zephir_is_true(&_19$$15))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_20$$16, "__construct", NULL, 431, &path);
					zephir_check_call_status();
			...
			zephir_read_property_cached(&_21$$13, this_ptr, _zephir_prop_0, 473, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_22$$13, &_21$$13, "get", NULL, 0, &className);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&moduleObject, &_22$$13);
			zephir_read_property_cached(&_23$$13, this_ptr, _zephir_prop_0, 473, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &moduleObject, "registerautoloaders", NULL, 0, &_23$$13);
			zephir_check_call_status();
			zephir_read_property_cached(&_24$$13, this_ptr, _zephir_prop_0, 473, PH_NOISY_CC | PH_READONLY);
			...
			if (UNEXPECTED(!((zephir_is_instance_of(&module, SL("Closure")))))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_25$$19, "__construct", NULL, 430, &moduleName, &_26$$19);
				zephir_check_call_status();
			...
			zephir_read_property_cached(&_28$$18, this_ptr, _zephir_prop_0, 473, PH_NOISY_CC);
		...
		zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_29$$9) != IS_NULL) {
			zephir_read_property_cached(&_30$$20, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_33, this_ptr, _zephir_prop_0, 473, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_8);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_36, this_ptr, _zephir_prop_4, 477, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &dispatcher, "setoptions", NULL, 0, &_36);
	zephir_check_call_status();
	zephir_read_property_cached(&_37, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_37) != IS_NULL) {
		zephir_read_property_cached(&_38$$22, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_41, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_41) != IS_NULL) {
		zephir_read_property_cached(&_42$$24, this_ptr, _zephir_prop_1, 474, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Console, setArgument)
{
	...
	if (str) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 475, &handleArgs);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 477, &opts);
	RETURN_THIS();
}
