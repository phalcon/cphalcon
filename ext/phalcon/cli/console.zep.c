...
PHP_METHOD(Phalcon_Cli_Console, handle)
{
	...
	zval *arguments_param = NULL, __$false, className, dispatcher, module, moduleName, moduleObject, path, router, task, _0, _2, _6, _7, _8, _10, _33, _34, _35, _36, _37, _41, _1$$3, _3$$4, _4$$4, _5$$4, _11$$6, _12$$9, _29$$9, _13$$10, _14$$10, _15$$10, _17$$12, _18$$12, _19$$15, _20$$16, _21$$13, _22$$13, _23$$13, _24$$13, _25$$19, _26$$19, _28$$18, _30$$20, _31$$20, _32$$20, _38$$22, _39$$22, _40$$22, _42$$24, _43$$24;
	zval arguments, _27$$18;
	...
	if (UNEXPECTED(!_zephir_prop_3)) {
		_zephir_prop_3 = zend_string_init("defaultModule", 13, 1);
	}
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 440);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Cli/Console.zep", 49);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_2) != IS_NULL) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_8);
	...
	if (_9) {
		zephir_read_property_cached(&_10, this_ptr, _zephir_prop_2, 484, PH_NOISY_CC | PH_READONLY);
		_9 = zephir_is_true(&_10);
	}
	if (_9) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_2, 484, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_3, 485, PH_NOISY_CC);
	}
	if (zephir_is_true(&moduleName)) {
		zephir_read_property_cached(&_12$$9, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_12$$9) != IS_NULL) {
			zephir_read_property_cached(&_13$$10, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(_16$$9)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_17$$12, "__construct", NULL, 441, &moduleName, &_18$$12);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_17$$12, "phalcon/Cli/Console.zep", 98);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (Z_TYPE_P(&module) == IS_ARRAY) {
			...
			if (zephir_array_isset_string_fetch(&path, &module, SL("path"), 0)) {
				...
				if (UNEXPECTED(!zephir_is_true(&_19$$15))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_20$$16, "__construct", NULL, 442, &path);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_20$$16, "phalcon/Cli/Console.zep", 118);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			zephir_read_property_cached(&_21$$13, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_22$$13, &_21$$13, "get", NULL, 0, &className);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&moduleObject, &_22$$13);
			zephir_read_property_cached(&_23$$13, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(NULL, &moduleObject, "registerautoloaders", NULL, 0, &_23$$13);
			zephir_check_call_status();
			zephir_read_property_cached(&_24$$13, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC | PH_READONLY);
			...
			if (UNEXPECTED(!((zephir_is_instance_of(&module, SL("Closure")))))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_25$$19, "__construct", NULL, 441, &moduleName, &_26$$19);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_25$$19, "phalcon/Cli/Console.zep", 142);
				ZEPHIR_MM_RESTORE();
				return;
			}
			...
			zephir_read_property_cached(&_28$$18, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC);
			zephir_array_fast_append(&_27$$18, &_28$$18);
			ZEPHIR_INIT_NVAR(&moduleObject);
			ZEPHIR_CALL_USER_FUNC_ARRAY(&moduleObject, &module, &_27$$18);
			zephir_check_call_status();
		}
		zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_29$$9) != IS_NULL) {
			zephir_read_property_cached(&_30$$20, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_VAR(&_32$$20);
			ZVAL_STRING(&_32$$20, "console:afterStartModule");
			ZEPHIR_CALL_METHOD(&_31$$20, &_30$$20, "fire", NULL, 0, &_32$$20, this_ptr, &moduleObject);
			zephir_check_call_status();
			if (ZEPHIR_IS_FALSE_IDENTICAL(&_31$$20)) {
				RETURN_MM_BOOL(0);
			}
		}
	}
	zephir_read_property_cached(&_33, this_ptr, _zephir_prop_0, 482, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_8);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_36, this_ptr, _zephir_prop_4, 486, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &dispatcher, "setoptions", NULL, 0, &_36);
	zephir_check_call_status();
	zephir_read_property_cached(&_37, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_37) != IS_NULL) {
		zephir_read_property_cached(&_38$$22, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_40$$22);
		ZVAL_STRING(&_40$$22, "console:beforeHandleTask");
		ZEPHIR_CALL_METHOD(&_39$$22, &_38$$22, "fire", NULL, 0, &_40$$22, this_ptr, &dispatcher);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(&_39$$22)) {
			RETURN_MM_BOOL(0);
		}
	}
	ZEPHIR_CALL_METHOD(&task, &dispatcher, "dispatch", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_41, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_41) != IS_NULL) {
		zephir_read_property_cached(&_42$$24, this_ptr, _zephir_prop_1, 483, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_43$$24);
		ZVAL_STRING(&_43$$24, "console:afterHandleTask");
		ZEPHIR_CALL_METHOD(NULL, &_42$$24, "fire", NULL, 0, &_43$$24, this_ptr, &task);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&task);
}
...
PHP_METHOD(Phalcon_Cli_Console, setArgument)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "array_shift", NULL, 38, &arguments);
		ZEPHIR_UNREF(&arguments);
		zephir_check_call_status();
	}
	zephir_is_iterable(&arguments, 0, "phalcon/Cli/Console.zep", 228);
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_2$$5, "--");
				ZVAL_LONG(&_3$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_4$$5, "strncmp", &_5, 349, &arg, &_2$$5, &_3$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_4$$5, 0)) {
					...
					ZVAL_STRING(&_17$$9, "-");
					ZVAL_LONG(&_18$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_19$$9, "strncmp", &_5, 349, &arg, &_17$$9, &_18$$9);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_19$$9, 0)) {
						...
						zephir_array_append(&args, &arg, PH_SEPARATE, "phalcon/Cli/Console.zep", 220);
					}
				}
			} else {
				zephir_array_append(&args, &arg, PH_SEPARATE, "phalcon/Cli/Console.zep", 224);
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_24$$14, "--");
					ZVAL_LONG(&_25$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_26$$14, "strncmp", &_5, 349, &arg, &_24$$14, &_25$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_26$$14, 0)) {
						...
						ZVAL_STRING(&_38$$18, "-");
						ZVAL_LONG(&_39$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_40$$18, "strncmp", &_5, 349, &arg, &_38$$18, &_39$$18);
						zephir_check_call_status();
	...
	if (str) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 484, &_43$$22);
	} else {
		if (!(ZEPHIR_IS_EMPTY(&args))) {
			ZEPHIR_MAKE_REF(&args);
			ZEPHIR_CALL_FUNCTION(&_45$$24, "array_shift", NULL, 38, &args);
			ZEPHIR_UNREF(&args);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&args))) {
			ZEPHIR_MAKE_REF(&args);
			ZEPHIR_CALL_FUNCTION(&_46$$25, "array_shift", NULL, 38, &args);
			ZEPHIR_UNREF(&args);
			zephir_check_call_status();
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 484, &handleArgs);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 486, &opts);
	RETURN_THIS();
}
