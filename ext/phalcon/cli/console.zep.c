...
ZEPHIR_INIT_CLASS(Phalcon_Cli_Console) {
	...
	zend_declare_property_null(phalcon_cli_console_ce, SL("arguments"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_cli_console_ce, SL("options"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Cli_Console, handle) {
	...
	zval *arguments_param = NULL, __$false, container, router, eventsManager, moduleName, modules, module, path, className, moduleObject, dispatcher, task, _0, _7, _8, _20, _21, _22, _23, _1$$3, _2$$3, _4$$3, _5$$4, _6$$4, _10$$6, _11$$10, _12$$10, _13$$9, _14$$12, _15$$12, _16$$17, _17$$17, _18$$18, _19$$18, _24$$20, _25$$20, _26$$22;
	zval arguments;
	...
	if (Z_TYPE_P(&container) != IS_OBJECT) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Cli/Console.zep", 42 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	_9 = !(zephir_fast_count_int(&arguments TSRMLS_CC));
	if (_9) {
	...
	if (zephir_is_true(&moduleName)) {
		...
		if (!(zephir_array_isset(&modules, &moduleName))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_14$$12, "phalcon/Cli/Console.zep", 85 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		ZEPHIR_OBS_VAR(&module);
		zephir_array_fetch(&module, &modules, &moduleName, PH_NOISY, "phalcon/Cli/Console.zep", 88 TSRMLS_CC);
		if (Z_TYPE_P(&module) != IS_ARRAY) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_cli_console_exception_ce, "Invalid module definition path", "phalcon/Cli/Console.zep", 90);
			return;
		}
		...
		if (zephir_array_isset_string_fetch(&path, &module, SL("path"), 0)) {
			if (!(zephir_class_exists(&className, zephir_is_true(&__$false)  TSRMLS_CC))) {
				if (!((zephir_file_exists(&path TSRMLS_CC) == SUCCESS))) {
					...
					object_init_ex(&_16$$17, phalcon_cli_console_exception_ce);
					ZEPHIR_INIT_VAR(&_17$$17);
					ZEPHIR_CONCAT_SVS(&_17$$17, "Module definition path '", &path, "' doesn't exist");
					ZEPHIR_CALL_METHOD(NULL, &_16$$17, "__construct", NULL, 1, &_17$$17);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_16$$17, "phalcon/Cli/Console.zep", 102 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
...
PHP_METHOD(Phalcon_Cli_Console, setArgument) {
	...
	zephir_is_iterable(&arguments, 0, "phalcon/Cli/Console.zep", 181);
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _1)
		{
			...
			if (Z_TYPE_P(&arg) == IS_STRING) {
				...
				ZVAL_STRING(&_3$$5, "--");
				ZVAL_LONG(&_4$$5, 2);
				ZEPHIR_CALL_FUNCTION(&_5$$5, "strncmp", &_6, 114, &arg, &_3$$5, &_4$$5);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG(&_5$$5, 0)) {
					...
					ZVAL_STRING(&_18$$9, "-");
					ZVAL_LONG(&_19$$9, 1);
					ZEPHIR_CALL_FUNCTION(&_20$$9, "strncmp", &_6, 114, &arg, &_18$$9, &_19$$9);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_20$$9, 0)) {
						...
						zephir_array_append(&args, &arg, PH_SEPARATE, "phalcon/Cli/Console.zep", 173);
					}
				}
			} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&arg) == IS_STRING) {
					...
					ZVAL_STRING(&_23$$14, "--");
					ZVAL_LONG(&_24$$14, 2);
					ZEPHIR_CALL_FUNCTION(&_25$$14, "strncmp", &_6, 114, &arg, &_23$$14, &_24$$14);
					zephir_check_call_status();
					if (ZEPHIR_IS_LONG(&_25$$14, 0)) {
						...
						if (zephir_is_true(&pos)) {
							...
							zephir_fast_trim(&_27$$16, &_29$$16, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
							...
							zephir_fast_trim(&_30$$16, &_33$$16, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
							...
							zephir_fast_trim(&_34$$17, &_36$$17, NULL , ZEPHIR_TRIM_BOTH TSRMLS_CC);
						...
						ZVAL_STRING(&_37$$18, "-");
						ZVAL_LONG(&_38$$18, 1);
						ZEPHIR_CALL_FUNCTION(&_39$$18, "strncmp", &_6, 114, &arg, &_37$$18, &_38$$18);
						zephir_check_call_status();
	...
	if (str) {
		...
		zephir_check_call_status();
		zephir_fast_join(&_42$$22, &_43$$22, &args TSRMLS_CC);
		...
		if (zephir_fast_count_int(&args TSRMLS_CC)) {
			...
			zephir_fast_array_merge(&_47$$26, &handleArgs, &args TSRMLS_CC);
