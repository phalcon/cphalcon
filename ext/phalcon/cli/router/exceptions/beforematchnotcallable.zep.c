...
PHP_METHOD(Phalcon_Cli_Router_Exceptions_BeforeMatchNotCallable, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "Before-Match callback is not callable in matched route");
	ZEPHIR_CALL_PARENT(NULL, phalcon_cli_router_exceptions_beforematchnotcallable_ce, getThis(), "__construct", NULL, 0, &_0);
