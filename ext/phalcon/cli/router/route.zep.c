...
PHP_METHOD(Phalcon_Cli_Router_Route, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 491, &_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 492, &_2);
	ZVAL_UNDEF(&_1);
...
PHP_METHOD(Phalcon_Cli_Router_Route, beforeMatch)
{
	...
	if (UNEXPECTED(!(zephir_is_callable(callback)))) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 493, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 408, &_1$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Cli/Router/Route.zep", 113);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 494, callback);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Cli_Router_Route, compilePattern)
{
	...
	if (zephir_memnstr_str(&pattern, SL(":"), "phalcon/Cli/Router/Route.zep", 131)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC);
		zephir_array_update_string(&map, SL(":delimiter"), &_1$$3, PH_COPY | PH_SEPARATE);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_3$$3);
		ZEPHIR_CONCAT_VS(&_3$$3, &_2$$3, ":module");
		zephir_array_update_zval(&map, &_3$$3, &idPattern, PH_COPY);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_5$$3);
		ZEPHIR_CONCAT_VS(&_5$$3, &_4$$3, ":task");
		zephir_array_update_zval(&map, &_5$$3, &idPattern, PH_COPY);
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_7$$3);
		ZEPHIR_CONCAT_VS(&_7$$3, &_6$$3, ":namespace");
		zephir_array_update_zval(&map, &_7$$3, &idPattern, PH_COPY);
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_9$$3);
		ZEPHIR_CONCAT_VS(&_9$$3, &_8$$3, ":action");
		zephir_array_update_zval(&map, &_9$$3, &idPattern, PH_COPY);
		zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_11$$3);
		ZEPHIR_CONCAT_VS(&_11$$3, &_10$$3, ":params");
		zephir_read_property_cached(&_12$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_13$$3);
		ZEPHIR_CONCAT_SVS(&_13$$3, "(", &_12$$3, ".*)?");
		zephir_array_update_zval(&map, &_11$$3, &_13$$3, PH_COPY);
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&_13$$3);
		ZEPHIR_CONCAT_VS(&_13$$3, &_14$$3, ":int");
		zephir_read_property_cached(&_15$$3, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
					...
					if (bracketCount == 0) {
						...
						if (!(notValid)) {
							...
							if (_25$$17) {
								...
								zephir_read_property_cached(&_28$$27, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Router_Route, getReversedPaths)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("array_flip", NULL, 247, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Cli_Router_Route, reConfigure)
{
		...
		if (Z_TYPE_P(&taskName) != IS_NULL) {
			if (zephir_memnstr_str(&taskName, SL("\\"), "phalcon/Cli/Router/Route.zep", 458)) {
				...
				if (UNEXPECTED(_1$$10)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_2$$11, "__construct", NULL, 409, &pattern);
					zephir_check_call_status();
	...
	if (UNEXPECTED(Z_TYPE_P(&routePaths) != IS_ARRAY)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$16, "__construct", NULL, 409, &pattern);
		zephir_check_call_status();
	...
	if (!(zephir_start_with_str(&pattern, SL("#")))) {
		...
		if (zephir_memnstr_str(&pattern, SL(":delimiter"), "phalcon/Cli/Router/Route.zep", 515)) {
			...
			zephir_read_property_cached(&_8$$21, this_ptr, _zephir_prop_0, 491, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 493, &pattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 496, &compiledPattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 495, &routePaths);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Cli_Router_Route, setDescription)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 497, &description_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Cli_Router_Route, setName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&name_zv, name);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 498, &name_zv);
	RETURN_THISW();
}
