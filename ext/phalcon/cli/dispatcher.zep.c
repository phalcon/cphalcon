...
PHP_METHOD(Phalcon_Cli_Dispatcher, callActionMethod)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 483, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, getOption)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 484, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setOptions)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 483, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setTaskName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&taskName_zv, taskName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 486, &taskName_zv);
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setTaskSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 487, &taskSuffix_zv);
}
