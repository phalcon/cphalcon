...
PHP_METHOD(Phalcon_Cli_Dispatcher, getOption)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 487, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setDefaultTask)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 488, &taskName_zv);
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setOptions)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 486, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setTaskSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 490, &taskSuffix_zv);
}
