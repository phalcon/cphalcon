...
PHP_METHOD(Phalcon_Cli_Dispatcher, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_cli_dispatcher_ce, this_ptr, "__construct", &_1, 41);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, _throwDispatchException) {
	...
	ZEPHIR_CALL_METHOD(NULL, exception, "__construct", &_1, 2, message, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "_handleexception", NULL, 0, exception);
	zephir_check_call_status();
