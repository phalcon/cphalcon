...
PHP_METHOD(Phalcon_Cli_Dispatcher, callActionMethod)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 446, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, getOption)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 447, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setDefaultTask)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 448, &taskName_zv);
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setOptions)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 446, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setTaskName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&taskName_zv, taskName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 449, &taskName_zv);
}
...
PHP_METHOD(Phalcon_Cli_Dispatcher, setTaskSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 450, &taskSuffix_zv);
}
