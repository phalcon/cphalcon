...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_phalcon_cli_router_getroutebyid, 0, 1, Phalcon\\Cli\\Router\\RouteInterface, MAY_BE_BOOL)
	ZEND_ARG_INFO(0, id)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_phalcon_cli_router_getroutebyname, 0, 1, Phalcon\\Cli\\Router\\RouteInterface, MAY_BE_BOOL)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_cli_router_setdefaultaction, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, actionName, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_cli_router_setdefaultmodule, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, moduleName, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_cli_router_setdefaults, 0, 1, MAY_BE_STATIC)
