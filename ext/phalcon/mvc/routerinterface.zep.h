...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_phalcon_mvc_routerinterface_getroutebyid, 0, 1, Phalcon\\Mvc\\Router\\RouteInterface, MAY_BE_BOOL)
	ZEND_ARG_INFO(0, routeId)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_phalcon_mvc_routerinterface_getroutebyname, 0, 1, Phalcon\\Mvc\\Router\\RouteInterface, MAY_BE_BOOL)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_mvc_routerinterface_loadfromconfig, 0, 1, Phalcon\\Mvc\\RouterInterface, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_routerinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_RouterInterface, loadFromConfig, arginfo_phalcon_mvc_routerinterface_loadfromconfig)
