...
PHP_METHOD(Phalcon_Mvc_Micro, mount) {
	...
	if (Z_TYPE_P(&handlers) == IS_ARRAY) {
		...
		if (zephir_is_true(&_0$$5)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &lazyHandler, "__construct", NULL, 334, &mainHandler);
			zephir_check_call_status();
		} else {
...
PHP_METHOD(Phalcon_Mvc_Micro, setService) {
	...
	if (Z_TYPE_P(&dependencyInjector) != IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &dependencyInjector, "__construct", NULL, 335);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("_dependencyInjector"), &dependencyInjector);
	}
	if (shared) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "set", NULL, 336, &serviceName, definition, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, hasService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "has", NULL, 337, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "get", NULL, 338, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getSharedService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&dependencyInjector, "getshared", NULL, 339, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, offsetUnset) {
	...
	ZEPHIR_CALL_METHOD(NULL, &dependencyInjector, "remove", NULL, 340, alias);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
