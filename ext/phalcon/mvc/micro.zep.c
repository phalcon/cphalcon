...
PHP_METHOD(Phalcon_Mvc_Micro, getService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "get", NULL, 418, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getSharedService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "getshared", NULL, 419, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, handle) {
	...
	/* try_start_1: */
		...
		if (Z_TYPE_P(&matchedRoute) == IS_OBJECT) {
			...
			zephir_is_iterable(&beforeHandlers, 0, "phalcon/Mvc/Micro.zep", 441);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&beforeHandlers), _17$$7)
				{
					...
					if (_19$$11) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&before TSRMLS_CC)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_20$$14, "__construct", NULL, 1, &_21$$14);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_20$$14, "phalcon/Mvc/Micro.zep", 424 TSRMLS_CC);
							goto try_end_1;
					...
					zephir_check_call_status();
						...
						if (_23$$16) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&before TSRMLS_CC)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_24$$19, "__construct", NULL, 1, &_25$$19);
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_24$$19, "phalcon/Mvc/Micro.zep", 424 TSRMLS_CC);
								goto try_end_1;
			...
			if (Z_TYPE_P(&handler) == IS_ARRAY) {
				...
				zephir_array_fetch_long(&realHandler, &handler, 0, PH_NOISY, "phalcon/Mvc/Micro.zep", 472 TSRMLS_CC);
				...
				if (_34$$25) {
					...
					zephir_array_fetch_long(&methodName, &handler, 1, PH_NOISY, "phalcon/Mvc/Micro.zep", 475 TSRMLS_CC);
			...
			if (_38$$7) {
				...
				zephir_array_fetch_long(&methodName, &handler, 1, PH_NOISY, "phalcon/Mvc/Micro.zep", 492 TSRMLS_CC);
			...
			zephir_is_iterable(&afterBindingHandlers, 0, "phalcon/Mvc/Micro.zep", 555);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterBindingHandlers), _41$$7)
				{
					...
					if (_43$$31) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&afterBinding TSRMLS_CC)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_44$$34, "__construct", NULL, 1, &_45$$34);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_44$$34, "phalcon/Mvc/Micro.zep", 535 TSRMLS_CC);
							goto try_end_1;
					...
					zephir_check_call_status();
						...
						if (_47$$36) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&afterBinding TSRMLS_CC)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_48$$39, "__construct", NULL, 1, &_49$$39);
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_48$$39, "phalcon/Mvc/Micro.zep", 535 TSRMLS_CC);
								goto try_end_1;
			...
			zephir_is_iterable(&afterHandlers, 0, "phalcon/Mvc/Micro.zep", 594);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterHandlers), _52$$7)
				{
					...
					if (_54$$42) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&after TSRMLS_CC)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_55$$45, "__construct", NULL, 1, &_56$$45);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_55$$45, "phalcon/Mvc/Micro.zep", 581 TSRMLS_CC);
							goto try_end_1;
					...
					zephir_check_call_status();
						...
						if (_58$$47) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&after TSRMLS_CC)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_59$$50, "__construct", NULL, 1, &_60$$50);
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_59$$50, "phalcon/Mvc/Micro.zep", 581 TSRMLS_CC);
								goto try_end_1;
			...
			if (UNEXPECTED(!(zephir_is_callable(&notFoundHandler TSRMLS_CC)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_65$$55, "__construct", NULL, 1, &_66$$55);
				zephir_check_call_status_or_jump(try_end_1);
				zephir_throw_exception_debug(&_65$$55, "phalcon/Mvc/Micro.zep", 614 TSRMLS_CC);
				goto try_end_1;
		...
		zephir_is_iterable(&finishHandlers, 0, "phalcon/Mvc/Micro.zep", 669);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&finishHandlers), _68$$4)
			{
				...
				if (_70$$57) {
					...
					if (UNEXPECTED(!(zephir_is_callable(&finish TSRMLS_CC)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_71$$60, "__construct", NULL, 1, &_72$$60);
						zephir_check_call_status_or_jump(try_end_1);
						zephir_throw_exception_debug(&_71$$60, "phalcon/Mvc/Micro.zep", 650 TSRMLS_CC);
						goto try_end_1;
				...
				zephir_check_call_status();
					...
					if (_75$$62) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&finish TSRMLS_CC)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_76$$65, "__construct", NULL, 1, &_77$$65);
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_76$$65, "phalcon/Mvc/Micro.zep", 650 TSRMLS_CC);
							goto try_end_1;
		...
		if (zephir_is_instance_of(&_80, SL("Throwable") TSRMLS_CC)) {
			...
			if (zephir_is_true(&errorHandler)) {
				if (UNEXPECTED(!(zephir_is_callable(&errorHandler TSRMLS_CC)))) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_micro_exception_ce, "Error handler is not callable", "phalcon/Mvc/Micro.zep", 690);
					return;
				}
				...
				if (Z_TYPE_P(&returnedValue) == IS_OBJECT) {
					if (!(zephir_instance_of_ev(&returnedValue, phalcon_http_responseinterface_ce TSRMLS_CC))) {
						zephir_throw_exception_debug(&e, "phalcon/Mvc/Micro.zep", 703 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&returnedValue)) {
						zephir_throw_exception_debug(&e, "phalcon/Mvc/Micro.zep", 707 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
				...
				if (!ZEPHIR_IS_FALSE_IDENTICAL(&returnedValue)) {
					zephir_throw_exception_debug(&e, "phalcon/Mvc/Micro.zep", 712 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	if (zephir_is_true(&_0)) {
		...
		if (UNEXPECTED(!(zephir_is_callable(&_84$$77 TSRMLS_CC)))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_micro_exception_ce, "Response handler is not callable or is not defined", "phalcon/Mvc/Micro.zep", 725);
			return;
		}
...
PHP_METHOD(Phalcon_Mvc_Micro, hasService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "has", NULL, 420, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, mount) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&mainHandler))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_micro_exception_ce, "Collection requires a main handler", "phalcon/Mvc/Micro.zep", 848);
		return;
	}
	ZEPHIR_CALL_METHOD(&handlers, collection, "gethandlers", NULL, 0);
	zephir_check_call_status();
	if (UNEXPECTED(!(zephir_fast_count_int(&handlers TSRMLS_CC)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_micro_exception_ce, "There are no handlers to mount", "phalcon/Mvc/Micro.zep", 854);
		return;
	}
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &lazyHandler, "__construct", NULL, 421, &mainHandler);
		zephir_check_call_status();
	} else {
	...
	zephir_check_call_status();
	zephir_is_iterable(&handlers, 0, "phalcon/Mvc/Micro.zep", 912);
	if (Z_TYPE_P(&handlers) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&handlers), _1)
		{
			...
			if (UNEXPECTED(Z_TYPE_P(&handler) != IS_ARRAY)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_micro_exception_ce, "One of the registered handlers is invalid", "phalcon/Mvc/Micro.zep", 875);
				return;
			}
			ZEPHIR_OBS_NVAR(&methods);
			zephir_array_fetch_long(&methods, &handler, 0, PH_NOISY, "phalcon/Mvc/Micro.zep", 878 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&pattern);
			zephir_array_fetch_long(&pattern, &handler, 1, PH_NOISY, "phalcon/Mvc/Micro.zep", 879 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&subHandler);
			zephir_array_fetch_long(&subHandler, &handler, 2, PH_NOISY, "phalcon/Mvc/Micro.zep", 880 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&name);
			zephir_array_fetch_long(&name, &handler, 3, PH_NOISY, "phalcon/Mvc/Micro.zep", 881 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Micro, offsetUnset) {
	...
	ZEPHIR_CALL_METHOD(NULL, &container, "remove", NULL, 422, alias);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Micro, setService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "set", NULL, 423, &serviceName, definition, &_0);
	zephir_check_call_status();
	RETURN_MM();
