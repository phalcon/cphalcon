...
PHP_METHOD(Phalcon_Mvc_Micro, error)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &handler);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 977, handler);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Micro, getRouter)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 980, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "clear", NULL, 0);
		zephir_check_call_status();
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 980, PH_NOISY_CC | PH_READONLY);
		ZVAL_BOOL(&_5$$3, 1);
...
PHP_METHOD(Phalcon_Mvc_Micro, handle)
{
	...
	/* try_start_1: */
		...
		if (Z_TYPE_P(&_2$$4) != IS_NULL) {
			...
			zephir_read_property_cached(&_3$$5, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC);
			if (zephir_instance_of_ev(&_3$$5, phalcon_events_manager_ce)) {
				zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&matchedRoute) != IS_NULL) {
			...
			zephir_read_property_cached(&_15$$9, this_ptr, _zephir_prop_2, 982, PH_NOISY_CC | PH_READONLY);
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 983, &handler);
			zephir_read_property_cached(&_18$$9, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_18$$9) != IS_NULL) {
				zephir_memory_observe(&_19$$11);
				zephir_read_property_cached(&_19$$11, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC);
				if (zephir_instance_of_ev(&_19$$11, phalcon_events_manager_ce)) {
					zephir_read_property_cached(&_23$$12, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
					...
					zephir_read_property_cached(&_20$$11, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&handler, this_ptr, _zephir_prop_3, 983, PH_NOISY_CC);
			}
			zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_4, 984, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CPY_WRT(&beforeHandlers, &_29$$9);
			if (0) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 985, &__$true);
			} else {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 985, &__$false);
			}
			...
			zephir_is_iterable(_30$$9, 0, "phalcon/Mvc/Micro.zep", 457);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_30$$9), _32$$9)
				{
					...
					if (_33$$15) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&before)))) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_34$$18, "phalcon/Mvc/Micro.zep", 440);
							goto try_end_1;
					...
					zephir_read_property_cached(&_37$$15, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status();
						...
						if (_40$$20) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&before)))) {
								...
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_41$$23, "phalcon/Mvc/Micro.zep", 440);
								goto try_end_1;
						...
						zephir_read_property_cached(&_43$$20, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status_or_jump(try_end_1);
			zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_6, 978, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_29$$9, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_29$$9) != IS_NULL) {
				zephir_read_property_cached(&_56$$33, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_59$$9, this_ptr, _zephir_prop_7, 986, PH_NOISY_CC | PH_READONLY);
			...
			zephir_is_iterable(_60$$9, 0, "phalcon/Mvc/Micro.zep", 569);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_60$$9), _62$$9)
				{
					...
					if (_63$$35) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&afterBinding)))) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_64$$38, "phalcon/Mvc/Micro.zep", 549);
							goto try_end_1;
					...
					zephir_read_property_cached(&_66$$35, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status();
						...
						if (_69$$40) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&afterBinding)))) {
								...
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_70$$43, "phalcon/Mvc/Micro.zep", 549);
								goto try_end_1;
						...
						zephir_read_property_cached(&_72$$40, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
			...
			ZEPHIR_INIT_NVAR(&afterBinding);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 987, &returnedValue);
			zephir_read_property_cached(&_59$$9, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_59$$9) != IS_NULL) {
				zephir_read_property_cached(&_73$$45, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_75$$9, this_ptr, _zephir_prop_9, 988, PH_NOISY_CC | PH_READONLY);
			...
			zephir_is_iterable(_76$$9, 0, "phalcon/Mvc/Micro.zep", 606);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_76$$9), _78$$9)
				{
					...
					if (_79$$46) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&after)))) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_80$$49, "phalcon/Mvc/Micro.zep", 593);
							goto try_end_1;
					...
					zephir_read_property_cached(&_82$$46, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status();
						...
						if (_85$$51) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&after)))) {
								...
								zephir_check_call_status_or_jump(try_end_1);
								zephir_throw_exception_debug(&_86$$54, "phalcon/Mvc/Micro.zep", 593);
								goto try_end_1;
						...
						zephir_read_property_cached(&_88$$51, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_89$$56, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_89$$56) != IS_NULL) {
				zephir_read_property_cached(&_90$$57, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_93$$56, this_ptr, _zephir_prop_10, 989, PH_NOISY_CC | PH_READONLY);
			...
			if (UNEXPECTED(!(zephir_is_callable(&notFoundHandler)))) {
				...
				zephir_check_call_status_or_jump(try_end_1);
				zephir_throw_exception_debug(&_94$$59, "phalcon/Mvc/Micro.zep", 622);
				goto try_end_1;
		...
		zephir_read_property_cached(&_95$$4, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_95$$4) != IS_NULL) {
			zephir_read_property_cached(&_96$$60, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_98$$4, this_ptr, _zephir_prop_11, 990, PH_NOISY_CC | PH_READONLY);
		...
		zephir_is_iterable(_99$$4, 0, "phalcon/Mvc/Micro.zep", 674);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_99$$4), _100$$4)
			{
				...
				if (_101$$61) {
					...
					if (UNEXPECTED(!(zephir_is_callable(&finish)))) {
						...
						zephir_check_call_status_or_jump(try_end_1);
						zephir_throw_exception_debug(&_102$$64, "phalcon/Mvc/Micro.zep", 655);
						goto try_end_1;
				...
				zephir_read_property_cached(&_105$$61, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
					...
					if (_108$$66) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&finish)))) {
							...
							zephir_check_call_status_or_jump(try_end_1);
							zephir_throw_exception_debug(&_109$$69, "phalcon/Mvc/Micro.zep", 655);
							goto try_end_1;
					...
					zephir_read_property_cached(&_112$$66, this_ptr, _zephir_prop_5, 985, PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_113, SL("Throwable"))) {
			...
			zephir_read_property_cached(&_114$$71, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_114$$71) != IS_NULL) {
				zephir_read_property_cached(&_115$$72, this_ptr, _zephir_prop_1, 979, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_117$$71, this_ptr, _zephir_prop_12, 977, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_117$$71) != IS_NULL) {
				zephir_read_property_cached(&_118$$73, this_ptr, _zephir_prop_12, 977, PH_NOISY_CC | PH_READONLY);
				if (UNEXPECTED(!(zephir_is_callable(&_118$$73)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_119$$74, "phalcon/Mvc/Micro.zep", 691);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_read_property_cached(&_120$$73, this_ptr, _zephir_prop_12, 977, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_13, 991, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_122$$81, this_ptr, _zephir_prop_13, 991, PH_NOISY_CC | PH_READONLY);
		if (UNEXPECTED(!(zephir_is_callable(&_122$$81)))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_123$$82, "phalcon/Mvc/Micro.zep", 724);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_read_property_cached(&_124$$81, this_ptr, _zephir_prop_13, 991, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_NVAR(&returnedValue);
...
PHP_METHOD(Phalcon_Mvc_Micro, mount)
{
	...
	zephir_is_iterable(_3, 0, "phalcon/Mvc/Micro.zep", 859);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			if (UNEXPECTED(Z_TYPE_P(&handler) != IS_ARRAY)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$8, "phalcon/Mvc/Micro.zep", 822);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (UNEXPECTED(Z_TYPE_P(&handler) != IS_ARRAY)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_13$$16, "phalcon/Mvc/Micro.zep", 822);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_OBS_NVAR(&methods);
...
PHP_METHOD(Phalcon_Mvc_Micro, setActiveHandler)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 983, activeHandler);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Micro, setModelBinder)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 978, modelBinder);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Micro, checkDiContainer)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 981, &_1$$3);
	}
	ZEPHIR_MM_RESTORE();
}
