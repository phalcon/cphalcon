...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_application_phpfopen, 0, 2, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_application_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Application, phpFclose, arginfo_phalcon_mvc_application_phpfclose, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFgetCsv, arginfo_phalcon_mvc_application_phpfgetcsv, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFileExists, arginfo_phalcon_mvc_application_phpfileexists, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFileGetContents, arginfo_phalcon_mvc_application_phpfilegetcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFilePutContents, arginfo_phalcon_mvc_application_phpfileputcontents, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFopen, arginfo_phalcon_mvc_application_phpfopen, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpFwrite, arginfo_phalcon_mvc_application_phpfwrite, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpIsWritable, arginfo_phalcon_mvc_application_phpiswritable, ZEND_ACC_PROTECTED)
	PHP_ME(Phalcon_Mvc_Application, phpUnlink, arginfo_phalcon_mvc_application_phpunlink, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
