...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 951, &controllerName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 952, &controllerSuffix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setDefaultController)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&controllerName_zv, controllerName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 953, &controllerName_zv);
	RETURN_THISW();
}
