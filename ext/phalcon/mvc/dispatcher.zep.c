...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 962, &controllerName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 963, &controllerSuffix_zv);
	RETURN_THISW();
}
