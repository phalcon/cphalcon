...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 945, &controllerName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setControllerSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 946, &controllerSuffix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, setDefaultController)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&controllerName_zv, controllerName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 947, &controllerName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Dispatcher, throwDispatchException)
{
	...
	if (Z_TYPE_P(&container) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/Dispatcher.zep", 219);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&_3);
	...
	zephir_throw_exception_debug(&exception, "phalcon/Mvc/Dispatcher.zep", 241);
	ZEPHIR_MM_RESTORE();
	return;
}
