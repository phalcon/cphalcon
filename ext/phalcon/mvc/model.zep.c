...
PHP_METHOD(Phalcon_Mvc_Model, __construct) {
	...
	if (UNEXPECTED(Z_TYPE_P(container) != IS_OBJECT)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Mvc/Model.zep", 138 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(modelsManager) != IS_OBJECT) {
		...
		if (UNEXPECTED(Z_TYPE_P(modelsManager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The injected service 'modelsManager' is not valid", "phalcon/Mvc/Model.zep", 152);
			return;
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model, __call) {
	...
	ZEPHIR_CALL_SELF(&records, "_invokefinder", &_0, 413, &method, &arguments);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_2, "phalcon/Mvc/Model.zep", 220 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model, __callStatic) {
	...
	ZEPHIR_CALL_SELF(&records, "_invokefinder", &_0, 413, &method, &arguments);
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(&records) == IS_NULL)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/Model.zep", 237 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(&records);
...
PHP_METHOD(Phalcon_Mvc_Model, __get) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *property_param = NULL, modelName, manager, lowerProperty, relation, method, _0, _4, _5, _1$$3, _2$$4, _3$$4;
	zval property;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&relation) == IS_OBJECT) {
		...
		if (zephir_array_isset(&_1$$3, &lowerProperty)) {
			...
			zephir_array_fetch(&_3$$4, &_2$$4, &lowerProperty, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 271 TSRMLS_CC);
			RETURN_CTOR(&_3$$4);
		}
...
PHP_METHOD(Phalcon_Mvc_Model, __set) {
	...
	zend_bool _0;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *property_param = NULL, *value, value_sub, lowerProperty, related, modelName, manager, relation, referencedModel, item, dirtyState, _13, _14, _1$$3, _2$$4, _3$$4, _4$$6, _5$$7, _6$$8, _7$$9, _8$$9, *_9$$10, _10$$10, _11$$17, _12$$17, _15$$19, _16$$20;
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(value), _9$$10)
						{
							...
							if (Z_TYPE_P(&item) == IS_OBJECT) {
								if (zephir_instance_of_ev(&item, phalcon_mvc_modelinterface_ce TSRMLS_CC)) {
									zephir_array_append(&related, &item, PH_SEPARATE, "phalcon/Mvc/Model.zep", 404);
								}
							}
	...
	ZEPHIR_CALL_METHOD(&_13, this_ptr, "_possiblesetter", NULL, 414, &property, value);
	zephir_check_call_status();
	if (zephir_is_true(&_13)) {
		RETVAL_ZVAL(value, 1, 0);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_14, "property_exists", NULL, 415, this_ptr, &property);
	zephir_check_call_status();
	if (zephir_is_true(&_14)) {
		...
		if (UNEXPECTED(!zephir_is_true(&_15$$19))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_16$$20, "phalcon/Mvc/Model.zep", 438 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model, assign) {
	...
	if (Z_TYPE_P(dataColumnMap) == IS_ARRAY) {
		...
		zephir_is_iterable(&data, 0, "phalcon/Mvc/Model.zep", 571);
		if (Z_TYPE_P(&data) == IS_ARRAY) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&_4, 0, "phalcon/Mvc/Model.zep", 628);
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			...
			if (_7$$12) {
				ZEPHIR_CALL_SELF(&_8$$13, "caseinsensitivecolumnmap", &_9, 416, &columnMap, &attribute);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (!(zephir_array_isset_fetch(&attributeField, &columnMap, &attribute, 0 TSRMLS_CC))) {
					if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$16, "phalcon/Mvc/Model.zep", 602 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					continue;
			...
			if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0 TSRMLS_CC)) {
				...
				if (!(_13$$18)) {
					ZEPHIR_CALL_METHOD(&_14$$18, this_ptr, "_possiblesetter", &_15, 414, &attributeField, &value);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_16$$22) {
					ZEPHIR_CALL_SELF(&_17$$23, "caseinsensitivecolumnmap", &_9, 416, &columnMap, &attribute);
					zephir_check_call_status();
				...
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_fetch(&attributeField, &columnMap, &attribute, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_18$$26, "phalcon/Mvc/Model.zep", 602 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						continue;
				...
				if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0 TSRMLS_CC)) {
					...
					if (!(_20$$28)) {
						ZEPHIR_CALL_METHOD(&_21$$28, this_ptr, "_possiblesetter", &_15, 414, &attributeField, &value);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, cloneResult) {
	...
	zephir_check_call_status();
	zephir_is_iterable(&data, 0, "phalcon/Mvc/Model.zep", 706);
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _3, _4, _1)
		{
			...
			if (UNEXPECTED(Z_TYPE_P(&key) != IS_STRING)) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Invalid key in array data provided to dumpResult()", "phalcon/Mvc/Model.zep", 696);
				return;
			}
...
PHP_METHOD(Phalcon_Mvc_Model, cloneResultMap) {
	...
	ZEPHIR_CALL_METHOD(NULL, &instance, "setdirtystate", NULL, 0, &_0);
	zephir_check_call_status();
	zephir_is_iterable(&data, 0, "phalcon/Mvc/Model.zep", 809);
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _3, _4, _1)
		{
			ZEPHIR_INIT_NVAR(&key);
			...
			if (Z_TYPE_P(&key) == IS_STRING) {
				...
				if (_8$$4) {
					...
					do {
						if (ZEPHIR_IS_LONG(&_9$$9, 0)) {
							ZVAL_LONG(&_10$$10, 10);
							ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 23, &value, &_10$$10);
							zephir_check_call_status();
							break;
						}
					...
					zephir_array_fetch_long(&_12$$14, &attribute, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 785 TSRMLS_CC);
					do {
				...
				zephir_array_fetch_long(&attributeName, &attribute, 0, PH_NOISY, "phalcon/Mvc/Model.zep", 801 TSRMLS_CC);
					...
					if (_15$$18) {
						...
						do {
							if (ZEPHIR_IS_LONG(&_16$$23, 0)) {
								ZVAL_LONG(&_17$$24, 10);
								ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 23, &value, &_17$$24);
								zephir_check_call_status();
								break;
							}
						...
						zephir_array_fetch_long(&_18$$28, &attribute, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 785 TSRMLS_CC);
						do {
...
PHP_METHOD(Phalcon_Mvc_Model, cloneResultMapHydrate) {
	...
	zephir_is_iterable(&data, 0, "phalcon/Mvc/Model.zep", 901);
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(columnMap) == IS_ARRAY) {
				...
				if (_4$$9) {
					ZEPHIR_CALL_SELF(&_5$$10, "caseinsensitivecolumnmap", &_6, 416, columnMap, &key);
					zephir_check_call_status();
				...
				if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
					if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_7$$12, "phalcon/Mvc/Model.zep", 872 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					} else {
						continue;
				...
				if (Z_TYPE_P(&attribute) == IS_ARRAY) {
					ZEPHIR_OBS_NVAR(&attributeName);
					zephir_array_fetch_long(&attributeName, &attribute, 0, PH_NOISY, "phalcon/Mvc/Model.zep", 882 TSRMLS_CC);
				} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(columnMap) == IS_ARRAY) {
					...
					if (_10$$23) {
						ZEPHIR_CALL_SELF(&_11$$24, "caseinsensitivecolumnmap", &_6, 416, columnMap, &key);
						zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_12$$26, "phalcon/Mvc/Model.zep", 872 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						} else {
							continue;
...
PHP_METHOD(Phalcon_Mvc_Model, create) {
	...
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getreadconnection", NULL, 417);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 400, &_4$$3, &_5$$3, &_6$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, delete) {
	...
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&writeConnection, this_ptr, "getwriteconnection", NULL, 418);
	zephir_check_call_status();
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_checkforeignkeysreverserestrict", NULL, 419);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&primaryKeys) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&primaryKeys), _3)
		{
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &primaryKey, 0 TSRMLS_CC)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_5$$9, "phalcon/Mvc/Model.zep", 1068 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &primaryKey, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$11, "phalcon/Mvc/Model.zep", 1078 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
			...
			if (UNEXPECTED(!(zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_10$$13, "phalcon/Mvc/Model.zep", 1091 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &primaryKey, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_15$$15, "phalcon/Mvc/Model.zep", 1068 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &primaryKey, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$17, "phalcon/Mvc/Model.zep", 1078 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (UNEXPECTED(!(zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_19$$19, "phalcon/Mvc/Model.zep", 1091 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 1097);
	...
	ZEPHIR_CALL_METHOD(&schema, this_ptr, "getschema", NULL, 420);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&source, this_ptr, "getsource", NULL, 421);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_28$$25, this_ptr, "_checkforeignkeysreversecascade", NULL, 422);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, find) {
	...
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_0, 423, &params);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, findFirst) {
	...
	if (Z_TYPE_P(parameters) == IS_NULL) {
		...
		array_init(&params);
		zephir_array_append(&params, parameters, PH_SEPARATE, "phalcon/Mvc/Model.zep", 1448);
	} else {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Parameters passed must be of type array, string, numeric or null", "phalcon/Mvc/Model.zep", 1452);
		return;
	}
	ZVAL_LONG(&_2, 1);
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_1, 423, &params, &_2);
	zephir_check_call_status();
	ZVAL_BOOL(&_2, 1);
...
PHP_METHOD(Phalcon_Mvc_Model, getChangedFields) {
	...
	if (UNEXPECTED(Z_TYPE_P(&snapshot) != IS_ARRAY)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The record doesn't have a valid data snapshot", "phalcon/Mvc/Model.zep", 1537);
		return;
	}
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&allAttributes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&allAttributes), _4, _5, _2)
		{
			...
			zephir_array_fetch(&_6$$6, &snapshot, &name, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 1588 TSRMLS_CC);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch(&_7$$10, &snapshot, &name, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 1588 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model, getMessages) {
	...
	if (_0) {
		...
		zephir_is_iterable(&_1$$3, 0, "phalcon/Mvc/Model.zep", 1659);
		if (Z_TYPE_P(&_1$$3) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1$$3), _2$$3)
			{
				...
				if (ZEPHIR_IS_EQUAL(&_4$$4, filter)) {
					zephir_array_append(&filtered, &message, PH_SEPARATE, "phalcon/Mvc/Model.zep", 1655);
				}
			} ZEND_HASH_FOREACH_END();
		} else {
...
PHP_METHOD(Phalcon_Mvc_Model, getModelsMetaData) {
	...
	if (Z_TYPE_P(&metaData) != IS_OBJECT) {
		...
		if (UNEXPECTED(Z_TYPE_P(&metaData) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The injected service 'modelsMetadata' is not valid", "phalcon/Mvc/Model.zep", 1693);
			return;
		}
...
PHP_METHOD(Phalcon_Mvc_Model, getRelated) {
	...
	if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Mvc/Model.zep", 1772 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (Z_TYPE_P(arguments) == IS_NULL) {
		...
		if (_5$$4) {
			...
			zephir_array_fetch(&result, &_7$$5, &lowerAlias, PH_NOISY, "phalcon/Mvc/Model.zep", 1784 TSRMLS_CC);
		} else {
			ZVAL_NULL(&_8$$6);
...
PHP_METHOD(Phalcon_Mvc_Model, getUpdatedFields) {
	...
	if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).update_snapshot_on_save))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Update snapshot on save must be enabled for this method to work properly", "phalcon/Mvc/Model.zep", 1882);
		return;
	}
	if (UNEXPECTED(Z_TYPE_P(&snapshot) != IS_ARRAY)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The record doesn't have a valid data snapshot", "phalcon/Mvc/Model.zep", 1888);
		return;
	}
	zephir_read_property(&_0, this_ptr, SL("dirtyState"), PH_NOISY_CC | PH_READONLY);
	if (UNEXPECTED(!ZEPHIR_IS_LONG(&_0, 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Change checking cannot be performed because the object has not been persisted or is deleted", "phalcon/Mvc/Model.zep", 1897);
		return;
	}
	ZEPHIR_INIT_VAR(&updated);
	array_init(&updated);
	zephir_is_iterable(&snapshot, 0, "phalcon/Mvc/Model.zep", 1912);
	if (Z_TYPE_P(&snapshot) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&snapshot), _3, _4, _1)
		{
			...
			if (!(_5$$6)) {
				zephir_array_fetch(&_6$$6, &oldSnapshot, &name, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 1907 TSRMLS_CC);
				_5$$6 = !ZEPHIR_IS_IDENTICAL(&value, &_6$$6);
			}
			if (_5$$6) {
				zephir_array_append(&updated, &name, PH_SEPARATE, "phalcon/Mvc/Model.zep", 1908);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (!(_7$$8)) {
					zephir_array_fetch(&_8$$8, &oldSnapshot, &name, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 1907 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model, hasChanged) {
	...
	if (Z_TYPE_P(fieldName) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&intersect, "array_intersect", NULL, 424, fieldName, &changedFields);
		zephir_check_call_status();
		if (allFields) {
...
PHP_METHOD(Phalcon_Mvc_Model, hasUpdated) {
	...
	if (Z_TYPE_P(fieldName) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&intersect, "array_intersect", NULL, 424, fieldName, &updatedFields);
		zephir_check_call_status();
		if (allFields) {
			RETURN_MM_BOOL(ZEPHIR_IS_EQUAL(&intersect, fieldName));
		}
...
PHP_METHOD(Phalcon_Mvc_Model, query) {
	...
	if (zephir_instance_of_ev(container, phalcon_diinterface_ce TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &criteria, "setdi", NULL, 425, container);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_3);
	zephir_get_called_class(&_3 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &criteria, "setmodelname", NULL, 426, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, refresh) {
	...
	zephir_read_property(&_0, this_ptr, SL("dirtyState"), PH_NOISY_CC | PH_READONLY);
	if (UNEXPECTED(!ZEPHIR_IS_LONG(&_0, 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The record cannot be refreshed because it does not exist or is deleted", "phalcon/Mvc/Model.zep", 2169);
		return;
	}
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&readConnection, this_ptr, "getreadconnection", NULL, 417);
	zephir_check_call_status();
	zephir_read_property(&_1, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&uniqueKey))) {
		...
		if (UNEXPECTED(!zephir_is_true(&_2$$6))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The record cannot be refreshed because it does not exist or is deleted", "phalcon/Mvc/Model.zep", 2194);
			return;
		}
	...
	if (UNEXPECTED(Z_TYPE_P(&uniqueParams) != IS_ARRAY)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The record cannot be refreshed because it does not exist or is deleted", "phalcon/Mvc/Model.zep", 2205);
		return;
	}
	...
	ZEPHIR_CALL_METHOD(&_4, &metaData, "getattributes", NULL, 0, this_ptr);
	zephir_check_call_status();
	zephir_is_iterable(&_4, 0, "phalcon/Mvc/Model.zep", 2220);
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			ZEPHIR_INIT_NVAR(&attribute);
			...
			zephir_array_append(&fields, &_7$$9, PH_SEPARATE, "phalcon/Mvc/Model.zep", 2214);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, &_4, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_append(&fields, &_8$$10, PH_SEPARATE, "phalcon/Mvc/Model.zep", 2214);
			ZEPHIR_CALL_METHOD(NULL, &_4, "next", NULL, 0);
			zephir_check_call_status();
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model, save) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_5)) {
		...
		if (UNEXPECTED(ZEPHIR_GLOBAL(orm).exception_on_failed_save)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_7$$11, "__construct", NULL, 427, this_ptr, &_8$$11);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_7$$11, "phalcon/Mvc/Model.zep", 2369 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		RETURN_MM_BOOL(0);
...
PHP_METHOD(Phalcon_Mvc_Model, unserialize) {
	...
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		...
		if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 1, &_2$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_1$$4, "phalcon/Mvc/Model.zep", 2490 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_update_property_zval(this_ptr, SL("container"), &container);
		...
		if (UNEXPECTED(Z_TYPE_P(&manager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The injected service 'modelsManager' is not valid", "phalcon/Mvc/Model.zep", 2506);
			return;
		}
		...
		if (zephir_is_true(&_5$$3)) {
			if (zephir_array_isset_string_fetch(&snapshot, &attributes, SL("snapshot"), 1)) {
				...
				zephir_array_fetch_string(&_7$$7, &attributes, SL("_attributes"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 2522 TSRMLS_CC);
				ZEPHIR_CPY_WRT(&attributes, &_7$$7);
			} else {
				zephir_update_property_zval(this_ptr, SL("snapshot"), &attributes);
			}
		}
		zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Model.zep", 2534);
		if (Z_TYPE_P(&attributes) == IS_ARRAY) {
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _2$$3, _3$$3, _0$$3)
			{
				...
				if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
					if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_4$$7, "phalcon/Mvc/Model.zep", 2622 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					continue;
				...
				if (Z_TYPE_P(&attribute) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_long_fetch(&attribute, &attribute, 0, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_7$$10, "phalcon/Mvc/Model.zep", 2633 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						continue;
				...
				zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_9$$14, "phalcon/Mvc/Model.zep", 2622 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						continue;
					...
					if (Z_TYPE_P(&attribute) == IS_ARRAY) {
						...
						if (!(zephir_array_isset_long_fetch(&attribute, &attribute, 0, 0 TSRMLS_CC))) {
							if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_11$$17, "phalcon/Mvc/Model.zep", 2633 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							continue;
...
PHP_METHOD(Phalcon_Mvc_Model, setSnapshotData) {
	...
	if (Z_TYPE_P(columnMap) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&snapshot);
		array_init(&snapshot);
		zephir_is_iterable(&data, 0, "phalcon/Mvc/Model.zep", 2706);
		if (Z_TYPE_P(&data) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _2$$3, _3$$3, _0$$3)
			{
				ZEPHIR_INIT_NVAR(&key);
				...
				if (_4$$4) {
					ZEPHIR_CALL_SELF(&_5$$6, "caseinsensitivecolumnmap", &_6, 416, columnMap, &key);
					zephir_check_call_status();
				...
				if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
					if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_7$$8, "phalcon/Mvc/Model.zep", 2686 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					continue;
				...
				if (Z_TYPE_P(&attribute) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_long_fetch(&attribute, &attribute, 0, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_10$$11, "phalcon/Mvc/Model.zep", 2697 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						continue;
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_12$$12) {
						ZEPHIR_CALL_SELF(&_13$$14, "caseinsensitivecolumnmap", &_6, 416, columnMap, &key);
						zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&attribute, columnMap, &key, 0 TSRMLS_CC))) {
						if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_14$$16, "phalcon/Mvc/Model.zep", 2686 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						continue;
					...
					if (Z_TYPE_P(&attribute) == IS_ARRAY) {
						...
						if (!(zephir_array_isset_long_fetch(&attribute, &attribute, 0, 0 TSRMLS_CC))) {
							if (UNEXPECTED(!(ZEPHIR_GLOBAL(orm).ignore_unknown_columns))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_16$$19, "phalcon/Mvc/Model.zep", 2697 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							continue;
...
PHP_METHOD(Phalcon_Mvc_Model, setup) {
	...
	zval *options_param = NULL, disableEvents, columnRenaming, notNullValidations, exceptionOnFailedSave, phqlLiterals, virtualForeignKeys, lateStateBinding, castOnHydrate, ignoreUnknownColumns, updateSnapshotOnSave, disableAssignSetters, caseInsensitiveColumnMap, prefetchRecords;
	zval options;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (_3$$4) {
					ZEPHIR_CALL_SELF(&_4$$5, "caseinsensitivecolumnmap", &_5, 416, &columnMap, &attribute);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (_9$$14) {
						ZEPHIR_CALL_SELF(&_10$$15, "caseinsensitivecolumnmap", &_5, 416, &columnMap, &attribute);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, update) {
	...
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getreadconnection", NULL, 417);
		zephir_check_call_status();
		...
		if (!(zephir_is_true(&_1$$3))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 400, &_5$$4, &_6$$4, &_7$$4);
			zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&belongsTo), _1)
		{
			...
			if (Z_TYPE_P(&foreignKey) == IS_ARRAY) {
				if (zephir_array_isset_string(&foreignKey, SL("action"))) {
					...
					zephir_array_fetch_string(&_3$$6, &foreignKey, SL("action"), PH_NOISY, "phalcon/Mvc/Model.zep", 3068 TSRMLS_CC);
			...
			if (Z_TYPE_P(&fields) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&fields) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _8$$8, _9$$8, _6$$8)
					{
						...
						zephir_array_fetch(&_10$$9, &referencedFields, &position, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 3104 TSRMLS_CC);
						ZEPHIR_INIT_LNVAR(_11$$9);
						ZEPHIR_CONCAT_SVSV(&_11$$9, "[", &_10$$9, "] = ?", &position);
						zephir_array_append(&conditions, &_11$$9, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3104);
					...
					while (1) {
						...
						zephir_check_call_status();
							ZEPHIR_OBS_NVAR(&value);
							zephir_fetch_property_zval(&value, this_ptr, &field, PH_SILENT_CC);
							zephir_array_fetch(&_12$$11, &referencedFields, &position, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 3104 TSRMLS_CC);
							ZEPHIR_INIT_LNVAR(_13$$11);
							ZEPHIR_CONCAT_SVSV(&_13$$11, "[", &_12$$11, "] = ?", &position);
							zephir_array_append(&conditions, &_13$$11, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3104);
							zephir_array_append(&bindParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3105);
							if (Z_TYPE_P(&value) == IS_NULL) {
								numberNull++;
							}
				...
				zephir_array_append(&conditions, &_14$$13, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3116);
			...
			if (_15$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_20$$19, "__construct", &_22, 400, &message, &fields, &_21$$19);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&foreignKey) == IS_ARRAY) {
					if (zephir_array_isset_string(&foreignKey, SL("action"))) {
						...
						zephir_array_fetch_string(&_24$$26, &foreignKey, SL("action"), PH_NOISY, "phalcon/Mvc/Model.zep", 3068 TSRMLS_CC);
				...
				if (Z_TYPE_P(&fields) == IS_ARRAY) {
					...
					if (Z_TYPE_P(&fields) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _29$$28, _30$$28, _27$$28)
						{
							...
							ZEPHIR_OBS_NVAR(&value);
							zephir_fetch_property_zval(&value, this_ptr, &field, PH_SILENT_CC);
							zephir_array_fetch(&_31$$29, &referencedFields, &position, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 3104 TSRMLS_CC);
							ZEPHIR_INIT_LNVAR(_32$$29);
							ZEPHIR_CONCAT_SVSV(&_32$$29, "[", &_31$$29, "] = ?", &position);
							zephir_array_append(&conditions, &_32$$29, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3104);
							zephir_array_append(&bindParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3105);
							if (Z_TYPE_P(&value) == IS_NULL) {
								numberNull++;
							}
						...
						while (1) {
							...
							zephir_check_call_status();
								ZEPHIR_OBS_NVAR(&value);
								zephir_fetch_property_zval(&value, this_ptr, &field, PH_SILENT_CC);
								zephir_array_fetch(&_33$$31, &referencedFields, &position, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 3104 TSRMLS_CC);
								ZEPHIR_INIT_LNVAR(_34$$31);
								ZEPHIR_CONCAT_SVSV(&_34$$31, "[", &_33$$31, "] = ?", &position);
								zephir_array_append(&conditions, &_34$$31, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3104);
								zephir_array_append(&bindParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3105);
								if (Z_TYPE_P(&value) == IS_NULL) {
									numberNull++;
								}
					...
					zephir_array_append(&conditions, &_35$$33, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3116);
					zephir_array_append(&bindParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3117);
					if (Z_TYPE_P(&value) == IS_NULL) {
						validateWithNulls = 1;
					}
				...
				if (_36$$23) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_41$$39, "__construct", &_22, 400, &message, &fields, &_42$$39);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(&relations) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&relations), _1)
		{
			...
			if (zephir_is_true(&_15$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_18$$12, "__construct", &_20, 400, &message, &fields, &_19$$12);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_34$$14)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_37$$23, "__construct", &_20, 400, &message, &fields, &_38$$23);
					zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _1)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_3$$7, "phalcon/Mvc/Model.zep", 3474 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
				...
				if (!ZEPHIR_IS_EQUAL(&field, identityField)) {
					...
					if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_8$$14, "phalcon/Mvc/Model.zep", 3503 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						...
						if (zephir_array_isset(&defaultValues, &field)) {
							...
							zephir_check_call_status();
							zephir_array_append(&values, &_10$$16, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3511);
							zephir_array_update_zval(&snapshot, &attributeField, &__$null, PH_COPY | PH_SEPARATE);
						} else {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$20, "phalcon/Mvc/Model.zep", 3474 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
					...
					if (!ZEPHIR_IS_EQUAL(&field, identityField)) {
						...
						if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
							...
							if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_16$$27, "phalcon/Mvc/Model.zep", 3503 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3506);
							...
							if (zephir_array_isset(&defaultValues, &field)) {
								...
								zephir_check_call_status();
								zephir_array_append(&values, &_18$$29, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3511);
								zephir_array_update_zval(&snapshot, &attributeField, &__$null, PH_COPY | PH_SEPARATE);
							} else {
								zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3519);
								zephir_array_update_zval(&snapshot, &attributeField, &value, PH_COPY | PH_SEPARATE);
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(identityField)) {
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, identityField, 0 TSRMLS_CC)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_21$$34, "phalcon/Mvc/Model.zep", 3553 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
		...
		if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
			...
			if (_23$$36) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, identityField, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_24$$41, "phalcon/Mvc/Model.zep", 3582 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
...
PHP_METHOD(Phalcon_Mvc_Model, _doLowUpdate) {
	...
	zephir_is_iterable(&nonPrimary, 0, "phalcon/Mvc/Model.zep", 3811);
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&nonPrimary), _2)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_4$$9, "phalcon/Mvc/Model.zep", 3700 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
			...
			if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_7$$12, "phalcon/Mvc/Model.zep", 3713 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_OBS_NVAR(&value);
				if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
					if (!(useDynamicUpdate)) {
						zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3725);
						zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3726);
						zephir_array_append(&bindTypes, &bindType, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3727);
					} else {
							...
							if (Z_TYPE_P(&value) == IS_NULL) {
								...
								if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
									...
									if (UNEXPECTED(!(zephir_array_isset_fetch(&dataType, &dataTypes, &field, 0 TSRMLS_CC)))) {
										...
										zephir_check_call_status();
										zephir_throw_exception_debug(&_9$$22, "phalcon/Mvc/Model.zep", 3752 TSRMLS_CC);
										ZEPHIR_MM_RESTORE();
										return;
									}
									do {
										...
										if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
											ZEPHIR_CALL_FUNCTION(&_11$$24, "floatval", &_12, 428, &snapshotValue);
											zephir_check_call_status();
											ZEPHIR_CALL_FUNCTION(&_13$$24, "floatval", &_12, 428, &value);
											zephir_check_call_status();
						...
						if (changed) {
							zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3791);
							zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3792);
							zephir_array_append(&bindTypes, &bindType, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3793);
						}
					}
					...
					zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3801);
					zephir_array_append(&values, &__$null, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3802);
					zephir_array_append(&bindTypes, &bindSkip, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3803);
				}
			}
		} ZEND_HASH_FOREACH_END();
	} else {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_16$$31, "phalcon/Mvc/Model.zep", 3700 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_18$$34, "phalcon/Mvc/Model.zep", 3713 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&value);
								...
								if (Z_TYPE_P(&value) == IS_NULL) {
									...
									if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
										...
										if (UNEXPECTED(!(zephir_array_isset_fetch(&dataType, &dataTypes, &field, 0 TSRMLS_CC)))) {
											...
											zephir_check_call_status();
											zephir_throw_exception_debug(&_20$$44, "phalcon/Mvc/Model.zep", 3752 TSRMLS_CC);
											ZEPHIR_MM_RESTORE();
											return;
										}
										do {
											...
											if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
												ZEPHIR_CALL_FUNCTION(&_22$$46, "floatval", &_12, 428, &snapshotValue);
												zephir_check_call_status();
												ZEPHIR_CALL_FUNCTION(&_23$$46, "floatval", &_12, 428, &value);
												zephir_check_call_status();
	...
	if (Z_TYPE_P(&uniqueParams) != IS_ARRAY) {
		...
		zephir_check_call_status();
		if (UNEXPECTED(!(zephir_fast_count_int(&primaryKeys TSRMLS_CC)))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "A primary key must be defined in the model in order to perform the operation", "phalcon/Mvc/Model.zep", 3835);
			return;
		}
		ZEPHIR_INIT_NVAR(&uniqueParams);
		array_init(&uniqueParams);
		zephir_is_iterable(&primaryKeys, 0, "phalcon/Mvc/Model.zep", 3862);
		if (Z_TYPE_P(&primaryKeys) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&primaryKeys), _26$$53)
			{
				...
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_28$$57, "phalcon/Mvc/Model.zep", 3848 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
					zephir_array_update_zval(&newSnapshot, &attributeField, &value, PH_COPY | PH_SEPARATE);
					zephir_array_append(&uniqueParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3856);
				} else {
					zephir_array_update_zval(&newSnapshot, &attributeField, &__$null, PH_COPY | PH_SEPARATE);
					zephir_array_append(&uniqueParams, &__$null, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3859);
				}
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &primaryKeys, "rewind", NULL, 0);
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_30$$63, "phalcon/Mvc/Model.zep", 3848 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
					} else {
...
PHP_METHOD(Phalcon_Mvc_Model, _exists) {
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&primaryKeys), _1$$3)
			{
				...
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_3$$9, "phalcon/Mvc/Model.zep", 3945 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
					...
					zephir_array_append(&uniqueParams, &value, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3966);
				} else {
					zephir_array_append(&uniqueParams, &__$null, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3968);
					numberEmpty++;
				}
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&type, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_7$$14, "phalcon/Mvc/Model.zep", 3975 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3978);
				ZEPHIR_CALL_METHOD(&_9$$7, connection, "escapeidentifier", &_10, 0, &field);
				zephir_check_call_status();
				ZEPHIR_INIT_LNVAR(_11$$7);
				ZEPHIR_CONCAT_VS(&_11$$7, &_9$$7, " = ?");
				zephir_array_append(&wherePk, &_11$$7, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3979);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &primaryKeys, "rewind", NULL, 0);
			zephir_check_call_status();
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_12$$17, "phalcon/Mvc/Model.zep", 3945 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
					} else {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&type, &bindDataTypes, &field, 0 TSRMLS_CC)))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_15$$22, "phalcon/Mvc/Model.zep", 3975 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3978);
					...
					zephir_array_append(&wherePk, &_19$$15, PH_SEPARATE, "phalcon/Mvc/Model.zep", 3979);
				ZEPHIR_CALL_METHOD(NULL, &primaryKeys, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_27, &num, SL("rowcount"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 4040 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model, _groupResult) {
	...
	if (Z_TYPE_P(parameters) != IS_ARRAY) {
		...
		array_init(&params);
		if (Z_TYPE_P(parameters) != IS_NULL) {
			zephir_array_append(&params, parameters, PH_SEPARATE, "phalcon/Mvc/Model.zep", 4135);
		}
	} else {
		ZEPHIR_CPY_WRT(&params, parameters);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, _invokeFinder) {
	...
	if (UNEXPECTED(!(zephir_array_isset_long_fetch(&value, &arguments, 0, 0 TSRMLS_CC)))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_3$$7, "phalcon/Mvc/Model.zep", 4254 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (zephir_array_isset(&attributes, &extraMethod)) {
		...
		if (zephir_array_isset(&attributes, &extraMethodFirst)) {
			...
			if (UNEXPECTED(!(zephir_array_isset(&attributes, &field)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_7$$13, "phalcon/Mvc/Model.zep", 4291 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Phalcon_Mvc_Model, _preSave) {
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_checkforeignkeysrestrict", NULL, 429);
		zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&notNull), _7$$12)
				{
					...
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_9$$19, "phalcon/Mvc/Model.zep", 4410 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
					} else {
					...
					if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
									...
									if (zephir_array_isset(&emptyStringValues, &field)) {
										...
										if (!(_12$$27)) {
											...
											if (_13$$27) {
												...
												if (!(_14$$27)) {
													zephir_array_fetch(&_15$$27, &defaultValues, &field, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 4439 TSRMLS_CC);
						...
						if (isNull) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_16$$32, "__construct", &_19, 400, &_17$$32, &attributeField, &_18$$32);
							zephir_check_call_status();
					...
					zephir_check_call_status();
						if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
							...
							if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeField, &columnMap, &field, 0 TSRMLS_CC)))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_20$$38, "phalcon/Mvc/Model.zep", 4410 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
						} else {
						...
						if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
										...
										if (zephir_array_isset(&emptyStringValues, &field)) {
											...
											if (!(_22$$46)) {
												...
												if (_23$$46) {
													...
													if (!(_24$$46)) {
														zephir_array_fetch(&_25$$46, &defaultValues, &field, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model.zep", 4439 TSRMLS_CC);
							...
							if (isNull) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_26$$51, "__construct", &_19, 400, &_27$$51, &attributeField, &_28$$51);
								zephir_check_call_status();
			...
			if (Z_TYPE_P(&relation) == IS_OBJECT) {
				...
				if (ZEPHIR_IS_LONG(&type, 0)) {
					...
					if (!(zephir_is_true(&_16$$5))) {
						...
						zephir_check_call_status();
						zephir_is_iterable(&_17$$8, 0, "phalcon/Mvc/Model.zep", 4648);
				...
				if (Z_TYPE_P(&relation) == IS_OBJECT) {
					...
					if (ZEPHIR_IS_LONG(&type, 0)) {
						...
						if (!(zephir_is_true(&_32$$15))) {
							...
							zephir_check_call_status();
							zephir_is_iterable(&_33$$18, 0, "phalcon/Mvc/Model.zep", 4648);
...
PHP_METHOD(Phalcon_Mvc_Model, skipAttributesOnCreate) {
	...
	ZEPHIR_INIT_VAR(&keysAttributes);
	array_init(&keysAttributes);
	zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Model.zep", 5213);
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _0)
		{
			ZEPHIR_INIT_NVAR(&attribute);
...
PHP_METHOD(Phalcon_Mvc_Model, skipAttributesOnUpdate) {
	...
	ZEPHIR_INIT_VAR(&keysAttributes);
	array_init(&keysAttributes);
	zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Model.zep", 5247);
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _0)
		{
			ZEPHIR_INIT_NVAR(&attribute);
...
PHP_METHOD(Phalcon_Mvc_Model, validate) {
	...
	for (;_1->funcs->valid(_1 TSRMLS_CC) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1 TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", &_7, 400, &_3$$4, &_4$$4, &_5$$4, &_6$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, caseInsensitiveColumnMap) {
	...
	zephir_is_iterable(&_0, 0, "phalcon/Mvc/Model.zep", 5383);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
