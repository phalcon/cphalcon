...
PHP_METHOD(Phalcon_Mvc_Model, delete)
{
	...
	if (zephir_is_true(&success)) {
		zephir_read_property(&_41$$29, this_ptr, ZEND_STRL("modelsManager"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_41$$29, "registerwrite", NULL, 0, this_ptr);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_42$$29);
		array_init(&_42$$29);
		zephir_update_property_zval(this_ptr, ZEND_STRL("related"), &_42$$29);
		ZEPHIR_INIT_VAR(&_43$$29);
		array_init(&_43$$29);
		zephir_update_property_zval(this_ptr, ZEND_STRL("dirtyRelated"), &_43$$29);
		zephir_read_property(&_44$$29, this_ptr, ZEND_STRL("modelsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, doLowUpdate)
{
	...
	if (_81) {
		if (Z_TYPE_P(&snapshot) == IS_ARRAY) {
			...
			zephir_update_property_zval(this_ptr, ZEND_STRL("snapshot"), &_83$$96);
		} else {
			ZEPHIR_INIT_VAR(&_84$$97);
			array_init(&_84$$97);
			zephir_update_property_zval(this_ptr, ZEND_STRL("oldSnapshot"), &_84$$97);
