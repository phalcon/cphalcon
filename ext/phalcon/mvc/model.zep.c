	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		if (zephir_array_isset_fetch(&value, dataMapped, attributeField, 0 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_METHOD(&_10$$16, this_ptr, "_possiblesetter", &_11, 313, attributeField, value);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _preSave) {
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_7$$9, this_ptr, "_checkforeignkeysrestrict", NULL, 316);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, save) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(_7)) {
		...
		if (ZEPHIR_GLOBAL(orm).exception_on_failed_save) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, _9$$12, "__construct", NULL, 318, this_ptr, _10$$12);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, delete) {
	...
	zephir_check_call_status();
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_20$$20, this_ptr, "_checkforeignkeysreversecascade", NULL, 320);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, __call) {
	...
	ZEPHIR_CALL_SELF(&records, "_invokefinder", &_0, 321, method, arguments);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, __set) {
	...
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "_possiblesetter", NULL, 313, property, value);
	zephir_check_call_status();
	if (zephir_is_true(_9)) {
		RETVAL_ZVAL(value, 1, 0);
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "_isvisible", NULL, 322, property);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _isVisible) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(&reflectionProp, reflectionClass, "getproperty", NULL, 323, property);
