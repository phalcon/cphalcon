...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model)
{
	 ...
	 */
	{
		...
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("dirtyRelated"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_LONG(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("dirtyState"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_LONG, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("errorMessages"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_NULL(&_zc0);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("modelsManager"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_NULL, SL("Phalcon\\Mvc\\Model\\ManagerInterface"));
	}

	{
		zval _zc0;
		ZVAL_NULL(&_zc0);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("modelsMetaData"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_NULL, SL("Phalcon\\Mvc\\Model\\MetaDataInterface"));
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("oldSnapshot"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_LONG(&_zc0, 0);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("operationMade"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_LONG, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("rawValues"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("related"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}

	{
		zval _zc0;
		ZVAL_BOOL(&_zc0, 0);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("skipped"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_BOOL, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("snapshot"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("syncRelated"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
	 ...
	 */
	{
		zval _zc0;
		array_init_size(&_zc0, 1);
		zephir_declare_typed_property(phalcon_mvc_model_ce, SL("uniqueTypes"), &_zc0, ZEND_ACC_PROTECTED, MAY_BE_ARRAY, NULL, 0);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, __construct)
{
	...
	if (Z_TYPE_P(container) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$4, "phalcon/Mvc/Model.zep", 277);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(modelsManager) == IS_NULL) {
		...
		if (Z_TYPE_P(modelsManager) == IS_NULL) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_4$$6, "phalcon/Mvc/Model.zep", 288);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 995, modelsManager);
...
PHP_METHOD(Phalcon_Mvc_Model, __callStatic)
{
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_1, "phalcon/Mvc/Model.zep", 384);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Mvc_Model, __get)
{
	...
	if (Z_TYPE_P(&relation) == IS_OBJECT) {
		...
		if (zephir_array_isset_value(&_1$$3, &lowerProperty)) {
			...
			zephir_array_fetch(&_3$$4, &_2$$4, &lowerProperty, PH_NOISY, "phalcon/Mvc/Model.zep", 415);
			RETURN_CCTOR(&_3$$4);
		}
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 997, PH_NOISY_CC | PH_READONLY);
		...
		_7$$3 = _5$$3;
		if (_7$$3) {
			zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_1, 997, PH_NOISY_CC | PH_READONLY);
			zephir_memory_observe(&_9$$3);
			zephir_array_fetch(&_9$$3, &_8$$3, &lowerProperty, PH_NOISY, "phalcon/Mvc/Model.zep", 426);
			_7$$3 = Z_TYPE_P(&_9$$3) == IS_OBJECT;
		}
		_10$$3 = _7$$3;
		if (_10$$3) {
			zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_1, 997, PH_NOISY_CC | PH_READONLY);
			zephir_memory_observe(&_12$$3);
			zephir_array_fetch(&_12$$3, &_11$$3, &lowerProperty, PH_NOISY, "phalcon/Mvc/Model.zep", 427);
			_10$$3 = zephir_instance_of_ev(&_12$$3, phalcon_mvc_modelinterface_ce);
		}
		if (_10$$3) {
			zephir_read_property_cached(&_13$$5, this_ptr, _zephir_prop_1, 997, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, __serialize)
{
	...
	if (_4) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 999, PH_NOISY_CC | PH_READONLY);
...
{
	zend_bool _0, _12$$10, _13$$10;
	zval related;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval property_zv, *value, value_sub, __$null, lowerProperty, modelName, manager, relation, referencedModel, item, dirtyState, _17, _18, _1$$3, _2$$4, _3$$4, _4$$6, _5$$7, _6$$8, _7$$9, *_8$$10, _9$$10, *_10$$10, _11$$10, _14$$10, _15$$17, _16$$19, _19$$22, _20$$23, _21$$23;
	zend_string *property = NULL;
	zval *this_ptr = getThis();
	...
	if (_0) {
		...
		if (Z_TYPE_P(&relation) == IS_OBJECT) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 998, &dirtyState);
		...
		if (Z_TYPE_P(&relation) == IS_OBJECT) {
			...
			zephir_switch_0_clause_1: ;
				...
				if (Z_TYPE_P(&referencedModel) == IS_OBJECT) {
					...
					ZVAL_UNDEF(&_7$$9);
					ZVAL_LONG(&_7$$9, 1);
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 998, &_7$$9);
					RETVAL_ZVAL(value, 1, 0);
					RETURN_MM();
				}
				goto zephir_switch_0_end;
			...
			zephir_switch_0_clause_3: ;
				...
				if (Z_TYPE_P(value) == IS_STRING) {
					...
					zephir_string_to_char_array(&_9$$10, value);
					_8$$10 = &_9$$10;
				} else {
					_8$$10 = value;
				}
				zephir_is_iterable(_8$$10, 0, "phalcon/Mvc/Model.zep", 601);
				if (Z_TYPE_P(_8$$10) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_8$$10), _10$$10)
					{
						ZEPHIR_INIT_NVAR(&item);
						ZVAL_COPY(&item, _10$$10);
						if (Z_TYPE_P(&item) == IS_OBJECT) {
							if (zephir_instance_of_ev(&item, phalcon_mvc_modelinterface_ce)) {
								zephir_array_append(&related, &item, PH_SEPARATE, "phalcon/Mvc/Model.zep", 596);
							}
						}
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_11$$10, _8$$10, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_11$$10)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&item, _8$$10, "current", NULL, 0);
						zephir_check_call_status();
							if (Z_TYPE_P(&item) == IS_OBJECT) {
								if (zephir_instance_of_ev(&item, phalcon_mvc_modelinterface_ce)) {
									zephir_array_append(&related, &item, PH_SEPARATE, "phalcon/Mvc/Model.zep", 596);
				...
				if (_13$$10) {
					...
					ZVAL_UNDEF(&_15$$17);
					ZVAL_LONG(&_15$$17, 1);
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 998, &_15$$17);
				} else {
	...
	if (zephir_is_true(&_18)) {
		...
		if (UNEXPECTED(!zephir_is_true(&_19$$22))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_20$$23, "phalcon/Mvc/Model.zep", 663);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model, __unserialize)
{
	...
	if (Z_TYPE_P(&container) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Mvc/Model.zep", 692);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 994, &container);
	...
	if (Z_TYPE_P(&manager) == IS_NULL) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$5, "phalcon/Mvc/Model.zep", 705);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 995, &manager);
	...
	if (zephir_array_isset_string_fetch(&properties, &data, SL("attributes"), 0)) {
		...
		zephir_is_iterable(_7$$7, 0, "phalcon/Mvc/Model.zep", 736);
	...
	if (zephir_array_isset_string_fetch(&dirtyState, &data, SL("dirtyState"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 998, &dirtyState);
	}
	...
	if (zephir_is_true(&_3)) {
		...
		if (zephir_array_isset_string_fetch(&snapshot, &data, SL("snapshot"), 0)) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 999, &_14$$13);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 999, &properties);
		}
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model, assign)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1000, &rawValues);
	ZEPHIR_INIT_VAR(&_0);
...
PHP_METHOD(Phalcon_Mvc_Model, create)
{
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1001, &_2$$3);
		RETURN_MM_BOOL(0);
	}
...
PHP_METHOD(Phalcon_Mvc_Model, delete)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 3);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1002, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1001, &_1);
	ZEPHIR_INIT_VAR(&_3);
	...
	if (zephir_is_true(&_33)) {
		if (0) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1003, &__$true);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1003, &__$false);
		}
		...
		zephir_read_property_cached(&_37$$20, this_ptr, _zephir_prop_2, 1003, PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_is_true(&success)) {
		zephir_read_property_cached(&_43$$29, this_ptr, _zephir_prop_3, 995, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_43$$29, "registerwrite", NULL, 0, this_ptr);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_44$$29);
		array_init(&_44$$29);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 997, &_44$$29);
		ZEPHIR_INIT_VAR(&_45$$29);
		array_init(&_45$$29);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 996, &_45$$29);
		zephir_read_property_cached(&_46$$29, this_ptr, _zephir_prop_3, 995, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_46$$29, "clearreusableobjects", NULL, 0);
		zephir_check_call_status();
	}
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 998, &_0);
...
PHP_METHOD(Phalcon_Mvc_Model, doSave)
{
	...
	if (zephir_is_true(&exists)) {
		ZVAL_UNDEF(&_4$$8);
		ZVAL_LONG(&_4$$8, 2);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1002, &_4$$8);
	} else {
		ZVAL_UNDEF(&_5$$9);
		ZVAL_LONG(&_5$$9, 1);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1002, &_5$$9);
	}
	ZEPHIR_INIT_NVAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1001, &_1);
	...
	if (_14) {
		...
		zephir_read_property_cached(&savedSnapshot, this_ptr, _zephir_prop_3, 999, PH_NOISY_CC);
		ZEPHIR_OBS_NVAR(&savedOldSnapshot);
		zephir_read_property_cached(&savedOldSnapshot, this_ptr, _zephir_prop_4, 1005, PH_NOISY_CC);
	}
	if (zephir_is_true(&exists)) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&success)) {
		ZVAL_UNDEF(&_17$$16);
		ZVAL_LONG(&_17$$16, 0);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 998, &_17$$16);
	}
	if (hasRelatedToSave) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&success)) {
		...
		if (_22$$21) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 999, &savedSnapshot);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1005, &savedOldSnapshot);
		}
	} else {
		if (hasRelatedToSave) {
			ZEPHIR_INIT_VAR(&_25$$24);
			array_init(&_25$$24);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 996, &_25$$24);
		}
		ZEPHIR_INIT_VAR(&_26$$23);
		array_init(&_26$$23);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 997, &_26$$23);
		zephir_read_property_cached(&_27$$23, this_ptr, _zephir_prop_8, 995, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, getMessages)
{
	...
	if (_1) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 1001, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, getModelsMetaData)
{
	...
	if (Z_TYPE_P(&metaData) == IS_NULL) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_1, 994, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, getReadConnection)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 995, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, getRelated)
{
	...
	if (Z_TYPE_P(arguments) == IS_NULL) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 996, PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_value(&_3$$4, &lowerAlias)) {
			zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_1, 996, PH_NOISY_CC | PH_READONLY);
			zephir_memory_observe(&_5$$5);
			zephir_array_fetch(&_5$$5, &_4$$5, &lowerAlias, PH_NOISY, "phalcon/Mvc/Model.zep", 3115);
			RETURN_CCTOR(&_5$$5);
		}
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_2, 997, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, getUpdatedFields)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 998, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, setOldSnapshotData)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1005, &snapshot);
	ZEPHIR_MM_RESTORE();
}
	...
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		...
		if (zephir_is_true(&_3$$3)) {
			...
			if (zephir_array_isset_string_fetch(&snapshot, &attributes, SL("snapshot"), 0)) {
				...
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 999, &_18$$18);
			} else {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 999, &properties);
			}
		}
...
PHP_METHOD(Phalcon_Mvc_Model, update)
{
	...
	if (zephir_is_true(&_0)) {
		...
		if (!(zephir_is_true(&_1$$3))) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1001, &_3$$4);
			RETURN_MM_BOOL(0);
		}
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "save", NULL, 0);
...
PHP_METHOD(Phalcon_Mvc_Model, doLowInsert)
{
	...
	if (zephir_is_true(&success)) {
		...
		if (_69$$62) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 999, &snapshot);
		}
	}
	RETURN_CCTOR(&success);
}
...
PHP_METHOD(Phalcon_Mvc_Model, doLowUpdate)
{
	...
	if (EXPECTED(_3)) {
		...
		if (ZEPHIR_IS_EMPTY(&fields)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1005, &snapshot);
			RETURN_MM_BOOL(1);
		}
	} else {
		if (Z_TYPE_P(&nonPrimary) == IS_STRING) {
	...
	if (_87) {
		if (Z_TYPE_P(&snapshot) == IS_ARRAY) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 999, &_89$$96);
		} else {
			ZEPHIR_INIT_VAR(&_90$$97);
			array_init(&_90$$97);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1005, &_90$$97);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 999, &newSnapshot);
		}
	}
	RETURN_CCTOR(&success);
}
...
PHP_METHOD(Phalcon_Mvc_Model, has)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 998, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_0))) {
		RETURN_MM_BOOL(1);
	}
	if (Z_TYPE_P(&uniqueKey) == IS_NULL) {
	...
	if (zephir_is_true(&_31)) {
		ZVAL_UNDEF(&_32$$30);
		ZVAL_LONG(&_32$$30, 0);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 998, &_32$$30);
		RETURN_MM_BOOL(1);
	} else {
		ZVAL_UNDEF(&_33$$31);
		ZVAL_LONG(&_33$$31, 1);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 998, &_33$$31);
	}
	RETURN_MM_BOOL(0);
}
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_1), _4, _5, _3)
		{
			...
			if (Z_TYPE_P(&relation) == IS_OBJECT) {
				...
				if (isThrough) {
					...
					zephir_read_property_cached(&_17$$9, this_ptr, _zephir_prop_0, 1004, PH_NOISY_CC | PH_READONLY);
					if (zephir_array_isset_fetch(&override, &_17$$9, &name, 0)) {
						doSync = zephir_get_boolval(&override);
					} else {
						ZEPHIR_OBS_NVAR(&override);
						zephir_read_property_cached(&_18$$9, this_ptr, _zephir_prop_0, 1004, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&relation) == IS_OBJECT) {
					...
					if (isThrough) {
						...
						ZEPHIR_OBS_NVAR(&override);
						zephir_read_property_cached(&_221$$89, this_ptr, _zephir_prop_0, 1004, PH_NOISY_CC | PH_READONLY);
						if (zephir_array_isset_fetch(&override, &_221$$89, &name, 0)) {
							doSync = zephir_get_boolval(&override);
						} else {
							ZEPHIR_OBS_NVAR(&override);
							zephir_read_property_cached(&_222$$89, this_ptr, _zephir_prop_0, 1004, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, preSave)
{
	...
	if (zephir_is_true(&_50)) {
		...
		zephir_read_property_cached(&_56$$60, this_ptr, _zephir_prop_0, 1003, PH_NOISY_CC | PH_READONLY);
