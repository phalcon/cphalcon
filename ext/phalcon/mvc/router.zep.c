			...
			if (Z_TYPE_P(&methods) != IS_NULL) {
				if (Z_TYPE_P(&request) == IS_NULL) {
					...
					if (Z_TYPE_P(&container) != IS_OBJECT) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_8$$9, "phalcon/Mvc/Router.zep", 464 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
			...
			if (Z_TYPE_P(&hostname) != IS_NULL) {
				if (Z_TYPE_P(&request) == IS_NULL) {
					...
					if (Z_TYPE_P(&container) != IS_OBJECT) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_18$$13, "phalcon/Mvc/Router.zep", 495 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					if (Z_TYPE_P(&paths) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paths), _33$$32, _34$$32, _31$$32)
						{
							...
							if (Z_TYPE_P(&part) != IS_STRING) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_35$$34, "phalcon/Mvc/Router.zep", 614 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
						...
						while (1) {
							...
							zephir_check_call_status();
								if (Z_TYPE_P(&part) != IS_STRING) {
									...
									zephir_check_call_status();
									zephir_throw_exception_debug(&_42$$45, "phalcon/Mvc/Router.zep", 614 TSRMLS_CC);
									ZEPHIR_MM_RESTORE();
									return;
								}
				...
				if (Z_TYPE_P(&methods) != IS_NULL) {
					if (Z_TYPE_P(&request) == IS_NULL) {
						...
						if (Z_TYPE_P(&container) != IS_OBJECT) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_50$$58, "phalcon/Mvc/Router.zep", 464 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
				...
				if (Z_TYPE_P(&hostname) != IS_NULL) {
					if (Z_TYPE_P(&request) == IS_NULL) {
						...
						if (Z_TYPE_P(&container) != IS_OBJECT) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_58$$62, "phalcon/Mvc/Router.zep", 495 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						...
						if (Z_TYPE_P(&paths) == IS_ARRAY) {
							ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paths), _73$$81, _74$$81, _71$$81)
							{
								...
								if (Z_TYPE_P(&part) != IS_STRING) {
									...
									zephir_check_call_status();
									zephir_throw_exception_debug(&_75$$83, "phalcon/Mvc/Router.zep", 614 TSRMLS_CC);
									ZEPHIR_MM_RESTORE();
									return;
								}
							...
							while (1) {
								...
								zephir_check_call_status();
									if (Z_TYPE_P(&part) != IS_STRING) {
										...
										zephir_check_call_status();
										zephir_throw_exception_debug(&_82$$94, "phalcon/Mvc/Router.zep", 614 TSRMLS_CC);
										ZEPHIR_MM_RESTORE();
										return;
									}
