...
PHP_METHOD(Phalcon_Mvc_Router, __construct) {
	...
	if (defaultRoutes) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_3, 269, _2, _1);
		...
		ZEPHIR_CALL_METHOD(NULL, _2, "__construct", &_3, 269, _5, _4);
	  ...
	  ; zephir_hash_move_backwards_ex(_5, &_4)
		...
		if (Z_TYPE_P(methods) != IS_NULL) {
			if (Z_TYPE_P(request) == IS_NULL) {
				...
				ZEPHIR_CALL_METHOD(&_8, dependencyInjector, "getshared", &_10, 0, _9);
				zephir_check_temp_parameter(_9);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(request, _8);
			}
			ZEPHIR_CALL_METHOD(&_8, request, "ismethod", &_11, 0, methods);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, route, "__construct", &_0, 269, pattern, paths, httpMethods);
	zephir_check_call_status();
