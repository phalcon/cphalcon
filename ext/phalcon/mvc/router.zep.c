...
PHP_METHOD(Phalcon_Mvc_Router, buildDispatcherDump)
{
	...
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_1), _3, _4, _2)
		{
			...
			ZVAL_COPY(&route, _2);
			ZEPHIR_CALL_FUNCTION(&_5$$4, "spl_object_id", &_6, 50, &route);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_30$$11, "spl_object_id", &_6, 50, &route);
				zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_51), _53, _54, _52)
		{
			...
			if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _55$$18)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_57$$19, "spl_object_id", &_6, 50, &scalarVal);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_61$$20, "spl_object_id", &_6, 50, &scalarVal);
						zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _64$$21)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_66$$22, "spl_object_id", &_6, 50, &scalarVal);
						zephir_check_call_status();
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&scalarVal, &innerVal, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_CALL_FUNCTION(&_70$$23, "spl_object_id", &_6, 50, &scalarVal);
							zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_71), _73, _74, _72)
		{
			...
			if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _75$$24)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_77$$25, "spl_object_id", &_6, 50, &scalarVal);
					zephir_check_call_status();
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&scalarVal, &innerVal, "current", NULL, 0);
					zephir_check_call_status();
						ZEPHIR_CALL_FUNCTION(&_81$$26, "spl_object_id", &_6, 50, &scalarVal);
						zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _84$$27)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_86$$28, "spl_object_id", &_6, 50, &scalarVal);
						zephir_check_call_status();
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&scalarVal, &innerVal, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_CALL_FUNCTION(&_90$$29, "spl_object_id", &_6, 50, &scalarVal);
							zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&innerVal), _97$$30, _98$$30, _96$$30)
				{
					...
					if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _99$$31)
						{
							...
							ZEPHIR_CALL_FUNCTION(&_101$$32, "spl_object_id", &_6, 50, &scalarVal);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								ZEPHIR_CALL_FUNCTION(&_105$$33, "spl_object_id", &_6, 50, &scalarVal);
								zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _108$$34)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_110$$35, "spl_object_id", &_6, 50, &scalarVal);
								zephir_check_call_status();
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&scalarVal, &mostInnerVal, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_CALL_FUNCTION(&_114$$36, "spl_object_id", &_6, 50, &scalarVal);
									zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&innerVal), _119$$37, _120$$37, _118$$37)
					{
						...
						if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _121$$38)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_123$$39, "spl_object_id", &_6, 50, &scalarVal);
								zephir_check_call_status();
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&scalarVal, &mostInnerVal, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_CALL_FUNCTION(&_127$$40, "spl_object_id", &_6, 50, &scalarVal);
									zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _130$$41)
								{
									...
									ZEPHIR_CALL_FUNCTION(&_132$$42, "spl_object_id", &_6, 50, &scalarVal);
									zephir_check_call_status();
								...
								while (1) {
									...
									ZEPHIR_CALL_METHOD(&scalarVal, &mostInnerVal, "current", NULL, 0);
									zephir_check_call_status();
										ZEPHIR_CALL_FUNCTION(&_136$$43, "spl_object_id", &_6, 50, &scalarVal);
										zephir_check_call_status();
