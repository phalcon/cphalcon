...
PHP_METHOD(Phalcon_Mvc_Router, attach)
{
	...
	do {
		...
		if (position == 0) {
			...
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
			zephir_fast_array_merge(&_0$$4, &_1$$4, &_2$$4);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 278, &_0$$4);
			break;
		}
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 279, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 279, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Router, clear)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 278, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	...
	ZEPHIR_INIT_VAR(&_5);
	array_init(&_5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 284, &_5);
	ZEPHIR_INIT_VAR(&_6);
	array_init(&_6);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 285, &_6);
	ZEPHIR_INIT_VAR(&_7);
	array_init(&_7);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 286, &_7);
	ZEPHIR_INIT_VAR(&_8);
	array_init(&_8);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 287, &_8);
	ZEPHIR_INIT_VAR(&_9);
	array_init(&_9);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 288, &_9);
	ZEPHIR_INIT_VAR(&_10);
	array_init(&_10);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 289, &_10);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 279, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 279, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router, buildDispatcherDump)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 278, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_51, this_ptr, _zephir_prop_2, 280, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_71, this_ptr, _zephir_prop_3, 281, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_91, this_ptr, _zephir_prop_4, 283, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Router, loadDispatcherFromArray)
{
	...
	ZEPHIR_INIT_NVAR(&routeData);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 278, &rebuiltRoutes);
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_42), _44, _45, _43)
		{
			...
			if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _46$$20)
				{
					...
					zephir_read_property_cached(&_47$$21, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
				...
				while (1) {
					...
					zephir_check_call_status();
						zephir_read_property_cached(&_51$$22, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _55$$23)
					{
						...
						zephir_read_property_cached(&_56$$24, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&scalarIdx, &innerVal, "current", NULL, 0);
						zephir_check_call_status();
							zephir_read_property_cached(&_60$$25, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_62), _64, _65, _63)
		{
			...
			if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _66$$26)
				{
					...
					zephir_read_property_cached(&_67$$27, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&scalarIdx, &innerVal, "current", NULL, 0);
					zephir_check_call_status();
						zephir_read_property_cached(&_71$$28, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&innerVal) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&innerVal), _75$$29)
					{
						...
						zephir_read_property_cached(&_76$$30, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&scalarIdx, &innerVal, "current", NULL, 0);
						zephir_check_call_status();
							zephir_read_property_cached(&_80$$31, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&innerVal), _88$$32, _89$$32, _87$$32)
				{
					...
					if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _90$$33)
						{
							...
							zephir_read_property_cached(&_91$$34, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
						...
						while (1) {
							...
							zephir_check_call_status();
								zephir_read_property_cached(&_95$$35, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
					...
					zephir_check_call_status();
						...
						if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _99$$36)
							{
								...
								zephir_read_property_cached(&_100$$37, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&scalarIdx, &mostInnerVal, "current", NULL, 0);
								zephir_check_call_status();
									zephir_read_property_cached(&_104$$38, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&innerVal), _110$$39, _111$$39, _109$$39)
					{
						...
						if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _112$$40)
							{
								...
								zephir_read_property_cached(&_113$$41, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&scalarIdx, &mostInnerVal, "current", NULL, 0);
								zephir_check_call_status();
									zephir_read_property_cached(&_117$$42, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&mostInnerVal) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&mostInnerVal), _121$$43)
								{
									...
									zephir_read_property_cached(&_122$$44, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
								...
								while (1) {
									...
									ZEPHIR_CALL_METHOD(&scalarIdx, &mostInnerVal, "current", NULL, 0);
									zephir_check_call_status();
										zephir_read_property_cached(&_126$$45, this_ptr, _zephir_prop_0, 278, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&innerVal);
	ZEPHIR_INIT_NVAR(&innerKey);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 280, &methodRoutesRehydrated);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 281, &candidatesRehydrated);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 283, &staticRehydrated);
	zephir_array_fetch_string(&_128, &dump, SL("staticShadowedByMethod"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 904);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 284, &_128);
	zephir_array_fetch_string(&_129, &dump, SL("hostnameByMethod"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 905);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 285, &_129);
	zephir_array_fetch_string(&_130, &dump, SL("hostnameLessByMethod"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 906);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 286, &_130);
	zephir_array_fetch_string(&_131, &dump, SL("combinedRegexByMethod"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 907);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 287, &_131);
	zephir_array_fetch_string(&_132, &dump, SL("combinedRegexDisabled"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 908);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 288, &_132);
	zephir_array_fetch_string(&_133, &dump, SL("combinedRegexMarkMap"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 909);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 289, &_133);
	zephir_array_fetch_string(&_134, &dump, SL("routeMeta"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 910);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 282, &_134);
	ZEPHIR_INIT_VAR(&_135);
	array_init(&_135);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 290, &_135);
	ZEPHIR_INIT_VAR(&_136);
	array_init(&_136);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_12, 291, &_136);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 279, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 279, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router, useCache)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 292, cache);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 293, &key_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router, getDefaults)
{
	...
	zephir_memory_observe(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 294, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("namespace"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 295, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("module"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 296, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("controller"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 297, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("action"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 298, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Router, getRouteById)
{
	...
	if (zephir_array_isset_fetch(&key, &_0, routeId, 0)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 278, PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_2$$3, &_1$$3, &key, PH_NOISY | PH_READONLY, "phalcon/Mvc/Router.zep", 1147);
		RETURN_CTOR(&_2$$3);
	}
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 278, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Router, handle)
{
	...
	ZVAL_NULL(&matches);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 301, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 301, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 302, &__$null);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_3, 303, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_4, 304, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_5, 279, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_6, 281, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&candidateRoutes, &_8, &requestMethod, 0))) {
		ZEPHIR_OBS_NVAR(&candidateRoutes);
		zephir_read_property_cached(&_9$$11, this_ptr, _zephir_prop_6, 281, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_7, 285, PH_NOISY_CC | PH_READONLY);
	_11 = zephir_array_isset_value(&_10, &requestMethod);
	if (_11) {
		zephir_read_property_cached(&_12, this_ptr, _zephir_prop_7, 285, PH_NOISY_CC | PH_READONLY);
	...
	if (_11) {
		...
		zephir_read_property_cached(&_14, this_ptr, _zephir_prop_7, 285, PH_NOISY_CC | PH_READONLY);
		_15 = zephir_array_isset_value_string(&_14, SL("*"));
		if (_15) {
			zephir_read_property_cached(&_16, this_ptr, _zephir_prop_7, 285, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&eventsManager) == IS_NULL) {
		...
		zephir_read_property_cached(&_18$$15, this_ptr, _zephir_prop_8, 283, PH_NOISY_CC | PH_READONLY);
		...
		if (_20$$15) {
			zephir_read_property_cached(&_21$$15, this_ptr, _zephir_prop_9, 284, PH_NOISY_CC | PH_READONLY);
		...
		if (_20$$15) {
			...
			zephir_read_property_cached(&_23$$15, this_ptr, _zephir_prop_8, 283, PH_NOISY_CC | PH_READONLY);
			...
			if (_25$$15) {
				zephir_read_property_cached(&_26$$15, this_ptr, _zephir_prop_9, 284, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&staticBucketMethod) != IS_NULL) {
			zephir_read_property_cached(&_28$$18, this_ptr, _zephir_prop_8, 283, PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&staticBucket) == IS_ARRAY) {
				ZEND_HASH_REVERSE_FOREACH_VAL(Z_ARRVAL_P(&staticBucket), _30$$18)
				{
					...
					zephir_check_call_status();
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 302, &staticRoute);
					break;
				} ZEND_HASH_FOREACH_END();
			} else {
	...
	_41 = _40;
	if (_41) {
		zephir_read_property_cached(&_42, this_ptr, _zephir_prop_10, 288, PH_NOISY_CC | PH_READONLY);
		_41 = !(zephir_array_isset_value(&_42, &requestMethod));
	}
	_43 = _41;
	if (_43) {
		zephir_memory_observe(&combinedChunks);
		zephir_read_property_cached(&_44, this_ptr, _zephir_prop_11, 287, PH_NOISY_CC | PH_READONLY);
		_43 = zephir_array_isset_fetch(&combinedChunks, &_44, &requestMethod, 0);
	}
	if (_43) {
		zephir_read_property_cached(&_45$$39, this_ptr, _zephir_prop_12, 289, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&combinedChunks) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&combinedChunks), _47$$39, _48$$39, _46$$39)
			{
				...
				zephir_read_property_cached(&_51$$40, this_ptr, _zephir_prop_13, 282, PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_14, 305, &combinedMatchesLocal);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 302, &combinedRoute);
				ZEPHIR_INIT_NVAR(&routeFound);
				ZVAL_BOOL(&routeFound, 1);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_OBS_NVAR(&combinedRoute);
					zephir_array_fetch(&combinedRoute, &candidateRoutes, &combinedRouteIdx, PH_NOISY, "phalcon/Mvc/Router.zep", 1404);
					zephir_read_property_cached(&_77$$62, this_ptr, _zephir_prop_13, 282, PH_NOISY_CC | PH_READONLY);
					ZEPHIR_OBS_NVAR(&combinedRouteMeta);
	...
	if (!(zephir_is_true(&routeFound))) {
		...
		if (Z_TYPE_P(&_98$$84) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_98$$84), _100$$84, _101$$84, _99$$84)
			{
				...
				zephir_read_property_cached(&_102$$85, this_ptr, _zephir_prop_13, 282, PH_NOISY_CC | PH_READONLY);
				...
				if (zephir_is_true(&routeFound)) {
					...
					if (Z_TYPE_P(&matches) == IS_ARRAY) {
						...
						ZEPHIR_INIT_NVAR(&position);
						ZEPHIR_INIT_NVAR(&part);
						zephir_update_property_zval_cached(this_ptr, _zephir_prop_14, 305, &matches);
					}
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 302, &route);
					break;
				}
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					zephir_read_property_cached(&_131$$121, this_ptr, _zephir_prop_13, 282, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&routeFound))) {
		zephir_read_property_cached(&_158$$159, this_ptr, _zephir_prop_15, 306, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_159, this_ptr, _zephir_prop_16, 294, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_17, 307, &_159);
	zephir_read_property_cached(&_160, this_ptr, _zephir_prop_18, 295, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_19, 308, &_160);
	zephir_read_property_cached(&_161, this_ptr, _zephir_prop_20, 296, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_21, 309, &_161);
	zephir_read_property_cached(&_162, this_ptr, _zephir_prop_22, 297, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_23, 310, &_162);
	zephir_read_property_cached(&_163, this_ptr, _zephir_prop_24, 298, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_25, 311, &_163);
	if (zephir_is_true(&routeFound)) {
		zephir_memory_observe(&vnamespace);
		if (zephir_array_isset_string_fetch(&vnamespace, &parts, SL("namespace"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_17, 307, &vnamespace);
		...
		if (zephir_array_isset_string_fetch(&module, &parts, SL("module"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_19, 308, &module);
		...
		if (zephir_array_isset_string_fetch(&controller, &parts, SL("controller"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_21, 309, &controller);
		...
		if (zephir_array_isset_string_fetch(&action, &parts, SL("action"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_23, 310, &action);
		...
		if (!(ZEPHIR_IS_EMPTY(&params))) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_25, 311, &_165$$169);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_25, 311, &parts);
		}
	}
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
	...
	zephir_read_property_cached(&_167, this_ptr, _zephir_prop_26, 292, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_167) != IS_NULL) {
		zephir_read_property_cached(&_168$$172, this_ptr, _zephir_prop_26, 292, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_169$$172, this_ptr, _zephir_prop_27, 293, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_26, 292, &__$null);
		ZEPHIR_INIT_VAR(&_171$$172);
		ZEPHIR_INIT_NVAR(&_171$$172);
		ZVAL_STRING(&_171$$172, "");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_27, 293, &_171$$172);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router, notFound)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 306, paths);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Router, removeExtraSlashes)
{
	...
	if (remove) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 300, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 300, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setDefaultAction)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 297, &actionName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setDefaultController)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 296, &controllerName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setDefaultModule)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 295, &moduleName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setDefaultNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 294, &namespaceName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 303, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Router, setKeyRouteIds)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 290, &routeIds);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setKeyRouteNames)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 291, &routeNames);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Router, setUriSource)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 299, &_0);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router, rebuildMethodIndex)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_5, 278, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_15, this_ptr, _zephir_prop_0, 280, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_string_fetch(&starRoutes, &_15, SL("*"), 0))) {
		ZEPHIR_INIT_NVAR(&starRoutes);
		array_init(&starRoutes);
	}
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_0, 280, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_16) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_16), _18, _19, _17)
		{
			...
			zephir_read_property_cached(&_22$$16, this_ptr, _zephir_prop_5, 278, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_30$$28, this_ptr, _zephir_prop_5, 278, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_34);
	array_init(&_34);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 282, &_34);
	zephir_read_property_cached(&_35, this_ptr, _zephir_prop_5, 278, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&candidateRoute);
	zephir_read_property_cached(&_45, this_ptr, _zephir_prop_1, 281, PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&candidates) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&candidates), _49$$44)
				{
					...
					if (!(zephir_memnstr_str(&bucketPattern, SL("^"), "phalcon/Mvc/Router.zep", 2285))) {
						...
						zephir_read_property_cached(&_50$$47, this_ptr, _zephir_prop_3, 283, PH_NOISY_CC | PH_READONLY);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (!(zephir_memnstr_str(&bucketPattern, SL("^"), "phalcon/Mvc/Router.zep", 2285))) {
							...
							ZEPHIR_OBS_NVAR(&staticBucket);
							zephir_read_property_cached(&_62$$55, this_ptr, _zephir_prop_3, 283, PH_NOISY_CC | PH_READONLY);
				...
				if (Z_TYPE_P(&candidates) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&candidates), _74$$61)
					{
						...
						if (!(zephir_memnstr_str(&bucketPattern, SL("^"), "phalcon/Mvc/Router.zep", 2285))) {
							...
							ZEPHIR_OBS_NVAR(&staticBucket);
							zephir_read_property_cached(&_75$$64, this_ptr, _zephir_prop_3, 283, PH_NOISY_CC | PH_READONLY);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (!(zephir_memnstr_str(&bucketPattern, SL("^"), "phalcon/Mvc/Router.zep", 2285))) {
								...
								ZEPHIR_OBS_NVAR(&staticBucket);
								zephir_read_property_cached(&_87$$72, this_ptr, _zephir_prop_3, 283, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_97);
	array_init(&_97);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 285, &_97);
	ZEPHIR_INIT_VAR(&_98);
	array_init(&_98);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 286, &_98);
	zephir_read_property_cached(&_99, this_ptr, _zephir_prop_1, 281, PH_NOISY_CC | PH_READONLY);
	...
	array_init(&_119);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 287, &_119);
	ZEPHIR_INIT_VAR(&_120);
	array_init(&_120);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 289, &_120);
	ZEPHIR_INIT_VAR(&_121);
	array_init(&_121);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 288, &_121);
	zephir_read_property_cached(&_122, this_ptr, _zephir_prop_1, 281, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_122) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_122), _124, _125, _123)
		{
			...
			zephir_read_property_cached(&_126$$92, this_ptr, _zephir_prop_6, 285, PH_NOISY_CC | PH_READONLY);
			...
			ZEPHIR_INIT_NVAR(&bucketRoute);
			ZEPHIR_INIT_NVAR(&bucketIdx);
			zephir_read_property_cached(&_140$$92, this_ptr, _zephir_prop_10, 288, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_156$$105, this_ptr, _zephir_prop_6, 285, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_OBS_NVAR(&hostnameBucketRef);
				...
				ZEPHIR_INIT_NVAR(&bucketRoute);
				ZEPHIR_INIT_NVAR(&bucketIdx);
				zephir_read_property_cached(&_170$$105, this_ptr, _zephir_prop_10, 288, PH_NOISY_CC | PH_READONLY);
