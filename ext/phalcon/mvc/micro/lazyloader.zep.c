...
PHP_METHOD(Phalcon_Mvc_Micro_LazyLoader, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 967, &definition_zv);
}
...
PHP_METHOD(Phalcon_Mvc_Micro_LazyLoader, callMethod)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 967, PH_NOISY_CC | PH_READONLY);
