...
PHP_METHOD(Phalcon_Mvc_Micro_Collection, setHandler)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 933, handler);
	if (isLazy) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 934, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 934, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Micro_Collection, setLazy)
{
	...
	if (isLazy) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 934, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 934, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Micro_Collection, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 935, &prefix_zv);
	RETURN_THISW();
}
