...
PHP_METHOD(Phalcon_Mvc_Collection_Document, offsetGet) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The index does not exist in the row", "phalcon/mvc/collection/document.zep", 54);
	return;
...
PHP_METHOD(Phalcon_Mvc_Collection_Document, offsetUnset) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_mvc_collection_exception_ce, "The index does not exist in the row", "phalcon/mvc/collection/document.zep", 76);
	return;
