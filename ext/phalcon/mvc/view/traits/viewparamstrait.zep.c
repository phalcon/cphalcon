...
PHP_METHOD(Phalcon_Mvc_View_Traits_ViewParamsTrait, getParamsToView)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1241, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_View_Traits_ViewParamsTrait, getRegisteredEngines)
{
	...
	zephir_memory_observe(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1242, PH_NOISY_CC);
	zephir_get_arrval(&_1, &_0);
	RETURN_CTOR(&_1);
}
...
PHP_METHOD(Phalcon_Mvc_View_Traits_ViewParamsTrait, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1243, &content_zv);
	RETURN_THISW();
}
