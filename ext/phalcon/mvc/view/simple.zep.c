...
PHP_METHOD(Phalcon_Mvc_View_Simple, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1210, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1211, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, partial)
{
	...
	zephir_check_call_status();
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1211, &viewParams);
	}
	ZEPHIR_CALL_FUNCTION(NULL, "ob_end_clean", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1212, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, registerEngines)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1210, &engines);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1213, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setVars)
{
	...
	if (merge) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1211, PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &params);
		ZEPHIR_CPY_WRT(&params, &_0$$3);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1211, &params);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, loadTemplateEngines)
{
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		zephir_read_property_cached(&di, this_ptr, _zephir_prop_1, 1216, PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(&engines);
		array_init(&engines);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 1210, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_20$$19, this_ptr, _zephir_prop_0, 1215, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, internalRender)
{
	...
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1217, &path_zv);
	}
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		ZEPHIR_INIT_VAR(&_2$$4);
	...
	notExists = 1;
	mustClean = 1;
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1214, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_3);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1212, &content_zv);
	RETURN_THISW();
}
