...
PHP_METHOD(Phalcon_Mvc_View_Simple, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1199, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, partial)
{
	...
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1199, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1199, &viewParams);
	}
	ZEPHIR_CALL_FUNCTION(NULL, "ob_end_clean", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1200, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1201, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setVars)
{
	...
	if (merge) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1199, PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &params);
		ZEPHIR_CPY_WRT(&params, &_0$$3);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1199, &params);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View_Simple, loadTemplateEngines)
{
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		zephir_read_property_cached(&di, this_ptr, _zephir_prop_1, 1204, PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(&engines);
		array_init(&engines);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 1198, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1203, &engines);
	} else {
		zephir_read_property_cached(&_20$$19, this_ptr, _zephir_prop_0, 1203, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, internalRender)
{
	...
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1205, &path_zv);
	}
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		ZEPHIR_INIT_VAR(&_2$$4);
	...
	notExists = 1;
	mustClean = 1;
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1202, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_3);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, getParamsToView)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1199, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1200, &content_zv);
	RETURN_THISW();
}
