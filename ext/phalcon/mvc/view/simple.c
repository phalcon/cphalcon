...
PHP_METHOD(Phalcon_Mvc_View_Simple, setViewsDir) {
	...
	if (Z_TYPE_P(viewsDir_param) != IS_STRING && Z_TYPE_P(viewsDir_param) != IS_NULL) {
...
PHP_METHOD(Phalcon_Mvc_View_Simple, _internalRender) {
	...
	zval *path_param = NULL, *params, *eventsManager, *engines, *extension = NULL, *engine = NULL, *viewEnginePath = NULL, *viewsDirPath, *_0 = NULL, *_1 = NULL, *_2, **_5, *_6, *_7;
	zval *path = NULL;
...
PHP_METHOD(Phalcon_Mvc_View_Simple, setContent) {
	...
	if (Z_TYPE_P(content_param) != IS_STRING && Z_TYPE_P(content_param) != IS_NULL) {
