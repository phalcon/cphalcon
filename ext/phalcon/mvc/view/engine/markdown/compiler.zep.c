...
PHP_METHOD(Phalcon_Mvc_View_Engine_Markdown_Compiler, setDI) {
	...
	if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_mvc_view_exception_ce, "Dependency Injector is invalid", "phalcon/mvc/view/engine/markdown/compiler.zep", 83);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Markdown_Compiler, _compileSource) {
	...
	zend_bool _0, _2, _4, _6, _11, _13;
	zval *viewCode_param = NULL, *intermediate, *options, *code = NULL, *compileOption = NULL, *compileRender = NULL, *afterCompile = NULL, *_1, *_3, *_5, *_7, *_8, *_12, *_14;
	zval *viewCode = NULL, *_10 = NULL;
	...
	if (Z_TYPE_P(options) == IS_ARRAY) {
		...
		if (_0) {
			ZEPHIR_OBS_VAR(_1);
			zephir_array_fetch_string(&_1, options, SL("compileOption"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 161 TSRMLS_CC);
			_0 = Z_TYPE_P(_1) == IS_ARRAY;
		}
		if (_0) {
			ZEPHIR_OBS_NVAR(compileOption);
			zephir_array_fetch_string(&compileOption, options, SL("compileOption"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 162 TSRMLS_CC);
		}
		_2 = zephir_array_isset_string(options, SS("compileRender"));
		if (_2) {
			ZEPHIR_OBS_VAR(_3);
			zephir_array_fetch_string(&_3, options, SL("compileRender"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 165 TSRMLS_CC);
			_2 = Z_TYPE_P(_3) == IS_ARRAY;
		}
		if (_2) {
			ZEPHIR_OBS_NVAR(compileRender);
			zephir_array_fetch_string(&compileRender, options, SL("compileRender"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 166 TSRMLS_CC);
		}
		_4 = zephir_array_isset_string(options, SS("beforeCompile"));
		if (_4) {
			ZEPHIR_OBS_VAR(_5);
			zephir_array_fetch_string(&_5, options, SL("beforeCompile"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 169 TSRMLS_CC);
			_4 = Z_TYPE_P(_5) == IS_OBJECT;
		}
		_6 = _4;
		if (_6) {
			ZEPHIR_OBS_VAR(_7);
			zephir_array_fetch_string(&_7, options, SL("beforeCompile"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 169 TSRMLS_CC);
			_6 = zephir_instance_of_ev(_7, zend_ce_closure TSRMLS_CC);
		}
		if (_6) {
			ZEPHIR_INIT_VAR(code);
			zephir_array_fetch_string(&_8, options, SL("beforeCompile"), PH_NOISY | PH_READONLY, "phalcon/mvc/view/engine/markdown/compiler.zep", 170 TSRMLS_CC);
			ZEPHIR_INIT_VAR(_9);
			zephir_create_array(_9, 1, 0 TSRMLS_CC);
			zephir_array_fast_append(_9, viewCode);
			ZEPHIR_CALL_USER_FUNC_ARRAY(code, _8, _9);
			zephir_check_call_status();
			zephir_get_strval(_10, code);
			ZEPHIR_CPY_WRT(viewCode, _10);
		}
		_11 = zephir_array_isset_string(options, SS("afterCompile"));
		if (_11) {
			ZEPHIR_OBS_VAR(_12);
			zephir_array_fetch_string(&_12, options, SL("afterCompile"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 174 TSRMLS_CC);
			_11 = Z_TYPE_P(_12) == IS_OBJECT;
		}
		_13 = _11;
		if (_13) {
			ZEPHIR_OBS_VAR(_14);
			zephir_array_fetch_string(&_14, options, SL("afterCompile"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 174 TSRMLS_CC);
			_13 = zephir_instance_of_ev(_14, zend_ce_closure TSRMLS_CC);
		}
		if (_13) {
			ZEPHIR_OBS_NVAR(afterCompile);
			zephir_array_fetch_string(&afterCompile, options, SL("afterCompile"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 175 TSRMLS_CC);
		}
	}
	...
	if (Z_TYPE_P(intermediate) == IS_ARRAY) {
		if (zephir_array_isset_string(intermediate, SS("result"))) {
			zephir_array_fetch_string(&_8, intermediate, SL("result"), PH_NOISY | PH_READONLY, "phalcon/mvc/view/engine/markdown/compiler.zep", 184 TSRMLS_CC);
			zephir_update_property_this(this_ptr, SL("_compilation"), _8 TSRMLS_CC);
		}
		if (zephir_array_isset_string(intermediate, SS("toc"))) {
			zephir_array_fetch_string(&_8, intermediate, SL("toc"), PH_NOISY | PH_READONLY, "phalcon/mvc/view/engine/markdown/compiler.zep", 188 TSRMLS_CC);
			zephir_update_property_this(this_ptr, SL("_toc"), _8 TSRMLS_CC);
		}
		if (zephir_array_isset_string(intermediate, SS("meta"))) {
			zephir_array_fetch_string(&_8, intermediate, SL("meta"), PH_NOISY | PH_READONLY, "phalcon/mvc/view/engine/markdown/compiler.zep", 192 TSRMLS_CC);
			zephir_update_property_this(this_ptr, SL("_meta"), _8 TSRMLS_CC);
		}
		if (zephir_is_callable(afterCompile TSRMLS_CC)) {
			...
			ZEPHIR_CALL_USER_FUNC_ARRAY(code, afterCompile, _9);
			zephir_check_call_status();
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "Invalid intermediate representation", "phalcon/mvc/view/engine/markdown/compiler.zep", 205);
	return;
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Markdown_Compiler, compileFile) {
	...
	if (ZEPHIR_IS_EQUAL(path, compiledPath)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "Template path and compilation template path cannot be the same", "phalcon/mvc/view/engine/markdown/compiler.zep", 240);
		return;
	}
	if (!((zephir_file_exists(path TSRMLS_CC) == SUCCESS))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_0, "phalcon/mvc/view/engine/markdown/compiler.zep", 247 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(viewCode);
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(viewCode)) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_2, _1);
		zephir_check_call_status();
		zephir_throw_exception_debug(_0, "phalcon/mvc/view/engine/markdown/compiler.zep", 255 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "Markdown directory can't be written", "phalcon/mvc/view/engine/markdown/compiler.zep", 265);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Markdown_Compiler, compile) {
	...
	if (Z_TYPE_P(options) == IS_ARRAY) {
		if (zephir_array_isset_string(options, SS("compileAlways"))) {
			...
			zephir_array_fetch_string(&compileAlways, options, SL("compileAlways"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 307 TSRMLS_CC);
			if (Z_TYPE_P(compileAlways) != IS_BOOL) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compileAlways must be a bool value", "phalcon/mvc/view/engine/markdown/compiler.zep", 309);
				return;
			}
		}
		if (zephir_array_isset_string(options, SS("prefix"))) {
			ZEPHIR_OBS_NVAR(prefix);
			zephir_array_fetch_string(&prefix, options, SL("prefix"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 317 TSRMLS_CC);
			if (Z_TYPE_P(prefix) != IS_STRING) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "prefix must be a string", "phalcon/mvc/view/engine/markdown/compiler.zep", 319);
				return;
			}
		}
		if (zephir_array_isset_string(options, SS("compiledPath"))) {
			ZEPHIR_OBS_NVAR(compiledPath);
			zephir_array_fetch_string(&compiledPath, options, SL("compiledPath"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 327 TSRMLS_CC);
			if (Z_TYPE_P(compiledPath) != IS_STRING) {
				if (Z_TYPE_P(compiledPath) != IS_OBJECT) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compiledPath must be a string or a closure", "phalcon/mvc/view/engine/markdown/compiler.zep", 330);
					return;
				}
			}
		}
		if (zephir_array_isset_string(options, SS("compiledSeparator"))) {
			...
			zephir_array_fetch_string(&compiledSeparator, options, SL("compiledSeparator"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 339 TSRMLS_CC);
			if (Z_TYPE_P(compiledSeparator) != IS_STRING) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compiledSeparator must be a string", "phalcon/mvc/view/engine/markdown/compiler.zep", 341);
				return;
			}
		}
		if (zephir_array_isset_string(options, SS("compiledExtension"))) {
			ZEPHIR_OBS_NVAR(compiledExtension);
			zephir_array_fetch_string(&compiledExtension, options, SL("compiledExtension"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 349 TSRMLS_CC);
			if (Z_TYPE_P(compiledExtension) != IS_STRING) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compiledExtension must be a string", "phalcon/mvc/view/engine/markdown/compiler.zep", 351);
				return;
			}
		}
		if (zephir_array_isset_string(options, SS("stat"))) {
			ZEPHIR_OBS_NVAR(stat);
			zephir_array_fetch_string(&stat, options, SL("stat"), PH_NOISY, "phalcon/mvc/view/engine/markdown/compiler.zep", 359 TSRMLS_CC);
		}
	}
	if (Z_TYPE_P(compiledPath) == IS_STRING) {
		...
		if (Z_TYPE_P(compiledPath) == IS_OBJECT) {
			if (zephir_instance_of_ev(compiledPath, zend_ce_closure TSRMLS_CC)) {
				...
				if (Z_TYPE_P(compiledTemplatePath) != IS_STRING) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compiledPath closure didn't return a valid string", "phalcon/mvc/view/engine/markdown/compiler.zep", 400);
					return;
				}
			} else {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_view_exception_ce, "compiledPath must be a string or a closure", "phalcon/mvc/view/engine/markdown/compiler.zep", 403);
				return;
			}
		}
	}
	...
	if (zephir_is_true(compileAlways)) {
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(stat)) {
			...
			if (!((zephir_file_exists(realCompiledPath TSRMLS_CC) == SUCCESS))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_4, "phalcon/mvc/view/engine/markdown/compiler.zep", 442 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
