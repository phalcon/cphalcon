...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, attributeReader) {
	...
	if (ZEPHIR_IS_LONG(_0, 265)) {
		...
		ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_7, 391, left);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(_9, 265)) {
		...
		ZEPHIR_CALL_METHOD(&_11$$12, this_ptr, "expression", &_7, 391, right);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, expr, SS("arguments"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&arguments, this_ptr, "expression", &_0, 391, funcArguments);
		zephir_check_call_status();
	} else {
	...
	if (ZEPHIR_IS_LONG(nameType, 265)) {
		...
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 392, _2$$6, _1$$6);
			...
			if (Z_TYPE_P(extendedBlocks) == IS_ARRAY) {
				...
				if (zephir_array_isset_fetch(&block, extendedBlocks, currentBlock, 0 TSRMLS_CC)) {
					...
					if (Z_TYPE_P(block) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&code, this_ptr, "_statementlistorextends", NULL, 393, block);
						zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "expression", &_0, 391, nameExpr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveTest) {
	...
	if (ZEPHIR_IS_LONG(type, 350)) {
		...
		if (zephir_array_isset_string_fetch(&name, testName, SS("value"), 0 TSRMLS_CC)) {
			if (ZEPHIR_IS_STRING(name, "divisibleby")) {
				...
				ZEPHIR_CALL_METHOD(&_0$$12, this_ptr, "expression", &_2, 391, _1$$12);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_STRING(name, "sameas")) {
				...
				ZEPHIR_CALL_METHOD(&_3$$13, this_ptr, "expression", &_2, 391, _4$$13);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_STRING(name, "type")) {
				...
				ZEPHIR_CALL_METHOD(&_5$$14, this_ptr, "expression", &_2, 391, _6$$14);
				zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "expression", &_2, 391, test);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveFilter) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, filter, SS("arguments"), 0 TSRMLS_CC)) {
		if (!ZEPHIR_IS_STRING(name, "default")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 394, funcArguments, _4$$7);
			ZEPHIR_UNREF(funcArguments);
			zephir_check_call_status();
		}
		ZEPHIR_CALL_METHOD(&arguments, this_ptr, "expression", NULL, 391, funcArguments);
		zephir_check_call_status();
	} else {
	...
	if (Z_TYPE_P(extensions) == IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 392, _7$$9, _6$$9);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, expression) {
	...
	while (1) {
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "fireextensionevent", &_2, 392, _1$$4, _0$$4);
		...
		if (!(zephir_array_isset_string_fetch(&type, expr, SS("type"), 0 TSRMLS_CC))) {
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_4$$6, &_3$$6)
				...
				ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_7, 391, _6$$7);
				zephir_check_call_status();
				ZEPHIR_OBS_NVAR(name);
		...
		if (ZEPHIR_IS_LONG(type, 124)) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "resolvefilter", &_13, 395, _12$$13, leftCode);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_OBS_NVAR(right);
		if (zephir_array_isset_string_fetch(&right, expr, SS("right"), 0 TSRMLS_CC)) {
			ZEPHIR_CALL_METHOD(&rightCode, this_ptr, "expression", &_7, 391, right);
			zephir_check_call_status();
		}
		ZEPHIR_INIT_NVAR(exprCode);
		ZVAL_NULL(exprCode);
		do {
			...
			if (ZEPHIR_IS_LONG(type, 365)) {
				...
				if (zephir_array_isset_string_fetch(&start, expr, SS("start"), 0 TSRMLS_CC)) {
					ZEPHIR_CALL_METHOD(&startCode, this_ptr, "expression", &_7, 391, start);
					zephir_check_call_status();
				} else {
				...
				if (zephir_array_isset_string_fetch(&end, expr, SS("end"), 0 TSRMLS_CC)) {
					ZEPHIR_CALL_METHOD(&endCode, this_ptr, "expression", &_7, 391, end);
					zephir_check_call_status();
				} else {
			...
			if (ZEPHIR_IS_LONG(type, 366)) {
				...
				ZEPHIR_CALL_METHOD(&_20$$69, this_ptr, "expression", &_7, 391, _21$$69);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(exprCode);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, _statementListOrExtends) {
	...
	if (isStatementList == 1) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_statementlist", NULL, 396, statements);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETVAL_ZVAL(statements, 1, 0);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileForeach) {
	...
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_0, 391, expr);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&code, this_ptr, "_statementlist", NULL, 396, blockStatements, _5);
	zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&ifExpr, statement, SS("if_expr"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_17$$13, this_ptr, "expression", &_0, 391, ifExpr);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileIf) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "expression", NULL, 391, expr);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "_statementlist", &_4, 396, _2, _3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(compilation);
	...
	if (zephir_array_isset_string_fetch(&blockStatements, statement, SS("false_statements"), 0 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "_statementlist", &_4, 396, blockStatements, _6$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCache) {
	...
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_0, 391, expr);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", &_0, 391, expr);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(compilation);
	...
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "_statementlist", NULL, 396, _11, _12);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSet) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_4, 391, _3$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_4, 391, _5$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileAutoEscape) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "_statementlist", NULL, 396, _0, _1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileEcho) {
	...
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", NULL, 391, expr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileInclude) {
	...
	ZEPHIR_CALL_METHOD(&path, this_ptr, "expression", &_3, 391, pathExpr);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "expression", &_3, 391, params);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileMacro) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_6$$6, &_5$$6)
			...
			if (zephir_array_isset_string_fetch(&defaultValue, parameter, SS("default"), 0 TSRMLS_CC)) {
				ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "expression", &_13, 391, defaultValue);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&blockStatements, statement, SS("block_statements"), 0 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(&_16$$10, this_ptr, "_statementlist", NULL, 396, blockStatements, _17$$10);
		zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_11, 392, _10$$8, _9$$8);
			...
			if (ZEPHIR_IS_LONG(type, 307)) {
				...
				if (zephir_is_true(blockMode)) {
					...
					if (Z_TYPE_P(blockStatements) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&_25$$21, this_ptr, "_statementlist", &_27, 396, blockStatements, _26$$21);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, _compileSource) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "_statementlist", &_1, 396, intermediate, _0);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(extended);
	zephir_read_property_this(&extended, this_ptr, SL("_extended"), PH_NOISY_CC);
		  ...
		  ; zephir_hash_move_forward_ex(_3$$7, &_2$$7)
			...
			if (Z_TYPE_P(name) == IS_STRING) {
				if (zephir_array_isset(blocks, name)) {
					...
					ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "_statementlist", &_1, 396, localBlock);
					zephir_check_call_status();
				} else {
					if (Z_TYPE_P(block) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "_statementlist", &_1, 396, block);
						zephir_check_call_status();
					} else {
