...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, attributeReader) {
	...
	if (ZEPHIR_IS_LONG(_0, 265)) {
		...
		ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_4, 368, left);
		zephir_check_call_status();
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(_6, 265)) {
		...
		ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", &_4, 368, right);
		zephir_check_call_status();
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, expr, SS("arguments"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&arguments, this_ptr, "expression", &_0, 368, funcArguments);
		zephir_check_call_status();
		zephir_check_call_status();
	} else {
	...
	if (ZEPHIR_IS_LONG(nameType, 265)) {
		...
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 369, _2, _1);
			...
			if (Z_TYPE_P(extendedBlocks) == IS_ARRAY) {
				...
				if (zephir_array_isset_fetch(&block, extendedBlocks, currentBlock, 0 TSRMLS_CC)) {
					...
					if (Z_TYPE_P(block) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&code, this_ptr, "_statementlistorextends", NULL, 370, block);
						zephir_check_call_status();
						zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&method, "lcfirst", NULL, 143, _2);
		zephir_check_call_status();
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "expression", &_0, 368, nameExpr);
	zephir_check_call_status();
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveTest) {
	...
	if (ZEPHIR_IS_LONG(type, 350)) {
		...
		if (zephir_array_isset_string_fetch(&name, testName, SS("value"), 0 TSRMLS_CC)) {
			if (ZEPHIR_IS_STRING(name, "divisibleby")) {
				...
				ZEPHIR_CALL_METHOD(&_0, this_ptr, "expression", &_2, 368, _1);
				zephir_check_call_status();
				zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "expression", &_2, 368, test);
	zephir_check_call_status();
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveFilter) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, filter, SS("arguments"), 0 TSRMLS_CC)) {
		if (!ZEPHIR_IS_STRING(name, "default")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 371, funcArguments, _4);
			Z_UNSET_ISREF_P(funcArguments);
			zephir_check_call_status();
			zephir_check_call_status();
		}
		ZEPHIR_CALL_METHOD(&arguments, this_ptr, "expression", NULL, 368, funcArguments);
		zephir_check_call_status();
		zephir_check_call_status();
	} else {
	...
	if (Z_TYPE_P(extensions) == IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 369, _0, _4);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, expression) {
	...
	while (1) {
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "fireextensionevent", &_2, 369, _1, _0);
		...
		if (!(zephir_array_isset_string_fetch(&type, expr, SS("type"), 0 TSRMLS_CC))) {
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_4, &_3)
				...
				ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_7, 368, _6);
				zephir_check_call_status();
				zephir_check_call_status();
				ZEPHIR_OBS_NVAR(name);
		...
		if (zephir_array_isset_string_fetch(&left, expr, SS("left"), 0 TSRMLS_CC)) {
			ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_7, 368, left);
			zephir_check_call_status();
			zephir_check_call_status();
		}
		...
		if (ZEPHIR_IS_LONG(type, 124)) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "resolvefilter", &_12, 372, _11, leftCode);
			zephir_check_call_status();
			zephir_check_call_status();
			break;
		}
		...
		if (zephir_array_isset_string_fetch(&right, expr, SS("right"), 0 TSRMLS_CC)) {
			ZEPHIR_CALL_METHOD(&rightCode, this_ptr, "expression", &_7, 368, right);
			zephir_check_call_status();
			zephir_check_call_status();
		}
		ZEPHIR_INIT_NVAR(exprCode);
		...
		do {
			...
			if (ZEPHIR_IS_LONG(type, 365)) {
				...
				if (zephir_array_isset_string_fetch(&start, expr, SS("start"), 0 TSRMLS_CC)) {
					ZEPHIR_CALL_METHOD(&startCode, this_ptr, "expression", &_7, 368, start);
					zephir_check_call_status();
					zephir_check_call_status();
				} else {
				...
				if (zephir_array_isset_string_fetch(&end, expr, SS("end"), 0 TSRMLS_CC)) {
					ZEPHIR_CALL_METHOD(&endCode, this_ptr, "expression", &_7, 368, end);
					zephir_check_call_status();
					zephir_check_call_status();
				} else {
			...
			if (ZEPHIR_IS_LONG(type, 366)) {
				...
				ZEPHIR_CALL_METHOD(&_16, this_ptr, "expression", &_7, 368, _6);
				zephir_check_call_status();
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(exprCode);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, _statementListOrExtends) {
	...
	if (isStatementList == 1) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_statementlist", NULL, 373, statements);
		zephir_check_call_status();
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileForeach) {
	...
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_0, 368, expr);
	zephir_check_call_status();
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&code, this_ptr, "_statementlist", NULL, 373, blockStatements, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&ifExpr, statement, SS("if_expr"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_12, this_ptr, "expression", &_0, 368, ifExpr);
		zephir_check_call_status();
		zephir_check_call_status();
		ZEPHIR_INIT_LNVAR(_5);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileIf) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "expression", NULL, 368, expr);
	zephir_check_call_status();
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "_statementlist", &_3, 373, _2, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(compilation);
	...
	if (zephir_array_isset_string_fetch(&blockStatements, statement, SS("false_statements"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_4, this_ptr, "_statementlist", &_3, 373, blockStatements, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
		zephir_check_call_status();
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_5);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCache) {
	...
	zephir_check_call_status();
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", &_0, 368, expr);
	zephir_check_call_status();
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(compilation);
	...
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "_statementlist", NULL, 373, _3, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	zephir_check_call_status();
	zephir_concat_self(&compilation, _6 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSet) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_4, 368, _3);
		zephir_check_call_status();
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileAutoEscape) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "_statementlist", NULL, 373, _0, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileEcho) {
	...
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", NULL, 368, expr);
	zephir_check_call_status();
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileInclude) {
	...
	ZEPHIR_CALL_METHOD(&path, this_ptr, "expression", &_3, 368, pathExpr);
	zephir_check_call_status();
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", &_3, 368, params);
	zephir_check_call_status();
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileMacro) {
	...
	if (zephir_array_isset_string_fetch(&blockStatements, statement, SS("block_statements"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_11, this_ptr, "_statementlist", NULL, 373, blockStatements, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
		zephir_check_call_status();
		zephir_check_call_status();
		ZEPHIR_INIT_LNVAR(_2);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (Z_TYPE_P(extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_10, 369, _4, _9);
		...
		do {
			...
			if (ZEPHIR_IS_LONG(type, 307)) {
				...
				if (zephir_is_true(blockMode)) {
					...
					if (Z_TYPE_P(blockStatements) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&_11, this_ptr, "_statementlist", &_17, 373, blockStatements, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
						zephir_check_call_status();
						zephir_check_call_status();
						zephir_concat_self(&compilation, _11 TSRMLS_CC);
					}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, _compileSource) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "_statementlist", &_0, 373, intermediate, (extendsMode ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)));
	zephir_check_call_status();
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(extended);
	zephir_read_property_this(&extended, this_ptr, SL("_extended"), PH_NOISY_CC);
		  ...
		  ; zephir_hash_move_forward_ex(_2, &_1)
			...
			if (Z_TYPE_P(name) == IS_STRING) {
				if (zephir_array_isset(blocks, name)) {
					...
					ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "_statementlist", &_0, 373, localBlock);
					zephir_check_call_status();
					zephir_check_call_status();
				} else {
					if (Z_TYPE_P(block) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "_statementlist", &_0, 373, block);
						zephir_check_call_status();
						zephir_check_call_status();
					} else {
