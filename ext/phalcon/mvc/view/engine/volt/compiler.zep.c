...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compile)
{
	...
	if (Z_TYPE_P(&compiledPath) == IS_STRING) {
		if (!(ZEPHIR_IS_EMPTY(&compiledPath))) {
			ZEPHIR_CALL_FUNCTION(&_22$$22, "realpath", NULL, 135, &templatePath_zv);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCase)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$4, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 583);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileDo)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 607);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", NULL, 0, &expr);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileEcho)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 631);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", NULL, 0, &expr);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &expr, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 639);
	if (ZEPHIR_IS_LONG(&_1, 350)) {
		...
		zephir_array_fetch_string(&name, &expr, SL("name"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 644);
		zephir_array_fetch_string(&_4$$4, &name, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 645);
		if (ZEPHIR_IS_LONG(&_4$$4, 265)) {
			zephir_array_fetch_string(&_5$$6, &name, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 650);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileElseIf)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0, &statement);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 681);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", NULL, 0, &expr);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileFile)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_EQUAL(&path_zv, &compiledPath_zv))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 712);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(!((zephir_file_exists(&path_zv) == SUCCESS)))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 719);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&viewCode))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$5, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 729);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&_4))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_5$$8, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 750);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CCTOR(&compilation);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileForeach)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool extendsMode;
	zval *statement_param = NULL, *extendsMode_param = NULL, prefix, level, prefixLevel, expr, exprCode, bstatement, type, blockStatements, forElse, code, loopContext, iterator, key, ifExpr, variable, _5, _0$$3, *_1$$4, _2$$4, _3$$7, _4$$10, _6$$11, _7$$11, _8$$11, _9$$11, _10$$11, _11$$11, _12$$11, _13$$11, _14$$11, _15$$13, _16$$14, _17$$15, _18$$15, _19$$17, _20$$17, _21$$17, _22$$17, _23$$17, _24$$17, _25$$18, _26$$22;
	zval statement;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(!(zephir_array_isset_value_string(&statement, SL("expr"))))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 775);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&compilation);
	...
	zephir_memory_observe(&expr);
	zephir_array_fetch_string(&expr, &statement, SL("expr"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 793);
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", NULL, 0, &expr);
	zephir_check_call_status();
	zephir_memory_observe(&blockStatements);
	zephir_array_fetch_string(&blockStatements, &statement, SL("block_statements"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 799);
	ZEPHIR_INIT_NVAR(&forElse);
	ZVAL_BOOL(&forElse, 0);
	if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
		zephir_is_iterable(&blockStatements, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 819);
		if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&blockStatements), _1$$4)
			{
				...
				if (ZEPHIR_IS_LONG(&type, 321)) {
					...
					ZEPHIR_CONCAT_SVS(&_3$$7, "<?php $", &prefixLevel, "iterated = false; ?>");
					zephir_concat_self(&compilation, &_3$$7);
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_2$$4, &blockStatements, "valid", NULL, 0);
				zephir_check_call_status();
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_LONG(&type, 321)) {
						...
						ZEPHIR_CONCAT_SVS(&_4$$10, "<?php $", &prefixLevel, "iterated = false; ?>");
						zephir_concat_self(&compilation, &_4$$10);
						ZEPHIR_CPY_WRT(&forElse, &prefixLevel);
						zephir_update_property_array(this_ptr, SL("forElsePointers"), &level, &forElse);
						break;
					}
	...
	ZEPHIR_CALL_METHOD(&code, this_ptr, "statementlist", NULL, 0, &blockStatements, &_5);
	zephir_check_call_status();
	...
	if (zephir_array_isset_value(&loopContext, &level)) {
		...
		ZEPHIR_CONCAT_SVSVS(&_6$$11, "<?php $", &prefixLevel, "iterator = ", &exprCode, "; ");
		zephir_concat_self(&compilation, &_6$$11);
		ZEPHIR_INIT_VAR(&_7$$11);
		ZEPHIR_CONCAT_SVS(&_7$$11, "$", &prefixLevel, "incr = 0; ");
		zephir_concat_self(&compilation, &_7$$11);
		ZEPHIR_INIT_VAR(&_8$$11);
		ZEPHIR_CONCAT_SVS(&_8$$11, "$", &prefixLevel, "loop = new stdClass(); ");
		zephir_concat_self(&compilation, &_8$$11);
		ZEPHIR_INIT_VAR(&_9$$11);
		ZEPHIR_CONCAT_SVSVS(&_9$$11, "$", &prefixLevel, "loop->self = &$", &prefixLevel, "loop; ");
		zephir_concat_self(&compilation, &_9$$11);
		ZEPHIR_INIT_VAR(&_10$$11);
		ZEPHIR_CONCAT_SVSVS(&_10$$11, "$", &prefixLevel, "loop->length = count($", &prefixLevel, "iterator); ");
		zephir_concat_self(&compilation, &_10$$11);
		ZEPHIR_INIT_VAR(&_11$$11);
		ZEPHIR_CONCAT_SVS(&_11$$11, "$", &prefixLevel, "loop->index = 1; ");
		zephir_concat_self(&compilation, &_11$$11);
		ZEPHIR_INIT_VAR(&_12$$11);
		ZEPHIR_CONCAT_SVS(&_12$$11, "$", &prefixLevel, "loop->index0 = 1; ");
		zephir_concat_self(&compilation, &_12$$11);
		ZEPHIR_INIT_VAR(&_13$$11);
		ZEPHIR_CONCAT_SVSVS(&_13$$11, "$", &prefixLevel, "loop->revindex = $", &prefixLevel, "loop->length; ");
		zephir_concat_self(&compilation, &_13$$11);
		ZEPHIR_INIT_VAR(&_14$$11);
		ZEPHIR_CONCAT_SVSVS(&_14$$11, "$", &prefixLevel, "loop->revindex0 = $", &prefixLevel, "loop->length - 1; ?>");
	...
	zephir_memory_observe(&variable);
	zephir_array_fetch_string(&variable, &statement, SL("variable"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 849);
	zephir_memory_observe(&key);
	if (zephir_array_isset_string_fetch(&key, &statement, SL("key"), 0)) {
		ZEPHIR_INIT_VAR(&_15$$13);
		ZEPHIR_CONCAT_SVSVSVS(&_15$$13, "<?php foreach (", &iterator, " as $", &key, " => $", &variable, ") { ");
		zephir_concat_self(&compilation, &_15$$13);
	} else {
		ZEPHIR_INIT_VAR(&_16$$14);
		ZEPHIR_CONCAT_SVSVS(&_16$$14, "<?php foreach (", &iterator, " as $", &variable, ") { ");
		zephir_concat_self(&compilation, &_16$$14);
	}
	zephir_memory_observe(&ifExpr);
	if (zephir_array_isset_string_fetch(&ifExpr, &statement, SL("if_expr"), 0)) {
		ZEPHIR_CALL_METHOD(&_17$$15, this_ptr, "expression", NULL, 0, &ifExpr);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_18$$15);
		ZEPHIR_CONCAT_SVS(&_18$$15, "if (", &_17$$15, ") { ?>");
	...
	if (zephir_array_isset_value(&loopContext, &level)) {
		...
		ZEPHIR_CONCAT_SVSVS(&_19$$17, "<?php $", &prefixLevel, "loop->first = ($", &prefixLevel, "incr == 0); ");
		zephir_concat_self(&compilation, &_19$$17);
		ZEPHIR_INIT_VAR(&_20$$17);
		ZEPHIR_CONCAT_SVSVS(&_20$$17, "$", &prefixLevel, "loop->index = $", &prefixLevel, "incr + 1; ");
		zephir_concat_self(&compilation, &_20$$17);
		ZEPHIR_INIT_VAR(&_21$$17);
		ZEPHIR_CONCAT_SVSVS(&_21$$17, "$", &prefixLevel, "loop->index0 = $", &prefixLevel, "incr; ");
		zephir_concat_self(&compilation, &_21$$17);
		ZEPHIR_INIT_VAR(&_22$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_22$$17, "$", &prefixLevel, "loop->revindex = $", &prefixLevel, "loop->length - $", &prefixLevel, "incr; ");
		zephir_concat_self(&compilation, &_22$$17);
		ZEPHIR_INIT_VAR(&_23$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_23$$17, "$", &prefixLevel, "loop->revindex0 = $", &prefixLevel, "loop->length - ($", &prefixLevel, "incr + 1); ");
		zephir_concat_self(&compilation, &_23$$17);
		ZEPHIR_INIT_VAR(&_24$$17);
		ZEPHIR_CONCAT_SVSVSVS(&_24$$17, "$", &prefixLevel, "loop->last = ($", &prefixLevel, "incr == ($", &prefixLevel, "loop->length - 1)); ?>");
		zephir_concat_self(&compilation, &_24$$17);
	}
	if (Z_TYPE_P(&forElse) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_25$$18);
		ZEPHIR_CONCAT_SVS(&_25$$18, "<?php $", &forElse, "iterated = true; ?>");
		zephir_concat_self(&compilation, &_25$$18);
	}
	...
	if (Z_TYPE_P(&forElse) == IS_STRING) {
		...
		if (zephir_array_isset_value(&loopContext, &level)) {
			...
			ZEPHIR_CONCAT_SVS(&_26$$22, "<?php $", &prefixLevel, "incr++; } ?>");
			zephir_concat_self(&compilation, &_26$$22);
		} else {
			zephir_concat_self_str(&compilation, "<?php } ?>", sizeof("<?php } ?>") - 1);
		}
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileIf)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0, &statement);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 952);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", NULL, 0, &expr);
	zephir_check_call_status();
	zephir_array_fetch_string(&_3, &statement, SL("true_statements"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 958);
	if (extendsMode) {
		ZVAL_BOOL(&_4, 1);
	} else {
		ZVAL_BOOL(&_4, 0);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileInclude)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&pathExpr, &statement, SL("path"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 992);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_array_fetch_string(&_1, &pathExpr, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 999);
	if (ZEPHIR_IS_LONG(&_1, 260)) {
		if (!(zephir_array_isset_value_string(&statement, SL("params")))) {
			zephir_memory_observe(&path);
			zephir_array_fetch_string(&path, &pathExpr, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1008);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileMacro)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool extendsMode;
	zval *statement_param = NULL, *extendsMode_param = NULL, name, defaultValue, parameters, position, parameter, variableName, blockStatements, _1, _3, _0$$3, _2$$4, *_6$$6, _7$$6, _10$$7, _11$$7, _12$$7, _13$$7, _14$$8, _16$$8, _17$$9, _18$$10, _19$$10, _20$$10, _21$$10, _22$$11, _23$$11, _24$$12, _25$$13, _26$$13, _27$$13;
	zval statement;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&name, &statement, SL("name"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1067);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(zephir_array_isset_value(&_1, &name))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$4, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1074);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (!(zephir_array_isset_string_fetch(&parameters, &statement, SL("parameters"), 0))) {
		...
		zephir_is_iterable(&parameters, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1111);
		if (Z_TYPE_P(&parameters) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parameters), _8$$6, _9$$6, _6$$6)
			{
				...
				zephir_array_fetch_string(&variableName, &parameter, SL("variable"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1093);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileReturn)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1148);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", NULL, 0, &expr);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSet)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *statement_param = NULL, assignments, assignment, exprCode, target, *_1, _2, _0$$3, _3$$4, _5$$4, _6$$4, _7$$5, _8$$6, _9$$7, _10$$8, _11$$9, _12$$10, _13$$10, _14$$10, _15$$11, _16$$12, _17$$13, _18$$14, _19$$15;
	zval statement;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&assignments, &statement, SL("assignments"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1225);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&compilation);
	ZVAL_STRING(&compilation, "<?php");
	zephir_is_iterable(&assignments, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1274);
	if (Z_TYPE_P(&assignments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&assignments), _1)
		{
			...
			zephir_array_fetch_string(&_3$$4, &assignment, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1236);
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_4, 0, &_3$$4);
			zephir_check_call_status();
			zephir_array_fetch_string(&_5$$4, &assignment, SL("variable"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1243);
			ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_4, 0, &_5$$4);
			zephir_check_call_status();
			zephir_array_fetch_string(&_6$$4, &assignment, SL("op"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1249);
			do {
				...
				if (ZEPHIR_IS_LONG(&_6$$4, 284)) {
					...
					zephir_concat_self(&compilation, &_10$$8);
					break;
				}
				ZEPHIR_INIT_NVAR(&_11$$9);
				ZEPHIR_CONCAT_SVSVS(&_11$$9, " ", &target, " = ", &exprCode, ";");
				zephir_concat_self(&compilation, &_11$$9);
				break;
			} while(0);
		...
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_2, &assignments, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_2)) {
				break;
			}
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_12$$10, &assignment, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1236);
				ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_4, 0, &_12$$10);
				zephir_check_call_status();
				zephir_array_fetch_string(&_13$$10, &assignment, SL("variable"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1243);
				ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_4, 0, &_13$$10);
				zephir_check_call_status();
				zephir_array_fetch_string(&_14$$10, &assignment, SL("op"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1249);
				do {
					if (ZEPHIR_IS_LONG(&_14$$10, 281)) {
						ZEPHIR_INIT_NVAR(&_15$$11);
						ZEPHIR_CONCAT_SVSVS(&_15$$11, " ", &target, " += ", &exprCode, ";");
						zephir_concat_self(&compilation, &_15$$11);
						break;
					}
					if (ZEPHIR_IS_LONG(&_14$$10, 282)) {
						ZEPHIR_INIT_NVAR(&_16$$12);
						ZEPHIR_CONCAT_SVSVS(&_16$$12, " ", &target, " -= ", &exprCode, ";");
						zephir_concat_self(&compilation, &_16$$12);
						break;
					}
					if (ZEPHIR_IS_LONG(&_14$$10, 283)) {
						ZEPHIR_INIT_NVAR(&_17$$13);
						ZEPHIR_CONCAT_SVSVS(&_17$$13, " ", &target, " *= ", &exprCode, ";");
						zephir_concat_self(&compilation, &_17$$13);
						break;
					}
					if (ZEPHIR_IS_LONG(&_14$$10, 284)) {
						ZEPHIR_INIT_NVAR(&_18$$14);
						ZEPHIR_CONCAT_SVSVS(&_18$$14, " ", &target, " /= ", &exprCode, ";");
						zephir_concat_self(&compilation, &_18$$14);
						break;
					}
					ZEPHIR_INIT_NVAR(&_19$$15);
					ZEPHIR_CONCAT_SVSVS(&_19$$15, " ", &target, " = ", &exprCode, ";");
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSwitch)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 0, &statement);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1315);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "expression", NULL, 0, &expr);
	...
	if (zephir_array_isset_string_fetch(&caseClauses, &statement, SL("case_clauses"), 0)) {
		...
		if (zephir_fast_strlen_ev(&lines) != 0) {
			...
			ZEPHIR_INIT_VAR(&_4$$5);
			ZVAL_STRING(&_4$$5, "");
			ZEPHIR_CALL_FUNCTION(&_5$$5, "preg_replace", NULL, 75, &_3$$5, &_4$$5, &lines);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, expression)
{
	zval _32$$78;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_3 = NULL, *_8 = NULL, *_13 = NULL, *_16 = NULL, *_18 = NULL, *_24 = NULL, *_36 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool doubleQuotes;
	zval *expr_param = NULL, *doubleQuotes_param = NULL, end, endCode, exprCode, extensions, items, left, leftCode, name, right, rightCode, singleExpr, singleExprCode, start, startCode, type, _0, _2$$4, *_4$$6, _5$$6, _6$$7, _7$$7, _9$$8, _10$$10, _11$$10, _12$$11, _14$$14, _15$$15, _17$$16, _19$$17, _20$$35, _21$$36, _22$$40, _23$$50, _25$$54, _26$$56, _27$$74, _28$$74, _29$$74, _30$$78, _31$$78, _33$$78, _34$$78, _35$$78;
	zval expr, _1$$4;
	zval *this_ptr = getThis();
	...
	while (1) {
		...
		if (!(zephir_array_isset_string_fetch(&type, &expr, SL("type"), 0))) {
			...
			array_init(&items);
			zephir_is_iterable(&expr, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1414);
			if (Z_TYPE_P(&expr) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _4$$6)
				{
					ZEPHIR_INIT_NVAR(&singleExpr);
					ZVAL_COPY(&singleExpr, _4$$6);
					zephir_array_fetch_string(&_6$$7, &singleExpr, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1403);
					if (doubleQuotes) {
						ZVAL_BOOL(&_7$$7, 1);
					} else {
						ZVAL_BOOL(&_7$$7, 0);
					}
					ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_8, 0, &_6$$7, &_7$$7);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&name);
					if (zephir_array_isset_string_fetch(&name, &singleExpr, SL("name"), 0)) {
						ZEPHIR_INIT_NVAR(&_9$$8);
						ZEPHIR_CONCAT_SVSV(&_9$$8, "'", &name, "' => ", &singleExprCode);
						zephir_array_append(&items, &_9$$8, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1408);
					} else {
						zephir_array_append(&items, &singleExprCode, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1410);
					}
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						zephir_array_fetch_string(&_10$$10, &singleExpr, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1403);
						if (doubleQuotes) {
							ZVAL_BOOL(&_11$$10, 1);
						} else {
							ZVAL_BOOL(&_11$$10, 0);
						}
						ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_8, 0, &_10$$10, &_11$$10);
						zephir_check_call_status();
						ZEPHIR_OBS_NVAR(&name);
						if (zephir_array_isset_string_fetch(&name, &singleExpr, SL("name"), 0)) {
							ZEPHIR_INIT_NVAR(&_12$$11);
							ZEPHIR_CONCAT_SVSV(&_12$$11, "'", &name, "' => ", &singleExprCode);
							zephir_array_append(&items, &_12$$11, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1408);
						} else {
							zephir_array_append(&items, &singleExprCode, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1410);
						}
		...
		if (zephir_array_isset_string_fetch(&left, &expr, SL("left"), 0)) {
			...
			ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_8, 0, &left, &_14$$14);
			zephir_check_call_status();
		}
		if (ZEPHIR_IS_LONG(&type, 311)) {
			zephir_array_fetch_string(&_15$$15, &expr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1440);
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "resolvetest", &_16, 0, &_15$$15, &leftCode);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 124)) {
			zephir_array_fetch_string(&_17$$16, &expr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1452);
		...
		if (zephir_array_isset_string_fetch(&right, &expr, SL("right"), 0)) {
			...
			ZEPHIR_CALL_METHOD(&rightCode, this_ptr, "expression", &_8, 0, &right, &_19$$17);
			zephir_check_call_status();
		}
		ZEPHIR_INIT_NVAR(&exprCode);
		ZVAL_NULL(&exprCode);
		do {
			...
			if (ZEPHIR_IS_LONG(&type, 258)) {
				...
				zephir_array_fetch_string(&exprCode, &expr, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1523);
				break;
			}
			...
			if (ZEPHIR_IS_LONG(&type, 260)) {
				...
				if (EXPECTED(doubleQuotes == 0)) {
					zephir_array_fetch_string(&_20$$35, &expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1532);
					ZEPHIR_CONCAT_SVS(&exprCode, "'", &_20$$35, "'");
				} else {
					zephir_array_fetch_string(&_21$$36, &expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1534);
					ZEPHIR_CONCAT_SVS(&exprCode, "\"", &_21$$36, "\"");
				}
				break;
			}
			...
			if (ZEPHIR_IS_LONG(&type, 265)) {
				zephir_array_fetch_string(&_22$$40, &expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1551);
				ZEPHIR_INIT_NVAR(&exprCode);
				ZEPHIR_CONCAT_SV(&exprCode, "$", &_22$$40);
				break;
			}
			...
			if (ZEPHIR_IS_LONG(&type, 350)) {
				...
				ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "functioncall", &_24, 0, &expr, &_23$$50);
				zephir_check_call_status();
				break;
			}
			...
			if (ZEPHIR_IS_LONG(&type, 365)) {
				...
				if (zephir_array_isset_string_fetch(&start, &expr, SL("start"), 0)) {
					...
					ZEPHIR_CALL_METHOD(&startCode, this_ptr, "expression", &_8, 0, &start, &_25$$54);
					zephir_check_call_status();
				} else {
				...
				if (zephir_array_isset_string_fetch(&end, &expr, SL("end"), 0)) {
					...
					ZEPHIR_CALL_METHOD(&endCode, this_ptr, "expression", &_8, 0, &end, &_26$$56);
					zephir_check_call_status();
				} else {
			...
			if (ZEPHIR_IS_LONG(&type, 366)) {
				zephir_array_fetch_string(&_28$$74, &expr, SL("ternary"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1690);
				if (doubleQuotes) {
					ZVAL_BOOL(&_29$$74, 1);
				} else {
					ZVAL_BOOL(&_29$$74, 0);
				}
				ZEPHIR_CALL_METHOD(&_27$$74, this_ptr, "expression", &_8, 0, &_28$$74, &_29$$74);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&exprCode);
				ZEPHIR_CONCAT_SVSVSVS(&exprCode, "(", &_27$$74, " ? ", &leftCode, " : ", &rightCode, ")");
				break;
			}
			...
			if (ZEPHIR_IS_LONG(&type, 364)) {
				ZEPHIR_OBS_NVAR(&exprCode);
				zephir_array_fetch_string(&exprCode, &expr, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1702);
				break;
			}
			ZEPHIR_INIT_NVAR(&_30$$78);
			object_init_ex(&_30$$78, phalcon_mvc_view_engine_volt_exceptions_unknownvoltexpression_ce);
			ZEPHIR_OBS_NVAR(&_31$$78);
			zephir_array_fetch_string(&_31$$78, &expr, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1706);
			zephir_cast_to_string(&_32$$78, &_31$$78);
			ZEPHIR_OBS_NVAR(&_33$$78);
			zephir_array_fetch_string(&_33$$78, &expr, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1706);
			ZVAL_LONG(&_34$$78, zephir_get_intval(&type));
			ZVAL_LONG(&_35$$78, zephir_get_intval(&_33$$78));
			ZEPHIR_CALL_METHOD(NULL, &_30$$78, "__construct", &_36, 0, &_34$$78, &_32$$78, &_35$$78);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_30$$78, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1706);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, fireExtensionEvent)
{
	...
	zval name_zv, *arguments_param = NULL, extensions, extension, status, _0, *_1, _2;
	zend_string *name = NULL;
	zval *this_ptr = getThis();
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("extensions"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&extensions, &_0);
	zephir_is_iterable(&extensions, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1754);
	if (Z_TYPE_P(&extensions) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _1)
		{
			...
			if ((zephir_method_exists(&extension, &name_zv)  == SUCCESS)) {
				if (!(ZEPHIR_IS_EMPTY(&arguments))) {
					...
					zephir_array_fast_append(&_3$$5, &name_zv);
					...
					zephir_array_fast_append(&_4$$6, &name_zv);
					ZEPHIR_INIT_NVAR(&status);
			...
			zephir_check_call_status();
				if ((zephir_method_exists(&extension, &name_zv)  == SUCCESS)) {
					if (!(ZEPHIR_IS_EMPTY(&arguments))) {
						...
						zephir_array_fast_append(&_5$$10, &name_zv);
						ZEPHIR_INIT_NVAR(&status);
						...
						zephir_array_fast_append(&_6$$11, &name_zv);
						ZEPHIR_INIT_NVAR(&status);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall)
{
	...
	zephir_array_fetch_string(&nameExpr, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1773);
	zephir_memory_observe(&nameType);
	zephir_array_fetch_string(&nameType, &nameExpr, SL("type"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1774);
	...
	if (ZEPHIR_IS_LONG(&nameType, 265)) {
		zephir_memory_observe(&name);
		zephir_array_fetch_string(&name, &nameExpr, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1791);
		...
		if (Z_TYPE_P(&functions) == IS_ARRAY) {
			...
			if (zephir_array_isset_fetch(&definition, &functions, &name, 0)) {
				...
				zephir_array_fetch_string(&_7$$9, &expr, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1840);
				zephir_cast_to_string(&_8$$9, &_7$$9);
				zephir_memory_observe(&_9$$9);
				zephir_array_fetch_string(&_9$$9, &expr, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1840);
				ZVAL_LONG(&_10$$9, zephir_get_intval(&_9$$9));
				ZEPHIR_CALL_METHOD(NULL, &_5$$9, "__construct", NULL, 0, &_6$$9, &_8$$9, &_10$$9);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_5$$9, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 1840);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		...
		ZEPHIR_CALL_FUNCTION(&method, "lcfirst", NULL, 138, &_15$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, getUniquePrefix)
{
	...
	if (UNEXPECTED(Z_TYPE_P(&_8) != IS_STRING)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_9$$6, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2134);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveTest)
{
	...
	zephir_array_fetch_string(&type, &test, SL("type"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2168);
	if (ZEPHIR_IS_LONG(&type, 265)) {
		zephir_memory_observe(&name);
		zephir_array_fetch_string(&name, &test, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2174);
		do {
	...
	if (ZEPHIR_IS_LONG(&type, 350)) {
		...
		zephir_array_fetch_string(&testName, &test, SL("name"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2197);
		ZEPHIR_OBS_NVAR(&name);
		if (zephir_array_isset_string_fetch(&name, &testName, SL("value"), 0)) {
			do {
				if (ZEPHIR_IS_STRING(&name, "divisibleby")) {
					zephir_array_fetch_string(&_1$$12, &test, SL("arguments"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2202);
				...
				if (ZEPHIR_IS_STRING(&name, "sameas")) {
					zephir_array_fetch_string(&_3$$13, &test, SL("arguments"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2204);
				...
				if (ZEPHIR_IS_STRING(&name, "type")) {
					zephir_array_fetch_string(&_5$$14, &test, SL("arguments"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2206);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSource)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool extendsMode;
	zval viewCode_zv, *extendsMode_param = NULL, currentPath, intermediate, extended, finalCompilation, blocks, extendedBlocks, name, block, blockCompilation, localBlock, compilation, options, autoescape, _0, _5, _1$$5, _2$$5, _3$$5, _4$$6, _6$$7, *_7$$7, _8$$7;
	zend_string *viewCode = NULL, *_10$$7;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&autoescape, &options, SL("autoescape"), 0)) {
			if (UNEXPECTED(((Z_TYPE_P(&autoescape) == IS_TRUE || Z_TYPE_P(&autoescape) == IS_FALSE) != 1))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_1$$5, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2279);
				ZEPHIR_MM_RESTORE();
				return;
			}
			zephir_update_property_zval(this_ptr, ZEND_STRL("autoescape"), &autoescape);
	...
	if (UNEXPECTED(Z_TYPE_P(&intermediate) != IS_ARRAY)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$6, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2292);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (extendsMode) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&extended)) {
		...
		zephir_is_iterable(&extendedBlocks, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2364);
		if (Z_TYPE_P(&extendedBlocks) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&extendedBlocks), _9$$7, _10$$7, _7$$7)
			{
				ZEPHIR_INIT_NVAR(&name);
				if (_10$$7 != NULL) { 
					ZVAL_STR_COPY(&name, _10$$7);
				} else {
					ZVAL_LONG(&name, _9$$7);
				}
				...
				if (Z_TYPE_P(&name) == IS_STRING) {
					if (zephir_array_key_exists(&blocks, &name)) {
						...
						zephir_array_fetch(&localBlock, &blocks, &name, PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2324);
					...
					if (extendsMode) {
						zephir_array_append(&finalCompilation, &block, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2357);
					} else {
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_8$$7, &extendedBlocks, "valid", NULL, 0);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, getFinalPath)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval path_zv, view, viewsDirs, viewsDir, _0, *_1$$4, _2$$4, _3$$5, _4$$7;
	...
	if (Z_TYPE_P(&view) == IS_OBJECT) {
		...
		if (Z_TYPE_P(&viewsDirs) == IS_ARRAY) {
			zephir_is_iterable(&viewsDirs, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2398);
			if (Z_TYPE_P(&viewsDirs) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&viewsDirs), _1$$4)
				{
					...
					ZEPHIR_INIT_NVAR(&_3$$5);
					ZEPHIR_CONCAT_VV(&_3$$5, &viewsDir, &path_zv);
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CONCAT_VV(&_4$$7, &viewsDir, &path_zv);
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveFilter)
{
	...
	ZVAL_NULL(&code);
	zephir_memory_observe(&type);
	zephir_array_fetch_string(&type, &filter, SL("type"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2416);
	if (ZEPHIR_IS_LONG(&type, 265)) {
		zephir_memory_observe(&name);
		zephir_array_fetch_string(&name, &filter, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2422);
	} else {
		if (UNEXPECTED(!ZEPHIR_IS_LONG(&type, 350))) {
			...
			zephir_array_fetch_string(&_1$$5, &filter, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2428);
			zephir_cast_to_string(&_2$$5, &_1$$5);
			zephir_memory_observe(&_3$$5);
			zephir_array_fetch_string(&_3$$5, &filter, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2428);
			ZVAL_LONG(&_4$$5, zephir_get_intval(&_3$$5));
			ZEPHIR_CALL_METHOD(NULL, &_0$$5, "__construct", NULL, 0, &_2$$5, &_4$$5);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_0$$5, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2428);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_memory_observe(&functionName);
		zephir_array_fetch_string(&functionName, &filter, SL("name"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2431);
		ZEPHIR_OBS_NVAR(&name);
		zephir_array_fetch_string(&name, &functionName, SL("value"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2432);
	}
	ZEPHIR_INIT_VAR(&funcArguments);
	ZVAL_NULL(&funcArguments);
	ZEPHIR_INIT_VAR(&arguments);
	...
	if (zephir_array_isset_string_fetch(&funcArguments, &filter, SL("arguments"), 0)) {
		if (!ZEPHIR_IS_STRING(&name, "default")) {
			...
			zephir_array_fetch_string(&file, &filter, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2446);
			zephir_memory_observe(&line);
			zephir_array_fetch_string(&line, &filter, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2447);
			...
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 470, &funcArguments, &_5$$7);
	...
	if (zephir_array_isset_fetch(&definition, &filters, &name, 0)) {
		...
		zephir_array_fetch_string(&_13$$11, &filter, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2520);
		zephir_cast_to_string(&_14$$11, &_13$$11);
		zephir_memory_observe(&_15$$11);
		zephir_array_fetch_string(&_15$$11, &filter, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2520);
		ZVAL_LONG(&_16$$11, zephir_get_intval(&_15$$11));
		ZEPHIR_CALL_METHOD(NULL, &_11$$11, "__construct", NULL, 0, &_12$$11, &_14$$11, &_16$$11);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_11$$11, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2520);
		ZEPHIR_MM_RESTORE();
		return;
	}
	do {
		...
		if (ZEPHIR_IS_STRING(&name, "join")) {
			zephir_array_fetch_long(&_17$$24, &funcArguments, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2546);
			zephir_array_fetch_string(&_18$$24, &_17$$24, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2546);
			zephir_array_fetch_string(&_19$$24, &_18$$24, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2547);
			zephir_array_fetch_long(&_20$$24, &funcArguments, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2547);
			zephir_array_fetch_string(&_21$$24, &_20$$24, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2547);
			zephir_array_fetch_string(&_22$$24, &_21$$24, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2547);
	...
	zephir_array_fetch_string(&_35, &filter, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2592);
	zephir_cast_to_string(&_36, &_35);
	zephir_memory_observe(&_37);
	zephir_array_fetch_string(&_37, &filter, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2592);
	ZVAL_LONG(&_7, zephir_get_intval(&_37));
	ZEPHIR_CALL_METHOD(NULL, &_33, "__construct", NULL, 0, &_34, &_36, &_7);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_33, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2592);
	ZEPHIR_MM_RESTORE();
	return;
}
...
{
	zval _108, _8$$7, _61$$37, _69$$40, _104$$70;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL, *_11 = NULL, *_14 = NULL, *_18 = NULL, *_20 = NULL, *_23 = NULL, *_25 = NULL, *_30 = NULL, *_32 = NULL, *_34 = NULL, *_38 = NULL, *_40 = NULL, *_43 = NULL, *_45 = NULL, *_47 = NULL, *_50 = NULL, *_52 = NULL, *_55 = NULL, *_58 = NULL, *_65 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool extendsMode, _1;
	zval *statements_param = NULL, *extendsMode_param = NULL, __$true, __$false, extended, blockMode, compilation, extensions, statement, tempCompilation, type, blockName, blockStatements, blocks, path, finalPath, subCompiler, level, _0, *_2, _3, _4$$6, _6$$7, _7$$7, _9$$7, _10$$7, _13$$8, _15$$10, _16$$11, _17$$11, _19$$12, _21$$13, _22$$13, _24$$14, _26$$15, _27$$15, _28$$16, _29$$16, _31$$17, _33$$18, _35$$19, _36$$24, _37$$24, _39$$25, _41$$26, _42$$27, _44$$28, _46$$29, _48$$30, _49$$30, _51$$33, _53$$34, _54$$34, _56$$35, _57$$35, _59$$37, _60$$37, _62$$37, _63$$37, _64$$37, _66$$39, _67$$40, _68$$40, _70$$40, _71$$40, _73$$41, _74$$43, _75$$44, _76$$44, _77$$45, _78$$46, _79$$46, _80$$47, _81$$48, _82$$48, _83$$49, _84$$49, _85$$50, _86$$51, _87$$52, _88$$57, _89$$57, _90$$58, _91$$59, _92$$60, _93$$61, _94$$62, _95$$63, _96$$63, _97$$66, _98$$67, _99$$67, _100$$68, _101$$68, _102$$70, _103$$70, _105$$70, _106$$70, _107$$70;
	zval statements, _12$$8, _72$$41;
	zval *this_ptr = getThis();
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("extensions"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&extensions, &_0);
	zephir_is_iterable(&statements, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2873);
	if (Z_TYPE_P(&statements) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&statements), _2)
		{
			...
			if (UNEXPECTED(Z_TYPE_P(&statement) != IS_ARRAY)) {
				ZEPHIR_INIT_NVAR(&_4$$6);
				object_init_ex(&_4$$6, phalcon_mvc_view_engine_volt_exceptions_corruptedstatement_ce);
				ZEPHIR_CALL_METHOD(NULL, &_4$$6, "__construct", &_5, 0);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_4$$6, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2632);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (UNEXPECTED(!(zephir_array_isset_value_string(&statement, SL("type"))))) {
				ZEPHIR_INIT_NVAR(&_6$$7);
				object_init_ex(&_6$$7, phalcon_mvc_view_engine_volt_exceptions_invalidstatement_ce);
				ZEPHIR_OBS_NVAR(&_7$$7);
				zephir_array_fetch_string(&_7$$7, &statement, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
				zephir_cast_to_string(&_8$$7, &_7$$7);
				ZEPHIR_OBS_NVAR(&_9$$7);
				zephir_array_fetch_string(&_9$$7, &statement, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
				ZVAL_LONG(&_10$$7, zephir_get_intval(&_9$$7));
				ZEPHIR_CALL_METHOD(NULL, &_6$$7, "__construct", &_11, 0, &_8$$7, &_10$$7, &statement);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$7, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				...
				zephir_array_fast_append(&_12$$8, &statement);
				ZEPHIR_INIT_NVAR(&_13$$8);
				ZVAL_STRING(&_13$$8, "compileStatement");
				ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_14, 0, &_13$$8, &_12$$8);
				zephir_check_call_status();
			...
			ZEPHIR_OBS_NVAR(&type);
			zephir_array_fetch_string(&type, &statement, SL("type"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2665);
			do {
				if (ZEPHIR_IS_LONG(&type, 357)) {
					zephir_array_fetch_string(&_15$$10, &statement, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2673);
					zephir_concat_self(&compilation, &_15$$10);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					...
					ZEPHIR_CALL_METHOD(&_16$$11, this_ptr, "compileif", &_18, 0, &statement, &_17$$11);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_16$$11);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 302)) {
					ZEPHIR_CALL_METHOD(&_19$$12, this_ptr, "compileelseif", &_20, 0, &statement);
					zephir_check_call_status();
				...
				if (ZEPHIR_IS_LONG(&type, 411)) {
					...
					ZEPHIR_CALL_METHOD(&_21$$13, this_ptr, "compileswitch", &_23, 0, &statement, &_22$$13);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_21$$13);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 412)) {
					ZEPHIR_CALL_METHOD(&_24$$14, this_ptr, "compilecase", &_25, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_24$$14);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 413)) {
					ZVAL_BOOL(&_27$$15, 0);
					ZEPHIR_CALL_METHOD(&_26$$15, this_ptr, "compilecase", &_25, 0, &statement, &_27$$15);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_26$$15);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 304)) {
					...
					ZEPHIR_CALL_METHOD(&_28$$16, this_ptr, "compileforeach", &_30, 0, &statement, &_29$$16);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_28$$16);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&_31$$17, this_ptr, "compileset", &_32, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_31$$17);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 359)) {
					ZEPHIR_CALL_METHOD(&_33$$18, this_ptr, "compileecho", &_34, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_33$$18);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 307)) {
					ZEPHIR_OBS_NVAR(&blockName);
					zephir_array_fetch_string(&blockName, &statement, SL("name"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2720);
					ZEPHIR_OBS_NVAR(&blockStatements);
					zephir_array_isset_string_fetch(&blockStatements, &statement, SL("block_statements"), 0);
					zephir_read_property(&_35$$19, this_ptr, ZEND_STRL("blocks"), PH_NOISY_CC | PH_READONLY);
					ZEPHIR_CPY_WRT(&blocks, &_35$$19);
					if (zephir_is_true(&blockMode)) {
						...
						if (Z_TYPE_P(&compilation) != IS_NULL) {
							zephir_array_append(&blocks, &compilation, PH_SEPARATE, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2735);
							ZEPHIR_INIT_NVAR(&compilation);
							ZVAL_NULL(&compilation);
						}
						...
						if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
							...
							ZEPHIR_CALL_METHOD(&_36$$24, this_ptr, "statementlist", &_38, 0, &blockStatements, &_37$$24);
							zephir_check_call_status();
							zephir_concat_self(&compilation, &_36$$24);
						}
					}
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 310)) {
					...
					zephir_array_fetch_string(&path, &statement, SL("path"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2760);
					zephir_array_fetch_string(&_39$$25, &path, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2764);
					ZEPHIR_CALL_METHOD(&finalPath, this_ptr, "getfinalpath", &_40, 0, &_39$$25);
					zephir_check_call_status();
					...
					if (Z_TYPE_P(&tempCompilation) == IS_NULL) {
						ZEPHIR_CALL_METHOD(&_41$$26, &subCompiler, "getcompiledtemplatepath", NULL, 0);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&tempCompilation);
						zephir_file_get_contents(&tempCompilation, &_41$$26);
					}
					if (1) {
						zephir_update_property_zval(this_ptr, ZEND_STRL("extended"), &__$true);
					} else {
				...
				if (ZEPHIR_IS_LONG(&type, 313)) {
					ZEPHIR_CALL_METHOD(&_42$$27, this_ptr, "compileinclude", &_43, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_42$$27);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 316)) {
					ZEPHIR_CALL_METHOD(&_44$$28, this_ptr, "compiledo", &_45, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_44$$28);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 327)) {
					ZEPHIR_CALL_METHOD(&_46$$29, this_ptr, "compilereturn", &_47, 0, &statement);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_46$$29);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 317)) {
					...
					ZEPHIR_CALL_METHOD(&_48$$30, this_ptr, "compileautoescape", &_50, 0, &statement, &_49$$30);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_48$$30);
					break;
				}
				...
				if (ZEPHIR_IS_LONG(&type, 321)) {
					ZEPHIR_CALL_METHOD(&_51$$33, this_ptr, "compileforelse", &_52, 0);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_51$$33);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 322)) {
					...
					ZEPHIR_CALL_METHOD(&_53$$34, this_ptr, "compilemacro", &_55, 0, &statement, &_54$$34);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_53$$34);
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 325)) {
					...
					ZEPHIR_CALL_METHOD(&_56$$35, this_ptr, "compilecall", &_58, 0, &statement, &_57$$35);
					zephir_check_call_status();
					zephir_concat_self(&compilation, &_56$$35);
					break;
				}
				...
				object_init_ex(&_59$$37, phalcon_mvc_view_engine_volt_exceptions_unknownvoltstatement_ce);
				ZEPHIR_OBS_NVAR(&_60$$37);
				zephir_array_fetch_string(&_60$$37, &statement, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
				zephir_cast_to_string(&_61$$37, &_60$$37);
				ZEPHIR_OBS_NVAR(&_62$$37);
				zephir_array_fetch_string(&_62$$37, &statement, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
				ZVAL_LONG(&_63$$37, zephir_get_intval(&type));
				ZVAL_LONG(&_64$$37, zephir_get_intval(&_62$$37));
				ZEPHIR_CALL_METHOD(NULL, &_59$$37, "__construct", &_65, 0, &_63$$37, &_61$$37, &_64$$37);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_59$$37, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
				ZEPHIR_MM_RESTORE();
				return;
			} while(0);
		...
		while (1) {
			...
			zephir_check_call_status();
				if (UNEXPECTED(Z_TYPE_P(&statement) != IS_ARRAY)) {
					...
					object_init_ex(&_66$$39, phalcon_mvc_view_engine_volt_exceptions_corruptedstatement_ce);
					ZEPHIR_CALL_METHOD(NULL, &_66$$39, "__construct", &_5, 0);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_66$$39, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2632);
					ZEPHIR_MM_RESTORE();
					return;
				}
				if (UNEXPECTED(!(zephir_array_isset_value_string(&statement, SL("type"))))) {
					ZEPHIR_INIT_NVAR(&_67$$40);
					object_init_ex(&_67$$40, phalcon_mvc_view_engine_volt_exceptions_invalidstatement_ce);
					ZEPHIR_OBS_NVAR(&_68$$40);
					zephir_array_fetch_string(&_68$$40, &statement, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
					zephir_cast_to_string(&_69$$40, &_68$$40);
					ZEPHIR_OBS_NVAR(&_70$$40);
					zephir_array_fetch_string(&_70$$40, &statement, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
					ZVAL_LONG(&_71$$40, zephir_get_intval(&_70$$40));
					ZEPHIR_CALL_METHOD(NULL, &_67$$40, "__construct", &_11, 0, &_69$$40, &_71$$40, &statement);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_67$$40, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2639);
					ZEPHIR_MM_RESTORE();
					return;
				}
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					ZEPHIR_INIT_NVAR(&_72$$41);
					zephir_create_array(&_72$$41, 1, 0);
					zephir_array_fast_append(&_72$$41, &statement);
					ZEPHIR_INIT_NVAR(&_73$$41);
					ZVAL_STRING(&_73$$41, "compileStatement");
					ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_14, 0, &_73$$41, &_72$$41);
					zephir_check_call_status();
					if (Z_TYPE_P(&tempCompilation) == IS_STRING) {
						zephir_concat_self(&compilation, &tempCompilation);
						continue;
				...
				do {
					if (ZEPHIR_IS_LONG(&type, 357)) {
						zephir_array_fetch_string(&_74$$43, &statement, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2673);
						zephir_concat_self(&compilation, &_74$$43);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 300)) {
						if (extendsMode) {
						...
						ZEPHIR_CALL_METHOD(&_75$$44, this_ptr, "compileif", &_18, 0, &statement, &_76$$44);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_75$$44);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 302)) {
						ZEPHIR_CALL_METHOD(&_77$$45, this_ptr, "compileelseif", &_20, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_77$$45);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 411)) {
						if (extendsMode) {
						...
						ZEPHIR_CALL_METHOD(&_78$$46, this_ptr, "compileswitch", &_23, 0, &statement, &_79$$46);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_78$$46);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 412)) {
						ZEPHIR_CALL_METHOD(&_80$$47, this_ptr, "compilecase", &_25, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_80$$47);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 413)) {
						ZVAL_BOOL(&_82$$48, 0);
						ZEPHIR_CALL_METHOD(&_81$$48, this_ptr, "compilecase", &_25, 0, &statement, &_82$$48);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_81$$48);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 304)) {
						if (extendsMode) {
						...
						ZEPHIR_CALL_METHOD(&_83$$49, this_ptr, "compileforeach", &_30, 0, &statement, &_84$$49);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_83$$49);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 306)) {
						ZEPHIR_CALL_METHOD(&_85$$50, this_ptr, "compileset", &_32, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_85$$50);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 359)) {
						ZEPHIR_CALL_METHOD(&_86$$51, this_ptr, "compileecho", &_34, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_86$$51);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 307)) {
						ZEPHIR_OBS_NVAR(&blockName);
						...
						ZEPHIR_OBS_NVAR(&blockStatements);
						zephir_array_isset_string_fetch(&blockStatements, &statement, SL("block_statements"), 0);
						zephir_read_property(&_87$$52, this_ptr, ZEND_STRL("blocks"), PH_NOISY_CC | PH_READONLY);
						ZEPHIR_CPY_WRT(&blocks, &_87$$52);
						if (zephir_is_true(&blockMode)) {
							if (Z_TYPE_P(&blocks) != IS_ARRAY) {
								ZEPHIR_INIT_NVAR(&blocks);
								array_init(&blocks);
							...
							if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
								...
								ZEPHIR_CALL_METHOD(&_88$$57, this_ptr, "statementlist", &_38, 0, &blockStatements, &_89$$57);
								zephir_check_call_status();
								zephir_concat_self(&compilation, &_88$$57);
							}
						}
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 310)) {
						ZEPHIR_OBS_NVAR(&path);
						zephir_array_fetch_string(&path, &statement, SL("path"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2760);
						zephir_array_fetch_string(&_90$$58, &path, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2764);
						ZEPHIR_CALL_METHOD(&finalPath, this_ptr, "getfinalpath", &_40, 0, &_90$$58);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&extended);
						ZVAL_BOOL(&extended, 1);
						ZEPHIR_INIT_NVAR(&subCompiler);
						...
						zephir_check_call_status();
						if (Z_TYPE_P(&tempCompilation) == IS_NULL) {
							ZEPHIR_CALL_METHOD(&_91$$59, &subCompiler, "getcompiledtemplatepath", NULL, 0);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&tempCompilation);
							zephir_file_get_contents(&tempCompilation, &_91$$59);
						}
						if (1) {
							zephir_update_property_zval(this_ptr, ZEND_STRL("extended"), &__$true);
						} else {
					...
					if (ZEPHIR_IS_LONG(&type, 313)) {
						ZEPHIR_CALL_METHOD(&_92$$60, this_ptr, "compileinclude", &_43, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_92$$60);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 316)) {
						ZEPHIR_CALL_METHOD(&_93$$61, this_ptr, "compiledo", &_45, 0, &statement);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_93$$61);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 327)) {
						ZEPHIR_CALL_METHOD(&_94$$62, this_ptr, "compilereturn", &_47, 0, &statement);
						zephir_check_call_status();
					...
					if (ZEPHIR_IS_LONG(&type, 317)) {
						...
						ZEPHIR_CALL_METHOD(&_95$$63, this_ptr, "compileautoescape", &_50, 0, &statement, &_96$$63);
						zephir_check_call_status();
					...
					if (ZEPHIR_IS_LONG(&type, 321)) {
						ZEPHIR_CALL_METHOD(&_97$$66, this_ptr, "compileforelse", &_52, 0);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_97$$66);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 322)) {
						if (extendsMode) {
						...
						ZEPHIR_CALL_METHOD(&_98$$67, this_ptr, "compilemacro", &_55, 0, &statement, &_99$$67);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_98$$67);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 325)) {
						if (extendsMode) {
						...
						ZEPHIR_CALL_METHOD(&_100$$68, this_ptr, "compilecall", &_58, 0, &statement, &_101$$68);
						zephir_check_call_status();
						zephir_concat_self(&compilation, &_100$$68);
						break;
					}
					if (ZEPHIR_IS_LONG(&type, 358)) {
						break;
					...
					object_init_ex(&_102$$70, phalcon_mvc_view_engine_volt_exceptions_unknownvoltstatement_ce);
					ZEPHIR_OBS_NVAR(&_103$$70);
					zephir_array_fetch_string(&_103$$70, &statement, SL("file"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
					zephir_cast_to_string(&_104$$70, &_103$$70);
					ZEPHIR_OBS_NVAR(&_105$$70);
					zephir_array_fetch_string(&_105$$70, &statement, SL("line"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
					ZVAL_LONG(&_106$$70, zephir_get_intval(&type));
					ZVAL_LONG(&_107$$70, zephir_get_intval(&_105$$70));
					ZEPHIR_CALL_METHOD(NULL, &_102$$70, "__construct", &_65, 0, &_106$$70, &_104$$70, &_107$$70);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_102$$70, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2865);
					ZEPHIR_MM_RESTORE();
					return;
				} while(0);
	...
	zephir_cast_to_string(&_108, &compilation);
	RETURN_CTOR(&_108);
}
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, statementListOrExtends)
{
	...
	if (!(zephir_array_isset_value_string(statements, SL("type")))) {
		zephir_is_iterable(statements, 0, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2922);
		if (Z_TYPE_P(statements) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&left, &name, SL("left"), 0)) {
			...
			if (zephir_array_isset_string_fetch(&leftValue, &left, SL("value"), 0)) {
				...
				if (_0$$6) {
					...
					zephir_array_fetch_string(&_1$$6, &left, SL("name"), PH_NOISY, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 2959);
