...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1095, columnTypes);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1096, &resultsetRowClass_zv);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, __unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1100, &_0);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, current)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1102, &row);
		RETURN_CCTOR(&row);
	}
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 1098, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&hydrateMode, &_1);
	do {
		if (ZEPHIR_IS_LONG(&hydrateMode, 0)) {
			zephir_read_property_cached(&_2$$6, this_ptr, _zephir_prop_4, 1096, PH_NOISY_CC | PH_READONLY);
			if (!ZEPHIR_IS_STRING_IDENTICAL(&_2$$6, "")) {
				zephir_read_property_cached(&_3$$7, this_ptr, _zephir_prop_4, 1096, PH_NOISY_CC | PH_READONLY);
	...
	dirtyState = 0;
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_5, 1095, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, serialize)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1097, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1098, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Complex, unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1100, &_6);
