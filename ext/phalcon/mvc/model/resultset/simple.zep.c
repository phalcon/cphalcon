...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1087, model);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1088, columnMap);
	if (keepSnapshots) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1089, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1089, &__$false);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __serialize)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1087, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("model"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1090, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1088, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("columnMap"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1091, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("hydrateMode"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 1089, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1092, &_1);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, current)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1088, PH_NOISY_CC | PH_READONLY);
	...
	do {
		if (ZEPHIR_IS_LONG(&hydrateMode, 0)) {
			...
			if (zephir_is_true(&_1$$5)) {
				...
				zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_4, 1087, PH_NOISY_CC);
				if (zephir_instance_of_ev(&_3$$6, phalcon_mvc_model_ce)) {
					zephir_read_property_cached(&_4$$7, this_ptr, _zephir_prop_4, 1087, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_4, 1087, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_5, 1089, PH_NOISY_CC | PH_READONLY);
				ZVAL_LONG(&_7$$6, 0);
				_8$$6 = zephir_fetch_class(&modelName);
				ZEPHIR_CALL_CE_STATIC(&activeRow, _8$$6, "cloneresultmap", NULL, 0, &_5$$6, &row, &columnMap, &_7$$6, &_6$$6);
				zephir_check_call_status();
			} else {
				zephir_read_property_cached(&_9$$9, this_ptr, _zephir_prop_4, 1087, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_10$$9, this_ptr, _zephir_prop_5, 1089, PH_NOISY_CC | PH_READONLY);
				ZVAL_LONG(&_11$$9, 0);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, serialize)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1087, PH_NOISY_CC);
	zephir_array_update_string(&data, SL("model"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1090, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1088, PH_NOISY_CC);
	zephir_array_update_string(&data, SL("columnMap"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 1091, PH_NOISY_CC);
	zephir_array_update_string(&data, SL("hydrateMode"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_4, 1089, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, toArray)
{
	...
	zephir_read_property_cached(&records, this_ptr, _zephir_prop_0, 1092, PH_NOISY_CC);
	if (Z_TYPE_P(&records) != IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_1, 1096, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&result, &_0$$3);
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_2, 1095, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1095, &__$null);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1092, &records);
	}
	_1 = renameColumns;
	if (_1) {
		zephir_memory_observe(&_2);
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_3, 1087, PH_NOISY_CC);
		_1 = !(zephir_instance_of_ev(&_2, phalcon_mvc_model_row_ce));
	}
	if (_1) {
		zephir_read_property_cached(&_3$$5, this_ptr, _zephir_prop_4, 1088, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1087, &_6);
	zephir_array_fetch_string(&_7, &resultset, SL("rows"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Resultset/Simple.zep", 344);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1092, &_7);
