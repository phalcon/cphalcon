...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1102, model);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1103, columnMap);
	if (keepSnapshots) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1104, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1104, &__$false);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __serialize)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1102, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("model"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1105, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1103, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("columnMap"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1106, PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("hydrateMode"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 1104, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, __unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1107, &_1);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, current)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1110, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1106, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&hydrateMode, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1103, PH_NOISY_CC | PH_READONLY);
	...
	do {
		if (ZEPHIR_IS_LONG(&hydrateMode, 0)) {
			...
			if (zephir_is_true(&_1$$5)) {
				...
				zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_4, 1102, PH_NOISY_CC);
				if (zephir_instance_of_ev(&_3$$6, phalcon_mvc_model_ce)) {
					zephir_read_property_cached(&_4$$7, this_ptr, _zephir_prop_4, 1102, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_4, 1102, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_5, 1104, PH_NOISY_CC | PH_READONLY);
				ZVAL_LONG(&_7$$6, 0);
				_8$$6 = zephir_fetch_class(&modelName);
				ZEPHIR_CALL_CE_STATIC(&activeRow, _8$$6, "cloneresultmap", NULL, 0, &_5$$6, &row, &columnMap, &_7$$6, &_6$$6);
				zephir_check_call_status();
			} else {
				zephir_read_property_cached(&_9$$9, this_ptr, _zephir_prop_4, 1102, PH_NOISY_CC | PH_READONLY);
				zephir_read_property_cached(&_10$$9, this_ptr, _zephir_prop_5, 1104, PH_NOISY_CC | PH_READONLY);
				ZVAL_LONG(&_11$$9, 0);
				ZEPHIR_CALL_CE_STATIC(&activeRow, phalcon_mvc_model_ce, "cloneresultmap", NULL, 0, &_9$$9, &row, &columnMap, &_11$$9, &_10$$9);
				zephir_check_call_status();
			}
			zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_6, 1111, PH_NOISY_CC | PH_READONLY);
			if (Z_TYPE_P(&_12$$5) != IS_NULL) {
				zephir_read_property_cached(&_13$$10, this_ptr, _zephir_prop_6, 1111, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1109, &activeRow);
	RETURN_CCTOR(&activeRow);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, serialize)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1102, PH_NOISY_CC);
	...
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1103, PH_NOISY_CC);
	zephir_array_update_string(&data, SL("columnMap"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 1106, PH_NOISY_CC);
	zephir_array_update_string(&data, SL("hydrateMode"), &_1, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_4, 1104, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, setEagerMap)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1111, &eagerMap);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, sliceRows)
{
	...
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _0)
		{
			...
			ZVAL_COPY(&index, _0);
			ZEPHIR_OBS_NVAR(&row);
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1107, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&row);
				zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_0, 1107, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_1, 1103, PH_NOISY_CC);
	zephir_array_fast_append(&_7, &_8);
	ZEPHIR_OBS_NVAR(&_8);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 1102, PH_NOISY_CC);
	zephir_array_fast_append(&_7, &_8);
	zephir_array_fast_append(&_7, &__$false);
	zephir_array_fast_append(&_7, &__$null);
	ZEPHIR_OBS_NVAR(&_8);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 1104, PH_NOISY_CC);
	zephir_array_fast_append(&_7, &_8);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, toArray)
{
	...
	zephir_read_property_cached(&records, this_ptr, _zephir_prop_0, 1107, PH_NOISY_CC);
	_0 = renameColumns;
	if (_0) {
		zephir_memory_observe(&_1);
		zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1102, PH_NOISY_CC);
		_0 = !(zephir_instance_of_ev(&_1, phalcon_mvc_model_row_ce));
	}
	if (_0) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_2, 1103, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset_Simple, unserialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1102, &_6);
	zephir_array_fetch_string(&_7, &resultset, SL("rows"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Resultset/Simple.zep", 396);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1107, &_7);
