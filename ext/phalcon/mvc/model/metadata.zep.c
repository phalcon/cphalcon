...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getStrategy)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 66, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readColumnMap)
{
	...
	if (EXPECTED(Z_TYPE_P(&keyName) != IS_NULL)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 63, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readMetaData)
{
	...
	if (EXPECTED(Z_TYPE_P(&key) != IS_NULL)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 65, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, reset)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 63, &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 68, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 64, container);
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setStrategy)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 66, strategy);
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, write)
{
	...
	/* try_start_1: */
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 67, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, writeMetaDataIndex)
{
	...
	if (zephir_array_isset_value(&_0, &key)) {
		...
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_1, 68, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, initializeMetaData)
{
	...
	if (EXPECTED(Z_TYPE_P(key) != IS_NULL)) {
		...
		if (0 == zephir_array_isset_value(&metaData, key)) {
			...
			zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_1, 68, PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset_value(&_4$$4, key)) {
				zephir_read_property_cached(&_5$$10, this_ptr, _zephir_prop_1, 68, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_12$$10, this_ptr, _zephir_prop_1, 68, PH_NOISY_CC | PH_READONLY);
