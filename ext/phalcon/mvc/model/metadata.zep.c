...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getAttributes)
{
	...
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_METHOD(&data, this_ptr, "readmetadataindex", NULL, 43, model, &_0);
	...
	if (UNEXPECTED(Z_TYPE_P(&data) != IS_ARRAY)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 44);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getColumnMap)
{
	...
	zephir_fetch_params(1, 1, 0, &model);
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_METHOD(&data, this_ptr, "readcolumnmapindex", NULL, 45, model, &_0);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 44);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getColumnMapUniqueKey)
{
	...
	if (0 == zephir_array_isset_value(&_0, &key)) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "initializecolumnmap", NULL, 46, model, &key);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getDI)
{
	...
	if (Z_TYPE_P(&container) != IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 47);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getIdentityField)
{
	...
	zephir_fetch_params(1, 1, 0, &model);
	ZVAL_LONG(&_0, 8);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "readmetadataindex", NULL, 43, model, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getMetaDataUniqueKey)
{
	...
	if (0 == zephir_array_isset_value(&_0, &key)) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "initializemetadata", NULL, 48, model, &key);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(&_1$$3)) {
			RETURN_MM_NULL();
		}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getModelUUID)
{
	...
	ZVAL_LONG(&_0, 1);
	ZEPHIR_CALL_METHOD(&pks, this_ptr, "readmetadataindex", NULL, 43, model, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getStrategy)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 64, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, hasAttribute)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "readmetadata", NULL, 49, model);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, modelEquals)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "spl_object_id", NULL, 50, first);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "spl_object_id", NULL, 50, other);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readColumnMap)
{
	...
	ZEPHIR_CALL_METHOD(&keyName, this_ptr, "getcolumnmapuniquekey", NULL, 51, model);
	zephir_check_call_status();
	if (EXPECTED(Z_TYPE_P(&keyName) != IS_NULL)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 61, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readMetaData)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 0, &model);
	ZEPHIR_CALL_METHOD(&key, this_ptr, "getmetadatauniquekey", NULL, 52, model);
	zephir_check_call_status();
	if (EXPECTED(Z_TYPE_P(&key) != IS_NULL)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 63, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, reset)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 61, &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 66, &_2);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setAutomaticCreateAttributes)
{
	...
	ZVAL_LONG(&_0, 10);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "writemetadataindex", NULL, 53, model, &_0, &attributes);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 62, container);
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setStrategy)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 64, strategy);
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, write)
{
	...
	/* try_start_1: */
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 65, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&result, &_1$$3, "set", NULL, 0, &key_zv, &data);
		zephir_check_call_status_or_jump(try_end_1);
		if (ZEPHIR_IS_FALSE_IDENTICAL(&result)) {
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "throwwriteexception", NULL, 54, &option);
			zephir_check_call_status_or_jump(try_end_1);
		}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, writeMetaDataIndex)
{
	...
	if (zephir_array_isset_value(&_0, &key)) {
		...
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_1, 66, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, initialize)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "initializemetadata", NULL, 48, model, key);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "initializecolumnmap", NULL, 46, model, key);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, initializeMetaData)
{
	...
	if (EXPECTED(Z_TYPE_P(key) != IS_NULL)) {
		...
		if (0 == zephir_array_isset_value(&metaData, key)) {
			...
			if (Z_TYPE_P(&data) != IS_NULL) {
				...
				if ((zephir_method_exists_ex(model, ZEND_STRL("metadata")) == SUCCESS)) {
					...
					if (UNEXPECTED(Z_TYPE_P(&modelMetadata) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_2$$8, "__construct", NULL, 55, &_3$$8);
						zephir_check_call_status();
			...
			zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_1, 66, PH_NOISY_CC | PH_READONLY);
			if (zephir_array_isset_value(&_4$$4, key)) {
				zephir_read_property_cached(&_5$$10, this_ptr, _zephir_prop_1, 66, PH_NOISY_CC | PH_READONLY);
				...
				zephir_read_property_cached(&_12$$10, this_ptr, _zephir_prop_1, 66, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, throwWriteException)
{
	...
	if (zephir_is_true(option)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 56, &message);
		zephir_check_call_status();
