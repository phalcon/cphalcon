...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, __construct)
{
	...
	if (Z_TYPE_P(cache) != IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$4, "is_a", NULL, 166, cache, &_2$$4);
		zephir_check_call_status();
		_4$$4 = !ZEPHIR_IS_TRUE_IDENTICAL(&_3$$4);
		if (_4$$4) {
			ZEPHIR_INIT_NVAR(&_2$$4);
			ZVAL_STRING(&_2$$4, "Psr\\SimpleCache\\CacheInterface");
			ZEPHIR_CALL_FUNCTION(&_5$$4, "is_a", NULL, 166, cache, &_2$$4);
			zephir_check_call_status();
		...
		if (UNEXPECTED(_4$$4)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", NULL, 174);
			zephir_check_call_status();
	...
	while (1) {
		...
		if (transaction == 0) {
			if (UNEXPECTED(!((zephir_method_exists_ex(&record, ZEND_STRL("getwriteconnection")) == SUCCESS)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", &_4, 176);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getFirst)
{
	...
	ZVAL_LONG(&_1, 0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 177, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getLast)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 177, &_0);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "current", NULL, 0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetGet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 177, index);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "current", NULL, 0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetSet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 179);
	zephir_check_call_status();
