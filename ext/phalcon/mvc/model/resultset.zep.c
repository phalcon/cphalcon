...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, __construct)
{
	...
	if (Z_TYPE_P(cache) != IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$4, "is_a", NULL, 200, cache, &_2$$4);
		zephir_check_call_status();
		_4$$4 = !ZEPHIR_IS_TRUE_IDENTICAL(&_3$$4);
		if (_4$$4) {
			ZEPHIR_INIT_NVAR(&_2$$4);
			ZVAL_STRING(&_2$$4, "Psr\\SimpleCache\\CacheInterface");
			ZEPHIR_CALL_FUNCTION(&_5$$4, "is_a", NULL, 200, cache, &_2$$4);
			zephir_check_call_status();
		...
		if (UNEXPECTED(_4$$4)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", NULL, 212);
			zephir_check_call_status();
	...
	if (_14) {
		ZEPHIR_CALL_METHOD(&_15, this_ptr, "count", NULL, 213);
		zephir_check_call_status();
	...
	while (1) {
		...
		if (transaction == 0) {
			if (UNEXPECTED(!((zephir_method_exists_ex(&record, ZEND_STRL("getwriteconnection")) == SUCCESS)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", &_4, 215);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getFirst)
{
	...
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 216, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, getLast)
{
	...
	ZEPHIR_CALL_METHOD(&count, this_ptr, "count", NULL, 213);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, next)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 216, &_1);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetExists)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "count", NULL, 213);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetGet)
{
	...
	if (UNEXPECTED(ZEPHIR_GE(index, &_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 217);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/Model/Resultset.zep", 601);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 216, index);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "current", NULL, 0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, offsetSet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 218);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, seek)
{
	...
	if (_1) {
		...
		if (Z_TYPE_P(&_3$$3) == IS_ARRAY) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 241, &__$null);
			RETURN_MM_NULL();
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, setIsFresh)
{
	...
	if (isFresh) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 243, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 243, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, valid)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "seek", NULL, 216, &_1$$3);
		zephir_check_call_status();
	}
	zephir_memory_observe(&_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 238, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Resultset, refresh)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 243, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 243, &__$false);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 241, &__$null);
	ZVAL_UNDEF(&_3);
	ZVAL_LONG(&_3, 0);
	...
	if (_10) {
		ZEPHIR_CALL_METHOD(&_11, this_ptr, "count", NULL, 213);
		zephir_check_call_status();
