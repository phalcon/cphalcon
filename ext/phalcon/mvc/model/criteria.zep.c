...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, betweenWhere)
{
	...
	zephir_read_property_cached(&hiddenParam, this_ptr, _zephir_prop_0, 1006, PH_NOISY_CC);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1006, &nextHiddenParam);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, bind)
{
	...
	if (_5) {
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_0, 1005, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, createBuilder)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1005, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, inWhere)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1006, &hiddenParam);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, setModelName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1007, &modelName_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Criteria, where)
{
	...
	if (Z_TYPE_P(bindParams) == IS_ARRAY) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1005, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
		...
		zephir_read_property_cached(&_5$$6, this_ptr, _zephir_prop_0, 1005, PH_NOISY_CC | PH_READONLY);
