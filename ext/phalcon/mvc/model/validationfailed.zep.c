...
PHP_METHOD(Phalcon_Mvc_Model_ValidationFailed, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1069, model);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1070, &validationMessages);
