...
PHP_METHOD(Phalcon_Mvc_Model_Transaction, getConnection) {
	...
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "connection_aborted", NULL, 432);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction, rollback) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *rollbackMessage_param = NULL, *rollbackRecord = NULL, rollbackRecord_sub, __$null, manager, connection, _0, _1, _2$$4, _3$$4;
	...
	if (zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", NULL, 433, &rollbackMessage, &_3$$4);
		zephir_check_call_status();
