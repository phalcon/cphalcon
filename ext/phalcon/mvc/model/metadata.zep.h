...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_mvc_model_metadata_getidentityfield, 0, 1, MAY_BE_NULL|MAY_BE_BOOL|MAY_BE_STRING)
	ZEND_ARG_OBJ_INFO(0, model, Phalcon\\Mvc\\ModelInterface, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_model_metadata_getmodeluuid, 0, 2, IS_STRING, 1)
	ZEND_ARG_OBJ_INFO(0, model, Phalcon\\Mvc\\ModelInterface, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_mvc_model_metadata_modelequals, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_OBJ_INFO(0, first, Phalcon\\Mvc\\ModelInterface, 0)
	ZEND_ARG_OBJ_INFO(0, other, Phalcon\\Mvc\\ModelInterface, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_mvc_model_metadata_readcolumnmapindex, 0, 2, MAY_BE_NULL|MAY_BE_ARRAY|MAY_BE_BOOL|MAY_BE_STRING)
	ZEND_ARG_OBJ_INFO(0, model, Phalcon\\Mvc\\ModelInterface, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_mvc_model_metadata_readmetadataindex, 0, 2, MAY_BE_NULL|MAY_BE_ARRAY|MAY_BE_BOOL|MAY_BE_STRING)
	ZEND_ARG_OBJ_INFO(0, model, Phalcon\\Mvc\\ModelInterface, 0)
	ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_model_metadata_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Model_MetaData, getMetaDataUniqueKey, arginfo_phalcon_mvc_model_metadata_getmetadatauniquekey, ZEND_ACC_FINAL|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Mvc_Model_MetaData, getModelUUID, arginfo_phalcon_mvc_model_metadata_getmodeluuid, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_MetaData, modelEquals, arginfo_phalcon_mvc_model_metadata_modelequals, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Mvc_Model_MetaData, getArrVal, arginfo_phalcon_mvc_model_metadata_getarrval, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_FE_END
};
