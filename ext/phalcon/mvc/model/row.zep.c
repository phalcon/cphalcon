...
PHP_METHOD(Phalcon_Mvc_Model_Row, offsetGet) {
	...
	if (UNEXPECTED(!(zephir_fetch_property_zval(&value, this_ptr, index, PH_SILENT_CC)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The index does not exist in the row", "/home/nikos/Work/niden/cphalcon/phalcon/Mvc/Model/Row.zep", 46);
		return;
	}
	RETURN_CCTOR(&value);
...
PHP_METHOD(Phalcon_Mvc_Model_Row, offsetSet) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_mvc_model_exception_ce, "Row is an immutable ArrayAccess object", "/home/nikos/Work/niden/cphalcon/phalcon/Mvc/Model/Row.zep", 70);
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Row, offsetUnset) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_mvc_model_exception_ce, "Row is an immutable ArrayAccess object", "/home/nikos/Work/niden/cphalcon/phalcon/Mvc/Model/Row.zep", 80);
	return;
