...
PHP_METHOD(Phalcon_Mvc_Model_Row, offsetGet) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The index does not exist in the row", "phalcon/mvc/model/row.zep", 65);
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Row, offsetUnset) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_mvc_model_exception_ce, "Row is an immutable ArrayAccess object", "phalcon/mvc/model/row.zep", 86);
	return;
