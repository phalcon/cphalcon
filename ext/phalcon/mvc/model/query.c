...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getQualified) {
	...
	if (zephir_array_isset(sqlColumnAliases, columnName)) {
		array_init_size(return_value, Resource id #1170);
	...
	array_init_size(return_value, Resource id #1172);
	add_assoc_stringl_ex(return_value, SS("type"), SL("qualified"), 1);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	if (ZEPHIR_IS_LONG(_0, 352)) {
		array_init_size(return_value, Resource id #1174);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getFunctionCall) {
	...
	array_init_size(return_value, Resource id #1180);
	add_assoc_stringl_ex(return_value, SS("type"), SL("functionCall"), 1);
	ZEPHIR_OBS_NVAR(_5);
	zephir_array_fetch_string(&_5, expr, SL("name"), PH_NOISY TSRMLS_CC);
	zephir_array_update_string(&return_value, SL("name"), &_5, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, expr, SS("type"), 1 TSRMLS_CC)) {
		...
		do {
			if (ZEPHIR_IS_LONG(exprType, '<')) {
				...
				array_init_size(exprReturn, Resource id #1182);
			...
			if (ZEPHIR_IS_LONG(exprType, '=')) {
				...
				array_init_size(exprReturn, Resource id #1184);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("="), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, '>')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1186);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL(">"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 270)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1188);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("<>"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 271)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1190);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("<="), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 272)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1192);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL(">="), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 266)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1194);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 267)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1196);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, '+')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1198);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("+"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, '-')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1200);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("-"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, '*')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1202);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("*"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, '/')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1204);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("/"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, '%')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1206);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("%"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 38)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1208);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("&"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 124)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1210);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
				add_assoc_stringl_ex(exprReturn, SS("op"), SL("|"), 1);
				zephir_array_update_string(&exprReturn, SL("left"), &left, PH_COPY | PH_SEPARATE);
				zephir_array_update_string(&exprReturn, SL("right"), &right, PH_COPY | PH_SEPARATE);
			...
			if (ZEPHIR_IS_LONG(exprType, 356)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1212);
			...
			if (ZEPHIR_IS_LONG(exprType, 367)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1214);
			...
			if (ZEPHIR_IS_LONG(exprType, 258) || ZEPHIR_IS_LONG(exprType, 259)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1216);
			...
			if (ZEPHIR_IS_LONG(exprType, 333)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1218);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("literal"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 334)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1220);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("literal"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 260)) {
				...
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1223);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("literal"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 273)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1225);
			...
			if (ZEPHIR_IS_LONG(exprType, 274)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1227);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("placeholder"), 1);
				zephir_array_fetch_string(&_1, expr, SL("value"), PH_NOISY | PH_READONLY TSRMLS_CC);
				ZEPHIR_INIT_VAR(_5);
			...
			if (ZEPHIR_IS_LONG(exprType, 322)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1229);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("literal"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 268)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1231);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 351)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1233);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 275)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1235);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 357)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1237);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, '!')) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1239);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("unary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 365)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1241);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("unary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 366)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1243);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("unary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 315)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1245);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 323)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1247);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 330)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1249);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("unary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 331)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1251);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 276)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1253);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("binary-op"), 1);
			...
			if (ZEPHIR_IS_LONG(exprType, 332)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1255);
			...
			if (ZEPHIR_IS_LONG(exprType, 335)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1257);
			...
			if (ZEPHIR_IS_LONG(exprType, 358)) {
				ZEPHIR_INIT_NVAR(exprReturn);
				array_init_size(exprReturn, Resource id #1259);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("literal"), 1);
				ZEPHIR_OBS_NVAR(_0);
	...
	if (zephir_array_isset_long(expr, 0)) {
		...
		array_init_size(return_value, Resource id #1261);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(columnType, 352)) {
		...
		for (
			...
			ZEPHIR_INIT_NVAR(_4);
			array_init_size(_4, Resource id #1263);
	...
	if (ZEPHIR_IS_LONG(columnType, 353)) {
		...
		ZEPHIR_INIT_NVAR(_4);
		array_init_size(_4, Resource id #1265);
		add_assoc_stringl_ex(_4, SS("type"), SL("object"), 1);
		zephir_array_update_string(&_4, SL("model"), &modelName, PH_COPY | PH_SEPARATE);
	...
	if (ZEPHIR_IS_LONG(columnType, 354)) {
		...
		array_init_size(sqlColumn, Resource id #1267);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getTable) {
	...
	if (zephir_array_isset_string_fetch(&modelName, qualifiedName, SS("name"), 1 TSRMLS_CC)) {
		...
		if (zephir_is_true(schema)) {
			array_init_size(return_value, Resource id #1269);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoin) {
	...
	if (zephir_array_isset_string_fetch(&qualified, join, SS("qualified"), 1 TSRMLS_CC)) {
		...
		if (ZEPHIR_IS_LONG(_0, 355)) {
			...
			ZEPHIR_INIT_VAR(schema);
			zephir_call_method(schema, model, "getschema");
			array_init_size(return_value, Resource id #1271);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	if ((Z_TYPE_P(fields) != IS_ARRAY)) {
		...
		ZEPHIR_INIT_NVAR(_0);
		ZEPHIR_INIT_VAR(_2);
		array_init_size(_2, Resource id #1277);
		...
		for (
			...
			array_init_size(_10, Resource id #1283);
	...
	array_init_size(return_value, Resource id #1285);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getMultiJoin) {
	...
	if ((Z_TYPE_P(fields) == IS_ARRAY)) {
		...
		for (
			...
			ZEPHIR_INIT_NVAR(_3);
			ZEPHIR_INIT_NVAR(_9);
			array_init_size(_9, Resource id #1291);
		...
		array_init_size(sqlJoins, Resource id #1293);
		ZEPHIR_INIT_NVAR(_3);
		array_init_size(_3, Resource id #1295);
		...
		ZEPHIR_INIT_NVAR(_7);
		array_init_size(_7, Resource id #1297);
		ZEPHIR_INIT_NVAR(_9);
		array_init_size(_9, Resource id #1299);
		add_assoc_stringl_ex(_9, SS("type"), SL("binary-op"), 1);
		add_assoc_stringl_ex(_9, SS("op"), SL("="), 1);
		ZEPHIR_INIT_VAR(_11);
		ZEPHIR_INIT_VAR(_12);
		array_init_size(_12, Resource id #1301);
		...
		ZEPHIR_INIT_VAR(_13);
		array_init_size(_13, Resource id #1303);
		...
		ZEPHIR_INIT_NVAR(_3);
		array_init_size(_3, Resource id #1305);
		zephir_array_update_string(&_3, SL("type"), &joinType, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_3, SL("source"), &joinSource, PH_COPY | PH_SEPARATE);
		ZEPHIR_INIT_NVAR(_7);
		array_init_size(_7, Resource id #1307);
		ZEPHIR_INIT_NVAR(_9);
		array_init_size(_9, Resource id #1309);
		add_assoc_stringl_ex(_9, SS("type"), SL("binary-op"), 1);
		add_assoc_stringl_ex(_9, SS("op"), SL("="), 1);
		ZEPHIR_INIT_NVAR(_11);
		ZEPHIR_INIT_VAR(_14);
		array_init_size(_14, Resource id #1311);
		...
		ZEPHIR_INIT_NVAR(_11);
		ZEPHIR_INIT_VAR(_15);
		array_init_size(_15, Resource id #1313);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	if (!(zephir_array_isset_long(joins, 0))) {
		...
		array_init_size(selectJoins, Resource id #1315);
	...
	for (
		...
		array_init_size(completeSource, Resource id #1317);
		...
		for (
			...
			if (!(zephir_array_isset_fetch(&preCondition, joinPreCondition, joinAlias, 1 TSRMLS_CC))) {
				...
				if ((Z_TYPE_P(relation) == IS_OBJECT)) {
					...
					ZEPHIR_INIT_NVAR(_27);
					array_init_size(_27, Resource id #1319);
				...
				ZEPHIR_INIT_NVAR(_5);
				array_init_size(_5, Resource id #1321);
				...
				ZEPHIR_INIT_NVAR(_28);
				array_init_size(_28, Resource id #1323);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	if (!(zephir_array_isset_long(order, 0))) {
		...
		array_init_size(orderColumns, Resource id #1325);
	...
	for (
		...
		if (zephir_array_isset_string_fetch(&orderSort, orderItem, SS("sort"), 1 TSRMLS_CC)) {
			...
			ZEPHIR_INIT_NVAR(orderPartSort);
			array_init_size(orderPartSort, Resource id #1331);
			zephir_array_fast_append(orderPartSort, orderPartExpr);
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getGroupClause) {
	...
	if (zephir_array_isset_long(group, 0)) {
		...
		array_init_size(groupParts, Resource id #1333);
		ZEPHIR_INIT_NVAR(_3);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	if (!(zephir_array_isset_long(tables, 0))) {
		...
		array_init_size(selectedModels, Resource id #1335);
	...
	for (
		...
		if (zephir_is_true(schema)) {
			ZEPHIR_INIT_NVAR(completeSource);
			array_init_size(completeSource, Resource id #1337);
			zephir_array_fast_append(completeSource, source);
			zephir_array_fast_append(completeSource, schema);
		} else {
		...
		if (zephir_array_isset_string_fetch(&alias, selectedModel, SS("alias"), 0 TSRMLS_CC)) {
			...
			if ((Z_TYPE_P(completeSource) == IS_ARRAY)) {
				...
				ZEPHIR_INIT_NVAR(completeSource);
				array_init_size(completeSource, Resource id #1339);
				zephir_array_fast_append(completeSource, source);
	...
	if (!(zephir_array_isset_long(columns, 0))) {
		...
		array_init_size(selectColumns, Resource id #1341);
	...
	array_init_size(sqlSelect, Resource id #1343);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	if (zephir_is_true(schema)) {
		...
		array_init_size(source, Resource id #1345);
	...
	for (
		...
		ZEPHIR_INIT_NVAR(_4);
		array_init_size(_4, Resource id #1347);
		ZEPHIR_OBS_NVAR(_5);
	...
	array_init_size(sqlInsert, Resource id #1349);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	if (!(zephir_array_isset_long(tables, 0))) {
		...
		array_init_size(updateTables, Resource id #1351);
	...
	for (
		...
		ZEPHIR_INIT_NVAR(completeSource);
		if (zephir_is_true(schema)) {
			array_init_size(completeSource, Resource id #1353);
			zephir_array_fast_append(completeSource, source);
			zephir_array_fast_append(completeSource, schema);
		} else {
			array_init_size(completeSource, Resource id #1355);
			zephir_array_fast_append(completeSource, source);
			zephir_array_fast_append(completeSource, ZEPHIR_GLOBAL(global_null));
		}
	...
	if (!(zephir_array_isset_long(values, 0))) {
		...
		array_init_size(updateValues, Resource id #1357);
	...
	for (
		...
		array_init_size(_13, Resource id #1359);
		ZEPHIR_OBS_NVAR(_14);
	...
	array_init_size(sqlUpdate, Resource id #1361);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (!(zephir_array_isset_long(tables, 0))) {
		...
		array_init_size(deleteTables, Resource id #1363);
	...
	for (
		...
		ZEPHIR_INIT_NVAR(completeSource);
		if (zephir_is_true(schema)) {
			array_init_size(completeSource, Resource id #1365);
			zephir_array_fast_append(completeSource, source);
			zephir_array_fast_append(completeSource, schema);
		} else {
			array_init_size(completeSource, Resource id #1367);
			zephir_array_fast_append(completeSource, source);
			zephir_array_fast_append(completeSource, ZEPHIR_GLOBAL(global_null));
		}
		if (zephir_array_isset_string_fetch(&alias, table, SS("alias"), 1 TSRMLS_CC)) {
		...
		if (ZEPHIR_IS_STRING(_0, "object")) {
			...
			if ((isComplex == 1)) {
				...
				for (
					...
					ZEPHIR_INIT_NVAR(_6);
					array_init_size(_6, Resource id #1370);
				...
				for (
					...
					array_init_size(_26, Resource id #1372);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	array_init_size(selectIr, Resource id #1380);
	ZEPHIR_INIT_VAR(_0);
	array_init_size(_0, Resource id #1382);
	ZEPHIR_INIT_VAR(_1);
	array_init_size(_1, Resource id #1384);
	ZEPHIR_INIT_VAR(_2);
	array_init_size(_2, Resource id #1386);
