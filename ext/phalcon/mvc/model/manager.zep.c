...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addBelongsTo)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1010, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createBuilder)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &_2);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createQuery)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1022, &query);
	RETURN_CCTOR(&query);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getModelSource)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 1026, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 1025, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getReadConnection)
{
	...
	if (zephir_is_true(&_0)) {
		...
		if (zephir_array_isset_value(&_2$$3, &writeService)) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 1028, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getconnection", NULL, 0, model, &_3$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1030, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelations)
{
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 1016, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_3, 1018, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_4, 1014, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationsBetween)
{
	...
	zephir_get_strval(&keyRelation, &_2);
	zephir_memory_observe(&relations);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1009, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_3, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_3, 1017, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_6, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_4, 1013, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, initialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1033, model);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1034, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1033, &__$null);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isVisibleModelProperty)
{
	...
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_0, 1037, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, load)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1020, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, missingMethod)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 1034, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, registerWrite)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1028, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, removeBehavior)
{
	...
	if (zephir_array_isset_value(&_0, &entityName)) {
		...
		if (Z_TYPE_P(&_2$$3) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_2$$3), _4$$3, _5$$3, _3$$3)
			{
				...
				if (ZEPHIR_IS_IDENTICAL(&_6$$4, &behaviorClass_zv)) {
					zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 1008, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_IDENTICAL(&_11$$6, &behaviorClass_zv)) {
						zephir_read_property_cached(&_12$$7, this_ptr, _zephir_prop_0, 1008, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&behavior);
		ZEPHIR_INIT_NVAR(&key);
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_0, 1008, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, resetConnectionState)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1029, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1020, container);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1034, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setModelPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1026, &prefix_zv);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setSticky)
{
	...
	if (sticky) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1027, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1027, &__$false);
	}
}
