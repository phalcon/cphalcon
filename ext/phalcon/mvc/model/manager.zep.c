...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addBelongsTo)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 991, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createBuilder)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1002, &_2);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createQuery)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1003, &query);
	RETURN_CCTOR(&query);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getBelongsToRecords)
{
	...
	zephir_memory_observe(&relations);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 992, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getModelSource)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 1006, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getReadConnection)
{
	...
	if (zephir_is_true(&_0)) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_2, 1010, PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_value(&_2$$3, &writeService)) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 1009, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getconnection", NULL, 0, model, &_3$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1011, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelations)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 993, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 997, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_3, 999, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_4, 995, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationsBetween)
{
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 992, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_4, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 996, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_5, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_3, 998, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_6, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_4, 994, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, initialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1014, model);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1015, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1014, &__$null);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isKeepingSnapshots)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1016, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	zephir_get_class(&_1, model, 1);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isVisibleModelProperty)
{
	...
	if (!(zephir_array_isset_value(&_0, &className))) {
		...
		zephir_check_call_status();
		ZVAL_LONG(&_1$$3, 1);
		ZEPHIR_CALL_METHOD(&reflectionProperties, &classReflection, "getproperties", NULL, 325, &_1$$3);
		zephir_check_call_status();
	...
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_0, 1018, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, load)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1001, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, missingMethod)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 1015, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, notifyEvent)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 1004, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_7);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, registerWrite)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1009, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, removeBehavior)
{
	...
	if (zephir_array_isset_value(&_0, &entityName)) {
		...
		if (Z_TYPE_P(&_2$$3) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_2$$3), _4$$3, _5$$3, _3$$3)
			{
				...
				if (ZEPHIR_IS_IDENTICAL(&_6$$4, &behaviorClass_zv)) {
					zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 989, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_IDENTICAL(&_11$$6, &behaviorClass_zv)) {
						zephir_read_property_cached(&_12$$7, this_ptr, _zephir_prop_0, 989, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&behavior);
		ZEPHIR_INIT_NVAR(&key);
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_0, 989, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, resetConnectionState)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1010, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1001, container);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1015, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setModelPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1007, &prefix_zv);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setSticky)
{
	...
	if (sticky) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1008, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1008, &__$false);
	}
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, checkHasRelationship)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
