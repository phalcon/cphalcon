...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addBelongsTo)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1014, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1015, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasMany)
{
	...
	ZEPHIR_CONCAT_VSV(&_0, &entityName, "$", &referencedEntity);
	zephir_get_strval(&keyRelation, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1016, PH_NOISY_CC | PH_READONLY);
	...
	zephir_memory_observe(&singleRelations);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1017, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasManyToMany)
{
	...
	ZEPHIR_CONCAT_VSV(&_0, &entityName, "$", &referencedEntity);
	zephir_get_strval(&keyRelation, &_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1018, PH_NOISY_CC | PH_READONLY);
	...
	zephir_memory_observe(&singleRelations);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1019, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&singleRelations, &_1, &entityName, 0))) {
		ZEPHIR_INIT_NVAR(&singleRelations);
		array_init(&singleRelations);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasOne)
{
	...
	zephir_memory_observe(&singleRelations);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1021, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&singleRelations, &_4, &entityName, 0))) {
		ZEPHIR_INIT_NVAR(&singleRelations);
		array_init(&singleRelations);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, clearReusableObjects)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1024, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createBuilder)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1026, &_2);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, createQuery)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1027, &query);
	RETURN_CCTOR(&query);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getBelongsToRecords)
{
	...
	zephir_memory_observe(&relations);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1016, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getModelSource)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 1031, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 1030, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getReadConnection)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1033, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&writeService, this_ptr, "getconnectionservice", NULL, 0, model, &_1$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_2, 1034, PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_value(&_2$$3, &writeService)) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 1033, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getconnection", NULL, 0, model, &_3$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_3, 1035, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelations)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1017, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 1021, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_3, 1023, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_16, this_ptr, _zephir_prop_4, 1019, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationsBetween)
{
	...
	zephir_get_strval(&keyRelation, &_2);
	zephir_memory_observe(&relations);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 1014, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_3, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 1016, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_4, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 1020, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_5, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_3, 1022, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_fetch(&relations, &_6, &keyRelation, 0)) {
		RETURN_CCTOR(&relations);
	}
	ZEPHIR_OBS_NVAR(&relations);
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_4, 1018, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, initialize)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1038, model);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1038, &__$null);
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isUsingDynamicUpdate)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1041, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	zephir_get_class(&_1, model, 1);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isVisibleModelProperty)
{
	...
	if (!(zephir_array_isset_value(&_0, &className))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &classReflection, "__construct", NULL, 244, &className);
		zephir_check_call_status();
		ZVAL_LONG(&_1$$3, 1);
		ZEPHIR_CALL_METHOD(&reflectionProperties, &classReflection, "getproperties", NULL, 363, &_1$$3);
		zephir_check_call_status();
	...
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_0, 1042, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, load)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1025, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, missingMethod)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 1039, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, registerWrite)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1033, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, removeBehavior)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
	if (zephir_array_isset_value(&_0, &entityName)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&_2$$3) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_2$$3), _4$$3, _5$$3, _3$$3)
			{
				...
				if (ZEPHIR_IS_IDENTICAL(&_6$$4, &behaviorClass_zv)) {
					zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_IDENTICAL(&_11$$6, &behaviorClass_zv)) {
						zephir_read_property_cached(&_12$$7, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
		...
		ZEPHIR_INIT_NVAR(&behavior);
		ZEPHIR_INIT_NVAR(&key);
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_0, 1013, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1025, container);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1039, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, setModelPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1031, &prefix_zv);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, checkHasRelationship)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1037, PH_NOISY_CC | PH_READONLY);
