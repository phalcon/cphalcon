...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1091, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1092, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1093, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1094, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1095, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1096, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1097, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1098, intermediateReferencedFields);
}
