...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1080, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1081, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1082, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1083, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1084, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1085, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1086, intermediateReferencedFields);
}
