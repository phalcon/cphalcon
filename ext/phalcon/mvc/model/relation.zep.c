...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1089, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1090, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1091, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1092, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1093, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1094, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1095, intermediateReferencedFields);
}
