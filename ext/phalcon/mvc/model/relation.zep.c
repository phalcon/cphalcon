...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1086, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1087, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1088, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1089, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1090, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1091, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1092, intermediateReferencedFields);
}
