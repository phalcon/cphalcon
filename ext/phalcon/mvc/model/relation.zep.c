...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1071, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1072, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1073, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1074, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1075, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1076, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1077, intermediateReferencedFields);
}
