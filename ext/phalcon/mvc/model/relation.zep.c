...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1087, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1088, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1089, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1090, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1091, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1092, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1093, intermediateReferencedFields);
}
