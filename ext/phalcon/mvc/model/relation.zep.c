...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1112, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1113, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1114, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1115, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1116, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1117, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1118, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1119, intermediateReferencedFields);
}
