...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1034, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1035, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1036, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1037, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1038, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1039, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1040, intermediateReferencedFields);
}
