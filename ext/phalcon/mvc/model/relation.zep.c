...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1039, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1040, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1041, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1042, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1043, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1044, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1045, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1046, intermediateReferencedFields);
}
