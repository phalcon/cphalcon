...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1076, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1077, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1078, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1079, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1080, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1081, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1082, intermediateReferencedFields);
}
