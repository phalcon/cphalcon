...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1084, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1085, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1086, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1087, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1088, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1089, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1090, intermediateReferencedFields);
}
