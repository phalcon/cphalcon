...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1095, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1096, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1097, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1098, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1099, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1100, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1101, intermediateReferencedFields);
}
