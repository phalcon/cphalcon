...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1091, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1092, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1093, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1094, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1095, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1096, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1097, intermediateReferencedFields);
}
