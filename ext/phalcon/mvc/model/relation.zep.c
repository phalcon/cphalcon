...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1030, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1031, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1032, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1033, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1034, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1035, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1036, intermediateReferencedFields);
}
