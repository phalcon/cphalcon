...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1093, &_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1094, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1095, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1096, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1097, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1098, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1099, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1100, intermediateReferencedFields);
}
