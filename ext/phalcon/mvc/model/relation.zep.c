...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1079, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1080, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1081, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1082, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1083, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1084, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1085, intermediateReferencedFields);
}
