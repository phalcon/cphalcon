...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1031, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1032, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1033, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1034, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1035, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1036, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1037, intermediateReferencedFields);
}
