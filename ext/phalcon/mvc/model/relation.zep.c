...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1093, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1094, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1095, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1096, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1097, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1098, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1099, intermediateReferencedFields);
}
