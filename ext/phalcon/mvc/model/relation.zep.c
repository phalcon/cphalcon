...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1074, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1075, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1076, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1077, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1078, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1079, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1080, intermediateReferencedFields);
}
