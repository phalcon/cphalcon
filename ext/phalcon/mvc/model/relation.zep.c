...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1067, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1068, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1069, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1070, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1071, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1072, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1073, intermediateReferencedFields);
}
