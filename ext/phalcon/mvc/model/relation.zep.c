...
PHP_METHOD(Phalcon_Mvc_Model_Relation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1078, &referencedModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1079, fields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1080, referencedFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1081, &options);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Relation, setIntermediateRelation)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1082, intermediateFields);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1083, &intermediateModel_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1084, intermediateReferencedFields);
}
