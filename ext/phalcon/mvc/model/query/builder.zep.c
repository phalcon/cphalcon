...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, getPhql)
{
		...
		if (Z_TYPE_P(&order) == IS_ARRAY) {
			...
			if (Z_TYPE_P(&order) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&order), _73$$69)
				{
					...
					ZVAL_STRING(&_74$$70, " ");
					ZEPHIR_CALL_FUNCTION(&lastSpacePosition$$70, "strrpos", &_75, 510, &itemTrimmed$$70, &_74$$70);
					zephir_check_call_status();
					...
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&lastSpacePosition$$70)) {
						...
						ZEPHIR_CALL_FUNCTION(&_81$$72, "strcasecmp", &_82, 74, &perhapsDirection$$72, &_80$$72);
						zephir_check_call_status();
						_83$$72 = ZEPHIR_IS_LONG(&_81$$72, 0);
						if (!(_83$$72)) {
							ZEPHIR_INIT_NVAR(&_80$$72);
							ZVAL_STRING(&_80$$72, "asc");
							ZEPHIR_CALL_FUNCTION(&_84$$72, "strcasecmp", &_82, 74, &perhapsDirection$$72, &_80$$72);
							zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZVAL_STRING(&_90$$76, " ");
						ZEPHIR_CALL_FUNCTION(&lastSpacePosition$$76, "strrpos", &_75, 510, &itemTrimmed$$76, &_90$$76);
						zephir_check_call_status();
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&lastSpacePosition$$76)) {
							...
							ZEPHIR_CALL_FUNCTION(&_96$$78, "strcasecmp", &_82, 74, &perhapsDirection$$78, &_95$$78);
							zephir_check_call_status();
							_97$$78 = ZEPHIR_IS_LONG(&_96$$78, 0);
							if (!(_97$$78)) {
								ZEPHIR_INIT_NVAR(&_95$$78);
								ZVAL_STRING(&_95$$78, "asc");
								ZEPHIR_CALL_FUNCTION(&_98$$78, "strcasecmp", &_82, 74, &perhapsDirection$$78, &_95$$78);
								zephir_check_call_status();
	...
	if (Z_TYPE_P(&limit) != IS_NULL) {
		...
		if (zephir_is_numeric(&number)) {
			...
			ZEPHIR_CALL_FUNCTION(&_107$$91, "intval", NULL, 81, &number, &_106$$91);
			zephir_check_call_status();
			...
			if (_111$$91) {
				...
				ZEPHIR_CALL_FUNCTION(&_113$$92, "intval", NULL, 81, &offset, &_112$$92);
				zephir_check_call_status();
