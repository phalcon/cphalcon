...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, __construct)
{
	...
	if (Z_TYPE_P(params) == IS_ARRAY) {
		...
		if (zephir_array_isset_long_fetch(&conditions, params, 0, 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1020, &conditions);
		} else {
		...
		if (Z_TYPE_P(&conditions) == IS_ARRAY) {
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1020, &_7$$7);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &mergedParams);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &mergedTypes);
		}
		zephir_memory_observe(&bind);
		if (zephir_array_isset_string_fetch(&bind, params, SL("bind"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &bind);
		}
		zephir_memory_observe(&bindTypes);
		if (zephir_array_isset_string_fetch(&bindTypes, params, SL("bindTypes"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &bindTypes);
		}
		zephir_memory_observe(&distinct);
		if (zephir_array_isset_string_fetch(&distinct, params, SL("distinct"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1023, &distinct);
		}
		zephir_memory_observe(&fromClause);
		if (zephir_array_isset_string_fetch(&fromClause, params, SL("models"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1024, &fromClause);
		}
		zephir_memory_observe(&columns);
		if (zephir_array_isset_string_fetch(&columns, params, SL("columns"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1025, &columns);
		}
		zephir_memory_observe(&joinsClause);
		if (zephir_array_isset_string_fetch(&joinsClause, params, SL("joins"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 1026, &joinsClause);
		}
		...
		if (zephir_array_isset_string_fetch(&havingClause, params, SL("having"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 1027, &havingClause);
		}
		zephir_memory_observe(&orderClause);
		if (zephir_array_isset_string_fetch(&orderClause, params, SL("order"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 1028, &orderClause);
		}
			...
			if (Z_TYPE_P(&limitClause) == IS_ARRAY) {
				...
				if (zephir_array_isset_long_fetch(&limit, &limitClause, 0, 0)) {
					if (Z_TYPE_P(&limit) == IS_LONG) {
						zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1029, &limit);
					}
					zephir_memory_observe(&offset);
					if (zephir_array_isset_long_fetch(&offset, &limitClause, 1, 0)) {
						if (Z_TYPE_P(&offset) == IS_LONG) {
							zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 1030, &offset);
						}
					}
				} else {
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1029, &limitClause);
				}
			} else {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1029, &limitClause);
			}
		...
		if (zephir_array_isset_string_fetch(&offsetClause, params, SL("offset"), 1)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 1030, &offsetClause);
		}
		if (zephir_array_isset_string_fetch(&forUpdate, params, SL("for_update"), 1)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 1031, &forUpdate);
		}
		if (zephir_array_isset_string_fetch(&sharedLock, params, SL("shared_lock"), 1)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_12, 1032, &sharedLock);
		}
	} else {
		...
		if (_8$$38) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1020, params);
		}
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 1033, container);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, addFrom)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1024, &models);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, andHaving)
{
	...
	zephir_read_property_cached(&currentConditions, this_ptr, _zephir_prop_0, 1027, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, columns)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1025, columns);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, distinct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1023, distinct);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, getPhql)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1024, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&models, &_0);
	if (Z_TYPE_P(&models) == IS_ARRAY) {
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1020, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1023, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 1025, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_5, 1026, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_7, 1027, PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&order) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&order), _73$$69)
				{
					...
					if (!ZEPHIR_IS_FALSE_IDENTICAL(&lastSpacePosition$$70)) {
						...
						ZEPHIR_CALL_FUNCTION(&_81$$72, "strcasecmp", &_82, 85, &perhapsDirection$$72, &_80$$72);
						zephir_check_call_status();
						_83$$72 = ZEPHIR_IS_LONG(&_81$$72, 0);
						if (!(_83$$72)) {
							ZEPHIR_INIT_NVAR(&_80$$72);
							ZVAL_STRING(&_80$$72, "asc");
							ZEPHIR_CALL_FUNCTION(&_84$$72, "strcasecmp", &_82, 85, &perhapsDirection$$72, &_80$$72);
							zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (!ZEPHIR_IS_FALSE_IDENTICAL(&lastSpacePosition$$76)) {
							...
							ZEPHIR_CALL_FUNCTION(&_96$$78, "strcasecmp", &_82, 85, &perhapsDirection$$78, &_95$$78);
							zephir_check_call_status();
							_97$$78 = ZEPHIR_IS_LONG(&_96$$78, 0);
							if (!(_97$$78)) {
								ZEPHIR_INIT_NVAR(&_95$$78);
								ZVAL_STRING(&_95$$78, "asc");
								ZEPHIR_CALL_FUNCTION(&_98$$78, "strcasecmp", &_82, 85, &perhapsDirection$$78, &_95$$78);
								zephir_check_call_status();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_9, 1029, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&limit) != IS_NULL) {
		...
		if (Z_TYPE_P(&limit) == IS_ARRAY) {
			...
			if (zephir_is_numeric(&limit)) {
				...
				zephir_read_property_cached(&_105$$88, this_ptr, _zephir_prop_10, 1030, PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_is_numeric(&number)) {
			...
			ZEPHIR_CALL_FUNCTION(&_107$$91, "intval", NULL, 95, &number, &_106$$91);
			zephir_check_call_status();
			...
			if (_111$$91) {
				...
				ZEPHIR_CALL_FUNCTION(&_113$$92, "intval", NULL, 95, &offset, &_112$$92);
				zephir_check_call_status();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_11, 1031, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, getQuery)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1021, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&bindParams, &_0);
	if (Z_TYPE_P(&bindParams) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(NULL, &query, "setbindparams", NULL, 0, &bindParams);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1022, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_3, 1032, PH_NOISY_CC);
	if (((Z_TYPE_P(&_5) == IS_TRUE || Z_TYPE_P(&_5) == IS_FALSE) == 1)) {
		zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_3, 1032, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &query, "setsharedlock", NULL, 0, &_6$$6);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 1035, PH_NOISY_CC | PH_READONLY);
	_7 = !ZEPHIR_IS_STRING(&_0, "");
	if (_7) {
		_7 = (zephir_method_exists_ex(&query, ZEND_STRL("setresultsetrowclass")) == SUCCESS);
	}
	if (_7) {
		zephir_read_property_cached(&_8$$7, this_ptr, _zephir_prop_4, 1035, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, groupBy)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1034, group);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, having)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1027, &conditions_zv);
	zephir_memory_observe(&currentBindParams);
	zephir_read_property_cached(&currentBindParams, this_ptr, _zephir_prop_1, 1021, PH_NOISY_CC);
	if (Z_TYPE_P(&currentBindParams) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_add_function(&_0$$3, &currentBindParams, &bindParams);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &bindParams);
	}
	zephir_memory_observe(&currentBindTypes);
	zephir_read_property_cached(&currentBindTypes, this_ptr, _zephir_prop_2, 1022, PH_NOISY_CC);
	if (Z_TYPE_P(&currentBindTypes) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_1$$5);
		zephir_add_function(&_1$$5, &currentBindTypes, &bindTypes);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &_1$$5);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &bindTypes);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, limit)
{
	...
	if (zephir_is_numeric(offset)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1030, &_3$$4);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, orderBy)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1028, orderBy);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, setBindParams)
{
	...
	if (merge) {
		zephir_memory_observe(&currentBindParams);
		zephir_read_property_cached(&currentBindParams, this_ptr, _zephir_prop_0, 1021, PH_NOISY_CC);
		if (Z_TYPE_P(&currentBindParams) == IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_0$$4);
			zephir_add_function(&_0$$4, &currentBindParams, &bindParams);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1021, &_0$$4);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1021, &bindParams);
		}
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1021, &bindParams);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, setBindTypes)
{
	...
	if (UNEXPECTED(merge)) {
		zephir_memory_observe(&currentBindTypes);
		zephir_read_property_cached(&currentBindTypes, this_ptr, _zephir_prop_0, 1022, PH_NOISY_CC);
		if (Z_TYPE_P(&currentBindTypes) == IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_0$$4);
			zephir_add_function(&_0$$4, &currentBindTypes, &bindTypes);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1022, &_0$$4);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1022, &bindTypes);
		}
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1022, &bindTypes);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, setResultsetRowClass)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1035, &resultsetRowClass_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, where)
{
	...
	if (zephir_fast_count_int(&bindParams) > 0) {
		...
		if (Z_TYPE_P(&currentBindParams) == IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_0$$4);
			zephir_add_function(&_0$$4, &currentBindParams, &bindParams);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &_0$$4);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1021, &bindParams);
		}
	}
	if (zephir_fast_count_int(&bindTypes) > 0) {
		zephir_read_property_cached(&currentBindTypes, this_ptr, _zephir_prop_2, 1022, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&currentBindTypes) == IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_1$$7);
			zephir_add_function(&_1$$7, &currentBindTypes, &bindTypes);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &_1$$7);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1022, &bindTypes);
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, conditionBetween)
{
	...
	zephir_read_property_cached(&hiddenParam, this_ptr, _zephir_prop_0, 1036, PH_NOISY_CC);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1036, &nextHiddenParam);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query_Builder, conditionIn)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 1036, PH_NOISY_CC);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1036, &_14);
	RETURN_THIS();
}
