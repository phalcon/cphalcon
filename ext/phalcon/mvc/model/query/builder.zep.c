		...
		if (Z_TYPE_P(&order) == IS_ARRAY) {
			...
			if (Z_TYPE_P(&order) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&order), _73$$69)
				{
					...
					ZVAL_STRING(&_74$$70, " ");
					ZEPHIR_CALL_FUNCTION(&lastSpacePosition$$70, "strrpos", &_75, 503, &itemTrimmed$$70, &_74$$70);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZVAL_STRING(&_90$$76, " ");
						ZEPHIR_CALL_FUNCTION(&lastSpacePosition$$76, "strrpos", &_75, 503, &itemTrimmed$$76, &_90$$76);
						zephir_check_call_status();
