...
#define PPNSTATE 314
#define PPNRULE 171
#define PPERRORSYMBOL 89
#define PPERRSYMDT pp287
...
// 325 "parser.php.lemon"
{
  ...
  pp_destructor(52,&ppmsp[-5].minor);
  pp_destructor(53,&ppmsp[-3].minor);
...
// 329 "parser.php.lemon"
{
  ...
  pp_destructor(52,&ppmsp[-8].minor);
  pp_destructor(54,&ppmsp[-6].minor);
...
{
	{
		...
		phql_ret_expr(&ppgotominor.pp82, PHQL_T_CAST, &ppmsp[-3].minor.pp82, &qualified);
	}
  pp_destructor(76,&ppmsp[-5].minor);
  pp_destructor(54,&ppmsp[-4].minor);
...
{
	{
		zval qualified;
		phql_ret_raw_qualified_name(&qualified, ppmsp[-1].minor.pp0, NULL);
		phql_ret_expr(&ppgotominor.pp82, PHQL_T_CONVERT, &ppmsp[-3].minor.pp82, &qualified);
	}
  pp_destructor(77,&ppmsp[-5].minor);
  pp_destructor(54,&ppmsp[-4].minor);
