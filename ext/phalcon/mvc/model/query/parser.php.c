...
#line 1565 "parser.php.c"
        break;
      case 48:
#line 382 "parser.php.lemon"
{
	phql_ret_update_clause(&yygotominor.yy202, &yymsp[-3].minor.yy202, &yymsp[-2].minor.yy202, &yymsp[0].minor.yy202);
  yy_destructor(47,&yymsp[-4].minor);
  yy_destructor(48,&yymsp[-1].minor);
}
#line 1574 "parser.php.c"
        break;
      case 51:
