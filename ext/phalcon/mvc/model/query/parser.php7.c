...
#line 878 "parser.php7.c"
      break;
    case 116:
    case 126:
    case 129:
    case 132:
#line 1034 "parser.php7.lemon"
{
#if PHP_VERSION_ID < 70000
	zval_ptr_dtor(&(yypminor->yy162));
#else
...
#line 1329 "parser.php7.c"
        break;
      case 8:
#line 175 "parser.php7.lemon"
{
	yygotominor.yy162 = phql_ret_distinct_all(0);
  yy_destructor(29,&yymsp[0].minor);
}
#line 1337 "parser.php7.c"
        break;
      case 9:
      case 20:
      case 27:
...
#line 1401 "parser.php7.c"
        break;
      case 14:
#line 211 "parser.php7.lemon"
{
...
#line 1438 "parser.php7.c"
        break;
      case 25:
#line 286 "parser.php7.lemon"
{
	yygotominor.yy162 = phql_ret_qualified_name(NULL, NULL, yymsp[0].minor.yy0);
  yy_destructor(32,&yymsp[-1].minor);
}
#line 1446 "parser.php7.c"
        break;
      case 26:
      case 46:
      case 66:
      case 160:
#line 290 "parser.php7.lemon"
{
	yygotominor.yy162 = phql_ret_qualified_name(NULL, NULL, yymsp[0].minor.yy0);
}
#line 1456 "parser.php7.c"
        break;
      case 28:
...
#line 2055 "parser.php7.c"
        break;
      case 126:
#line 863 "parser.php7.lemon"
{
