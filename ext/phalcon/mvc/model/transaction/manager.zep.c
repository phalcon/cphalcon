...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, collectTransactions)
{
	...
	ZEPHIR_INIT_VAR(&_5);
	array_init(&_5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1065, &_5);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, getOrCreateTransaction)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_2, 1065, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 1069, PH_NOISY_CC | PH_READONLY);
	if (autoBegin) {
		ZVAL_BOOL(&_9, 1);
	} else {
		ZVAL_BOOL(&_9, 0);
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, setDbService)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1069, &service_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, collectTransaction)
{
	...
	ZEPHIR_INIT_NVAR(&managedTransaction);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1065, &newTransactions);
	ZEPHIR_MM_RESTORE();
}
