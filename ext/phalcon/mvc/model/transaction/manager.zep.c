...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1121, container);
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, collectTransactions)
{
	...
	ZEPHIR_INIT_VAR(&_5);
	array_init(&_5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1122, &_5);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, get)
{
	...
	if (!(zephir_is_true(&_0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1124, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, getOrCreateTransaction)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1125, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_2, 1122, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 1126, PH_NOISY_CC | PH_READONLY);
	if (autoBegin) {
		ZVAL_BOOL(&_9, 1);
	} else {
		ZVAL_BOOL(&_9, 0);
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, setDbService)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1126, &service_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, setRollbackPendent)
{
	...
	if (rollbackPendent) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1124, &__$true);
	} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, collectTransaction)
{
	...
	ZEPHIR_INIT_NVAR(&managedTransaction);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1122, &newTransactions);
	ZEPHIR_MM_RESTORE();
}
