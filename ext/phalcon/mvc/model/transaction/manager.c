...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, __construct) {
	...
	if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_transaction_exception_ce, "A dependency injector container is required to obtain the services related to the ORM", "phalcon/mvc/model/transaction/manager.zep", 95);
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, get) {
	...
	zval *_1;
	zval *autoBegin_param = NULL, *_0, *_2;
	zend_bool autoBegin;
	...
	if (!(zephir_is_true(_0))) {
		_0 = zephir_fetch_nproperty_this(this_ptr, SL("_rollbackPendent"), PH_NOISY_CC);
		if (zephir_is_true(_0)) {
			ZEPHIR_INIT_VAR(_1);
			array_init_size(_1, 3);
			zephir_array_fast_append(_1, this_ptr);
			ZEPHIR_INIT_VAR(_2);
			ZVAL_STRING(_2, "rollbackPendent", 1);
			zephir_array_fast_append(_1, _2);
			ZEPHIR_CALL_FUNCTION(NULL, "register_shutdown_function", &_3, _1);
			zephir_check_call_status();
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, getOrCreateTransaction) {
	...
	HashTable *_2;
	HashPosition _1;
	zval *autoBegin_param = NULL, *dependencyInjector = NULL, *transaction = NULL, *transactions, *_0, **_3;
	zend_bool autoBegin;
	...
	if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_transaction_exception_ce, "A dependency injector container is required to obtain the services related to the ORM", "phalcon/mvc/model/transaction/manager.zep", 203);
		return;
	}
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_number"), PH_NOISY_CC);
	if (zephir_is_true(_0)) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_service"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(NULL, transaction, "__construct", NULL, dependencyInjector, (autoBegin ? ZEPHIR_GLOBAL(global_true) : ZEPHIR_GLOBAL(global_false)), _0);
	zephir_check_call_status();
