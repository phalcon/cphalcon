...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _34)
	{
		...
		ZEPHIR_CALL_METHOD(&_35$$37, this_ptr, "_getselectcolumn", &_36, 450, &column);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_46$$48, this_ptr, "_getexpression", NULL, 439, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_47$$49, this_ptr, "_getgroupclause", NULL, 451, &groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_48$$50, this_ptr, "_getexpression", NULL, 439, &having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_49$$51, this_ptr, "_getorderclause", NULL, 452, &order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_50$$52, this_ptr, "_getlimitclause", NULL, 453, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
	{
		...
		ZEPHIR_CALL_METHOD(&_5$$7, this_ptr, "_getexpression", &_7, 439, &exprValue, &_6$$7);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _3)
	{
		...
		ZEPHIR_CALL_METHOD(&_4$$15, this_ptr, "_getexpression", &_7, 439, &_5$$15, &_6$$15);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_10$$15, this_ptr, "_getexpression", &_7, 439, &exprColumn, &_11$$15);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_13$$16, 1);
		ZEPHIR_CALL_METHOD(&_12$$16, this_ptr, "_getexpression", &_7, 439, &where, &_13$$16);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_12$$16, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_14$$17, this_ptr, "_getlimitclause", NULL, 453, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_4$$12, 1);
		ZEPHIR_CALL_METHOD(&_3$$12, this_ptr, "_getexpression", NULL, 439, &where, &_4$$12);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_3$$12, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_5$$13, this_ptr, "_getlimitclause", NULL, 453, &limit);
		zephir_check_call_status();
	...
	if (!(isComplex)) {
		...
		if (_45$$47) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				...
				ZEPHIR_CALL_FUNCTION(&_49$$59, "is_subclass_of", NULL, 433, &resultsetClassName, &_48$$59);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 457, &simpleColumnMap, &resultObject, &resultData, &cache, &_55$$47);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	if (!(zephir_fast_count_int(&records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_17$$14, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 459, &_17$$14);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_20$$15))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_22$$16, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 459, &_22$$16, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
