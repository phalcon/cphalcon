...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute)
{
	...
	do {
		if (ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeselect", NULL, 496, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeinsert", NULL, 497, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeupdate", NULL, 498, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executedelete", NULL, 499, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$19, "__construct", NULL, 30, &_4$$19);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql)
{
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "executeselect", NULL, 496, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, parse)
{
	...
	if (Z_TYPE_P(&ast) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			...
			do {
				if (ZEPHIR_IS_LONG(&type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 500);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 501);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 502);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 503);
					zephir_check_call_status();
					break;
				}
				...
				ZEPHIR_CALL_METHOD(NULL, &_4$$13, "__construct", NULL, 30, &_5$$13);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeDelete)
{
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "getrelatedrecords", NULL, 504, &model, &intermediate, &bindParams, &bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	while (1) {
		...
		if (!(zephir_is_true(&_5$$6))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_7$$7, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_7$$7, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeInsert)
{
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _4, _5, _2)
		{
			...
			if (_18$$8) {
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_19$$15, "__construct", &_14, 30, &_20$$15);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				do {
					...
					if (ZEPHIR_IS_LONG(&_21$$17, 273) || ZEPHIR_IS_LONG(&_21$$17, 274) || ZEPHIR_IS_LONG(&_21$$17, 277)) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&insertValue, &bindParams, &wildcard, 0)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_27$$21, "__construct", &_14, 30, &_28$$21);
							zephir_check_call_status();
				...
				if (_31$$17) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_32$$24, "__construct", &_14, 30, &_33$$24);
						zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_34, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeSelect)
{
	...
	if (!(isComplex)) {
		...
		if (_90$$83) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				if (UNEXPECTED(!(zephir_class_exists(&resultsetClassName, 1)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_91$$98, "__construct", NULL, 30, &_92$$98);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_94$$97, "is_subclass_of", NULL, 488, &resultsetClassName, &_93$$97);
				zephir_check_call_status();
				if (UNEXPECTED(!zephir_is_true(&_94$$97))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_95$$99, "__construct", NULL, 30, &_96$$99);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 506, &simpleColumnMap, &resultObject, &resultData, &cache, &_98$$83);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 507, &columns1, &resultData, &cache);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeUpdate)
{
			...
			do {
				...
				if (ZEPHIR_IS_LONG(&_6$$5, 273) || ZEPHIR_IS_LONG(&_6$$5, 274) || ZEPHIR_IS_LONG(&_6$$5, 277)) {
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&updateValue, &bindParams, &wildcard, 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_12$$11, "__construct", &_14, 30, &_13$$11);
						zephir_check_call_status();
				...
				do {
					...
					if (ZEPHIR_IS_LONG(&_18$$14, 273) || ZEPHIR_IS_LONG(&_18$$14, 274) || ZEPHIR_IS_LONG(&_18$$14, 277)) {
						...
						if (UNEXPECTED(!(zephir_array_isset_fetch(&updateValue, &bindParams, &wildcard, 0)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_24$$20, "__construct", &_14, 30, &_25$$20);
							zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&field);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&records, this_ptr, "getrelatedrecords", NULL, 504, &model, &intermediate, &selectBindParams, &selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$23, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_28$$23);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_31$$24))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_33$$25, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_33$$25, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_35, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &_35);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getCallArgument)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getexpression", NULL, 508, &argument);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getCaseExpression)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getexpression", &_6, 508, &_5$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getexpression", &_6, 508, &_7$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "getexpression", &_6, 508, &_10$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "getexpression", &_6, 508, &_13$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "getexpression", &_6, 508, &_14$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "getexpression", &_6, 508, &_17$$8);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "getexpression", &_6, 508, &_19);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getExpression)
{
	...
	if (zephir_array_isset_string_fetch(&exprType, &expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, &expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "getexpression", NULL, 508, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, &expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "getexpression", NULL, 508, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getqualified", NULL, 509, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
					...
					do {
						...
						if (ZEPHIR_IS_STRING(&bindType, "array") || ZEPHIR_IS_STRING(&bindType, "array-str") || ZEPHIR_IS_STRING(&bindType, "array-int")) {
							...
							if (UNEXPECTED(!(zephir_array_isset_fetch(&bind, &_49$$43, &name, 0)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_50$$44, "__construct", NULL, 30, &_51$$44);
								zephir_check_call_status();
							...
							if (UNEXPECTED(Z_TYPE_P(&bind) != IS_ARRAY)) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_52$$45, "__construct", NULL, 30, &_53$$45);
								zephir_check_call_status();
							...
							if (UNEXPECTED(zephir_fast_count_int(&bind) < 1)) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_54$$46, "__construct", NULL, 30, &_55$$46);
								zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(NULL, &_58$$47, "__construct", NULL, 30, &_59$$47);
						zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG(&exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getfunctioncall", NULL, 510, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getcaseexpression", NULL, 511, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 309)) {
				...
				ZVAL_BOOL(&_83$$69, 1);
				ZEPHIR_CALL_METHOD(&_82$$69, this_ptr, "_prepareselect", NULL, 500, &expr, &_83$$69);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_84$$70, "__construct", NULL, 30, &_85$$70);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string(&expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualified", NULL, 509, &expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(&expr, 0)) {
		...
		if (Z_TYPE_P(&expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _86$$72)
			{
				...
				ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "getexpression", NULL, 508, &exprListItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_89$$74, this_ptr, "getexpression", NULL, 508, &exprListItem);
					zephir_check_call_status();
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "getexpression", &_3, 508, &groupItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "getexpression", &_3, 508, &groupItem);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "getexpression", &_3, 508, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getLimitClause)
{
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "getexpression", NULL, 508, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "getexpression", NULL, 508, &offset);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _1)
		{
			...
			if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
				...
				if (UNEXPECTED(zephir_array_isset(&joinModels, &alias))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$9, "__construct", &_8, 30, &_7$$9);
					zephir_check_call_status();
				...
				if (UNEXPECTED(zephir_array_isset(&joinModels, &realModelName))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_9$$11, "__construct", &_8, 30, &_11$$11);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
					...
					if (UNEXPECTED(zephir_array_isset(&joinModels, &alias))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_13$$14, "__construct", &_8, 30, &_15$$14);
						zephir_check_call_status();
					...
					if (UNEXPECTED(zephir_array_isset(&joinModels, &realModelName))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_16$$16, "__construct", &_8, 30, &_18$$16);
						zephir_check_call_status();
	...
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _21, _22, _19)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_23$$18, this_ptr, "getexpression", &_24, 508, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_25$$20, this_ptr, "getexpression", &_24, 508, &joinExpr);
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
							...
							if (Z_TYPE_P(&relations) == IS_ARRAY) {
								if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_52$$31, "__construct", &_8, 30, &_54$$31);
									zephir_check_call_status();
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_66$$45, "__construct", &_8, 30, &_68$$45);
										zephir_check_call_status();
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_82$$60, "__construct", &_8, 30, &_84$$60);
										zephir_check_call_status();
								...
								if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
									...
									if (Z_TYPE_P(&relations) == IS_ARRAY) {
										if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_94$$74, "__construct", &_8, 30, &_96$$74);
											zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getMultiJoin)
{
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _3$$3, _4$$3, _1$$3)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset(&referencedFields, &position)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$5, "__construct", &_8, 30, &_7$$5);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "getqualified", &_11, 509, &_10$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "getqualified", &_11, 509, &_12$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(!(zephir_array_isset(&referencedFields, &position)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_13$$7, "__construct", &_8, 30, &_15$$7);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "getqualified", &_11, 509, &_18$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "getqualified", &_11, 509, &_19$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 509, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 509, &_26$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 509, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("left"), &_24$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 509, &_28$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("right"), &_24$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_22$$8, &_23$$8);
		zephir_array_update_string(&_21$$8, SL("conditions"), &_22$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getOrderClause)
{
	...
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "getexpression", &_3, 508, &_2$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "getexpression", &_3, 508, &_8$$10);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getQualified)
{
	...
	if (zephir_array_isset_string_fetch(&columnDomain, &expr, SL("domain"), 0)) {
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0)))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_8$$7, "__construct", NULL, 30, &_10$$7);
			zephir_check_call_status();
		...
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&model, &sqlAliasesModelsInstances, &columnDomain, 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", NULL, 30, &_14$$9);
				zephir_check_call_status();
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_15$$12, "__construct", NULL, 30, &_17$$12);
				zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_18$$14), _19$$14)
			{
				...
				if (zephir_is_true(&_21$$15)) {
					...
					if (UNEXPECTED(number > 1)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_23$$17, "__construct", NULL, 30, &_25$$17);
						zephir_check_call_status();
				...
				zephir_check_call_status();
					...
					if (zephir_is_true(&_26$$18)) {
						...
						if (UNEXPECTED(number > 1)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_28$$20, "__construct", NULL, 30, &_30$$20);
							zephir_check_call_status();
		...
		if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&hasModel))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_31$$21, "__construct", NULL, 30, &_33$$21);
			zephir_check_call_status();
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &models, &className, 0)))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_35$$23, "__construct", NULL, 30, &_37$$23);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_38$$27, "__construct", NULL, 30, &_40$$27);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSelectColumn)
{
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		...
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0$$4), _3$$4, _4$$4, _1$$4)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_5$$5, "lcfirst", &_6, 101, &modelName);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_9$$7, "lcfirst", &_6, 101, &modelName);
					zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0)))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$11, "__construct", NULL, 30, &_14$$11);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&preparedAlias) != IS_STRING) {
			if (ZEPHIR_IS_EQUAL(&columnDomain, &modelName)) {
				ZEPHIR_CALL_FUNCTION(&preparedAlias, "lcfirst", &_6, 101, &modelName);
				zephir_check_call_status();
			} else {
	...
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "getexpression", NULL, 508, &columnData);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_19, "__construct", NULL, 30, &_20);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleJoin)
{
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getqualified", NULL, 509, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getqualified", NULL, 509, &_4$$3);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_12, 30, &_11$$6);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "getqualified", NULL, 509, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "getqualified", NULL, 509, &_16$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_17$$8, "__construct", &_12, 30, &_19$$8);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "getqualified", NULL, 509, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "getqualified", NULL, 509, &_23$$7);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete)
{
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_10$$17, 1);
		ZEPHIR_CALL_METHOD(&_9$$17, this_ptr, "getexpression", NULL, 508, &where, &_10$$17);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert)
{
	...
	if (Z_TYPE_P(&_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
		{
			...
			ZEPHIR_CALL_METHOD(&_7$$7, this_ptr, "getexpression", &_9, 508, &exprValue, &_8$$7);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "getexpression", &_9, 508, &exprValue, &_13$$8);
				zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _14$$9)
			{
				...
				if (UNEXPECTED(!zephir_is_true(&_16$$10))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_18$$11, "__construct", &_21, 30, &_20$$11);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!zephir_is_true(&_22$$12))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_24$$13, "__construct", &_21, 30, &_26$$13);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect)
{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectedModels), _2)
		{
			...
			if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
				if (UNEXPECTED(zephir_array_isset(&sqlAliases, &alias))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$17, "__construct", &_8, 30, &_7$$17);
					zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _10$$21)
					{
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_17$$27, "__construct", &_8, 30, &_19$$27);
								zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_29$$31, "__construct", &_8, 30, &_31$$31);
									zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
					if (UNEXPECTED(zephir_array_isset(&sqlAliases, &alias))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_38$$36, "__construct", &_8, 30, &_40$$36);
						zephir_check_call_status();
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _43$$40)
						{
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_50$$46, "__construct", &_8, 30, &_52$$46);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_62$$50, "__construct", &_8, 30, &_64$$50);
										zephir_check_call_status();
	...
	ZEPHIR_OBS_VAR(&where);
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_104$$92, this_ptr, "getexpression", NULL, 508, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_106$$94, this_ptr, "getexpression", NULL, 508, &having);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate)
{
	...
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _9)
		{
			...
			ZEPHIR_CALL_METHOD(&_11$$20, this_ptr, "getexpression", &_14, 508, &_12$$20, &_13$$20);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_17$$20, this_ptr, "getexpression", &_14, 508, &exprColumn, &_18$$20);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_19$$21, this_ptr, "getexpression", &_14, 508, &_20$$21, &_21$$21);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_24$$21, this_ptr, "getexpression", &_14, 508, &exprColumn, &_25$$21);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_27$$22, 1);
		ZEPHIR_CALL_METHOD(&_26$$22, this_ptr, "getexpression", &_14, 508, &where, &_27$$22);
		zephir_check_call_status();
