...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getQualified) {
	...
	if (zephir_array_isset_string_fetch(&columnDomain, expr, SS("domain"), 0 TSRMLS_CC)) {
		...
		if (!(zephir_array_isset_fetch(&source, sqlAliases, columnDomain, 0 TSRMLS_CC))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_0$$5, "phalcon/mvc/model/query.zep", 222 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
			...
			if (!(zephir_array_isset_fetch(&model, sqlAliasesModelsInstances, columnDomain, 0 TSRMLS_CC))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_3$$7, "phalcon/mvc/model/query.zep", 239 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		if (Z_TYPE_P(columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, columnMap, columnName, 0 TSRMLS_CC))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_6$$10, "phalcon/mvc/model/query.zep", 249 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
		...
		zephir_is_iterable(_9$$12, &_11$$12, &_10$$12, 0, 0, "phalcon/mvc/model/query.zep", 279);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_11$$12, &_10$$12)
			...
			if (zephir_is_true(_13$$13)) {
				...
				if (number > 1) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(_15$$15, "phalcon/mvc/model/query.zep", 270 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(hasModel)) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_18$$16, "phalcon/mvc/model/query.zep", 280 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (!(zephir_array_isset_fetch(&source, models, className, 0 TSRMLS_CC))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_21$$18, "phalcon/mvc/model/query.zep", 296 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
		...
		if (Z_TYPE_P(columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, columnMap, columnName, 0 TSRMLS_CC))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_24$$22, "phalcon/mvc/model/query.zep", 313 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getexpression", NULL, 282, argument);
	zephir_check_call_status();
	RETURN_MM();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (zephir_array_isset_string(whenExpr, SS("right"))) {
			...
			zephir_array_fetch_string(&_6$$4, whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 354 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "_getexpression", &_7, 282, _6$$4);
			zephir_check_call_status();
			zephir_array_update_string(&_4$$4, SL("expr"), &_5$$4, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_8$$4, whenExpr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 355 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "_getexpression", &_7, 282, _8$$4);
			zephir_check_call_status();
			zephir_array_update_string(&_4$$4, SL("then"), &_5$$4, PH_COPY | PH_SEPARATE);
			zephir_array_append(&whenClauses, _4$$4, PH_SEPARATE, "phalcon/mvc/model/query.zep", 356);
		} else {
			ZEPHIR_INIT_NVAR(_9$$5);
			zephir_create_array(_9$$5, 2, 0 TSRMLS_CC);
			add_assoc_stringl_ex(_9$$5, SS("type"), SL("else"), 1);
			zephir_array_fetch_string(&_11$$5, whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 360 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "_getexpression", &_7, 282, _11$$5);
			zephir_check_call_status();
			zephir_array_update_string(&_9$$5, SL("expr"), &_10$$5, PH_COPY | PH_SEPARATE);
			zephir_array_append(&whenClauses, _9$$5, PH_SEPARATE, "phalcon/mvc/model/query.zep", 361);
		}
	}
	zephir_create_array(return_value, 3, 0 TSRMLS_CC);
	add_assoc_stringl_ex(return_value, SS("type"), SL("case"), 1);
	zephir_array_fetch_string(&_13, expr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 367 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "_getexpression", &_7, 282, _13);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getFunctionCall) {
	...
	if (zephir_array_isset_string_fetch(&arguments, expr, SS("arguments"), 0 TSRMLS_CC)) {
		...
		if (zephir_array_isset_long(arguments, 0)) {
			...
			zephir_is_iterable(arguments, &_1$$6, &_0$$6, 0, 0, "phalcon/mvc/model/query.zep", 393);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_1$$6, &_0$$6)
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "_getcallargument", &_4, 283, argument);
				zephir_check_call_status();
				zephir_array_append(&functionArgs, _3$$7, PH_SEPARATE, "phalcon/mvc/model/query.zep", 391);
			}
		} else {
			zephir_create_array(functionArgs, 1, 0 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_5$$8, this_ptr, "_getcallargument", &_4, 283, arguments);
			zephir_check_call_status();
		...
		if (distinct) {
			...
			ZEPHIR_OBS_VAR(_6$$9);
			zephir_array_fetch_string(&_6$$9, expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 401 TSRMLS_CC);
			...
			zephir_array_fetch_string(&_8$$10, expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 408 TSRMLS_CC);
	...
	add_assoc_stringl_ex(return_value, SS("type"), SL("functionCall"), 1);
	ZEPHIR_OBS_VAR(_9);
	zephir_array_fetch_string(&_9, expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 417 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, expr, SS("type"), 0 TSRMLS_CC)) {
		...
		if (!ZEPHIR_IS_LONG(exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, expr, SS("left"), 0 TSRMLS_CC)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", &_1, 282, exprLeft, _0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, expr, SS("right"), 0 TSRMLS_CC)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", &_1, 282, exprRight, _2$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", &_3, 284, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(exprType, 258) || ZEPHIR_IS_LONG(exprType, 259) || ZEPHIR_IS_LONG(exprType, 414)) {
				...
				zephir_array_fetch_string(&_4$$25, expr, SL("value"), PH_NOISY, "phalcon/mvc/model/query.zep", 535 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(exprType, 273)) {
				...
				zephir_array_fetch_string(&_6$$33, expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 565 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(exprType, 274)) {
				...
				zephir_create_array(exprReturn, 2, 0 TSRMLS_CC);
				add_assoc_stringl_ex(exprReturn, SS("type"), SL("placeholder"), 1);
				zephir_array_fetch_string(&_9$$34, expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 569 TSRMLS_CC);
					...
					do {
						...
						if (ZEPHIR_IS_STRING(bindType, "array") || ZEPHIR_IS_STRING(bindType, "array-str") || ZEPHIR_IS_STRING(bindType, "array-int")) {
							...
							if (!(zephir_array_isset_fetch(&bind, _23$$43, name, 0 TSRMLS_CC))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(_24$$44, "phalcon/mvc/model/query.zep", 617 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (Z_TYPE_P(bind) != IS_ARRAY) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(_26$$45, "phalcon/mvc/model/query.zep", 621 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (zephir_fast_count_int(bind TSRMLS_CC) < 1) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(_28$$46, "phalcon/mvc/model/query.zep", 625 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							ZEPHIR_INIT_NVAR(exprReturn);
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(_31$$47, "phalcon/mvc/model/query.zep", 637 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					} while(0);
			...
			if (ZEPHIR_IS_LONG(exprType, 358)) {
				...
				zephir_array_fetch_string(&_34$$65, expr, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 710 TSRMLS_CC);
				zephir_array_update_string(&exprReturn, SL("value"), &_34$$65, PH_COPY | PH_SEPARATE);
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getfunctioncall", NULL, 285, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getcaseexpression", NULL, 286, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, 309)) {
				...
				ZVAL_BOOL(_36$$68, 1);
				ZEPHIR_CALL_METHOD(&_35$$68, this_ptr, "_prepareselect", NULL, 287, expr, _36$$68);
				zephir_check_call_status();
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_37$$69, "phalcon/mvc/model/query.zep", 726 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);
	...
	if (zephir_array_isset_string(expr, SS("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", &_3, 284, expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(expr, 0)) {
		...
		zephir_is_iterable(expr, &_40$$71, &_39$$71, 0, 0, "phalcon/mvc/model/query.zep", 747);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_40$$71, &_39$$71)
			...
			ZEPHIR_CALL_METHOD(&_42$$72, this_ptr, "_getexpression", &_1, 282, exprListItem);
			zephir_check_call_status();
			zephir_array_append(&listItems, _42$$72, PH_SEPARATE, "phalcon/mvc/model/query.zep", 745);
		}
		zephir_create_array(return_value, 2, 0 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(columnType, 352)) {
		...
		zephir_is_iterable(_0$$4, &_2$$4, &_1$$4, 0, 0, "phalcon/mvc/model/query.zep", 794);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_2$$4, &_1$$4)
			...
			if (Z_TYPE_P(eager) != IS_NULL) {
				...
				zephir_array_fetch_string(&_6$$6, column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 789 TSRMLS_CC);
	...
	if (ZEPHIR_IS_LONG(columnType, 353)) {
		...
		if (!(zephir_array_isset_fetch(&source, sqlAliases, columnDomain, 0 TSRMLS_CC))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(_7$$9, "phalcon/mvc/model/query.zep", 814 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (Z_TYPE_P(eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_10$$13, column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 854 TSRMLS_CC);
	...
	if (ZEPHIR_IS_LONG(columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "_getexpression", NULL, 282, columnData);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_11$$16, column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 884 TSRMLS_CC);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(_12, "phalcon/mvc/model/query.zep", 893 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoin) {
	...
	if (zephir_array_isset_string_fetch(&qualified, join, SS("qualified"), 0 TSRMLS_CC)) {
		zephir_array_fetch_string(&_0$$3, qualified, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 932 TSRMLS_CC);
		if (ZEPHIR_IS_LONG(_0$$3, 355)) {
			...
			if (zephir_memnstr_str(modelName, SL(":"), "phalcon/mvc/model/query.zep", 936)) {
				...
				zephir_array_fetch_long(&_2$$5, nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 938 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_1$$5, manager, "getnamespacealias", NULL, 0, _2$$5);
				zephir_check_call_status();
				zephir_array_fetch_long(&_3$$5, nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 938 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	if (Z_TYPE_P(fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "_getqualified", &_3, 284, _2$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "_getqualified", &_3, 284, _4$$3);
		zephir_check_call_status();
		...
		zephir_is_iterable(fields, &_6$$4, &_5$$4, 0, 0, "phalcon/mvc/model/query.zep", 1079);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_6$$4, &_5$$4)
			...
			ZEPHIR_CALL_METHOD(&_13$$5, this_ptr, "_getqualified", &_3, 284, _14$$5);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_13$$5, this_ptr, "_getqualified", &_3, 284, _15$$5);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getMultiJoin) {
	...
	zephir_check_call_status();
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		zephir_is_iterable(fields, &_1$$3, &_0$$3, 0, 0, "phalcon/mvc/model/query.zep", 1204);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
			...
			if (!(zephir_array_isset(referencedFields, position))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_3$$5, "phalcon/mvc/model/query.zep", 1175 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
			...
			ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "_getqualified", &_9, 284, _8$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "_getqualified", &_9, 284, _10$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 284, _15$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 284, _16$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 284, _17$$6);
		zephir_check_call_status();
		zephir_array_update_string(&_13$$6, SL("left"), &_14$$6, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 284, _18$$6);
		zephir_check_call_status();
		zephir_array_update_string(&_13$$6, SL("right"), &_14$$6, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(_12$$6, _13$$6);
		zephir_array_update_string(&_11$$6, SL("conditions"), &_12$$6, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_3, 288, manager, joinItem);
		zephir_check_call_status();
		ZEPHIR_OBS_NVAR(source);
		...
		ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_4, 289, joinItem);
		zephir_check_call_status();
		...
		if (zephir_array_isset_string_fetch(&aliasExpr, joinItem, SS("alias"), 0 TSRMLS_CC)) {
			...
			if (zephir_array_isset(joinModels, alias)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_5$$9, "phalcon/mvc/model/query.zep", 1337 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
			...
			if (zephir_array_isset(joinModels, realModelName)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_9$$11, "phalcon/mvc/model/query.zep", 1396 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
	...
	zephir_is_iterable(joinPrepared, &_13, &_12, 0, 0, "phalcon/mvc/model/query.zep", 1471);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_13, &_12)
		...
		if (zephir_array_isset_string_fetch(&joinExpr, joinItem, SS("conditions"), 0 TSRMLS_CC)) {
			ZEPHIR_CALL_METHOD(&_15$$13, this_ptr, "_getexpression", &_16, 282, joinExpr);
			zephir_check_call_status();
	...
	if (!(zephir_is_true(_17))) {
		...
		zephir_is_iterable(joinPrepared, &_20$$14, &_19$$14, 0, 0, "phalcon/mvc/model/query.zep", 1482);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_20$$14, &_19$$14)
			...
			zephir_array_append(&sqlJoins, _22$$15, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1480);
		}
		RETURN_CCTOR(sqlJoins);
	}
	ZEPHIR_INIT_NVAR(fromModels);
	array_init(fromModels);
	zephir_is_iterable(selectTables, &_25, &_24, 0, 0, "phalcon/mvc/model/query.zep", 1496);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_25, &_24)
		...
		zephir_array_fetch_string(&_27$$16, tableItem, SL("qualifiedName"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1490 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(_28$$16);
		zephir_array_fetch_string(&_28$$16, _27$$16, SL("name"), PH_NOISY, "phalcon/mvc/model/query.zep", 1490 TSRMLS_CC);
		zephir_array_update_zval(&fromModels, _28$$16, &ZEPHIR_GLOBAL(global_true), PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_INIT_VAR(_29);
	zephir_is_iterable(fromModels, &_31, &_30, 0, 0, "phalcon/mvc/model/query.zep", 1602);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_31, &_30)
		...
		zephir_is_iterable(joinModels, &_34$$17, &_33$$17, 0, 0, "phalcon/mvc/model/query.zep", 1600);
		for (
			...
			if (!(zephir_array_isset_fetch(&preCondition, joinPreCondition, joinAlias, 0 TSRMLS_CC))) {
				...
				if (ZEPHIR_IS_FALSE_IDENTICAL(relation)) {
					...
					if (Z_TYPE_P(relations) == IS_ARRAY) {
						if (zephir_fast_count_int(relations TSRMLS_CC) != 1) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(_38$$22, "phalcon/mvc/model/query.zep", 1536 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
				...
				if (Z_TYPE_P(relation) == IS_OBJECT) {
					...
					if (!(zephir_is_true(_41$$23))) {
						ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_42, 290, joinType, joinSource, modelAlias, joinAlias, relation);
						zephir_check_call_status();
					} else {
						ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_43, 291, joinType, joinSource, modelAlias, joinAlias, relation);
						zephir_check_call_status();
					}
					if (zephir_array_isset_long(sqlJoin, 0)) {
						zephir_is_iterable(sqlJoin, &_45$$26, &_44$$26, 0, 0, "phalcon/mvc/model/query.zep", 1572);
						for (
					...
					zephir_array_append(&sqlJoins, _47$$29, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1585);
				}
			} else {
				...
				zephir_array_append(&sqlJoins, _49$$30, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1597);
			}
		}
	}
	RETURN_CCTOR(sqlJoins);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		zephir_array_fetch_string(&_3$$5, orderItem, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1625 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_4, 282, _3$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getGroupClause) {
	...
	if (zephir_array_isset_long(group, 0)) {
		...
		zephir_is_iterable(group, &_1$$3, &_0$$3, 0, 0, "phalcon/mvc/model/query.zep", 1661);
		for (
		  ; zephir_hash_get_current_data_ex(_1$$3, (void**) &_2$$3, &_0$$3) == SUCCESS
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
		) {
			ZEPHIR_GET_HVALUE(groupItem, _2$$3);
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "_getexpression", &_4, 282, groupItem);
			zephir_check_call_status();
			zephir_array_append(&groupParts, _3$$4, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1659);
		}
	} else {
		zephir_create_array(groupParts, 1, 0 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_5$$5, this_ptr, "_getexpression", &_4, 282, group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, limitClause, SS("number"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", &_1, 282, number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, limitClause, SS("offset"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_1, 282, offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_memnstr_str(modelName, SL(":"), "phalcon/mvc/model/query.zep", 1799)) {
			...
			zephir_fast_explode_str(nsAlias, SL(":"), modelName, LONG_MAX TSRMLS_CC);
			zephir_array_fetch_long(&_4$$15, nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1801 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_3$$15, manager, "getnamespacealias", &_5, 0, _4$$15);
			zephir_check_call_status();
			zephir_array_fetch_long(&_6$$15, nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1801 TSRMLS_CC);
		...
		if (zephir_array_isset_string_fetch(&alias, selectedModel, SS("alias"), 0 TSRMLS_CC)) {
			if (zephir_array_isset(sqlAliases, alias)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_9$$20, "phalcon/mvc/model/query.zep", 1825 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
			zephir_array_update_zval(&sqlAliases, alias, &alias, PH_COPY | PH_SEPARATE);
		...
		if (zephir_array_isset_string_fetch(&with, selectedModel, SS("with"), 0 TSRMLS_CC)) {
			...
			zephir_is_iterable(withs, &_14$$24, &_13$$24, 0, 0, "phalcon/mvc/model/query.zep", 1905);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_14$$24, &_13$$24)
				...
				if (Z_TYPE_P(relation) == IS_OBJECT) {
					...
					if (Z_TYPE_P(relation) == IS_OBJECT) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(_22$$31, "phalcon/mvc/model/query.zep", 1879 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
				...
				zephir_array_append(&selectColumns, _25$$27, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1889);
				...
				zephir_array_append(&automaticJoins, _26$$27, PH_SEPARATE, "phalcon/mvc/model/query.zep", 1901);
				number++;
			}
		}
	...
	if (zephir_fast_count_int(joins TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "_getjoins", &_41, 292, select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(automaticJoins TSRMLS_CC)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	zephir_is_iterable(selectColumns, &_43, &_42, 0, 0, "phalcon/mvc/model/query.zep", 1998);
	for (
	  ; zephir_hash_get_current_data_ex(_43, (void**) &_44, &_42) == SUCCESS
	  ; zephir_hash_move_forward_ex(_43, &_42)
	) {
		ZEPHIR_GET_HVALUE(column, _44);
		ZEPHIR_CALL_METHOD(&_45$$41, this_ptr, "_getselectcolumn", &_46, 293, column);
		zephir_check_call_status();
		zephir_is_iterable(_45$$41, &_48$$41, &_47$$41, 0, 0, "phalcon/mvc/model/query.zep", 1997);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_48$$41, &_47$$41)
			...
			if (zephir_array_isset_string_fetch(&alias, column, SS("alias"), 0 TSRMLS_CC)) {
				...
				if (zephir_array_isset_string_fetch(&alias, sqlColumn, SS("balias"), 0 TSRMLS_CC)) {
					...
					zephir_array_fetch_string(&_50$$46, sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 1987 TSRMLS_CC);
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_53$$51, this_ptr, "_getexpression", &_54, 282, where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SS("groupBy"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_55$$52, this_ptr, "_getgroupclause", NULL, 294, groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SS("having"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_56$$53, this_ptr, "_getexpression", &_54, 282, having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SS("orderBy"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_57$$54, this_ptr, "_getorderclause", NULL, 295, order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_58$$55, this_ptr, "_getlimitclause", NULL, 296, limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	if (zephir_memnstr_str(modelName, SL(":"), "phalcon/mvc/model/query.zep", 2088)) {
		ZEPHIR_INIT_VAR(nsAlias);
		zephir_fast_explode_str(nsAlias, SL(":"), modelName, LONG_MAX TSRMLS_CC);
		zephir_array_fetch_long(&_1$$6, nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2090 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_0$$6, manager, "getnamespacealias", NULL, 0, _1$$6);
		zephir_check_call_status();
		zephir_array_fetch_long(&_2$$6, nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2090 TSRMLS_CC);
		ZEPHIR_INIT_VAR(realModelName);
	...
	zephir_array_fetch_string(&_4, ast, SL("values"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2106 TSRMLS_CC);
	zephir_is_iterable(_4, &_6, &_5, 0, 0, "phalcon/mvc/model/query.zep", 2115);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_6, &_5)
		...
		zephir_array_fetch_string(&_9$$9, exprValue, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2110 TSRMLS_CC);
		...
		ZEPHIR_CALL_METHOD(&_10$$9, this_ptr, "_getexpression", &_12, 282, exprValue, _11$$9);
		zephir_check_call_status();
		zephir_array_update_string(&_8$$9, SL("value"), &_10$$9, PH_COPY | PH_SEPARATE);
		zephir_array_append(&exprValues, _8$$9, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2112);
	}
	...
	if (zephir_array_isset_string_fetch(&fields, ast, SS("fields"), 0 TSRMLS_CC)) {
		...
		zephir_is_iterable(fields, &_14$$10, &_13$$10, 0, 0, "phalcon/mvc/model/query.zep", 2137);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_14$$10, &_13$$10)
			...
			if (!(zephir_is_true(_16$$11))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_18$$12, "phalcon/mvc/model/query.zep", 2130 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_memnstr_str(modelName, SL(":"), "phalcon/mvc/model/query.zep", 2198)) {
			ZEPHIR_INIT_NVAR(nsAlias);
			zephir_fast_explode_str(nsAlias, SL(":"), modelName, LONG_MAX TSRMLS_CC);
			zephir_array_fetch_long(&_4$$9, nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2200 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_3$$9, manager, "getnamespacealias", &_5, 0, _4$$9);
			zephir_check_call_status();
			zephir_array_fetch_long(&_6$$9, nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2200 TSRMLS_CC);
			ZEPHIR_INIT_NVAR(realModelName);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_10, &_9)
		...
		zephir_array_fetch_string(&_13$$17, updateValue, SL("column"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2260 TSRMLS_CC);
		...
		ZEPHIR_CALL_METHOD(&_12$$17, this_ptr, "_getexpression", &_15, 282, _13$$17, _14$$17);
		zephir_check_call_status();
		zephir_array_append(&sqlFields, _12$$17, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2260);
		...
		zephir_array_fetch_string(&_17$$17, exprColumn, SL("type"), PH_NOISY, "phalcon/mvc/model/query.zep", 2263 TSRMLS_CC);
		...
		ZEPHIR_CALL_METHOD(&_18$$17, this_ptr, "_getexpression", &_15, 282, exprColumn, _19$$17);
		zephir_check_call_status();
		zephir_array_update_string(&_16$$17, SL("value"), &_18$$17, PH_COPY | PH_SEPARATE);
		zephir_array_append(&sqlValues, _16$$17, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2265);
	}
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		ZEPHIR_INIT_VAR(_21$$18);
		ZVAL_BOOL(_21$$18, 1);
		ZEPHIR_CALL_METHOD(&_20$$18, this_ptr, "_getexpression", &_15, 282, where, _21$$18);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_20$$18, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_22$$19, this_ptr, "_getlimitclause", NULL, 296, limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_memnstr_str(modelName, SL(":"), "phalcon/mvc/model/query.zep", 2334)) {
			ZEPHIR_INIT_NVAR(nsAlias);
			zephir_fast_explode_str(nsAlias, SL(":"), modelName, LONG_MAX TSRMLS_CC);
			zephir_array_fetch_long(&_4$$8, nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2336 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&_3$$8, manager, "getnamespacealias", &_5, 0, _4$$8);
			zephir_check_call_status();
			zephir_array_fetch_long(&_6$$8, nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2336 TSRMLS_CC);
			ZEPHIR_INIT_NVAR(realModelName);
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		...
		ZVAL_BOOL(_10$$14, 1);
		ZEPHIR_CALL_METHOD(&_9$$14, this_ptr, "_getexpression", NULL, 282, where, _10$$14);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_9$$14, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_11$$15, this_ptr, "_getlimitclause", NULL, 296, limit);
		zephir_check_call_status();
		...
		if (zephir_array_isset_string_fetch(&uniqueId, ast, SS("id"), 0 TSRMLS_CC)) {
			...
			if (zephir_array_isset_fetch(&irPhql, _0$$5, uniqueId, 0 TSRMLS_CC)) {
				if (Z_TYPE_P(irPhql) == IS_ARRAY) {
					zephir_array_fetch_string(&_1$$7, ast, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2425 TSRMLS_CC);
		...
		if (zephir_array_isset_string_fetch(&type, ast, SS("type"), 0 TSRMLS_CC)) {
			...
			do {
				if (ZEPHIR_IS_LONG(type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 287);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 297);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 298);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 299);
					zephir_check_call_status();
					break;
				}
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(_2$$13, "phalcon/mvc/model/query.zep", 2458 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			} while(0);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeSelect) {
	...
	zval *_22$$27 = NULL, *_30$$30 = NULL, *_45$$60 = NULL, *_50$$62 = NULL;
	HashTable *_1, *_8, *_12, *_20$$24, *_28$$29, *_33$$37, *_37$$43, *_43$$59, *_48$$61;
	HashPosition _0, _7, _11, _19$$24, _27$$29, _32$$37, _36$$43, _42$$59, _47$$61;
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_8, &_7)
		...
		zephir_array_fetch_string(&_10$$9, column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2551 TSRMLS_CC);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_12, &_11)
		...
		zephir_array_fetch_string(&_14$$21, column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2589 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(_14$$21, "object")) {
			...
			if (isComplex == 1) {
				...
				zephir_is_iterable(attributes, &_20$$24, &_19$$24, 0, 0, "phalcon/mvc/model/query.zep", 2617);
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_20$$24, &_19$$24)
					...
					zephir_array_append(&selectColumns, _22$$27, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2613);
				}
				...
				zephir_is_iterable(attributes, &_28$$29, &_27$$29, 0, 0, "phalcon/mvc/model/query.zep", 2635);
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_28$$29, &_27$$29)
					...
					zephir_array_append(&selectColumns, _30$$30, PH_SEPARATE, "phalcon/mvc/model/query.zep", 2633);
				}
			}
		} else {
	...
	if (Z_TYPE_P(bindParams) == IS_ARRAY) {
		...
		zephir_is_iterable(bindParams, &_33$$37, &_32$$37, 0, 0, "phalcon/mvc/model/query.zep", 2682);
		for (
	...
	if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
		...
		zephir_is_iterable(bindTypes, &_37$$43, &_36$$43, 0, 0, "phalcon/mvc/model/query.zep", 2698);
		for (
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_40, result, "numrows", NULL, 0, result);
	zephir_check_call_status();
		...
		if (isSimpleStd == 1) {
			...
			if (!(ZEPHIR_GLOBAL(orm).cast_on_hydrate)) {
				...
				if (Z_TYPE_P(columnMap) == IS_NULL) {
					array_init(simpleColumnMap);
					ZEPHIR_CALL_METHOD(&_41$$59, metaData, "getattributes", NULL, 0, model);
					zephir_check_call_status();
					zephir_is_iterable(_41$$59, &_43$$59, &_42$$59, 0, 0, "phalcon/mvc/model/query.zep", 2781);
					for (
					  ; zephir_hash_get_current_data_ex(_43$$59, (void**) &_44$$59, &_42$$59) == SUCCESS
					  ; zephir_hash_move_forward_ex(_43$$59, &_42$$59)
					) {
						ZEPHIR_GET_HVALUE(attribute, _44$$59);
						ZEPHIR_INIT_NVAR(_45$$60);
						zephir_create_array(_45$$60, 2, 0 TSRMLS_CC);
						zephir_array_fast_append(_45$$60, attribute);
						ZEPHIR_OBS_NVAR(_46$$60);
						zephir_array_fetch(&_46$$60, typesColumnMap, attribute, PH_NOISY, "phalcon/mvc/model/query.zep", 2779 TSRMLS_CC);
						zephir_array_fast_append(_45$$60, _46$$60);
						zephir_array_update_zval(&simpleColumnMap, attribute, &_45$$60, PH_COPY | PH_SEPARATE);
					}
				} else {
					array_init(simpleColumnMap);
					zephir_is_iterable(columnMap, &_48$$61, &_47$$61, 0, 0, "phalcon/mvc/model/query.zep", 2786);
					for (
					  ; zephir_hash_get_current_data_ex(_48$$61, (void**) &_49$$61, &_47$$61) == SUCCESS
					  ; zephir_hash_move_forward_ex(_48$$61, &_47$$61)
					) {
						ZEPHIR_GET_HMKEY(column, _48$$61, _47$$61);
						ZEPHIR_GET_HVALUE(attribute, _49$$61);
						ZEPHIR_INIT_NVAR(_50$$62);
						zephir_create_array(_50$$62, 2, 0 TSRMLS_CC);
						zephir_array_fast_append(_50$$62, attribute);
						ZEPHIR_OBS_NVAR(_51$$62);
						zephir_array_fetch(&_51$$62, typesColumnMap, column, PH_NOISY, "phalcon/mvc/model/query.zep", 2784 TSRMLS_CC);
						zephir_array_fast_append(_50$$62, _51$$62);
						zephir_array_update_zval(&simpleColumnMap, column, &_50$$62, PH_COPY | PH_SEPARATE);
					}
				}
			}
			ZEPHIR_CALL_METHOD(&_52$$54, manager, "iskeepingsnapshots", NULL, 0, model);
			zephir_check_call_status();
			isKeepingSnapshots = zephir_get_boolval(_52$$54);
		}
		object_init_ex(return_value, phalcon_mvc_model_resultset_simple_ce);
		ZEPHIR_INIT_VAR(_53$$52);
		if (isKeepingSnapshots) {
			ZVAL_BOOL(_53$$52, 1);
		} else {
			ZVAL_BOOL(_53$$52, 0);
		}
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 300, simpleColumnMap, resultObject, resultData, cache, _53$$52);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 301, columns1, resultData, cache);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		zephir_array_fetch_string(&_5$$11, value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 2877 TSRMLS_CC);
		do {
			...
			if (ZEPHIR_IS_LONG(_5$$11, 273) || ZEPHIR_IS_LONG(_5$$11, 274) || ZEPHIR_IS_LONG(_5$$11, 277)) {
				...
				if (!(zephir_array_isset_fetch(&insertValue, bindParams, wildcard, 0 TSRMLS_CC))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(_11$$16, "phalcon/mvc/model/query.zep", 2899 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				break;
		...
		if (automaticFields == 1) {
			if (Z_TYPE_P(columnMap) == IS_ARRAY) {
				...
				if (!(zephir_array_isset_fetch(&attributeName, columnMap, fieldName, 0 TSRMLS_CC))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(_17$$20, "phalcon/mvc/model/query.zep", 2917 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 302, _20, insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		zephir_array_fetch_string(&_5$$8, value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/mvc/model/query.zep", 3008 TSRMLS_CC);
		do {
			...
			if (ZEPHIR_IS_LONG(_5$$8, 273) || ZEPHIR_IS_LONG(_5$$8, 274) || ZEPHIR_IS_LONG(_5$$8, 277)) {
				...
				if (zephir_array_isset_fetch(&updateValue, bindParams, wildcard, 0 TSRMLS_CC)) {
					...
					ZEPHIR_CALL_METHOD(NULL, _11$$16, "__construct", &_13, 9, _12$$16);
					zephir_check_call_status();
					zephir_throw_exception_debug(_11$$16, "phalcon/mvc/model/query.zep", 3033 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				break;
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 303, model, intermediate, selectBindParams, selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZEPHIR_INIT_VAR(_17$$19);
		ZVAL_BOOL(_17$$19, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 302, _17$$19);
		zephir_check_call_status();
		RETURN_MM();
	}
	if ((zephir_method_exists_ex(model, SS("selectwriteconnection") TSRMLS_CC) == SUCCESS)) {
	...
	for (;_19->funcs->valid(_19 TSRMLS_CC) == SUCCESS && !EG(exception); _19->funcs->move_forward(_19 TSRMLS_CC)) {
		...
		if (!(zephir_is_true(_20$$23))) {
			...
			ZVAL_BOOL(_22$$24, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 302, _22$$24, record);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	...
	ZEPHIR_INIT_VAR(_23);
	ZVAL_BOOL(_23, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 302, _23);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 303, model, intermediate, bindParams, bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZEPHIR_INIT_VAR(_2$$5);
		ZVAL_BOOL(_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 302, _2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	if ((zephir_method_exists_ex(model, SS("selectwriteconnection") TSRMLS_CC) == SUCCESS)) {
	...
	for (;_4->funcs->valid(_4 TSRMLS_CC) == SUCCESS && !EG(exception); _4->funcs->move_forward(_4 TSRMLS_CC)) {
		...
		if (!(zephir_is_true(_5$$9))) {
			...
			ZVAL_BOOL(_7$$10, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 302, _7$$10, record);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	...
	ZEPHIR_INIT_VAR(_8);
	ZVAL_BOOL(_8, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 302, _8);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_CALL_METHOD(NULL, query, "__construct", NULL, 304);
	zephir_check_call_status();
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("_dependencyInjector"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(NULL, query, "setdi", NULL, 305, _5);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
	ZVAL_LONG(_2, 309);
	ZEPHIR_CALL_METHOD(NULL, query, "settype", NULL, 306, _2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, query, "setintermediate", NULL, 307, selectIr);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(query, "execute", NULL, 308, bindParams, bindTypes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	do {
		if (ZEPHIR_IS_LONG(type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeselect", NULL, 309, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeinsert", NULL, 310, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeupdate", NULL, 311, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executedelete", NULL, 312, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_4$$27, "phalcon/mvc/model/query.zep", 3363 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleResult) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "execute", NULL, 308, bindParams, bindTypes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	if (ZEPHIR_IS_LONG(_0, 309)) {
		...
		ZVAL_BOOL(_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 309, intermediate, _1$$3, _2$$3, _3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
