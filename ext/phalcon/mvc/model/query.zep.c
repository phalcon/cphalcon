...
PHP_METHOD(Phalcon_Mvc_Model_Query, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1051, &phql_zv);
	...
	if (zephir_array_isset_string_fetch(&enableImplicitJoins, &options, SL("enable_implicit_joins"), 0)) {
		if (ZEPHIR_IS_TRUE(&enableImplicitJoins)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1052, &__$true);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1052, &__$false);
		}
	} else {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1052, &_0$$5);
	}
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1053, &_2);
	ZEPHIR_INIT_VAR(&_3);
	array_init(&_3);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1054, &_3);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, cache)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1055, &cacheOptions);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute)
{
	...
	if (Z_TYPE_P(&cacheOptions) != IS_NULL) {
		...
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_2, 1057, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1058, &cache);
	}
	ZEPHIR_CALL_METHOD(&intermediate, this_ptr, "parse", NULL, 0);
	zephir_check_call_status();
	zephir_memory_observe(&defaultBindParams);
	zephir_read_property_cached(&defaultBindParams, this_ptr, _zephir_prop_4, 1053, PH_NOISY_CC);
	ZEPHIR_INIT_VAR(&mergedParams);
	zephir_add_function(&mergedParams, &defaultBindParams, &bindParams);
	zephir_memory_observe(&defaultBindTypes);
	zephir_read_property_cached(&defaultBindTypes, this_ptr, _zephir_prop_5, 1054, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql)
{
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_2, 1054, PH_NOISY_CC | PH_READONLY);
		ZVAL_BOOL(&_3$$3, 1);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, parse)
{
	...
	if (Z_TYPE_P(&ast) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&uniqueId, &ast, SL("id"), 0)) {
			...
			if (zephir_array_isset_fetch(&irPhql, &_1$$5, &uniqueId, 0)) {
				if (Z_TYPE_P(&irPhql) == IS_ARRAY) {
					...
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1059, &_2$$7);
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1061, &ast);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1059, &type);
			do {
				if (ZEPHIR_IS_LONG(&type, 309)) {
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1060, &irPhql);
	RETURN_CCTOR(&irPhql);
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setBindParams)
{
	...
	if (merge) {
		...
		zephir_read_property_cached(&currentBindParams, this_ptr, _zephir_prop_0, 1053, PH_NOISY_CC);
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_add_function(&_0$$3, &currentBindParams, &bindParams);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1053, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1053, &bindParams);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setBindTypes)
{
	...
	if (UNEXPECTED(merge)) {
		...
		zephir_read_property_cached(&currentBindTypes, this_ptr, _zephir_prop_0, 1054, PH_NOISY_CC);
		if (Z_TYPE_P(&currentBindTypes) == IS_ARRAY) {
			ZEPHIR_INIT_VAR(&_0$$4);
			zephir_add_function(&_0$$4, &currentBindTypes, &bindTypes);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1054, &_0$$4);
		} else {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1054, &bindTypes);
		}
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1054, &bindTypes);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1062, &manager);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1063, &metaData);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1057, container);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setIntermediate)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1060, &intermediate);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setSharedLock)
{
	...
	if (sharedLock) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1064, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1064, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setTransaction)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1065, transaction);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, setType)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, type);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1059, &_0);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeDelete)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 1067, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_1, &modelName, 0))) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 1062, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeInsert)
{
	...
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_2, 1063, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeSelect)
{
	...
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&models), _1)
		{
			...
			zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 1067, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&model);
				zephir_read_property_cached(&_13$$9, this_ptr, _zephir_prop_1, 1067, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columns), _28, _29, _27)
		{
			...
			if (ZEPHIR_IS_STRING(&_30$$32, "object")) {
				...
				zephir_read_property_cached(&_31$$33, this_ptr, _zephir_prop_1, 1067, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_58$$50, "object")) {
					...
					zephir_array_fetch_string(&modelName, &column, SL("model"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1195);
					ZEPHIR_OBS_NVAR(&instance);
					zephir_read_property_cached(&_59$$51, this_ptr, _zephir_prop_1, 1067, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_110, this_ptr, _zephir_prop_4, 1058, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&cache, &_110);
	if (!(isComplex)) {
		if (isSimpleStd) {
			zephir_read_property_cached(&_111$$92, this_ptr, _zephir_prop_5, 1066, PH_NOISY_CC | PH_READONLY);
			if (!ZEPHIR_IS_STRING_IDENTICAL(&_111$$92, "")) {
				zephir_read_property_cached(&_112$$93, this_ptr, _zephir_prop_5, 1066, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_110, this_ptr, _zephir_prop_5, 1066, PH_NOISY_CC | PH_READONLY);
				...
				if (zephir_memnstr_str(&value, SL(":"), "phalcon/Mvc/Model/Query.zep", 2106)) {
					...
					do {
						...
						if (ZEPHIR_IS_STRING(&bindType, "array") || ZEPHIR_IS_STRING(&bindType, "array-str") || ZEPHIR_IS_STRING(&bindType, "array-int")) {
							...
							zephir_read_property_cached(&_58$$52, this_ptr, _zephir_prop_0, 1053, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getJoinType)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1051, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getJoins)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1070, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sqlAliasesModels, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 1071, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sqlModelsAliases, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 1072, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sqlAliasesModelsInstances, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_5, 1067, PH_NOISY_CC | PH_READONLY);
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _1)
		{
			...
			if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
				...
				if (UNEXPECTED(zephir_array_isset_value(&joinModels, &alias))) {
					...
					zephir_read_property_cached(&_5$$9, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
				...
				if (UNEXPECTED(zephir_array_isset_value(&joinModels, &realModelName))) {
					...
					zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
					...
					if (UNEXPECTED(zephir_array_isset_value(&joinModels, &alias))) {
						...
						zephir_read_property_cached(&_13$$14, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
					...
					if (UNEXPECTED(zephir_array_isset_value(&joinModels, &realModelName))) {
						...
						zephir_read_property_cached(&_15$$16, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&joinItem);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1068, &models);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1069, &sqlAliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1070, &sqlAliasesModels);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1071, &sqlModelsAliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1072, &sqlAliasesModelsInstances);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1067, &modelsInstances);
	...
	ZEPHIR_INIT_NVAR(&joinItem);
	ZEPHIR_INIT_NVAR(&joinAliasName);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_8, 1052, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_0))) {
					...
					if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
						...
						if (Z_TYPE_P(&relations) == IS_ARRAY) {
							if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
								...
								zephir_read_property_cached(&_44$$28, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
						...
						if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
							...
							if (Z_TYPE_P(&relations) == IS_ARRAY) {
								if (UNEXPECTED(zephir_fast_count_int(&relations) != 1)) {
									...
									zephir_read_property_cached(&_64$$43, this_ptr, _zephir_prop_7, 1051, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _2$$3, _3$$3, _1$$3)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset_value(&referencedFields, &position)))) {
					...
					zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_1, 1051, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(!(zephir_array_isset_value(&referencedFields, &position)))) {
						...
						zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_1, 1051, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getQualified)
{
	...
	if (zephir_array_isset_value(&_0, &nestingLevel)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 1074, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 1063, PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_array_isset_string_fetch(&columnDomain, &expr, SL("domain"), 0)) {
		zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_3, 1069, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0)))) {
			...
			zephir_read_property_cached(&_9$$7, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_is_true(&_11$$6)) {
			zephir_read_property_cached(&_13$$8, this_ptr, _zephir_prop_5, 1072, PH_NOISY_CC | PH_READONLY);
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&model, &sqlAliasesModelsInstances, &columnDomain, 0)))) {
				...
				zephir_read_property_cached(&_15$$9, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0)))) {
				...
				zephir_read_property_cached(&_17$$12, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_18$$14, this_ptr, _zephir_prop_6, 1067, PH_NOISY_CC | PH_READONLY);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_18$$14), _19$$14)
			{
				...
				if (zephir_is_true(&_20$$15)) {
					...
					if (UNEXPECTED(number > 1)) {
						...
						zephir_read_property_cached(&_23$$17, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
				...
				zephir_check_call_status();
					...
					if (zephir_is_true(&_27$$18)) {
						...
						if (UNEXPECTED(number > 1)) {
							...
							zephir_read_property_cached(&_30$$20, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&hasModel))) {
			...
			zephir_read_property_cached(&_32$$21, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_34$$14, this_ptr, _zephir_prop_7, 1068, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &models, &className, 0)))) {
			...
			zephir_read_property_cached(&_37$$23, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0)))) {
				...
				zephir_read_property_cached(&_41$$27, this_ptr, _zephir_prop_4, 1051, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getRelatedRecords)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1057, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSelectColumn)
{
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		zephir_read_property_cached(&_1$$4, this_ptr, _zephir_prop_0, 1068, PH_NOISY_CC | PH_READONLY);
	...
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		zephir_read_property_cached(&_18$$10, this_ptr, _zephir_prop_1, 1069, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0)))) {
			...
			zephir_read_property_cached(&_20$$11, this_ptr, _zephir_prop_2, 1051, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_18$$10, this_ptr, _zephir_prop_3, 1070, PH_NOISY_CC | PH_READONLY);
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _6$$4, _7$$4, _5$$4)
			{
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0)))) {
					...
					zephir_read_property_cached(&_9$$6, this_ptr, _zephir_prop_0, 1051, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0)))) {
						...
						zephir_read_property_cached(&_18$$8, this_ptr, _zephir_prop_0, 1051, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, prepareDelete)
{
	...
	ZEPHIR_INIT_NVAR(&table);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1068, &models);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1067, &modelsInstances);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1069, &sqlAliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1072, &sqlAliasesModelsInstances);
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _18$$9)
			{
				...
				if (UNEXPECTED(!zephir_is_true(&_19$$10))) {
					...
					zephir_read_property_cached(&_22$$11, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (UNEXPECTED(!zephir_is_true(&_26$$12))) {
						...
						zephir_read_property_cached(&_29$$13, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, prepareSelect)
{
	...
	if (ZEPHIR_IS_EMPTY(ast)) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1061, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 1062, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&manager, &_3);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 1063, PH_NOISY_CC | PH_READONLY);
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectedModels), _6)
		{
			...
			if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
				if (UNEXPECTED(zephir_array_isset_value(&sqlAliases, &alias))) {
					...
					zephir_read_property_cached(&_9$$17, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _12$$21)
					{
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
								...
								zephir_read_property_cached(&_19$$27, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
									...
									zephir_read_property_cached(&_33$$31, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
					if (UNEXPECTED(zephir_array_isset_value(&sqlAliases, &alias))) {
						...
						zephir_read_property_cached(&_43$$36, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _46$$40)
						{
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
									...
									zephir_read_property_cached(&_53$$46, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									if (UNEXPECTED(Z_TYPE_P(&relation) != IS_OBJECT)) {
										...
										zephir_read_property_cached(&_66$$50, this_ptr, _zephir_prop_3, 1051, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&selectedModel);
	if (!(merge)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1068, &models);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1067, &modelsInstances);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 1069, &sqlAliases);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 1070, &sqlAliasesModels);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 1071, &sqlModelsAliases);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1072, &sqlAliasesModelsInstances);
	} else {
		zephir_memory_observe(&tempModels);
		zephir_read_property_cached(&tempModels, this_ptr, _zephir_prop_4, 1068, PH_NOISY_CC);
		zephir_memory_observe(&tempModelsInstances);
		zephir_read_property_cached(&tempModelsInstances, this_ptr, _zephir_prop_5, 1067, PH_NOISY_CC);
		zephir_memory_observe(&tempSqlAliases);
		zephir_read_property_cached(&tempSqlAliases, this_ptr, _zephir_prop_6, 1069, PH_NOISY_CC);
		zephir_memory_observe(&tempSqlAliasesModels);
		zephir_read_property_cached(&tempSqlAliasesModels, this_ptr, _zephir_prop_7, 1070, PH_NOISY_CC);
		zephir_memory_observe(&tempSqlModelsAliases);
		zephir_read_property_cached(&tempSqlModelsAliases, this_ptr, _zephir_prop_8, 1071, PH_NOISY_CC);
		zephir_memory_observe(&tempSqlAliasesModelsInstances);
		zephir_read_property_cached(&tempSqlAliasesModelsInstances, this_ptr, _zephir_prop_9, 1072, PH_NOISY_CC);
	...
	zephir_read_property_cached(&_114, this_ptr, _zephir_prop_10, 1073, PH_NOISY_CC);
	...
	if (merge) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1068, &tempModels);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1067, &tempModelsInstances);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 1069, &tempSqlAliases);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 1070, &tempSqlAliasesModels);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 1071, &tempSqlModelsAliases);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 1072, &tempSqlAliasesModelsInstances);
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, prepareUpdate)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1067, &modelsInstances);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1069, &sqlAliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1070, &sqlAliasesModels);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 1071, &sqlModelsAliases);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 1072, &sqlAliasesModelsInstances);
	ZEPHIR_INIT_VAR(&sqlJoins);
	array_init(&sqlJoins);
	zephir_memory_observe(&joins);
