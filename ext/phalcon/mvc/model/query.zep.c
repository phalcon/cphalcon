...
PHP_METHOD(Phalcon_Mvc_Model_Query, setDI) {
	...
	if (Z_TYPE_P(&manager) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Injected service 'modelsManager' is invalid", "phalcon/Mvc/Model/Query.zep", 183);
		return;
	}
	ZEPHIR_INIT_NVAR(&_0);
	...
	if (Z_TYPE_P(&metaData) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Injected service 'modelsMetaData' is invalid", "phalcon/Mvc/Model/Query.zep", 188);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getQualified) {
	...
	zephir_array_fetch_string(&columnName, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 235 TSRMLS_CC);
	...
	if (zephir_array_isset(&_0, &nestingLevel)) {
		...
		zephir_array_fetch(&sqlColumnAliases, &_1$$3, &nestingLevel, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 243 TSRMLS_CC);
	} else {
	...
	if (_2) {
		...
		if (!(_3)) {
			zephir_array_fetch_string(&_4, &expr, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 248 TSRMLS_CC);
	...
	if (zephir_array_isset_string_fetch(&columnDomain, &expr, SL("domain"), 0)) {
		...
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0 TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_5$$7, "__construct", NULL, 1, &_7$$7);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_5$$7, "phalcon/Mvc/Model/Query.zep", 270 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
			...
			if (!(zephir_array_isset_fetch(&model, &sqlAliasesModelsInstances, &columnDomain, 0 TSRMLS_CC))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_8$$9, "phalcon/Mvc/Model/Query.zep", 290 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0 TSRMLS_CC))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_11$$12, "__construct", NULL, 1, &_13$$12);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_11$$12, "phalcon/Mvc/Model/Query.zep", 302 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
		...
		zephir_is_iterable(&_14$$14, 0, "phalcon/Mvc/Model/Query.zep", 336);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_14$$14), _15$$14)
			{
				...
				if (zephir_is_true(&_17$$15)) {
					...
					if (number > 1) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_19$$17, "__construct", NULL, 1, &_21$$17);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_19$$17, "phalcon/Mvc/Model/Query.zep", 326 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				...
				zephir_check_call_status();
					...
					if (zephir_is_true(&_22$$18)) {
						...
						if (number > 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_24$$20, "__construct", NULL, 1, &_26$$20);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_24$$20, "phalcon/Mvc/Model/Query.zep", 326 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_CPY_WRT(&hasModel, &model);
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(&hasModel)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_27$$21, "__construct", NULL, 1, &_29$$21);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_27$$21, "phalcon/Mvc/Model/Query.zep", 339 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (Z_TYPE_P(&models) != IS_ARRAY) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The models list was not loaded correctly", "phalcon/Mvc/Model/Query.zep", 347);
			return;
		}
		...
		if (!(zephir_array_isset_fetch(&source, &models, &className, 0 TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_30$$23, "__construct", NULL, 1, &_32$$23);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_30$$23, "phalcon/Mvc/Model/Query.zep", 357 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		if (ZEPHIR_GLOBAL(orm).column_renaming) {
		...
		if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
			...
			if (!(zephir_array_isset_fetch(&realColumnName, &columnMap, &columnName, 0 TSRMLS_CC))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_33$$27, "__construct", NULL, 1, &_35$$27);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_33$$27, "phalcon/Mvc/Model/Query.zep", 376 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		} else {
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	zephir_array_fetch_string(&_0, &argument, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 399 TSRMLS_CC);
	if (ZEPHIR_IS_LONG(&_0, 352)) {
		zephir_create_array(return_value, 1, 0 TSRMLS_CC);
		add_assoc_stringl_ex(return_value, SL("type"), SL("all"));
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getexpression", NULL, 395, &argument);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCaseExpression) {
	...
	zephir_array_fetch_string(&_0, &expr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 413 TSRMLS_CC);
	zephir_is_iterable(&_0, 0, "phalcon/Mvc/Model/Query.zep", 428);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				zephir_array_fetch_string(&_5$$4, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 417 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 395, &_5$$4);
				zephir_check_call_status();
				zephir_array_update_string(&_3$$4, SL("expr"), &_4$$4, PH_COPY | PH_SEPARATE);
				zephir_array_fetch_string(&_7$$4, &whenExpr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 418 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 395, &_7$$4);
				zephir_check_call_status();
				zephir_array_update_string(&_3$$4, SL("then"), &_4$$4, PH_COPY | PH_SEPARATE);
				zephir_array_append(&whenClauses, &_3$$4, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 419);
			} else {
				ZEPHIR_INIT_NVAR(&_8$$5);
				zephir_create_array(&_8$$5, 2, 0 TSRMLS_CC);
				add_assoc_stringl_ex(&_8$$5, SL("type"), SL("else"));
				zephir_array_fetch_string(&_10$$5, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 423 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "_getexpression", &_6, 395, &_10$$5);
				zephir_check_call_status();
				zephir_array_update_string(&_8$$5, SL("expr"), &_9$$5, PH_COPY | PH_SEPARATE);
				zephir_array_append(&whenClauses, &_8$$5, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 424);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					zephir_array_fetch_string(&_13$$7, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 417 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 395, &_13$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_11$$7, SL("expr"), &_12$$7, PH_COPY | PH_SEPARATE);
					zephir_array_fetch_string(&_14$$7, &whenExpr, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 418 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 395, &_14$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_11$$7, SL("then"), &_12$$7, PH_COPY | PH_SEPARATE);
					zephir_array_append(&whenClauses, &_11$$7, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 419);
				} else {
					ZEPHIR_INIT_NVAR(&_15$$8);
					zephir_create_array(&_15$$8, 2, 0 TSRMLS_CC);
					add_assoc_stringl_ex(&_15$$8, SL("type"), SL("else"));
					zephir_array_fetch_string(&_17$$8, &whenExpr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 423 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "_getexpression", &_6, 395, &_17$$8);
					zephir_check_call_status();
					zephir_array_update_string(&_15$$8, SL("expr"), &_16$$8, PH_COPY | PH_SEPARATE);
					zephir_array_append(&whenClauses, &_15$$8, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 424);
				}
	...
	zephir_array_fetch_string(&_19, &expr, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 430 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "_getexpression", &_6, 395, &_19);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getFunctionCall) {
	...
	if (zephir_array_isset_string_fetch(&arguments, &expr, SL("arguments"), 0)) {
		...
		if (zephir_array_isset_long(&arguments, 0)) {
			...
			zephir_is_iterable(&arguments, 0, "phalcon/Mvc/Model/Query.zep", 456);
			if (Z_TYPE_P(&arguments) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _0$$6)
				{
					ZEPHIR_INIT_NVAR(&argument);
					ZVAL_COPY(&argument, _0$$6);
					ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "_getcallargument", &_3, 396, &argument);
					zephir_check_call_status();
					zephir_array_append(&functionArgs, &_2$$7, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 454);
				} ZEND_HASH_FOREACH_END();
			} else {
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "_getcallargument", &_3, 396, &argument);
						zephir_check_call_status();
						zephir_array_append(&functionArgs, &_4$$8, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 454);
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getcallargument", &_3, 396, &arguments);
			zephir_check_call_status();
		...
		if (distinct) {
			...
			zephir_array_fetch_string(&_7$$10, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 464 TSRMLS_CC);
			...
			zephir_array_fetch_string(&_9$$11, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 471 TSRMLS_CC);
	...
	add_assoc_stringl_ex(return_value, SL("type"), SL("functionCall"));
	ZEPHIR_OBS_VAR(&_10);
	zephir_array_fetch_string(&_10, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 480 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, &expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, &expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", NULL, 395, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, &expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", NULL, 395, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", NULL, 397, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 258) || ZEPHIR_IS_LONG(&exprType, 259) || ZEPHIR_IS_LONG(&exprType, 414)) {
				...
				zephir_array_fetch_string(&_19$$25, &expr, SL("value"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 594 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(&exprType, 260)) {
				...
				zephir_array_fetch_string(&value, &expr, SL("value"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 606 TSRMLS_CC);
				if (quoting) {
					if (zephir_memnstr_str(&value, SL("'"), "phalcon/Mvc/Model/Query.zep", 612)) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 273)) {
				...
				zephir_array_fetch_string(&_25$$33, &expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 627 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(&exprType, 274)) {
				...
				zephir_array_fetch_string(&_29$$34, &expr, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 636 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(&exprType, 277)) {
				...
				zephir_array_fetch_string(&value, &expr, SL("value"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 641 TSRMLS_CC);
				if (zephir_memnstr_str(&value, SL(":"), "phalcon/Mvc/Model/Query.zep", 642)) {
					ZEPHIR_INIT_VAR(&valueParts);
					zephir_fast_explode_str(&valueParts, SL(":"), &value, LONG_MAX TSRMLS_CC);
					ZEPHIR_OBS_VAR(&name);
					zephir_array_fetch_long(&name, &valueParts, 0, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 645 TSRMLS_CC);
					ZEPHIR_OBS_VAR(&bindType);
					zephir_array_fetch_long(&bindType, &valueParts, 1, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 646 TSRMLS_CC);
					do {
						...
						if (ZEPHIR_IS_STRING(&bindType, "array") || ZEPHIR_IS_STRING(&bindType, "array-str") || ZEPHIR_IS_STRING(&bindType, "array-int")) {
							...
							if (!(zephir_array_isset_fetch(&bind, &_49$$43, &name, 0 TSRMLS_CC))) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_50$$44, "phalcon/Mvc/Model/Query.zep", 687 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (Z_TYPE_P(&bind) != IS_ARRAY) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_52$$45, "phalcon/Mvc/Model/Query.zep", 693 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
							if (zephir_fast_count_int(&bind TSRMLS_CC) < 1) {
								...
								zephir_check_call_status();
								zephir_throw_exception_debug(&_54$$46, "phalcon/Mvc/Model/Query.zep", 699 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_58$$47, "phalcon/Mvc/Model/Query.zep", 713 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					} while(0);
			...
			if (ZEPHIR_IS_LONG(&exprType, 358)) {
				...
				zephir_array_fetch_string(&_79$$65, &expr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 786 TSRMLS_CC);
			...
			if (ZEPHIR_IS_LONG(&exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getfunctioncall", NULL, 398, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getcaseexpression", NULL, 399, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 309)) {
				...
				ZVAL_BOOL(&_82$$68, 1);
				ZEPHIR_CALL_METHOD(&_81$$68, this_ptr, "_prepareselect", NULL, 400, &expr, &_82$$68);
				zephir_check_call_status();
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_83$$69, "phalcon/Mvc/Model/Query.zep", 806 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		} while(0);
	...
	if (zephir_array_isset_string(&expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", NULL, 397, &expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(&expr, 0)) {
		...
		zephir_is_iterable(&expr, 0, "phalcon/Mvc/Model/Query.zep", 827);
		if (Z_TYPE_P(&expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _85$$71)
			{
				ZEPHIR_INIT_NVAR(&exprListItem);
				ZVAL_COPY(&exprListItem, _85$$71);
				ZEPHIR_CALL_METHOD(&_87$$72, this_ptr, "_getexpression", NULL, 395, &exprListItem);
				zephir_check_call_status();
				zephir_array_append(&listItems, &_87$$72, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 825);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "_getexpression", NULL, 395, &exprListItem);
					zephir_check_call_status();
					zephir_array_append(&listItems, &_88$$73, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 825);
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Unknown expression", "phalcon/Mvc/Model/Query.zep", 830);
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		...
		zephir_is_iterable(&_0$$4, 0, "phalcon/Mvc/Model/Query.zep", 874);
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0$$4), _3$$4, _4$$4, _1$$4)
			{
				...
				if (Z_TYPE_P(&eager) != IS_NULL) {
					...
					zephir_array_fetch_string(&_7$$6, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 869 TSRMLS_CC);
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&eager) != IS_NULL) {
						zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
						zephir_array_fetch_string(&_10$$8, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 869 TSRMLS_CC);
	...
	if (!(zephir_array_isset_string(&column, SL("column")))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 878);
		return;
	}
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		...
		zephir_read_property(&sqlAliases, this_ptr, SL("_sqlAliases"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(&columnDomain);
		zephir_array_fetch_string(&columnDomain, &column, SL("column"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 891 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(&source);
		if (!(zephir_array_isset_fetch(&source, &sqlAliases, &columnDomain, 0 TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_11$$11, "__construct", NULL, 1, &_13$$11);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_11$$11, "phalcon/Mvc/Model/Query.zep", 896 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		zephir_array_fetch(&modelName, &sqlAliasesModels, &columnDomain, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 910 TSRMLS_CC);
		...
		if (Z_TYPE_P(&eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_15$$15, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 937 TSRMLS_CC);
			zephir_array_update_string(&sqlColumn, SL("eagerType"), &_15$$15, PH_COPY | PH_SEPARATE);
		}
		zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 940);
		RETURN_CCTOR(&sqlColumns);
	}
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		zephir_array_fetch_string(&columnData, &column, SL("column"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 954 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "_getexpression", NULL, 395, &columnData);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&eager) != IS_NULL) {
			zephir_array_update_string(&sqlColumn, SL("eager"), &eager, PH_COPY | PH_SEPARATE);
			zephir_array_fetch_string(&_17$$18, &column, SL("eagerType"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 967 TSRMLS_CC);
		...
		zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 971);
		RETURN_CCTOR(&sqlColumns);
	}
	ZEPHIR_INIT_VAR(&_18);
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_18, "phalcon/Mvc/Model/Query.zep", 976 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getTable) {
	...
	if (!(zephir_array_isset_string_fetch(&modelName, &qualifiedName, SL("name"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 989);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoin) {
	...
	if (zephir_array_isset_string_fetch(&qualified, &join, SL("qualified"), 0)) {
		zephir_array_fetch_string(&_0$$3, &qualified, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1013 TSRMLS_CC);
		if (ZEPHIR_IS_LONG(&_0$$3, 355)) {
			ZEPHIR_OBS_VAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualified, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1015 TSRMLS_CC);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 1017)) {
				ZEPHIR_INIT_VAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
				zephir_array_fetch_long(&_2$$5, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1019 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_1$$5, manager, "getnamespacealias", NULL, 0, &_2$$5);
				zephir_check_call_status();
				zephir_array_fetch_long(&_3$$5, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1019 TSRMLS_CC);
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 1037);
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoinType) {
	...
	if (!(zephir_array_isset_string_fetch(&type, &join, SL("type"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 1048);
		return;
	}
	do {
	...
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Mvc/Model/Query.zep", 1071 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 397, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 397, &_4$$3);
		zephir_check_call_status();
		...
		zephir_is_iterable(&fields, 0, "phalcon/Mvc/Model/Query.zep", 1156);
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0 TSRMLS_CC))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_9$$6, "phalcon/Mvc/Model/Query.zep", 1132 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 397, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 397, &_16$$5);
				zephir_check_call_status();
				zephir_array_update_string(&_13$$5, SL("right"), &_14$$5, PH_COPY | PH_SEPARATE);
				zephir_array_append(&sqlJoinPartialConditions, &_13$$5, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1153);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&referencedField, &referencedFields, &position, 0 TSRMLS_CC))) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$8, "phalcon/Mvc/Model/Query.zep", 1132 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 397, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 397, &_23$$7);
					zephir_check_call_status();
					zephir_array_update_string(&_20$$7, SL("right"), &_21$$7, PH_COPY | PH_SEPARATE);
					zephir_array_append(&sqlJoinPartialConditions, &_20$$7, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1153);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getMultiJoin) {
	...
	zephir_check_call_status();
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		zephir_is_iterable(&fields, 0, "phalcon/Mvc/Model/Query.zep", 1279);
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _2$$3, _3$$3, _0$$3)
			{
				...
				if (!(zephir_array_isset(&referencedFields, &position))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_4$$5, "phalcon/Mvc/Model/Query.zep", 1250 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_OBS_NVAR(&intermediateField);
				zephir_array_fetch(&intermediateField, &intermediateFields, &position, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1256 TSRMLS_CC);
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 397, &_9$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "_getqualified", &_10, 397, &_11$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (!(zephir_array_isset(&referencedFields, &position))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", &_7, 1, &_14$$7);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$7, "phalcon/Mvc/Model/Query.zep", 1250 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_OBS_NVAR(&intermediateField);
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 397, &_17$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "_getqualified", &_10, 397, &_18$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 397, &_24$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 397, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 397, &_26$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("left"), &_23$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_23$$8, this_ptr, "_getqualified", &_10, 397, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_22$$8, SL("right"), &_23$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_21$$8, &_22$$8);
		zephir_array_update_string(&_20$$8, SL("conditions"), &_21$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	zephir_array_fetch_string(&joins, &select, SL("joins"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1377 TSRMLS_CC);
	...
	zephir_is_iterable(&selectJoins, 0, "phalcon/Mvc/Model/Query.zep", 1530);
	if (Z_TYPE_P(&selectJoins) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_2, 401, &manager, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&source);
			zephir_array_fetch_string(&source, &joinData, SL("source"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1390 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&schema);
			zephir_array_fetch_string(&schema, &joinData, SL("schema"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1391 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&model);
			zephir_array_fetch_string(&model, &joinData, SL("model"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1392 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&realModelName);
			zephir_array_fetch_string(&realModelName, &joinData, SL("modelName"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1393 TSRMLS_CC);
			...
			ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_3, 402, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&aliasExpr);
			if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
				ZEPHIR_OBS_NVAR(&alias);
				zephir_array_fetch_string(&alias, &aliasExpr, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1406 TSRMLS_CC);
				if (zephir_array_isset(&joinModels, &alias)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_4$$9, "phalcon/Mvc/Model/Query.zep", 1414 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_append(&completeSource, &alias, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1420);
				...
				if (zephir_array_isset(&joinModels, &realModelName)) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_8$$11, "phalcon/Mvc/Model/Query.zep", 1475 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&aliasExpr, &joinItem, SL("alias"), 0)) {
					...
					if (zephir_array_isset(&joinModels, &alias)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_12$$14, "__construct", &_7, 1, &_14$$14);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$14, "phalcon/Mvc/Model/Query.zep", 1414 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_append(&completeSource, &alias, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1420);
					...
					if (zephir_array_isset(&joinModels, &realModelName)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_15$$16, "__construct", &_7, 1, &_17$$16);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_15$$16, "phalcon/Mvc/Model/Query.zep", 1475 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_update_zval(&joinTypes, &realModelName, &joinType, PH_COPY | PH_SEPARATE);
	...
	zephir_is_iterable(&joinPrepared, 0, "phalcon/Mvc/Model/Query.zep", 1550);
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _20, _21, _18)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_22$$18, this_ptr, "_getexpression", &_23, 395, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_24$$20, this_ptr, "_getexpression", &_23, 395, &joinExpr);
					zephir_check_call_status();
	...
	if (!(zephir_is_true(&_25))) {
		...
		if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _29$$21, _30$$21, _27$$21)
			{
				...
				zephir_array_fetch(&joinType, &joinTypes, &joinAliasName, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1552 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(&joinSource);
				zephir_array_fetch(&joinSource, &joinSources, &joinAliasName, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1553 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(&preCondition);
				zephir_array_fetch(&preCondition, &joinPreCondition, &joinAliasName, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1554 TSRMLS_CC);
				...
				zephir_array_append(&sqlJoins, &_31$$22, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1559);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &joinPrepared, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_array_append(&sqlJoins, &_33$$23, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1559);
				ZEPHIR_CALL_METHOD(NULL, &joinPrepared, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
	...
	zephir_is_iterable(&selectTables, 0, "phalcon/Mvc/Model/Query.zep", 1575);
	if (Z_TYPE_P(&selectTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectTables), _35)
		{
			...
			zephir_array_fetch_string(&_37$$24, &tableItem, SL("qualifiedName"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1569 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&_38$$24);
			zephir_array_fetch_string(&_38$$24, &_37$$24, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1569 TSRMLS_CC);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_39$$25, &tableItem, SL("qualifiedName"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1569 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(&_40$$25);
				zephir_array_fetch_string(&_40$$25, &_39$$25, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1569 TSRMLS_CC);
	...
	ZEPHIR_INIT_NVAR(&tableItem);
	ZEPHIR_INIT_VAR(&_41);
	zephir_is_iterable(&fromModels, 0, "phalcon/Mvc/Model/Query.zep", 1704);
	if (Z_TYPE_P(&fromModels) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fromModels), _44, _45, _42)
		{
			...
			ZVAL_COPY(&_41, _42);
			zephir_is_iterable(&joinModels, 0, "phalcon/Mvc/Model/Query.zep", 1702);
			if (Z_TYPE_P(&joinModels) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinModels), _48$$26, _49$$26, _46$$26)
				{
					...
					ZEPHIR_OBS_NVAR(&joinSource);
					zephir_array_fetch(&joinSource, &joinSources, &joinAlias, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1582 TSRMLS_CC);
					ZEPHIR_OBS_NVAR(&joinType);
					zephir_array_fetch(&joinType, &joinTypes, &joinAlias, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1587 TSRMLS_CC);
					ZEPHIR_OBS_NVAR(&preCondition);
					if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0 TSRMLS_CC))) {
						ZEPHIR_OBS_NVAR(&modelNameAlias);
						zephir_array_fetch(&modelNameAlias, &sqlAliasesModels, &joinAlias, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1597 TSRMLS_CC);
						...
						if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
							...
							if (Z_TYPE_P(&relations) == IS_ARRAY) {
								if (zephir_fast_count_int(&relations TSRMLS_CC) != 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_52$$31, "__construct", &_7, 1, &_54$$31);
									zephir_check_call_status();
									zephir_throw_exception_debug(&_52$$31, "phalcon/Mvc/Model/Query.zep", 1625 TSRMLS_CC);
									ZEPHIR_MM_RESTORE();
									return;
								}
								ZEPHIR_OBS_NVAR(&relation);
								zephir_array_fetch_long(&relation, &relations, 0, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1631 TSRMLS_CC);
							}
						}
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							ZEPHIR_OBS_NVAR(&modelAlias);
							zephir_array_fetch(&modelAlias, &sqlModelsAliases, &fromModelName, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1643 TSRMLS_CC);
							ZEPHIR_CALL_METHOD(&_55$$32, &relation, "isthrough", NULL, 0);
							zephir_check_call_status();
							if (!(zephir_is_true(&_55$$32))) {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_56, 403, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							} else {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_57, 404, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							}
							if (zephir_array_isset_long(&sqlJoin, 0)) {
								zephir_is_iterable(&sqlJoin, 0, "phalcon/Mvc/Model/Query.zep", 1673);
								if (Z_TYPE_P(&sqlJoin) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&sqlJoin), _58$$35)
									{
										...
										zephir_array_append(&sqlJoins, &sqlJoinItem, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1671);
									} ZEND_HASH_FOREACH_END();
								} else {
								...
								zephir_array_append(&sqlJoins, &sqlJoin, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1674);
							}
						} else {
							...
							zephir_array_append(&sqlJoins, &_60$$39, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1687);
						}
					} else {
						...
						zephir_array_append(&sqlJoins, &_62$$40, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1699);
					}
				} ZEND_HASH_FOREACH_END();
			} else {
					...
					zephir_check_call_status();
						...
						if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0 TSRMLS_CC))) {
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations TSRMLS_CC) != 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_66$$45, "__construct", &_7, 1, &_68$$45);
										zephir_check_call_status();
										zephir_throw_exception_debug(&_66$$45, "phalcon/Mvc/Model/Query.zep", 1625 TSRMLS_CC);
										ZEPHIR_MM_RESTORE();
										return;
									}
									ZEPHIR_OBS_NVAR(&relation);
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								zephir_array_append(&sqlJoins, &_72$$53, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1687);
							}
						} else {
							...
							zephir_array_append(&sqlJoins, &_74$$54, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1699);
						}
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinModels), _78$$55, _79$$55, _76$$55)
					{
						...
						if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0 TSRMLS_CC))) {
							...
							if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
								...
								if (Z_TYPE_P(&relations) == IS_ARRAY) {
									if (zephir_fast_count_int(&relations TSRMLS_CC) != 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_82$$60, "__construct", &_7, 1, &_84$$60);
										zephir_check_call_status();
										zephir_throw_exception_debug(&_82$$60, "phalcon/Mvc/Model/Query.zep", 1625 TSRMLS_CC);
										ZEPHIR_MM_RESTORE();
										return;
									}
									ZEPHIR_OBS_NVAR(&relation);
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								zephir_array_append(&sqlJoins, &_88$$68, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1687);
							}
						} else {
							...
							zephir_array_append(&sqlJoins, &_90$$69, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1699);
						}
					} ZEND_HASH_FOREACH_END();
				} else {
					ZEPHIR_CALL_METHOD(NULL, &joinModels, "rewind", NULL, 0);
						...
						zephir_check_call_status();
							...
							if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0 TSRMLS_CC))) {
								...
								if (ZEPHIR_IS_FALSE_IDENTICAL(&relation)) {
									...
									if (Z_TYPE_P(&relations) == IS_ARRAY) {
										if (zephir_fast_count_int(&relations TSRMLS_CC) != 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_94$$74, "__construct", &_7, 1, &_96$$74);
											zephir_check_call_status();
											zephir_throw_exception_debug(&_94$$74, "phalcon/Mvc/Model/Query.zep", 1625 TSRMLS_CC);
											ZEPHIR_MM_RESTORE();
											return;
										}
										ZEPHIR_OBS_NVAR(&relation);
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									zephir_array_append(&sqlJoins, &_100$$82, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1687);
								}
							} else {
								...
								zephir_array_append(&sqlJoins, &_102$$83, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1699);
							}
						ZEPHIR_CALL_METHOD(NULL, &joinModels, "next", NULL, 0);
						zephir_check_call_status();
					}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	zephir_is_iterable(&orderColumns, 0, "phalcon/Mvc/Model/Query.zep", 1744);
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			zephir_array_fetch_string(&_2$$5, &orderItem, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1726 TSRMLS_CC);
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 395, &_2$$5);
			zephir_check_call_status();
			...
			zephir_array_append(&orderParts, &orderPartSort, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1741);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_9$$10, &orderItem, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1726 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 395, &_9$$10);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getGroupClause) {
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		zephir_is_iterable(&group, 0, "phalcon/Mvc/Model/Query.zep", 1762);
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				ZEPHIR_INIT_NVAR(&groupItem);
				ZVAL_COPY(&groupItem, _0$$3);
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_3, 395, &groupItem);
				zephir_check_call_status();
				zephir_array_append(&groupParts, &_2$$4, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1760);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "_getexpression", &_3, 395, &groupItem);
					zephir_check_call_status();
					zephir_array_append(&groupParts, &_4$$5, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1760);
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "_getexpression", &_3, 395, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", NULL, 395, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "_getexpression", NULL, 395, &offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	if (!(zephir_array_isset_string_fetch(&tables, &select, SL("tables"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 1818);
		return;
	}
	ZEPHIR_OBS_VAR(&columns);
	if (!(zephir_array_isset_string_fetch(&columns, &select, SL("columns"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted SELECT AST", "phalcon/Mvc/Model/Query.zep", 1822);
		return;
	}
	...
	zephir_read_property(&metaData, this_ptr, SL("_metaData"), PH_NOISY_CC);
	if (Z_TYPE_P(&manager) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "A models-manager is required to execute the query", "phalcon/Mvc/Model/Query.zep", 1889);
		return;
	}
	if (Z_TYPE_P(&metaData) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "A meta-data is required to execute the query", "phalcon/Mvc/Model/Query.zep", 1893);
		return;
	}
	number = 0;
	ZEPHIR_INIT_VAR(&automaticJoins);
	array_init(&automaticJoins);
	zephir_is_iterable(&selectedModels, 0, "phalcon/Mvc/Model/Query.zep", 2035);
	if (Z_TYPE_P(&selectedModels) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectedModels), _0)
		{
			...
			zephir_array_fetch_string(&qualifiedName, &selectedModel, SL("qualifiedName"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1902 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1903 TSRMLS_CC);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 1906)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
				zephir_array_fetch_long(&_3$$15, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1908 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_2$$15, &manager, "getnamespacealias", &_4, 0, &_3$$15);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$15, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1908 TSRMLS_CC);
			...
			if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
				if (zephir_array_isset(&sqlAliases, &alias)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_7$$20, "__construct", &_10, 1, &_9$$20);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_7$$20, "phalcon/Mvc/Model/Query.zep", 1937 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
				...
				if (Z_TYPE_P(&completeSource) == IS_ARRAY) {
					zephir_array_append(&completeSource, &alias, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 1949);
				} else {
			...
			if (zephir_array_isset_string_fetch(&with, &selectedModel, SL("with"), 0)) {
				...
				zephir_is_iterable(&withs, 0, "phalcon/Mvc/Model/Query.zep", 2027);
				if (Z_TYPE_P(&withs) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _12$$24)
					{
						...
						zephir_array_fetch_string(&relationModel, &withItem, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 1977 TSRMLS_CC);
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_20$$31, "__construct", &_10, 1, &_22$$31);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_20$$31, "phalcon/Mvc/Model/Query.zep", 2001 TSRMLS_CC);
								ZEPHIR_MM_RESTORE();
								return;
							}
						}
						...
						zephir_array_append(&selectColumns, &_23$$27, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2011);
						...
						zephir_array_append(&automaticJoins, &_24$$27, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2023);
						number++;
					} ZEND_HASH_FOREACH_END();
				} else {
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_32$$36, "__construct", &_10, 1, &_34$$36);
									zephir_check_call_status();
									zephir_throw_exception_debug(&_32$$36, "phalcon/Mvc/Model/Query.zep", 2001 TSRMLS_CC);
									ZEPHIR_MM_RESTORE();
									return;
								}
							}
							...
							zephir_array_append(&selectColumns, &_35$$32, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2011);
							...
							zephir_array_append(&automaticJoins, &_36$$32, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2023);
							number++;
			...
			zephir_array_append(&sqlModels, &realModelName, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2029);
			zephir_array_append(&sqlTables, &completeSource, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2030);
			zephir_array_update_zval(&modelsInstances, &realModelName, &model, PH_COPY | PH_SEPARATE);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 1906)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
					zephir_array_fetch_long(&_39$$38, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1908 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_38$$38, &manager, "getnamespacealias", &_40, 0, &_39$$38);
					zephir_check_call_status();
					zephir_array_fetch_long(&_41$$38, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 1908 TSRMLS_CC);
					ZEPHIR_INIT_NVAR(&realModelName);
				...
				if (zephir_array_isset_string_fetch(&alias, &selectedModel, SL("alias"), 0)) {
					if (zephir_array_isset(&sqlAliases, &alias)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_44$$43, "__construct", &_10, 1, &_46$$43);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_44$$43, "phalcon/Mvc/Model/Query.zep", 1937 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&withs), _49$$47)
						{
							...
							if (Z_TYPE_P(&relation) == IS_OBJECT) {
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_57$$54, "__construct", &_10, 1, &_59$$54);
									zephir_check_call_status();
									zephir_throw_exception_debug(&_57$$54, "phalcon/Mvc/Model/Query.zep", 2001 TSRMLS_CC);
									ZEPHIR_MM_RESTORE();
									return;
								}
							}
							...
							zephir_array_append(&selectColumns, &_60$$50, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2011);
							...
							zephir_array_append(&automaticJoins, &_61$$50, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2023);
							number++;
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &withs, "rewind", NULL, 0);
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&relation) == IS_OBJECT) {
									...
									if (Z_TYPE_P(&relation) == IS_OBJECT) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_69$$59, "__construct", &_10, 1, &_71$$59);
										zephir_check_call_status();
										zephir_throw_exception_debug(&_69$$59, "phalcon/Mvc/Model/Query.zep", 2001 TSRMLS_CC);
										ZEPHIR_MM_RESTORE();
										return;
									}
								}
								...
								zephir_array_append(&selectColumns, &_72$$55, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2011);
								...
								zephir_array_append(&automaticJoins, &_73$$55, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2023);
								number++;
							ZEPHIR_CALL_METHOD(NULL, &withs, "next", NULL, 0);
							zephir_check_call_status();
						}
	...
	if (zephir_fast_count_int(&joins TSRMLS_CC)) {
		if (zephir_fast_count_int(&automaticJoins TSRMLS_CC)) {
			if (zephir_array_isset_long(&joins, 0)) {
				...
				zephir_array_append(&automaticJoins, &joins, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2067);
				zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
			}
		}
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "_getjoins", NULL, 405, &select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(&automaticJoins TSRMLS_CC)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	array_init(&sqlColumnAliases);
	zephir_is_iterable(&selectColumns, 0, "phalcon/Mvc/Model/Query.zep", 2123);
	if (Z_TYPE_P(&selectColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _88)
		{
			ZEPHIR_INIT_NVAR(&column);
			ZVAL_COPY(&column, _88);
			ZEPHIR_CALL_METHOD(&_90$$69, this_ptr, "_getselectcolumn", &_91, 406, &column);
			zephir_check_call_status();
			zephir_is_iterable(&_90$$69, 0, "phalcon/Mvc/Model/Query.zep", 2122);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_90$$69), _92$$69)
				{
					...
					if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
						...
						if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
							zephir_array_fetch_string(&_94$$73, &column, SL("column"), PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2107 TSRMLS_CC);
							if (zephir_array_isset_string(&_94$$73, SL("domain"))) {
								zephir_array_fetch_string(&_95$$74, &column, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
								zephir_array_fetch_string(&_96$$74, &_95$$74, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
							...
							zephir_array_fetch_string(&_98$$75, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2112 TSRMLS_CC);
							if (ZEPHIR_IS_STRING(&_98$$75, "scalar")) {
								...
								zephir_array_append(&sqlColumns, &sqlColumn, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2115);
							}
						}
					}
					position++;
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
							...
							ZEPHIR_OBS_NVAR(&alias);
							if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
								zephir_array_fetch_string(&_101$$81, &column, SL("column"), PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2107 TSRMLS_CC);
								if (zephir_array_isset_string(&_101$$81, SL("domain"))) {
									zephir_array_fetch_string(&_102$$82, &column, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
									zephir_array_fetch_string(&_103$$82, &_102$$82, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
								...
								zephir_array_fetch_string(&_105$$83, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2112 TSRMLS_CC);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_108$$86, this_ptr, "_getselectcolumn", &_91, 406, &column);
				zephir_check_call_status();
				zephir_is_iterable(&_108$$86, 0, "phalcon/Mvc/Model/Query.zep", 2122);
				if (Z_TYPE_P(&_108$$86) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_108$$86), _109$$86)
					{
						...
						if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
							...
							ZEPHIR_OBS_NVAR(&alias);
							if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
								zephir_array_fetch_string(&_111$$90, &column, SL("column"), PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2107 TSRMLS_CC);
								if (zephir_array_isset_string(&_111$$90, SL("domain"))) {
									zephir_array_fetch_string(&_112$$91, &column, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
									zephir_array_fetch_string(&_113$$91, &_112$$91, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
								...
								zephir_array_fetch_string(&_115$$92, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2112 TSRMLS_CC);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (zephir_array_isset_string_fetch(&alias, &column, SL("alias"), 0)) {
								...
								ZEPHIR_OBS_NVAR(&alias);
								if (zephir_array_isset_string_fetch(&alias, &sqlColumn, SL("balias"), 0)) {
									zephir_array_fetch_string(&_118$$98, &column, SL("column"), PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2107 TSRMLS_CC);
									if (zephir_array_isset_string(&_118$$98, SL("domain"))) {
										zephir_array_fetch_string(&_119$$99, &column, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
										zephir_array_fetch_string(&_120$$99, &_119$$99, SL("domain"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2108 TSRMLS_CC);
									...
									zephir_array_fetch_string(&_122$$100, &sqlColumn, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2112 TSRMLS_CC);
	...
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_126$$105, this_ptr, "_getexpression", NULL, 395, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_127$$106, this_ptr, "_getgroupclause", NULL, 407, &groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_128$$107, this_ptr, "_getexpression", NULL, 395, &having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_129$$108, this_ptr, "_getorderclause", NULL, 408, &order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_130$$109, this_ptr, "_getlimitclause", NULL, 409, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	if (!(zephir_array_isset_string(&ast, SL("qualifiedName")))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted INSERT AST", "phalcon/Mvc/Model/Query.zep", 2198);
		return;
	}
	if (!(zephir_array_isset_string(&ast, SL("values")))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted INSERT AST", "phalcon/Mvc/Model/Query.zep", 2202);
		return;
	}
	ZEPHIR_OBS_VAR(&qualifiedName);
	zephir_array_fetch_string(&qualifiedName, &ast, SL("qualifiedName"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2205 TSRMLS_CC);
	if (!(zephir_array_isset_string(&qualifiedName, SL("name")))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted INSERT AST", "phalcon/Mvc/Model/Query.zep", 2209);
		return;
	}
	ZEPHIR_OBS_VAR(&manager);
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2213 TSRMLS_CC);
	if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 2216)) {
		ZEPHIR_INIT_VAR(&nsAlias);
		zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
		zephir_array_fetch_long(&_1$$6, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2218 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(&_0$$6, &manager, "getnamespacealias", NULL, 0, &_1$$6);
		zephir_check_call_status();
		zephir_array_fetch_long(&_2$$6, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2218 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&realModelName);
	...
	zephir_array_fetch_string(&_4, &ast, SL("values"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2234 TSRMLS_CC);
	zephir_is_iterable(&_4, 0, "phalcon/Mvc/Model/Query.zep", 2243);
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			...
			zephir_array_fetch_string(&_8$$9, &exprValue, SL("type"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2238 TSRMLS_CC);
			...
			ZEPHIR_CALL_METHOD(&_9$$9, this_ptr, "_getexpression", &_11, 395, &exprValue, &_10$$9);
			zephir_check_call_status();
			zephir_array_update_string(&_7$$9, SL("value"), &_9$$9, PH_COPY | PH_SEPARATE);
			zephir_array_append(&exprValues, &_7$$9, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2240);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_13$$10, &exprValue, SL("type"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2238 TSRMLS_CC);
				...
				ZEPHIR_CALL_METHOD(&_14$$10, this_ptr, "_getexpression", &_11, 395, &exprValue, &_15$$10);
				zephir_check_call_status();
				zephir_array_update_string(&_12$$10, SL("value"), &_14$$10, PH_COPY | PH_SEPARATE);
				zephir_array_append(&exprValues, &_12$$10, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2240);
	...
	if (zephir_array_isset_string_fetch(&fields, &ast, SL("fields"), 0)) {
		...
		zephir_is_iterable(&fields, 0, "phalcon/Mvc/Model/Query.zep", 2267);
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _16$$11)
			{
				...
				zephir_array_fetch_string(&name, &field, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2254 TSRMLS_CC);
				...
				if (!(zephir_is_true(&_18$$12))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_20$$13, "__construct", &_23, 1, &_22$$13);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_20$$13, "phalcon/Mvc/Model/Query.zep", 2260 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_append(&sqlFields, &name, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2264);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, &fields, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				...
				zephir_check_call_status();
					...
					if (!(zephir_is_true(&_24$$14))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_26$$15, "__construct", &_23, 1, &_28$$15);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_26$$15, "phalcon/Mvc/Model/Query.zep", 2260 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_append(&sqlFields, &name, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2264);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	if (!(zephir_array_isset_string_fetch(&update, &ast, SL("update"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted UPDATE AST", "phalcon/Mvc/Model/Query.zep", 2292);
		return;
	}
	ZEPHIR_OBS_VAR(&tables);
	if (!(zephir_array_isset_string_fetch(&tables, &update, SL("tables"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted UPDATE AST", "phalcon/Mvc/Model/Query.zep", 2296);
		return;
	}
	ZEPHIR_OBS_VAR(&values);
	if (!(zephir_array_isset_string_fetch(&values, &update, SL("values"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted UPDATE AST", "phalcon/Mvc/Model/Query.zep", 2300);
		return;
	}
	ZEPHIR_INIT_VAR(&models);
	array_init(&models);
	...
	ZEPHIR_OBS_VAR(&manager);
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	zephir_is_iterable(&updateTables, 0, "phalcon/Mvc/Model/Query.zep", 2376);
	if (Z_TYPE_P(&updateTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateTables), _0)
		{
			...
			ZVAL_COPY(&table, _0);
			ZEPHIR_OBS_NVAR(&qualifiedName);
			zephir_array_fetch_string(&qualifiedName, &table, SL("qualifiedName"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2324 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2325 TSRMLS_CC);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 2330)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
				zephir_array_fetch_long(&_3$$9, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2332 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_2$$9, &manager, "getnamespacealias", &_4, 0, &_3$$9);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$9, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2332 TSRMLS_CC);
				ZEPHIR_INIT_NVAR(&realModelName);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 2330)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
					zephir_array_fetch_long(&_10$$16, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2332 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_9$$16, &manager, "getnamespacealias", &_11, 0, &_10$$16);
					zephir_check_call_status();
					zephir_array_fetch_long(&_12$$16, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2332 TSRMLS_CC);
					ZEPHIR_INIT_NVAR(&realModelName);
	...
	notQuoting = 0;
	zephir_is_iterable(&updateValues, 0, "phalcon/Mvc/Model/Query.zep", 2400);
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _16)
		{
			...
			zephir_array_fetch_string(&_19$$24, &updateValue, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2392 TSRMLS_CC);
			if (notQuoting) {
				ZVAL_BOOL(&_20$$24, 1);
			} else {
				ZVAL_BOOL(&_20$$24, 0);
			}
			ZEPHIR_CALL_METHOD(&_18$$24, this_ptr, "_getexpression", &_21, 395, &_19$$24, &_20$$24);
			zephir_check_call_status();
			zephir_array_append(&sqlFields, &_18$$24, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2392);
			ZEPHIR_OBS_NVAR(&exprColumn);
			zephir_array_fetch_string(&exprColumn, &updateValue, SL("expr"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2393 TSRMLS_CC);
			ZEPHIR_INIT_NVAR(&_22$$24);
			zephir_create_array(&_22$$24, 2, 0 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&_23$$24);
			zephir_array_fetch_string(&_23$$24, &exprColumn, SL("type"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2395 TSRMLS_CC);
			...
			ZEPHIR_CALL_METHOD(&_24$$24, this_ptr, "_getexpression", &_21, 395, &exprColumn, &_25$$24);
			zephir_check_call_status();
			zephir_array_update_string(&_22$$24, SL("value"), &_24$$24, PH_COPY | PH_SEPARATE);
			zephir_array_append(&sqlValues, &_22$$24, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2397);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_27$$25, &updateValue, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2392 TSRMLS_CC);
				if (notQuoting) {
					ZVAL_BOOL(&_28$$25, 1);
				} else {
					ZVAL_BOOL(&_28$$25, 0);
				}
				ZEPHIR_CALL_METHOD(&_26$$25, this_ptr, "_getexpression", &_21, 395, &_27$$25, &_28$$25);
				zephir_check_call_status();
				zephir_array_append(&sqlFields, &_26$$25, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2392);
				ZEPHIR_OBS_NVAR(&exprColumn);
				zephir_array_fetch_string(&exprColumn, &updateValue, SL("expr"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2393 TSRMLS_CC);
				ZEPHIR_INIT_NVAR(&_29$$25);
				zephir_create_array(&_29$$25, 2, 0 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(&_30$$25);
				zephir_array_fetch_string(&_30$$25, &exprColumn, SL("type"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2395 TSRMLS_CC);
				...
				ZEPHIR_CALL_METHOD(&_31$$25, this_ptr, "_getexpression", &_21, 395, &exprColumn, &_32$$25);
				zephir_check_call_status();
				zephir_array_update_string(&_29$$25, SL("value"), &_31$$25, PH_COPY | PH_SEPARATE);
				zephir_array_append(&sqlValues, &_29$$25, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2397);
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_34$$26, 1);
		ZEPHIR_CALL_METHOD(&_33$$26, this_ptr, "_getexpression", &_21, 395, &where, &_34$$26);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_33$$26, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_35$$27, this_ptr, "_getlimitclause", NULL, 409, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (!(zephir_array_isset_string_fetch(&delete, &ast, SL("delete"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted DELETE AST", "phalcon/Mvc/Model/Query.zep", 2433);
		return;
	}
	ZEPHIR_OBS_VAR(&tables);
	if (!(zephir_array_isset_string_fetch(&tables, &delete, SL("tables"), 0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted DELETE AST", "phalcon/Mvc/Model/Query.zep", 2437);
		return;
	}
	ZEPHIR_INIT_VAR(&models);
	array_init(&models);
	...
	ZEPHIR_OBS_VAR(&manager);
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	zephir_is_iterable(&deleteTables, 0, "phalcon/Mvc/Model/Query.zep", 2507);
	if (Z_TYPE_P(&deleteTables) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&deleteTables), _0)
		{
			...
			ZVAL_COPY(&table, _0);
			ZEPHIR_OBS_NVAR(&qualifiedName);
			zephir_array_fetch_string(&qualifiedName, &table, SL("qualifiedName"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2461 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&modelName);
			zephir_array_fetch_string(&modelName, &qualifiedName, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2462 TSRMLS_CC);
			if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 2467)) {
				ZEPHIR_INIT_NVAR(&nsAlias);
				zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
				zephir_array_fetch_long(&_3$$8, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2469 TSRMLS_CC);
				ZEPHIR_CALL_METHOD(&_2$$8, &manager, "getnamespacealias", &_4, 0, &_3$$8);
				zephir_check_call_status();
				zephir_array_fetch_long(&_5$$8, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2469 TSRMLS_CC);
				ZEPHIR_INIT_NVAR(&realModelName);
			...
			if (zephir_array_isset_string_fetch(&alias, &table, SL("alias"), 0)) {
				zephir_array_update_zval(&sqlAliases, &alias, &alias, PH_COPY | PH_SEPARATE);
				zephir_array_append(&completeSource, &alias, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2489);
				zephir_array_append(&sqlTables, &completeSource, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2490);
				zephir_array_update_zval(&sqlAliasesModelsInstances, &alias, &model, PH_COPY | PH_SEPARATE);
				zephir_array_update_zval(&models, &alias, &realModelName, PH_COPY | PH_SEPARATE);
			} else {
				zephir_array_update_zval(&sqlAliases, &realModelName, &source, PH_COPY | PH_SEPARATE);
				zephir_array_update_zval(&sqlAliasesModelsInstances, &realModelName, &model, PH_COPY | PH_SEPARATE);
				zephir_array_append(&sqlTables, &source, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2496);
				zephir_array_update_zval(&models, &realModelName, &source, PH_COPY | PH_SEPARATE);
			}
			zephir_array_append(&sqlModels, &realModelName, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2500);
			zephir_array_update_zval(&modelsInstances, &realModelName, &model, PH_COPY | PH_SEPARATE);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_memnstr_str(&modelName, SL(":"), "phalcon/Mvc/Model/Query.zep", 2467)) {
					ZEPHIR_INIT_NVAR(&nsAlias);
					zephir_fast_explode_str(&nsAlias, SL(":"), &modelName, LONG_MAX TSRMLS_CC);
					zephir_array_fetch_long(&_10$$15, &nsAlias, 0, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2469 TSRMLS_CC);
					ZEPHIR_CALL_METHOD(&_9$$15, &manager, "getnamespacealias", &_11, 0, &_10$$15);
					zephir_check_call_status();
					zephir_array_fetch_long(&_12$$15, &nsAlias, 1, PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2469 TSRMLS_CC);
					ZEPHIR_INIT_NVAR(&realModelName);
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_17$$21, 1);
		ZEPHIR_CALL_METHOD(&_16$$21, this_ptr, "_getexpression", NULL, 395, &where, &_17$$21);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_16$$21, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_18$$22, this_ptr, "_getlimitclause", NULL, 409, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, parse) {
		...
		if (zephir_array_isset_string_fetch(&uniqueId, &ast, SL("id"), 0)) {
			...
			if (zephir_array_isset_fetch(&irPhql, &_0$$5, &uniqueId, 0 TSRMLS_CC)) {
				if (Z_TYPE_P(&irPhql) == IS_ARRAY) {
					zephir_array_fetch_string(&_1$$7, &ast, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2559 TSRMLS_CC);
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			...
			do {
				if (ZEPHIR_IS_LONG(&type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 400);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 410);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 411);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 412);
					zephir_check_call_status();
					break;
				}
				...
				ZEPHIR_CALL_METHOD(NULL, &_2$$13, "__construct", NULL, 1, &_3$$13);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_2$$13, "phalcon/Mvc/Model/Query.zep", 2594 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			} while(0);
	...
	if (Z_TYPE_P(&irPhql) != IS_ARRAY) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Corrupted AST", "phalcon/Mvc/Model/Query.zep", 2600);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeSelect) {
	...
	ZEPHIR_OBS_VAR(&models);
	zephir_array_fetch_string(&models, &intermediate, SL("models"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2645 TSRMLS_CC);
	zephir_is_iterable(&models, 0, "phalcon/Mvc/Model/Query.zep", 2673);
	if (Z_TYPE_P(&models) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&models), _0)
		{
			...
			if (Z_TYPE_P(&connection) == IS_OBJECT) {
				...
				if (zephir_fast_count_int(&connectionTypes TSRMLS_CC) == 2) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Cannot use models of different database systems in the same query", "phalcon/Mvc/Model/Query.zep", 2668);
					return;
				}
			}
		} ZEND_HASH_FOREACH_END();
	...
	ZEPHIR_INIT_NVAR(&modelName);
	ZEPHIR_OBS_VAR(&columns);
	zephir_array_fetch_string(&columns, &intermediate, SL("columns"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2673 TSRMLS_CC);
	haveObjects = 0;
	haveScalars = 0;
	isComplex = 0;
	numberObjects = 0;
	ZEPHIR_CPY_WRT(&columns1, &columns);
	zephir_is_iterable(&columns, 0, "phalcon/Mvc/Model/Query.zep", 2700);
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _9)
		{
			...
			if (Z_TYPE_P(&column) != IS_ARRAY) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Invalid column definition", "phalcon/Mvc/Model/Query.zep", 2686);
				return;
			}
			zephir_array_fetch_string(&_11$$11, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2689 TSRMLS_CC);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_12$$16, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2689 TSRMLS_CC);
	...
	ZEPHIR_OBS_VAR(&metaData);
	zephir_read_property(&metaData, this_ptr, SL("_metaData"), PH_NOISY_CC);
	zephir_is_iterable(&columns, 0, "phalcon/Mvc/Model/Query.zep", 2810);
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columns), _15, _16, _13)
		{
			...
			zephir_array_fetch_string(&sqlColumn, &column, SL("column"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2724 TSRMLS_CC);
			zephir_array_fetch_string(&_17$$28, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2727 TSRMLS_CC);
			if (ZEPHIR_IS_STRING(&_17$$28, "object")) {
				ZEPHIR_OBS_NVAR(&modelName);
				zephir_array_fetch_string(&modelName, &column, SL("model"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2729 TSRMLS_CC);
				...
				if (isComplex) {
					...
					zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Model/Query.zep", 2765);
					if (Z_TYPE_P(&attributes) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _22$$31)
						{
							...
							zephir_array_append(&selectColumns, &_24$$34, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2758);
						} ZEND_HASH_FOREACH_END();
					} else {
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								zephir_array_append(&selectColumns, &_26$$35, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2758);
					...
					zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Model/Query.zep", 2784);
					if (Z_TYPE_P(&attributes) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _31$$37)
						{
							...
							zephir_array_append(&selectColumns, &_33$$38, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2782);
						} ZEND_HASH_FOREACH_END();
					} else {
						ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
						zephir_check_call_status();
						while (1) {
							...
							zephir_check_call_status();
								...
								zephir_array_append(&selectColumns, &_34$$39, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2782);
							ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
							zephir_check_call_status();
						}
					}
				...
				zephir_array_append(&selectColumns, &columnAlias, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2795);
			}
			_37$$28 = !isComplex;
			if (_37$$28) {
				_37$$28 = isSimpleStd;
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&sqlColumn);
				zephir_array_fetch_string(&sqlColumn, &column, SL("column"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2724 TSRMLS_CC);
				zephir_array_fetch_string(&_38$$46, &column, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 2727 TSRMLS_CC);
					...
					if (isComplex) {
						...
						if (Z_TYPE_P(&attributes) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _43$$49)
							{
								...
								zephir_array_append(&selectColumns, &_45$$52, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2758);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								...
								zephir_check_call_status();
									...
									zephir_array_append(&selectColumns, &_47$$53, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2758);
								ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
								zephir_check_call_status();
							}
						}
						...
						if (Z_TYPE_P(&attributes) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attributes), _52$$55)
							{
								...
								zephir_array_append(&selectColumns, &_54$$56, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2782);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &attributes, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								...
								zephir_check_call_status();
									...
									zephir_array_append(&selectColumns, &_55$$57, PH_SEPARATE, "phalcon/Mvc/Model/Query.zep", 2782);
								ZEPHIR_CALL_METHOD(NULL, &attributes, "next", NULL, 0);
								zephir_check_call_status();
							}
						}
	...
	if (Z_TYPE_P(bindParams) == IS_ARRAY) {
		...
		zephir_is_iterable(bindParams, 0, "phalcon/Mvc/Model/Query.zep", 2831);
		if (Z_TYPE_P(bindParams) == IS_ARRAY) {
	...
	if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
		...
		zephir_is_iterable(bindTypes, 0, "phalcon/Mvc/Model/Query.zep", 2847);
		if (Z_TYPE_P(bindTypes) == IS_ARRAY) {
	...
	if (!(isComplex)) {
		if (isSimpleStd) {
			...
			if (!(ZEPHIR_GLOBAL(orm).cast_on_hydrate)) {
				...
				if (Z_TYPE_P(&columnMap) == IS_NULL) {
					...
					zephir_check_call_status();
					zephir_is_iterable(&_75$$94, 0, "phalcon/Mvc/Model/Query.zep", 2938);
					if (Z_TYPE_P(&_75$$94) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_75$$94), _76$$94)
						{
							...
							zephir_array_fetch(&_79$$95, &typesColumnMap, &attribute, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2936 TSRMLS_CC);
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								zephir_array_fetch(&_81$$96, &typesColumnMap, &attribute, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2936 TSRMLS_CC);
					...
					array_init(&simpleColumnMap);
					zephir_is_iterable(&columnMap, 0, "phalcon/Mvc/Model/Query.zep", 2946);
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&columnMap), _84$$97, _85$$97, _82$$97)
						{
							...
							zephir_array_fetch(&_87$$98, &typesColumnMap, &column, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2944 TSRMLS_CC);
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								zephir_array_fetch(&_89$$99, &typesColumnMap, &column, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 2944 TSRMLS_CC);
		...
		if (_91$$87) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				if (!(zephir_class_exists(&resultsetClassName, 1 TSRMLS_CC))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_92$$102, "__construct", NULL, 1, &_93$$102);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_92$$102, "phalcon/Mvc/Model/Query.zep", 2962 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_INIT_VAR(&_94$$101);
				ZVAL_STRING(&_94$$101, "Phalcon\\Mvc\\Model\\ResultsetInterface");
				ZEPHIR_CALL_FUNCTION(&_95$$101, "is_subclass_of", NULL, 385, &resultsetClassName, &_94$$101);
				zephir_check_call_status();
				if (!(zephir_is_true(&_95$$101))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_96$$103, "__construct", NULL, 1, &_97$$103);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_96$$103, "phalcon/Mvc/Model/Query.zep", 2968 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 413, &simpleColumnMap, &resultObject, &resultData, &cache, &_101$$87);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 414, &columns1, &resultData, &cache);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_string(&modelName, &intermediate, SL("model"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3014 TSRMLS_CC);
	ZEPHIR_OBS_VAR(&manager);
	zephir_read_property(&manager, this_ptr, SL("_manager"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(&model);
	...
	ZEPHIR_OBS_VAR(&values);
	zephir_array_fetch_string(&values, &intermediate, SL("values"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3046 TSRMLS_CC);
	if (zephir_fast_count_int(&fields TSRMLS_CC) != zephir_fast_count_int(&values TSRMLS_CC)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "The column count does not match the values count", "phalcon/Mvc/Model/Query.zep", 3055);
		return;
	}
	ZEPHIR_CALL_METHOD(&dialect, &connection, "getdialect", NULL, 0);
	zephir_check_call_status();
	...
	zephir_is_iterable(&values, 0, "phalcon/Mvc/Model/Query.zep", 3129);
	if (Z_TYPE_P(&values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _3, _4, _1)
		{
			...
			zephir_array_fetch_string(&_5$$8, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 3067 TSRMLS_CC);
			do {
				...
				if (ZEPHIR_IS_LONG(&_5$$8, 273) || ZEPHIR_IS_LONG(&_5$$8, 274) || ZEPHIR_IS_LONG(&_5$$8, 277)) {
					if (Z_TYPE_P(bindParams) != IS_ARRAY) {
						ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Bound parameter cannot be replaced because placeholders is not an array", "phalcon/Mvc/Model/Query.zep", 3086);
						return;
					}
					...
					if (!(zephir_array_isset_fetch(&insertValue, bindParams, &wildcard, 0 TSRMLS_CC))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_11$$13, "__construct", &_13, 1, &_12$$13);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_11$$13, "phalcon/Mvc/Model/Query.zep", 3093 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					break;
			...
			zephir_array_fetch(&fieldName, &fields, &number, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3103 TSRMLS_CC);
			if (automaticFields) {
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0 TSRMLS_CC))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_17$$17, "__construct", &_13, 1, &_18$$17);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_17$$17, "phalcon/Mvc/Model/Query.zep", 3114 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&exprValue);
				zephir_array_fetch_string(&exprValue, &value, SL("value"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3066 TSRMLS_CC);
				zephir_array_fetch_string(&_19$$20, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 3067 TSRMLS_CC);
				do {
					...
					if (ZEPHIR_IS_LONG(&_19$$20, 273) || ZEPHIR_IS_LONG(&_19$$20, 274) || ZEPHIR_IS_LONG(&_19$$20, 277)) {
						...
						if (!(zephir_array_isset_fetch(&insertValue, bindParams, &wildcard, 0 TSRMLS_CC))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_25$$25, "__construct", &_13, 1, &_26$$25);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_25$$25, "phalcon/Mvc/Model/Query.zep", 3093 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						break;
				...
				if (automaticFields) {
					if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
						...
						if (!(zephir_array_isset_fetch(&attributeName, &columnMap, &fieldName, 0 TSRMLS_CC))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_29$$29, "__construct", &_13, 1, &_30$$29);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_29$$29, "phalcon/Mvc/Model/Query.zep", 3114 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
					} else {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_31, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	if (zephir_array_isset_long(&models, 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Updating several models at the same time is still not supported", "phalcon/Mvc/Model/Query.zep", 3159);
		return;
	}
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_long(&modelName, &models, 0, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3162 TSRMLS_CC);
	ZEPHIR_OBS_VAR(&model);
	zephir_read_property(&_0, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_0, &modelName, 0 TSRMLS_CC))) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&fields);
	zephir_array_fetch_string(&fields, &intermediate, SL("fields"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3181 TSRMLS_CC);
	ZEPHIR_OBS_VAR(&values);
	zephir_array_fetch_string(&values, &intermediate, SL("values"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3182 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&updateValues);
	array_init(&updateValues);
	ZEPHIR_CPY_WRT(&selectBindParams, bindParams);
	ZEPHIR_CPY_WRT(&selectBindTypes, bindTypes);
	zephir_is_iterable(&fields, 0, "phalcon/Mvc/Model/Query.zep", 3262);
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _4, _5, _2)
		{
			...
			ZVAL_COPY(&field, _2);
			ZEPHIR_OBS_NVAR(&value);
			zephir_array_fetch(&value, &values, &number, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3198 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&exprValue);
			zephir_array_fetch_string(&exprValue, &value, SL("value"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3199 TSRMLS_CC);
			if (zephir_array_isset_string(&field, SL("balias"))) {
				ZEPHIR_OBS_NVAR(&fieldName);
				zephir_array_fetch_string(&fieldName, &field, SL("balias"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3202 TSRMLS_CC);
			} else {
				ZEPHIR_OBS_NVAR(&fieldName);
				zephir_array_fetch_string(&fieldName, &field, SL("name"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3204 TSRMLS_CC);
			}
			zephir_array_fetch_string(&_6$$5, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 3207 TSRMLS_CC);
			do {
				...
				if (ZEPHIR_IS_LONG(&_6$$5, 273) || ZEPHIR_IS_LONG(&_6$$5, 274) || ZEPHIR_IS_LONG(&_6$$5, 277)) {
					if (Z_TYPE_P(bindParams) != IS_ARRAY) {
						ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Bound parameter cannot be replaced because placeholders is not an array", "phalcon/Mvc/Model/Query.zep", 3226);
						return;
					}
					...
					if (zephir_array_isset_fetch(&updateValue, bindParams, &wildcard, 0 TSRMLS_CC)) {
						...
						zephir_check_call_status();
						zephir_throw_exception_debug(&_12$$13, "phalcon/Mvc/Model/Query.zep", 3241 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
					break;
				...
				if (ZEPHIR_IS_LONG(&_6$$5, 277)) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Not supported", "phalcon/Mvc/Model/Query.zep", 3246);
					return;
				}
				ZEPHIR_INIT_NVAR(&updateValue);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_18$$16, &value, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Model/Query.zep", 3207 TSRMLS_CC);
				do {
					...
					if (ZEPHIR_IS_LONG(&_18$$16, 273) || ZEPHIR_IS_LONG(&_18$$16, 274) || ZEPHIR_IS_LONG(&_18$$16, 277)) {
						...
						if (zephir_array_isset_fetch(&updateValue, bindParams, &wildcard, 0 TSRMLS_CC)) {
							...
							zephir_check_call_status();
							zephir_throw_exception_debug(&_24$$24, "phalcon/Mvc/Model/Query.zep", 3241 TSRMLS_CC);
							ZEPHIR_MM_RESTORE();
							return;
						}
						break;
	...
	ZEPHIR_INIT_NVAR(&field);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 416, &model, &intermediate, &selectBindParams, &selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$27, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_28$$27);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_31$$28))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_33$$29, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_33$$29, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_35, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_35);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_OBS_VAR(&models);
	zephir_array_fetch_string(&models, &intermediate, SL("models"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3332 TSRMLS_CC);
	if (zephir_array_isset_long(&models, 1)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Delete from several models at the same time is still not supported", "phalcon/Mvc/Model/Query.zep", 3337);
		return;
	}
	ZEPHIR_OBS_VAR(&modelName);
	zephir_array_fetch_long(&modelName, &models, 0, PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3340 TSRMLS_CC);
	ZEPHIR_OBS_VAR(&model);
	zephir_read_property(&_0, this_ptr, SL("_modelsInstances"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_isset_fetch(&model, &_0, &modelName, 0 TSRMLS_CC))) {
		zephir_read_property(&_1$$4, this_ptr, SL("_manager"), PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 416, &model, &intermediate, bindParams, bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, bindParams, bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_5$$6))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_7$$7, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_7$$7, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 415, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_OBS_VAR(&_4);
	zephir_array_fetch_string(&_4, &intermediate, SL("models"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3432 TSRMLS_CC);
	zephir_array_update_string(&selectIr, SL("models"), &_4, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_4);
	zephir_array_fetch_string(&_4, &intermediate, SL("tables"), PH_NOISY, "phalcon/Mvc/Model/Query.zep", 3434 TSRMLS_CC);
	...
	ZEPHIR_CALL_METHOD(NULL, &query, "__construct", NULL, 417);
	zephir_check_call_status();
	zephir_read_property(&_5, this_ptr, SL("container"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &query, "setdi", NULL, 418, &_5);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 309);
	ZEPHIR_CALL_METHOD(NULL, &query, "settype", NULL, 419, &_6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &query, "setintermediate", NULL, 420, &selectIr);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(&query, "execute", NULL, 421, bindParams, bindTypes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	if (Z_TYPE_P(&cacheOptions) != IS_NULL) {
		if (Z_TYPE_P(&cacheOptions) != IS_ARRAY) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Invalid caching options", "phalcon/Mvc/Model/Query.zep", 3480);
			return;
		}
		ZEPHIR_OBS_VAR(&key);
		if (!(zephir_array_isset_string_fetch(&key, &cacheOptions, SL("key"), 0))) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "A cache key must be provided to identify the cached resultset in the cache backend", "phalcon/Mvc/Model/Query.zep", 3489);
			return;
		}
		...
		if (Z_TYPE_P(&cache) != IS_OBJECT) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Cache service must be an object", "phalcon/Mvc/Model/Query.zep", 3508);
			return;
		}
		...
		if (!(ZEPHIR_IS_EMPTY(&result))) {
			if (Z_TYPE_P(&result) != IS_OBJECT) {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Cache didn't return a valid resultset", "phalcon/Mvc/Model/Query.zep", 3517);
				return;
			}
			ZVAL_BOOL(&_1$$9, 0);
	...
	if (_2) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Bound parameters must be an array", "phalcon/Mvc/Model/Query.zep", 3572);
		return;
	}
	...
	if (_3) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Bound parameter types must be an array", "phalcon/Mvc/Model/Query.zep", 3576);
		return;
	}
	ZEPHIR_OBS_VAR(&type);
	...
	do {
		if (ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeselect", NULL, 422, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeinsert", NULL, 423, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeupdate", NULL, 424, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executedelete", NULL, 425, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$27, "__construct", NULL, 1, &_5$$27);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$27, "phalcon/Mvc/Model/Query.zep", 3619 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
	...
	if (Z_TYPE_P(&cacheOptions) != IS_NULL) {
		if (!ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "Only PHQL statements that return resultsets can be cached", "phalcon/Mvc/Model/Query.zep", 3633);
			return;
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleResult) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "execute", NULL, 421, bindParams, bindTypes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 422, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "This type of statement generates multiple SQL statements", "phalcon/Mvc/Model/Query.zep", 3813);
	return;
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getWriteConnection) {
	...
	if ((zephir_method_exists_ex(model, SL("selectwriteconnection") TSRMLS_CC) == SUCCESS)) {
		...
		zephir_check_call_status();
		if (Z_TYPE_P(&connection) != IS_OBJECT) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "selectWriteConnection did not return a connection", "phalcon/Mvc/Model/Query.zep", 3880);
			return;
		}
		RETURN_CCTOR(&connection);
	}
