...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_mvc_model_manager_mergefindparameters, 0, 0, 2)
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_model_manager_method_entry) {
	...
	PHP_ME(Phalcon_Mvc_Model_Manager, mergeFindParameters, arginfo_phalcon_mvc_model_manager_mergefindparameters, ZEND_ACC_PROTECTED|ZEND_ACC_FINAL)
