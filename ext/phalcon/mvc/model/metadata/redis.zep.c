...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Redis, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _5, "__construct", NULL, 277, _6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, _4, "__construct", NULL, 281, _5, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Redis, reset) {
	...
	if (Z_TYPE_P(meta) == IS_ARRAY) {
		...
		zephir_is_iterable(meta, &_2$$3, &_1$$3, 0, 0, "phalcon/mvc/model/metadata/redis.zep", 131);
		for (
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_redis_ce, this_ptr, "reset", &_5, 279);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
