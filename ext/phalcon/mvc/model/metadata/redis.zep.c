...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Redis, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 331, &_6);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Redis, reset) {
	...
	if (Z_TYPE_P(&meta) == IS_ARRAY) {
		...
		zephir_is_iterable(&meta, 0, "phalcon/mvc/model/metadata/redis.zep", 130);
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_redis_ce, this_ptr, "reset", &_5, 333);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
