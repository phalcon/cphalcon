...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, 277, _3);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 278, _2, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, reset) {
	...
	if (Z_TYPE_P(meta) == IS_ARRAY) {
		...
		zephir_is_iterable(meta, &_2$$3, &_1$$3, 0, 0, "phalcon/mvc/model/metadata/libmemcached.zep", 128);
		for (
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_libmemcached_ce, this_ptr, "reset", &_5, 279);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
