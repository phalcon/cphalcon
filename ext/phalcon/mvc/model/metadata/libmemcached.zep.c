...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, 338, _3);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, _1, "__construct", NULL, 339, _2, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, reset) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_libmemcached_ce, getThis(), "reset", &_5, 340);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
