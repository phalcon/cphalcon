...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model_MetaData_Libmemcached) {
	...
	zend_declare_property_null(phalcon_mvc_model_metadata_libmemcached_ce, SL("memcache"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_model_metadata_libmemcached_ce, SL("metaData"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(phalcon_mvc_model_metadata_libmemcached_ce, SL("ttl"), 172800, ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, __construct) {
	...
	if (!(zephir_array_isset_string(options, SL("servers")))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_model_exception_ce, "No servers given in options", "phalcon/Mvc/Model/Metadata/Libmemcached.zep", 67);
		return;
	}
	...
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 395, &_2, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Libmemcached, reset) {
	...
	if (Z_TYPE_P(&meta) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&meta), _2$$3, _3$$3, _1$$3)
		{
			...
			zephir_read_property(&_4$$4, this_ptr, SL("memcache"), PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_libmemcached_ce, getThis(), "reset", &_5, 0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
