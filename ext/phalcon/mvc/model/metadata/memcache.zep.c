...
PHP_METHOD(Phalcon_Mvc_Model_MetaData_Memcache, reset) {
	...
	if (Z_TYPE_P(&meta) == IS_ARRAY) {
		...
		zephir_is_iterable(&meta, 0, "phalcon/mvc/model/metadata/memcache.zep", 130);
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_mvc_model_metadata_memcache_ce, this_ptr, "reset", &_5, 333);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
