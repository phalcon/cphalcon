...
PHP_METHOD(Phalcon_Mvc_Model_Behavior_SoftDelete, notify) {
	...
	zval *type_param = NULL, *model, model_sub, options, value, field, updateModel, message, modelsManager, metaData, _0, _1, _2, _6, _3$$7, *_4$$7, _8$$9, _9$$9;
	zval type;
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, &modelsManager, "iskeepingsnapshots", NULL, 0, model);
	zephir_check_call_status();
	_7 = zephir_is_true(&_6);
	if (_7) {
		_7 = ZEPHIR_GLOBAL(orm).update_snapshot_on_save;
	}
	if (_7) {
