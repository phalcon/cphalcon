...
PHP_METHOD(Phalcon_Mvc_Url, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1103, router);
}
...
PHP_METHOD(Phalcon_Mvc_Url, get)
{
	...
	if (Z_TYPE_P(uri) == IS_ARRAY) {
		...
		zephir_read_property_cached(&_7$$9, this_ptr, _zephir_prop_0, 1103, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&router, &_7$$9);
		if (UNEXPECTED(!zephir_is_true(&router))) {
			zephir_read_property_cached(&_8$$11, this_ptr, _zephir_prop_1, 1104, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Url, getBaseUri)
{
	...
	if (Z_TYPE_P(&baseUri) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1105, &baseUri);
	}
...
PHP_METHOD(Phalcon_Mvc_Url, setBasePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1107, &basePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Url, setBaseUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1105, &baseUri_zv);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1106, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1106, &baseUri_zv);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Url, setStaticBaseUri)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1106, &staticBaseUri_zv);
	RETURN_THISW();
}
