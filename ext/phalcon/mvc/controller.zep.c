...
PHP_METHOD(Phalcon_Mvc_Controller, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 957, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Controller, fireManagerEvent)
{
	...
	zephir_read_property_cached(&eventsManager, this_ptr, _zephir_prop_0, 957, PH_NOISY_CC);
