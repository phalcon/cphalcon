...
PHP_METHOD(Phalcon_Mvc_Controller, getEventsManager)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 962, PH_NOISY_CC);
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Phalcon_Mvc_Controller, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 962, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_Controller, fireManagerEvent)
{
	...
	zephir_read_property_cached(&eventsManager, this_ptr, _zephir_prop_0, 962, PH_NOISY_CC);
