...
PHP_METHOD(Phalcon_Mvc_Application, handle)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 940, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_2, 941, PH_NOISY_CC);
	}
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 943, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(NULL, &response, "sendheaders", NULL, 0);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_45, this_ptr, _zephir_prop_5, 944, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Application, sendCookiesOnHandleRequest)
{
	...
	if (sendCookies) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 944, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 944, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Application, sendHeadersOnHandleRequest)
{
	...
	if (sendHeaders) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 943, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 943, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Application, useImplicitView)
{
	...
	if (implicitView) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 942, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 942, &__$false);
	}
	RETURN_THISW();
}
