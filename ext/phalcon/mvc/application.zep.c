...
PHP_METHOD(Phalcon_Mvc_Application, handle)
{
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_2, 949, PH_NOISY_CC);
	}
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 950, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_45, this_ptr, _zephir_prop_5, 952, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Application, sendCookiesOnHandleRequest)
{
	...
	if (sendCookies) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 952, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 952, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Application, sendHeadersOnHandleRequest)
{
	...
	if (sendHeaders) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 951, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 951, &__$false);
	}
	RETURN_THISW();
}
