...
PHP_METHOD(Phalcon_Mvc_Application, handle)
{
	...
	if (!(zephir_is_true(&moduleName))) {
		...
		zephir_read_property_cached(&moduleName, this_ptr, _zephir_prop_2, 942, PH_NOISY_CC);
	}
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_3, 943, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_45, this_ptr, _zephir_prop_5, 945, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Application, sendCookiesOnHandleRequest)
{
	...
	if (sendCookies) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 945, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 945, &__$false);
	}
	RETURN_THISW();
}
