	...
	for (
		...
		if ((Z_TYPE_P(methods) != IS_NULL)) {
			if ((Z_TYPE_P(request) == IS_NULL)) {
				...
				zephir_call_method_p1(_6, dependencyInjector, "getshared", _7);
