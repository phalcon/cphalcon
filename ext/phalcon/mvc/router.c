...
PHP_METHOD(Phalcon_Mvc_Router, handle) {
	...
	for (
		...
		if ((Z_TYPE_P(hostname) != IS_NULL)) {
			...
			if (zephir_memnstr_str(hostname, SL("("), "/Users/gutierrezandresfelipe/cphalcon/phalcon/mvc/router.zep", 426)) {
				if (zephir_memnstr_str(hostname, SL("#"), "/Users/gutierrezandresfelipe/cphalcon/phalcon/mvc/router.zep", 427)) {
		...
		if (zephir_memnstr_str(pattern, SL("^"), "/Users/gutierrezandresfelipe/cphalcon/phalcon/mvc/router.zep", 447)) {
