...
PHP_METHOD(Phalcon_Mvc_Router, handle) {
	...
	zend_function *_5 = NULL, *_9 = NULL, *_10 = NULL;
	HashTable *_3, *_13;
	HashPosition _2, _12;
	zval *uri = NULL, *realUri = NULL, *request = NULL, *currentHostName = NULL, *routeFound = NULL, *parts = NULL, *params, *matches, *notFoundPaths, *vnamespace, *module, *controller, *action, *paramsStr, *strParams, *route = NULL, *methods = NULL, *dependencyInjector = NULL, *hostname = NULL, *regexHostName = NULL, *matched = NULL, *pattern = NULL, *handledUri = NULL, *beforeMatch = NULL, *paths = NULL, *converters = NULL, *part = NULL, *position = NULL, *matchPosition = NULL, *converter = NULL, *_0, *_1, **_4, *_6 = NULL, *_7 = NULL, *_8 = NULL, *_11 = NULL, **_14, _15 = zval_used_for_init, *_16, *_17, *_18, *_19;
	...
	for (
		...
		if ((Z_TYPE_P(methods) != IS_NULL)) {
			if ((Z_TYPE_P(request) == IS_NULL)) {
				...
				zephir_call_method_p1_cache(_7, dependencyInjector, "getshared", _8, &_9);
				ZEPHIR_CPY_WRT(request, _7);
			}
			ZEPHIR_INIT_NVAR(_7);
			zephir_call_method_p1_cache(_7, request, "ismethod", methods, &_9);
		...
		if ((Z_TYPE_P(hostname) != IS_NULL)) {
			if ((Z_TYPE_P(request) == IS_NULL)) {
				...
				ZEPHIR_INIT_NVAR(_8);
				ZVAL_STRING(_8, "request", 1);
				zephir_call_method_p1_cache(_7, dependencyInjector, "getshared", _8, &_10);
				ZEPHIR_CPY_WRT(request, _7);
			}
		...
		if (zephir_is_true(routeFound)) {
			...
			zephir_call_method_cache(beforeMatch, route, "getbeforematch", &_10);
		...
		if (zephir_is_true(routeFound)) {
			...
			if ((Z_TYPE_P(matches) == IS_ARRAY)) {
				...
				zephir_call_method_cache(converters, route, "getconverters", &_10);
...
PHP_METHOD(Phalcon_Mvc_Router, mount) {
	...
	HashTable *_1, *_5;
	HashPosition _0, _4;
	zval *group, *groupRoutes, *beforeMatch, *hostname, *routes, *route = NULL, **_2, **_6, *_7;
	...
	if ((Z_TYPE_P(beforeMatch) != IS_NULL)) {
		...
		for (
			...
			zephir_call_method_p1_cache_noret(route, "beforematch", beforeMatch, &_3);
		}
	}
	...
	if ((Z_TYPE_P(hostname) != IS_NULL)) {
		...
		for (
			...
			zephir_call_method_p1_cache_noret(route, "sethostname", hostname, &_3);
		}
	}
	...
	if ((Z_TYPE_P(routes) == IS_ARRAY)) {
		ZEPHIR_INIT_VAR(_7);
		zephir_fast_array_merge(_7, &(routes), &(groupRoutes) TSRMLS_CC);
