...
PHP_METHOD(Phalcon_Mvc_View, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1162, &options);
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1163, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1164, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View, cleanTemplateAfter)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, cleanTemplateBefore)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1166, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, disable)
{
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1167, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1167, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, disableLevel)
{
	...
	if (Z_TYPE_P(level) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1168, level);
	} else {
...
PHP_METHOD(Phalcon_Mvc_View, getActiveRenderPath)
{
	...
	zephir_read_property_cached(&activeRenderPath, this_ptr, _zephir_prop_0, 1169, PH_NOISY_CC);
...
{
	zend_ulong _6$$4, _19$$9;
	zend_bool _16, _12$$4, _24$$9;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_10 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval view_zv, basePath, viewsDir, engines, extension, _0, _2, *_3, _15, _1$$3, _4$$4, *_5$$4, _11$$4, _8$$5, _9$$5, _13$$7, _14$$7, _17$$9, *_18$$9, _23$$9, _21$$10, _22$$10, _25$$12, _26$$12;
	zend_string *view = NULL, *_7$$4, *_20$$9;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&engines, this_ptr, _zephir_prop_1, 1163, PH_NOISY_CC);
	...
	zephir_check_call_status();
	zephir_is_iterable(&_2, 0, "phalcon/Mvc/View.zep", 556);
	if (Z_TYPE_P(&_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
		{
			...
			zephir_is_iterable(&engines, 0, "phalcon/Mvc/View.zep", 554);
			if (Z_TYPE_P(&engines) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _6$$4, _7$$4, _5$$4)
				{
					ZEPHIR_INIT_NVAR(&extension);
					if (_7$$4 != NULL) { 
						ZVAL_STR_COPY(&extension, _7$$4);
					} else {
						ZVAL_LONG(&extension, _6$$4);
					}
					ZEPHIR_INIT_NVAR(&_4$$4);
					ZVAL_COPY(&_4$$4, _5$$4);
					ZEPHIR_INIT_NVAR(&_9$$5);
					ZEPHIR_CONCAT_VVVV(&_9$$5, &basePath, &viewsDir, &view_zv, &extension);
					ZEPHIR_CALL_METHOD(&_8$$5, this_ptr, "phpfileexists", &_10, 0, &_9$$5);
					zephir_check_call_status();
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&_11$$4, &engines, "valid", NULL, 0);
					zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						ZEPHIR_CONCAT_VVVV(&_14$$7, &basePath, &viewsDir, &view_zv, &extension);
						ZEPHIR_CALL_METHOD(&_13$$7, this_ptr, "phpfileexists", &_10, 0, &_14$$7);
						zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_is_iterable(&engines, 0, "phalcon/Mvc/View.zep", 554);
				if (Z_TYPE_P(&engines) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _19$$9, _20$$9, _18$$9)
					{
						ZEPHIR_INIT_NVAR(&extension);
						if (_20$$9 != NULL) { 
							ZVAL_STR_COPY(&extension, _20$$9);
						} else {
							ZVAL_LONG(&extension, _19$$9);
						}
						ZEPHIR_INIT_NVAR(&_17$$9);
						ZVAL_COPY(&_17$$9, _18$$9);
						ZEPHIR_INIT_NVAR(&_22$$10);
						ZEPHIR_CONCAT_VVVV(&_22$$10, &basePath, &viewsDir, &view_zv, &extension);
						ZEPHIR_CALL_METHOD(&_21$$10, this_ptr, "phpfileexists", &_10, 0, &_22$$10);
						zephir_check_call_status();
						if (zephir_is_true(&_21$$10)) {
							RETURN_MM_BOOL(1);
						}
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_23$$9, &engines, "valid", NULL, 0);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&extension, &engines, "key", NULL, 0);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_17$$9, &engines, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_26$$12);
							ZEPHIR_CONCAT_VVVV(&_26$$12, &basePath, &viewsDir, &view_zv, &extension);
							ZEPHIR_CALL_METHOD(&_25$$12, this_ptr, "phpfileexists", &_10, 0, &_26$$12);
							zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View, partial)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *partialPath_param = NULL, *params = NULL, params_sub, __$null, viewParams, segment, segments, _3, *_4, _6, _7, _8, _9, _10, _0$$3, _1$$3, _2$$3;
	zval partialPath;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1164, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&viewParams, &_0$$3);
		ZEPHIR_INIT_VAR(&_1$$3);
		zephir_fast_array_merge(&_1$$3, &viewParams, params);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1164, &_1$$3);
	...
	array_init(&segments);
	ZEPHIR_INIT_VAR(&_3);
	zephir_fast_explode_str(&_3, SL("/"), &partialPath, LONG_MAX);
	zephir_is_iterable(&_3, 0, "phalcon/Mvc/View.zep", 625);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3), _4)
	{
		ZEPHIR_INIT_NVAR(&segment);
		ZVAL_COPY(&segment, _4);
		_5$$4 = !ZEPHIR_IS_STRING_IDENTICAL(&segment, ".");
		if (_5$$4) {
			_5$$4 = !ZEPHIR_IS_STRING_IDENTICAL(&segment, "..");
		}
		if (_5$$4) {
			zephir_array_append(&segments, &segment, PH_SEPARATE, "phalcon/Mvc/View.zep", 621);
		}
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&segment);
	ZEPHIR_INIT_NVAR(&partialPath);
	zephir_fast_join_str(&partialPath, SL("/"), &segments);
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "loadtemplateengines", NULL, 0);
	zephir_check_call_status();
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_1, 1171, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_8);
	ZEPHIR_CONCAT_VV(&_8, &_7, &partialPath);
	ZVAL_BOOL(&_9, 0);
	ZVAL_BOOL(&_10, 0);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &_6, &_8, &_9, &_10);
	zephir_check_call_status();
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1164, &viewParams);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View, pick)
{
	...
	if (Z_TYPE_P(renderView) == IS_ARRAY) {
		...
		ZVAL_NULL(&layout);
		if (zephir_memnstr_str(renderView, SL("/"), "phalcon/Mvc/View.zep", 672)) {
			ZEPHIR_INIT_VAR(&parts);
			zephir_fast_explode_str(&parts, SL("/"), renderView, LONG_MAX);
			ZEPHIR_OBS_NVAR(&layout);
			zephir_array_fetch_long(&layout, &parts, 0, PH_NOISY, "phalcon/Mvc/View.zep", 674);
		}
		...
		if (Z_TYPE_P(&layout) != IS_NULL) {
			zephir_array_append(&pickView, &layout, PH_SEPARATE, "phalcon/Mvc/View.zep", 680);
		}
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1172, &pickView);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, processRender)
{
	...
	zend_bool fireEvents, silence = 0, _5, _32, _16$$17, _26$$23;
	zval params;
	zval controllerName_zv, actionName_zv, *params_param = NULL, *fireEvents_param = NULL, layoutsDir, layout, pickView, layoutName, engines, renderView, pickViewAction, eventsManager, disabledLevels, templatesBefore, templatesAfter, templateBefore, templateAfter, _0, _2, _4, _8, _9, _1$$3, _6$$11, _7$$11, _10$$15, _11$$17, *_12$$17, _15$$17, _13$$18, _14$$18, _17$$19, _18$$19, _19$$21, _20$$21, _21$$23, *_22$$23, _25$$23, _23$$24, _24$$24, _27$$25, _28$$25, _29$$27, _30$$27, _31$$13, _33$$28;
	zend_string *controllerName = NULL, *actionName = NULL;
	zval *this_ptr = getThis();
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 1167, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "ob_get_contents", NULL, 0);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1174, &_1$$3);
		RETURN_MM_BOOL(0);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &controllerName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1176, &actionName_zv);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setvars", NULL, 0, &params);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_5, 1177, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&layoutsDir, &_2);
	if (!(zephir_is_true(&layoutsDir))) {
		ZEPHIR_INIT_NVAR(&layoutsDir);
		ZVAL_STRING(&layoutsDir, "layouts/");
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_6, 1178, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_7, 1172, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&pickView) == IS_NULL) {
		...
		zephir_array_fetch_long(&renderView, &pickView, 0, PH_NOISY, "phalcon/Mvc/View.zep", 759);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_8, 1179, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1174, &_8);
	silence = 1;
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_9, 1168, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&disabledLevels, &_2);
	zephir_memory_observe(&_9);
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_10, 1180, PH_NOISY_CC);
	...
	if (renderLevel) {
		if (renderLevel >= 1) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 1))) {
				ZVAL_UNDEF(&_10$$15);
				ZVAL_LONG(&_10$$15, 1);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_10$$15);
				if (silence) {
					ZVAL_BOOL(&_10$$15, 1);
				} else {
					ZVAL_BOOL(&_10$$15, 0);
		...
		if (renderLevel >= 2) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 2))) {
				ZVAL_UNDEF(&_11$$17);
				ZVAL_LONG(&_11$$17, 2);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_11$$17);
				zephir_read_property_cached(&_11$$17, this_ptr, _zephir_prop_11, 1166, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CPY_WRT(&templatesBefore, &_11$$17);
				silence = 0;
				zephir_is_iterable(&templatesBefore, 0, "phalcon/Mvc/View.zep", 835);
				if (Z_TYPE_P(&templatesBefore) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&templatesBefore), _12$$17)
					{
						...
						ZEPHIR_CONCAT_VV(&_13$$18, &layoutsDir, &templateBefore);
						if (silence) {
							ZVAL_BOOL(&_14$$18, 1);
						} else {
							ZVAL_BOOL(&_14$$18, 0);
						}
						ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &engines, &_13$$18, &_14$$18);
						zephir_check_call_status();
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_15$$17, &templatesBefore, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_15$$17)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&templateBefore, &templatesBefore, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_17$$19);
							ZEPHIR_CONCAT_VV(&_17$$19, &layoutsDir, &templateBefore);
							if (silence) {
								ZVAL_BOOL(&_18$$19, 1);
							} else {
								ZVAL_BOOL(&_18$$19, 0);
							}
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &engines, &_17$$19, &_18$$19);
							zephir_check_call_status();
					}
				}
				ZEPHIR_INIT_NVAR(&templateBefore);
		...
		if (renderLevel >= 3) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 3))) {
				ZVAL_UNDEF(&_19$$21);
				ZVAL_LONG(&_19$$21, 3);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_19$$21);
				ZEPHIR_INIT_VAR(&_20$$21);
				ZEPHIR_CONCAT_VV(&_20$$21, &layoutsDir, &layoutName);
				if (silence) {
					ZVAL_BOOL(&_19$$21, 1);
				} else {
					ZVAL_BOOL(&_19$$21, 0);
				}
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &engines, &_20$$21, &_19$$21);
				zephir_check_call_status();
			}
		}
		if (renderLevel >= 4) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 4))) {
				ZVAL_UNDEF(&_21$$23);
				ZVAL_LONG(&_21$$23, 4);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_21$$23);
				zephir_read_property_cached(&_21$$23, this_ptr, _zephir_prop_12, 1165, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_CPY_WRT(&templatesAfter, &_21$$23);
				silence = 0;
				zephir_is_iterable(&templatesAfter, 0, "phalcon/Mvc/View.zep", 871);
				if (Z_TYPE_P(&templatesAfter) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&templatesAfter), _22$$23)
					{
						ZEPHIR_INIT_NVAR(&templateAfter);
						ZVAL_COPY(&templateAfter, _22$$23);
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_25$$23, &templatesAfter, "valid", NULL, 0);
						zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							ZEPHIR_CONCAT_VV(&_27$$25, &layoutsDir, &templateAfter);
							if (silence) {
								ZVAL_BOOL(&_28$$25, 1);
							} else {
								ZVAL_BOOL(&_28$$25, 0);
							}
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &engines, &_27$$25, &_28$$25);
							zephir_check_call_status();
					}
				}
				ZEPHIR_INIT_NVAR(&templateAfter);
		...
		if (renderLevel >= 5) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 5))) {
				ZVAL_UNDEF(&_29$$27);
				ZVAL_LONG(&_29$$27, 5);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_29$$27);
				zephir_read_property_cached(&_29$$27, this_ptr, _zephir_prop_13, 1181, PH_NOISY_CC | PH_READONLY);
				if (silence) {
					ZVAL_BOOL(&_30$$27, 1);
				} else {
					ZVAL_BOOL(&_30$$27, 0);
				}
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "enginerender", NULL, 0, &engines, &_29$$27, &_30$$27);
				zephir_check_call_status();
			}
		}
		ZVAL_UNDEF(&_31$$13);
		ZVAL_LONG(&_31$$13, 0);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &_31$$13);
	}
	_32 = fireEvents;
	if (_32) {
		_32 = Z_TYPE_P(&eventsManager) == IS_OBJECT;
	}
	if (_32) {
		ZEPHIR_INIT_VAR(&_33$$28);
		ZVAL_STRING(&_33$$28, "view:afterRender");
		ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", NULL, 0, &_33$$28, this_ptr);
		zephir_check_call_status();
	}
	RETURN_MM_BOOL(1);
}
...
PHP_METHOD(Phalcon_Mvc_View, registerEngines)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1163, &engines);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, reset)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1180, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1174, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1166, &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1165, &_2);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setBasePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1170, &basePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setLayout)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1178, &layout_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setLayoutsDir)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1177, &layoutsDir_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setMainView)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1181, &viewPath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setPartialsDir)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1171, &partialsDir_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateAfter)
{
	...
	if (Z_TYPE_P(templateAfter) != IS_ARRAY) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, templateAfter);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateBefore)
{
	...
	if (Z_TYPE_P(templateBefore) != IS_ARRAY) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1166, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1166, templateBefore);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setVars)
{
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1164, PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &params);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1164, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1164, &params);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setViewsDir)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *viewsDir, viewsDir_sub, position, directory, newViewsDir, _1$$3, _2$$4, *_3$$5, _9$$5, _6$$7, _8$$6, _11$$9, _12$$8;
	zval *this_ptr = getThis();
	...
	if (_0) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/View.zep", 1139);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (Z_TYPE_P(viewsDir) == IS_STRING) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1183, &_2$$4);
	} else {
		ZEPHIR_INIT_VAR(&newViewsDir);
		array_init(&newViewsDir);
		zephir_is_iterable(viewsDir, 0, "phalcon/Mvc/View.zep", 1155);
		if (Z_TYPE_P(viewsDir) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(viewsDir), _4$$5, _5$$5, _3$$5)
			{
				...
				if (Z_TYPE_P(&directory) != IS_STRING) {
					...
					object_init_ex(&_6$$7, phalcon_mvc_view_exceptions_viewsdiritemmustbestring_ce);
					ZEPHIR_CALL_METHOD(NULL, &_6$$7, "__construct", &_7, 0);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_6$$7, "phalcon/Mvc/View.zep", 1149);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_CALL_METHOD(&_8$$6, this_ptr, "todirseparator", NULL, 0, &directory);
				zephir_check_call_status();
				zephir_array_update_zval(&newViewsDir, &position, &_8$$6, PH_COPY | PH_SEPARATE);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				ZEPHIR_CALL_METHOD(&_9$$5, viewsDir, "valid", NULL, 0);
				zephir_check_call_status();
				...
				zephir_check_call_status();
					if (Z_TYPE_P(&directory) != IS_STRING) {
						...
						object_init_ex(&_11$$9, phalcon_mvc_view_exceptions_viewsdiritemmustbestring_ce);
						ZEPHIR_CALL_METHOD(NULL, &_11$$9, "__construct", &_7, 0);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_11$$9, "phalcon/Mvc/View.zep", 1149);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "todirseparator", NULL, 0, &directory);
					zephir_check_call_status();
					zephir_array_update_zval(&newViewsDir, &position, &_12$$8, PH_COPY | PH_SEPARATE);
			}
		}
		ZEPHIR_INIT_NVAR(&directory);
		ZEPHIR_INIT_NVAR(&position);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1183, &newViewsDir);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, start)
{
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_0);
	RETURN_THIS();
}
...
{
	zend_ulong _6$$3, _31$$16;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_4 = NULL, *_9 = NULL, *_13 = NULL, *_16 = NULL, *_23 = NULL, *_26 = NULL, *_37 = NULL, *_40 = NULL, *_47 = NULL, *_50 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool silence, mustClean, _28, _18$$3, _42$$16;
	zend_string *viewPath = NULL, *_7$$3, *_32$$16;
	zval *engines_param = NULL, viewPath_zv, *silence_param = NULL, *mustClean_param = NULL, basePath, engine, eventsManager, extension, viewsDir, viewsDirPath, viewEnginePath, viewEnginePaths, viewParams, _0, _1, *_2, _27, _3$$3, *_5$$3, _17$$3, _8$$6, _11$$8, _12$$8, _14$$7, _15$$10, _19$$11, _21$$13, _22$$13, _24$$12, _25$$15, _29$$16, *_30$$16, _41$$16, _33$$19, _35$$21, _36$$21, _38$$20, _39$$23, _43$$24, _45$$26, _46$$26, _48$$25, _49$$28, _51$$29, _52$$30;
	zval engines, _10$$8, _20$$13, _34$$21, _44$$26;
	zval *this_ptr = getThis();
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1179, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&eventsManager, &_0);
	ZEPHIR_INIT_VAR(&viewEnginePaths);
	array_init(&viewEnginePaths);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getviewsdirs", NULL, 0);
	zephir_check_call_status();
	zephir_is_iterable(&_1, 0, "phalcon/Mvc/View.zep", 1261);
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
		{
			ZEPHIR_INIT_NVAR(&viewsDir);
			ZVAL_COPY(&viewsDir, _2);
			ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "isabsolutepath", &_4, 0, &viewPath_zv);
			zephir_check_call_status();
			...
			zephir_is_iterable(&engines, 0, "phalcon/Mvc/View.zep", 1256);
			if (Z_TYPE_P(&engines) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _6$$3, _7$$3, _5$$3)
				{
					...
					ZEPHIR_CALL_METHOD(&_8$$6, this_ptr, "phpfileexists", &_9, 0, &viewEnginePath);
					zephir_check_call_status();
					if (zephir_is_true(&_8$$6)) {
						if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
							...
							zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1169, &_10$$8);
					...
					zephir_array_append(&viewEnginePaths, &viewEnginePath, PH_SEPARATE, "phalcon/Mvc/View.zep", 1254);
				} ZEND_HASH_FOREACH_END();
			} else {
				ZEPHIR_CALL_METHOD(NULL, &engines, "rewind", NULL, 0);
				zephir_check_call_status();
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&_17$$3, &engines, "valid", NULL, 0);
					zephir_check_call_status();
					...
					zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&viewEnginePath);
						ZEPHIR_CONCAT_VV(&viewEnginePath, &viewsDirPath, &extension);
						ZEPHIR_CALL_METHOD(&_19$$11, this_ptr, "phpfileexists", &_9, 0, &viewEnginePath);
						zephir_check_call_status();
						if (zephir_is_true(&_19$$11)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_20$$13);
								zephir_create_array(&_20$$13, 1, 0);
								zephir_array_fast_append(&_20$$13, &viewEnginePath);
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1169, &_20$$13);
								ZEPHIR_INIT_NVAR(&_22$$13);
								ZVAL_STRING(&_22$$13, "view:beforeRenderView");
								ZEPHIR_CALL_METHOD(&_21$$13, &eventsManager, "fire", &_23, 0, &_22$$13, this_ptr, &viewEnginePath);
								zephir_check_call_status();
								if (ZEPHIR_IS_FALSE_IDENTICAL(&_21$$13)) {
									continue;
								}
							}
							if (mustClean) {
							...
							ZEPHIR_CALL_METHOD(NULL, &engine, "render", NULL, 0, &viewEnginePath, &viewParams, &_24$$12);
							zephir_check_call_status();
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_25$$15);
								ZVAL_STRING(&_25$$15, "view:afterRenderView");
								ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", &_26, 0, &_25$$15, this_ptr);
								zephir_check_call_status();
							}
							RETURN_MM_NULL();
						}
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_29$$16, this_ptr, "isabsolutepath", &_4, 0, &viewPath_zv);
				zephir_check_call_status();
				...
				zephir_is_iterable(&engines, 0, "phalcon/Mvc/View.zep", 1256);
				if (Z_TYPE_P(&engines) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _31$$16, _32$$16, _30$$16)
					{
						ZEPHIR_INIT_NVAR(&extension);
						if (_32$$16 != NULL) { 
							ZVAL_STR_COPY(&extension, _32$$16);
						} else {
							ZVAL_LONG(&extension, _31$$16);
						}
						ZEPHIR_INIT_NVAR(&engine);
						ZVAL_COPY(&engine, _30$$16);
						ZEPHIR_INIT_NVAR(&viewEnginePath);
						ZEPHIR_CONCAT_VV(&viewEnginePath, &viewsDirPath, &extension);
						ZEPHIR_CALL_METHOD(&_33$$19, this_ptr, "phpfileexists", &_9, 0, &viewEnginePath);
						zephir_check_call_status();
						if (zephir_is_true(&_33$$19)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_34$$21);
								zephir_create_array(&_34$$21, 1, 0);
								zephir_array_fast_append(&_34$$21, &viewEnginePath);
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1169, &_34$$21);
								ZEPHIR_INIT_NVAR(&_36$$21);
								ZVAL_STRING(&_36$$21, "view:beforeRenderView");
								ZEPHIR_CALL_METHOD(&_35$$21, &eventsManager, "fire", &_37, 0, &_36$$21, this_ptr, &viewEnginePath);
								zephir_check_call_status();
								if (ZEPHIR_IS_FALSE_IDENTICAL(&_35$$21)) {
									continue;
								}
							}
							if (mustClean) {
							...
							ZEPHIR_CALL_METHOD(NULL, &engine, "render", NULL, 0, &viewEnginePath, &viewParams, &_38$$20);
							zephir_check_call_status();
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								ZEPHIR_INIT_NVAR(&_39$$23);
								ZVAL_STRING(&_39$$23, "view:afterRenderView");
								ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", &_40, 0, &_39$$23, this_ptr);
								zephir_check_call_status();
							}
							RETURN_MM_NULL();
						}
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_41$$16, &engines, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_41$$16)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&extension, &engines, "key", NULL, 0);
						zephir_check_call_status();
						...
						zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&viewEnginePath);
							ZEPHIR_CONCAT_VV(&viewEnginePath, &viewsDirPath, &extension);
							ZEPHIR_CALL_METHOD(&_43$$24, this_ptr, "phpfileexists", &_9, 0, &viewEnginePath);
							zephir_check_call_status();
							if (zephir_is_true(&_43$$24)) {
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									ZEPHIR_INIT_NVAR(&_44$$26);
									zephir_create_array(&_44$$26, 1, 0);
									zephir_array_fast_append(&_44$$26, &viewEnginePath);
									zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1169, &_44$$26);
									ZEPHIR_INIT_NVAR(&_46$$26);
									ZVAL_STRING(&_46$$26, "view:beforeRenderView");
									ZEPHIR_CALL_METHOD(&_45$$26, &eventsManager, "fire", &_47, 0, &_46$$26, this_ptr, &viewEnginePath);
									zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &engine, "render", NULL, 0, &viewEnginePath, &viewParams, &_48$$25);
								zephir_check_call_status();
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									ZEPHIR_INIT_NVAR(&_49$$28);
									ZVAL_STRING(&_49$$28, "view:afterRenderView");
									ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", &_50, 0, &_49$$28, this_ptr);
									zephir_check_call_status();
								}
								RETURN_MM_NULL();
							}
	...
	ZEPHIR_INIT_NVAR(&viewsDir);
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1169, &viewEnginePaths);
		ZEPHIR_INIT_VAR(&_51$$29);
		ZVAL_STRING(&_51$$29, "view:notFoundView");
		ZEPHIR_CALL_METHOD(NULL, &eventsManager, "fire", NULL, 0, &_51$$29, this_ptr, &viewEnginePath);
		zephir_check_call_status();
	}
	if (!(silence)) {
		ZEPHIR_INIT_VAR(&_52$$30);
		object_init_ex(&_52$$30, phalcon_mvc_view_exceptions_viewnotfound_ce);
		ZEPHIR_CALL_METHOD(NULL, &_52$$30, "__construct", NULL, 0, &viewPath_zv);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_52$$30, "phalcon/Mvc/View.zep", 1268);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_View, getViewsDirs)
{
	...
	if (Z_TYPE_P(&_0) == IS_STRING) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1183, PH_NOISY_CC);
...
{
	zval _14$$11, _21$$17;
	zend_class_entry *_8$$9, *_18$$15;
	zend_bool _16$$5;
	zend_string *_6$$5;
	zend_ulong _5$$5;
	zval engines, di, registeredEngines, engineService, extension, _0, _1$$3, _2$$4, _3$$6, *_4$$5, _15$$5, _7$$9, _11$$12, _13$$11, _17$$15, _19$$18, _20$$17;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		array_init(&engines);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 1163, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_EMPTY(&registeredEngines)) {
			...
			if (Z_TYPE_P(&di) != IS_OBJECT) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_3$$6, "phalcon/Mvc/View.zep", 1322);
				ZEPHIR_MM_RESTORE();
				return;
			}
			zephir_is_iterable(&registeredEngines, 0, "phalcon/Mvc/View.zep", 1357);
			if (Z_TYPE_P(&registeredEngines) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&registeredEngines), _5$$5, _6$$5, _4$$5)
				{
					...
					if (Z_TYPE_P(&engineService) == IS_OBJECT) {
						if (zephir_is_instance_of(&engineService, SL("Closure"))) {
							...
							ZEPHIR_CALL_FUNCTION(&_7$$9, "call_user_func", &_10, 82, &engineService, this_ptr);
							zephir_check_call_status();
						...
						if (Z_TYPE_P(&engineService) != IS_STRING) {
							...
							object_init_ex(&_11$$12, phalcon_mvc_view_exceptions_invalidengineregistration_ce);
							ZEPHIR_CALL_METHOD(NULL, &_11$$12, "__construct", &_12, 0, &extension);
							zephir_check_call_status();
							zephir_throw_exception_debug(&_11$$12, "phalcon/Mvc/View.zep", 1348);
							ZEPHIR_MM_RESTORE();
							return;
						}
						ZEPHIR_INIT_NVAR(&_14$$11);
						zephir_create_array(&_14$$11, 1, 0);
						zephir_array_fast_append(&_14$$11, this_ptr);
						ZEPHIR_CALL_METHOD(&_13$$11, &di, "get", NULL, 0, &engineService, &_14$$11);
						zephir_check_call_status();
				...
				while (1) {
					...
					ZEPHIR_CALL_METHOD(&_15$$5, &registeredEngines, "valid", NULL, 0);
					zephir_check_call_status();
					...
					zephir_check_call_status();
						if (Z_TYPE_P(&engineService) == IS_OBJECT) {
							if (zephir_is_instance_of(&engineService, SL("Closure"))) {
								_18$$15 = zephir_fetch_class_str_ex(SL("Closure"), ZEND_FETCH_CLASS_AUTO);
								ZEPHIR_CALL_CE_STATIC(&_17$$15, _18$$15, "bind", &_9, 0, &engineService, &di);
								zephir_check_call_status();
								ZEPHIR_CPY_WRT(&engineService, &_17$$15);
								ZEPHIR_CALL_FUNCTION(&_17$$15, "call_user_func", &_10, 82, &engineService, this_ptr);
								zephir_check_call_status();
								zephir_array_update_zval(&engines, &extension, &_17$$15, PH_COPY | PH_SEPARATE);
							} else {
								zephir_array_update_zval(&engines, &extension, &engineService, PH_COPY | PH_SEPARATE);
							}
						} else {
							if (Z_TYPE_P(&engineService) != IS_STRING) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_19$$18, "__construct", &_12, 0, &extension);
								zephir_check_call_status();
								zephir_throw_exception_debug(&_19$$18, "phalcon/Mvc/View.zep", 1348);
								ZEPHIR_MM_RESTORE();
								return;
							}
...
PHP_METHOD(Phalcon_Mvc_View, getRegisteredEngines)
{
	...
	zephir_memory_observe(&_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 1163, PH_NOISY_CC);
	zephir_get_arrval(&_1, &_0);
	RETURN_CTOR(&_1);
}
...
PHP_METHOD(Phalcon_Mvc_View, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &content_zv);
	RETURN_THISW();
}
