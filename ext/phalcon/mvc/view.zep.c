...
PHP_METHOD(Phalcon_Mvc_View, partial)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_12, this_ptr, _zephir_prop_1, 1177, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_13);
	...
	if (renderLevel) {
		...
		if (renderLevel >= 3) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 3))) {
				ZVAL_UNDEF(&_21$$21);
				ZVAL_LONG(&_21$$21, 3);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1179, &_21$$21);
		...
		if (renderLevel >= 4) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 4))) {
				ZVAL_UNDEF(&_23$$23);
				ZVAL_LONG(&_23$$23, 4);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1179, &_23$$23);
				zephir_read_property_cached(&_23$$23, this_ptr, _zephir_prop_12, 1171, PH_NOISY_CC | PH_READONLY);
		...
		if (renderLevel >= 5) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 5))) {
				ZVAL_UNDEF(&_33$$27);
				ZVAL_LONG(&_33$$27, 5);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1179, &_33$$27);
				zephir_read_property_cached(&_33$$27, this_ptr, _zephir_prop_13, 1187, PH_NOISY_CC | PH_READONLY);
				if (silence) {
					ZVAL_BOOL(&_34$$27, 1);
				} else {
					ZVAL_BOOL(&_34$$27, 0);
		...
		ZVAL_UNDEF(&_35$$13);
		ZVAL_LONG(&_35$$13, 0);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1179, &_35$$13);
	}
	_36 = fireEvents;
	if (_36) {
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _8$$3, _9$$3, _7$$3)
				{
					...
					if (zephir_is_true(&_10$$6)) {
						if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
							...
							zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &_12$$8);
					...
					zephir_check_call_status();
						...
						if (zephir_is_true(&_21$$11)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &_22$$13);
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _33$$16, _34$$16, _32$$16)
					{
						...
						if (zephir_is_true(&_35$$19)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &_36$$21);
						...
						zephir_check_call_status();
							...
							if (zephir_is_true(&_45$$24)) {
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									...
									zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &_46$$26);
