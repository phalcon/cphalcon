...
PHP_METHOD(Phalcon_Mvc_View, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1164, &_0);
	ZEPHIR_INIT_VAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1165, &_1);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View, disableLevel)
{
	...
	if (Z_TYPE_P(level) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1169, level);
	} else {
...
PHP_METHOD(Phalcon_Mvc_View, getActiveRenderPath)
{
	...
	zephir_read_property_cached(&activeRenderPath, this_ptr, _zephir_prop_0, 1170, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_View, has)
{
	...
	zephir_read_property_cached(&engines, this_ptr, _zephir_prop_1, 1164, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_View, partial)
{
	...
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 1165, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&viewParams, &_0$$3);
		ZEPHIR_INIT_VAR(&_1$$3);
		zephir_fast_array_merge(&_1$$3, &viewParams, params);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &_1$$3);
	...
	zephir_check_call_status();
	if (Z_TYPE_P(params) == IS_ARRAY) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &viewParams);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_View, pick)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1173, &pickView);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, processRender)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1175, &_1$$3);
		RETURN_MM_BOOL(0);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1176, &controllerName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1177, &actionName_zv);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "setvars", NULL, 0, &params);
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_5, 1178, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&layoutsDir, &_2);
	if (!(zephir_is_true(&layoutsDir))) {
		ZEPHIR_INIT_NVAR(&layoutsDir);
		ZVAL_STRING(&layoutsDir, "layouts/");
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_6, 1179, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_7, 1173, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_8, 1180, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1175, &_8);
	silence = 1;
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_9, 1169, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&disabledLevels, &_2);
	zephir_memory_observe(&_9);
	zephir_read_property_cached(&_9, this_ptr, _zephir_prop_10, 1181, PH_NOISY_CC);
	...
	if (renderLevel) {
		if (renderLevel >= 1) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 1))) {
				ZVAL_UNDEF(&_10$$15);
				ZVAL_LONG(&_10$$15, 1);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_10$$15);
				if (silence) {
					ZVAL_BOOL(&_10$$15, 1);
				} else {
					ZVAL_BOOL(&_10$$15, 0);
		...
		if (renderLevel >= 2) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 2))) {
				ZVAL_UNDEF(&_11$$17);
				ZVAL_LONG(&_11$$17, 2);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_11$$17);
				zephir_read_property_cached(&_11$$17, this_ptr, _zephir_prop_11, 1167, PH_NOISY_CC | PH_READONLY);
		...
		if (renderLevel >= 3) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 3))) {
				ZVAL_UNDEF(&_19$$21);
				ZVAL_LONG(&_19$$21, 3);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_19$$21);
		...
		if (renderLevel >= 4) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 4))) {
				ZVAL_UNDEF(&_21$$23);
				ZVAL_LONG(&_21$$23, 4);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_21$$23);
				zephir_read_property_cached(&_21$$23, this_ptr, _zephir_prop_12, 1166, PH_NOISY_CC | PH_READONLY);
		...
		if (renderLevel >= 5) {
			if (!(zephir_array_isset_value_long(&disabledLevels, 5))) {
				ZVAL_UNDEF(&_29$$27);
				ZVAL_LONG(&_29$$27, 5);
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_29$$27);
				zephir_read_property_cached(&_29$$27, this_ptr, _zephir_prop_13, 1182, PH_NOISY_CC | PH_READONLY);
				if (silence) {
					ZVAL_BOOL(&_30$$27, 1);
				} else {
					ZVAL_BOOL(&_30$$27, 0);
		...
		ZVAL_UNDEF(&_31$$13);
		ZVAL_LONG(&_31$$13, 0);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1174, &_31$$13);
	}
	_32 = fireEvents;
	if (_32) {
...
PHP_METHOD(Phalcon_Mvc_View, reset)
{
	...
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1183, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1183, &__$false);
	}
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 5);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1181, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1175, &_1);
	ZEPHIR_INIT_NVAR(&_1);
	array_init(&_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 1167, &_1);
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 1166, &_2);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setBasePath)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1171, &basePath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1180, eventsManager);
}
...
PHP_METHOD(Phalcon_Mvc_View, setLayout)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1179, &layout_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setLayoutsDir)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1178, &layoutsDir_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setMainView)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1182, &viewPath_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setPartialsDir)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1172, &partialsDir_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateAfter)
{
	...
	if (Z_TYPE_P(templateAfter) != IS_ARRAY) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1166, templateAfter);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setTemplateBefore)
{
	...
	if (Z_TYPE_P(templateBefore) != IS_ARRAY) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1167, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1167, templateBefore);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setVars)
{
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1165, PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &params);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &_0$$3);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1165, &params);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, setViewsDir)
{
	...
	if (Z_TYPE_P(viewsDir) == IS_STRING) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1184, &_2$$4);
	} else {
		...
		ZEPHIR_INIT_NVAR(&directory);
		ZEPHIR_INIT_NVAR(&position);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1184, &newViewsDir);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Mvc_View, engineRender)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 1180, PH_NOISY_CC | PH_READONLY);
				...
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _6$$3, _7$$3, _5$$3)
				{
					...
					if (zephir_is_true(&_8$$6)) {
						if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
							...
							zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1170, &_10$$8);
					...
					zephir_check_call_status();
						...
						if (zephir_is_true(&_19$$11)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1170, &_20$$13);
					...
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&engines), _31$$16, _32$$16, _30$$16)
					{
						...
						if (zephir_is_true(&_33$$19)) {
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								...
								zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1170, &_34$$21);
						...
						zephir_check_call_status();
							...
							if (zephir_is_true(&_43$$24)) {
								if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
									...
									zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1170, &_44$$26);
	...
	ZEPHIR_INIT_NVAR(&viewsDir);
	if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1170, &viewEnginePaths);
...
PHP_METHOD(Phalcon_Mvc_View, getViewsDirs)
{
	...
	if (Z_TYPE_P(&_0) == IS_STRING) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 1184, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Mvc_View, loadTemplateEngines)
{
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&engines)) {
		...
		array_init(&engines);
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_2, 1164, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_View, setContent)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1175, &content_zv);
	RETURN_THISW();
}
