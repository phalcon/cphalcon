...
PHP_METHOD(Phalcon_Mvc_Router_Group, __construct)
{
	...
	if (_0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1131, paths);
	}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, beforeMatch)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1132, beforeMatch);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, clear)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1133, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1135, &prefix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, addRoute)
{
	...
	zephir_read_property_cached(&defaultPaths, this_ptr, _zephir_prop_0, 1131, PH_NOISY_CC);
	...
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 257, &_1, &mergedPaths, httpMethods);
	zephir_check_call_status();
