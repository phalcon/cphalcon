...
PHP_METHOD(Phalcon_Mvc_Router_Group, __construct)
{
	...
	if (_0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1127, paths);
	}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, beforeMatch)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1128, beforeMatch);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, setHostname)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1130, &hostname_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1131, &prefix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, addRoute)
{
	...
	zephir_read_property_cached(&defaultPaths, this_ptr, _zephir_prop_0, 1127, PH_NOISY_CC);
