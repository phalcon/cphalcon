...
PHP_METHOD(Phalcon_Mvc_Router_Group, __construct)
{
	...
	if (_0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1160, paths);
	}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, beforeMatch)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1161, beforeMatch);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, setHostname)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1163, &hostname_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Group, setPrefix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1164, &prefix_zv);
	RETURN_THISW();
}
