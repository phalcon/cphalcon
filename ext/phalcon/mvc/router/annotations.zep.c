...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, handle)
{
	...
	if (Z_TYPE_P(&handlers) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&handlers), _3)
		{
			...
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 1134, &__$null);
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, processActionAnnotation)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 1134, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&routePrefix, &_2);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 1136, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_2) != IS_NULL) {
		zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_2, 1136, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, processControllerAnnotation)
{
	...
	if (ZEPHIR_IS_STRING(&_0, "RoutePrefix")) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1134, &_1$$3);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, setActionSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1135, &actionSuffix_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, setActionPreformatCallback)
{
	...
	if (EXPECTED(zephir_is_callable(callback))) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1136, &_0$$4);
	} else {
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, setControllerSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1133, &controllerSuffix_zv);
	RETURN_THISW();
}
