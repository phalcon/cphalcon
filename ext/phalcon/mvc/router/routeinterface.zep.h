...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_mvc_router_routeinterface_gethttpmethods, 0, 0, MAY_BE_NULL|MAY_BE_ARRAY|MAY_BE_STRING)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_mvc_router_routeinterface_setrouteid, 0, 1, Phalcon\\Mvc\\Router\\RouteInterface, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_mvc_router_routeinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Mvc_Router_RouteInterface, setRouteId, arginfo_phalcon_mvc_router_routeinterface_setrouteid)
