...
PHP_METHOD(Phalcon_Mvc_Router_Route, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1130, &_1);
	ZVAL_UNDEF(&_0);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, getCompiledHostName)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1133, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&hostname, &_1);
	if (Z_TYPE_P(&hostname) == IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1132, &__$null);
		RETURN_MM_NULL();
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1132, &regexHostName);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, match)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &callback);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1135, callback);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, reConfigure)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1136, &pattern_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1137, &compiledPattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1134, &routePaths);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setGroup)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1138, group);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setHostname)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1133, &hostname_zv);
	if (0) {
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&name_zv, name);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1139, &name_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setRouteId)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1130, &routeId_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, via)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1140, httpMethods);
	RETURN_THISW();
}
