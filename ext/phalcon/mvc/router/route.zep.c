...
PHP_METHOD(Phalcon_Mvc_Router_Route, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1136, &_1);
	ZVAL_UNDEF(&_0);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, beforeMatch)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1137, callback);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, getCompiledHostName)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1139, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&hostname, &_1);
	if (Z_TYPE_P(&hostname) == IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1138, &__$null);
		RETURN_MM_NULL();
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1138, &regexHostName);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, match)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	zephir_fetch_params_without_memory_grow(1, 0, &callback);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1141, callback);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, reConfigure)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1142, &pattern_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1143, &compiledPattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1140, &routePaths);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setGroup)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1144, group);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setHostname)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1139, &hostname_zv);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1138, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1138, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&name_zv, name);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1145, &name_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setRouteId)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1136, &routeId_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, via)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1146, httpMethods);
	RETURN_THISW();
}
