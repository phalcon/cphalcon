...
PHP_METHOD(Phalcon_Mvc_Router_Route, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1128, &_1);
	ZVAL_UNDEF(&_0);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, beforeMatch)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1129, callback);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, getCompiledHostName)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 1131, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&hostname, &_1);
	if (Z_TYPE_P(&hostname) == IS_NULL) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1130, &__$null);
		RETURN_MM_NULL();
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1130, &regexHostName);
...
PHP_METHOD(Phalcon_Mvc_Router_Route, reConfigure)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1134, &pattern_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 1135, &compiledPattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 1132, &routePaths);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setGroup)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1136, group);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setHostname)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1131, &hostname_zv);
	if (0) {
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setName)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&name_zv, name);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1137, &name_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, setRouteId)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1128, &routeId_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Mvc_Router_Route, via)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1138, httpMethods);
	RETURN_THISW();
}
