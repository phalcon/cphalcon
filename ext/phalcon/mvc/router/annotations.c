...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, handle) {
	...
	zend_function *_6 = NULL, *_10 = NULL, *_17 = NULL;
	HashTable *_2, *_8, *_12, *_15;
	HashPosition _1, _7, _11, _14;
	zval *uri_param = NULL, *realUri = NULL, *annotationsService = NULL, *handlers, *controllerSuffix, *scope = NULL, *prefix, *dependencyInjector = NULL, *handler, *controllerName = NULL, *lowerControllerName = NULL, *namespaceName = NULL, *moduleName = NULL, *sufixed = NULL, *handlerAnnotations = NULL, *classAnnotations = NULL, *annotations = NULL, *annotation = NULL, *methodAnnotations = NULL, *lowercased = NULL, *method = NULL, *collection = NULL, *_0, **_3, *_4, *_5 = NULL, **_9, **_13, **_16;
	zval *uri = NULL;
		...
		if ((Z_TYPE_P(handlers) == IS_ARRAY)) {
			...
			for (
				...
				if ((Z_TYPE_P(scope) == IS_ARRAY)) {
					...
					zephir_call_method_p1(handlerAnnotations, annotationsService, "get", sufixed);
					ZEPHIR_INIT_NVAR(classAnnotations);
					zephir_call_method(classAnnotations, handlerAnnotations, "getclassannotations");
					if ((Z_TYPE_P(classAnnotations) == IS_OBJECT)) {
						ZEPHIR_INIT_NVAR(annotations);
						zephir_call_method(annotations, classAnnotations, "getannotations");
					...
					zephir_call_method(methodAnnotations, handlerAnnotations, "getmethodsannotations");
...
PHP_METHOD(Phalcon_Mvc_Router_Annotations, processActionAnnotation) {
	...
	HashPosition _5, _9;
	zend_bool isRoute;
	zval *module_param = NULL, *namespaceName_param = NULL, *controller_param = NULL, *action_param = NULL, *annotation, *name, *actionName, *routePrefix, *paths = NULL, *value, *uri = NULL, *route, *methods, *converts = NULL, *param = NULL, *convert = NULL, *conversorParam = NULL, *routeName, *_0, *_1, _2, *_3 = NULL, *_4 = NULL, **_7, **_11;
	...
	if ((isRoute == 1)) {
		...
		if ((Z_TYPE_P(methods) != IS_NULL)) {
			ZEPHIR_INIT_VAR(_4);
			ZVAL_STRING(_4, "methods", 1);
			ZEPHIR_INIT_BNVAR(methods);
			zephir_call_method_p1(methods, annotation, "getnamedargument", _4);
		...
		ZEPHIR_INIT_NVAR(_4);
		ZVAL_STRING(_4, "converts", 1);
		ZEPHIR_INIT_VAR(converts);
		zephir_call_method_p1(converts, annotation, "getnamedargument", _4);
		if ((Z_TYPE_P(converts) == IS_ARRAY)) {
			...
			for (
				...
				zephir_call_method_p2_cache_noret(route, "convert", &_8, param, convert);
			}
		}
		ZEPHIR_INIT_NVAR(_4);
		ZVAL_STRING(_4, "conversors", 1);
		...
		if ((Z_TYPE_P(converts) == IS_ARRAY)) {
			...
			for (
				...
				zephir_call_method_p2_cache_noret(route, "convert", &_12, conversorParam, convert);
			}
		}
		ZEPHIR_INIT_NVAR(_4);
		ZVAL_STRING(_4, "name", 1);
		ZEPHIR_INIT_VAR(routeName);
		zephir_call_method_p1(routeName, annotation, "getnamedargument", _4);
