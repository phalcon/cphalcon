...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Model) {
	...
	zend_class_implements(phalcon_mvc_model_ce TSRMLS_CC, 3, phalcon_mvc_modelinterface_ce, phalcon_mvc_model_resultinterface_ce, phalcon_di_injectionawareinterface_ce);
