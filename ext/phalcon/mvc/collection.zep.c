...
ZEPHIR_INIT_CLASS(Phalcon_Mvc_Collection) {
	...
	zend_declare_property_null(phalcon_mvc_collection_ce, SL("connection"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("container"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(phalcon_mvc_collection_ce, SL("dirtyState"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("disableEvents"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("errorMessages"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("modelsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_long(phalcon_mvc_collection_ce, SL("operationMade"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("reserved"), ZEND_ACC_PROTECTED|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_bool(phalcon_mvc_collection_ce, SL("skipped"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_mvc_collection_ce, SL("source"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Mvc_Collection, __construct) {
	...
	zval *container = NULL, container_sub, *modelsManager = NULL, modelsManager_sub, __$null, _1$$4, _2$$4, _4$$4, _5$$5;
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 0, 2, &container, &modelsManager);
	...
	if (UNEXPECTED(Z_TYPE_P(container) != IS_OBJECT)) {
		...
		object_init_ex(&_1$$4, phalcon_mvc_collection_exception_ce);
		ZEPHIR_INIT_VAR(&_4$$4);
		ZVAL_STRING(&_4$$4, "the services related to the ODM");
		ZEPHIR_CALL_CE_STATIC(&_2$$4, phalcon_mvc_collection_exception_ce, "containerservicenotfound", &_3, 0, &_4$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 5, &_2$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Mvc/Collection.zep", 84 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (Z_TYPE_P(modelsManager) != IS_OBJECT) {
		...
		ZVAL_STRING(&_5$$5, "collectionManager");
		ZEPHIR_CALL_METHOD(modelsManager, container, "getshared", NULL, 0, &_5$$5);
		zephir_check_call_status();
		if (UNEXPECTED(Z_TYPE_P(modelsManager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The injected service 'modelsManager' is not valid", "phalcon/Mvc/Collection.zep", 97);
			return;
		}
	}
...
PHP_METHOD(Phalcon_Mvc_Collection, aggregate) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 143);
		return;
	}
...
PHP_METHOD(Phalcon_Mvc_Collection, cloneResult) {
	...
	zephir_is_iterable(&document, 0, "phalcon/Mvc/Collection.zep", 190);
...
PHP_METHOD(Phalcon_Mvc_Collection, create) {
	...
	zval _5;
	zend_bool success = 0, exists = 0, _6;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, data, status, id, ok, collection, _0, _1, _2, _3, _4, _8, _9, _10, _7$$4;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&ok);
	_6 = zephir_array_isset_string_fetch(&ok, &status, SL("ok"), 0);
	if (_6) {
		_6 = zephir_is_true(&ok);
	}
	if (_6) {
		success = 1;
		ZEPHIR_OBS_VAR(&id);
		...
		ZVAL_LONG(&_7$$4, 0);
		zephir_update_property_zval(this_ptr, SL("dirtyState"), &_7$$4);
	}
	zephir_read_static_property_ce(&_8, phalcon_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_9, 1);
	} else {
		ZVAL_BOOL(&_9, 0);
...
PHP_METHOD(Phalcon_Mvc_Collection, createIfNotExist) {
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&criteria))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Criteria parameter must be array with one or more attributes of the model", "phalcon/Mvc/Collection.zep", 288);
		return;
	}
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "preparecu", NULL, 0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&keys, "array_flip", NULL, 162, &criteria);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&data, this_ptr, "toarray", NULL, 0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&query, "array_intersect_key", NULL, 8, &data, &keys);
	zephir_check_call_status();
	success = 0;
	ZEPHIR_INIT_VAR(&_6);
	...
	if (Z_TYPE_P(&status) == IS_NULL) {
		...
		if (Z_TYPE_P(&doc) == IS_ARRAY) {
			...
			ZVAL_LONG(&_9$$7, 1);
			zephir_update_property_zval(this_ptr, SL("operationMade"), &_9$$7);
			zephir_array_fetch_string(&_10$$7, &doc, SL("_id"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Collection.zep", 355 TSRMLS_CC);
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$8, "__construct", NULL, 4, &_12$$8);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, count) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_SELF("getgroupresultset", NULL, 0, &parameters, &collection, &connection);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, delete) {
	...
	zend_bool success = 0;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, disableEvents, status, id, connection, source, collection, mongoId, ok, _0, _1$$4, _2$$4, _3$$9, _4$$9, _7$$15, _8$$14;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	ZEPHIR_OBS_VAR(&id);
	if (UNEXPECTED(!(zephir_fetch_property(&id, this_ptr, SL("_id"), PH_SILENT_CC)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The document cannot be deleted because it doesn't exist", "phalcon/Mvc/Collection.zep", 416);
		return;
	}
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_static_property_ce(&_0, phalcon_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC);
	ZEPHIR_CPY_WRT(&disableEvents, &_0);
	if (!(zephir_is_true(&disableEvents))) {
		ZEPHIR_INIT_VAR(&_2$$4);
		ZVAL_STRING(&_2$$4, "beforeDelete");
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "fireeventcancel", NULL, 0, &_2$$4);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(&_1$$4)) {
			RETURN_MM_BOOL(0);
		}
	}
	zephir_read_property(&_0, this_ptr, SL("skipped"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 435);
		return;
	}
	...
	if (Z_TYPE_P(&id) == IS_OBJECT) {
		...
		zephir_read_property(&_3$$9, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
	...
	if (zephir_array_isset_string_fetch(&ok, &status, SL("ok"), 0)) {
		if (zephir_is_true(&ok)) {
			...
			ZVAL_LONG(&_8$$14, 2);
			zephir_update_property_zval(this_ptr, SL("dirtyState"), &_8$$14);
		}
	} else {
		success = 0;
	}
...
PHP_METHOD(Phalcon_Mvc_Collection, find) {
	...
	zephir_check_call_status();
	ZVAL_BOOL(&_3, 0);
	ZEPHIR_RETURN_CALL_SELF("getresultset", NULL, 0, &parameters, &collection, &_2, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, findById) {
	...
	ZEPHIR_RETURN_CALL_SELF("findfirst", NULL, 0, &_8);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, findFirst) {
	...
	zephir_check_call_status();
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("getresultset", NULL, 0, &parameters, &collection, &connection, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, getConnection) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, SL("connection"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) != IS_OBJECT) {
		zephir_read_property(&_1$$3, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&_2$$3, &_1$$3, "getconnection", NULL, 0, this_ptr);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("connection"), &_2$$3);
	}
...
PHP_METHOD(Phalcon_Mvc_Collection, getReservedAttributes) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_static_property_ce(&_0, phalcon_mvc_collection_ce, SL("reserved"), PH_NOISY_CC);
	if (Z_TYPE_P(&_0) != IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_1$$3);
		zephir_create_array(&_1$$3, 8, 0 TSRMLS_CC);
		zephir_array_update_string(&_1$$3, SL("_connection"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("container"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("source"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("operationMade"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("errorMessages"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("dirtyState"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("modelsManager"), &__$true, PH_COPY | PH_SEPARATE);
		zephir_array_update_string(&_1$$3, SL("skipped"), &__$true, PH_COPY | PH_SEPARATE);
		zend_update_static_property(phalcon_mvc_collection_ce, ZEND_STRL("reserved"), &_1$$3);
	}
	zephir_read_static_property_ce(&_2, phalcon_mvc_collection_ce, SL("reserved"), PH_NOISY_CC | PH_READONLY);
	RETURN_CTOR(&_2);
...
PHP_METHOD(Phalcon_Mvc_Collection, getSource) {
	...
	zephir_read_property(&_0, this_ptr, SL("source"), PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_0))) {
		...
		zephir_update_property_zval(this_ptr, SL("source"), &_1$$3);
	}
	RETURN_MM_MEMBER(getThis(), "source");
...
PHP_METHOD(Phalcon_Mvc_Collection, save) {
	...
	zval _6;
	zend_bool success = 0, _7;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, exists, data, status, id, ok, collection, _2, _3, _4, _5, _9, _10, _0$$3, _1$$4, _8$$7;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_METHOD(&collection, this_ptr, "preparecu", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&exists, this_ptr, "exists", NULL, 0, &collection);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&exists)) {
		ZEPHIR_INIT_ZVAL_NREF(_0$$3);
		ZVAL_LONG(&_0$$3, 1);
		zephir_update_property_zval(this_ptr, SL("operationMade"), &_0$$3);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_1$$4);
		ZVAL_LONG(&_1$$4, 2);
		zephir_update_property_zval(this_ptr, SL("operationMade"), &_1$$4);
	}
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&ok);
	_7 = zephir_array_isset_string_fetch(&ok, &status, SL("ok"), 0);
	if (_7) {
		_7 = zephir_is_true(&ok);
	}
	if (_7) {
		success = 1;
		if (ZEPHIR_IS_FALSE_IDENTICAL(&exists)) {
			...
			ZVAL_LONG(&_8$$7, 0);
			zephir_update_property_zval(this_ptr, SL("dirtyState"), &_8$$7);
		}
	}
	zephir_read_static_property_ce(&_9, phalcon_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	if (success) {
		ZVAL_BOOL(&_10, 1);
	} else {
		ZVAL_BOOL(&_10, 0);
...
PHP_METHOD(Phalcon_Mvc_Collection, serialize) {
	...
	zval container, serializer, _1, _2, _6, _3$$4, _4$$4, _5$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	...
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The dependency injector container is not valid", "phalcon/Mvc/Collection.zep", 946);
		return;
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	if (zephir_is_true(&_1)) {
		zephir_read_property(&_3$$4, this_ptr, SL("container"), PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &serializer, "setdata", NULL, 0, &_4$$4);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 10, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, setId) {
	...
	if (Z_TYPE_P(id) != IS_OBJECT) {
		zephir_read_property(&_0$$3, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Collection, summatory) {
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 1063);
		return;
	}
	ZEPHIR_CALL_METHOD(&collection, &connection, "selectcollection", NULL, 0, &source);
	zephir_check_call_status();
	...
	if (zephir_array_isset_long_fetch(&firstRetval, &retval, 0, 1 TSRMLS_CC)) {
		if (zephir_array_isset_string(&firstRetval, SL("summatory"))) {
			zephir_array_fetch_string(&_4$$6, &firstRetval, SL("summatory"), PH_NOISY | PH_READONLY, "phalcon/Mvc/Collection.zep", 1089 TSRMLS_CC);
			RETURN_CTOR(&_4$$6);
		}
...
PHP_METHOD(Phalcon_Mvc_Collection, toArray) {
	...
	zend_ulong _3;
	zval data;
	zval reserved, key, value, _0, *_1, _2;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	array_init(&data);
	ZEPHIR_CALL_FUNCTION(&_0, "get_object_vars", NULL, 214, this_ptr);
	zephir_check_call_status();
	zephir_is_iterable(&_0, 0, "phalcon/Mvc/Collection.zep", 1130);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _3, _4, _1)
		{
			...
			} else if (!(zephir_array_isset(&reserved, &key))) {
				zephir_array_update_zval(&data, &key, &value, PH_COPY | PH_SEPARATE);
			}
		} ZEND_HASH_FOREACH_END();
	} else {
...
PHP_METHOD(Phalcon_Mvc_Collection, unserialize) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_0 = NULL, *_3 = NULL;
	zval *data, data_sub, attributes, container, manager, key, value, serializer, _5, _6, _1$$3, _2$$3, _4$$3, _7$$4, _8$$4, _9$$6, *_10$$6, _11$$6;
	zval *this_ptr = getThis();
	...
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		ZEPHIR_INIT_VAR(&_1$$3);
		object_init_ex(&_1$$3, phalcon_mvc_collection_exception_ce);
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "the services related to the ODM");
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_mvc_collection_exception_ce, "containerservicenotfound", &_3, 0, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 5, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/Collection.zep", 1149 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	zephir_update_property_zval(this_ptr, SL("container"), &container);
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "serializer");
	ZEPHIR_CALL_METHOD(&_5, &container, "has", NULL, 0, &_6);
	zephir_check_call_status();
	if (zephir_is_true(&_5)) {
		ZEPHIR_INIT_VAR(&_8$$4);
		ZVAL_STRING(&_8$$4, "serializer");
		ZEPHIR_CALL_METHOD(&_7$$4, &container, "getshared", NULL, 0, &_8$$4);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&serializer, &_7$$4);
		ZEPHIR_CALL_METHOD(&attributes, &serializer, "unserialize", NULL, 0, data);
		zephir_check_call_status();
	} else {
	...
	if (Z_TYPE_P(&attributes) == IS_ARRAY) {
		...
		ZVAL_STRING(&_9$$6, "collectionManager");
		ZEPHIR_CALL_METHOD(&manager, &container, "getshared", NULL, 0, &_9$$6);
		zephir_check_call_status();
		if (UNEXPECTED(Z_TYPE_P(&manager) != IS_OBJECT)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The injected service 'collectionManager' is not valid", "phalcon/Mvc/Collection.zep", 1173);
			return;
		}
		zephir_update_property_zval(this_ptr, SL("modelsManager"), &manager);
		zephir_is_iterable(&attributes, 0, "phalcon/Mvc/Collection.zep", 1187);
		if (Z_TYPE_P(&attributes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&attributes), _12$$6, _13$$6, _10$$6)
			{
				ZEPHIR_INIT_NVAR(&key);
				if (_13$$6 != NULL) { 
			...
			zephir_check_call_status();
			while (1) {
				ZEPHIR_CALL_METHOD(&_11$$6, &attributes, "valid", NULL, 0);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, update) {
	...
	zend_bool success = 0, _7;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zval __$true, exists, data, status, ok, collection, _0, _1, _2, _3, _5, _8, _9;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_METHOD(&exists, this_ptr, "exists", NULL, 0, &collection);
	zephir_check_call_status();
	if (UNEXPECTED(!zephir_is_true(&exists))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "The document cannot be updated because it doesn't exist", "phalcon/Mvc/Collection.zep", 1208);
		return;
	}
	ZEPHIR_INIT_ZVAL_NREF(_0);
	ZVAL_LONG(&_0, 2);
...
PHP_METHOD(Phalcon_Mvc_Collection, validate) {
	...
	for (;_1->funcs->valid(_1 TSRMLS_CC) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1 TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZVAL_NULL(&_7$$4);
		ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", &_8, 4, &_3$$4, &_4$$4, &_5$$4, &_7$$4, &_6$$4);
		zephir_check_call_status();
 ...
 */
PHP_METHOD(Phalcon_Mvc_Collection, cancelOperation) {
 ...
 */
PHP_METHOD(Phalcon_Mvc_Collection, exists) {
	...
	if (Z_TYPE_P(&id) == IS_OBJECT) {
		...
		zephir_read_property(&_0$$5, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property(&_2, this_ptr, SL("dirtyState"), PH_NOISY_CC | PH_READONLY);
	...
	if (exists) {
		...
		ZVAL_LONG(&_5$$9, 0);
		zephir_update_property_zval(this_ptr, SL("dirtyState"), &_5$$9);
	} else {
		ZEPHIR_INIT_ZVAL_NREF(_6$$10);
		ZVAL_LONG(&_6$$10, 1);
		zephir_update_property_zval(this_ptr, SL("dirtyState"), &_6$$10);
	}
 ...
 */
PHP_METHOD(Phalcon_Mvc_Collection, getGroupResultset) {
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 1418);
		return;
	}
 ...
 * @return array
 */
PHP_METHOD(Phalcon_Mvc_Collection, getResultset) {
	...
	if (zephir_array_isset_string_fetch(&className, params, SL("class"), 0)) {
		...
		if (UNEXPECTED(!(_2$$3))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$4, "__construct", NULL, 5, &_4$$4);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$4, "phalcon/Mvc/Collection.zep", 1489 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} else {
	...
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 1503);
		return;
	}
	ZEPHIR_CALL_METHOD(&mongoCollection, connection, "selectcollection", NULL, 0, &source);
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(&mongoCollection) != IS_OBJECT)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Couldn't select mongo collection", "phalcon/Mvc/Collection.zep", 1509);
		return;
	}
	ZEPHIR_OBS_VAR(&conditions);
	if (!(zephir_array_isset_long_fetch(&conditions, params, 0, 0 TSRMLS_CC))) {
	...
	if (UNEXPECTED(Z_TYPE_P(&conditions) != IS_ARRAY)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Find parameters must be an array", "phalcon/Mvc/Collection.zep", 1522);
		return;
	}
	...
	if (unique) {
		...
		ZEPHIR_RETURN_CALL_SELF("cloneresult", NULL, 0, &base, &document);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (Z_TYPE_P(&_6) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_6), _7)
		{
			...
			ZEPHIR_CALL_SELF(&_9$$19, "cloneresult", &_10, 0, &base, &document);
			zephir_check_call_status();
			zephir_array_append(&collections, &_9$$19, PH_SEPARATE, "phalcon/Mvc/Collection.zep", 1581);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_SELF(&_11$$20, "cloneresult", &_10, 0, &base, &document);
				zephir_check_call_status();
				zephir_array_append(&collections, &_11$$20, PH_SEPARATE, "phalcon/Mvc/Collection.zep", 1581);
 ...
 */
PHP_METHOD(Phalcon_Mvc_Collection, preSave) {

	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool disableEvents, exists;
	zval *container, container_sub, *disableEvents_param = NULL, *exists_param = NULL, eventName, _3, _4, _0$$3, _1$$3, _2$$3, _5$$9, _6$$10, _7$$10, _8$$10, _9$$10, _10$$10;
	zval *this_ptr = getThis();
	...
	ZEPHIR_MM_GROW();
	zephir_fetch_params(1, 3, 0, &container, &disableEvents_param, &exists_param);
 ...
 */
PHP_METHOD(Phalcon_Mvc_Collection, postSave) {

	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *disableEvents_param = NULL, *success_param = NULL, *exists_param = NULL, eventName, _0$$4, _1$$3, _2$$5;
	...
	if (!(success)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "canceloperation", NULL, 0, &_1$$3);
		zephir_check_call_status();
		RETURN_MM_BOOL(0);
	}
	if (!(disableEvents)) {
		...
		ZVAL_STRING(&_2$$5, "afterSave");
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "fireevent", NULL, 0, &_2$$5);
		zephir_check_call_status();
	}
	RETURN_MM_BOOL(success);
...
PHP_METHOD(Phalcon_Mvc_Collection, prepareCU) {
	...
	zval container, connection, source, collection, _0, _1$$3, _2$$3, _4$$3;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	...
	if (UNEXPECTED(Z_TYPE_P(&container) != IS_OBJECT)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 5, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Mvc/Collection.zep", 1709 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&source, this_ptr, "getsource", NULL, 0);
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&source))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_mvc_collection_exception_ce, "Method getSource() returns empty string", "phalcon/Mvc/Collection.zep", 1714);
		return;
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getconnection", NULL, 0);
	zephir_check_call_status();
...
zend_object *zephir_init_properties_Phalcon_Mvc_Collection(zend_class_entry *class_type TSRMLS_DC) {
	...
	
	{
		...
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval(this_ptr, SL("errorMessages"), &_1$$3);
		}
		ZEPHIR_MM_RESTORE();
