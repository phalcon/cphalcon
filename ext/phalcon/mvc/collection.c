...
PHP_METHOD(Phalcon_Mvc_Collection, getReservedAttributes) {
	...
	if ((Z_TYPE_P(reserved) == IS_NULL)) {
		...
		array_init_size(reserved, Resource id #996);
...
PHP_METHOD(Phalcon_Mvc_Collection, _exists) {
	...
	if ((0 == 1)) {
		...
		ZEPHIR_INIT_NVAR(_1);
		ZEPHIR_INIT_VAR(_3);
		array_init_size(_3, Resource id #1000);
...
PHP_METHOD(Phalcon_Mvc_Collection, save) {
	...
	success = 0;
	ZEPHIR_INIT_VAR(_6);
	array_init_size(_6, Resource id #1002);
...
PHP_METHOD(Phalcon_Mvc_Collection, findById) {
	...
	ZEPHIR_INIT_NVAR(_1);
	array_init_size(_1, Resource id #1005);
	ZEPHIR_INIT_NVAR(_2);
	array_init_size(_2, Resource id #1007);
...
PHP_METHOD(Phalcon_Mvc_Collection, summatory) {
	...
	array_init_size(initial, Resource id #1016);
...
PHP_METHOD(Phalcon_Mvc_Collection, delete) {
	...
	success = 0;
	ZEPHIR_INIT_NVAR(_0);
	array_init_size(_0, Resource id #1018);
	zephir_array_update_string(&_0, SL("_id"), &mongoId, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(_1);
	array_init_size(_1, Resource id #1020);
