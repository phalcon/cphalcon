...
PHP_METHOD(Phalcon_Db_Result_PdoResult, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 613, connection);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 614, result);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 615, sqlStatement);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 616, bindParams);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 617, bindTypes);
}
...
PHP_METHOD(Phalcon_Db_Result_PdoResult, dataSeek)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 615, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&sqlStatement, &_0);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 616, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&bindParams, &_0);
	if (Z_TYPE_P(&bindParams) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&statement, &pdo, "prepare", NULL, 0, &sqlStatement);
		zephir_check_call_status();
		if (Z_TYPE_P(&statement) == IS_OBJECT) {
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_3, 617, PH_NOISY_CC | PH_READONLY);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 614, &statement);
	n = -1;
	number--;
	while (1) {
		if (!(n != number)) {
		...
		zephir_read_property_cached(&_3$$6, this_ptr, _zephir_prop_5, 618, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Result_PdoResult, execute)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 619, &__$null);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 614, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Result_PdoResult, fetch)
{
	...
	if (1 == 1) {
		...
		zephir_read_property_cached(&mode, this_ptr, _zephir_prop_0, 618, PH_NOISY_CC);
	}
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 614, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Result_PdoResult, fetchAll)
{
	...
	if (mode == 8) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 614, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_1$$3, mode);
	...
	if (_2) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 614, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_4$$4, mode);
		ZEPHIR_RETURN_CALL_METHOD(&_3$$4, "fetchall", NULL, 0, &_4$$4, fetchArgument);
		zephir_check_call_status();
		RETURN_MM();
	}
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 614, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_6, mode);
...
PHP_METHOD(Phalcon_Db_Result_PdoResult, numRows)
{
	...
	if (Z_TYPE_P(&rowCount) == IS_NULL) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 613, PH_NOISY_CC | PH_READONLY);
		...
		if (_2$$3) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_2, 614, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CPY_WRT(&pdoStatement, &_3$$4);
			ZEPHIR_CALL_METHOD(&rowCount, &pdoStatement, "rowcount", NULL, 0);
			zephir_check_call_status();
		}
		if (Z_TYPE_P(&rowCount) == IS_NULL) {
			zephir_read_property_cached(&_4$$5, this_ptr, _zephir_prop_3, 615, PH_NOISY_CC | PH_READONLY);
			...
			if (!(zephir_start_with_str(&sqlStatement, SL("SELECT COUNT(*) ")))) {
				...
				if (zephir_is_true(&_6$$6)) {
					...
					zephir_read_property_cached(&_10$$7, this_ptr, _zephir_prop_4, 616, PH_NOISY_CC | PH_READONLY);
					zephir_read_property_cached(&_11$$7, this_ptr, _zephir_prop_5, 617, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 619, &rowCount);
	}
