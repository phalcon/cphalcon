...
PHP_METHOD(Phalcon_Db_Result_Pdo, setFetchMode) {
	...
	zval *fetchMode_param = NULL, *pdoStatement, *_0, *_1 = NULL, *_2 = NULL, *_3 = NULL;
	int fetchMode;
	...
	do {
		...
		ZVAL_LONG(_0, 2);
		if (ZEPHIR_IS_LONG(_0, fetchMode)) {
			ZEPHIR_INIT_VAR(_1);
			ZEPHIR_INIT_NVAR(_1);
			ZVAL_LONG(_1, 4);
			zephir_call_method_p1_noret(pdoStatement, "setfetchmode", _1);
			ZEPHIR_INIT_VAR(_2);
			ZEPHIR_INIT_NVAR(_2);
			ZVAL_LONG(_2, 4);
		...
		ZEPHIR_INIT_NVAR(_1);
		ZVAL_LONG(_1, 1);
		if (ZEPHIR_IS_LONG(_1, fetchMode)) {
			ZEPHIR_INIT_NVAR(_2);
			ZEPHIR_INIT_NVAR(_2);
			ZVAL_LONG(_2, 2);
			zephir_call_method_p1_noret(pdoStatement, "setfetchmode", _2);
			ZEPHIR_INIT_VAR(_3);
			ZEPHIR_INIT_NVAR(_3);
			ZVAL_LONG(_3, 2);
			zephir_update_property_this(this_ptr, SL("_fetchMode"), _3 TSRMLS_CC);
			break;
		}
		ZEPHIR_INIT_NVAR(_1);
		ZEPHIR_INIT_NVAR(_1);
