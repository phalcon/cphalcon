...
PHP_METHOD(Phalcon_Db_Profiler_Item, getTotalElapsedNanoseconds)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 641, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Profiler_Item, setSqlBindTypes)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 642, &sqlBindTypes);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Db_Profiler_Item, setSqlStatement)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 643, &sqlStatement_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Db_Profiler_Item, setSqlVariables)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 644, &sqlVariables);
	RETURN_THIS();
}
