...
PHP_METHOD(Phalcon_Db_Adapter, describeIndexes) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		...
		zephir_array_fetch_long(&_5$$3, &index, 4, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 270 TSRMLS_CC);
		zephir_array_append(&columns, &_5$$3, PH_SEPARATE, "phalcon/Db/Adapter.zep", 270);
...
PHP_METHOD(Phalcon_Db_Adapter, describeReferences) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		...
		if (!(zephir_array_isset(&references, &constraintName))) {
			...
			zephir_array_fetch(&_5$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 312 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&referencedSchema);
			zephir_array_fetch_string(&referencedSchema, &_5$$5, SL("referencedSchema"), PH_NOISY, "phalcon/Db/Adapter.zep", 312 TSRMLS_CC);
			zephir_array_fetch(&_6$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 313 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&referencedTable);
			zephir_array_fetch_string(&referencedTable, &_6$$5, SL("referencedTable"), PH_NOISY, "phalcon/Db/Adapter.zep", 313 TSRMLS_CC);
			zephir_array_fetch(&_7$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 314 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&columns);
			zephir_array_fetch_string(&columns, &_7$$5, SL("columns"), PH_NOISY, "phalcon/Db/Adapter.zep", 314 TSRMLS_CC);
			zephir_array_fetch(&_8$$5, &references, &constraintName, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 315 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&referencedColumns);
			zephir_array_fetch_string(&referencedColumns, &_8$$5, SL("referencedColumns"), PH_NOISY, "phalcon/Db/Adapter.zep", 315 TSRMLS_CC);
		}
		zephir_array_fetch_long(&_9$$3, &reference, 1, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 318 TSRMLS_CC);
		zephir_array_append(&columns, &_9$$3, PH_SEPARATE, "phalcon/Db/Adapter.zep", 318);
		zephir_array_fetch_long(&_10$$3, &reference, 5, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 319 TSRMLS_CC);
		zephir_array_append(&referencedColumns, &_10$$3, PH_SEPARATE, "phalcon/Db/Adapter.zep", 319);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _13, _14, _12)
	{
		...
		zephir_array_fetch_string(&_17$$6, &arrayReference, SL("referencedSchema"), PH_NOISY, "phalcon/Db/Adapter.zep", 332 TSRMLS_CC);
		zephir_array_update_string(&_16$$6, SL("referencedSchema"), &_17$$6, PH_COPY | PH_SEPARATE);
		ZEPHIR_OBS_NVAR(&_17$$6);
		zephir_array_fetch_string(&_17$$6, &arrayReference, SL("referencedTable"), PH_NOISY, "phalcon/Db/Adapter.zep", 333 TSRMLS_CC);
		zephir_array_update_string(&_16$$6, SL("referencedTable"), &_17$$6, PH_COPY | PH_SEPARATE);
		ZEPHIR_OBS_NVAR(&_17$$6);
		zephir_array_fetch_string(&_17$$6, &arrayReference, SL("columns"), PH_NOISY, "phalcon/Db/Adapter.zep", 334 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Db_Adapter, insert) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _3, _4, _2)
	{
		...
		if (_5$$4) {
			...
			zephir_array_append(&placeholders, &_6$$5, PH_SEPARATE, "phalcon/Db/Adapter.zep", 700);
		} else {
			...
			if (Z_TYPE_P(&value) == IS_NULL) {
				...
				zephir_array_append(&placeholders, &_8$$8, PH_SEPARATE, "phalcon/Db/Adapter.zep", 707);
			} else {
				ZEPHIR_INIT_NVAR(&_9$$9);
				ZVAL_STRING(&_9$$9, "?");
				zephir_array_append(&placeholders, &_9$$9, PH_SEPARATE, "phalcon/Db/Adapter.zep", 709);
	...
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(fields), _10$$12)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&escapedFields, &_11$$13, PH_SEPARATE, "phalcon/Db/Adapter.zep", 730);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&field);
...
PHP_METHOD(Phalcon_Db_Adapter, listTables) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		...
		ZVAL_COPY(&table, _4);
		zephir_array_fetch_long(&_5$$3, &table, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 820 TSRMLS_CC);
		zephir_array_append(&allTables, &_5$$3, PH_SEPARATE, "phalcon/Db/Adapter.zep", 820);
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&table);
...
PHP_METHOD(Phalcon_Db_Adapter, listViews) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		ZEPHIR_INIT_NVAR(&table);
		ZVAL_COPY(&table, _4);
		zephir_array_fetch_long(&_5$$3, &table, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Adapter.zep", 840 TSRMLS_CC);
		zephir_array_append(&allTables, &_5$$3, PH_SEPARATE, "phalcon/Db/Adapter.zep", 840);
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&table);
	RETURN_CCTOR(&allTables);
...
PHP_METHOD(Phalcon_Db_Adapter, update) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(values), _1, _2, _0)
	{
		...
		if (_4$$3) {
			...
			zephir_array_append(&placeholders, &_6$$5, PH_SEPARATE, "phalcon/Db/Adapter.zep", 1034);
		} else {
			if (Z_TYPE_P(&value) == IS_OBJECT) {
				zephir_get_strval(&_7$$7, &value);
				ZEPHIR_CPY_WRT(&value, &_7$$7);
			...
			if (Z_TYPE_P(&value) == IS_NULL) {
				...
				zephir_array_append(&placeholders, &_8$$8, PH_SEPARATE, "phalcon/Db/Adapter.zep", 1041);
			} else {
				...
				zephir_array_append(&placeholders, &_9$$9, PH_SEPARATE, "phalcon/Db/Adapter.zep", 1050);
			}
		}
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&value);
