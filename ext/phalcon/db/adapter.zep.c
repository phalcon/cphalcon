...
PHP_METHOD(Phalcon_Db_Adapter, insert) {
	...
	zephir_is_iterable(values, &_3, &_2, 0, 0, "phalcon/db/adapter.zep", 334);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		if (Z_TYPE_P(value) == IS_OBJECT) {
			...
			zephir_array_append(&placeholders, _5, PH_SEPARATE, "phalcon/db/adapter.zep", 317);
		} else {
	...
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		if (ZEPHIR_GLOBAL(db).escape_identifiers) {
			...
			zephir_is_iterable(fields, &_7, &_6, 0, 0, "phalcon/db/adapter.zep", 351);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_7, &_6)
				...
				zephir_check_call_status();
				zephir_array_append(&escapedFields, _9, PH_SEPARATE, "phalcon/db/adapter.zep", 349);
			}
		} else {
...
PHP_METHOD(Phalcon_Db_Adapter, describeIndexes) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_9, &_8)
		...
		ZEPHIR_CALL_METHOD(NULL, _3, "__construct", &_11, 71, name, indexColumns);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter, describeReferences) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_13, &_12)
		...
		ZEPHIR_CALL_METHOD(NULL, _3, "__construct", &_16, 72, name, _11);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter, getDefaultIdValue) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_1, 73, _0);
