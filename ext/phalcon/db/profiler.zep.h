...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_db_profiler_getmaxprofiles, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_db_profiler_reset, 0, 0, MAY_BE_STATIC)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_db_profiler_setmaxprofiles, 0, 1, MAY_BE_STATIC)
	ZEND_ARG_TYPE_INFO(0, maxProfiles, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_db_profiler_startprofile, 0, 1, MAY_BE_STATIC)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_phalcon_db_profiler_stopprofile, 0, 0, MAY_BE_STATIC)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_db_profiler_method_entry) {
	...
	PHP_ME(Phalcon_Db_Profiler, getMaxProfiles, arginfo_phalcon_db_profiler_getmaxprofiles, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Db_Profiler, setMaxProfiles, arginfo_phalcon_db_profiler_setmaxprofiles, ZEND_ACC_PUBLIC)
