...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_columninterface___construct, 0, 0, 0)
	ZEND_ARG_INFO(0, columnName)
	ZEND_ARG_INFO(0, definition)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_columninterface___set_state, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_db_columninterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Db_ColumnInterface, __set_state, arginfo_phalcon_db_columninterface___set_state)
	PHP_FE_END
};
