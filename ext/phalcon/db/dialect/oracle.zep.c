...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, viewExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 152, viewName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 152, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 152, viewName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, listViews) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 152, schemaName);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, tableExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 152, tableName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 152, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 152, tableName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeColumns) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 152, table);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 152, schema);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 152, table);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeReferences) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 152, schema);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 152, table);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_3$$3);
		ZEPHIR_CONCAT_SVSVS(_3$$3, "AND AC.OWNER='", _0$$3, "' AND AC.TABLE_NAME = '", _2$$3, "'");
		zephir_concat_self(&sql, _3$$3 TSRMLS_CC);
	} else {
		ZEPHIR_CALL_CE_STATIC(&_4$$4, phalcon_text_ce, "upper", &_1, 152, table);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, prepareTable) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *table_param = NULL, *schema_param = NULL, *alias_param = NULL, *escapeChar_param = NULL, *_0 = NULL, *_2 = NULL, *_3 = NULL, *_4$$3 = NULL, *_5$$3, *_6$$4 = NULL, *_7$$4;
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_text_ce, "upper", &_1, 152, table);
	zephir_check_call_status();
	zephir_get_strval(table, _0);
	ZEPHIR_CALL_CE_STATIC(&_2, phalcon_text_ce, "upper", &_1, 152, schema);
	zephir_check_call_status();
