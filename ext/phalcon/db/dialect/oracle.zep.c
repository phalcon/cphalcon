...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, limit) {
	...
	int limit = 0, offset;
	zval *sqlQuery_param = NULL, *number, number_sub, _0$$4, _1$$4, _2$$4, _3$$3, _4$$3, _5$$3, _6$$5, _7$$5, _9$$6, _11$$7;
	zval sqlQuery, _8, _10$$6, _12$$7;
	ZEPHIR_INIT_THIS();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, getColumnDefinition) {
	...
	zval *column, column_sub, columnSql, size, scale, type, _0$$14, _1$$14, _2$$14;
	ZEPHIR_INIT_THIS();
	...
	do {
		if (ZEPHIR_IS_LONG(&type, 0)) {
			...
			ZVAL_STRING(&columnSql, "INTEGER");
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 1)) {
			ZEPHIR_INIT_NVAR(&columnSql);
			ZVAL_STRING(&columnSql, "DATE");
			break;
		}
		...
		if (ZEPHIR_IS_LONG(&type, 4)) {
			ZEPHIR_INIT_NVAR(&columnSql);
			ZVAL_STRING(&columnSql, "TIMESTAMP");
			break;
		}
		...
		if (ZEPHIR_IS_LONG(&type, 8)) {
			ZEPHIR_INIT_NVAR(&columnSql);
			ZVAL_STRING(&columnSql, "TINYINT(1)");
			break;
		}
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, addColumn) {
	...
	zval *tableName_param = NULL, *schemaName_param = NULL, *column, column_sub;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, viewExists) {
	...
	zval *viewName_param = NULL, *schemaName_param = NULL, _0$$3, _2$$3, _3;
	zval viewName, schemaName;
	ZEPHIR_INIT_THIS();
	...
	if (!ZEPHIR_IS_STRING(&schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 154, &viewName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 154, &schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 154, &viewName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, listViews) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *schemaName_param = NULL, _0$$3;
	zval schemaName;
	ZEPHIR_INIT_THIS();
	...
	if (!ZEPHIR_IS_STRING(&schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 154, &schemaName);
		zephir_check_call_status();
		ZEPHIR_CONCAT_SVS(return_value, "SELECT VIEW_NAME FROM ALL_VIEWS WHERE OWNER='", &_0$$3, "' ORDER BY VIEW_NAME");
		RETURN_MM();
	}
	RETURN_MM_STRING("SELECT VIEW_NAME FROM ALL_VIEWS VIEW_NAME");
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, tableExists) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *tableName_param = NULL, *schemaName_param = NULL, _0$$3, _2$$3, _3;
	zval tableName, schemaName;
	ZEPHIR_INIT_THIS();
	...
	if (!ZEPHIR_IS_STRING(&schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 154, &tableName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 154, &schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 154, &tableName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeColumns) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *table_param = NULL, *schema_param = NULL, _0$$3, _2$$3, _3;
	zval table, schema;
	ZEPHIR_INIT_THIS();
	...
	if (!ZEPHIR_IS_STRING(&schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 154, &table);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 154, &schema);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 154, &table);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, listTables) {
	...
	RETURN_MM_STRING("SELECT TABLE_NAME, OWNER FROM ALL_TABLES ORDER BY OWNER, TABLE_NAME");
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeReferences) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *table_param = NULL, *schema_param = NULL, sql, _0$$3, _2$$3, _3$$3, _4$$4, _5$$4;
	zval table, schema;
	ZEPHIR_INIT_THIS();
	...
	if (!ZEPHIR_IS_STRING(&schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 154, &schema);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 154, &table);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_3$$3);
		ZEPHIR_CONCAT_SVSVS(&_3$$3, "AND AC.OWNER='", &_0$$3, "' AND AC.TABLE_NAME = '", &_2$$3, "'");
		zephir_concat_self(&sql, &_3$$3 TSRMLS_CC);
	} else {
		ZEPHIR_CALL_CE_STATIC(&_4$$4, phalcon_text_ce, "upper", &_1, 154, &table);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, prepareTable) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	zval *table_param = NULL, *schema_param = NULL, *alias_param = NULL, *escapeChar_param = NULL, _0, _2, _3, _4$$3, _5$$3, _6$$4, _7$$4;
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_text_ce, "upper", &_1, 154, &table);
	zephir_check_call_status();
	zephir_get_strval(&table, &_0);
	ZEPHIR_CALL_CE_STATIC(&_2, phalcon_text_ce, "upper", &_1, 154, &schema);
	zephir_check_call_status();
	zephir_get_strval(&schema, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "escape", NULL, 43, &table, &escapeChar);
	zephir_check_call_status();
	zephir_get_strval(&table, &_3);
	if (!ZEPHIR_IS_STRING(&schema, "")) {
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "escapeschema", NULL, 53, &schema, &escapeChar);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_5$$3);
		ZEPHIR_CONCAT_VSV(&_5$$3, &_4$$3, ".", &table);
		zephir_get_strval(&table, &_5$$3);
	}
	if (!ZEPHIR_IS_STRING(&alias, "")) {
		ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "escape", NULL, 43, &alias, &escapeChar);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_7$$4);
		ZEPHIR_CONCAT_VSV(&_7$$4, &table, " ", &_6$$4);
		zephir_get_strval(&table, &_7$$4);
	}
	RETURN_CTOR(table);
