...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addColumn)
{
	...
	if (zephir_is_true(&_5)) {
		...
		_8$$5 = _7$$5;
		if (!(_8$$5)) {
			ZEPHIR_CALL_FUNCTION(&_9$$5, "is_float", NULL, 216, &defaultValue);
			zephir_check_call_status();
		...
		if (_8$$5) {
			...
			ZVAL_STRING(&_11$$7, "\"");
			ZEPHIR_CALL_FUNCTION(&_12$$7, "addcslashes", NULL, 217, &defaultValue, &_11$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addForeignKey)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "getcolumnlist", NULL, 57, &_11);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_12);
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _2)
		{
			...
			if (zephir_is_true(&_8$$7)) {
				...
				_11$$10 = _10$$10;
				if (!(_11$$10)) {
					ZEPHIR_CALL_FUNCTION(&_12$$10, "is_float", &_13, 216, &defaultValue);
					zephir_check_call_status();
				...
				if (_11$$10) {
					...
					ZVAL_STRING(&_15$$12, "\"");
					ZEPHIR_CALL_FUNCTION(&_16$$12, "addcslashes", &_17, 217, &defaultValue, &_15$$12);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_27$$16)) {
					...
					_30$$19 = _29$$19;
					if (!(_30$$19)) {
						ZEPHIR_CALL_FUNCTION(&_31$$19, "is_float", &_13, 216, &defaultValue);
						zephir_check_call_status();
					...
					if (_30$$19) {
						...
						ZVAL_STRING(&_33$$21, "\"");
						ZEPHIR_CALL_FUNCTION(&_34$$21, "addcslashes", &_17, 217, &defaultValue, &_33$$21);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _41$$25)
			{
				...
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_43$$27, this_ptr, "getcolumnlist", &_45, 57, &_44$$27);
					zephir_check_call_status();
					...
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_47$$29, this_ptr, "getcolumnlist", &_45, 57, &_48$$29);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_50$$30, this_ptr, "getcolumnlist", &_45, 57, &_51$$30);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_53$$32, this_ptr, "getcolumnlist", &_45, 57, &_54$$32);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_56$$34, this_ptr, "getcolumnlist", &_45, 57, &_57$$34);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_59$$35, this_ptr, "getcolumnlist", &_45, 57, &_60$$35);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _62$$36)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_65$$37, this_ptr, "getcolumnlist", &_45, 57, &_66$$37);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_70$$37, this_ptr, "getcolumnlist", &_45, 57, &_71$$37);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_81$$40, this_ptr, "getcolumnlist", &_45, 57, &_82$$40);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, getColumnDefinition)
{
	...
	do {
		if (ZEPHIR_IS_LONG(&columnType, 14)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_2$$3);
		...
		if (ZEPHIR_IS_LONG(&columnType, 3)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_8$$18, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 9)) {
			...
			ZEPHIR_CALL_METHOD(&_10$$20, this_ptr, "checkcolumnsizeandscale", NULL, 219, column);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_11$$20, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 7)) {
			...
			ZEPHIR_CALL_METHOD(&_14$$24, this_ptr, "checkcolumnsizeandscale", NULL, 219, column);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_15$$24, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 0)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_18$$26, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 21)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_21$$36, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 22)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_24$$40, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 26)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_31$$52, this_ptr, "checkcolumnunsigned", NULL, 218, column);
			zephir_check_call_status();
		...
		if (UNEXPECTED(ZEPHIR_IS_EMPTY(&columnSql))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_34$$59, "__construct", NULL, 32, &_36$$59);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _37$$61)
					{
						...
						ZVAL_STRING(&_39$$62, "\"");
						ZEPHIR_CALL_FUNCTION(&_40$$62, "addcslashes", &_41, 217, &value$$61, &_39$$62);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_43$$63, "\"");
							ZEPHIR_CALL_FUNCTION(&_44$$63, "addcslashes", &_41, 217, &value$$61, &_43$$63);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_50$$64, "\"");
				ZEPHIR_CALL_FUNCTION(&_51$$64, "addcslashes", &_41, 217, &typeValues, &_50$$64);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, modifyColumn)
{
	...
	if (zephir_is_true(&_10)) {
		...
		_13$$8 = _12$$8;
		if (!(_13$$8)) {
			ZEPHIR_CALL_FUNCTION(&_14$$8, "is_float", NULL, 216, &defaultValue);
			zephir_check_call_status();
		...
		if (_13$$8) {
			...
			ZVAL_STRING(&_16$$10, "\"");
			ZEPHIR_CALL_FUNCTION(&_17$$10, "addcslashes", NULL, 217, &defaultValue, &_16$$10);
			zephir_check_call_status();
