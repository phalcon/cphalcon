...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, createTable) {
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
		{
			...
			if (zephir_is_true(&_5$$7)) {
				...
				if (zephir_memnstr_str(&_6$$8, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 166)) {
					zephir_concat_self_str(&columnLine, SL(" DEFAULT CURRENT_TIMESTAMP") TSRMLS_CC);
				} else {
					ZEPHIR_INIT_NVAR(&_7$$10);
					ZVAL_STRING(&_7$$10, "\"");
					ZEPHIR_CALL_FUNCTION(&_8$$10, "addcslashes", &_9, 165, &defaultValue, &_7$$10);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_16$$14)) {
					...
					if (zephir_memnstr_str(&_17$$15, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 166)) {
						zephir_concat_self_str(&columnLine, SL(" DEFAULT CURRENT_TIMESTAMP") TSRMLS_CC);
					} else {
						ZEPHIR_INIT_NVAR(&_18$$17);
						ZVAL_STRING(&_18$$17, "\"");
						ZEPHIR_CALL_FUNCTION(&_19$$17, "addcslashes", &_9, 165, &defaultValue, &_18$$17);
						zephir_check_call_status();
	...
	if (zephir_array_isset_string(&definition, SL("options"))) {
		ZEPHIR_CALL_METHOD(&_59$$39, this_ptr, "gettableoptions", NULL, 0, &definition);
		zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _31$$58)
					{
						...
						ZVAL_STRING(&_33$$59, "\"");
						ZEPHIR_CALL_FUNCTION(&_34$$59, "addcslashes", &_35, 165, &value$$58, &_33$$59);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_37$$60, "\"");
							ZEPHIR_CALL_FUNCTION(&_38$$60, "addcslashes", &_35, 165, &value$$58, &_37$$60);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_44$$61, "\"");
				ZEPHIR_CALL_FUNCTION(&_45$$61, "addcslashes", &_35, 165, &typeValues, &_44$$61);
				zephir_check_call_status();
