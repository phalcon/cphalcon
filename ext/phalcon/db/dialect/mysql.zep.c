...
{
	zend_bool _30, _12$$12, _15$$14, _16$$14, _17$$14, _38$$25, _41$$27, _42$$27, _43$$27, _63$$33, _85$$46, _102$$53;
	zval indexSql, referenceSql, sql;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL, *_7 = NULL, *_19 = NULL, *_22 = NULL, *_55 = NULL, *_75 = NULL, *_100 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval definition, createLines;
	zval tableName_zv, schemaName_zv, *definition_param = NULL, temporary, options, table, columns, column, indexes, index, reference, references, indexName, columnLine, indexType, onDelete, onUpdate, defaultValue, upperDefaultValue, checks, check, *_2, _29, _105, _106, _0$$5, _1$$6, _3$$7, _4$$7, _6$$7, _8$$7, _9$$7, _10$$7, _25$$7, _26$$7, _11$$11, _24$$11, _13$$13, _14$$13, _18$$14, _20$$15, _21$$16, _23$$16, _27$$19, _28$$19, _31$$20, _32$$20, _33$$20, _34$$20, _35$$20, _36$$20, _49$$20, _50$$20, _37$$24, _48$$24, _39$$26, _40$$26, _44$$27, _45$$28, _46$$29, _47$$29, _51$$32, _52$$32, *_53$$33, _62$$33, _54$$35, _56$$35, _57$$37, _58$$37, _59$$38, _60$$38, _61$$36, _64$$41, _65$$41, _66$$43, _67$$43, _68$$44, _69$$44, _70$$42, *_71$$46, _84$$46, _72$$47, _73$$47, _74$$47, _76$$47, _77$$47, _78$$47, _79$$47, _80$$47, _81$$47, _82$$48, _83$$49, _86$$50, _87$$50, _88$$50, _89$$50, _90$$50, _91$$50, _92$$50, _93$$50, _94$$50, _95$$51, _96$$52, *_97$$53, _101$$53, _98$$54, _99$$54, _103$$55, _104$$55, _107$$56, _108$$56;
	zend_string *tableName = NULL, *schemaName = NULL;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
				...
				if (zephir_is_true(&_11$$11)) {
					...
					if (_12$$12) {
						...
						if (_17$$14) {
							...
							ZEPHIR_CALL_METHOD(&_21$$16, this_ptr, "escapestringliteral", &_22, 0, &defaultValue);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_23$$16);
							ZEPHIR_CONCAT_SVS(&_23$$16, " DEFAULT '", &_21$$16, "'");
							zephir_concat_self(&columnLine, &_23$$16);
						}
					}
				}
				ZEPHIR_CALL_METHOD(&_24$$11, &column, "isautoincrement", NULL, 0);
				zephir_check_call_status();
				if (zephir_is_true(&_24$$11)) {
					zephir_concat_self_str(&columnLine, SL(" AUTO_INCREMENT"));
				}
			}
			ZEPHIR_CALL_METHOD(&_25$$7, &column, "isprimary", NULL, 0);
			zephir_check_call_status();
			if (zephir_is_true(&_25$$7)) {
				zephir_concat_self_str(&columnLine, SL(" PRIMARY KEY"));
			}
			ZEPHIR_CALL_METHOD(&_26$$7, &column, "getcomment", NULL, 0);
			zephir_check_call_status();
			if (zephir_is_true(&_26$$7)) {
				ZEPHIR_CALL_METHOD(&_27$$19, &column, "getcomment", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_28$$19);
				ZEPHIR_CONCAT_SVS(&_28$$19, " COMMENT '", &_27$$19, "'");
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&_29, &columns, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_29)) {
				break;
			}
				...
				if (!(zephir_is_true(&_36$$20))) {
					...
					if (zephir_is_true(&_37$$24)) {
						...
						if (_38$$25) {
							...
							ZEPHIR_INIT_NVAR(&upperDefaultValue);
							zephir_fast_strtoupper(&upperDefaultValue, &defaultValue);
							_41$$27 = zephir_memnstr_str(&upperDefaultValue, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 242);
							if (!(_41$$27)) {
								_41$$27 = zephir_memnstr_str(&upperDefaultValue, SL("NULL"), "phalcon/Db/Dialect/Mysql.zep", 242);
							}
							_42$$27 = _41$$27;
							if (!(_42$$27)) {
							...
							if (_43$$27) {
								...
								ZEPHIR_CALL_METHOD(&_46$$29, this_ptr, "escapestringliteral", &_22, 0, &defaultValue);
								zephir_check_call_status();
								ZEPHIR_INIT_NVAR(&_47$$29);
								ZEPHIR_CONCAT_SVS(&_47$$29, " DEFAULT '", &_46$$29, "'");
								zephir_concat_self(&columnLine, &_47$$29);
							}
						}
					}
					ZEPHIR_CALL_METHOD(&_48$$24, &column, "isautoincrement", NULL, 0);
					zephir_check_call_status();
					if (zephir_is_true(&_48$$24)) {
						zephir_concat_self_str(&columnLine, SL(" AUTO_INCREMENT"));
					}
				}
				ZEPHIR_CALL_METHOD(&_49$$20, &column, "isprimary", NULL, 0);
				zephir_check_call_status();
				if (zephir_is_true(&_49$$20)) {
					zephir_concat_self_str(&columnLine, SL(" PRIMARY KEY"));
				}
				ZEPHIR_CALL_METHOD(&_50$$20, &column, "getcomment", NULL, 0);
				zephir_check_call_status();
				if (zephir_is_true(&_50$$20)) {
					ZEPHIR_CALL_METHOD(&_51$$32, &column, "getcomment", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_52$$32);
					ZEPHIR_CONCAT_SVS(&_52$$32, " COMMENT '", &_51$$32, "'");
					zephir_concat_self(&columnLine, &_52$$32);
				}
				zephir_array_append(&createLines, &columnLine, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 272);
		}
	}
	...
	if (zephir_array_isset_string_fetch(&indexes, &definition, SL("indexes"), 0)) {
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _53$$33)
			{
				ZEPHIR_INIT_NVAR(&index);
				ZVAL_COPY(&index, _53$$33);
				ZEPHIR_CALL_METHOD(&indexName, &index, "getname", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&indexType, &index, "gettype", NULL, 0);
				zephir_check_call_status();
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					ZEPHIR_CALL_METHOD(&_54$$35, this_ptr, "getindexcolumnlist", &_55, 0, &index);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_56$$35);
					ZEPHIR_CONCAT_SVS(&_56$$35, "PRIMARY KEY (", &_54$$35, ")");
					zephir_get_strval(&indexSql, &_56$$35);
				} else {
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						ZEPHIR_CALL_METHOD(&_57$$37, this_ptr, "getindexcolumnlist", &_55, 0, &index);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_58$$37);
						ZEPHIR_CONCAT_VSVSVS(&_58$$37, &indexType, " KEY `", &indexName, "` (", &_57$$37, ")");
						zephir_get_strval(&indexSql, &_58$$37);
					} else {
						ZEPHIR_CALL_METHOD(&_59$$38, this_ptr, "getindexcolumnlist", &_55, 0, &index);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_60$$38);
						ZEPHIR_CONCAT_SVSVS(&_60$$38, "KEY `", &indexName, "` (", &_59$$38, ")");
						zephir_get_strval(&indexSql, &_60$$38);
					}
					ZEPHIR_CALL_METHOD(&_61$$36, &index, "isinvisible", NULL, 0);
					zephir_check_call_status();
					if (zephir_is_true(&_61$$36)) {
			...
			while (1) {
				...
				ZEPHIR_CALL_METHOD(&_62$$33, &indexes, "valid", NULL, 0);
				zephir_check_call_status();
				if (!zend_is_true(&_62$$33)) {
					break;
				}
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						ZEPHIR_CALL_METHOD(&_64$$41, this_ptr, "getindexcolumnlist", &_55, 0, &index);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							ZEPHIR_CALL_METHOD(&_66$$43, this_ptr, "getindexcolumnlist", &_55, 0, &index);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_67$$43);
							ZEPHIR_CONCAT_VSVSVS(&_67$$43, &indexType, " KEY `", &indexName, "` (", &_66$$43, ")");
							zephir_get_strval(&indexSql, &_67$$43);
						} else {
							ZEPHIR_CALL_METHOD(&_68$$44, this_ptr, "getindexcolumnlist", &_55, 0, &index);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _71$$46)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_73$$47, this_ptr, "getcolumnlist", &_75, 119, &_74$$47);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_79$$47, this_ptr, "getcolumnlist", &_75, 119, &_80$$47);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_86$$50, &reference, "getname", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_88$$50, &reference, "getcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_87$$50, this_ptr, "getcolumnlist", &_75, 119, &_88$$50);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_90$$50, &reference, "getreferencedtable", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_91$$50, &reference, "getreferencedschema", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_89$$50, this_ptr, "preparetable", NULL, 0, &_90$$50, &_91$$50);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_93$$50, &reference, "getreferencedcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_92$$50, this_ptr, "getcolumnlist", &_75, 119, &_93$$50);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_94$$50);
					ZEPHIR_CONCAT_SVSVSSVSVS(&_94$$50, "CONSTRAINT `", &_86$$50, "` FOREIGN KEY (", &_87$$50, ")", " REFERENCES ", &_89$$50, " (", &_92$$50, ")");
					zephir_get_strval(&referenceSql, &_94$$50);
					ZEPHIR_CALL_METHOD(&onDelete, &reference, "getondelete", NULL, 0);
					zephir_check_call_status();
					if (!(ZEPHIR_IS_EMPTY(&onDelete))) {
						ZEPHIR_INIT_NVAR(&_95$$51);
						ZEPHIR_CONCAT_SV(&_95$$51, " ON DELETE ", &onDelete);
						zephir_concat_self(&referenceSql, &_95$$51);
					}
					ZEPHIR_CALL_METHOD(&onUpdate, &reference, "getonupdate", NULL, 0);
					zephir_check_call_status();
					if (!(ZEPHIR_IS_EMPTY(&onUpdate))) {
						ZEPHIR_INIT_NVAR(&_96$$52);
						ZEPHIR_CONCAT_SV(&_96$$52, " ON UPDATE ", &onUpdate);
						zephir_concat_self(&referenceSql, &_96$$52);
					}
					zephir_array_append(&createLines, &referenceSql, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 322);
			}
		}
	...
	if (zephir_array_isset_string_fetch(&checks, &definition, SL("checks"), 0)) {
		...
		if (Z_TYPE_P(&checks) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&checks), _97$$53)
			{
				ZEPHIR_INIT_NVAR(&check);
				ZVAL_COPY(&check, _97$$53);
				ZEPHIR_INIT_NVAR(&_99$$54);
				ZVAL_STRING(&_99$$54, "`");
				ZEPHIR_CALL_METHOD(&_98$$54, this_ptr, "getcheckclause", &_100, 0, &check, &_99$$54);
				zephir_check_call_status();
				zephir_array_append(&createLines, &_98$$54, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 331);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				ZEPHIR_CALL_METHOD(&_101$$53, &checks, "valid", NULL, 0);
				zephir_check_call_status();
				if (!zend_is_true(&_101$$53)) {
					break;
				}
				ZEPHIR_CALL_METHOD(&check, &checks, "current", NULL, 0);
				zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_104$$55);
					ZVAL_STRING(&_104$$55, "`");
					ZEPHIR_CALL_METHOD(&_103$$55, this_ptr, "getcheckclause", &_100, 0, &check, &_104$$55);
					zephir_check_call_status();
					zephir_array_append(&createLines, &_103$$55, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 331);
			}
		}
		ZEPHIR_INIT_NVAR(&check);
	}
	...
	if (zephir_array_isset_value_string(&definition, SL("options"))) {
		ZEPHIR_CALL_METHOD(&_107$$56, this_ptr, "gettableoptions", NULL, 0, &definition);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_108$$56);
		ZEPHIR_CONCAT_SV(&_108$$56, " ", &_107$$56);
		zephir_concat_self(&sql, &_108$$56);
	}
	RETURN_CTOR(&sql);
}
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _37$$77)
					{
						...
						ZEPHIR_CALL_METHOD(&_38$$78, this_ptr, "escapestringliteral", &_39, 0, &value$$77);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_40$$78);
						ZEPHIR_CONCAT_SVS(&_40$$78, "'", &_38$$78, "', ");
						zephir_concat_self(&valueSql$$77, &_40$$78);
					} ZEND_HASH_FOREACH_END();
				} else {
					...
					while (1) {
						...
						ZEPHIR_CALL_METHOD(&_41$$77, &typeValues, "valid", NULL, 0);
						zephir_check_call_status();
						if (!zend_is_true(&_41$$77)) {
							break;
						}
						ZEPHIR_CALL_METHOD(&value$$77, &typeValues, "current", NULL, 0);
						zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_43$$79, this_ptr, "escapestringliteral", &_39, 0, &value$$77);
							zephir_check_call_status();
							ZEPHIR_INIT_NVAR(&_44$$79);
							ZEPHIR_CONCAT_SVS(&_44$$79, "'", &_43$$79, "', ");
							zephir_concat_self(&valueSql$$77, &_44$$79);
					}
				}
				ZEPHIR_INIT_NVAR(&value$$77);
				ZVAL_LONG(&_45$$77, 0);
				ZVAL_LONG(&_46$$77, -2);
				ZEPHIR_INIT_VAR(&_47$$77);
				zephir_substr(&_47$$77, &valueSql$$77, 0 , -2 , 0);
				ZEPHIR_INIT_VAR(&_48$$77);
				ZEPHIR_CONCAT_SVS(&_48$$77, "(", &_47$$77, ")");
				zephir_concat_self(&columnSql, &_48$$77);
			} else {
				ZEPHIR_CALL_METHOD(&_49$$80, this_ptr, "escapestringliteral", &_39, 0, &typeValues);
				zephir_check_call_status();
				ZEPHIR_INIT_VAR(&_50$$80);
				ZEPHIR_CONCAT_SVS(&_50$$80, "('", &_49$$80, "')");
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, modifyColumn)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval tableName_zv, schemaName_zv, *column, column_sub, *currentColumn = NULL, currentColumn_sub, __$null, afterPosition, defaultValue, upperDefaultValue, columnDefinition, _0, _1, _2, _3, _4, _5, _11, _12, _13, _26, _29, _6$$4, _7$$4, _8$$4, _9$$5, _10$$5, _14$$9, _25$$9, _16$$11, _17$$11, _21$$12, _22$$13, _23$$14, _24$$14, _27$$16, _28$$16, _30$$19;
	zend_string *tableName = NULL, *schemaName = NULL;
	zval *this_ptr = getThis();
	...
	if (zephir_is_true(&_26)) {
		ZEPHIR_CALL_METHOD(&_27$$16, column, "getcomment", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_28$$16);
		ZEPHIR_CONCAT_SVS(&_28$$16, " COMMENT '", &_27$$16, "'");
		zephir_concat_self(&sql, &_28$$16);
	}
	ZEPHIR_CALL_METHOD(&_29, column, "isfirst", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_29)) {
		...
		if (zephir_is_true(&afterPosition)) {
			...
			ZEPHIR_CONCAT_SVS(&_30$$19, " AFTER `", &afterPosition, "`");
			zephir_concat_self(&sql, &_30$$19);
		}
	}
	RETURN_CTOR(&sql);
}
