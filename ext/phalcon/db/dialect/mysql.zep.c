...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addColumn) {
	...
	zval *tableName_param = NULL, *schemaName_param = NULL, *column, column_sub, afterPosition, defaultValue, _0, _1, _2, _3, _4, _10, _11, _12, _5$$3, _6$$4, _7$$5, _8$$5, _9$$5, _13$$11;
	...
	if (zephir_is_true(&_4)) {
		...
		if (zephir_memnstr_str(&_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 44)) {
			...
			ZEPHIR_CONCAT_SV(&_6$$4, " DEFAULT ", &defaultValue);
			zephir_concat_self(&sql, &_6$$4);
		} else {
			ZEPHIR_INIT_VAR(&_7$$5);
			ZVAL_STRING(&_7$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_8$$5, "addcslashes", NULL, 196, &defaultValue, &_7$$5);
			zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_12, column, "isfirst", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_12)) {
		...
		if (zephir_is_true(&afterPosition)) {
			...
			ZEPHIR_CONCAT_SVS(&_13$$11, " AFTER `", &afterPosition, "`");
			...
			if (zephir_is_true(&_7$$7)) {
				...
				if (Z_TYPE_P(&defaultValue) == IS_NULL) {
					...
					if (zephir_memnstr_str(&_8$$10, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 180)) {
						...
						ZVAL_STRING(&_10$$12, "\"");
						ZEPHIR_CALL_FUNCTION(&_11$$12, "addcslashes", &_12, 196, &defaultValue, &_10$$12);
						zephir_check_call_status();
				...
				if (zephir_is_true(&_19$$17)) {
					...
					if (Z_TYPE_P(&defaultValue) == IS_NULL) {
						...
						if (zephir_memnstr_str(&_20$$20, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 180)) {
							...
							ZVAL_STRING(&_22$$22, "\"");
							ZEPHIR_CALL_FUNCTION(&_23$$22, "addcslashes", &_12, 196, &defaultValue, &_22$$22);
							zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _28$$27)
			{
				...
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_30$$29, this_ptr, "getcolumnlist", &_32, 65, &_31$$29);
					zephir_check_call_status();
					...
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_34$$31, this_ptr, "getcolumnlist", &_32, 65, &_35$$31);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_37$$32, this_ptr, "getcolumnlist", &_32, 65, &_38$$32);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_40$$34, this_ptr, "getcolumnlist", &_32, 65, &_41$$34);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_43$$36, this_ptr, "getcolumnlist", &_32, 65, &_44$$36);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_46$$37, this_ptr, "getcolumnlist", &_32, 65, &_47$$37);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _49$$38)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_52$$39, this_ptr, "getcolumnlist", &_32, 65, &_53$$39);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_57$$39, this_ptr, "getcolumnlist", &_32, 65, &_58$$39);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_63$$42, this_ptr, "getcolumnlist", &_32, 65, &_64$$42);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_68$$42, this_ptr, "getcolumnlist", &_32, 65, &_69$$42);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, getColumnDefinition) {
	...
	do {
		...
		if (UNEXPECTED(ZEPHIR_IS_EMPTY(&columnSql))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_28$$56, "phalcon/Db/Dialect/Mysql.zep", 612);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				zephir_is_iterable(&typeValues, 0, "phalcon/Db/Dialect/Mysql.zep", 626);
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, modifyColumn) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *tableName_param = NULL, *schemaName_param = NULL, *column, column_sub, *currentColumn = NULL, currentColumn_sub, __$null, afterPosition, defaultValue, columnDefinition, _0, _1, _2, _3, _9, _15, _16, _17, _4$$4, _5$$4, _6$$4, _7$$5, _8$$5, _10$$6, _11$$7, _12$$8, _13$$8, _14$$8, _18$$14;
	zval tableName, schemaName, sql;
	zval *this_ptr = getThis();
	...
	if (zephir_is_true(&_9)) {
		...
		if (zephir_memnstr_str(&_10$$6, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 698)) {
			ZEPHIR_INIT_VAR(&_11$$7);
			ZEPHIR_CONCAT_SV(&_11$$7, " DEFAULT ", &defaultValue);
			zephir_concat_self(&sql, &_11$$7);
		} else {
			ZEPHIR_INIT_VAR(&_12$$8);
			ZVAL_STRING(&_12$$8, "\"");
			ZEPHIR_CALL_FUNCTION(&_13$$8, "addcslashes", NULL, 196, &defaultValue, &_12$$8);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_14$$8);
			ZEPHIR_CONCAT_SVS(&_14$$8, " DEFAULT \"", &_13$$8, "\"");
			zephir_concat_self(&sql, &_14$$8);
		}
	}
	...
	ZEPHIR_CALL_METHOD(&_16, column, "isautoincrement", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_16)) {
		zephir_concat_self_str(&sql, " AUTO_INCREMENT", sizeof(" AUTO_INCREMENT") - 1);
	}
	ZEPHIR_CALL_METHOD(&_17, column, "isfirst", NULL, 0);
	zephir_check_call_status();
	if (zephir_is_true(&_17)) {
		...
		if (zephir_is_true(&afterPosition)) {
			...
			ZEPHIR_CONCAT_SVS(&_18$$14, " AFTER `", &afterPosition, "`");
			zephir_concat_self(&sql, &_18$$14);
		}
	}
	RETURN_CTOR(&sql);
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, getTableOptions) {
	...
	if (zephir_array_isset_string_fetch(&engine, &options, SL("ENGINE"), 0)) {
		if (zephir_is_true(&engine)) {
			...
			zephir_array_append(&tableOptions, &_0$$5, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 823);
		}
	}
	...
	if (zephir_array_isset_string_fetch(&autoIncrement, &options, SL("AUTO_INCREMENT"), 0)) {
		if (zephir_is_true(&autoIncrement)) {
			...
			zephir_array_append(&tableOptions, &_1$$7, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 832);
		}
	}
	...
	if (zephir_array_isset_string_fetch(&tableCollation, &options, SL("TABLE_COLLATION"), 0)) {
		if (zephir_is_true(&tableCollation)) {
			...
			zephir_array_fetch_long(&_2$$9, &collationParts, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect/Mysql.zep", 842);
			ZEPHIR_INIT_VAR(&_3$$9);
			ZEPHIR_CONCAT_SV(&_3$$9, "DEFAULT CHARSET=", &_2$$9);
			zephir_array_append(&tableOptions, &_3$$9, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 842);
			ZEPHIR_INIT_VAR(&_4$$9);
			ZEPHIR_CONCAT_SV(&_4$$9, "COLLATE=", &tableCollation);
			zephir_array_append(&tableOptions, &_4$$9, PH_SEPARATE, "phalcon/Db/Dialect/Mysql.zep", 843);
		}
	}
