...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, createTable)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_5 = NULL, *_7 = NULL, *_19 = NULL, *_22 = NULL, *_57 = NULL, *_77 = NULL, *_102 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval definition, createLines;
	zval tableName_zv, schemaName_zv, *definition_param = NULL, temporary, options, table, columns, column, indexes, index, reference, references, indexName, columnLine, indexType, onDelete, onUpdate, defaultValue, upperDefaultValue, checks, check, *_2, _30, _107, _108, _0$$5, _1$$6, _3$$7, _4$$7, _6$$7, _8$$7, _9$$7, _10$$7, _25$$7, _26$$7, _11$$11, _24$$11, _13$$13, _14$$13, _18$$14, _20$$15, _21$$16, _23$$16, _27$$19, _28$$19, _29$$19, _32$$20, _33$$20, _34$$20, _35$$20, _36$$20, _37$$20, _50$$20, _51$$20, _38$$24, _49$$24, _40$$26, _41$$26, _45$$27, _46$$28, _47$$29, _48$$29, _52$$32, _53$$32, _54$$32, *_55$$33, _64$$33, _56$$35, _58$$35, _59$$37, _60$$37, _61$$38, _62$$38, _63$$36, _66$$41, _67$$41, _68$$43, _69$$43, _70$$44, _71$$44, _72$$42, *_73$$46, _86$$46, _74$$47, _75$$47, _76$$47, _78$$47, _79$$47, _80$$47, _81$$47, _82$$47, _83$$47, _84$$48, _85$$49, _88$$50, _89$$50, _90$$50, _91$$50, _92$$50, _93$$50, _94$$50, _95$$50, _96$$50, _97$$51, _98$$52, *_99$$53, _103$$53, _100$$54, _101$$54, _105$$55, _106$$55, _109$$56, _110$$56;
	zend_string *tableName = NULL, *schemaName = NULL;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _2)
		{
			...
			if (zephir_is_true(&_26$$7)) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_27$$19, this_ptr, "escapestringliteral", &_22, 0, &_28$$19);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_29$$19);
				ZEPHIR_CONCAT_SVS(&_29$$19, " COMMENT '", &_27$$19, "'");
		...
		while (1) {
			...
			zephir_check_call_status();
					...
					if (zephir_is_true(&_38$$24)) {
						...
						if (_39$$25) {
							...
							if (_44$$27) {
								...
								ZEPHIR_CALL_METHOD(&_47$$29, this_ptr, "escapestringliteral", &_22, 0, &defaultValue);
								zephir_check_call_status();
				...
				if (zephir_is_true(&_51$$20)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_52$$32, this_ptr, "escapestringliteral", &_22, 0, &_53$$32);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_54$$32);
					ZEPHIR_CONCAT_SVS(&_54$$32, " COMMENT '", &_52$$32, "'");
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _73$$46)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_75$$47, this_ptr, "getcolumnlist", &_77, 119, &_76$$47);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_81$$47, this_ptr, "getcolumnlist", &_77, 119, &_82$$47);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_89$$50, this_ptr, "getcolumnlist", &_77, 119, &_90$$50);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_94$$50, this_ptr, "getcolumnlist", &_77, 119, &_95$$50);
					zephir_check_call_status();
