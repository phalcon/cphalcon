		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _31$$58)
				{
					...
					ZVAL_STRING(&_32$$59, "\"");
					ZEPHIR_CALL_FUNCTION(&_33$$59, "addcslashes", &_34, 146, &value$$58, &_32$$59);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_40$$60, "\"");
				ZEPHIR_CALL_FUNCTION(&_41$$60, "addcslashes", &_34, 146, &typeValues, &_40$$60);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, modifyColumn) {
	...
	if (zephir_is_true(&_8)) {
		...
		if (zephir_memnstr_str(&_9$$6, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/mysql.zep", 293)) {
			...
			ZVAL_STRING(&_10$$8, "\"");
			ZEPHIR_CALL_FUNCTION(&_11$$8, "addcslashes", NULL, 146, &defaultValue, &_10$$8);
			zephir_check_call_status();
