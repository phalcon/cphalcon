		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$36)
				{
					...
					ZVAL_STRING(&_9$$37, "\\'");
					ZEPHIR_CALL_FUNCTION(&_10$$37, "addcslashes", &_11, 159, &value$$36, &_9$$37);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_17$$38, "\\'");
				ZEPHIR_CALL_FUNCTION(&_18$$38, "addcslashes", &_11, 159, &typeValues, &_17$$38);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, _castDefault) {
	...
	if (_5) {
		...
		ZVAL_STRING(&_7$$6, "\\'");
		ZEPHIR_CALL_FUNCTION(&_8$$6, "addcslashes", NULL, 159, &defaultValue, &_7$$6);
		zephir_check_call_status();
