...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, addForeignKey)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "getcolumnlist", NULL, 106, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_10);
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createTable)
{
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_48$$19, this_ptr, "getcolumnlist", NULL, 106, &primaryColumns);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _72$$33)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_74$$34, this_ptr, "getcolumnlist", NULL, 106, &_75$$34);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_79$$34, this_ptr, "getcolumnlist", NULL, 106, &_80$$34);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_87$$37, this_ptr, "getcolumnlist", NULL, 106, &_88$$37);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_92$$37, this_ptr, "getcolumnlist", NULL, 106, &_93$$37);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, getColumnDefinition)
{
	...
	do {
		...
		if (UNEXPECTED(ZEPHIR_IS_EMPTY(&columnSql))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_5$$74, "__construct", NULL, 439, &_7$$74, &_6$$74);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$76)
					{
						...
						ZVAL_STRING(&_9$$77, "\'");
						ZEPHIR_CALL_FUNCTION(&_10$$77, "addcslashes", &_11, 436, &value$$76, &_9$$77);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_15$$78, "\'");
							ZEPHIR_CALL_FUNCTION(&_16$$78, "addcslashes", &_11, 436, &value$$76, &_15$$78);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_22$$79, "\'");
				ZEPHIR_CALL_FUNCTION(&_23$$79, "addcslashes", &_11, 436, &typeValues, &_22$$79);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, castDefault)
{
	...
	if (_10) {
		...
		ZVAL_STRING(&_12$$7, "\'");
		ZEPHIR_CALL_FUNCTION(&_13$$7, "addcslashes", NULL, 436, &defaultValue, &_12$$7);
		zephir_check_call_status();
