			...
			if (Z_TYPE_P(typeValues) == IS_ARRAY) {
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_3, &_2)
					...
					ZVAL_STRING(&_5, "\"", 0);
					ZEPHIR_CALL_FUNCTION(&_0, "addcslashes", &_6, 140, value, &_5);
					zephir_check_call_status();
					ZEPHIR_INIT_LNVAR(_1);
					ZEPHIR_CONCAT_SVS(_1, "\"", _0, "\", ");
				...
				ZVAL_STRING(&_7, "\"", 0);
				ZEPHIR_CALL_FUNCTION(&_10, "addcslashes", &_6, 140, typeValues, &_7);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, modifyColumn) {
	...
	if (!ZEPHIR_IS_EQUAL(_3, _4)) {
		...
		if (!(ZEPHIR_IS_EMPTY(defaultValue))) {
			...
			ZVAL_STRING(&_11, "\"", 0);
			ZEPHIR_CALL_FUNCTION(&_12, "addcslashes", NULL, 140, defaultValue, &_11);
			zephir_check_call_status();
			ZEPHIR_INIT_LNVAR(_9);
		  ...
		  ; zephir_hash_move_forward_ex(_13, &_12)
			...
			if (ZEPHIR_IS_STRING(indexName, "PRIMARY")) {
				...
				if (!(ZEPHIR_IS_EMPTY(indexType))) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_15, this_ptr, "preparetable", NULL, 142, tableName, schemaName);
					zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, definition, SS("references"), 0 TSRMLS_CC)) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_21, &_20)
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_10, this_ptr, "preparetable", NULL, 142, _11, schemaName);
			zephir_check_call_status();
