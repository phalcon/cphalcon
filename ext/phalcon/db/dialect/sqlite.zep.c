		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$40)
				{
					...
					ZVAL_STRING(&_9$$41, "\"");
					ZEPHIR_CALL_FUNCTION(&_10$$41, "addcslashes", &_11, 162, &value$$40, &_9$$41);
					zephir_check_call_status();
				...
				ZVAL_STRING(&_17$$42, "\"");
				ZEPHIR_CALL_FUNCTION(&_18$$42, "addcslashes", &_11, 162, &typeValues, &_17$$42);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn) {
	...
	if (zephir_is_true(&_4)) {
		...
		if (zephir_memnstr_str(&_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 187)) {
			...
			ZVAL_STRING(&_6$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_7$$5, "addcslashes", NULL, 162, &defaultValue, &_6$$5);
			zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
	{
		...
		if (zephir_is_true(&_8$$7)) {
			...
			if (zephir_memnstr_str(&_9$$10, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 344)) {
				...
				ZVAL_STRING(&_10$$12, "\"");
				ZEPHIR_CALL_FUNCTION(&_11$$12, "addcslashes", &_12, 162, &defaultValue, &_10$$12);
				zephir_check_call_status();
