	...
	if (_7) {
		...
		if (_9$$3) {
			...
			if (zephir_memnstr_str(&_10$$3, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 67)) {
				...
				ZVAL_STRING(&_13$$6, "\"");
				ZEPHIR_CALL_FUNCTION(&_14$$6, "addcslashes", NULL, 507, &defaultValue, &_13$$6);
				zephir_check_call_status();
				...
				if (zephir_is_true(&_13$$8)) {
					...
					if (_14$$11) {
						...
						if (zephir_memnstr_str(&_15$$11, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 209)) {
							...
							ZVAL_STRING(&_18$$14, "\"");
							ZEPHIR_CALL_FUNCTION(&_19$$14, "addcslashes", &_20, 507, &defaultValue, &_18$$14);
							zephir_check_call_status();
					...
					if (zephir_is_true(&_33$$18)) {
						...
						if (_34$$21) {
							...
							if (zephir_memnstr_str(&_35$$21, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 209)) {
								...
								ZVAL_STRING(&_38$$24, "\"");
								ZEPHIR_CALL_FUNCTION(&_39$$24, "addcslashes", &_20, 507, &defaultValue, &_38$$24);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, getColumnDefinition)
{
	...
	do {
		...
		if (ZEPHIR_IS_EMPTY(&columnSql)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_5$$38, "__construct", NULL, 510, &_7$$38, &_6$$38);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_15$$42, "\"");
							ZEPHIR_CALL_FUNCTION(&_16$$42, "addcslashes", &_11, 507, &value$$40, &_15$$42);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_22$$43, "\"");
				ZEPHIR_CALL_FUNCTION(&_23$$43, "addcslashes", &_11, 507, &typeValues, &_22$$43);
				zephir_check_call_status();
