			...
			if (Z_TYPE_P(typeValues) == IS_ARRAY) {
				...
				for (
				  ...
				  ; zephir_hash_move_forward_ex(_13$$41, &_12$$41)
					...
					ZEPHIR_CALL_FUNCTION(&_16$$42, "addcslashes", &_17, 149, value$$41, &_15$$42);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_24$$43, "addcslashes", &_17, 149, typeValues, &_23$$43);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn) {
	...
	if (zephir_is_true(_4)) {
		...
		if (zephir_memnstr_str(_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 203)) {
			...
			ZVAL_STRING(&_6$$5, "\"", 0);
			ZEPHIR_CALL_FUNCTION(&_7$$5, "addcslashes", NULL, 149, defaultValue, &_6$$5);
			zephir_check_call_status();
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		if (zephir_is_true(_10$$7)) {
			...
			if (zephir_memnstr_str(_11$$10, SL("CURRENT_TIMESTAMP"), "phalcon/db/dialect/sqlite.zep", 360)) {
				...
				ZEPHIR_CALL_FUNCTION(&_13$$12, "addcslashes", &_14, 149, defaultValue, &_12$$12);
				zephir_check_call_status();
