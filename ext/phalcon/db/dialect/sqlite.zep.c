...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn)
{
	...
	if (zephir_is_true(&_5)) {
		...
		if (zephir_memnstr_str(&_6$$3, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 46)) {
			...
			ZVAL_STRING(&_7$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_8$$5, "addcslashes", NULL, 230, &defaultValue, &_7$$5);
			zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _2)
		{
			...
			if (zephir_is_true(&_11$$7)) {
				...
				if (zephir_memnstr_str(&_12$$10, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 175)) {
					...
					ZVAL_STRING(&_13$$12, "\"");
					ZEPHIR_CALL_FUNCTION(&_14$$12, "addcslashes", &_15, 230, &defaultValue, &_13$$12);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_24$$15)) {
					...
					if (zephir_memnstr_str(&_25$$18, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 175)) {
						...
						ZVAL_STRING(&_26$$20, "\"");
						ZEPHIR_CALL_FUNCTION(&_27$$20, "addcslashes", &_15, 230, &defaultValue, &_26$$20);
						zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$40)
					{
						...
						ZVAL_STRING(&_10$$41, "\"");
						ZEPHIR_CALL_FUNCTION(&_11$$41, "addcslashes", &_12, 230, &value$$40, &_10$$41);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_14$$42, "\"");
							ZEPHIR_CALL_FUNCTION(&_15$$42, "addcslashes", &_12, 230, &value$$40, &_14$$42);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_21$$43, "\"");
				ZEPHIR_CALL_FUNCTION(&_22$$43, "addcslashes", &_12, 230, &typeValues, &_21$$43);
				zephir_check_call_status();
