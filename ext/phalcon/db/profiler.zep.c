...
PHP_METHOD(Phalcon_Db_Profiler, startProfile)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &activeProfile, "setsqlstatement", NULL, 451, &sqlStatement_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &activeProfile, "setsqlvariables", NULL, 452, &sqlVariables);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &activeProfile, "setsqlbindtypes", NULL, 453, &sqlBindTypes);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_0, "hrtime", NULL, 402, &__$true);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &activeProfile, "setinitialtime", NULL, 454, &_0);
	zephir_check_call_status();
