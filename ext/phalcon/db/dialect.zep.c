...
{
	zend_bool _4$$5, _13$$7, _14$$7, _18$$9, _19$$9;
	zend_ulong _11;
	zval _8;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval escapeChar, _3$$4, _6$$6, _16$$7, _21$$9;
	zval str_zv, *escapeChar_param = NULL, parts, key, part, newParts, _0, _1, _7, *_9, _10, _2$$4, _5$$6, _15$$7, _17$$7, _20$$9, _22$$9;
	zend_string *str = NULL, *_12;
	...
	if (!(zephir_memnstr_str(&str_zv, SL("."), "phalcon/Db/Dialect.zep", 65))) {
	...
	zephir_is_iterable(&parts, 0, "phalcon/Db/Dialect.zep", 85);
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _11, _12, _9)
		{
			...
			ZVAL_COPY(&part, _9);
			_13$$7 = ZEPHIR_IS_STRING(&escapeChar, "");
			if (!(_13$$7)) {
			...
			ZEPHIR_CONCAT_VV(&_16$$7, &escapeChar, &escapeChar);
			zephir_fast_str_replace(&_15$$7, &escapeChar, &_16$$7, &part);
			ZEPHIR_INIT_NVAR(&_17$$7);
			ZEPHIR_CONCAT_VVV(&_17$$7, &escapeChar, &_15$$7, &escapeChar);
			zephir_array_update_zval(&newParts, &key, &_17$$7, PH_COPY | PH_SEPARATE);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, &parts, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_10, &parts, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_10)) {
				break;
			}
			...
			zephir_check_call_status();
				_18$$9 = ZEPHIR_IS_STRING(&escapeChar, "");
				if (!(_18$$9)) {
					_18$$9 = ZEPHIR_IS_STRING(&part, "");
				}
				_19$$9 = _18$$9;
				if (!(_19$$9)) {
					_19$$9 = ZEPHIR_IS_STRING(&part, "*");
				}
				if (_19$$9) {
					continue;
				}
				...
				ZEPHIR_CONCAT_VV(&_21$$9, &escapeChar, &escapeChar);
				zephir_fast_str_replace(&_20$$9, &escapeChar, &_21$$9, &part);
				ZEPHIR_INIT_NVAR(&_22$$9);
				ZEPHIR_CONCAT_VVV(&_22$$9, &escapeChar, &_20$$9, &escapeChar);
				zephir_array_update_zval(&newParts, &key, &_22$$9, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Db_Dialect, getColumnList)
{
	...
	zval *columnList_param = NULL, escapeChar_zv, *bindCounts_param = NULL, column, *_0, _1, _2$$3, _4$$4;
	...
	array_init(&columns);
	zephir_is_iterable(&columnList, 0, "phalcon/Db/Dialect.zep", 157);
	if (Z_TYPE_P(&columnList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columnList), _0)
		{
			ZEPHIR_INIT_NVAR(&column);
			ZVAL_COPY(&column, _0);
			ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getsqlcolumn", &_3, 80, &column, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			zephir_array_append(&columns, &_2$$3, PH_SEPARATE, "phalcon/Db/Dialect.zep", 154);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getsqlcolumn", &_3, 80, &column, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				zephir_array_append(&columns, &_4$$4, PH_SEPARATE, "phalcon/Db/Dialect.zep", 154);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlColumn)
{
	...
	if (!(zephir_array_isset_value_string(column, SL("type")))) {
		...
		zephir_array_fetch_long(&columnField, column, 0, PH_NOISY, "phalcon/Db/Dialect.zep", 189);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpression)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&type, &expression, SL("type"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 81);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Db/Dialect.zep", 253);
		ZEPHIR_MM_RESTORE();
		return;
	}
	do {
		if (ZEPHIR_IS_STRING(&type, "scalar")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionscalar", NULL, 82, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "object")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionobject", NULL, 83, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "qualified")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionqualified", NULL, 84, &expression, &escapeChar_zv);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "literal")) {
			zephir_array_fetch_string(&_1$$7, &expression, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 287);
			RETURN_CTOR(&_1$$7);
		}
		if (ZEPHIR_IS_STRING(&type, "placeholder")) {
			...
			if (zephir_array_isset_string_fetch(&times, &expression, SL("times"), 0)) {
				...
				zephir_array_fetch_string(&rawValue, &expression, SL("rawValue"), PH_NOISY, "phalcon/Db/Dialect.zep", 293);
				zephir_memory_observe(&value);
				zephir_array_fetch_string(&value, &expression, SL("value"), PH_NOISY, "phalcon/Db/Dialect.zep", 294);
				...
				if (ZEPHIR_GE_LONG(&_4$$9, _3$$9)) {
					while (1) {
						...
						zephir_array_append(&placeholders, &_6$$11, PH_SEPARATE, "phalcon/Db/Dialect.zep", 301);
					}
				}
				zephir_fast_join_str(return_value, SL(", "), &placeholders);
				RETURN_MM();
			}
			zephir_array_fetch_string(&_7$$8, &expression, SL("value"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 307);
			RETURN_CTOR(&_7$$8);
		}
		if (ZEPHIR_IS_STRING(&type, "binary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionbinaryoperations", NULL, 85, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "unary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionunaryoperations", NULL, 86, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "parentheses")) {
			zephir_array_fetch_string(&_9$$14, &expression, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 333);
			ZEPHIR_CALL_METHOD(&_8$$14, this_ptr, "getsqlexpression", NULL, 87, &_9$$14, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			ZEPHIR_CONCAT_SVS(return_value, "(", &_8$$14, ")");
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "functionCall")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionfunctioncall", NULL, 88, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "list")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionlist", NULL, 89, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "all")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionall", NULL, 90, &expression, &escapeChar_zv);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "select")) {
			zephir_memory_observe(&nestedDefinition);
			zephir_array_fetch_string(&nestedDefinition, &expression, SL("value"), PH_NOISY, "phalcon/Db/Dialect.zep", 372);
		...
		if (ZEPHIR_IS_STRING(&type, "cast")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncastvalue", NULL, 91, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "convert")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionconvertvalue", NULL, 92, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "case")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncase", NULL, 93, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
	} while(0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_11, "__construct", NULL, 94, &type);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_11, "phalcon/Db/Dialect.zep", 409);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlTable)
{
	...
	if (Z_TYPE_P(table) == IS_ARRAY) {
		...
		zephir_array_fetch_long(&tableName, table, 0, PH_NOISY, "phalcon/Db/Dialect.zep", 425);
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 95, table, &escapeChar_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Db_Dialect, limit)
{
	...
	if (Z_TYPE_P(number) == IS_ARRAY) {
		zephir_array_fetch_long(&_0$$3, number, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 468);
		ZEPHIR_INIT_VAR(&_1$$3);
		ZEPHIR_CONCAT_SV(&_1$$3, " LIMIT ", &_0$$3);
		zephir_concat_self(&sqlQuery, &_1$$3);
		_2$$3 = zephir_array_isset_value_long(number, 1);
		if (_2$$3) {
			zephir_array_fetch_long(&_3$$3, number, 1, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 470);
			_2$$3 = ((zephir_fast_strlen_ev(&_3$$3)) ? 1 : 0);
		}
		if (_2$$3) {
			zephir_array_fetch_long(&_4$$4, number, 1, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 471);
...
PHP_METHOD(Phalcon_Db_Dialect, createMaterializedView)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 96);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Db/Dialect.zep", 497);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Db_Dialect, dropMaterializedView)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 96);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Db/Dialect.zep", 505);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Db_Dialect, refreshMaterializedView)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 96);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Db/Dialect.zep", 516);
	ZEPHIR_MM_RESTORE();
	return;
}
...
{
	zval _5$$5, _8$$5, _11$$6, _13$$6;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_6 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval conflictColumns, updateColumns, assignments;
	zval sqlQuery_zv, *conflictColumns_param = NULL, *updateColumns_param = NULL, col, *_2, _3, _15, _16, _0$$3, _1$$4, _4$$5, _7$$5, _9$$5, _10$$6, _12$$6, _14$$6;
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&conflictColumns))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 97);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Db/Dialect.zep", 532);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&updateColumns))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 98);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Db/Dialect.zep", 536);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&assignments);
	array_init(&assignments);
	zephir_is_iterable(&updateColumns, 0, "phalcon/Db/Dialect.zep", 545);
	if (Z_TYPE_P(&updateColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateColumns), _2)
		{
			ZEPHIR_INIT_NVAR(&col);
			ZVAL_COPY(&col, _2);
			zephir_cast_to_string(&_5$$5, &col);
			ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "escape", &_6, 95, &_5$$5);
			zephir_check_call_status();
			zephir_cast_to_string(&_8$$5, &col);
			ZEPHIR_CALL_METHOD(&_7$$5, this_ptr, "escape", &_6, 95, &_8$$5);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_9$$5);
			ZEPHIR_CONCAT_VSV(&_9$$5, &_4$$5, " = excluded.", &_7$$5);
			zephir_array_append(&assignments, &_9$$5, PH_SEPARATE, "phalcon/Db/Dialect.zep", 542);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, &updateColumns, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_3, &updateColumns, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_3)) {
				break;
			}
			...
			zephir_check_call_status();
				zephir_cast_to_string(&_11$$6, &col);
				ZEPHIR_CALL_METHOD(&_10$$6, this_ptr, "escape", &_6, 95, &_11$$6);
				zephir_check_call_status();
				zephir_cast_to_string(&_13$$6, &col);
				ZEPHIR_CALL_METHOD(&_12$$6, this_ptr, "escape", &_6, 95, &_13$$6);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_14$$6);
				ZEPHIR_CONCAT_VSV(&_14$$6, &_10$$6, " = excluded.", &_12$$6);
				zephir_array_append(&assignments, &_14$$6, PH_SEPARATE, "phalcon/Db/Dialect.zep", 542);
			ZEPHIR_CALL_METHOD(NULL, &updateColumns, "next", NULL, 0);
			zephir_check_call_status();
		}
	}
	ZEPHIR_INIT_NVAR(&col);
	ZEPHIR_CALL_METHOD(&_15, this_ptr, "getcolumnlist", NULL, 99, &conflictColumns);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_16);
	zephir_fast_join_str(&_16, SL(", "), &assignments);
	ZEPHIR_CONCAT_VSVSSV(return_value, &sqlQuery_zv, " ON CONFLICT (", &_15, ")", " DO UPDATE SET ", &_16);
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Db_Dialect, returning)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 100);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_0, "phalcon/Db/Dialect.zep", 559);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Db_Dialect, select)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&tables, &definition, SL("tables"), 0)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exceptions_missingdefinitionkey_ce, "tables", "phalcon/Db/Dialect.zep", 587);
		return;
	}
	zephir_memory_observe(&columns);
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&columns, &definition, SL("columns"), 0)))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exceptions_missingdefinitionkey_ce, "columns", "phalcon/Db/Dialect.zep", 591);
		return;
	}
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getcolumnlist", NULL, 99, &columns, &escapeChar, &bindCounts);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZEPHIR_CONCAT_SV(&_2, " ", &_1);
	zephir_concat_self(&sql, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "getsqlexpressionfrom", NULL, 101, &tables, &escapeChar);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_4);
	...
	if (_5) {
		zephir_array_fetch_string(&_7$$10, &definition, SL("joins"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 625);
		ZEPHIR_CALL_METHOD(&_6$$10, this_ptr, "getsqlexpressionjoins", NULL, 102, &_7$$10, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_9) {
		ZEPHIR_CALL_METHOD(&_10$$11, this_ptr, "getsqlexpressionwhere", NULL, 103, &where, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_12) {
		ZEPHIR_CALL_METHOD(&_13$$12, this_ptr, "getsqlexpressiongroupby", NULL, 104, &groupBy, &escapeChar);
		zephir_check_call_status();
	...
	if (_15) {
		ZEPHIR_CALL_METHOD(&_16$$13, this_ptr, "getsqlexpressionhaving", NULL, 105, &having, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_18) {
		ZEPHIR_CALL_METHOD(&_19$$14, this_ptr, "getsqlexpressionorderby", NULL, 106, &orderBy, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(&sql, this_ptr, "getsqlexpressionlimit", NULL, 107, &_22$$15, &escapeChar, &bindCounts);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Db_Dialect, getIndexColumnList)
{
	...
	zend_bool wrapExpressions, hasExpression = 0, _4, _2$$3, _3$$5, _7$$8, _11$$18;
	zval *index, index_sub, *wrapExpressions_param = NULL, columns, directions, parts, column, direction, upper, rendered, *_0, _1, *_5, _6, _8$$10, _12$$20;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	hasExpression = 0;
	zephir_is_iterable(&columns, 0, "phalcon/Db/Dialect.zep", 789);
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _0)
		{
			ZEPHIR_INIT_NVAR(&column);
			ZVAL_COPY(&column, _0);
			_2$$3 = Z_TYPE_P(&column) == IS_OBJECT;
			if (_2$$3) {
				_2$$3 = zephir_instance_of_ev(&column, phalcon_db_rawvalue_ce);
			}
			if (_2$$3) {
				hasExpression = 1;
				break;
		...
		while (1) {
			...
			zephir_check_call_status();
				_3$$5 = Z_TYPE_P(&column) == IS_OBJECT;
				if (_3$$5) {
					_3$$5 = zephir_instance_of_ev(&column, phalcon_db_rawvalue_ce);
				}
				if (_3$$5) {
					hasExpression = 1;
					break;
	...
	_4 = !hasExpression;
	if (_4) {
		_4 = ZEPHIR_IS_EMPTY(&directions);
	}
	if (_4) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getcolumnlist", NULL, 99, &columns);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	array_init(&parts);
	i = 0;
	zephir_is_iterable(&columns, 0, "phalcon/Db/Dialect.zep", 825);
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _5)
		{
			...
			if (_7$$8) {
				...
				ZEPHIR_CALL_METHOD(&rendered, this_ptr, "escape", &_9, 95, &column);
				zephir_check_call_status();
			}
			...
			zephir_array_append(&parts, &rendered, PH_SEPARATE, "phalcon/Db/Dialect.zep", 821);
			i = (i + 1);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, &columns, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			ZEPHIR_CALL_METHOD(&_6, &columns, "valid", NULL, 0);
			zephir_check_call_status();
			if (!zend_is_true(&_6)) {
				break;
			}
			ZEPHIR_CALL_METHOD(&column, &columns, "current", NULL, 0);
			zephir_check_call_status();
				_11$$18 = Z_TYPE_P(&column) == IS_OBJECT;
				if (_11$$18) {
					_11$$18 = zephir_instance_of_ev(&column, phalcon_db_rawvalue_ce);
				}
				if (_11$$18) {
					if (wrapExpressions) {
						ZEPHIR_CALL_METHOD(&_12$$20, &column, "getvalue", NULL, 0);
						zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&rendered);
						ZEPHIR_CONCAT_SVS(&rendered, "(", &_12$$20, ")");
					} else {
						ZEPHIR_CALL_METHOD(&rendered, &column, "getvalue", NULL, 0);
						zephir_check_call_status();
					}
				...
				if (!(ZEPHIR_IS_EMPTY(&directions))) {
					ZEPHIR_OBS_NVAR(&direction);
					if (zephir_array_isset_long_fetch(&direction, &directions, i, 0)) {
						zephir_cast_to_string(&_13$$24, &direction);
						ZEPHIR_INIT_NVAR(&upper);
						zephir_fast_strtoupper(&upper, &_13$$24);
						if (ZEPHIR_IS_STRING(&upper, "DESC")) {
							zephir_concat_self_str(&rendered, SL(" DESC"));
						} else {
							zephir_concat_self_str(&rendered, SL(" ASC"));
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionBinaryOperations)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_string *escapeChar = NULL;
	zval *expression_param = NULL, escapeChar_zv, *bindCounts_param = NULL, left, right, _0, _1, _2;
	...
	zephir_array_fetch_string(&_0, &expression, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 881);
	ZEPHIR_CALL_METHOD(&left, this_ptr, "getsqlexpression", NULL, 0, &_0, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &expression, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 887);
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 87, &_1, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	zephir_array_fetch_string(&_2, &expression, SL("op"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 892);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionCase)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_string *escapeChar = NULL;
	zval *expression_param = NULL, escapeChar_zv, *bindCounts_param = NULL, whenClause, _0, _1, _2, _3, *_4, _5, _6$$3, _7$$4, _8$$4, _9$$4, _10$$4, _11$$4, _12$$5, _13$$5, _14$$5, _15$$6, _16$$7, _17$$7, _18$$7, _19$$7, _20$$7, _21$$8, _22$$8, _23$$8;
	zval expression, bindCounts;
	zval *this_ptr = getThis();
	...
	zephir_array_fetch_string(&_1, &expression, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 909);
	...
	zephir_array_fetch_string(&_3, &expression, SL("when-clauses"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 911);
	zephir_is_iterable(&_3, 0, "phalcon/Db/Dialect.zep", 922);
	if (Z_TYPE_P(&_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3), _4)
		{
			ZEPHIR_INIT_NVAR(&whenClause);
			ZVAL_COPY(&whenClause, _4);
			zephir_array_fetch_string(&_6$$3, &whenClause, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 912);
			if (ZEPHIR_IS_STRING(&_6$$3, "when")) {
				zephir_array_fetch_string(&_8$$4, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 914);
				ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "getsqlexpression", NULL, 87, &_8$$4, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				zephir_array_fetch_string(&_10$$4, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 916);
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "getsqlexpression", NULL, 87, &_10$$4, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_11$$4);
				ZEPHIR_CONCAT_SVSV(&_11$$4, " WHEN ", &_7$$4, " THEN ", &_9$$4);
				zephir_concat_self(&sql, &_11$$4);
			} else {
				zephir_array_fetch_string(&_13$$5, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 918);
				ZEPHIR_CALL_METHOD(&_12$$5, this_ptr, "getsqlexpression", NULL, 87, &_13$$5, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_string(&_15$$6, &whenClause, SL("type"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 912);
				if (ZEPHIR_IS_STRING(&_15$$6, "when")) {
					zephir_array_fetch_string(&_17$$7, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 914);
					ZEPHIR_CALL_METHOD(&_16$$7, this_ptr, "getsqlexpression", NULL, 87, &_17$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					zephir_array_fetch_string(&_19$$7, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 916);
					ZEPHIR_CALL_METHOD(&_18$$7, this_ptr, "getsqlexpression", NULL, 87, &_19$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_20$$7);
					ZEPHIR_CONCAT_SVSV(&_20$$7, " WHEN ", &_16$$7, " THEN ", &_18$$7);
					zephir_concat_self(&sql, &_20$$7);
				} else {
					zephir_array_fetch_string(&_22$$8, &whenClause, SL("expr"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 918);
					ZEPHIR_CALL_METHOD(&_21$$8, this_ptr, "getsqlexpression", NULL, 87, &_22$$8, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionCastValue)
{
	...
	zephir_array_fetch_string(&_0, &expression, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 939);
	ZEPHIR_CALL_METHOD(&left, this_ptr, "getsqlexpression", NULL, 0, &_0, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &expression, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 945);
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 87, &_1, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionConvertValue)
{
	...
	zephir_array_fetch_string(&_0, &expression, SL("left"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 967);
	ZEPHIR_CALL_METHOD(&left, this_ptr, "getsqlexpression", NULL, 0, &_0, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	zephir_array_fetch_string(&_1, &expression, SL("right"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 973);
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 87, &_1, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionFrom)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_string *escapeChar = NULL;
	zval *expression, expression_sub, escapeChar_zv, table, tables, *_0$$3, _1$$3, _5$$3, _2$$4, _4$$5;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		array_init(&tables);
		zephir_is_iterable(expression, 0, "phalcon/Db/Dialect.zep", 995);
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				ZEPHIR_INIT_NVAR(&table);
				ZVAL_COPY(&table, _0$$3);
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "getsqltable", &_3, 108, &table, &escapeChar_zv);
				zephir_check_call_status();
				zephir_array_append(&tables, &_2$$4, PH_SEPARATE, "phalcon/Db/Dialect.zep", 992);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "getsqltable", &_3, 108, &table, &escapeChar_zv);
					zephir_check_call_status();
					zephir_array_append(&tables, &_4$$5, PH_SEPARATE, "phalcon/Db/Dialect.zep", 992);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionFunctionCall)
{
	...
	zephir_array_fetch_string(&name, &expression, SL("name"), PH_NOISY, "phalcon/Db/Dialect.zep", 1016);
	...
	if (_1) {
		...
		if (_3$$4) {
			zephir_array_fetch_string(&_4$$4, &expression, SL("distinct"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1033);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionGroupBy)
{
	...
	zval bindCounts;
	zend_string *escapeChar = NULL;
	zval *expression, expression_sub, escapeChar_zv, *bindCounts_param = NULL, field, fields, *_0$$3, _1$$3, _8$$3, _2$$5, _4$$4, _6$$7, _7$$6;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		array_init(&fields);
		zephir_is_iterable(expression, 0, "phalcon/Db/Dialect.zep", 1071);
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
					...
					object_init_ex(&_2$$5, phalcon_db_exceptions_invalidgroupbyexpression_ce);
					ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", &_3, 109);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_2$$5, "phalcon/Db/Dialect.zep", 1061);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getsqlexpression", &_5, 0, &field, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				zephir_array_append(&fields, &_4$$4, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1068);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, expression, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						object_init_ex(&_6$$7, phalcon_db_exceptions_invalidgroupbyexpression_ce);
						ZEPHIR_CALL_METHOD(NULL, &_6$$7, "__construct", &_3, 109);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_6$$7, "phalcon/Db/Dialect.zep", 1061);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_CALL_METHOD(&_7$$6, this_ptr, "getsqlexpression", &_5, 87, &field, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					zephir_array_append(&fields, &_7$$6, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1068);
				ZEPHIR_CALL_METHOD(NULL, expression, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
		...
		zephir_fast_join_str(&_8$$3, SL(", "), &fields);
		ZEPHIR_CPY_WRT(&fields, &_8$$3);
	} else {
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionJoins)
{
	...
	zval bindCounts;
	zend_string *escapeChar = NULL;
	zval *expression, expression_sub, escapeChar_zv, *bindCounts_param = NULL, condition, join, joinCondition, joinTable, joinType, joinConditionsArray, *_0, _1, _10$$3, _12$$3, *_4$$6, _5$$6, _8$$6, _6$$7, _7$$8, _20$$11, _21$$11, *_14$$14, _15$$14, _18$$14, _16$$15, _17$$16;
	zval *this_ptr = getThis();
	...
	ZEPHIR_INIT_VAR(&sql);
	ZVAL_STRING(&sql, "");
	zephir_is_iterable(expression, 0, "phalcon/Db/Dialect.zep", 1145);
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0)
		{
			...
			if (_2$$3) {
				if (!(zephir_array_isset_value_long(&joinConditionsArray, 0))) {
					ZEPHIR_CALL_METHOD(&joinCondition, this_ptr, "getsqlexpression", &_3, 0, &joinConditionsArray, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
				} else {
					ZEPHIR_INIT_NVAR(&joinCondition);
					array_init(&joinCondition);
					zephir_is_iterable(&joinConditionsArray, 0, "phalcon/Db/Dialect.zep", 1130);
					if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _4$$6)
						{
							...
							ZEPHIR_CALL_METHOD(&_6$$7, this_ptr, "getsqlexpression", &_3, 87, &condition, &escapeChar_zv, &bindCounts);
							zephir_check_call_status();
							zephir_array_append(&joinCondition, &_6$$7, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1127);
						} ZEND_HASH_FOREACH_END();
					} else {
						...
						while (1) {
							...
							zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&_7$$8, this_ptr, "getsqlexpression", &_3, 87, &condition, &escapeChar_zv, &bindCounts);
								zephir_check_call_status();
								zephir_array_append(&joinCondition, &_7$$8, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1127);
			...
			zephir_array_fetch_string(&_10$$3, &join, SL("source"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1140);
			ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 108, &_10$$3, &escapeChar_zv);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_13$$11) {
					if (!(zephir_array_isset_value_long(&joinConditionsArray, 0))) {
						ZEPHIR_CALL_METHOD(&joinCondition, this_ptr, "getsqlexpression", &_3, 87, &joinConditionsArray, &escapeChar_zv, &bindCounts);
						zephir_check_call_status();
					} else {
						ZEPHIR_INIT_NVAR(&joinCondition);
						array_init(&joinCondition);
						...
						if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _14$$14)
							{
								...
								ZEPHIR_CALL_METHOD(&_16$$15, this_ptr, "getsqlexpression", &_3, 87, &condition, &escapeChar_zv, &bindCounts);
								zephir_check_call_status();
								zephir_array_append(&joinCondition, &_16$$15, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1127);
							} ZEND_HASH_FOREACH_END();
						} else {
							ZEPHIR_CALL_METHOD(NULL, &joinConditionsArray, "rewind", NULL, 0);
							zephir_check_call_status();
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&condition, &joinConditionsArray, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_CALL_METHOD(&_17$$16, this_ptr, "getsqlexpression", &_3, 87, &condition, &escapeChar_zv, &bindCounts);
									zephir_check_call_status();
									zephir_array_append(&joinCondition, &_17$$16, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1127);
								ZEPHIR_CALL_METHOD(NULL, &joinConditionsArray, "next", NULL, 0);
								zephir_check_call_status();
							}
						}
				...
				zephir_array_fetch_string(&_20$$11, &join, SL("source"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1140);
				ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 108, &_20$$11, &escapeChar_zv);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionLimit)
{
	...
	ZVAL_NULL(&offset);
	zephir_memory_observe(&value);
	zephir_array_fetch_string(&value, expression, SL("value"), PH_NOISY, "phalcon/Db/Dialect.zep", 1161);
	if (zephir_array_isset_value_string(expression, SL("sql"))) {
		ZEPHIR_OBS_NVAR(&sql);
		zephir_array_fetch_string(&sql, expression, SL("sql"), PH_NOISY, "phalcon/Db/Dialect.zep", 1164);
	}
	if (Z_TYPE_P(&value) == IS_ARRAY) {
		zephir_memory_observe(&_0$$4);
		zephir_array_fetch_string(&_0$$4, &value, SL("number"), PH_NOISY, "phalcon/Db/Dialect.zep", 1168);
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			zephir_array_fetch_string(&_1$$5, &value, SL("number"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1170);
			ZEPHIR_CALL_METHOD(&limit, this_ptr, "getsqlexpression", NULL, 0, &_1$$5, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
		} else {
			ZEPHIR_OBS_NVAR(&limit);
			zephir_array_fetch_string(&limit, &value, SL("number"), PH_NOISY, "phalcon/Db/Dialect.zep", 1175);
		}
		...
		if (_2$$4) {
			ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "getsqlexpression", NULL, 87, &offset, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionList)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_string *escapeChar = NULL;
	zval *expression_param = NULL, escapeChar_zv, *bindCounts_param = NULL, item, values, separator, _10, *_2$$4, _3$$4, _8$$4, _9$$4, _4$$5, _6$$6;
	...
	if (zephir_array_isset_value_string(&expression, SL("separator"))) {
		...
		zephir_array_fetch_string(&separator, &expression, SL("separator"), PH_NOISY, "phalcon/Db/Dialect.zep", 1214);
	}
	...
	if (_1) {
		zephir_is_iterable(&values, 0, "phalcon/Db/Dialect.zep", 1223);
		if (Z_TYPE_P(&values) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&values), _2$$4)
			{
				ZEPHIR_INIT_NVAR(&item);
				ZVAL_COPY(&item, _2$$4);
				ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "getsqlexpression", &_5, 0, &item, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				zephir_array_append(&items, &_4$$5, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1220);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "getsqlexpression", &_5, 87, &item, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					zephir_array_append(&items, &_6$$6, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1220);
				ZEPHIR_CALL_METHOD(NULL, &values, "next", NULL, 0);
				zephir_check_call_status();
			}
		}
		ZEPHIR_INIT_NVAR(&item);
		_7$$4 = zephir_array_isset_value_string(&expression, SL("parentheses"));
		if (_7$$4) {
			zephir_array_fetch_string(&_8$$4, &expression, SL("parentheses"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1223);
	...
	ZEPHIR_INIT_VAR(&_10);
	object_init_ex(&_10, phalcon_db_exceptions_invalidlistexpression_ce);
	ZEPHIR_CALL_METHOD(NULL, &_10, "__construct", NULL, 110);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_10, "phalcon/Db/Dialect.zep", 1230);
	ZEPHIR_MM_RESTORE();
	return;
}
...
{
	zend_bool _6$$4, _10$$7;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_3 = NULL, *_5 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval bindCounts;
	zend_string *escapeChar = NULL;
	zval *expression, expression_sub, escapeChar_zv, *bindCounts_param = NULL, field, fields, type, fieldSql, *_0$$3, _1$$3, _12$$3, _2$$5, _4$$4, _7$$6, _8$$8, _9$$7, _11$$9;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&fields);
		array_init(&fields);
		zephir_is_iterable(expression, 0, "phalcon/Db/Dialect.zep", 1295);
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				ZEPHIR_INIT_NVAR(&field);
				...
				if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
					ZEPHIR_INIT_NVAR(&_2$$5);
					object_init_ex(&_2$$5, phalcon_db_exceptions_invalidorderbyexpression_ce);
					ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", &_3, 111);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_2$$5, "phalcon/Db/Dialect.zep", 1276);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_array_fetch_long(&_4$$4, &field, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1280);
				ZEPHIR_CALL_METHOD(&fieldSql, this_ptr, "getsqlexpression", &_5, 0, &_4$$4, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&type);
				_6$$4 = zephir_array_isset_long_fetch(&type, &field, 1, 0);
				if (_6$$4) {
					_6$$4 = !ZEPHIR_IS_STRING(&type, "");
				}
				if (_6$$4) {
					ZEPHIR_INIT_NVAR(&_7$$6);
					ZEPHIR_CONCAT_SV(&_7$$6, " ", &type);
					zephir_concat_self(&fieldSql, &_7$$6);
				}
				zephir_array_append(&fields, &fieldSql, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1292);
			} ZEND_HASH_FOREACH_END();
		} else {
			ZEPHIR_CALL_METHOD(NULL, expression, "rewind", NULL, 0);
			zephir_check_call_status();
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						object_init_ex(&_8$$8, phalcon_db_exceptions_invalidorderbyexpression_ce);
						ZEPHIR_CALL_METHOD(NULL, &_8$$8, "__construct", &_3, 111);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_8$$8, "phalcon/Db/Dialect.zep", 1276);
						ZEPHIR_MM_RESTORE();
						return;
					}
					zephir_array_fetch_long(&_9$$7, &field, 0, PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1280);
					ZEPHIR_CALL_METHOD(&fieldSql, this_ptr, "getsqlexpression", &_5, 87, &_9$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&type);
					_10$$7 = zephir_array_isset_long_fetch(&type, &field, 1, 0);
					if (_10$$7) {
						_10$$7 = !ZEPHIR_IS_STRING(&type, "");
					}
					if (_10$$7) {
						ZEPHIR_INIT_NVAR(&_11$$9);
						ZEPHIR_CONCAT_SV(&_11$$9, " ", &type);
						zephir_concat_self(&fieldSql, &_11$$9);
					}
					zephir_array_append(&fields, &fieldSql, PH_SEPARATE, "phalcon/Db/Dialect.zep", 1292);
				ZEPHIR_CALL_METHOD(NULL, expression, "next", NULL, 0);
				zephir_check_call_status();
		...
		zephir_fast_join_str(&_12$$3, SL(", "), &fields);
		ZEPHIR_CPY_WRT(&fields, &_12$$3);
	} else {
		ZEPHIR_CPY_WRT(&fields, expression);
	}
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionQualified)
{
	...
	zephir_array_fetch_string(&column, &expression, SL("name"), PH_NOISY, "phalcon/Db/Dialect.zep", 1310);
	zephir_memory_observe(&domain);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionScalar)
{
	...
	if (zephir_array_isset_value_string(&expression, SL("column"))) {
		zephir_array_fetch_string(&_0$$3, &expression, SL("column"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1334);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlcolumn", NULL, 80, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	zephir_memory_observe(&value);
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&value, &expression, SL("value"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 81);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$4, "phalcon/Db/Dialect.zep", 1338);
		ZEPHIR_MM_RESTORE();
		return;
	}
	if (Z_TYPE_P(&value) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionUnaryOperations)
{
	...
	if (zephir_array_isset_string_fetch(&left, &expression, SL("left"), 0)) {
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_1$$3, &expression, SL("op"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1365);
	...
	if (zephir_array_isset_string_fetch(&right, &expression, SL("right"), 0)) {
		zephir_array_fetch_string(&_2$$4, &expression, SL("op"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 1372);
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "getsqlexpression", NULL, 87, &right, &escapeChar_zv, &bindCounts);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 112);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_4, "phalcon/Db/Dialect.zep", 1375);
	ZEPHIR_MM_RESTORE();
	return;
}
...
PHP_METHOD(Phalcon_Db_Dialect, prepareColumnAlias)
{
	...
	if (!ZEPHIR_IS_STRING(&alias_zv, "")) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "escape", NULL, 95, &alias_zv, &escapeChar_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareTable)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 95, &table, &escapeChar_zv);
	zephir_check_call_status();
	zephir_get_strval(&table, &_0);
	if (!ZEPHIR_IS_STRING(&schema_zv, "")) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "escapeschema", NULL, 113, &schema_zv, &escapeChar_zv);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_STRING(&alias_zv, "")) {
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "escape", NULL, 95, &alias_zv, &escapeChar_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareQualified)
{
	...
	if (!ZEPHIR_IS_STRING(&domain_zv, "")) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 95, &_0$$3, &escapeChar_zv);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 95, &column_zv, &escapeChar_zv);
	zephir_check_call_status();
	RETURN_MM();
}
