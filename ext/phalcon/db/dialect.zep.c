...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionBinaryOperations)
{
	...
	if (_1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 111, &operator);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 90, &_5, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "getsqltable", &_2, 112, &table, &escapeChar_zv);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_5$$5, this_ptr, "getsqltable", &_2, 112, &table, &escapeChar_zv);
					zephir_check_call_status();
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", &_2, 113);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_7$$7, "__construct", &_2, 113);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionJoins)
{
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 112, &_10$$3, &escapeChar_zv);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 112, &_23$$11, &escapeChar_zv);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionList)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_11, "__construct", NULL, 114);
	zephir_check_call_status();
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", &_2, 115);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_9$$8, "__construct", &_2, 115);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionUnaryOperations)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 116);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareTable)
{
	...
	if (!ZEPHIR_IS_STRING(&schema_zv, "")) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "escapeschema", NULL, 117, &schema_zv, &escapeChar_zv);
		zephir_check_call_status();
