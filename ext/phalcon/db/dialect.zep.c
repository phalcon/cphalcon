...
PHP_METHOD(Phalcon_Db_Dialect, getColumnList)
{
	...
	if (Z_TYPE_P(&columnList) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columnList), _0)
		{
			...
			ZVAL_COPY(&column, _0);
			ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "getsqlcolumn", &_2, 83, &column, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "getsqlcolumn", &_2, 83, &column, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpression)
{
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&type, &expression, SL("type"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 84);
		zephir_check_call_status();
	...
	do {
		if (ZEPHIR_IS_STRING(&type, "scalar")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionscalar", NULL, 85, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "object")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionobject", NULL, 86, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "qualified")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionqualified", NULL, 87, &expression, &escapeChar_zv);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "binary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionbinaryoperations", NULL, 88, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "unary-op")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionunaryoperations", NULL, 89, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "parentheses")) {
			...
			ZEPHIR_CALL_METHOD(&_8$$14, this_ptr, "getsqlexpression", NULL, 90, &_9$$14, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			ZEPHIR_CONCAT_SVS(return_value, "(", &_8$$14, ")");
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "functionCall")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionfunctioncall", NULL, 91, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "list")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionlist", NULL, 92, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "all")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionall", NULL, 93, &expression, &escapeChar_zv);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		if (ZEPHIR_IS_STRING(&type, "cast")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncastvalue", NULL, 94, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "convert")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressionconvertvalue", NULL, 95, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_STRING(&type, "case")) {
			ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlexpressioncase", NULL, 96, &expression, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
			RETURN_MM();
		}
	} while(0);
	...
	ZEPHIR_CALL_METHOD(NULL, &_11, "__construct", NULL, 97, &type);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlTable)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 98, table, &escapeChar_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Db_Dialect, createMaterializedView)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 99);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, onConflictUpdate)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&conflictColumns))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 100);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&updateColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateColumns), _2)
		{
			...
			ZEPHIR_CALL_METHOD(&_3$$5, this_ptr, "escape", &_5, 98, &_4$$5);
			zephir_check_call_status();
			zephir_cast_to_string(&_7$$5, &col);
			ZEPHIR_CALL_METHOD(&_6$$5, this_ptr, "escape", &_5, 98, &_7$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_11$$6, this_ptr, "escape", &_5, 98, &_12$$6);
				zephir_check_call_status();
				zephir_cast_to_string(&_14$$6, &col);
				ZEPHIR_CALL_METHOD(&_13$$6, this_ptr, "escape", &_5, 98, &_14$$6);
				zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&col);
	ZEPHIR_CALL_METHOD(&_16, this_ptr, "getcolumnlist", NULL, 102, &conflictColumns);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_17);
...
PHP_METHOD(Phalcon_Db_Dialect, select)
{
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getcolumnlist", NULL, 102, &columns, &escapeChar, &bindCounts);
	zephir_check_call_status();
	zephir_array_fast_append(&parts, &_1);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getsqlexpressionfrom", NULL, 104, &tables, &escapeChar);
	zephir_check_call_status();
	zephir_array_fast_append(&parts, &_1);
	...
	if (_2) {
		...
		ZEPHIR_CALL_METHOD(&_3$$10, this_ptr, "getsqlexpressionjoins", NULL, 105, &_4$$10, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_5) {
		ZEPHIR_CALL_METHOD(&_6$$11, this_ptr, "getsqlexpressionwhere", NULL, 106, &where, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_7) {
		ZEPHIR_CALL_METHOD(&_8$$12, this_ptr, "getsqlexpressiongroupby", NULL, 107, &groupBy, &escapeChar);
		zephir_check_call_status();
	...
	if (_9) {
		ZEPHIR_CALL_METHOD(&_10$$13, this_ptr, "getsqlexpressionhaving", NULL, 108, &having, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_11) {
		ZEPHIR_CALL_METHOD(&_12$$14, this_ptr, "getsqlexpressionorderby", NULL, 109, &orderBy, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_13) {
		...
		ZEPHIR_CALL_METHOD(&sql, this_ptr, "getsqlexpressionlimit", NULL, 110, &_14$$15, &escapeChar, &bindCounts);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Db_Dialect, getIndexColumnList)
{
	...
	if (_5) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getcolumnlist", NULL, 102, &columns);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_VAR(&parts);
	...
	if (Z_TYPE_P(&columns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _6)
		{
			...
			if (_7$$8) {
				...
				ZEPHIR_CALL_METHOD(&rendered, this_ptr, "escape", &_9, 98, &column);
				zephir_check_call_status();
			}
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionBinaryOperations)
{
	...
	ZEPHIR_CALL_METHOD(&right, this_ptr, "getsqlexpression", NULL, 90, &_1, &escapeChar_zv, &bindCounts);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3), _4)
		{
			...
			if (ZEPHIR_IS_STRING(&_5$$3, "when")) {
				...
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "getsqlexpression", NULL, 90, &_7$$4, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				zephir_array_fetch_string(&_9$$4, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 906);
				ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "getsqlexpression", NULL, 90, &_9$$4, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_11$$5, this_ptr, "getsqlexpression", NULL, 90, &_12$$5, &escapeChar_zv, &bindCounts);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_16$$6, "when")) {
					...
					ZEPHIR_CALL_METHOD(&_17$$7, this_ptr, "getsqlexpression", NULL, 90, &_18$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					zephir_array_fetch_string(&_20$$7, &whenClause, SL("then"), PH_NOISY | PH_READONLY, "phalcon/Db/Dialect.zep", 906);
					ZEPHIR_CALL_METHOD(&_19$$7, this_ptr, "getsqlexpression", NULL, 90, &_20$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_22$$8, this_ptr, "getsqlexpression", NULL, 90, &_23$$8, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "getsqltable", &_2, 111, &table, &escapeChar_zv);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_5$$5, this_ptr, "getsqltable", &_2, 111, &table, &escapeChar_zv);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_7$$7, "__construct", &_2, 112);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_7$$7, "phalcon/Db/Dialect.zep", 1051);
						ZEPHIR_MM_RESTORE();
						return;
					}
					ZEPHIR_CALL_METHOD(&_8$$6, this_ptr, "getsqlexpression", &_4, 90, &field, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionJoins)
{
	...
	if (Z_TYPE_P(expression) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0)
		{
				...
				if (!(zephir_array_isset_value_long(&joinConditionsArray, 0))) {
					...
					if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _3$$6)
						{
							...
							ZEPHIR_CALL_METHOD(&_4$$7, this_ptr, "getsqlexpression", &_2, 90, &condition, &escapeChar_zv, &bindCounts);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								ZEPHIR_CALL_METHOD(&_7$$8, this_ptr, "getsqlexpression", &_2, 90, &condition, &escapeChar_zv, &bindCounts);
								zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 111, &_10$$3, &escapeChar_zv);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_15$$11) {
					if (!(zephir_array_isset_value_long(&joinConditionsArray, 0))) {
						ZEPHIR_CALL_METHOD(&joinCondition, this_ptr, "getsqlexpression", &_2, 90, &joinConditionsArray, &escapeChar_zv, &bindCounts);
						zephir_check_call_status();
					} else {
						ZEPHIR_INIT_NVAR(&joinCondition);
						array_init(&joinCondition);
						...
						if (Z_TYPE_P(&joinConditionsArray) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&joinConditionsArray), _16$$14)
							{
								...
								ZEPHIR_CALL_METHOD(&_17$$15, this_ptr, "getsqlexpression", &_2, 90, &condition, &escapeChar_zv, &bindCounts);
								zephir_check_call_status();
							...
							while (1) {
								...
								ZEPHIR_CALL_METHOD(&condition, &joinConditionsArray, "current", NULL, 0);
								zephir_check_call_status();
									ZEPHIR_CALL_METHOD(&_20$$16, this_ptr, "getsqlexpression", &_2, 90, &condition, &escapeChar_zv, &bindCounts);
									zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&joinTable, this_ptr, "getsqltable", &_11, 111, &_23$$11, &escapeChar_zv);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionLimit)
{
	...
	if (Z_TYPE_P(&value) == IS_ARRAY) {
		...
		if (_2$$4) {
			ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "getsqlexpression", NULL, 90, &offset, &escapeChar_zv, &bindCounts);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionList)
{
	...
	if (_1) {
		...
		if (Z_TYPE_P(&values) == IS_ARRAY) {
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_7$$6, this_ptr, "getsqlexpression", &_4, 90, &item, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_11, "__construct", NULL, 113);
	zephir_check_call_status();
		...
		if (Z_TYPE_P(expression) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(expression), _0$$3)
			{
				...
				if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", &_2, 114);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(Z_TYPE_P(&field) != IS_ARRAY)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_9$$8, "__construct", &_2, 114);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&fieldSql, this_ptr, "getsqlexpression", &_4, 90, &_10$$7, &escapeChar_zv, &bindCounts);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&type);
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionScalar)
{
	...
	if (zephir_array_isset_value_string(&expression, SL("column"))) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getsqlcolumn", NULL, 83, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	zephir_memory_observe(&value);
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&value, &expression, SL("value"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 84);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, getSqlExpressionUnaryOperations)
{
	...
	if (zephir_array_isset_string_fetch(&right, &expression, SL("right"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "getsqlexpression", NULL, 90, &right, &escapeChar_zv, &bindCounts);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_4, "__construct", NULL, 115);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareColumnAlias)
{
	...
	if (!ZEPHIR_IS_STRING(&alias_zv, "")) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "escape", NULL, 98, &alias_zv, &escapeChar_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareTable)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "escape", NULL, 98, &table, &escapeChar_zv);
	zephir_check_call_status();
	zephir_get_strval(&table, &_0);
	if (!ZEPHIR_IS_STRING(&schema_zv, "")) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "escapeschema", NULL, 116, &schema_zv, &escapeChar_zv);
		zephir_check_call_status();
	...
	if (!ZEPHIR_IS_STRING(&alias_zv, "")) {
		ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "escape", NULL, 98, &alias_zv, &escapeChar_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect, prepareQualified)
{
	...
	if (!ZEPHIR_IS_STRING(&domain_zv, "")) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 98, &_0$$3, &escapeChar_zv);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "escape", NULL, 98, &column_zv, &escapeChar_zv);
	zephir_check_call_status();
	RETURN_MM();
}
