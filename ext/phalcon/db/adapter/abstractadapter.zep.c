...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, escapeIdentifier)
{
	...
	if (Z_TYPE_P(identifier) == IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 77, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 77, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 77, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 80, eventsManager);
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setDialect)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 77, dialect);
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setNestedTransactionsWithSavepoints)
{
	...
	if (nestedTransactionsWithSavepoints) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 81, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 81, &__$false);
	}
	RETURN_THIS();
}
