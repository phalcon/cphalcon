...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, describeIndexes)
{
	...
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _6)
		{
			...
			zephir_array_fetch_long(&_7$$3, &index, 4, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 458);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_long(&_10$$6, &index, 4, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 458);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, describeReferences)
{
	...
	if (Z_TYPE_P(_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_4), _6)
		{
			...
			zephir_array_fetch_long(&_11$$3, &reference, 1, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 515);
			zephir_array_append(&columns, &_11$$3, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 515);
			ZEPHIR_OBS_NVAR(&_12$$3);
			zephir_array_fetch_long(&_12$$3, &reference, 5, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 516);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_long(&_20$$6, &reference, 1, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 515);
				zephir_array_append(&columns, &_20$$6, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 515);
				ZEPHIR_OBS_NVAR(&_21$$6);
				zephir_array_fetch_long(&_21$$6, &reference, 5, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 516);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, escapeIdentifier)
{
	...
	if (Z_TYPE_P(identifier) == IS_ARRAY) {
		...
		zephir_array_fetch_long(&_2$$3, identifier, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 661);
		...
		zephir_array_fetch_long(&_5$$3, identifier, 1, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 661);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, insert)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_EMPTY(&values))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Db/Adapter/AbstractAdapter.zep", 982);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(&placeholders);
	...
	zephir_is_iterable(&values, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1007);
	if (Z_TYPE_P(&values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _2, _3, _1)
		{
			...
			zephir_array_fetch_string(&_5$$4, &placeholder, SL("placeholder"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 996);
			zephir_array_append(&placeholders, &_5$$4, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 996);
			ZEPHIR_OBS_NVAR(&_6$$4);
			zephir_array_fetch_string(&_6$$4, &placeholder, SL("bind"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 998);
			if (zephir_is_true(&_6$$4)) {
				ZEPHIR_OBS_NVAR(&_7$$5);
				zephir_array_fetch_string(&_7$$5, &placeholder, SL("value"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 999);
				zephir_array_append(&insertValues, &_7$$5, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 999);
				ZEPHIR_OBS_NVAR(&_8$$5);
				zephir_array_fetch_string(&_8$$5, &placeholder, SL("hasBindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1001);
				if (zephir_is_true(&_8$$5)) {
					ZEPHIR_OBS_NVAR(&_9$$6);
					zephir_array_fetch_string(&_9$$6, &placeholder, SL("bindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1002);
					zephir_array_append(&bindDataTypes, &_9$$6, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1002);
				}
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_12$$7, &placeholder, SL("placeholder"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 996);
				zephir_array_append(&placeholders, &_12$$7, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 996);
				ZEPHIR_OBS_NVAR(&_13$$7);
				zephir_array_fetch_string(&_13$$7, &placeholder, SL("bind"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 998);
				if (zephir_is_true(&_13$$7)) {
					ZEPHIR_OBS_NVAR(&_14$$8);
					zephir_array_fetch_string(&_14$$8, &placeholder, SL("value"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 999);
					zephir_array_append(&insertValues, &_14$$8, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 999);
					ZEPHIR_OBS_NVAR(&_15$$8);
					zephir_array_fetch_string(&_15$$8, &placeholder, SL("hasBindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1001);
					if (zephir_is_true(&_15$$8)) {
						ZEPHIR_OBS_NVAR(&_16$$9);
						zephir_array_fetch_string(&_16$$9, &placeholder, SL("bindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1002);
						zephir_array_append(&bindDataTypes, &_16$$9, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1002);
					}
				}
		}
	}
	...
	if (ZEPHIR_GT_LONG(&_18, 0)) {
		...
		zephir_fast_explode_str(&tableName, SL("."), &table_zv, ZEND_LONG_MAX);
	} else {
	...
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		...
		zephir_is_iterable(_19$$12, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1027);
		if (Z_TYPE_P(_19$$12) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_19$$12), _21$$12)
			{
				...
				zephir_check_call_status();
				zephir_array_append(&escapedFields, &_22$$13, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1024);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					zephir_array_append(&escapedFields, &_25$$14, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1024);
			}
		}
		ZEPHIR_INIT_NVAR(&field);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, insertAsDict)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1073);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_1), _4, _5, _3)
		{
			...
			ZEPHIR_INIT_NVAR(&value);
			ZVAL_COPY(&value, _3);
			zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1069);
			zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1070);
		} ZEND_HASH_FOREACH_END();
	} else {
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, listTables)
{
	...
	zephir_is_iterable(_3, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1124);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			...
			zephir_array_fetch_long(&_6$$3, &table, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1121);
			zephir_array_append(&allTables, &_6$$3, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1121);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_long(&_9$$4, &table, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1121);
				zephir_array_append(&allTables, &_9$$4, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1121);
		}
	}
	ZEPHIR_INIT_NVAR(&table);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, listViews)
{
	...
	zephir_is_iterable(_3, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1153);
	if (Z_TYPE_P(_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_3), _5)
		{
			ZEPHIR_INIT_NVAR(&table);
			ZVAL_COPY(&table, _5);
			ZEPHIR_OBS_NVAR(&_6$$3);
			zephir_array_fetch_long(&_6$$3, &table, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1150);
			zephir_array_append(&allTables, &_6$$3, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1150);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _3, "rewind", NULL, 0);
		zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&_9$$4);
				zephir_array_fetch_long(&_9$$4, &table, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1150);
				zephir_array_append(&allTables, &_9$$4, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1150);
		}
	}
	ZEPHIR_INIT_NVAR(&table);
	RETURN_CCTOR(&allTables);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, releaseSavepoint)
{
	...
	if (UNEXPECTED(!zephir_is_true(&_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 61);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Db/Adapter/AbstractAdapter.zep", 1181);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, rollbackSavepoint)
{
	...
	if (UNEXPECTED(!zephir_is_true(&_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 61);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_2$$3, "phalcon/Db/Adapter/AbstractAdapter.zep", 1203);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setNestedTransactionsWithSavepoints)
{
	...
	if (UNEXPECTED(ZEPHIR_GT_LONG(&_0, 0))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Db/Adapter/AbstractAdapter.zep", 1233);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (UNEXPECTED(!zephir_is_true(&_3))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_4$$4, "phalcon/Db/Adapter/AbstractAdapter.zep", 1237);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, tableExists)
{
	...
	zephir_array_fetch_long(&_4, &result, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1393);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, tableOptions)
{
	...
	zephir_array_fetch_long(&_2, &options, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1423);
	RETURN_CCTOR(&_2);
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, update)
{
	...
	zephir_is_iterable(_0, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1496);
	if (Z_TYPE_P(_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_0), _3, _4, _2)
		{
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&field, fields, &position, 0)))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_5$$4, "phalcon/Db/Adapter/AbstractAdapter.zep", 1476);
				ZEPHIR_MM_RESTORE();
				return;
			}
			...
			zephir_array_fetch_string(&_9$$3, &placeholder, SL("placeholder"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1482);
			ZEPHIR_INIT_NVAR(&_10$$3);
			ZEPHIR_CONCAT_VSV(&_10$$3, &escapedField, " = ", &_9$$3);
			zephir_array_append(&placeholders, &_10$$3, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1482);
			ZEPHIR_OBS_NVAR(&_11$$3);
			zephir_array_fetch_string(&_11$$3, &placeholder, SL("bind"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1484);
			if (zephir_is_true(&_11$$3)) {
				ZEPHIR_OBS_NVAR(&_12$$5);
				zephir_array_fetch_string(&_12$$5, &placeholder, SL("value"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1485);
				zephir_array_append(&updateValues, &_12$$5, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1485);
				ZEPHIR_OBS_NVAR(&_13$$5);
				zephir_array_fetch_string(&_13$$5, &placeholder, SL("hasBindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1487);
				if (zephir_is_true(&_13$$5)) {
					ZEPHIR_OBS_NVAR(&_14$$6);
					zephir_array_fetch_string(&_14$$6, &placeholder, SL("bindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1488);
					zephir_array_append(&bindDataTypes, &_14$$6, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1488);
				}
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&field, fields, &position, 0)))) {
					...
					zephir_check_call_status();
					zephir_throw_exception_debug(&_17$$8, "phalcon/Db/Adapter/AbstractAdapter.zep", 1476);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_CALL_METHOD(&escapedField, this_ptr, "escapeidentifier", &_7, 0, &field);
				...
				zephir_array_fetch_string(&_18$$7, &placeholder, SL("placeholder"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1482);
				ZEPHIR_INIT_NVAR(&_19$$7);
				ZEPHIR_CONCAT_VSV(&_19$$7, &escapedField, " = ", &_18$$7);
				zephir_array_append(&placeholders, &_19$$7, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1482);
				ZEPHIR_OBS_NVAR(&_20$$7);
				zephir_array_fetch_string(&_20$$7, &placeholder, SL("bind"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1484);
				if (zephir_is_true(&_20$$7)) {
					ZEPHIR_OBS_NVAR(&_21$$9);
					zephir_array_fetch_string(&_21$$9, &placeholder, SL("value"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1485);
					zephir_array_append(&updateValues, &_21$$9, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1485);
					ZEPHIR_OBS_NVAR(&_22$$9);
					zephir_array_fetch_string(&_22$$9, &placeholder, SL("hasBindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1487);
					if (zephir_is_true(&_22$$9)) {
						ZEPHIR_OBS_NVAR(&_23$$10);
						zephir_array_fetch_string(&_23$$10, &placeholder, SL("bindType"), PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1488);
						zephir_array_append(&bindDataTypes, &_23$$10, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1488);
					}
				}
		}
	}
	...
	if (Z_TYPE_P(whereCondition) != IS_NULL) {
		...
		if (Z_TYPE_P(whereCondition) == IS_STRING) {
			...
			if (UNEXPECTED(Z_TYPE_P(whereCondition) != IS_ARRAY)) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_26$$16, "phalcon/Db/Adapter/AbstractAdapter.zep", 1519);
				ZEPHIR_MM_RESTORE();
				return;
			}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, updateAsDict)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/Db/Adapter/AbstractAdapter.zep", 1592);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_1), _4, _5, _3)
		{
			ZEPHIR_INIT_NVAR(&field);
			...
			ZEPHIR_INIT_NVAR(&value);
			ZVAL_COPY(&value, _3);
			zephir_array_append(&fields, &field, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1588);
			zephir_array_append(&values, &value, PH_SEPARATE, "phalcon/Db/Adapter/AbstractAdapter.zep", 1589);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, _1, "rewind", NULL, 0);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, viewExists)
{
	...
	zephir_check_call_status();
	zephir_memory_observe(&_4);
	zephir_array_fetch_long(&_4, &_0, 0, PH_NOISY, "phalcon/Db/Adapter/AbstractAdapter.zep", 1625);
	RETURN_MM_BOOL(ZEPHIR_GT_LONG(&_4, 0));
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, buildValuePlaceholder)
{
	...
	if (hasBindType) {
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, dataTypes, position, 0)))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$7, "phalcon/Db/Adapter/AbstractAdapter.zep", 1688);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
