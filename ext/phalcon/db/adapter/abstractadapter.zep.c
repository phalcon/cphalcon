...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 71, &connectionId);
	ZVAL_UNDEF(&_0);
	...
	if (!(zephir_array_isset_string_fetch(&dialectClass, &descriptor, SL("dialectClass"), 0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 72, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&dialectClass) == IS_STRING) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 73, &_2$$4);
		...
		if (UNEXPECTED(!((zephir_instance_of_ev(&dialectClass, phalcon_db_dialectinterface_ce))))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$6, "__construct", NULL, 59, &_4$$6);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_3$$6, "phalcon/Db/Adapter/AbstractAdapter.zep", 214);
			ZEPHIR_MM_RESTORE();
			return;
		}
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 73, &dialectClass);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 74, &descriptor);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, createView)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 73, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, escapeIdentifier)
{
	...
	if (Z_TYPE_P(identifier) == IS_ARRAY) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 73, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 73, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 73, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 76, eventsManager);
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setDialect)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 73, dialect);
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, setNestedTransactionsWithSavepoints)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 73, PH_NOISY_CC | PH_READONLY);
	...
	if (nestedTransactionsWithSavepoints) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 77, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 77, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, update)
{
	...
	if (Z_TYPE_P(values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(values), _1, _2, _0)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&placeholder, this_ptr, "buildvalueplaceholder", &_6, 66, &value, &position, dataTypes);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_fetch(&field, fields, &position, 0)))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_15$$8, "__construct", &_4, 68);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(whereCondition) != IS_NULL) {
		...
		if (Z_TYPE_P(whereCondition) == IS_STRING) {
			...
			if (UNEXPECTED(Z_TYPE_P(whereCondition) != IS_ARRAY)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_24$$16, "__construct", NULL, 69);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_AbstractAdapter, buildValuePlaceholder)
{
	...
	if (hasBindType) {
		...
		if (UNEXPECTED(!(zephir_array_isset_fetch(&bindType, dataTypes, position, 0)))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_3$$7, "__construct", NULL, 70);
			zephir_check_call_status();
