...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Oracle, describeColumns) {
	...
	int ZEPHIR_LAST_CALL_STATUS;
	zval *table_param = NULL, *schema_param = NULL, *columns = NULL, *oldColumn = NULL, *field = NULL, *definition = NULL, *columnSize = NULL, *columnPrecision = NULL, *columnScale = NULL, *columnType = NULL, *columnName = NULL, *_0 = NULL, *_1, *_2 = NULL, *_3, **_6, *_7$$5 = NULL, *_8$$5 = NULL, *_9$$6 = NULL, *_10$$6 = NULL, *_11$$7 = NULL, *_12$$8 = NULL, *_13$$8 = NULL, *_14$$9 = NULL, *_15$$10 = NULL, *_16$$11 = NULL, *_17$$12 = NULL, *_18$$13 = NULL, *_19$$4 = NULL, *_20$$3, *_21$$3, *_22$$3 = NULL;
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		while (1) {
			...
			ZVAL_LONG(_19$$4, 6);
			zephir_array_update_string(&definition, SL("type"), &_19$$4, PH_COPY | PH_SEPARATE);
			break;
		}
		...
		zephir_array_fetch_long(&_20$$3, field, 6, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/oracle.zep", 183 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(_20$$3, "P")) {
			zephir_array_update_string(&definition, SL("primary"), &ZEPHIR_GLOBAL(global_true), PH_COPY | PH_SEPARATE);
		}
		zephir_array_fetch_long(&_21$$3, field, 5, PH_NOISY | PH_READONLY, "phalcon/db/adapter/pdo/oracle.zep", 190 TSRMLS_CC);
		if (ZEPHIR_IS_STRING(_21$$3, "N")) {
		...
		object_init_ex(_22$$3, phalcon_db_column_ce);
		ZEPHIR_CALL_METHOD(NULL, _22$$3, "__construct", &_23, 141, columnName, definition);
		zephir_check_call_status();
		zephir_array_append(&columns, _22$$3, PH_SEPARATE, "phalcon/db/adapter/pdo/oracle.zep", 199);
