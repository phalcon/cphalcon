...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, addForeignKey)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 584, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeColumns)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 585, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, 4);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeIndexes)
{
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _46, _47, _45)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_52$$31, "__construct", &_56, 60, &name, &_53$$31);
		zephir_check_call_status();
