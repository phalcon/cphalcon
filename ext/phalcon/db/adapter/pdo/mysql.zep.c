...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, addForeignKey)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 585, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeColumns)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 586, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, 4);
