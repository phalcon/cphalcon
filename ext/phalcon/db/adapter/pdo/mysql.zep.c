...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeIndexes)
{
	...
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _26, _27, _24)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_28$$19, "__construct", &_31, 36, &name, &_29$$19, &_30$$19);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_32$$20, "__construct", &_31, 36, &name, &_33$$20, &_34$$20);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeReferences)
{
	...
	if (Z_TYPE_P(&references) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _26, _27, _24)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_28$$9, "__construct", &_31, 37, &name, &_29$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_32$$10, "__construct", &_31, 37, &name, &_33$$10);
				zephir_check_call_status();
