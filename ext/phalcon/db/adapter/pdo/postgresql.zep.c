...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, describeColumns) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			zephir_array_fetch_long(&_50$$3, &field, 9, PH_NOISY, "phalcon/Db/Adapter/Pdo/Postgresql.zep", 500 TSRMLS_CC);
			...
			ZEPHIR_CALL_METHOD(NULL, &_59$$3, "__construct", &_60, 142, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_long(&_107$$40, &field, 9, PH_NOISY, "phalcon/Db/Adapter/Pdo/Postgresql.zep", 500 TSRMLS_CC);
				...
				ZEPHIR_CALL_METHOD(NULL, &_114$$40, "__construct", &_60, 142, &columnName, &definition);
				zephir_check_call_status();
