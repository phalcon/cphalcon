...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, connect) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_db_adapter_pdo_postgresql_ce, this_ptr, "connect", &_3, 85, descriptor);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_5, &_4)
		...
		if (Z_TYPE_P(_13) != IS_NULL) {
			...
			ZEPHIR_CALL_FUNCTION(&_15, "preg_replace", &_16, 83, _8, _9, _14);
			...
			ZEPHIR_CALL_FUNCTION(&_19, "strcasecmp", &_20, 86, _17, &_18);
			zephir_check_call_status();
