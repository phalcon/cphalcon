		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			if (_32$$3) {
				...
				if (_36$$30) {
					...
					ZEPHIR_CALL_FUNCTION(&_39$$30, "strcasecmp", &_40, 83, &_37$$30, &_38$$30);
					zephir_check_call_status();
				...
				if (_36$$30) {
					...
					ZVAL_STRING(&_43$$31, "");
					ZEPHIR_CALL_FUNCTION(&_44$$31, "preg_replace", &_45, 88, &_42$$31, &_43$$31, &_41$$31);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_78$$32) {
					...
					if (_82$$59) {
						...
						ZEPHIR_CALL_FUNCTION(&_85$$59, "strcasecmp", &_40, 83, &_83$$59, &_84$$59);
						zephir_check_call_status();
					...
					if (_82$$59) {
						...
						ZVAL_STRING(&_88$$60, "");
						ZEPHIR_CALL_FUNCTION(&_89$$60, "preg_replace", &_45, 88, &_87$$60, &_88$$60, &_86$$60);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeIndexes)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
		{
			...
			zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_0, 589, PH_NOISY_CC | PH_READONLY);
			...
			zephir_read_property_cached(&_10$$3, this_ptr, _zephir_prop_0, 589, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_31$$13, this_ptr, _zephir_prop_0, 589, PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_INIT_NVAR(&describeIndex);
				zephir_array_update_multi(&indexes, &columns, SL("zs"), 3, &keyName, SL("columns"));
				zephir_read_property_cached(&_33$$13, this_ptr, _zephir_prop_0, 589, PH_NOISY_CC | PH_READONLY);
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _49, _50, _48)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_51$$23, "__construct", &_54, 60, &name, &_52$$23, &_53$$23);
		zephir_check_call_status();
