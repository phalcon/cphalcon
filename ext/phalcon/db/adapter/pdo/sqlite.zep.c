...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, connect)
{
	...
	if (zephir_array_isset_string_fetch(&dbname, &descriptor, SL("dbname"), 0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 424);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			if (_32$$3) {
				...
				if (_36$$30) {
					...
					ZEPHIR_CALL_FUNCTION(&_39$$30, "strcasecmp", &_40, 74, &_37$$30, &_38$$30);
					zephir_check_call_status();
				...
				if (_36$$30) {
					...
					ZVAL_STRING(&_43$$31, "");
					ZEPHIR_CALL_FUNCTION(&_44$$31, "preg_replace", &_45, 79, &_42$$31, &_43$$31, &_41$$31);
					zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$3, "__construct", &_46, 423, &columnName, &definition);
			zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_78$$32) {
					...
					if (_82$$59) {
						...
						ZEPHIR_CALL_FUNCTION(&_85$$59, "strcasecmp", &_40, 74, &_83$$59, &_84$$59);
						zephir_check_call_status();
					...
					if (_82$$59) {
						...
						ZVAL_STRING(&_88$$60, "");
						ZEPHIR_CALL_FUNCTION(&_89$$60, "preg_replace", &_45, 79, &_87$$60, &_88$$60, &_86$$60);
						zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_50$$32, "__construct", &_46, 423, &columnName, &definition);
				zephir_check_call_status();
