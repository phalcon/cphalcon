...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, connect) {
	...
	ZEPHIR_RETURN_CALL_PARENT(phalcon_db_adapter_pdo_sqlite_ce, this_ptr, "connect", &_2, 152, &descriptor);
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeColumns) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _4)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_32$$3, "strcasecmp", &_33, 16, &_30$$3, &_31$$3);
		zephir_check_call_status();
		...
		if (_34$$3) {
			...
			ZVAL_STRING(&_38$$27, "");
			ZEPHIR_CALL_FUNCTION(&_39$$27, "preg_replace", &_40, 39, &_37$$27, &_38$$27, &_36$$27);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeIndexes) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _23, _24, _22)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_25$$12, "__construct", &_28, 22, &name, &_26$$12, &_27$$12);
		zephir_check_call_status();
