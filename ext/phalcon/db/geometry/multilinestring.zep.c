...
PHP_METHOD(Phalcon_Db_Geometry_MultiLineString, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 624, &lineStrings);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, srid);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 625, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Db_Geometry_MultiLineString, toWkt)
{
	...
	array_init(&parts);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 624, PH_NOISY_CC | PH_READONLY);
