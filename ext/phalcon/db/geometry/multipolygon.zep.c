...
PHP_METHOD(Phalcon_Db_Geometry_MultiPolygon, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 616, &polygons);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, srid);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 617, &_0);
	ZEPHIR_MM_RESTORE();
}
...
{
	zend_bool _5;
	zval polygon, parts, _0, *_1, _4, _8, _2$$3, _3$$3, _6$$4, _7$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			ZVAL_COPY(&polygon, _1);
			ZEPHIR_CALL_METHOD(&_2$$3, &polygon, "ringswkt", NULL, 0);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_3$$3);
			ZEPHIR_CONCAT_SVS(&_3$$3, "(", &_2$$3, ")");
			zephir_array_append(&parts, &_3$$3, PH_SEPARATE, "phalcon/Db/Geometry/MultiPolygon.zep", 43);
		...
		while (1) {
			...
			ZEPHIR_CALL_METHOD(&polygon, &_0, "current", NULL, 0);
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_6$$4, &polygon, "ringswkt", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_7$$4);
				ZEPHIR_CONCAT_SVS(&_7$$4, "(", &_6$$4, ")");
				zephir_array_append(&parts, &_7$$4, PH_SEPARATE, "phalcon/Db/Geometry/MultiPolygon.zep", 43);
		}
	}
	ZEPHIR_INIT_NVAR(&polygon);
	ZEPHIR_INIT_VAR(&_8);
	zephir_fast_join_str(&_8, SL(", "), &parts);
	ZEPHIR_CONCAT_SVS(return_value, "MULTIPOLYGON(", &_8, ")");
	RETURN_MM();
}
