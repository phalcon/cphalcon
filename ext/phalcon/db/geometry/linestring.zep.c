...
PHP_METHOD(Phalcon_Db_Geometry_LineString, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 623, &points);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, srid);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 624, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Db_Geometry_LineString, pointsWkt)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/Db/Geometry/LineString.zep", 59);
