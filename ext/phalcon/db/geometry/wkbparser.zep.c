...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, parse)
{
	...
	if (_0) {
		ZEPHIR_CALL_FUNCTION(&_1, "ctype_xdigit", NULL, 445, &raw_zv);
	...
	if (_0) {
		...
		ZVAL_STRING(&_5$$5, "V");
		ZEPHIR_CALL_FUNCTION(&arr, "unpack", NULL, 446, &_5$$5, &_4$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readGeometry)
{
	...
	do {
		...
		if (ZEPHIR_IS_LONG(&baseType, 2)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 447, &_5$$9, &srid);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_LONG(&baseType, 3)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 448, &_9$$10, &srid);
			zephir_check_call_status();
			RETURN_MM();
		}
		if (ZEPHIR_IS_LONG(&baseType, 4) || ZEPHIR_IS_LONG(&baseType, 5) || ZEPHIR_IS_LONG(&baseType, 6) || ZEPHIR_IS_LONG(&baseType, 7)) {
			...
			while (1) {
				...
				ZEPHIR_CALL_METHOD(&_14$$12, this_ptr, "readgeometry", &_15, 449, &srid);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &_16$$16, "__construct", NULL, 454, &_17$$16);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readPoint)
{
	...
	ZVAL_LONG(&_5, srid);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 455, &x, &y, &_5);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readPointList)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", &_9, 455, &x, &y);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readByte)
{
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "C");
	ZEPHIR_CALL_FUNCTION(&arr, "unpack", NULL, 446, &_6, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readUint32)
{
	...
	ZEPHIR_CALL_FUNCTION(&arr, "unpack", NULL, 446, &fmt, &_5);
	zephir_check_call_status();
