...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, parse)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 618, &body);
	ZVAL_UNDEF(&_8);
	ZVAL_LONG(&_8, zephir_fast_strlen_ev(&body));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 619, &_8);
	ZVAL_UNDEF(&_8);
	ZVAL_LONG(&_8, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 620, &_8);
	ZVAL_LONG(&_8, srid);
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readByte)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 618, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 620, PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_4, 1);
	ZEPHIR_INIT_VAR(&_5);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_7, this_ptr, _zephir_prop_0, 620, PH_NOISY_CC | PH_READONLY);
	ZVAL_UNDEF(&_8);
	ZVAL_LONG(&_8, (zephir_get_numberval(&_7) + 1));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 620, &_8);
...
PHP_METHOD(Phalcon_Db_Geometry_WkbParser, readUint32)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 620, PH_NOISY_CC | PH_READONLY);
	ZVAL_UNDEF(&_7);
	ZVAL_LONG(&_7, (zephir_get_numberval(&_6) + 4));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 620, &_7);
