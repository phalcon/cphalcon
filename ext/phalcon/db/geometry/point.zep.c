...
PHP_METHOD(Phalcon_Db_Geometry_Point, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_DOUBLE(&_0, x);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 612, &_0);
	ZVAL_UNDEF(&_0);
	ZVAL_DOUBLE(&_0, y);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 613, &_0);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, srid);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 614, &_0);
}
...
PHP_METHOD(Phalcon_Db_Geometry_Point, coordsWkt)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 613, PH_NOISY_CC | PH_READONLY);
