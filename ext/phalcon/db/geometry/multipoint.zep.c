...
PHP_METHOD(Phalcon_Db_Geometry_MultiPoint, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 642, &points);
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, srid);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 643, &_0);
	ZEPHIR_MM_RESTORE();
}
...
{
	zend_bool _6;
	zval point, parts, _0, *_1, _2, *_3, _5, _8, _4$$3, _7$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	ZEPHIR_CONCAT_SVS(return_value, "MULTIPOINT(", &_8, ")");
	RETURN_MM();
}
