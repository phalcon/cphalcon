...
PHP_METHOD(Phalcon_Filter_Validation, bind)
{
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(data), _10, _11, _9)
		{
			...
			zephir_read_property_cached(&_16$$8, this_ptr, _zephir_prop_3, 758, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_27$$15, this_ptr, _zephir_prop_3, 758, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Filter_Validation, validate)
{
	...
	if ((zephir_method_exists_ex(this_ptr, ZEND_STRL("aftervalidation")) == SUCCESS)) {
		zephir_read_property_cached(&_57$$44, this_ptr, _zephir_prop_5, 758, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_58$$44, this_ptr, _zephir_prop_3, 752, PH_NOISY_CC | PH_READONLY);
