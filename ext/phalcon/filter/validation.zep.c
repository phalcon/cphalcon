...
PHP_METHOD(Phalcon_Filter_Validation, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 735, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 736, &_2);
	ZEPHIR_INIT_VAR(&_3);
	ZEPHIR_INIT_NVAR(&_3);
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 737, &_4);
...
PHP_METHOD(Phalcon_Filter_Validation, bind)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 738, data);
	...
	if (ZEPHIR_IS_EMPTY(&whitelist)) {
		zephir_read_property_cached(&_7$$7, this_ptr, _zephir_prop_1, 739, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&whitelist, &_7$$7);
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_2, 740, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(data), _10, _11, _9)
		{
			...
			zephir_read_property_cached(&_16$$8, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
			if ((zephir_method_exists(&_16$$8, &method)  == SUCCESS)) {
				ZEPHIR_CALL_METHOD_ZVAL(NULL, entity, &method, NULL, 0, &value);
				zephir_check_call_status();
			} else {
				zephir_read_property_cached(&_17$$8, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
				if ((zephir_method_exists_ex(&_17$$8, ZEND_STRL("writeattribute")) == SUCCESS)) {
					...
					zephir_read_property_cached(&_18$$8, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property_cached(&_27$$15, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
				if ((zephir_method_exists(&_27$$15, &method)  == SUCCESS)) {
					ZEPHIR_CALL_METHOD_ZVAL(NULL, entity, &method, NULL, 0, &value);
					zephir_check_call_status();
				} else {
					zephir_read_property_cached(&_28$$15, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
					if ((zephir_method_exists_ex(&_28$$15, ZEND_STRL("writeattribute")) == SUCCESS)) {
						ZEPHIR_CALL_METHOD(NULL, entity, "writeattribute", NULL, 0, &field, &value);
						zephir_check_call_status();
					} else {
						zephir_read_property_cached(&_29$$15, this_ptr, _zephir_prop_3, 741, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Filter_Validation, getValue)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 740, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&filters, &_0);
	zephir_memory_observe(&fieldFilters);
	if (zephir_array_isset_fetch(&fieldFilters, &filters, &field_zv, 0)) {
...
PHP_METHOD(Phalcon_Filter_Validation, setEntity)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 741, entity);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Filter_Validation, setLabels)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 742, &labels);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Filter_Validation, setValidators)
{
	...
	zephir_get_arrval(&validators, validators_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 736, &validators);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Filter_Validation, validate)
{
	...
	zephir_read_property_cached(&validatorData, this_ptr, _zephir_prop_0, 736, PH_NOISY_CC);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 737, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_VAR(&_2);
	array_init(&_2);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 743, &_2);
	ZEPHIR_INIT_VAR(&_3);
	object_init_ex(&_3, phalcon_messages_messages_ce);
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 13);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 735, &_3);
	if (Z_TYPE_P(data) != IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 738, data);
		ZEPHIR_CPY_WRT(&inputData, data);
	} else {
		zephir_read_property_cached(&_0, this_ptr, _zephir_prop_4, 738, PH_NOISY_CC | PH_READONLY);
		if (!(ZEPHIR_IS_EMPTY(&_0))) {
			ZEPHIR_OBS_NVAR(&inputData);
			zephir_read_property_cached(&inputData, this_ptr, _zephir_prop_4, 738, PH_NOISY_CC);
		}
	}
	...
	if ((zephir_method_exists_ex(this_ptr, ZEND_STRL("beforevalidation")) == SUCCESS)) {
		zephir_read_property_cached(&_6$$8, this_ptr, _zephir_prop_5, 741, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_7$$8, this_ptr, _zephir_prop_3, 735, PH_NOISY_CC | PH_READONLY);
	...
	if ((zephir_method_exists_ex(this_ptr, ZEND_STRL("aftervalidation")) == SUCCESS)) {
		zephir_read_property_cached(&_57$$44, this_ptr, _zephir_prop_5, 741, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_58$$44, this_ptr, _zephir_prop_3, 735, PH_NOISY_CC | PH_READONLY);
