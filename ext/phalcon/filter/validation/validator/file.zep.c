...
PHP_METHOD(Phalcon_Filter_Validation_Validator_File, __construct)
{
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _5, _6, _3)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_8$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "maxSize");
			ZEPHIR_CALL_FUNCTION(&_10$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "equalSize");
			ZEPHIR_CALL_FUNCTION(&_11$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "allowedTypes");
			ZEPHIR_CALL_FUNCTION(&_12$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "maxResolution");
			ZEPHIR_CALL_FUNCTION(&_13$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "minResolution");
			ZEPHIR_CALL_FUNCTION(&_14$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "equalResolution");
			ZEPHIR_CALL_FUNCTION(&_15$$6, "strcasecmp", &_9, 45, &key, &_7$$6);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_38$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "maxSize");
				ZEPHIR_CALL_FUNCTION(&_39$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "equalSize");
				ZEPHIR_CALL_FUNCTION(&_40$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "allowedTypes");
				ZEPHIR_CALL_FUNCTION(&_41$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "maxResolution");
				ZEPHIR_CALL_FUNCTION(&_42$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "minResolution");
				ZEPHIR_CALL_FUNCTION(&_43$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "equalResolution");
				ZEPHIR_CALL_FUNCTION(&_44$$18, "strcasecmp", &_9, 45, &key, &_37$$18);
				zephir_check_call_status();
