...
PHP_METHOD(Phalcon_Filter_Validation_Validator_File, __construct)
{
	...
	if (zephir_array_isset_string(&options, SL("messageFileEmpty"))) {
		...
		ZEPHIR_CALL_METHOD(&messageFileEmpty, &helper, "__invoke", NULL, 149, &options, &_0$$3);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string(&options, SL("messageIniSize"))) {
		...
		ZEPHIR_CALL_METHOD(&messageIniSize, &helper, "__invoke", NULL, 149, &options, &_1$$4);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string(&options, SL("messageValid"))) {
		...
		ZEPHIR_CALL_METHOD(&messageValid, &helper, "__invoke", NULL, 149, &options, &_2$$5);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _5, _6, _3)
		{
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_8$$6, 0)) {
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_16$$7);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_16$$7);
				ZVAL_STRING(&_16$$7, "includedMinSize");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_16$$7);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_18, 296, &_17$$7);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_19$$8);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_19$$8);
				ZVAL_STRING(&_19$$8, "includedSize");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_19$$8);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_21, 297, &_20$$8);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_22$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_24, 298, &_23$$9);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_25$$10);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_27, 299, &_26$$10);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_28$$11);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_28$$11);
				ZVAL_STRING(&_28$$11, "includedMaxResolution");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_28$$11);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_30, 300, &_29$$11);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_31$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_31$$12);
				ZVAL_STRING(&_31$$12, "includedMinResolution");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_31$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 301, &_32$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_34$$13);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_35$$13);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&messageFileEmpty) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessagefileempty", &_37, 303, &messageFileEmpty);
				zephir_check_call_status();
			}
			if (Z_TYPE_P(&messageIniSize) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessageinisize", &_38, 304, &messageIniSize);
				zephir_check_call_status();
			}
			if (Z_TYPE_P(&messageValid) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessagevalid", &_39, 305, &messageValid);
				zephir_check_call_status();
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_LONG_IDENTICAL(&_41$$18, 0)) {
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_48$$19);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_48$$19);
					ZVAL_STRING(&_48$$19, "includedMinSize");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_48$$19);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_min_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_49$$19);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("messageMinSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMinSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_50$$20);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_50$$20);
					ZVAL_STRING(&_50$$20, "includedSize");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_50$$20);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_max_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_51$$20);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("maxSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_52$$21);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_equal_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_53$$21);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("equalSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageEqualSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_54$$22);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_mimetype_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_55$$22);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("allowedTypes"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageType"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_56$$23);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_56$$23);
					ZVAL_STRING(&_56$$23, "includedMaxResolution");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_56$$23);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_max_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_57$$23);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("maxResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMaxResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageMaxResolution"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_58$$24);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_58$$24);
					ZVAL_STRING(&_58$$24, "includedMinResolution");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 149, &options, &_58$$24);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_min_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_59$$24);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("minResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMinResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageMinResolution"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 149, &options, &_60$$25);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_equal_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_36, 302, &_61$$25);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("equalResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageEqualResolution"), PH_SEPARATE);
				} else {
