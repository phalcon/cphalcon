...
PHP_METHOD(Phalcon_Filter_Validation_Validator_StringLength, __construct)
{
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _1, _2, _0)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_4$$3, "strcasecmp", &_5, 77, &key, &_3$$3);
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_4$$3, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_6$$3, "strcasecmp", &_5, 77, &key, &_3$$3);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_14$$15, "strcasecmp", &_5, 77, &key, &_13$$15);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG_IDENTICAL(&_14$$15, 0)) {
					...
					ZEPHIR_CALL_FUNCTION(&_15$$15, "strcasecmp", &_5, 77, &key, &_13$$15);
					zephir_check_call_status();
