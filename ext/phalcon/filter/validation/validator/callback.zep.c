...
PHP_METHOD(Phalcon_Filter_Validation_Validator_Callback, validate)
{
	...
	if (zephir_is_callable(&callback)) {
		...
		zephir_read_property_cached(&savedTemplate, this_ptr, _zephir_prop_0, 744, PH_NOISY_CC);
		zephir_memory_observe(&savedChanged);
		zephir_read_property_cached(&savedChanged, this_ptr, _zephir_prop_1, 745, PH_NOISY_CC);
		zephir_memory_observe(&savedTemplates);
		zephir_read_property_cached(&savedTemplates, this_ptr, _zephir_prop_2, 746, PH_NOISY_CC);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 744, &savedTemplate);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 745, &savedChanged);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 746, &savedTemplates);
