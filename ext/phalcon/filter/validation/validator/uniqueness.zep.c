...
PHP_METHOD(Phalcon_Filter_Validation_Validator_Uniqueness, getColumnNameReal)
{
	...
	if (_2) {
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 764, PH_NOISY_CC | PH_READONLY);
	...
	if (_2) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 764, &_7$$3);
	}
	zephir_memory_observe(&_8);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 764, PH_NOISY_CC);
	_9 = Z_TYPE_P(&_8) == IS_ARRAY;
	if (_9) {
		zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 764, PH_NOISY_CC | PH_READONLY);
		_9 = zephir_array_isset_value(&_10, &field_zv);
	}
	if (_9) {
		zephir_read_property_cached(&_11$$4, this_ptr, _zephir_prop_0, 764, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Filter_Validation_Validator_Uniqueness, isUniqueness)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *validation, validation_sub, *field = NULL, field_sub, className, convert, record, singleField, values, params, _0, *_1, *_2, _5, _10, _14, _3$$4, _7$$5, _8$$6, _9$$7, _12$$9, _13$$11;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(field) != IS_ARRAY) {
		...
		array_init(field);
		zephir_array_append(field, &singleField, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 198);
	}
	...
	zephir_is_iterable(_1, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 208);
	...
	if (Z_TYPE_P(&convert) != IS_NULL) {
		...
		if (UNEXPECTED(!(Z_TYPE_P(&values) == IS_ARRAY))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_9$$7, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 212);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
	...
	if (_11) {
		...
		if (UNEXPECTED(ZEPHIR_IS_EMPTY(&record))) {
			...
			zephir_check_call_status();
			zephir_throw_exception_debug(&_12$$9, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 223);
			ZEPHIR_MM_RESTORE();
			return;
		}
	}
	...
	if (isModel) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_13$$11, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 232);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Phalcon_Filter_Validation_Validator_Uniqueness, isUniquenessModel)
{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			...
			if (zephir_is_true(&except)) {
				...
				if (_8$$6) {
					...
					zephir_is_iterable(_14$$7, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 301);
					if (Z_TYPE_P(_14$$7) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_14$$7), _17$$7, _18$$7, _16$$7)
						{
							...
							if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
								...
								zephir_is_iterable(_21$$9, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
								if (Z_TYPE_P(_21$$9) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_21$$9), _23$$9)
									{
										...
										zephir_array_append(&notInValues, &_25$$10, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_29$$11, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
									}
								}
								...
								zephir_array_append(&exceptConditions, &_31$$9, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
							} else {
								ZEPHIR_INIT_NVAR(&_32$$12);
								ZVAL_LONG(&_32$$12, index);
								ZEPHIR_INIT_NVAR(&_33$$12);
								ZEPHIR_CONCAT_VSV(&_33$$12, &attribute, " <> ?", &_32$$12);
								zephir_array_append(&exceptConditions, &_33$$12, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 296);
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									zephir_is_iterable(_38$$14, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
									if (Z_TYPE_P(_38$$14) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_38$$14), _40$$14)
										{
											...
											zephir_array_append(&notInValues, &_42$$15, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_46$$16, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
										}
									}
									...
									zephir_array_append(&exceptConditions, &_48$$14, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
								} else {
									ZEPHIR_INIT_NVAR(&_49$$17);
									ZVAL_LONG(&_49$$17, index);
									ZEPHIR_INIT_NVAR(&_50$$17);
									ZEPHIR_CONCAT_VSV(&_50$$17, &attribute, " <> ?", &_49$$17);
									zephir_array_append(&exceptConditions, &_50$$17, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 296);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
						}
					...
					if (Z_TYPE_P(&except) == IS_ARRAY) {
						...
						zephir_is_iterable(_54$$19, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 314);
						if (Z_TYPE_P(_54$$19) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_54$$19), _56$$19)
							{
								...
								zephir_array_append(&notInValues, &_58$$20, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 309);
								zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
								index++;
							} ZEND_HASH_FOREACH_END();
						} else {
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									zephir_array_append(&notInValues, &_62$$21, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 309);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
							}
						}
						...
						zephir_array_append(&exceptConditions, &_64$$19, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 314);
					} else {
					...
					zephir_is_iterable(&field, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 341);
					if (Z_TYPE_P(&field) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _67$$23)
						{
							...
							if (Z_TYPE_P(&except) == IS_ARRAY) {
								...
								zephir_is_iterable(_70$$25, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
								if (Z_TYPE_P(_70$$25) == IS_ARRAY) {
									ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_70$$25), _72$$25)
									{
										...
										zephir_array_append(&notInValues, &_74$$26, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
									} ZEND_HASH_FOREACH_END();
								} else {
									...
									while (1) {
										...
										zephir_check_call_status();
											...
											zephir_array_append(&notInValues, &_78$$27, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
									}
								}
								...
								zephir_array_append(&exceptConditions, &_80$$25, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
							} else {
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									zephir_is_iterable(_87$$30, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
									if (Z_TYPE_P(_87$$30) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_87$$30), _89$$30)
										{
											...
											zephir_array_append(&notInValues, &_91$$31, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_95$$32, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
										}
									}
									...
									zephir_array_append(&exceptConditions, &_97$$30, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
								} else {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&except)) {
					...
					if (_107$$37) {
						...
						zephir_is_iterable(_112$$38, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 301);
						if (Z_TYPE_P(_112$$38) == IS_ARRAY) {
							ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_112$$38), _115$$38, _116$$38, _114$$38)
							{
								...
								if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
									...
									zephir_is_iterable(_119$$40, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
									if (Z_TYPE_P(_119$$40) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_119$$40), _121$$40)
										{
											...
											zephir_array_append(&notInValues, &_123$$41, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_127$$42, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
										}
									}
									...
									zephir_array_append(&exceptConditions, &_129$$40, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
								} else {
									ZEPHIR_INIT_NVAR(&_130$$43);
									ZVAL_LONG(&_130$$43, index);
									ZEPHIR_INIT_NVAR(&_131$$43);
									ZEPHIR_CONCAT_VSV(&_131$$43, &attribute, " <> ?", &_130$$43);
									zephir_array_append(&exceptConditions, &_131$$43, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 296);
									zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
									index++;
								}
							} ZEND_HASH_FOREACH_END();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									if (Z_TYPE_P(&fieldExcept) == IS_ARRAY) {
										...
										zephir_is_iterable(_136$$45, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
										if (Z_TYPE_P(_136$$45) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_136$$45), _138$$45)
											{
												...
												zephir_array_append(&notInValues, &_140$$46, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_144$$47, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 289);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
											}
										}
										...
										zephir_array_append(&exceptConditions, &_146$$45, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 294);
									} else {
										ZEPHIR_INIT_NVAR(&_147$$48);
										ZVAL_LONG(&_147$$48, index);
										ZEPHIR_INIT_NVAR(&_148$$48);
										ZEPHIR_CONCAT_VSV(&_148$$48, &attribute, " <> ?", &_147$$48);
										zephir_array_append(&exceptConditions, &_148$$48, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 296);
										zephir_array_update_multi(&params, &fieldExcept, SL("sa"), 3, SL("bind"));
										index++;
									}
							}
						...
						if (Z_TYPE_P(&except) == IS_ARRAY) {
							...
							zephir_is_iterable(_152$$50, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 314);
							if (Z_TYPE_P(_152$$50) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_152$$50), _154$$50)
								{
									...
									zephir_array_append(&notInValues, &_156$$51, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 309);
									zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
									index++;
								} ZEND_HASH_FOREACH_END();
							} else {
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										zephir_array_append(&notInValues, &_160$$52, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 309);
										zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
										index++;
								}
							}
							...
							zephir_array_append(&exceptConditions, &_162$$50, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 314);
						} else {
						...
						if (Z_TYPE_P(&field) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _165$$54)
							{
								...
								if (Z_TYPE_P(&except) == IS_ARRAY) {
									...
									zephir_is_iterable(_168$$56, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
									if (Z_TYPE_P(_168$$56) == IS_ARRAY) {
										ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_168$$56), _170$$56)
										{
											...
											zephir_array_append(&notInValues, &_172$$57, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
											zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
											index++;
										} ZEND_HASH_FOREACH_END();
									} else {
										...
										while (1) {
											...
											zephir_check_call_status();
												...
												zephir_array_append(&notInValues, &_176$$58, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
										}
									}
									...
									zephir_array_append(&exceptConditions, &_178$$56, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
								} else {
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									if (Z_TYPE_P(&except) == IS_ARRAY) {
										...
										zephir_is_iterable(_185$$61, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
										if (Z_TYPE_P(_185$$61) == IS_ARRAY) {
											ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_185$$61), _187$$61)
											{
												...
												zephir_array_append(&notInValues, &_189$$62, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
												zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
												index++;
											} ZEND_HASH_FOREACH_END();
										} else {
											...
											while (1) {
												...
												zephir_check_call_status();
													...
													zephir_array_append(&notInValues, &_193$$63, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 329);
													zephir_array_update_multi(&params, &singleExcept, SL("sa"), 3, SL("bind"));
													index++;
											}
										}
										...
										zephir_array_append(&exceptConditions, &_195$$61, PH_SEPARATE, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 334);
									} else {
	...
	if (ZEPHIR_IS_LONG(&_198, 0)) {
		...
		zephir_is_iterable(_202$$65, 0, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 360);
	...
	ZEPHIR_INIT_NVAR(&_0);
	zephir_array_fetch_string(&_218, &params, SL("conditions"), PH_NOISY | PH_READONLY, "phalcon/Filter/Validation/Validator/Uniqueness.zep", 369);
