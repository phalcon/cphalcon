...
PHP_METHOD(Phalcon_Filter_Validation_Validator_Uniqueness, isUniqueness)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *validation, validation_sub, *field = NULL, field_sub, values, convert, record, params, className, singleField, _0, *_1, _2, _11, _3$$4, _5$$5, _6$$6, _7$$7, _9$$9, _10$$11;
	zval *this_ptr = getThis();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			...
			if (zephir_is_true(&except)) {
				...
				if (_9$$6) {
					...
					ZEPHIR_CALL_FUNCTION(&_13$$6, "range", &_14, 0, &_11$$6, &_12$$6);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&except)) {
					...
					if (_87$$37) {
						...
						ZEPHIR_CALL_FUNCTION(&_91$$37, "range", &_14, 0, &_89$$37, &_90$$37);
						zephir_check_call_status();
