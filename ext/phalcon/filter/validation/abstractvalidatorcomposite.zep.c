...
PHP_METHOD(Phalcon_Filter_Validation_AbstractValidatorComposite, validate)
{
	...
	zval *validation, validation_sub, *field, field_sub, validator, _0, _3, *_4, _5, _1$$3, _2$$3, _6$$4, _7$$6;
	...
	if (Z_TYPE_P(&_3) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3), _4)
		{
			...
			ZEPHIR_CALL_METHOD(&_6$$4, &validator, "validate", NULL, 0, validation, field);
			zephir_check_call_status();
