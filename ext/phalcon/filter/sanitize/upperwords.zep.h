...
ZEPHIR_INIT_FUNCS(phalcon_filter_sanitize_upperwords_method_entry) {
	...
	PHP_ME(Phalcon_Filter_Sanitize_UpperWords, phpExtensionLoaded, arginfo_phalcon_filter_sanitize_upperwords_phpextensionloaded, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_ME(Phalcon_Filter_Sanitize_UpperWords, phpFunctionExists, arginfo_phalcon_filter_sanitize_upperwords_phpfunctionexists, ZEND_ACC_PROTECTED|ZEND_ACC_STATIC)
	PHP_FE_END
};
