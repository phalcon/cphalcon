...
ZEPHIR_INIT_CLASS(Phalcon_Filter_Sanitize_Alpha)
{
	...
	zend_class_implements(phalcon_filter_sanitize_alpha_ce, 1, phalcon_contracts_filter_sanitizer_ce);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon_Filter_Sanitize_Alpha, __invoke)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "");
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 81, &_0, &_1, input);
