...
PHP_METHOD(Phalcon_Filter_Filter, get)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 749, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 749, PH_NOISY_CC | PH_READONLY);
...
{
	zval name_zv, *service, service_sub;
	zend_string *name = NULL;
	zval *this_ptr = getThis();
