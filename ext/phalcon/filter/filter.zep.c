...
PHP_METHOD(Phalcon_Filter_Filter, get)
{
	...
	if (1 != zephir_array_isset(&_3, &name)) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "createinstance", NULL, 283, &definition);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Filter_Filter, sanitize)
{
	...
	if (Z_TYPE_P(sanitizers) == IS_ARRAY) {
		...
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processarraysanitizers", NULL, 284, sanitizers, value, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (_1) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processarrayvalues", NULL, 285, value, sanitizers);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "sanitizer", NULL, 286, value, sanitizers);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Filter_Filter, processArraySanitizers)
{
	...
	if (Z_TYPE_P(&sanitizers) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&sanitizers), _2, _3, _0)
		{
			...
			ZEPHIR_CALL_METHOD(&split, this_ptr, "splitsanitizerparameters", &_4, 287, &sanitizerKey, &sanitizer);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "processvalueisarray", &_7, 288, value, &sanitizerName, &sanitizerParams, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(value, &_5$$4);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "processvalueisnotarray", &_8, 289, value, &sanitizerName, &sanitizerParams);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(value, &_5$$4);
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "processvalueisarray", &_7, 288, value, &sanitizerName, &sanitizerParams, &_10$$5);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(value, &_9$$5);
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "processvalueisnotarray", &_8, 289, value, &sanitizerName, &sanitizerParams);
				zephir_check_call_status();
				ZEPHIR_CPY_WRT(value, &_9$$5);
...
PHP_METHOD(Phalcon_Filter_Filter, processArrayValues)
{
	...
	if (Z_TYPE_P(&values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _2, _3, _0)
		{
			...
			ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "sanitizer", &_5, 286, &itemValue, &sanitizerName, &sanitizerParams);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "sanitizer", &_5, 286, &itemValue, &sanitizerName, &sanitizerParams);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Filter_Filter, processValueIsArray)
{
	...
	if (_0) {
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "processarrayvalues", NULL, 285, value, &sanitizerName, &sanitizerParams);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Filter_Filter, processValueIsNotArray)
{
	...
	if (Z_TYPE_P(value) != IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "sanitizer", NULL, 286, value, &sanitizerName, &sanitizerParams);
		zephir_check_call_status();
