...
ZEPHIR_INIT_FUNCS(phalcon_tag_method_entry) {
	...
	PHP_ME(Phalcon_Tag, colorField, arginfo_phalcon_tag_colorfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Tag, rangeField, arginfo_phalcon_tag_rangefield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Tag, dateTimeField, arginfo_phalcon_tag_datetimefield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, dateTimeLocalField, arginfo_phalcon_tag_datetimelocalfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, monthField, arginfo_phalcon_tag_monthfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, timeField, arginfo_phalcon_tag_timefield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, weekField, arginfo_phalcon_tag_weekfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Tag, searchField, arginfo_phalcon_tag_searchfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, telField, arginfo_phalcon_tag_telfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	PHP_ME(Phalcon_Tag, urlField, arginfo_phalcon_tag_urlfield, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Tag, form, arginfo_phalcon_tag_form, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Tag, setTitleSeparator, arginfo_phalcon_tag_settitleseparator, ZEND_ACC_STATIC|ZEND_ACC_PUBLIC)
