...
PHP_METHOD(phalcon_0__closure, __invoke) {
	...
	zephir_array_fetch_long(&_0, matches, 1, PH_NOISY | PH_READONLY, "phalcon/text.zep", 275 TSRMLS_CC);
	ZEPHIR_INIT_VAR(words);
	zephir_fast_explode_str(words, SL("|"), _0, LONG_MAX TSRMLS_CC);
	ZEPHIR_CALL_FUNCTION(&_2, "array_rand", NULL, 468, words);
	zephir_check_call_status();
	zephir_array_fetch(&_1, words, _2, PH_NOISY | PH_READONLY, "phalcon/text.zep", 276 TSRMLS_CC);
	RETURN_CTOR(_1);
