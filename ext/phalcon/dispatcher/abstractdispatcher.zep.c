...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, callActionMethod)
{
	...
	if (_1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &observer, "__construct", NULL, 39, &_3$$3);
		...
		ZEPHIR_CALL_METHOD(&altHandler, &observer, "get", NULL, 182, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "action");
		ZEPHIR_CALL_METHOD(&altAction, &observer, "get", NULL, 182, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_5$$3);
		array_init(&_5$$3);
		...
		ZEPHIR_CALL_METHOD(&altParams, &observer, "get", NULL, 182, &_6$$3, &_5$$3, &_7$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, dispatch)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&handlerHash, "spl_object_hash", &_30, 183, &handler);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, forward)
{
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 184);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getActiveMethod)
{
	...
	if (!(zephir_array_isset_fetch(&activeMethodName, &_0, &_1, 0))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&activeMethodName, "lcfirst", NULL, 173, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setDefaultAction)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&actionName_zv, actionName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 191, &actionName_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setDefaultNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 192, &defaultNamespace_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setEventsManager)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 170, eventsManager);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, resolveEmptyProperties)
{
	...
	if (!(zephir_is_true(&_0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 192, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&_4))) {
		zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_5, 191, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, toCamelCase)
{
	...
	if (!(zephir_array_isset_fetch(&camelCaseInput, &_0, &input_zv, 0))) {
		ZEPHIR_INIT_VAR(&_1$$3);
		ZVAL_STRING(&_1$$3, "/[_-]+/");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "preg_split", NULL, 185, &_1$$3, &input_zv);
		zephir_check_call_status();
