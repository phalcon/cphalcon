...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, callActionMethod)
{
	...
	if (_1) {
		...
		ZEPHIR_CALL_METHOD(&altHandler, &observer, "get", NULL, 179, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "action");
		ZEPHIR_CALL_METHOD(&altAction, &observer, "get", NULL, 179, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_5$$3);
		array_init(&_5$$3);
		...
		ZEPHIR_CALL_METHOD(&altParams, &observer, "get", NULL, 179, &_6$$3, &_5$$3, &_7$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, dispatch)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&handlerHash, "spl_object_hash", &_30, 180, &handler);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getActiveMethod)
{
	...
	if (!(zephir_array_isset_fetch(&activeMethodName, &_0, &_1, 0))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&activeMethodName, "lcfirst", NULL, 170, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, toCamelCase)
{
	...
	if (!(zephir_array_isset_fetch(&camelCaseInput, &_0, &input_zv, 0))) {
		ZEPHIR_INIT_VAR(&_1$$3);
		ZVAL_STRING(&_1$$3, "/[_-]+/");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "preg_split", NULL, 182, &_1$$3, &input_zv);
		zephir_check_call_status();
