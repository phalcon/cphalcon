...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, callActionMethod)
{
	...
	if (_1) {
		...
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC);
	...
	if (_1) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(!(zephir_is_callable(&_8$$3)))) {
			zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_1, 179, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_10$$4, this_ptr, _zephir_prop_2, 180, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_15, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC | PH_READONLY);
	_16 = Z_TYPE_P(&_15) != IS_NULL;
	if (_16) {
		zephir_memory_observe(&_17);
		zephir_read_property_cached(&_17, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC);
	...
	if (_16) {
		...
		zephir_read_property_cached(&_18$$5, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, dispatch)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 178, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&eventsManager, &_0);
	hasEventsManager = Z_TYPE_P(&eventsManager) == IS_OBJECT;
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 182, &__$true);
	} else {
	...
	if (hasEventsManager) {
		...
		/* try_start_1: */
			...
			if (_5$$5) {
				zephir_read_property_cached(&_6$$5, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
	...
	while (1) {
		zephir_read_property_cached(&_0, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			/* try_start_2: */
				...
				if (!(_18$$13)) {
					zephir_read_property_cached(&_14$$13, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_19$$12, SL("Exception"))) {
					...
					if (!(_21$$15)) {
						zephir_read_property_cached(&_22$$15, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (!(hasService)) {
			...
			if (_28$$18) {
				zephir_read_property_cached(&_27$$18, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(Z_TYPE_P(&handler) != IS_OBJECT)) {
			...
			if (_32$$20) {
				zephir_read_property_cached(&_31$$20, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_34$$10, this_ptr, _zephir_prop_3, 183, PH_NOISY_CC | PH_READONLY);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 184, &handler);
		zephir_read_property_cached(&_35$$10, this_ptr, _zephir_prop_5, 185, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_38$$10, this_ptr, _zephir_prop_5, 185, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_39$$10, this_ptr, _zephir_prop_6, 186, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&namespaceName, &_39$$10);
		zephir_read_property_cached(&_39$$10, this_ptr, _zephir_prop_7, 180, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&handlerName, &_39$$10);
		zephir_read_property_cached(&_39$$10, this_ptr, _zephir_prop_8, 179, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&actionName, &_39$$10);
		ZEPHIR_OBS_NVAR(&_40$$10);
		zephir_read_property_cached(&_40$$10, this_ptr, _zephir_prop_9, 187, PH_NOISY_CC);
		if (UNEXPECTED(Z_TYPE_P(&_40$$10) != IS_ARRAY)) {
			...
			if (_43$$24) {
				zephir_read_property_cached(&_42$$24, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (UNEXPECTED(!(zephir_is_callable(&_45$$10)))) {
			if (hasEventsManager) {
				...
				zephir_read_property_cached(&_48$$27, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (_51$$26) {
				zephir_read_property_cached(&_50$$26, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			/* try_start_3: */
				...
				if (!(_57$$32)) {
					zephir_read_property_cached(&_54$$32, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_59$$31, SL("Exception"))) {
					...
					if (!(_61$$34)) {
						zephir_read_property_cached(&_62$$34, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_is_true(&_64$$10)) {
			...
			/* try_start_4: */
				...
				if (!(_66$$37)) {
					zephir_read_property_cached(&_67$$37, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_69$$36, SL("Exception"))) {
					...
					if (!(_71$$39)) {
						zephir_read_property_cached(&_72$$39, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (isNewHandler) {
			...
			if (zephir_is_true(&_74$$41)) {
				...
				/* try_start_5: */
					...
					if (1) {
						zephir_update_property_zval_cached(this_ptr, _zephir_prop_10, 188, &__$true);
					} else {
				...
				if (EG(exception)) {
					...
					if (zephir_is_instance_of(&_75$$42, SL("Exception"))) {
						...
						if (!(_77$$44)) {
							zephir_read_property_cached(&_78$$44, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (_79$$41) {
				zephir_read_property_cached(&_80$$41, this_ptr, _zephir_prop_1, 178, PH_NOISY_CC | PH_READONLY);
				_79$$41 = Z_TYPE_P(&_80$$41) != IS_NULL;
			}
			_81$$41 = _79$$41;
			if (_81$$41) {
				ZEPHIR_OBS_NVAR(&_82$$41);
				zephir_read_property_cached(&_82$$41, this_ptr, _zephir_prop_1, 178, PH_NOISY_CC);
				_81$$41 = zephir_instance_of_ev(&_82$$41, phalcon_events_managerinterface_ce);
			}
			if (_81$$41) {
				zephir_read_property_cached(&_83$$46, this_ptr, _zephir_prop_1, 178, PH_NOISY_CC | PH_READONLY);
			...
			if (zephir_is_true(&eventsManager)) {
				...
				/* try_start_6: */
					...
					if (!(_86$$48)) {
						zephir_read_property_cached(&_87$$48, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
				...
				if (EG(exception)) {
					...
					if (zephir_is_instance_of(&_88$$47, SL("Exception"))) {
						...
						if (!(_90$$50)) {
							zephir_read_property_cached(&_91$$50, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_39$$10, this_ptr, _zephir_prop_11, 189, PH_NOISY_CC | PH_READONLY);
		if (zephir_is_true(&_39$$10)) {
			zephir_read_property_cached(&_92$$52, this_ptr, _zephir_prop_12, 190, PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			zephir_read_property_cached(&_96$$53, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_is_true(&_97$$10)) {
			...
			zephir_read_property_cached(&_99$$56, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			if (ZEPHIR_IS_FALSE_IDENTICAL(&_99$$56)) {
				continue;
			}
		}
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 191, &handler);
		...
		if (EG(exception)) {
			...
			if (zephir_is_instance_of(&_104$$10, SL("Exception"))) {
				...
				if (!(_106$$61)) {
					zephir_read_property_cached(&_107$$61, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			/* try_start_8: */
				...
				if (!(_110$$64)) {
					zephir_read_property_cached(&_111$$64, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_112$$63, SL("Exception"))) {
					...
					if (!(_114$$66)) {
						zephir_read_property_cached(&_115$$66, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (zephir_is_true(&_116$$10)) {
			...
			/* try_start_9: */
				...
				if (!(_118$$69)) {
					zephir_read_property_cached(&_119$$69, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_120$$68, SL("Exception"))) {
					...
					if (!(_122$$71)) {
						zephir_read_property_cached(&_123$$71, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_125$$73, SL("Exception"))) {
					...
					if (!(_127$$75)) {
						zephir_read_property_cached(&_128$$75, this_ptr, _zephir_prop_2, 182, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, forward)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 188, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 186, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 193, &_2);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_3, 180, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 194, &_3);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_5, 179, PH_NOISY_CC | PH_READONLY);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 195, &_4);
	zephir_memory_observe(&namespaceName);
	if (zephir_array_isset_string_fetch(&namespaceName, &forward, SL("namespace"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 186, &namespaceName);
	}
	zephir_memory_observe(&controllerName);
	if (zephir_array_isset_string_fetch(&controllerName, &forward, SL("controller"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 180, &controllerName);
	} else {
		zephir_memory_observe(&taskName);
		if (zephir_array_isset_string_fetch(&taskName, &forward, SL("task"), 0)) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 180, &taskName);
		}
	}
	zephir_memory_observe(&actionName);
	if (zephir_array_isset_string_fetch(&actionName, &forward, SL("action"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 179, &actionName);
	}
	zephir_memory_observe(&params);
	if (zephir_array_isset_string_fetch(&params, &forward, SL("params"), 0)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 187, &params);
	}
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 182, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_8, 182, &__$false);
	}
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 196, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 196, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getActiveMethod)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 197, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_array_isset_fetch(&activeMethodName, &_0, &_1, 0))) {
		...
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 179, PH_NOISY_CC);
		zephir_update_property_array(this_ptr, SL("activeMethodMap"), &_4$$3, &activeMethodName);
	}
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_2, 198, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getHandlerClass)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 180, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getParameter)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_1, 181, PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_0) == IS_NULL) {
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setActionName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 179, &actionName_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setActionSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 198, &actionSuffix_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setDefaultAction)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&actionName_zv, actionName);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 200, &actionName_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setDefaultNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 201, &defaultNamespace_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setHandlerSuffix)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 199, &handlerSuffix_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setModelBinder)
{
	...
	if (Z_TYPE_P(cache) == IS_STRING) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 181, PH_NOISY_CC | PH_READONLY);
	...
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 189, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 189, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 190, modelBinder);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setModuleName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 202, &moduleName_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setNamespaceName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 186, &namespaceName_zv);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setParameters)
{
	...
	zephir_get_arrval(&params, params_param);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 187, &params);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setReturnedValue)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 192, value);
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, resolveEmptyProperties)
{
	...
	if (!(zephir_is_true(&_0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 201, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 186, &_1$$3);
	}
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 180, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_2))) {
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_3, 203, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 180, &_3$$4);
	}
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_4, 179, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_is_true(&_4))) {
		zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_5, 200, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 179, &_5$$5);
	}
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, toCamelCase)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 204, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, setEventsManager)
{
	...
	if (_2) {
		...
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 181, PH_NOISY_CC);
		_2 = Z_TYPE_P(&_3) != IS_NULL;
	}
	if (_2) {
		zephir_memory_observe(&_4$$3);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 181, PH_NOISY_CC);
		ZEPHIR_INIT_VAR(&_5$$3);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 178, eventsManager);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, fireManagerEvent)
{
	...
	if (Z_TYPE_P(&_0) != IS_NULL) {
		...
		if (_1$$3) {
			...
			zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC);
			_1$$3 = zephir_instance_of_ev(&_2$$3, phalcon_events_manager_ce);
		}
		if (_1$$3) {
			zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC | PH_READONLY);
			if (cancellable) {
				ZVAL_BOOL(&_4$$4, 1);
			} else {
				ZVAL_BOOL(&_4$$4, 0);
		...
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_0, 178, PH_NOISY_CC | PH_READONLY);
		if (cancellable) {
			ZVAL_BOOL(&_7$$3, 1);
		} else {
			ZVAL_BOOL(&_7$$3, 0);
