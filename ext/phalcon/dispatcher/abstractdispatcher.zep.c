		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_9$$4, zend_exception_get_default(TSRMLS_C))) {
				...
				if (!ZEPHIR_IS_FALSE_IDENTICAL(&_10$$7)) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 181);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	while (1) {
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_20$$12, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 222);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_60$$30, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 363);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, ZEND_STRL("beforeexecuteroute")) == SUCCESS)) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_70$$35, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 382);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
			...
			if ((zephir_method_exists_ex(&handler, ZEND_STRL("initialize")) == SUCCESS)) {
				...
				if (EG(exception)) {
					...
					if (zephir_instance_of_ev(&_76$$41, zend_exception_get_default(TSRMLS_C))) {
						...
						zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 424);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
			...
			if (zephir_is_true(&eventsManager)) {
				...
				if (EG(exception)) {
					...
					if (zephir_instance_of_ev(&_86$$45, zend_exception_get_default(TSRMLS_C))) {
						...
						zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 443);
						ZEPHIR_MM_RESTORE();
						return;
					}
				}
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_102$$10, zend_exception_get_default(TSRMLS_C))) {
				...
				zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 515);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_112$$61, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 531);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if ((zephir_method_exists_ex(&handler, ZEND_STRL("afterexecuteroute")) == SUCCESS)) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_120$$66, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 548);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
		...
		if (hasEventsManager) {
			...
			if (EG(exception)) {
				...
				if (zephir_instance_of_ev(&_127$$71, zend_exception_get_default(TSRMLS_C))) {
					...
					zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 565);
					ZEPHIR_MM_RESTORE();
					return;
				}
			}
	...
	if (hasEventsManager) {
		...
		if (EG(exception)) {
			...
			if (zephir_instance_of_ev(&_133$$75, zend_exception_get_default(TSRMLS_C))) {
				...
				zephir_throw_exception_debug(&e, "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 582);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, forward) {
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_dispatcher_exception_ce, "Forwarding inside a controller's initialize() method is forbidden", "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 616);
		return;
	}
...
PHP_METHOD(Phalcon_Dispatcher_AbstractDispatcher, getHandlerClass) {
	...
	if (!(zephir_memnstr_str(&handlerName, SL("\\"), "/home/nikos/Work/niden/cphalcon/phalcon/Dispatcher/AbstractDispatcher.zep", 867))) {
