...
PHP_METHOD(Phalcon_Autoload_Loader, __construct)
{
	...
	if (isDebug) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 468, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 468, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, addNamespace)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkdirectories", NULL, 428, directories, &dirSeparator, &name_zv);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(directories, &_2);
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 469, PH_NOISY_CC | PH_READONLY);
	...
	if (prepend) {
		...
		zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 469, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_NVAR(&source);
		zephir_array_fetch(&source, &_5, &nsName, PH_NOISY, "phalcon/Autoload/Loader.zep", 140);
	}
	if (prepend) {
		zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 469, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_unique", NULL, 429, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoload)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 470, PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_LONG_IDENTICAL(&_0, 0)) {
		ZEPHIR_INIT_VAR(&_1$$3);
		array_init(&_1$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 471, &_1$$3);
	}
	result = 1;
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 470, PH_NOISY_CC | PH_READONLY);
	ZVAL_UNDEF(&_3);
	ZVAL_LONG(&_3, (zephir_get_numberval(&_2) + 1));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 470, &_3);
	ZEPHIR_INIT_VAR(&_4);
	ZEPHIR_CONCAT_SV(&_4, "Loading: ", &className_zv);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "loader:beforeCheckClass");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "firemanagerevent", NULL, 0, &_5, &className_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "autoloadcheckclasses", NULL, 431, &className_zv);
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_6)) {
		ZEPHIR_INIT_VAR(&_7$$4);
		ZEPHIR_CONCAT_SV(&_7$$4, "Class: 404: ", &className_zv);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_7$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "autoloadchecknamespaces", NULL, 432, &className_zv);
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(&_8$$4)) {
			ZEPHIR_INIT_VAR(&_9$$5);
			ZEPHIR_CONCAT_SV(&_9$$5, "Namespace: 404: ", &className_zv);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_9$$5);
			zephir_check_call_status();
			zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_2, 472, PH_NOISY_CC | PH_READONLY);
			ZVAL_BOOL(&_12$$5, 1);
			ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "autoloadcheckdirectories", NULL, 433, &_11$$5, &className_zv, &_12$$5);
			zephir_check_call_status();
			if (!ZEPHIR_IS_TRUE_IDENTICAL(&_10$$5)) {
				ZEPHIR_INIT_VAR(&_13$$6);
				ZEPHIR_CONCAT_SV(&_13$$6, "Directories: 404: ", &className_zv);
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_13$$6);
				zephir_check_call_status();
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 470, PH_NOISY_CC | PH_READONLY);
	ZVAL_UNDEF(&_15);
	ZVAL_LONG(&_15, (zephir_get_numberval(&_3) - 1));
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 470, &_15);
...
PHP_METHOD(Phalcon_Autoload_Loader, register)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "registerautoload", NULL, 434, &_1$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Autoload_Loader, setDirectories)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 435, &directories, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setExtensions)
{
	...
	if (!merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		array_init(&_0$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 476, &_0$$3);
		ZEPHIR_INIT_VAR(&_1$$3);
...
PHP_METHOD(Phalcon_Autoload_Loader, setFileCheckingCallback)
{
	...
	if (1 == zephir_is_callable(method)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 477, method);
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 477, &_0$$4);
	} else {
...
PHP_METHOD(Phalcon_Autoload_Loader, setFiles)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 435, &files, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setNamespaces)
{
	...
	if (!merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		array_init(&_0$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 469, &_0$$3);
	}
...
PHP_METHOD(Phalcon_Autoload_Loader, unregister)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 437, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 474, &__$true);
		} else {
...
PHP_METHOD(Phalcon_Autoload_Loader, requireFile)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 478, &file_zv);
		ZEPHIR_INIT_VAR(&_2$$3);
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckClasses)
{
	...
	if (1 == zephir_array_isset_value(&_0, &className_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 475, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(&_3$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 430, &_4$$4);
			zephir_check_call_status();
			RETURN_MM_BOOL(1);
		}
	}
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _1)
		{
			...
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _3$$3)
				{
					...
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 479, &filePath);
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_6$$4)) {
						if (isDirectory) {
							...
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_8$$6);
							zephir_check_call_status();
						}
						RETURN_MM_BOOL(1);
					}
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$7)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_14$$9);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _18$$10)
					{
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_20$$11)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_21$$13);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
						...
						zephir_check_call_status();
							...
							if (ZEPHIR_IS_TRUE_IDENTICAL(&_25$$14)) {
								if (isDirectory) {
									...
									ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_26$$16);
									zephir_check_call_status();
								}
								RETURN_MM_BOOL(1);
							}
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckNamespaces)
{
	...
	zephir_memory_observe(&className_zv);
	ZVAL_STR_COPY(&className_zv, className);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 469, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _2, _3, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "autoloadcheckdirectories", &_6, 433, &directories, &fileName);
			zephir_check_call_status();
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_5$$3)) {
				zephir_read_property_cached(&_7$$5, this_ptr, _zephir_prop_1, 479, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&_8$$5);
				ZEPHIR_CONCAT_SVSV(&_8$$5, "Namespace: ", &prefix, " - ", &_7$$5);
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_8$$5);
				zephir_check_call_status();
				RETURN_MM_BOOL(1);
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_13$$6, this_ptr, "autoloadcheckdirectories", &_6, 433, &directories, &fileName);
				zephir_check_call_status();
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$6)) {
					zephir_read_property_cached(&_14$$8, this_ptr, _zephir_prop_1, 479, PH_NOISY_CC | PH_READONLY);
					ZEPHIR_INIT_NVAR(&_15$$8);
					ZEPHIR_CONCAT_SVSV(&_15$$8, "Namespace: ", &prefix, " - ", &_14$$8);
					ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 430, &_15$$8);
					zephir_check_call_status();
					RETURN_MM_BOOL(1);
				}
		}
...
PHP_METHOD(Phalcon_Autoload_Loader, registerAutoload)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("spl_autoload_register", NULL, 439, &_0, &__$true, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setEventsManager)
{
	...
	if (_2) {
		...
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 480, PH_NOISY_CC);
		_2 = Z_TYPE_P(&_3) != IS_NULL;
	}
	if (_2) {
		zephir_memory_observe(&_4$$3);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_0, 480, PH_NOISY_CC);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 481, eventsManager);
	ZEPHIR_MM_RESTORE();
}
