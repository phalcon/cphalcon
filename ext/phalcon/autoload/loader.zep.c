...
PHP_METHOD(Phalcon_Autoload_Loader, addNamespace)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkdirectories", NULL, 289, directories, &dirSeparator);
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_unique", NULL, 290, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoload)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 291, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "loader:beforeCheckClass");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "firemanagerevent", NULL, 0, &_2, &className_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "autoloadcheckclasses", NULL, 292, &className_zv);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 291, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "autoloadchecknamespaces", NULL, 293, &className_zv);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 291, &_6);
	zephir_check_call_status();
	zephir_read_property(&_8, this_ptr, ZEND_STRL("directories"), PH_NOISY_CC | PH_READONLY);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "autoloadcheckdirectories", NULL, 294, &_8, &className_zv, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 291, &_10);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Phalcon_Autoload_Loader, register)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 295, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Autoload_Loader, setDirectories)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 296, &directories, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setFileCheckingCallback)
{
	...
	if (1 == zephir_is_callable(method)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 297);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, setFiles)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 296, &files, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setNamespaces)
{
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _2, _3, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "checkdirectories", &_5, 289, &directories, &dirSeparator);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "checkdirectories", &_5, 289, &directories, &dirSeparator);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, unregister)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoload");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 298, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("isRegistered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Autoload_Loader, requireFile)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "call_user_func", NULL, 299, &_0, &file_zv);
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 291, &_3$$3);
		zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _3$$3)
				{
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_6$$4)) {
						if (isDirectory) {
							...
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 291, &_8$$6);
							zephir_check_call_status();
						}
						RETURN_MM_BOOL(1);
					}
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$7)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 291, &_14$$9);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _18$$10)
					{
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_20$$11)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 291, &_21$$13);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
						...
						zephir_check_call_status();
							...
							if (ZEPHIR_IS_TRUE_IDENTICAL(&_25$$14)) {
								if (isDirectory) {
									...
									ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 291, &_26$$16);
									zephir_check_call_status();
								}
								RETURN_MM_BOOL(1);
							}
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckNamespaces)
{
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _2, _3, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_7$$3, this_ptr, "autoloadcheckdirectories", &_8, 294, &directories, &fileName);
			zephir_check_call_status();
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_7$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_11, 291, &_10$$5);
				zephir_check_call_status();
				RETURN_MM_BOOL(1);
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "autoloadcheckdirectories", &_8, 294, &directories, &fileName);
				zephir_check_call_status();
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_17$$6)) {
					...
					ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_11, 291, &_19$$8);
					zephir_check_call_status();
					RETURN_MM_BOOL(1);
				}
		}
...
PHP_METHOD(Phalcon_Autoload_Loader, checkDirectories)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 300);
		zephir_check_call_status();
