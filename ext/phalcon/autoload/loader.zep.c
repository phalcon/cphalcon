...
PHP_METHOD(Phalcon_Autoload_Loader, addNamespace)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkdirectories", NULL, 364, directories, &dirSeparator, &name_zv);
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_unique", NULL, 365, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoload)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, "loader:beforeCheckClass");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "firemanagerevent", NULL, 0, &_5, &className_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "autoloadcheckclasses", NULL, 367, &className_zv);
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_6)) {
		ZEPHIR_INIT_VAR(&_7$$4);
		ZEPHIR_CONCAT_SV(&_7$$4, "Class: 404: ", &className_zv);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_7$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_8$$4, this_ptr, "autoloadchecknamespaces", NULL, 368, &className_zv);
		zephir_check_call_status();
		if (!ZEPHIR_IS_TRUE_IDENTICAL(&_8$$4)) {
			ZEPHIR_INIT_VAR(&_9$$5);
			ZEPHIR_CONCAT_SV(&_9$$5, "Namespace: 404: ", &className_zv);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_9$$5);
			zephir_check_call_status();
			zephir_read_property(&_11$$5, this_ptr, ZEND_STRL("directories"), PH_NOISY_CC | PH_READONLY);
			ZVAL_BOOL(&_12$$5, 1);
			ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "autoloadcheckdirectories", NULL, 369, &_11$$5, &className_zv, &_12$$5);
			zephir_check_call_status();
			if (!ZEPHIR_IS_TRUE_IDENTICAL(&_10$$5)) {
				ZEPHIR_INIT_VAR(&_13$$6);
				ZEPHIR_CONCAT_SV(&_13$$6, "Directories: 404: ", &className_zv);
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_13$$6);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, register)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 370, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Autoload_Loader, setDirectories)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 371, &directories, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setFileCheckingCallback)
{
	...
	if (1 == zephir_is_callable(method)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 372);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, setFiles)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 371, &files, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, requireFile)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckClasses)
{
	...
	if (1 == zephir_array_isset_value(&_0, &className_zv)) {
		...
		if (ZEPHIR_IS_TRUE_IDENTICAL(&_3$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 366, &_4$$4);
			zephir_check_call_status();
			RETURN_MM_BOOL(1);
		}
	}
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _3$$3)
				{
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_6$$4)) {
						if (isDirectory) {
							...
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_8$$6);
							zephir_check_call_status();
						}
						RETURN_MM_BOOL(1);
					}
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$7)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_14$$9);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _18$$10)
					{
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_20$$11)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_21$$13);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
						...
						zephir_check_call_status();
							...
							if (ZEPHIR_IS_TRUE_IDENTICAL(&_25$$14)) {
								if (isDirectory) {
									...
									ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_26$$16);
									zephir_check_call_status();
								}
								RETURN_MM_BOOL(1);
							}
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckNamespaces)
{
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _2, _3, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "autoloadcheckdirectories", &_6, 369, &directories, &fileName);
			zephir_check_call_status();
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_5$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_8$$5);
				zephir_check_call_status();
				RETURN_MM_BOOL(1);
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_13$$6, this_ptr, "autoloadcheckdirectories", &_6, 369, &directories, &fileName);
				zephir_check_call_status();
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_13$$6)) {
					...
					ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_9, 366, &_15$$8);
					zephir_check_call_status();
					RETURN_MM_BOOL(1);
				}
		}
...
PHP_METHOD(Phalcon_Autoload_Loader, checkDirectories)
{
	...
	if (_0) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 374, &name_zv);
		zephir_check_call_status();
