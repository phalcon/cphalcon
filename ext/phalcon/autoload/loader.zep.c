...
PHP_METHOD(Phalcon_Autoload_Loader, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "php");
	ZEPHIR_CALL_FUNCTION(&_1, "sha1", NULL, 96, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "php");
	zephir_update_property_array(this_ptr, SL("extensions"), &_1, &_0);
	if (isDebug) {
...
PHP_METHOD(Phalcon_Autoload_Loader, addDirectory)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 96, &directory);
	zephir_check_call_status();
	zephir_update_property_array(this_ptr, SL("directories"), &_0, &directory);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, addExtension)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 96, &extension);
	zephir_check_call_status();
	zephir_update_property_array(this_ptr, SL("extensions"), &_0, &extension);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, addFile)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 96, &file);
	zephir_check_call_status();
	zephir_update_property_array(this_ptr, SL("files"), &_0, &file);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, addNamespace)
{
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkdirectories", NULL, 191, directories, &dirSeparator);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_unique", NULL, 192, &_7);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoload)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 193, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "loader:beforeCheckClass");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "firemanagerevent", NULL, 0, &_2, &className);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "autoloadcheckclasses", NULL, 194, &className);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 193, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "autoloadchecknamespaces", NULL, 195, &className);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 193, &_6);
	zephir_check_call_status();
	zephir_read_property(&_8, this_ptr, ZEND_STRL("directories"), PH_NOISY_CC | PH_READONLY);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "autoloadcheckdirectories", NULL, 196, &_8, &className, &_9);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 193, &_10);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Phalcon_Autoload_Loader, register)
{
	...
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 197, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Autoload_Loader, setDirectories)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 198, &directories, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setExtensions)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool merge;
	zval *extensions_param = NULL, *merge_param = NULL, extension, *_3, _4, _0$$3, _1$$3, _2$$3;
	zval extensions;
	zval *this_ptr = getThis();
	...
	if (!merge) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "sha1", NULL, 96, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_1$$3);
		ZVAL_STRING(&_1$$3, "php");
		zephir_update_property_array(this_ptr, SL("extensions"), &_2$$3, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Autoload_Loader, setFiles)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addtocollection", NULL, 198, &files, &_0, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Autoload_Loader, setNamespaces)
{
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _3, _4, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "checkdirectories", &_6, 191, &directories, &dirSeparator);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_8$$5, this_ptr, "checkdirectories", &_6, 191, &directories, &dirSeparator);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, unregister)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoload");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 199, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, ZEND_STRL("isRegistered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Autoload_Loader, requireFile)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "call_user_func", NULL, 200, &_0, &file);
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", NULL, 193, &_3$$3);
		zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _5$$3)
				{
					...
					if (ZEPHIR_IS_TRUE_IDENTICAL(&_9$$4)) {
						if (isDirectory) {
							...
							ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_11$$6);
							zephir_check_call_status();
						}
						RETURN_MM_BOOL(1);
					}
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_14$$7)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_15$$9);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _17$$10)
					{
						...
						if (ZEPHIR_IS_TRUE_IDENTICAL(&_20$$11)) {
							if (isDirectory) {
								...
								ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_21$$13);
								zephir_check_call_status();
							}
							RETURN_MM_BOOL(1);
						}
						...
						zephir_check_call_status();
							...
							if (ZEPHIR_IS_TRUE_IDENTICAL(&_23$$14)) {
								if (isDirectory) {
									...
									ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_24$$16);
									zephir_check_call_status();
								}
								RETURN_MM_BOOL(1);
							}
...
PHP_METHOD(Phalcon_Autoload_Loader, autoloadCheckNamespaces)
{
	...
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _3, _4, _1)
		{
			...
			ZEPHIR_CALL_METHOD(&_8$$3, this_ptr, "autoloadcheckdirectories", &_9, 196, &directories, &fileName);
			zephir_check_call_status();
			if (ZEPHIR_IS_TRUE_IDENTICAL(&_8$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_11$$5);
				zephir_check_call_status();
				RETURN_MM_BOOL(1);
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_16$$6, this_ptr, "autoloadcheckdirectories", &_9, 196, &directories, &fileName);
				zephir_check_call_status();
				if (ZEPHIR_IS_TRUE_IDENTICAL(&_16$$6)) {
					...
					ZEPHIR_CALL_METHOD(NULL, this_ptr, "adddebug", &_12, 193, &_18$$8);
					zephir_check_call_status();
					RETURN_MM_BOOL(1);
				}
			ZEPHIR_CALL_METHOD(NULL, &namespaces, "next", NULL, 0);
...
PHP_METHOD(Phalcon_Autoload_Loader, checkDirectories)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval dirSeparator;
	zval *directories = NULL, directories_sub, *dirSeparator_param = NULL, directory, *_2, _3, _1$$4, _4$$5, _5$$5, _6$$5, _8$$6, _9$$6, _10$$6;
	zval *this_ptr = getThis();
	...
	if (Z_TYPE_P(directories) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(directories), _2)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$5, "sha1", &_7, 96, &directory);
			zephir_check_call_status();
			zephir_array_update_zval(&results, &_6$$5, &directory, PH_COPY | PH_SEPARATE);
		} ZEND_HASH_FOREACH_END();
	} else {
		ZEPHIR_CALL_METHOD(NULL, directories, "rewind", NULL, 0);
		zephir_check_call_status();
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_fast_trim(&_8$$6, &directory, &dirSeparator, ZEPHIR_TRIM_RIGHT);
				ZEPHIR_INIT_NVAR(&_9$$6);
				ZEPHIR_CONCAT_VV(&_9$$6, &_8$$6, &dirSeparator);
				ZEPHIR_CPY_WRT(&directory, &_9$$6);
				ZEPHIR_CALL_FUNCTION(&_10$$6, "sha1", &_7, 96, &directory);
				zephir_check_call_status();
				zephir_array_update_zval(&results, &_10$$6, &directory, PH_COPY | PH_SEPARATE);
			ZEPHIR_CALL_METHOD(NULL, directories, "next", NULL, 0);
			zephir_check_call_status();
		}
	}
