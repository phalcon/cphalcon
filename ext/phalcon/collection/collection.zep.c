...
ZEPHIR_INIT_CLASS(Phalcon_Collection_Collection) {
	...
	ZEPHIR_REGISTER_CLASS(Phalcon\\Collection, Collection, phalcon, collection_collection, phalcon_collection_collection_method_entry, 0);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_collection_collection_ce, SL("data"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var bool
	 */
	zend_declare_property_bool(phalcon_collection_collection_ce, SL("insensitive"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_collection_collection_ce, SL("lowerKeys"), ZEND_ACC_PROTECTED TSRMLS_CC);

	phalcon_collection_collection_ce->create_object = zephir_init_properties_Phalcon_Collection_Collection;

	zend_class_implements(phalcon_collection_collection_ce TSRMLS_CC, 1, zend_ce_arrayaccess);
	zend_class_implements(phalcon_collection_collection_ce TSRMLS_CC, 1, spl_ce_Countable);
	zend_class_implements(phalcon_collection_collection_ce TSRMLS_CC, 1, zend_ce_aggregate);
	zend_class_implements(phalcon_collection_collection_ce TSRMLS_CC, 1, zephir_get_internal_ce(SL("jsonserializable")));
	zend_class_implements(phalcon_collection_collection_ce TSRMLS_CC, 1, zend_ce_serializable);
	return SUCCESS;
...
PHP_METHOD(Phalcon_Collection_Collection, get) {
	...
	if (EXPECTED(zephir_array_isset(&_2, &element))) {
		...
		zephir_array_fetch(&key, &_3$$4, &element, PH_NOISY | PH_READONLY, "phalcon/Collection/Collection.zep", 147 TSRMLS_CC);
		zephir_read_property(&_4$$4, this_ptr, SL("data"), PH_NOISY_CC | PH_READONLY);
		zephir_array_fetch(&_5$$4, &_4$$4, &key, PH_NOISY | PH_READONLY, "phalcon/Collection/Collection.zep", 149 TSRMLS_CC);
		RETURN_CTOR(&_5$$4);
	}
...
PHP_METHOD(Phalcon_Collection_Collection, init) {
	...
	zephir_is_iterable(&data, 0, "phalcon/Collection/Collection.zep", 191);
...
PHP_METHOD(Phalcon_Collection_Collection, remove) {
	...
	if (UNEXPECTED(zephir_is_true(&_0))) {
		...
		zephir_array_fetch(&key, &lowerKeys, &element, PH_NOISY | PH_READONLY, "phalcon/Collection/Collection.zep", 281 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Collection_Collection, serialize) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 6, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Collection_Collection, unserialize) {
	...
	ZEPHIR_CALL_FUNCTION(&data, "unserialize", NULL, 7, serialized);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "init", NULL, 0, &data);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
