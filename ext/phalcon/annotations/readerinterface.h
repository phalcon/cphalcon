...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_annotations_readerinterface_parse, 0, 0, 0)
	ZEND_ARG_INFO(0, className)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_annotations_readerinterface_parsedocblock, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_annotations_readerinterface_method_entry) {
	...
	PHP_ABSTRACT_ME(Phalcon_Annotations_ReaderInterface, parseDocBlock, arginfo_phalcon_annotations_readerinterface_parsedocblock)
	PHP_FE_END
};
