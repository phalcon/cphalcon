...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, get)
{
	...
	if (zephir_array_isset_value(&_0, &realClassName)) {
		zephir_read_property_cached(&_1$$5, this_ptr, _zephir_prop_0, 98, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_1, 99, PH_NOISY_CC | PH_READONLY);
		_5$$6 = ZEPHIR_GT_LONG(&_4$$6, 0);
		if (_5$$6) {
			zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_0, 98, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_1, 99, PH_NOISY_CC | PH_READONLY);
			_5$$6 = ZEPHIR_LE_LONG(&_7$$6, zephir_fast_count_int(&_6$$6));
		}
		if (_5$$6) {
			ZEPHIR_INIT_VAR(&_8$$7);
			array_init(&_8$$7);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 98, &_8$$7);
		}
		ZEPHIR_INIT_NVAR(&classAnnotations);
		object_init_ex(&classAnnotations, phalcon_annotations_reflection_ce);
		ZEPHIR_CALL_METHOD(NULL, &classAnnotations, "__construct", NULL, 85, &parsedAnnotations);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, getReader)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 100, &_1$$3);
	}
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, setReader)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 100, reader);
}
