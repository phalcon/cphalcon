...
ZEPHIR_INIT_CLASS(Phalcon_Annotations_Adapter_AbstractAdapter)
{
	 ...
	 * @var int
	 */
	zend_declare_property_long(phalcon_annotations_adapter_abstractadapter_ce, SL("annotationsLimit"), 0, ZEND_ACC_PROTECTED);
	/**
	 * @var Reader
	 */
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, get)
{
	...
	zval *className, className_sub, classAnnotations, parsedAnnotations, realClassName, reader, _0, _1$$5, _2$$5, _4$$6, _6$$6, _7$$6, _8$$7;
	...
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("annotationsLimit", 16, 1);
	}
	...
	if (zephir_array_isset_value(&_0, &realClassName)) {
		zephir_read_property_cached(&_1$$5, this_ptr, _zephir_prop_0, 91, PH_NOISY_CC | PH_READONLY);
	...
	if (_3) {
		...
		zephir_check_call_status();
		zephir_read_property_cached(&_4$$6, this_ptr, _zephir_prop_1, 92, PH_NOISY_CC | PH_READONLY);
		_5$$6 = ZEPHIR_GT_LONG(&_4$$6, 0);
		if (_5$$6) {
			zephir_read_property_cached(&_6$$6, this_ptr, _zephir_prop_0, 91, PH_NOISY_CC | PH_READONLY);
			zephir_read_property_cached(&_7$$6, this_ptr, _zephir_prop_1, 92, PH_NOISY_CC | PH_READONLY);
			_5$$6 = ZEPHIR_LE_LONG(&_7$$6, zephir_fast_count_int(&_6$$6));
		}
		if (_5$$6) {
			ZEPHIR_INIT_VAR(&_8$$7);
			array_init(&_8$$7);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 91, &_8$$7);
		}
		ZEPHIR_INIT_NVAR(&classAnnotations);
		object_init_ex(&classAnnotations, phalcon_annotations_reflection_ce);
		ZEPHIR_CALL_METHOD(NULL, &classAnnotations, "__construct", NULL, 82, &parsedAnnotations);
		zephir_check_call_status();
 ...
 */
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, getAnnotationsLimit)
{

	RETURN_MEMBER_TYPED(getThis(), "annotationsLimit", IS_LONG);
}
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, getConstant)
{
	...
	if (!(zephir_array_isset_fetch(&constant, &constants, &constantName_zv, 1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 83);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (Z_TYPE_P(&methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&methods), _1$$3, _2$$3, _0$$3)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_3$$5, "strcasecmp", &_4, 84, &methodKey, &methodName_zv);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_7$$7, "strcasecmp", &_4, 84, &methodKey, &methodName_zv);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, getReader)
{
	...
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("reader", 6, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 93, &_1$$3);
	}
 ...
 */
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, setAnnotationsLimit)
{
	zval *annotationsLimit_param = NULL, _0;
	zend_long annotationsLimit;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&_0);
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("annotationsLimit", 16, 1);
	}

	ZEND_PARSE_PARAMETERS_START(1, 1)
		Z_PARAM_LONG(annotationsLimit)
	ZEND_PARSE_PARAMETERS_END();
...
PHP_METHOD(Phalcon_Annotations_Adapter_AbstractAdapter, setReader)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 93, reader);
}
