...
ZEPHIR_INIT_CLASS(Phalcon_Annotations_Adapter_Apcu) {
	 ...
	 * @var string
	 */
	zend_declare_property_string(phalcon_annotations_adapter_apcu_ce, SL("prefix"), "", ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var int
	 */
	zend_declare_property_long(phalcon_annotations_adapter_apcu_ce, SL("ttl"), 172800, ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Annotations_Adapter_Apcu, read) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_fetch", NULL, 104, &_0);
...
PHP_METHOD(Phalcon_Annotations_Adapter_Apcu, write) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_store", NULL, 107, &_0, data, &_3);
	zephir_check_call_status();
	RETURN_MM();
