...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_annotations_adapter_abstractadapter_getannotationslimit, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_annotations_adapter_abstractadapter_setannotationslimit, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, annotationsLimit, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(phalcon_annotations_adapter_abstractadapter_method_entry) {
	...
	PHP_ME(Phalcon_Annotations_Adapter_AbstractAdapter, getAnnotationsLimit, arginfo_phalcon_annotations_adapter_abstractadapter_getannotationslimit, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Phalcon_Annotations_Adapter_AbstractAdapter, setAnnotationsLimit, arginfo_phalcon_annotations_adapter_abstractadapter_setannotationslimit, ZEND_ACC_PUBLIC)
