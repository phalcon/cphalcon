...
PHP_METHOD(Phalcon_Annotations_Collection, __construct) {
	...
	zval *reflectionData_param = NULL, annotations, annotationData, *_0, _1$$3;
	zval reflectionData;
	...
	zephir_is_iterable(&reflectionData, 0, "phalcon/Annotations/Collection.zep", 60);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionData), _0)
	{
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", &_2, 119, &annotationData);
		zephir_check_call_status();
		zephir_array_append(&annotations, &_1$$3, PH_SEPARATE, "phalcon/Annotations/Collection.zep", 57);
...
PHP_METHOD(Phalcon_Annotations_Collection, get) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *name_param = NULL, annotation, annotations, _0, *_1, _3, _2$$3;
	zval name, _4;
	zval *this_ptr = getThis();
	...
	zephir_is_iterable(&annotations, 0, "phalcon/Annotations/Collection.zep", 100);
	...
	ZEPHIR_INIT_VAR(&_4);
	ZEPHIR_CONCAT_SVS(&_4, "Collection doesn't have an annotation called '", &name, "'");
	ZEPHIR_CALL_METHOD(NULL, &_3, "__construct", NULL, 1, &_4);
	zephir_check_call_status();
	zephir_throw_exception_debug(&_3, "phalcon/Annotations/Collection.zep", 102 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();
	return;
...
PHP_METHOD(Phalcon_Annotations_Collection, getAll) {
	...
	zval found;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *name_param = NULL, annotations, annotation, _0, *_1, _2$$3;
	zval name;
	zval *this_ptr = getThis();
	...
	zephir_read_property(&_0, this_ptr, SL("annotations"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&annotations, &_0);
	zephir_is_iterable(&annotations, 0, "phalcon/Annotations/Collection.zep", 122);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&annotations), _1)
	{
		ZEPHIR_INIT_NVAR(&annotation);
		ZVAL_COPY(&annotation, _1);
