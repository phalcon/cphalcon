...
PHP_METHOD(Phalcon_Annotations_Collection, __construct)
{
	...
	if (Z_TYPE_P(&reflectionData) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionData), _0)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", &_2, 353, &annotationData);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", &_2, 353, &annotationData);
				zephir_check_call_status();
				zephir_array_append(&annotations, &_5$$4, PH_SEPARATE, "phalcon/Annotations/Collection.zep", 56);
		}
	}
	ZEPHIR_INIT_NVAR(&annotationData);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 393, &annotations);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Annotations_Collection, current)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 393, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 394, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Annotations_Collection, get)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_6, "__construct", NULL, 355, &name_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Annotations_Collection, rewind)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 394, &_0);
}
