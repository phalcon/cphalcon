...
PHP_METHOD(Phalcon_Annotations_Collection, __construct)
{
	...
	ZEPHIR_INIT_NVAR(&annotationData);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 398, &annotations);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Annotations_Collection, current)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 398, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 399, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Annotations_Collection, rewind)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 399, &_0);
}
