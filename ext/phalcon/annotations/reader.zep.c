...
PHP_METHOD(Phalcon_Annotations_Reader, parse) {
	...
	ZEPHIR_CALL_METHOD(NULL, reflection, "__construct", NULL, 93, className);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&comment, reflection, "getdoccomment", NULL, 94);
	zephir_check_call_status();
	if (Z_TYPE_P(comment) == IS_STRING) {
		ZEPHIR_INIT_VAR(classAnnotations);
		ZEPHIR_CALL_METHOD(&_0$$3, reflection, "getfilename", NULL, 95);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, reflection, "getstartline", NULL, 96);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&properties, reflection, "getproperties", NULL, 97);
	zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_3$$5, &_2$$5)
			...
			if (Z_TYPE_P(comment) == IS_STRING) {
				...
				ZEPHIR_CALL_METHOD(&_5$$7, reflection, "getfilename", NULL, 95);
				zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&methods, reflection, "getmethods", NULL, 98);
	zephir_check_call_status();
