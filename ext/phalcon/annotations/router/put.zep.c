...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Annotations\\Router, Put, phalcon, annotations_router_put, phalcon_annotations_router_route_ce, phalcon_annotations_router_put_method_entry, 0);
 ...
 */
PHP_METHOD(Phalcon_Annotations_Router_Put, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "PUT");
	ZEPHIR_CALL_PARENT(NULL, phalcon_annotations_router_put_ce, getThis(), "__construct", NULL, 0, &route_zv, &_0, &name_zv, &paths, &converters, beforeMatch);
