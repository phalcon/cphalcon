...
{
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\Annotations\\Router, Connect, phalcon, annotations_router_connect, phalcon_annotations_router_route_ce, phalcon_annotations_router_connect_method_entry, 0);

	{
		zend_attribute *_za = zephir_add_class_attribute(phalcon_annotations_router_connect_ce, SL("Attribute"), 1);
		zval _zc0;
		ZVAL_LONG(&_zc0, 68);
 ...
 */
PHP_METHOD(Phalcon_Annotations_Router_Connect, __construct)
{
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_annotations_router_connect_ce, getThis(), "__construct", NULL, 0, &route_zv, &_0, &name_zv, &paths, &converters, beforeMatch);
