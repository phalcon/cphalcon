...
PHP_METHOD(Phalcon_Annotations_Reflection, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 398, &reflectionData);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Annotations_Reflection, getClassAnnotations)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 398, PH_NOISY_CC | PH_READONLY);
		if (zephir_array_isset_string_fetch(&reflectionClass, &_1$$3, SL("class"), 0)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", NULL, 85, &reflectionClass);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 399, &_2$$4);
		}
	}
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionConstants) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionConstants), _3$$4, _4$$4, _2$$4)
				{
					...
					ZEPHIR_CALL_METHOD(NULL, &_5$$5, "__construct", &_6, 85, &reflectionConstant);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_6, 85, &reflectionConstant);
						zephir_check_call_status();
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionProperties) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionProperties), _3$$4, _4$$4, _2$$4)
				{
					...
					ZEPHIR_INIT_NVAR(&_5$$5);
					object_init_ex(&_5$$5, phalcon_annotations_collection_ce);
					ZEPHIR_CALL_METHOD(NULL, &_5$$5, "__construct", &_6, 85, &reflectionProperty);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_9$$6);
						object_init_ex(&_9$$6, phalcon_annotations_collection_ce);
						ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_6, 85, &reflectionProperty);
						zephir_check_call_status();
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionMethods) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionMethods), _3$$4, _4$$4, _2$$4)
				{
					...
					ZEPHIR_INIT_NVAR(&_5$$5);
					object_init_ex(&_5$$5, phalcon_annotations_collection_ce);
					ZEPHIR_CALL_METHOD(NULL, &_5$$5, "__construct", &_6, 85, &reflectionMethod);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_9$$6);
						object_init_ex(&_9$$6, phalcon_annotations_collection_ce);
						ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_6, 85, &reflectionMethod);
						zephir_check_call_status();
