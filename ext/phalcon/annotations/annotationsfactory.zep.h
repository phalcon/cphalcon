...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_annotations_annotationsfactory_newinstance, 0, 1, IS_OBJECT, "Phalcon\\Annotations\\Adapter\\AdapterInterface", 0)
#endif
#if PHP_VERSION_ID >= 70200
