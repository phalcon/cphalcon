...
PHP_METHOD(Phalcon_Annotations_Annotation, getExpression) {
	...
	HashTable *_2;
	HashPosition _1;
	zval *expr, *value = NULL, *item = NULL, *resolvedItem = NULL, *arrayValue = NULL, *name = NULL, *type, *_0, **_3, *_4, *_5, *_6;
		...
		if (ZEPHIR_IS_LONG(type, 308)) {
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_2, &_1)
				...
				zephir_call_internal_method_p1(resolvedItem, this_ptr, "getexpression", ZEND_MN(Phalcon\\Annotations_Annotation_getExpression), _4);
