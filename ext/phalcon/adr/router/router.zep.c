...
PHP_METHOD(Phalcon_ADR_Router_Router, candidatesFor)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "derivecandidates", NULL, 332, &method_zv, &path_zv);
	zephir_check_call_status();
	ZVAL_LONG(&_1, 0);
	ZEPHIR_RETURN_CALL_FUNCTION("array_column", NULL, 333, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, classFor)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&segments), _3)
	{
		...
		ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "camelize", &_5, 334, &segment);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, match)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&located, this_ptr, "locate", NULL, 336, &method, &path);
	zephir_check_call_status();
	if (Z_TYPE_P(&located) == IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "middlewarefor", NULL, 337, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 338, &_3$$4, &_4$$4, &_5$$4);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "verbs", NULL, 339);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&_7) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_7), _8)
		{
			...
			if (_11$$5) {
				ZEPHIR_CALL_METHOD(&_12$$5, this_ptr, "locate", NULL, 336, &other, &path);
				zephir_check_call_status();
			...
			if (_11$$5) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_13$$6, "__construct", &_14, 340);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_18$$7) {
					ZEPHIR_CALL_METHOD(&_19$$7, this_ptr, "locate", NULL, 336, &other, &path);
					zephir_check_call_status();
				...
				if (_18$$7) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_20$$8, "__construct", &_14, 340);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, methodFor)
{
	...
	ZEPHIR_CALL_METHOD(&verb, this_ptr, "verbof", NULL, 341, &className_zv);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
...
PHP_METHOD(Phalcon_ADR_Router_Router, pathFor)
{
	...
	zephir_memory_observe(&className_zv);
	ZVAL_STR_COPY(&className_zv, className);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "verbof", NULL, 341, &className_zv);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_pop", NULL, 342, &parts);
	ZEPHIR_UNREF(&parts);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_COPY(&part, _4);
			ZEPHIR_CALL_METHOD(&_5$$5, this_ptr, "decamelize", &_6, 343, &part);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_10$$6, this_ptr, "decamelize", &_6, 343, &part);
				zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&part);
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "actionparams", NULL, 344, &className_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, camelize)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "ucwords", NULL, 345, &segment_zv, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
	ZEPHIR_INIT_VAR(&_4);
...
PHP_METHOD(Phalcon_ADR_Router_Router, deriveCandidates)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_METHOD(&segment, this_ptr, "camelize", &_6, 334, &_5$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&candidate);
		ZEPHIR_CONCAT_VSV(&candidate, &subNamespace, "\\", &segment);
		ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "hassubnamespace", &_8, 346, &candidate);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, locate)
{
	...
	zephir_memory_observe(&path_zv);
	ZVAL_STR_COPY(&path_zv, path);
	ZEPHIR_CALL_METHOD(&candidates, this_ptr, "derivecandidates", NULL, 332, &method_zv, &path_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, middlewareFor)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _2, _3, _1)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$3, "strncmp", &_7, 347, &className_zv, &full, &_5$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_13$$5, "strncmp", &_7, 347, &className_zv, &full, &_12$$5);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Router_Router, verbOf)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "strncmp", NULL, 347, &className_zv, &prefix, &_1);
	zephir_check_call_status();
	...
	zephir_fast_explode_str(&parts, SL("\\"), &_3, LONG_MAX);
	ZEPHIR_MAKE_REF(&parts);
	ZEPHIR_CALL_FUNCTION(&last, "array_pop", NULL, 342, &parts);
	ZEPHIR_UNREF(&parts);
	zephir_check_call_status();
	if (ZEPHIR_IS_EMPTY(&parts)) {
		ZEPHIR_INIT_VAR(&_4$$4);
		ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "verbs", NULL, 339);
		zephir_check_call_status();
