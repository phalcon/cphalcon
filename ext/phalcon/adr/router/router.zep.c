...
PHP_METHOD(Phalcon_ADR_Router_Router, classFor)
{
	...
	if (ZEPHIR_IS_EMPTY(&segments)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 367, PH_NOISY_CC | PH_READONLY);
	...
	ZEPHIR_INIT_NVAR(&segment);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 367, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_7);
...
PHP_METHOD(Phalcon_ADR_Router_Router, pathFor)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 367, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Router_Router, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 368, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setMiddlewareMap)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 369, &middlewareMap);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 370, &wordSeparator_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, camelize)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 370, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 370, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Router_Router, deriveCandidates)
{
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 367, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
...
PHP_METHOD(Phalcon_ADR_Router_Router, middlewareFor)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _2, _3, _1)
		{
			...
			ZVAL_COPY(&list, _1);
			zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_1, 367, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_1, 367, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&full);
