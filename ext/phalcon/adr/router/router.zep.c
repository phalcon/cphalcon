...
PHP_METHOD(Phalcon_ADR_Router_Router, classFor)
{
	...
	ZEPHIR_INIT_NVAR(&segment);
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 363, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_7);
...
PHP_METHOD(Phalcon_ADR_Router_Router, pathFor)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 363, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Router_Router, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 364, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setMiddlewareMap)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 365, &middlewareMap);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 366, &wordSeparator_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, deriveCandidates)
{
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 363, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
...
PHP_METHOD(Phalcon_ADR_Router_Router, locate)
{
	...
	zephir_check_call_status();
	zephir_is_iterable(&candidates, 0, "phalcon/ADR/Router/Router.zep", 374);
	if (Z_TYPE_P(&candidates) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&candidates), _0)
		{
			ZEPHIR_INIT_NVAR(&candidate);
			ZVAL_COPY(&candidate, _0);
			zephir_array_fetch_long(&_1$$3, &candidate, 0, PH_NOISY | PH_READONLY, "phalcon/ADR/Router/Router.zep", 369);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_array_fetch_long(&_4$$5, &candidate, 0, PH_NOISY | PH_READONLY, "phalcon/ADR/Router/Router.zep", 369);
...
PHP_METHOD(Phalcon_ADR_Router_Router, middlewareFor)
{
	...
	zephir_is_iterable(&_0, 0, "phalcon/ADR/Router/Router.zep", 390);
...
PHP_METHOD(Phalcon_ADR_Router_Router, verbOf)
{
	...
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "verbs", NULL, 339);
	zephir_check_call_status();
	zephir_is_iterable(&_7, 0, "phalcon/ADR/Router/Router.zep", 427);
	if (Z_TYPE_P(&_7) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_7), _8)
		{
			ZEPHIR_INIT_NVAR(&candidate);
