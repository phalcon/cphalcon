...
PHP_METHOD(Phalcon_ADR_Router_Router, classFor)
{
	...
	if (ZEPHIR_IS_STRING_IDENTICAL(&uri, "")) {
		...
		zephir_fast_explode_str(&segments, SL("/"), &uri, ZEND_LONG_MAX);
	}
	if (ZEPHIR_IS_EMPTY(&segments)) {
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
	...
	zephir_is_iterable(_3, 0, "phalcon/ADR/Router/Router.zep", 143);
	...
	ZEPHIR_INIT_NVAR(&segment);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_9);
...
PHP_METHOD(Phalcon_ADR_Router_Router, match)
{
	...
	if (Z_TYPE_P(&located) == IS_ARRAY) {
		...
		zephir_array_fetch_long(&_3$$4, &located, 0, PH_NOISY, "phalcon/ADR/Router/Router.zep", 162);
	...
	zephir_is_iterable(_8, 0, "phalcon/ADR/Router/Router.zep", 174);
...
PHP_METHOD(Phalcon_ADR_Router_Router, pathFor)
{
	...
	zephir_is_iterable(_4, 0, "phalcon/ADR/Router/Router.zep", 220);
	...
	zephir_is_iterable(_15, 0, "phalcon/ADR/Router/Router.zep", 226);
...
PHP_METHOD(Phalcon_ADR_Router_Router, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 377, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setBaseNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 376, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setMiddlewareMap)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 378, &middlewareMap);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 379, &wordSeparator_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, deriveCandidates)
{
	...
	while (1) {
		...
		zephir_array_append(&parts, &segment, PH_SEPARATE, "phalcon/ADR/Router/Router.zep", 346);
	...
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_0, 376, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
...
PHP_METHOD(Phalcon_ADR_Router_Router, hasSubNamespace)
{
	...
	if (zephir_memnstr_str(&subNamespace_zv, SL(".."), "phalcon/ADR/Router/Router.zep", 369)) {
		RETURN_MM_BOOL(0);
	}
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 377, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	...
	ZEPHIR_RETURN_CALL_FUNCTION("is_dir", NULL, 167, &_4);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_ADR_Router_Router, locate)
{
	...
	zephir_is_iterable(_0, 0, "phalcon/ADR/Router/Router.zep", 408);
	if (Z_TYPE_P(_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_0), _2)
		{
			...
			zephir_array_fetch_long(&_3$$3, &candidate, 0, PH_NOISY, "phalcon/ADR/Router/Router.zep", 392);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_long(&_11$$6, &candidate, 0, PH_NOISY, "phalcon/ADR/Router/Router.zep", 392);
...
PHP_METHOD(Phalcon_ADR_Router_Router, middlewareFor)
{
	...
	zephir_is_iterable(_1, 0, "phalcon/ADR/Router/Router.zep", 427);
	if (Z_TYPE_P(_1) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(_1), _4, _5, _3)
		{
			...
			ZVAL_COPY(&list, _3);
			zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_1, 376, PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_13$$5, this_ptr, _zephir_prop_1, 376, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&full);
...
PHP_METHOD(Phalcon_ADR_Router_Router, verbOf)
{
	...
	zephir_is_iterable(_8, 0, "phalcon/ADR/Router/Router.zep", 464);
	if (Z_TYPE_P(_8) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(_8), _10)
		{
			ZEPHIR_INIT_NVAR(&candidate);
