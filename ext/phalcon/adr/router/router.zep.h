...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_phalcon_adr_router_router_routableunderanotherverb, 0, 1, _IS_BOOL, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_adr_router_router_method_entry) {
	...
	PHP_ME(Phalcon_ADR_Router_Router, routableUnderAnotherVerb, arginfo_phalcon_adr_router_router_routableunderanotherverb, ZEND_ACC_PROTECTED)
