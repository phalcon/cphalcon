...
PHP_METHOD(Phalcon_ADR_Router_RouterMatch, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 357, &action_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 358, &attributes);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 359, &middleware);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 360, name);
	ZEPHIR_MM_RESTORE();
}
