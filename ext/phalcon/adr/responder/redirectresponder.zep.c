...
PHP_METHOD(Phalcon_ADR_Responder_RedirectResponder, __invoke)
{
	...
	zval *request, request_sub, *response, response_sub, *payload, payload_sub, result, _1$$3, _2$$3, _3$$3, _4$$3;
	...
	if (_0) {
		ZEPHIR_CALL_METHOD(&_2$$3, &result, "status", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, response, "setstatuscode", NULL, 0, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_3$$3, &result, "url", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "Location");
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "setheader", NULL, 0, &_4$$3, &_3$$3);
		zephir_check_call_status();
	}
