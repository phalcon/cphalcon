...
PHP_METHOD(Phalcon_ADR_Responder_ChainResponder, __invoke)
{
	...
	zephir_is_iterable(&_0, 0, "phalcon/ADR/Responder/ChainResponder.zep", 45);
...
PHP_METHOD(Phalcon_ADR_Responder_ChainResponder, with)
{
	...
	zephir_array_append(&links, link, PH_SEPARATE, "phalcon/ADR/Responder/ChainResponder.zep", 53);
