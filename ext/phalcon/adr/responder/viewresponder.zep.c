...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 367, renderer);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 368, statusMapper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 369, &template_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __invoke)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 369, PH_NOISY_CC | PH_READONLY);
