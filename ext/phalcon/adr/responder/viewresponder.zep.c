...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 364, renderer);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 365, statusMapper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 366, &template_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __invoke)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 366, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "viewdata", NULL, 332, payload);
