...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 358, renderer);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 359, statusMapper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 360, &template_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __invoke)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_2, 359, PH_NOISY_CC | PH_READONLY);
