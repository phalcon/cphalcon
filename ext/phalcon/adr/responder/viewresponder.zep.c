...
PHP_METHOD(Phalcon_ADR_Responder_ViewResponder, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 373, renderer);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 374, statusMapper);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 375, &template_zv);
	ZEPHIR_MM_RESTORE();
}
