...
PHP_METHOD(Phalcon_ADR_Application, __construct)
{
	...
	if (Z_TYPE_P(container) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(&_1$$3, &_0$$3, "addprovider", NULL, 307, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(container, &_1$$3, "newcontainer", NULL, 0);
		zephir_check_call_status();
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 335, container);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Application, handle)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 335, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 336, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_4, "")) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 336, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setbasenamespace", NULL, 0, &_5$$3);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 337, PH_NOISY_CC | PH_READONLY);
	if (!(ZEPHIR_IS_EMPTY(&_6))) {
		zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_2, 337, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setmiddlewaremap", NULL, 0, &_7$$4);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 338, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_8, "")) {
		zephir_read_property_cached(&_9$$5, this_ptr, _zephir_prop_3, 338, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setactiondirectory", NULL, 0, &_9$$5);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_4, 339, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_10, "")) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_4, 339, PH_NOISY_CC | PH_READONLY);
	...
	/* try_start_1: */
		...
		if (Z_TYPE_P(&match) == IS_NULL) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$8, "__construct", NULL, 308);
			zephir_check_call_status_or_jump(try_end_1);
			zephir_throw_exception_debug(&_12$$8, "phalcon/ADR/Application.zep", 163);
			goto try_end_1;

		}
		zephir_read_property_cached(&_13$$7, this_ptr, _zephir_prop_0, 335, PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("Throwable"))) {
			...
			/* try_start_2: */
				...
				zephir_read_property_cached(&_30$$12, this_ptr, _zephir_prop_0, 335, PH_NOISY_CC | PH_READONLY);
				...
				ZEPHIR_CALL_METHOD(NULL, &_32$$12, "__construct", NULL, 309);
				zephir_check_call_status_or_jump(try_end_2);
			...
			if (EG(exception)) {
				...
				if (zephir_is_instance_of(&_33$$11, SL("Throwable"))) {
					...
					ZEPHIR_CALL_METHOD(&_35$$13, &response, "setstatuscode", NULL, 310, &_36$$13);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Application, secureWith)
{
	...
	if (zephir_array_isset_value(&_0, &prefix_zv)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 337, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Application, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 338, &actionDirectory_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setBaseNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 336, &baseNamespace_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 339, &wordSeparator_zv);
	RETURN_THISW();
}
