...
PHP_METHOD(Phalcon_ADR_Application, __construct)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 1)
		Z_PARAM_OPTIONAL
		Z_PARAM_OBJECT_OF_CLASS_OR_NULL(container, zephir_get_internal_ce(SL("phalcon\\container\\container")))
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 337, container);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Application, handle)
{
	...
	zend_ulong _20$$7;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_23 = NULL, *_24 = NULL, *_28 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *request, request_sub, attributes, dispatcher, events, exception, key, match, response, router, value, _0, _1, _2, _3, _4, _6, _8, _10, _12, _39, _5$$3, _7$$4, _9$$5, _11$$6, _13$$8, _14$$7, _15$$7, _16$$7, _17$$7, _18$$7, *_19$$7, _25$$7, _29$$7, _30$$7, _22$$9, _27$$10, _31$$12, _32$$12, _33$$12, _34$$11, _35$$11, _36$$13, _37$$13, _38$$13;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 337, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\ADR\\Dispatcher");
	ZEPHIR_CALL_METHOD(&dispatcher, &_2, "get", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 337, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\Events\\Manager");
	ZEPHIR_CALL_METHOD(&events, &_3, "get", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 338, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_4, "")) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 338, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setbasenamespace", NULL, 0, &_5$$3);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 339, PH_NOISY_CC | PH_READONLY);
	if (!(ZEPHIR_IS_EMPTY(&_6))) {
		zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_2, 339, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setmiddlewaremap", NULL, 0, &_7$$4);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 340, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_8, "")) {
		zephir_read_property_cached(&_9$$5, this_ptr, _zephir_prop_3, 340, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setactiondirectory", NULL, 0, &_9$$5);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_4, 341, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_10, "")) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_4, 341, PH_NOISY_CC | PH_READONLY);
	...
	/* try_start_1: */
		...
		zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_0, 337, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status_or_jump(try_end_1);
		zephir_is_iterable(&attributes, 0, "phalcon/ADR/Application.zep", 180);
		if (Z_TYPE_P(&attributes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&attributes), _20$$7, _21$$7, _19$$7)
			{
				ZEPHIR_INIT_NVAR(&key);
				if (_21$$7 != NULL) { 
					ZVAL_STR_COPY(&key, _21$$7);
				} else {
					ZVAL_LONG(&key, _20$$7);
				}
				ZEPHIR_INIT_NVAR(&value);
				ZVAL_COPY(&value, _19$$7);
				ZEPHIR_CALL_METHOD(&_22$$9, request, "getattributes", &_23, 0);
				zephir_check_call_status_or_jump(try_end_1);
				ZEPHIR_CALL_METHOD(NULL, &_22$$9, "set", &_24, 0, &key, &value);
				zephir_check_call_status_or_jump(try_end_1);
			} ZEND_HASH_FOREACH_END();
		} else {
			...
			while (1) {
				...
				ZEPHIR_CALL_METHOD(&_25$$7, &attributes, "valid", NULL, 0);
				zephir_check_call_status();
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_27$$10, request, "getattributes", &_28, 0);
					zephir_check_call_status_or_jump(try_end_1);
					ZEPHIR_CALL_METHOD(NULL, &_27$$10, "set", &_24, 0, &key, &value);
					zephir_check_call_status_or_jump(try_end_1);
			}
		}
		ZEPHIR_INIT_NVAR(&value);
		ZEPHIR_INIT_NVAR(&key);
		ZEPHIR_CALL_METHOD(&_29$$7, &match, "getaction", NULL, 0);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_CALL_METHOD(&_30$$7, &match, "getmiddleware", NULL, 0);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_CALL_METHOD(&response, &dispatcher, "dispatch", NULL, 0, &_29$$7, request, &_30$$7);
		zephir_check_call_status_or_jump(try_end_1);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("Throwable"))) {
			...
			/* try_start_2: */
				...
				zephir_read_property_cached(&_31$$12, this_ptr, _zephir_prop_0, 337, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_VAR(&_33$$12);
				ZVAL_STRING(&_33$$12, "Phalcon\\ADR\\ErrorResponder");
				ZEPHIR_CALL_METHOD(&_32$$12, &_31$$12, "get", NULL, 0, &_33$$12);
				zephir_check_call_status_or_jump(try_end_2);
				ZEPHIR_INIT_NVAR(&_33$$12);
				object_init_ex(&_33$$12, phalcon_http_response_ce);
				ZEPHIR_CALL_METHOD(NULL, &_33$$12, "__construct", NULL, 313);
				zephir_check_call_status_or_jump(try_end_2);
				ZEPHIR_CALL_METHOD(&response, &_32$$12, "handle", NULL, 0, request, &_33$$12, &exception);
				zephir_check_call_status_or_jump(try_end_2);
			...
			if (EG(exception)) {
				...
				ZVAL_OBJ(&_34$$11, EG(exception));
				Z_ADDREF_P(&_34$$11);
				ZEPHIR_INIT_VAR(&_35$$11);
				if (zephir_is_instance_of(&_34$$11, SL("Throwable"))) {
					zend_clear_exception();
					ZEPHIR_CPY_WRT(&_35$$11, &_34$$11);
					...
					zephir_check_call_status();
					ZVAL_LONG(&_37$$13, 500);
					ZEPHIR_CALL_METHOD(&_36$$13, &response, "setstatuscode", NULL, 314, &_37$$13);
					zephir_check_call_status();
					ZEPHIR_INIT_VAR(&_38$$13);
					ZVAL_STRING(&_38$$13, "Internal Server Error");
					ZEPHIR_CALL_METHOD(NULL, &_36$$13, "setcontent", NULL, 0, &_38$$13);
					zephir_check_call_status();
				}
			}
		}
	...
	ZEPHIR_INIT_VAR(&_39);
	ZVAL_STRING(&_39, "application:afterHandle");
	ZEPHIR_CALL_METHOD(NULL, &events, "fire", NULL, 0, &_39, this_ptr, &response);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Application, secureWith)
{
	...
	if (zephir_array_isset_value(&_0, &prefix_zv)) {
		...
		zephir_array_fetch(&list, &_1$$3, &prefix_zv, PH_NOISY, "phalcon/ADR/Application.zep", 212);
	}
	zephir_array_append(&list, &guard_zv, PH_SEPARATE, "phalcon/ADR/Application.zep", 215);
...
PHP_METHOD(Phalcon_ADR_Application, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 340, &actionDirectory_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setBaseNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 338, &baseNamespace_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 341, &wordSeparator_zv);
	RETURN_THISW();
}
