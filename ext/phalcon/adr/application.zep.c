...
PHP_METHOD(Phalcon_ADR_Application, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 336, container);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Application, handle)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 336, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\ADR\\Dispatcher");
	ZEPHIR_CALL_METHOD(&dispatcher, &_2, "get", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 336, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\Events\\Manager");
	ZEPHIR_CALL_METHOD(&events, &_3, "get", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 337, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_4, "")) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_1, 337, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setbasenamespace", NULL, 0, &_5$$3);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_2, 338, PH_NOISY_CC | PH_READONLY);
	if (!(ZEPHIR_IS_EMPTY(&_6))) {
		zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_2, 338, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setmiddlewaremap", NULL, 0, &_7$$4);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_3, 339, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_8, "")) {
		zephir_read_property_cached(&_9$$5, this_ptr, _zephir_prop_3, 339, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &router, "setactiondirectory", NULL, 0, &_9$$5);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_10, this_ptr, _zephir_prop_4, 340, PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING_IDENTICAL(&_10, "")) {
		zephir_read_property_cached(&_11$$6, this_ptr, _zephir_prop_4, 340, PH_NOISY_CC | PH_READONLY);
	...
	/* try_start_1: */
		...
		zephir_read_property_cached(&_14$$7, this_ptr, _zephir_prop_0, 336, PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("Throwable"))) {
			...
			/* try_start_2: */
				...
				zephir_read_property_cached(&_32$$12, this_ptr, _zephir_prop_0, 336, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Application, setActionDirectory)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 339, &actionDirectory_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setBaseNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 337, &baseNamespace_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_ADR_Application, setWordSeparator)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 340, &wordSeparator_zv);
	RETURN_THISW();
}
