...
PHP_METHOD(Phalcon_ADR_Dispatcher, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 347, container);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 348, events);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 349, &globalMiddleware);
	ZEPHIR_MM_RESTORE();
}
