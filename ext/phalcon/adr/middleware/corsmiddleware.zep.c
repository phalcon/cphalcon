...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, __invoke)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_4, &_3)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &response, "__construct", NULL, 304);
		zephir_check_call_status();
		ZVAL_LONG(&_5$$4, 204);
		ZEPHIR_CALL_METHOD(NULL, &response, "setstatuscode", NULL, 305, &_5$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 325, &_7$$4, &_6$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 325, &_9$$4, &_7$$4);
		zephir_check_call_status();
		...
		if (ZEPHIR_GT_LONG(&_10$$4, 0)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 325, &_13$$5, &_12$$5);
			zephir_check_call_status();
		}
