...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, __invoke)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_4, &_3)) {
		...
		zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_0, 345, PH_NOISY_CC | PH_READONLY);
		zephir_fast_join_str(&_6$$4, SL(", "), &_5$$4);
		ZEPHIR_INIT_VAR(&_7$$4);
		ZVAL_STRING(&_7$$4, "Access-Control-Allow-Methods");
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 322, &_7$$4, &_6$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 322, &_9$$4, &_7$$4);
		zephir_check_call_status();
		...
		if (ZEPHIR_GT_LONG(&_10$$4, 0)) {
			...
			zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_2, 348, PH_NOISY_CC);
			zephir_cast_to_string(&_12$$5, &_11$$5);
			ZEPHIR_INIT_VAR(&_13$$5);
			ZVAL_STRING(&_13$$5, "Access-Control-Max-Age");
			ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 322, &_13$$5, &_12$$5);
			zephir_check_call_status();
		}
...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, isAllowed)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 344, PH_NOISY_CC | PH_READONLY);
