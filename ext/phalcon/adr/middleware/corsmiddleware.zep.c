...
ZEPHIR_INIT_CLASS(Phalcon_ADR_Middleware_CorsMiddleware)
{
	 ...
	 * @var bool
	 */
	zend_declare_property_bool(phalcon_adr_middleware_corsmiddleware_ce, SL("allowCredentials"), 0, ZEND_ACC_PROTECTED);
	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_adr_middleware_corsmiddleware_ce, SL("allowedHeaders"), ZEND_ACC_PROTECTED);
	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_adr_middleware_corsmiddleware_ce, SL("allowedMethods"), ZEND_ACC_PROTECTED);
	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_adr_middleware_corsmiddleware_ce, SL("allowedOrigins"), ZEND_ACC_PROTECTED);
	/**
	 * @var int
	 */
	zend_declare_property_long(phalcon_adr_middleware_corsmiddleware_ce, SL("maxAge"), 0, ZEND_ACC_PROTECTED);
...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 335, &_0);
	ZEPHIR_INIT_VAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 336, &_1);
	ZEPHIR_INIT_VAR(&_4);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 337, &_4);
	ZEPHIR_INIT_VAR(&_6);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 338, &_6);
	ZEPHIR_INIT_VAR(&_8);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 339, &_8);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, __invoke)
{
	...
	if (ZEPHIR_IS_IDENTICAL(&_4, &_3)) {
		...
		zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_0, 336, PH_NOISY_CC | PH_READONLY);
		zephir_fast_join_str(&_6$$4, SL(", "), &_5$$4);
		ZEPHIR_INIT_VAR(&_7$$4);
		ZVAL_STRING(&_7$$4, "Access-Control-Allow-Methods");
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 302, &_7$$4, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_7$$4);
		zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_1, 337, PH_NOISY_CC | PH_READONLY);
		zephir_fast_join_str(&_7$$4, SL(", "), &_8$$4);
		ZEPHIR_INIT_VAR(&_9$$4);
		ZVAL_STRING(&_9$$4, "Access-Control-Allow-Headers");
		ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 302, &_9$$4, &_7$$4);
		zephir_check_call_status();
		zephir_read_property_cached(&_10$$4, this_ptr, _zephir_prop_2, 339, PH_NOISY_CC | PH_READONLY);
		if (ZEPHIR_GT_LONG(&_10$$4, 0)) {
			zephir_memory_observe(&_11$$5);
			zephir_read_property_cached(&_11$$5, this_ptr, _zephir_prop_2, 339, PH_NOISY_CC);
			zephir_cast_to_string(&_12$$5, &_11$$5);
			ZEPHIR_INIT_VAR(&_13$$5);
			ZVAL_STRING(&_13$$5, "Access-Control-Max-Age");
			ZEPHIR_CALL_METHOD(NULL, &response, "setheader", NULL, 302, &_13$$5, &_12$$5);
			zephir_check_call_status();
		}
...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, applyHeaders)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 338, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Middleware_CorsMiddleware, isAllowed)
{
	...
	zephir_memory_observe(&origin_zv);
	ZVAL_STR_COPY(&origin_zv, origin);
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 335, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "*");
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 335, PH_NOISY_CC | PH_READONLY);
