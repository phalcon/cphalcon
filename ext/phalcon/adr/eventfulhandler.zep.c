...
PHP_METHOD(Phalcon_ADR_EventfulHandler, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 348, action);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 349, events);
}
...
PHP_METHOD(Phalcon_ADR_EventfulHandler, __invoke)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 348, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "adr:beforeExecuteAction");
	ZEPHIR_CALL_METHOD(NULL, &_0, "fire", NULL, 0, &_2, &_1, request);
	zephir_check_call_status();
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 348, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&response, &_3, "__invoke", NULL, 0, request);
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 349, PH_NOISY_CC | PH_READONLY);
