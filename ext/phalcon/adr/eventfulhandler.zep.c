...
PHP_METHOD(Phalcon_ADR_EventfulHandler, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 351, events);
}
...
PHP_METHOD(Phalcon_ADR_EventfulHandler, __invoke)
{
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 351, PH_NOISY_CC | PH_READONLY);
