...
PHP_METHOD(Phalcon_ADR_Input_Input, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 352, &data);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Input_Input, fromArray)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 330, &data);
...
PHP_METHOD(Phalcon_ADR_Input_Input, fromRequest)
{
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "json");
	ZEPHIR_CALL_FUNCTION(&_3, "str_contains", NULL, 331, &_1, &_2);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 330, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_ADR_Input_Input, get)
{
	...
	if (zephir_array_isset_value(&_1, &key_zv)) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 352, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_OBS_NVAR(&_0);
