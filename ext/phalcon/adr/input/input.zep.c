...
PHP_METHOD(Phalcon_ADR_Input_Input, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 348, &data);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_ADR_Input_Input, fromArray)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 327, &data);
...
PHP_METHOD(Phalcon_ADR_Input_Input, fromRequest)
{
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "json");
	ZEPHIR_CALL_FUNCTION(&_3, "str_contains", NULL, 328, &_1, &_2);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_9, "array_merge", NULL, 196, &_5, &_6, &json, &_8);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 327, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
