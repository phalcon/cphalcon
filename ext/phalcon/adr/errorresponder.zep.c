...
PHP_METHOD(Phalcon_ADR_ErrorResponder, __construct)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "defaultmap", NULL, 313);
...
PHP_METHOD(Phalcon_ADR_ErrorResponder, handle)
{
	...
	ZEPHIR_CALL_METHOD(&ref, this_ptr, "correlationid", NULL, 314, request);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&status, this_ptr, "resolvestatus", NULL, 315, exception);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_5);
	...
	ZEPHIR_CALL_METHOD(&_8, &_5, "withstatus", NULL, 316, &status);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "details", NULL, 317, exception, &ref, &status);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_ErrorResponder, correlationId)
{
	...
	if (ZEPHIR_IS_EMPTY(&id)) {
		ZVAL_LONG(&_1$$3, 8);
		ZEPHIR_CALL_FUNCTION(&_2$$3, "random_bytes", NULL, 318, &_1$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&id, "bin2hex", NULL, 319, &_2$$3);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_ADR_ErrorResponder, details)
{
	...
	zephir_create_array(return_value, 2, 0);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "reason", NULL, 320, &status);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_ErrorResponder, resolveStatus)
{
	...
	ZEPHIR_CALL_FUNCTION(&_3, "class_parents", NULL, 321, exception);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_4, "array_values", NULL, 27, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "class_implements", NULL, 322, exception);
	zephir_check_call_status();
