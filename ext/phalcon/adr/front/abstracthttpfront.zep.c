...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 245, &projectRoot_zv);
}
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, boot)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 246, &_1$$3);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 246, PH_NOISY_CC | PH_READONLY);
