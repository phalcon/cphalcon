...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 246, &projectRoot_zv);
}
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, boot)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 247, &_1$$3);
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 247, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadenvironment", NULL, 0, &_2$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 247, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, run)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(&container, this_ptr, "boot", NULL, 216);
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, buildContainer)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 217);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, getApplication)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 218, container);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, handleBootError)
{
	...
	ZEPHIR_CALL_FUNCTION(NULL, "error_log", NULL, 219, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "headers_sent", NULL, 220);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		ZVAL_LONG(&_2$$3, 500);
		ZEPHIR_CALL_FUNCTION(NULL, "http_response_code", NULL, 221, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "Content-Type: text/plain; charset=utf-8");
		ZEPHIR_CALL_FUNCTION(NULL, "header", NULL, 222, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_ADR_Front_AbstractHttpFront, registerProviders)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "provide", NULL, 223, container);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
