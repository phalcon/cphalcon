...
ZEPHIR_INIT_CLASS(phalcon_52__closure)
{
	ZEPHIR_REGISTER_CLASS(phalcon, 52__closure, phalcon, 52__closure, phalcon_52__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	zend_declare_property_null(phalcon_52__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC);
	zend_declare_property_null(phalcon_52__closure_ce, SL("__$zephir_this"), ZEND_ACC_PUBLIC);
	return SUCCESS;
}

PHP_METHOD(phalcon_52__closure, __invoke)
{
