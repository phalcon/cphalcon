...
ZEPHIR_INIT_CLASS(phalcon_41__closure)
{
	...
	zend_declare_property_null(phalcon_41__closure_ce, SL("escaper"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(phalcon_41__closure, __invoke)
{
	...
	zephir_read_static_property_ce(&escaper, phalcon_41__closure_ce, SL("escaper"), PH_NOISY_CC);
