...
{
	ZEPHIR_REGISTER_CLASS(Phalcon\\Container\\Provider, Web, phalcon, container_provider_web, phalcon_container_provider_web_method_entry, 0);

	zend_class_implements(phalcon_container_provider_web_ce, 1, phalcon_contracts_container_service_provider_ce);
	return SUCCESS;
}
...
PHP_METHOD(Phalcon_Container_Provider_Web, provide)
{
	...
	zval *services, services_sub, _0, _1, _2;
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Http\\Response\\Cookies");
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Encryption\\Crypt");
	ZEPHIR_CALL_METHOD(NULL, services, "bind", NULL, 0, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "Phalcon\\Encryption\\Crypt\\CryptInterface");
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Mvc\\Dispatcher");
	ZEPHIR_CALL_METHOD(NULL, services, "bind", NULL, 0, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "Phalcon\\Mvc\\DispatcherInterface");
	...
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Annotations\\Adapter\\Memory");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "Phalcon\\Annotations\\Adapter\\Memory");
	ZEPHIR_CALL_METHOD(NULL, services, "set", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Annotations\\Adapter\\Memory");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "annotationsMemory");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Assets\\Manager");
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_STRING(&_1, "Phalcon\\Assets\\Manager");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "assets");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Flash\\Direct");
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_STRING(&_1, "Phalcon\\Flash\\Direct");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "flash");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Support\\HelperFactory");
	ZEPHIR_INIT_NVAR(&_2);
	...
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\Encryption\\Security\\Security");
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_STRING(&_1, "Phalcon\\Contracts\\Encryption\\Security\\Security");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "security");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Storage\\SerializerFactory");
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_STRING(&_1, "Phalcon\\Storage\\SerializerFactory");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "storageSerializer");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Flash\\Session");
	ZEPHIR_INIT_NVAR(&_2);
	...
	ZVAL_STRING(&_1, "Phalcon\\Flash\\Session");
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "flashSession");
	ZEPHIR_CALL_METHOD(NULL, services, "setalias", NULL, 0, &_1, &_2);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Phalcon\\Support\\Settings");
	ZEPHIR_INIT_NVAR(&_2);
