...
PHP_METHOD(Phalcon_Container_Resolver_Resolver, isResolvableClass)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 222, &className_zv);
...
PHP_METHOD(Phalcon_Container_Resolver_Resolver, resolveCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 219, &closure);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&params, &reflection, "getparameters", NULL, 220);
	zephir_check_call_status();
