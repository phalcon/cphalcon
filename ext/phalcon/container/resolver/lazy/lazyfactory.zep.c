...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, arrayValues)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 501, &values);
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, call)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 502, callableObject);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, csEnv)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, &name_zv, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, envDefault)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 506, &name_zv, defaultValue, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, functionCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 507, &functionName_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, newInstance)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 511, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, staticCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0, &className_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
