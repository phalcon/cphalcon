...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, arrayValues)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 461, &values);
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, call)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 462, callableObject);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, callableGet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 463, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, csEnv)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 465, &name_zv, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, envDefault)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 466, &name_zv, defaultValue, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, functionCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 467, &functionName_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, get)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 468, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, getCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 469, &id_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, newInstance)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 471, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, staticCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 472, &className_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
