...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, arrayValues)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &values);
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, call)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 484, callableObject);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, callableGet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 485, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, callableNew)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 486, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, csEnv)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 487, &name_zv, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, envDefault)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 488, &name_zv, defaultValue, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, functionCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 489, &functionName_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, getCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 491, &id_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, newCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 492, &id_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, staticCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 494, &className_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
