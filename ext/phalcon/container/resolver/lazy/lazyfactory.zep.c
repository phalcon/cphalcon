...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, arrayValues)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 480, &values);
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, call)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 481, callableObject);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, callableGet)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 482, &id_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, csEnv)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 484, &name_zv, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, envDefault)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 485, &name_zv, defaultValue, &type_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, functionCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 486, &functionName_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, getCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 488, &id_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_LazyFactory, staticCall)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 491, &className_zv, &method_zv, &args);
	zephir_check_call_status();
	RETURN_MM();
}
