...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_FunctionCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 498, &functionName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 499, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_FunctionCall, resolve)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 498, PH_NOISY_CC | PH_READONLY);
