...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_FunctionCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 545, &functionName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 546, &arguments);
	ZEPHIR_MM_RESTORE();
}
