...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_StaticCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 561, className);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 562, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 563, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_StaticCall, resolve)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 563, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 562, PH_NOISY_CC);
