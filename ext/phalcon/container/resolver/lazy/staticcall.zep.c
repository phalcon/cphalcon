...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_StaticCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 563, className);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 564, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 565, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_StaticCall, resolve)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 564, PH_NOISY_CC);
