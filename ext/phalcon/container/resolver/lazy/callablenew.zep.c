...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_CallableNew, resolve)
{
	...
	zephir_create_closure_ex(&instance, this_ptr, phalcon_12__closure_ce, SL("__invoke"));
	zephir_update_static_property_ce(phalcon_12__closure_ce, ZEND_STRL("container"), container);
