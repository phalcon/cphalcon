...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_Env, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 158, &varname_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 159, &vartype_zv);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_Env, getEnv)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 158, PH_NOISY_CC | PH_READONLY);
	if (!(zephir_array_key_exists(&envs, &_1))) {
		ZEPHIR_INIT_VAR(&_2$$3);
		object_init_ex(&_2$$3, phalcon_container_exceptions_envnotdefined_ce);
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_0, 158, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 158, PH_NOISY_CC);
