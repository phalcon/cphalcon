...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 539, id);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 540, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 541, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, resolve)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 541, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 540, PH_NOISY_CC);
