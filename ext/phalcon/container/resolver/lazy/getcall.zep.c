...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 549, id);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 550, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 551, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, resolve)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 549, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 550, PH_NOISY_CC);
