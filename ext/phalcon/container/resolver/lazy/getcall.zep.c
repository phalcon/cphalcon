...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 549, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 550, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_GetCall, resolve)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 548, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&id, this_ptr, "resolveargument", NULL, 0, ioc, &_0);
	zephir_check_call_status();
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 550, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC);
