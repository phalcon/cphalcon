...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_CallableGet, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 530, id);
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_CallableGet, resolve)
{
	...
	zephir_create_closure_ex(&instance, this_ptr, phalcon_16__closure_ce, SL("__invoke"));
	zephir_update_static_property_ce(phalcon_16__closure_ce, ZEND_STRL("ioc"), ioc);
