...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_NewCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 510, id);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 511, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 512, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_NewCall, resolve)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 512, PH_NOISY_CC | PH_READONLY);
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_2, 511, PH_NOISY_CC);
