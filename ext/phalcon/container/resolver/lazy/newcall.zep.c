...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_NewCall, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 573, id);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 574, &method_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 575, &arguments);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Resolver_Lazy_NewCall, resolve)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_2, 574, PH_NOISY_CC);
