...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 525, &serviceName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 526, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 527, raw);
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, addTag)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 529, PH_NOISY_CC | PH_READONLY);
	_3 = Z_TYPE_P(&_2) != IS_NULL;
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 529, PH_NOISY_CC | PH_READONLY);
		_3 = (zephir_method_exists_ex(&_4, ZEND_STRL("settag")) == SUCCESS);
	}
	if (_3) {
		zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_1, 529, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_2, 525, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, buildService)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 530, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&factory, &_1$$3);
		ZEPHIR_CALL_ZVAL_FUNCTION(&instance, &factory, NULL, 0, container);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_2$$4);
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 531, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_3$$4) != IS_NULL) {
			ZEPHIR_OBS_NVAR(&_2$$4);
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 531, PH_NOISY_CC);
		} else {
			ZEPHIR_OBS_NVAR(&_2$$4);
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_2, 525, PH_NOISY_CC);
		}
		ZEPHIR_CPY_WRT(&className, &_2$$4);
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_3, 532, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(&args, this_ptr, "resolveargs", NULL, 475, container, &_4$$4);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&instance, &reflection, "newinstanceargs", NULL, 476, &args);
		zephir_check_call_status();
	}
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_4, 533, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, freeze)
{
	...
	if (_3) {
		...
		zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_3, 531, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_9$$4) != IS_NULL) {
			ZEPHIR_OBS_NVAR(&_8$$4);
			zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_3, 531, PH_NOISY_CC);
		} else {
			ZEPHIR_OBS_NVAR(&_8$$4);
			zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_4, 525, PH_NOISY_CC);
		}
		...
		ZEPHIR_CALL_METHOD(NULL, &reflection, "__construct", NULL, 242, &className);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&constructor, &reflection, "getconstructor", NULL, 477);
		zephir_check_call_status();
		...
		if ((zephir_method_exists_ex(container, ZEND_STRL("getresolver")) == SUCCESS)) {
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_2, 535, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_11$$5, &_10$$5, "resolveparameters", NULL, 0, container, &params, &_12$$5);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 532, &_11$$5);
		}
	} else {
		...
		if (_6) {
			...
			zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 535, PH_NOISY_CC);
			_6 = !(ZEPHIR_IS_EMPTY(&_7));
		}
		if (_6) {
			zephir_read_property_cached(&_13$$6, this_ptr, _zephir_prop_2, 535, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 532, &_13$$6);
		}
	}
	if (1) {
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, getClass)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 525, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 478, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, getFactory)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_1, 525, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 479, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, hasExtenders)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 533, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setContainer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 529, container);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setClass)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 531, &className_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setExtenders)
{
	...
	if (Z_TYPE_P(&extenders) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&extenders), _1, _2, _0)
		{
			...
			if (!(zephir_is_callable(&extender))) {
				...
				zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_0, 525, PH_NOISY_CC | PH_READONLY);
				zephir_cast_to_string(&_5$$4, &key);
				ZEPHIR_CALL_METHOD(NULL, &_3$$4, "__construct", &_6, 480, &_4$$4, &_5$$4);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (!(zephir_is_callable(&extender))) {
					...
					zephir_read_property_cached(&_10$$6, this_ptr, _zephir_prop_0, 525, PH_NOISY_CC | PH_READONLY);
					zephir_cast_to_string(&_11$$6, &key);
					ZEPHIR_CALL_METHOD(NULL, &_9$$6, "__construct", &_6, 480, &_10$$6, &_11$$6);
					zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&extender);
	ZEPHIR_INIT_NVAR(&key);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 533, &extenders);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setFactory)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 530, factory);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setLifetime)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 537, &lifetime_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, unsetExtenders)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 533, &_0);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, unsetFactory)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 530, &__$null);
	RETURN_THIS();
}
