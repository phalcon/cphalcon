...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 533, &serviceName_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 534, &type_zv);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 535, raw);
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, addTag)
{
	...
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 537, PH_NOISY_CC | PH_READONLY);
		_3 = (zephir_method_exists_ex(&_4, ZEND_STRL("settag")) == SUCCESS);
	}
	if (_3) {
		zephir_read_property_cached(&_5$$4, this_ptr, _zephir_prop_1, 537, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_6$$4, this_ptr, _zephir_prop_2, 533, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, buildService)
{
	...
	if (zephir_is_true(&_0)) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 538, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CPY_WRT(&factory, &_1$$3);
		ZEPHIR_CALL_ZVAL_FUNCTION(&instance, &factory, NULL, 0, container);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_2$$4);
		zephir_read_property_cached(&_3$$4, this_ptr, _zephir_prop_1, 539, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_3$$4) != IS_NULL) {
			ZEPHIR_OBS_NVAR(&_2$$4);
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_1, 539, PH_NOISY_CC);
		} else {
			ZEPHIR_OBS_NVAR(&_2$$4);
			zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_2, 533, PH_NOISY_CC);
		}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, freeze)
{
	...
	if (_3) {
		...
		zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_3, 539, PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_9$$4) != IS_NULL) {
			ZEPHIR_OBS_NVAR(&_8$$4);
			zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_3, 539, PH_NOISY_CC);
		} else {
			ZEPHIR_OBS_NVAR(&_8$$4);
			zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_4, 533, PH_NOISY_CC);
		}
		...
		if ((zephir_method_exists_ex(container, ZEND_STRL("getresolver")) == SUCCESS)) {
			...
			zephir_check_call_status();
			zephir_read_property_cached(&_12$$5, this_ptr, _zephir_prop_2, 543, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_METHOD(&_11$$5, &_10$$5, "resolveparameters", NULL, 0, container, &params, &_12$$5);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 540, &_11$$5);
		}
	} else {
		zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 534, PH_NOISY_CC | PH_READONLY);
		_6 = ZEPHIR_IS_STRING_IDENTICAL(&_5, "string");
		if (_6) {
			zephir_memory_observe(&_7);
			zephir_read_property_cached(&_7, this_ptr, _zephir_prop_2, 543, PH_NOISY_CC);
			_6 = !(ZEPHIR_IS_EMPTY(&_7));
		}
		if (_6) {
			zephir_read_property_cached(&_13$$6, this_ptr, _zephir_prop_2, 543, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 540, &_13$$6);
		}
	}
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 542, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 542, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, hasExtenders)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 541, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, isCacheable)
{
	...
	if (_1) {
		zephir_read_property_cached(&_2, this_ptr, _zephir_prop_1, 542, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setClass)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 539, &className_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setContainer)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 537, container);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setExtenders)
{
	...
	ZEPHIR_INIT_NVAR(&extender);
	ZEPHIR_INIT_NVAR(&key);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 541, &extenders);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setFactory)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 538, factory);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setIsCacheable)
{
	...
	zephir_check_call_status();
	if (isCacheable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 544, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 544, &__$false);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, setLifetime)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 545, &lifetime_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, unsetClass)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkfrozen", NULL, 0);
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 539, &__$null);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Container_Definition_ServiceDefinition, unsetExtenders)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 541, &_0);
	RETURN_THIS();
}
