...
PHP_METHOD(Phalcon_Container_Definition_Processor_StringProcessor, process)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &def, "__construct", NULL, 333, &name_zv, &_0, definition);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &def, "setclass", NULL, 342, definition);
	zephir_check_call_status();
	ZVAL_BOOL(&_1, 1);
	ZEPHIR_CALL_METHOD(NULL, &def, "setiscacheable", NULL, 341, &_1);
	zephir_check_call_status();
	RETURN_CCTOR(&def);
}
