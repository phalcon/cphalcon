...
PHP_METHOD(Phalcon_Validation, __construct) {
	...
	if (zephir_fast_count_int(validators TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_1$$3, "array_filter", &_2, 458, validators, _0$$3);
		zephir_check_call_status();
		zephir_update_property_this(this_ptr, SL("_validators"), _1$$3 TSRMLS_CC);
		ZEPHIR_INIT_VAR(_3$$3);
		ZEPHIR_INIT_NVAR(_3$$3);
		zephir_create_closure_ex(_3$$3, NULL, phalcon_2__closure_ce, SS("__invoke") TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_4$$3, "array_filter", &_2, 458, validators, _3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation, rules) {
	...
	HashTable *_1, *_5$$7;
	HashPosition _0, _4$$7;
	zval *validators = NULL, *_3$$6 = NULL, *_7$$8 = NULL, *_8$$9 = NULL;
	zval *field, *validators_param = NULL, *validator = NULL, *singleField = NULL, **_2, **_6$$7;
	...
	zephir_is_iterable(validators, &_1, &_0, 0, 0, "phalcon/validation.zep", 269);
	for (
		...
		if (zephir_instance_of_ev(validator, phalcon_validation_validatorinterface_ce TSRMLS_CC)) {
			if (Z_TYPE_P(field) == IS_ARRAY) {
				if (zephir_instance_of_ev(validator, phalcon_validation_combinedfieldsvalidator_ce TSRMLS_CC)) {
					...
					zephir_array_fast_append(_3$$6, field);
					zephir_array_fast_append(_3$$6, validator);
					zephir_update_property_array_append(this_ptr, SL("_combinedFieldsValidators"), _3$$6 TSRMLS_CC);
				} else {
					zephir_is_iterable(field, &_5$$7, &_4$$7, 0, 0, "phalcon/validation.zep", 259);
					for (
					  ; zephir_hash_get_current_data_ex(_5$$7, (void**) &_6$$7, &_4$$7) == SUCCESS
					  ; zephir_hash_move_forward_ex(_5$$7, &_4$$7)
					) {
						ZEPHIR_GET_HVALUE(singleField, _6$$7);
						ZEPHIR_INIT_NVAR(_7$$8);
						zephir_create_array(_7$$8, 2, 0 TSRMLS_CC);
						zephir_array_fast_append(_7$$8, singleField);
						zephir_array_fast_append(_7$$8, validator);
						zephir_update_property_array_append(this_ptr, SL("_validators"), _7$$8 TSRMLS_CC);
					}
				}
			} else if (Z_TYPE_P(field) == IS_STRING) {
				ZEPHIR_INIT_NVAR(_8$$9);
				zephir_create_array(_8$$9, 2, 0 TSRMLS_CC);
				zephir_array_fast_append(_8$$9, field);
				zephir_array_fast_append(_8$$9, validator);
				zephir_update_property_array_append(this_ptr, SL("_validators"), _8$$9 TSRMLS_CC);
			} else {
				ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Field must be passed as array of fields or string", "phalcon/validation.zep", 265);
				return;
			}
		}
	}
...
PHP_METHOD(Phalcon_Validation, setFilters) {
	...
	if (Z_TYPE_P(field) == IS_ARRAY) {
		zephir_is_iterable(field, &_1$$3, &_0$$3, 0, 0, "phalcon/validation.zep", 286);
		for (
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Field must be passed as array of fields or string.", "phalcon/validation.zep", 291);
		return;
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Validation, setEntity) {
	...
	if (Z_TYPE_P(entity) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_validation_exception_ce, "Entity must be an object", "phalcon/validation.zep", 334);
		return;
	}
...
PHP_METHOD(Phalcon_Validation, bind) {
	...
	if (Z_TYPE_P(entity) != IS_OBJECT) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_validation_exception_ce, "Entity must be an object", "phalcon/validation.zep", 464);
		return;
	}
	...
	if (_0) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STRW(phalcon_validation_exception_ce, "Data to validate must be an array or object", "phalcon/validation.zep", 468);
		return;
	}
	zephir_update_property_this(this_ptr, SL("_entity"), entity TSRMLS_CC);
	zephir_update_property_this(this_ptr, SL("_data"), data TSRMLS_CC);
...
PHP_METHOD(Phalcon_Validation, getValue) {
	...
	if (_1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "There is no data to validate", "phalcon/validation.zep", 513);
		return;
	}
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		if (zephir_array_isset(data, field)) {
			ZEPHIR_OBS_NVAR(value);
			zephir_array_fetch(&value, data, field, PH_NOISY, "phalcon/validation.zep", 525 TSRMLS_CC);
		}
	} else {
		...
		if (zephir_array_isset_fetch(&fieldFilters, filters, field, 0 TSRMLS_CC)) {
			if (zephir_is_true(fieldFilters)) {
				...
				if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
					...
					zephir_check_call_status();
					if (Z_TYPE_P(dependencyInjector) != IS_OBJECT) {
						ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "A dependency injector is required to obtain the 'filter' service", "phalcon/validation.zep", 550);
						return;
					}
				}
				...
				if (Z_TYPE_P(filterService) != IS_OBJECT) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_validation_exception_ce, "Returned 'filter' service is invalid", "phalcon/validation.zep", 556);
					return;
				}
...
PHP_METHOD(Phalcon_Validation, preChecking) {
	...
	if (Z_TYPE_P(field) == IS_ARRAY) {
		zephir_is_iterable(field, &_1$$3, &_0$$3, 0, 0, "phalcon/validation.zep", 585);
		for (
		  ; zephir_hash_get_current_data_ex(_1$$3, (void**) &_2$$3, &_0$$3) == SUCCESS
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
		) {
