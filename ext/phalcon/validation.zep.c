...
PHP_METHOD(Phalcon_Validation, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "array_filter", NULL, 229, &validators, &_0);
	...
	ZEPHIR_CALL_FUNCTION(&_3, "array_filter", NULL, 229, &validators, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation, validate) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *data = NULL, data_sub, *entity = NULL, entity_sub, __$null, validators, messages, scope, field, validator, status, combinedFieldsValidators, _0, *_2, *_8, _3$$9, _5$$9, _6$$13, _7$$13, _9$$15, _10$$15, _11$$19, _12$$19, _13$$21;
	zval *this_ptr = getThis();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&validators), _2)
	{
		...
		ZEPHIR_CALL_METHOD(&_3$$9, this_ptr, "prechecking", &_4, 0, &field, &validator);
		zephir_check_call_status();
		if (zephir_is_true(&_3$$9)) {
			continue;
		}
		ZEPHIR_CALL_METHOD(&_5$$9, &validator, "validate", NULL, 0, this_ptr, &field);
		zephir_check_call_status();
		if (ZEPHIR_IS_FALSE_IDENTICAL(&_5$$9)) {
			ZEPHIR_INIT_NVAR(&_7$$13);
			ZVAL_STRING(&_7$$13, "cancelOnFail");
			ZEPHIR_CALL_METHOD(&_6$$13, &validator, "getoption", NULL, 0, &_7$$13);
			zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&combinedFieldsValidators), _8)
	{
		...
		ZEPHIR_CALL_METHOD(&_9$$15, this_ptr, "prechecking", &_4, 0, &field, &validator);
		zephir_check_call_status();
	...
	if ((zephir_method_exists_ex(this_ptr, SL("aftervalidation") TSRMLS_CC) == SUCCESS)) {
		zephir_read_property(&_13$$21, this_ptr, SL("messages"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "aftervalidation", NULL, 0, data, entity, &_13$$21);
		zephir_check_call_status();
	}
