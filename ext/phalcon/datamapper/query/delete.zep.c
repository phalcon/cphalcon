...
PHP_METHOD(Phalcon_DataMapper_Query_Delete, returning)
{
	...
	zephir_array_fetch_string(&_2, &_1, SL("RETURNING"), PH_NOISY, "phalcon/DataMapper/Query/Delete.zep", 71);
...
PHP_METHOD(Phalcon_DataMapper_Query_Delete, getStatement)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 581, PH_NOISY_CC | PH_READONLY);
	zephir_memory_observe(&_2);
	zephir_array_fetch_string(&_2, &_1, SL("FROM"), PH_NOISY, "phalcon/DataMapper/Query/Delete.zep", 86);
	ZEPHIR_INIT_VAR(&_4);
