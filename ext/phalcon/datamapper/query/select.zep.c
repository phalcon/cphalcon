...
PHP_METHOD(Phalcon_DataMapper_Query_Select, __call)
{
	...
	if (EXPECTED(zephir_array_isset_value(&proxied, &method_zv))) {
		...
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 573, PH_NOISY_CC);
	...
	ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 505, &method_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, asAlias)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 574, &asAlias_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, appendJoin)
{
	...
	if (!(ZEPHIR_IS_EMPTY(value))) {
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 575, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_2$$3, type);
		ZEPHIR_CALL_METHOD(&_1$$3, &_0$$3, "bindinline", NULL, 0, value, &_2$$3);
		zephir_check_call_status();
		zephir_concat_self(&condition, &_1$$3);
	}
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_1, 576, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_1, 576, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_1, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, columns)
{
	...
	ZEPHIR_INIT_NVAR(&key);
	ZEPHIR_INIT_VAR(&_7);
	zephir_read_property_cached(&_8, this_ptr, _zephir_prop_0, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, forUpdate)
{
	...
	if (enable) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 577, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 577, &__$false);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, getStatement)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, hasColumns)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, join)
{
	...
	if (!(ZEPHIR_IS_EMPTY(value))) {
		zephir_read_property_cached(&_16$$5, this_ptr, _zephir_prop_0, 575, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_18$$5, type);
		ZEPHIR_CALL_METHOD(&_17$$5, &_16$$5, "bindinline", NULL, 0, value, &_18$$5);
		zephir_check_call_status();
		zephir_concat_self(&condition, &_17$$5);
	}
	zephir_read_property_cached(&_19, this_ptr, _zephir_prop_1, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, reset)
{
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 574, &_0);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 577, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 577, &__$false);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, subSelect)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 573, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 575, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 506, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, getCurrentStatement)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "buildcolumns", NULL, 507);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "buildfrom", NULL, 508);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	zephir_read_property_cached(&_11, this_ptr, _zephir_prop_1, 574, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_12);
	ZVAL_STRING(&_12, "");
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_12, &_11))) {
		zephir_read_property_cached(&_13$$4, this_ptr, _zephir_prop_1, 574, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, buildColumns)
{
	...
	if (!(zephir_is_true(&_0))) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 576, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, buildFrom)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 576, PH_NOISY_CC | PH_READONLY);
