...
PHP_METHOD(Phalcon_DataMapper_Query_Select, __call)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_5, "__construct", NULL, 420, &method_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, subSelect)
{
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 421, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Select, getCurrentStatement)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "buildcolumns", NULL, 422);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "buildfrom", NULL, 423);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
