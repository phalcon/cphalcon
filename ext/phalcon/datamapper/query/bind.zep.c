...
PHP_METHOD(Phalcon_DataMapper_Query_Bind, bindInline)
{
	...
	zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 565, PH_NOISY_CC | PH_READONLY);
	ZVAL_UNDEF(&_4);
...
PHP_METHOD(Phalcon_DataMapper_Query_Bind, remove)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 566, &store);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_Bind, inlineArray)
{
	...
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&data), _0)
		{
			ZEPHIR_INIT_NVAR(&value);
			ZVAL_COPY(&value, _0);
			zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 565, PH_NOISY_CC | PH_READONLY);
			ZVAL_UNDEF(&_2$$3);
			ZVAL_LONG(&_2$$3, (zephir_get_numberval(&_1$$3) + 1));
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 565, &_2$$3);
			zephir_read_property_cached(&_2$$3, this_ptr, _zephir_prop_0, 565, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_INIT_NVAR(&key);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_read_property_cached(&_8$$4, this_ptr, _zephir_prop_0, 565, PH_NOISY_CC | PH_READONLY);
				ZVAL_UNDEF(&_9$$4);
				ZVAL_LONG(&_9$$4, (zephir_get_numberval(&_8$$4) + 1));
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 565, &_9$$4);
				zephir_read_property_cached(&_9$$4, this_ptr, _zephir_prop_0, 565, PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&key);
