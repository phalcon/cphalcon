...
PHP_METHOD(Phalcon_DataMapper_Query_QueryFactory, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 572, &selectClass);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_QueryFactory, newDelete)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 504, connection, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_QueryFactory, newInsert)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "newbind", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 505, connection, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_DataMapper_Query_QueryFactory, newUpdate)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "newbind", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 506, connection, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
