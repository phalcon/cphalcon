...
PHP_METHOD(Phalcon_DataMapper_Query_Insert, column)
{
	...
	if (Z_TYPE_P(value) != IS_NULL) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_0, 525, PH_NOISY_CC | PH_READONLY);
		ZVAL_LONG(&_2$$3, type);
...
PHP_METHOD(Phalcon_DataMapper_Query_Insert, getStatement)
{
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "buildcolumns", NULL, 450);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Query_Insert, buildColumns)
{
	...
	zephir_read_property_cached(&_15, this_ptr, _zephir_prop_0, 527, PH_NOISY_CC | PH_READONLY);
