...
PHP_METHOD(Phalcon_DataMapper_Query_Insert, getStatement)
{
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "buildcolumns", NULL, 327);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Query_Insert, buildColumns)
{
	...
	zend_ulong _4;
	zval columns;
	zval column, _0, _1, _2, *_3, _8, _10, _11, _12, _13, _14, _15, _16, _17, _6$$3, _9$$4;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	...
	ZEPHIR_CALL_FUNCTION(&_16, "array_values", NULL, 27, &_15);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_17);
	ZVAL_STRING(&_17, ",");
