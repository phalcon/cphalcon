...
PHP_METHOD(Phalcon_DataMapper_Query_AbstractConditions, appendCondition)
{
	...
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
	...
	zephir_check_call_status();
	zephir_read_property_cached(&_6, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_AbstractConditions, buildLimitCommon)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
	...
	if (!ZEPHIR_IS_LONG_IDENTICAL(&_6, 0)) {
		zephir_read_property_cached(&_7$$4, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_AbstractConditions, buildLimitEarly)
{
	...
	if (_3) {
		zephir_read_property_cached(&_4, this_ptr, _zephir_prop_1, 105, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&_5);
	...
	_6 = _3;
	if (_6) {
		zephir_read_property_cached(&_7, this_ptr, _zephir_prop_1, 105, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&_8);
	...
	if (_6) {
		zephir_read_property_cached(&_9$$3, this_ptr, _zephir_prop_1, 105, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_AbstractConditions, buildLimitSqlsrv)
{
	...
	if (_2) {
		zephir_read_property_cached(&_3, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
	...
	if (_2) {
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Query_AbstractConditions, processValue)
{
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		...
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 105, PH_NOISY_CC | PH_READONLY);
