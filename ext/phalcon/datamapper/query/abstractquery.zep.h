...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_reset, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetcolumns, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetfrom, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetwhere, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetgroupby, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resethaving, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetorderby, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetlimit, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_phalcon_datamapper_query_abstractquery_resetflags, 0, 0, Phalcon\\DataMapper\\Query\\AbstractQuery, 0)
ZEND_END_ARG_INFO()
