...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, __construct)
{
	...
	if (!(zephir_array_isset_value(&available, &_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 446, &_2$$3);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, __debugInfo)
{
	...
	zephir_array_fast_append(&_0, &_2);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 511, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_OBS_NVAR(&_2);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, connect)
{
	...
	if (!(zephir_is_true(&_0))) {
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 512, &_2$$3);
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_1, 513, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, disconnect)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 512, &__$null);
