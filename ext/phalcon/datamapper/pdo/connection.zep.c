...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, __debugInfo)
{
	...
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 549, PH_NOISY_CC | PH_READONLY);
	...
	ZVAL_STRING(&_3, "****");
	zephir_array_fast_append(&_0, &_3);
	zephir_read_property_cached(&_4, this_ptr, _zephir_prop_0, 549, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_OBS_NVAR(&_2);
	zephir_array_fetch_long(&_2, &_4, 3, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 103);
	zephir_array_fast_append(&_0, &_2);
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 549, PH_NOISY_CC | PH_READONLY);
	ZEPHIR_OBS_NVAR(&_2);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, connect)
{
	...
	if (!(zephir_is_true(&_0))) {
		zephir_read_property_cached(&_1$$3, this_ptr, _zephir_prop_1, 551, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "connect");
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "start", NULL, 0, &_2$$3);
		zephir_check_call_status();
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&dsn);
		zephir_array_fetch_long(&dsn, &_3$$3, 0, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 120);
		zephir_read_property_cached(&_4$$3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&username);
		zephir_array_fetch_long(&username, &_4$$3, 1, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 121);
		zephir_read_property_cached(&_5$$3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&password);
		zephir_array_fetch_long(&password, &_5$$3, 2, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 122);
		zephir_read_property_cached(&_6$$3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&options);
		zephir_array_fetch_long(&options, &_6$$3, 3, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 123);
		zephir_read_property_cached(&_7$$3, this_ptr, _zephir_prop_2, 549, PH_NOISY_CC | PH_READONLY);
		zephir_memory_observe(&queries);
		zephir_array_fetch_long(&queries, &_7$$3, 4, PH_NOISY, "phalcon/DataMapper/Pdo/Connection.zep", 124);
		ZEPHIR_INIT_NVAR(&_2$$3);
		object_init_ex(&_2$$3, php_pdo_get_dbh_ce());
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 0, &dsn, &username, &password, &options);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 550, &_2$$3);
		zephir_read_property_cached(&_8$$3, this_ptr, _zephir_prop_1, 551, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "finish", NULL, 0);
		zephir_check_call_status();
		zephir_is_iterable(&queries, 0, "phalcon/DataMapper/Pdo/Connection.zep", 134);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection, disconnect)
{
	...
	zephir_check_call_status();
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 550, &__$null);
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 551, PH_NOISY_CC | PH_READONLY);
