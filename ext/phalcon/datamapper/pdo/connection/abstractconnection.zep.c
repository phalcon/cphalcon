...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, __call)
{
	...
	if (!((zephir_method_exists(&_0, name)  == SUCCESS))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 162, &message);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, exec)
{
	...
	/* try_start_1: */
		...
		zephir_read_property(&_2$$3, this_ptr, ZEND_STRL("pdo"), PH_NOISY_CC | PH_READONLY);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			...
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "canreconnect", NULL, 163, &e);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "reconnect", NULL, 164);
			zephir_check_call_status();
	...
	zephir_read_property(&_5, this_ptr, ZEND_STRL("profiler"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, perform)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(&sth, this_ptr, "performstatement", NULL, 165, &statement_zv, &values);
		zephir_check_call_status_or_jump(try_end_1);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			zend_clear_exception();
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "canreconnect", NULL, 163, &e);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, prepare)
{
	...
	zephir_read_property(&_5, this_ptr, ZEND_STRL("profiler"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_6, &sth, ZEND_STRL("queryString"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, query)
{
	...
	/* try_start_1: */
		...
		zephir_read_property(&_3$$3, this_ptr, ZEND_STRL("pdo"), PH_NOISY_CC);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			zend_clear_exception();
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "canreconnect", NULL, 163, &e);
			zephir_check_call_status();
			...
			zephir_read_property(&_7$$4, this_ptr, ZEND_STRL("pdo"), PH_NOISY_CC);
	...
	zephir_read_property(&_9, this_ptr, ZEND_STRL("profiler"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_10, &sth, ZEND_STRL("queryString"), PH_NOISY_CC | PH_READONLY);
