...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, __call) {
	...
	ZEPHIR_OBS_VAR(&_3);
	zephir_read_property(&_3, this_ptr, SL("pdo"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, beginTransaction) {
	...
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, SL("pdo"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&result, &_2, "begintransaction", NULL, 0);
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, SL("profiler"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, isConnected) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, SL("pdo"), PH_NOISY_CC);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, perform) {
	...
	zephir_check_call_status();
	zephir_read_property(&_7, this_ptr, SL("profiler"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, prepare) {
	...
	zephir_check_call_status();
	zephir_read_property(&_3, this_ptr, SL("profiler"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_4, &sth, SL("queryString"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, query) {
	...
	zephir_check_call_status();
	zephir_read_property(&_4, this_ptr, SL("profiler"), PH_NOISY_CC | PH_READONLY);
	zephir_read_property(&_5, &sth, SL("queryString"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, quote) {
	...
	if (Z_TYPE_P(&element) != IS_ARRAY) {
		zephir_get_strval(&_0$$3, &element);
	...
	if (Z_TYPE_P(value) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(value), _5, _6, _3)
		{
			...
			zephir_get_strval(&_7$$4, &element);
		...
		while (1) {
			...
			zephir_check_call_status();
				zephir_get_strval(&_11$$5, &element);
