...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, __call)
{
	...
	if (!((zephir_method_exists(&_0, name)  == SUCCESS))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 157, &message);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, exec)
{
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			...
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "canreconnect", NULL, 158, &e);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "reconnect", NULL, 159);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, perform)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(&sth, this_ptr, "performstatement", NULL, 160, &statement_zv, &values);
		zephir_check_call_status_or_jump(try_end_1);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			zend_clear_exception();
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "canreconnect", NULL, 158, &e);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Connection_AbstractConnection, query)
{
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("PDOException"))) {
			zend_clear_exception();
			ZEPHIR_CPY_WRT(&e, &_1);
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "canreconnect", NULL, 158, &e);
			zephir_check_call_status();
