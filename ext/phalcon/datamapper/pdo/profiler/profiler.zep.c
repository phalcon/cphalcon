...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 525, logger);
	ZEPHIR_INIT_NVAR(&_0);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 526, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, finish)
{
	...
	if (UNEXPECTED(zephir_is_true(&_0))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&finish, "hrtime", NULL, 455, &__$true);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, &ex, "gettraceasstring", NULL, 456);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "backtrace");
		zephir_update_property_array(this_ptr, SL("context"), &_2$$3, &_1$$3);
		zephir_read_property_cached(&_3$$3, this_ptr, _zephir_prop_1, 528, PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_EMPTY(&values)) {
			...
			zephir_read_property_cached(&_9$$3, this_ptr, _zephir_prop_2, 526, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_11$$3, this_ptr, _zephir_prop_3, 525, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_12$$3, this_ptr, _zephir_prop_4, 524, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_13$$3, this_ptr, _zephir_prop_5, 523, PH_NOISY_CC | PH_READONLY);
		zephir_read_property_cached(&_14$$3, this_ptr, _zephir_prop_1, 528, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_METHOD(NULL, &_11$$3, "log", NULL, 0, &_12$$3, &_13$$3, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_15$$3);
		array_init(&_15$$3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 528, &_15$$3);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, getLogLevel)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 524, PH_NOISY_CC);
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, setLogFormat)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 523, &logFormat_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, setLogLevel)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 524, &logLevel_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_DataMapper_Pdo_Profiler_Profiler, start)
{
	...
	if (UNEXPECTED(zephir_is_true(&_0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$3, "hrtime", NULL, 455, &__$true);
		zephir_check_call_status();
		zephir_array_update_string(&_1$$3, SL("start"), &_2$$3, PH_COPY | PH_SEPARATE);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 528, &_1$$3);
	}
	ZEPHIR_MM_RESTORE();
}
