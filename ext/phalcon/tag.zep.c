...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	if (zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "iconv", NULL, 501, &_3$$3, &_4$$3, &text);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "iconv");
	ZEPHIR_CALL_FUNCTION(&_17, "extension_loaded", NULL, 174, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag, textArea) {
	...
	ZEPHIR_CALL_SELF(&code, "renderattributes", NULL, 0, &_1, &params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "htmlspecialchars", NULL, 228, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
