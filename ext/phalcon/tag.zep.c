...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 451, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfieldchecked", &_0, 452, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 451, &_1, parameters, &_2);
	zephir_check_call_status();
	RETURN_MM();
