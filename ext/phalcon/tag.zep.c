...
PHP_METHOD(Phalcon_Tag, getUrlService) {
	...
	zval url, dependencyInjector, _0$$3, _2$$3, _3$$3;
	int ZEPHIR_LAST_CALL_STATUS;
	...
	if (Z_TYPE_P(&url) != IS_OBJECT) {
		zephir_read_static_property_ce(&_0$$3, phalcon_tag_ce, SL("_dependencyInjector"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Tag, getEscaperService) {
	...
	zval escaper, dependencyInjector, _0$$3, _2$$3, _3$$3;
	int ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_1 = NULL;
	ZEPHIR_INIT_THIS();
...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 436, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfieldchecked", &_0, 437, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 436, &_1, parameters, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, selectStatic) {
	...
	ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_tag_select_ce, "selectfield", &_0, 215, parameters, data);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	if (zephir_is_true(&_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", &_5, 438, &_3$$3, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_6$$3);
		ZVAL_STRING(&_6$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_7$$3, "iconv", NULL, 392, &_4$$3, &_6$$3, &text);
		zephir_check_call_status();
	...
	if (zephir_is_true(replace)) {
		...
		if (Z_TYPE_P(replace) == IS_ARRAY) {
			zephir_is_iterable(replace, 0, "phalcon/tag.zep", 1369);
	...
	ZEPHIR_INIT_VAR(&_14);
	ZVAL_STRING(&_14, "");
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", &_15, 29, &_0, &_14, &text);
	zephir_check_call_status();
	if (lowercase) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_17, "preg_replace", &_15, 29, &_0, &separator, &friendly);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_17)) {
		ZVAL_LONG(&_18$$10, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", &_5, 438, &_18$$10, &locale);
		zephir_check_call_status();
	}
