...
PHP_METHOD(Phalcon_Tag, getDI) {
	...
	if (Z_TYPE_P(di) != IS_OBJECT) {
		ZEPHIR_CALL_CE_STATIC(&di, phalcon_di_ce, "getdefault", &_0, 115);
		zephir_check_call_status();
	}
	RETURN_CCTOR(di);
...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 323, _1, parameters);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("_inputfieldchecked", &_0, 324, _1, parameters);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZEPHIR_INIT_VAR(_2);
	ZVAL_BOOL(_2, 1);
	ZEPHIR_RETURN_CALL_SELF("_inputfield", &_0, 323, _1, parameters, _2);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, selectStatic) {
	...
	ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_tag_select_ce, "selectfield", &_0, 147, parameters, data);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", &_2, 58, &_0);
	zephir_check_call_status();
	if (zephir_is_true(_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", &_4, 325, &_0, &_3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "UTF-8", 0);
		ZEPHIR_SINIT_NVAR(_3);
		ZVAL_STRING(&_3, "ASCII//TRANSLIT", 0);
		ZEPHIR_CALL_FUNCTION(&_5, "iconv", NULL, 295, &_0, &_3, text);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", &_13, 77, _11, _12, text);
	...
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", &_13, 77, _11, separator, friendly);
	zephir_check_temp_parameter(_11);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_5, "extension_loaded", &_2, 58, &_3);
	zephir_check_call_status();
	if (zephir_is_true(_5)) {
		ZEPHIR_SINIT_NVAR(_3);
		ZVAL_LONG(&_3, 0);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", &_4, 325, &_3, locale);
		zephir_check_call_status();
	}
