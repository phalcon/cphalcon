...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	if (zephir_is_true(_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", &_5, 412, &_3$$3, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_3$$3);
		ZVAL_STRING(&_3$$3, "UTF-8", 0);
		ZEPHIR_SINIT_NVAR(_4$$3);
		ZVAL_STRING(&_4$$3, "ASCII//TRANSLIT", 0);
		ZEPHIR_CALL_FUNCTION(&_6$$3, "iconv", NULL, 369, &_3$$3, &_4$$3, text);
		zephir_check_call_status();
	...
	if (zephir_is_true(_19)) {
		...
		ZVAL_LONG(&_20$$10, 0);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", &_5, 412, &_20$$10, locale);
		zephir_check_call_status();
	}
