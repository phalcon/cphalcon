...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", &_13, 27, _11, _12, text);
	...
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", &_13, 27, _11, separator, friendly);
	zephir_check_temp_parameter(_11);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_5, "extension_loaded", &_2, 124, &_3);
	zephir_check_call_status();
