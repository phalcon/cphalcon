...
PHP_METHOD(Phalcon_Traits_Factory_FactoryTrait, getCachedInstance)
{
	...
	zephir_read_property_cached(&_2, this_ptr, _zephir_prop_0, 1387, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Traits_Factory_FactoryTrait, getService)
{
	...
	zephir_read_property_cached(&_5, this_ptr, _zephir_prop_0, 1388, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Traits_Factory_FactoryTrait, init)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 1388, &_0);
	ZEPHIR_MM_RESTORE();
}
