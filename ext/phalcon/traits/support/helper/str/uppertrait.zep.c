...
{
	ZEPHIR_REGISTER_TRAIT(Phalcon\\Traits\\Support\\Helper\\Str, UpperTrait, phalcon, traits_support_helper_str_uppertrait, phalcon_traits_support_helper_str_uppertrait_method_entry);
