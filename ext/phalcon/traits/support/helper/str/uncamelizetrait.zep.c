...
{
	ZEPHIR_REGISTER_TRAIT(Phalcon\\Traits\\Support\\Helper\\Str, UncamelizeTrait, phalcon, traits_support_helper_str_uncamelizetrait, phalcon_traits_support_helper_str_uncamelizetrait_method_entry);
