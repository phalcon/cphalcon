...
{
	ZEPHIR_REGISTER_TRAIT(Phalcon\\Traits\\Support\\Helper\\Str, LowerTrait, phalcon, traits_support_helper_str_lowertrait, phalcon_traits_support_helper_str_lowertrait_method_entry);
