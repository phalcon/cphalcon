...
{
	ZEPHIR_REGISTER_TRAIT(Phalcon\\Traits\\Support\\Helper\\Str, InterpolateTrait, phalcon, traits_support_helper_str_interpolatetrait, phalcon_traits_support_helper_str_interpolatetrait_method_entry);
