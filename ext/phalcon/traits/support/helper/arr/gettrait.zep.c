...
{
	ZEPHIR_REGISTER_TRAIT(Phalcon\\Traits\\Support\\Helper\\Arr, GetTrait, phalcon, traits_support_helper_arr_gettrait, phalcon_traits_support_helper_arr_gettrait_method_entry);
