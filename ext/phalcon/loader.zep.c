...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "is_file", &_6, 299, &filePath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	zephir_is_iterable(&namespaces, 0, "phalcon/loader.zep", 391);
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _3, _4, _2)
	{
		...
		zephir_is_iterable(&directories, 0, "phalcon/loader.zep", 386);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _8$$6)
		{
			...
			zephir_is_iterable(&extensions, 0, "phalcon/loader.zep", 385);
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _10$$9)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_13$$10, "is_file", &_14, 299, &filePath);
				zephir_check_call_status();
	...
	zephir_is_iterable(&directories, 0, "phalcon/loader.zep", 446);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _18)
	{
		...
		zephir_is_iterable(&extensions, 0, "phalcon/loader.zep", 441);
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _20$$14)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_23$$15, "is_file", &_14, 299, &filePath);
			zephir_check_call_status();
