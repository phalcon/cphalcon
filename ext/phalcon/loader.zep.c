...
ZEPHIR_INIT_CLASS(Phalcon_Loader) {
	...
	zend_declare_property_null(phalcon_loader_ce, SL("checkedPath"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("classes"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("directories"), ZEND_ACC_PROTECTED TSRMLS_CC);

	zend_declare_property_null(phalcon_loader_ce, SL("eventsManager"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("extensions"), ZEND_ACC_PROTECTED TSRMLS_CC);
	 ...
	 * @var array
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("files"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var bool
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("foundPath"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var array
	 */
	zend_declare_property_null(phalcon_loader_ce, SL("namespaces"), ZEND_ACC_PROTECTED TSRMLS_CC);

	/**
	 * @var bool
	 */
	zend_declare_property_bool(phalcon_loader_ce, SL("registered"), 0, ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	zephir_read_property(&_0, this_ptr, SL("classes"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&classes, &_0);
	ZEPHIR_OBS_VAR(&filePath);
	if (zephir_array_isset_fetch(&filePath, &classes, &className, 0 TSRMLS_CC)) {
		if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
			zephir_update_property_zval(this_ptr, SL("foundPath"), &filePath);
	...
	ZEPHIR_INIT_VAR(&ns);
	ZVAL_STRING(&ns, "\\");
	zephir_read_property(&_0, this_ptr, SL("namespaces"), PH_NOISY_CC | PH_READONLY);
	...
	zephir_is_iterable(&namespaces, 0, "phalcon/Loader.zep", 196);
	if (Z_TYPE_P(&namespaces) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _5, _6, _3)
		{
			...
			zephir_fast_str_replace(&_9$$6, &ns, &ds, &fileName TSRMLS_CC);
			ZEPHIR_CPY_WRT(&fileName, &_9$$6);
			zephir_is_iterable(&directories, 0, "phalcon/Loader.zep", 191);
			if (Z_TYPE_P(&directories) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _10$$6)
				{
					...
					zephir_is_iterable(&extensions, 0, "phalcon/Loader.zep", 190);
					if (Z_TYPE_P(&extensions) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _13$$9)
						{
							...
							if (Z_TYPE_P(&eventsManager) == IS_OBJECT) {
								zephir_update_property_zval(this_ptr, SL("checkedPath"), &filePath);
							...
							ZEPHIR_CALL_FUNCTION(&_17$$10, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								ZEPHIR_CALL_FUNCTION(&_23$$14, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						zephir_fast_trim(&_26$$18, &directory, &ds, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
						ZEPHIR_INIT_NVAR(&fixedDirectory);
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _27$$18)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_31$$19, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_36$$23, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_fast_str_replace(&_41$$27, &ns, &ds, &fileName TSRMLS_CC);
				...
				if (Z_TYPE_P(&directories) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _42$$27)
					{
						...
						zephir_fast_trim(&_44$$30, &directory, &ds, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
						ZEPHIR_INIT_NVAR(&fixedDirectory);
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _45$$30)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_49$$31, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_54$$35, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							zephir_fast_trim(&_57$$39, &directory, &ds, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
							ZEPHIR_INIT_NVAR(&fixedDirectory);
							...
							if (Z_TYPE_P(&extensions) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _58$$39)
								{
									...
									ZEPHIR_CALL_FUNCTION(&_62$$40, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										ZEPHIR_CALL_FUNCTION(&_67$$44, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
										zephir_check_call_status();
	...
	zephir_is_iterable(&directories, 0, "phalcon/Loader.zep", 254);
	if (Z_TYPE_P(&directories) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _70)
		{
			...
			zephir_fast_trim(&_72$$48, &directory, &ds, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
			ZEPHIR_INIT_NVAR(&fixedDirectory);
			ZEPHIR_CONCAT_VV(&fixedDirectory, &_72$$48, &ds);
			zephir_is_iterable(&extensions, 0, "phalcon/Loader.zep", 249);
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _73$$48)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_77$$49, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_82$$53, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_fast_trim(&_85$$57, &directory, &ds, ZEPHIR_TRIM_RIGHT TSRMLS_CC);
				ZEPHIR_INIT_NVAR(&fixedDirectory);
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _86$$57)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_90$$58, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_95$$62, "call_user_func", &_18, 203, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	zephir_is_iterable(&_0, 0, "phalcon/Loader.zep", 365);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			zephir_read_property(&_3$$3, this_ptr, SL("eventsManager"), PH_NOISY_CC);
			if (Z_TYPE_P(&_3$$3) == IS_OBJECT) {
				zephir_update_property_zval(this_ptr, SL("checkedPath"), &filePath);
				zephir_read_property(&_4$$4, this_ptr, SL("eventsManager"), PH_NOISY_CC | PH_READONLY);
				ZEPHIR_INIT_NVAR(&_5$$4);
				ZVAL_STRING(&_5$$4, "loader:beforeCheckPath");
				ZEPHIR_CALL_METHOD(NULL, &_4$$4, "fire", NULL, 0, &_5$$4, this_ptr, &filePath);
				zephir_check_call_status();
			}
			ZEPHIR_CALL_FUNCTION(&_6$$3, "call_user_func", &_7, 203, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
			if (zephir_is_true(&_6$$3)) {
				ZEPHIR_OBS_NVAR(&_8$$5);
				zephir_read_property(&_8$$5, this_ptr, SL("eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_8$$5) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, SL("foundPath"), &filePath);
					zephir_read_property(&_9$$6, this_ptr, SL("eventsManager"), PH_NOISY_CC | PH_READONLY);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_read_property(&_11$$7, this_ptr, SL("eventsManager"), PH_NOISY_CC);
				if (Z_TYPE_P(&_11$$7) == IS_OBJECT) {
					zephir_update_property_zval(this_ptr, SL("checkedPath"), &filePath);
					zephir_read_property(&_12$$8, this_ptr, SL("eventsManager"), PH_NOISY_CC | PH_READONLY);
					ZEPHIR_INIT_NVAR(&_13$$8);
					ZVAL_STRING(&_13$$8, "loader:beforeCheckPath");
					ZEPHIR_CALL_METHOD(NULL, &_12$$8, "fire", NULL, 0, &_13$$8, this_ptr, &filePath);
					zephir_check_call_status();
				}
				ZEPHIR_CALL_FUNCTION(&_14$$7, "call_user_func", &_7, 203, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
				if (zephir_is_true(&_14$$7)) {
					ZEPHIR_OBS_NVAR(&_15$$9);
					zephir_read_property(&_15$$9, this_ptr, SL("eventsManager"), PH_NOISY_CC);
					if (Z_TYPE_P(&_15$$9) == IS_OBJECT) {
						zephir_update_property_zval(this_ptr, SL("foundPath"), &filePath);
						zephir_read_property(&_16$$10, this_ptr, SL("eventsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Loader, register) {
	...
	zephir_read_property(&_0, this_ptr, SL("registered"), PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 372, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Loader, registerClasses) {
	...
	if (merge) {
		...
		zephir_read_property(&_1$$3, this_ptr, SL("classes"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &classes TSRMLS_CC);
		zephir_update_property_zval(this_ptr, SL("classes"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, SL("classes"), &classes);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, registerDirs) {
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property(&_1$$3, this_ptr, SL("directories"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &directories TSRMLS_CC);
		zephir_update_property_zval(this_ptr, SL("directories"), &_0$$3);
	} else {
		zephir_update_property_zval(this_ptr, SL("directories"), &directories);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, registerFiles) {
	...
	if (merge) {
		ZEPHIR_INIT_VAR(&_0$$3);
		zephir_read_property(&_1$$3, this_ptr, SL("files"), PH_NOISY_CC | PH_READONLY);
		zephir_fast_array_merge(&_0$$3, &_1$$3, &files TSRMLS_CC);
		zephir_update_property_zval(this_ptr, SL("files"), &_0$$3);
	} else {
...
PHP_METHOD(Phalcon_Loader, registerNamespaces) {
	...
	zephir_check_call_status();
	if (merge) {
		zephir_is_iterable(&preparedNamespaces, 0, "phalcon/Loader.zep", 456);
		if (Z_TYPE_P(&preparedNamespaces) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&preparedNamespaces), _2$$3, _3$$3, _0$$3)
			{
				...
				zephir_read_property(&_4$$4, this_ptr, SL("namespaces"), PH_NOISY_CC | PH_READONLY);
				...
				zephir_array_fetch(&_8$$4, &_7$$4, &name, PH_NOISY | PH_READONLY, "phalcon/Loader.zep", 452 TSRMLS_CC);
				zephir_fast_array_merge(&_6$$4, &_8$$4, &paths TSRMLS_CC);
			...
			while (1) {
				...
				zephir_check_call_status();
					zephir_read_property(&_9$$6, this_ptr, SL("namespaces"), PH_NOISY_CC | PH_READONLY);
					...
					zephir_array_fetch(&_13$$6, &_12$$6, &name, PH_NOISY | PH_READONLY, "phalcon/Loader.zep", 452 TSRMLS_CC);
					zephir_fast_array_merge(&_11$$6, &_13$$6, &paths TSRMLS_CC);
		...
		zephir_update_property_zval(this_ptr, SL("namespaces"), &preparedNamespaces);
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, setExtensions) {
	...
	zephir_update_property_zval(this_ptr, SL("extensions"), &extensions);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, setFileCheckingCallback) {
	...
	if (EXPECTED(zephir_is_callable(callback TSRMLS_CC))) {
		...
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_loader_exception_ce, "The 'callback' parameter must be either a callable or NULL.", "phalcon/Loader.zep", 508);
		return;
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 373, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("registered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Loader, prepareNamespace) {
	...
	array_init(&prepared);
	zephir_is_iterable(&namespace, 0, "phalcon/Loader.zep", 549);
...
zend_object *zephir_init_properties_Phalcon_Loader(zend_class_entry *class_type TSRMLS_DC) {
	...
	
	{
		...
		if (Z_TYPE_P(&_0) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_1$$3);
			array_init(&_1$$3);
			zephir_update_property_zval(this_ptr, SL("namespaces"), &_1$$3);
		}
		...
		zephir_read_property(&_4, this_ptr, SL("extensions"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_4) == IS_NULL) {
			...
			zephir_update_property_zval(this_ptr, SL("extensions"), &_5$$5);
		}
		zephir_read_property(&_7, this_ptr, SL("directories"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_7) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_8$$6);
			array_init(&_8$$6);
			zephir_update_property_zval(this_ptr, SL("directories"), &_8$$6);
		}
		zephir_read_property(&_9, this_ptr, SL("classes"), PH_NOISY_CC | PH_READONLY);
		if (Z_TYPE_P(&_9) == IS_NULL) {
			ZEPHIR_INIT_VAR(&_10$$7);
			array_init(&_10$$7);
			zephir_update_property_zval(this_ptr, SL("classes"), &_10$$7);
		}
		ZEPHIR_MM_RESTORE();
