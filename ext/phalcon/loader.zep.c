...
PHP_METHOD(Phalcon_Loader, register) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 305, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 306, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("_registered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "call_user_func", &_6, 307, &fileCheckingCallback, &filePath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _4, _5, _3)
	{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _9$$6)
		{
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _11$$9)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_14$$10, "call_user_func", &_15, 307, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _18)
	{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _20$$14)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_23$$15, "call_user_func", &_15, 307, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
