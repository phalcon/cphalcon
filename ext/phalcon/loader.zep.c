...
PHP_METHOD(Phalcon_Loader, setFileCheckingCallback) {
	...
	if (EXPECTED(zephir_is_callable(callback TSRMLS_CC))) {
		...
		zephir_create_closure_ex(&_0$$4, NULL, phalcon_26__closure_ce, SL("__invoke"));
...
PHP_METHOD(Phalcon_Loader, registerNamespaces) {
	...
	if (merge) {
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&preparedNamespaces), _1$$3, _2$$3, _0$$3)
		{
			...
			zephir_array_fetch(&_7$$4, &_6$$4, &name, PH_NOISY | PH_READONLY, "phalcon/loader.zep", 145 TSRMLS_CC);
...
PHP_METHOD(Phalcon_Loader, register) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 328, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 329, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("_registered"), &__$true);
		} else {
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
	{
		...
		ZEPHIR_CALL_FUNCTION(&_5$$3, "call_user_func", &_6, 330, &fileCheckingCallback, &filePath);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, autoLoad) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *className_param = NULL, eventsManager, classes, extensions, filePath, ds, fixedDirectory, directories, ns, namespaces, nsPrefix, directory, fileName, extension, nsClassName, fileCheckingCallback, _2, *_3, *_18, _0$$3, _1$$5, _6$$6, _7$$6, _8$$6, *_9$$6, _10$$9, *_11$$9, _12$$11, _14$$10, _16$$13, _19$$14, *_20$$14, _21$$16, _23$$15, _24$$18, _26$$19;
	zval className;
	zval *this_ptr = getThis();
	...
	ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&namespaces), _4, _5, _3)
	{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _9$$6)
		{
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _11$$9)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_14$$10, "call_user_func", &_15, 330, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _18)
	{
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _20$$14)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_23$$15, "call_user_func", &_15, 330, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
