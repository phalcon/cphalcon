...
ZEPHIR_INIT_CLASS(Phalcon_CLI_Dispatcher) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Phalcon\\CLI, Dispatcher, phalcon_cli_dispatcher, "phalcon\\dispatcher", phalcon_cli_dispatcher_method_entry, 0);
	...
	zend_declare_property_string(phalcon_cli_dispatcher_ce, SL("_defaultAction"), "main", ZEND_ACC_PUBLIC TSRMLS_CC);
...
PHP_METHOD(Phalcon_CLI_Dispatcher, _throwDispatchException) {
	...
	zval *message, *exceptionCode = NULL, *exception, *eventsManager, *_0, *_1;
