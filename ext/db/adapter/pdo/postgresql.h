...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_db_adapter_pdo_postgresql_escapeidentifier, 0, 0, 1)
...
PHALCON_INIT_FUNCS(phalcon_db_adapter_pdo_postgresql_method_entry){
	...
	PHP_ME(Phalcon_Db_Adapter_Pdo_Postgresql, escapeIdentifier, arginfo_phalcon_db_adapter_pdo_postgresql_escapeidentifier, ZEND_ACC_PUBLIC) 
