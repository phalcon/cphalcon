...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_assets_resource_js___construct, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(phalcon_assets_resource_js_method_entry) {
	PHP_ME(Phalcon_Assets_Resource_Js, __construct, arginfo_phalcon_assets_resource_js___construct, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
