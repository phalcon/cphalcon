...
#define ZEPHIR_CONCAT_SVSSS(result, op1, op2, op3, op4, op5) \
	 zephir_concat_svsss(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, op5, sizeof(op5)-1, 0);
#define ZEPHIR_SCONCAT_SVSSS(result, op1, op2, op3, op4, op5) \
	 zephir_concat_svsss(result, op1, sizeof(op1)-1, op2, op3, sizeof(op3)-1, op4, sizeof(op4)-1, op5, sizeof(op5)-1, 1);
...
#define ZEPHIR_CONCAT_VVSVV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vvsvv(result, op1, op2, op3, sizeof(op3)-1, op4, op5, 0);
#define ZEPHIR_SCONCAT_VVSVV(result, op1, op2, op3, op4, op5) \
	 zephir_concat_vvsvv(result, op1, op2, op3, sizeof(op3)-1, op4, op5, 1);
