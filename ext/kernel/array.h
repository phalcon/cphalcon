...
int phalcon_array_isset_quick_string_fetch(zval **fetched, zval *arr, const char *index, uint index_length, unsigned long key) PHALCON_ATTR_NONNULL;
int phalcon_array_isset_string_fetch(zval **fetched, zval *arr, const char *index, uint index_length) PHALCON_ATTR_NONNULL;
int phalcon_array_isset_long_fetch(zval **fetched, zval *arr, unsigned long index) PHALCON_ATTR_NONNULL;

/** Check for index existence */
int phalcon_array_isset(const zval *arr, zval *index) PHALCON_ATTR_NONNULL;
int phalcon_array_isset_long(const zval *arr, unsigned long index) PHALCON_ATTR_NONNULL;
int phalcon_array_isset_string(const zval *arr, const char *index, uint index_length) PHALCON_ATTR_NONNULL;

/** Fast index existence checking */
int phalcon_array_isset_quick_string(const zval *arr, const char *index, uint index_length, unsigned long key) PHALCON_ATTR_NONNULL;

/** Unset existing indexes */
int phalcon_array_unset(zval **arr, zval *index, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_unset_long(zval **arr, unsigned long index, int flags) PHALCON_ATTR_NONNULL;
...
int phalcon_array_append_long(zval **arr, long value, int separate) PHALCON_ATTR_NONNULL;
int phalcon_array_append_string(zval **arr, char *value, uint value_length, int separate) PHALCON_ATTR_NONNULL;

/** Modify arrays */
int phalcon_array_update_zval(zval **arr, zval *index, zval **value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_zval_bool(zval **arr, zval *index, int value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_zval_long(zval **arr, zval *index, long value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_zval_string(zval **arr, zval *index, char *value, uint value_length, int flags) PHALCON_ATTR_NONNULL;

int phalcon_array_update_string(zval **arr, const char *index, uint index_length, zval **value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_string_bool(zval **arr, const char *index, uint index_length, int value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_string_long(zval **arr, const char *index, uint index_length, long value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_string_string(zval **arr, const char *index, uint index_length, char *value, uint value_length, int flags) PHALCON_ATTR_NONNULL;

int phalcon_array_update_long(zval **arr, unsigned long index, zval **value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_long_string(zval **arr, unsigned long index, char *value, uint value_length, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_long_long(zval **arr, unsigned long index, long value, int flags) PHALCON_ATTR_NONNULL;
int phalcon_array_update_long_bool(zval **arr, unsigned long index, int value, int flags) PHALCON_ATTR_NONNULL;
...
int phalcon_array_fetch_string(zval **return_value, zval *arr, const char *index, uint index_length, int silent) PHALCON_ATTR_NONNULL;
int phalcon_array_fetch_long(zval **return_value, zval *arr, unsigned long index, int silent) PHALCON_ATTR_NONNULL;
...
void phalcon_array_next(zval *array) PHALCON_ATTR_NONNULL;
...
int phalcon_array_is_associative(zval *arr) PHALCON_ATTR_NONNULL;
