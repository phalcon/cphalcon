...
const char *phalcon_interned_modelsCriteria			= NULL;
const char *phalcon_interned_modelsResultsetSimple	= NULL;
const char *phalcon_interned_modelsResultsetComplex	= NULL;
...
const char *phalcon_interned_cookies				= NULL;
const char *phalcon_interned_annotations			= NULL;
const char *phalcon_interned_security				= NULL;
const char *phalcon_interned_crypt					= NULL;
const char *phalcon_interned_flash					= NULL;
const char *phalcon_interned_flashSession			= NULL;
const char *phalcon_interned_tag					= NULL;
const char *phalcon_interned_sessionBag				= NULL;
...
PHALCON_STATIC void phalcon_init_interned_strings(TSRMLS_D)
{
	...
	phalcon_interned_modelsCriteria				= zend_new_interned_string(ZEND_STRS("modelsCriteria"), 0 TSRMLS_CC);
	phalcon_interned_modelsResultsetSimple		= zend_new_interned_string(ZEND_STRS("modelsResultsetSimple"), 0 TSRMLS_CC);
	phalcon_interned_modelsResultsetComplex		= zend_new_interned_string(ZEND_STRS("modelsResultsetComplex"), 0 TSRMLS_CC);
