...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_put, 0, 0, 4)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_phalcon_queue_beanstalk_delete, 0, 0, 1)
	ZEND_ARG_INFO(0, id)
ZEND_END_ARG_INFO()
...
PHALCON_INIT_FUNCS(phalcon_queue_beanstalk_method_entry){
	...
	PHP_ME(Phalcon_Queue_Beanstalk, _write, NULL, ZEND_ACC_PROTECTED) 
	PHP_ME(Phalcon_Queue_Beanstalk, reserve, arginfo_phalcon_queue_beanstalk_reserve, ZEND_ACC_PUBLIC) 
	PHP_ME(Phalcon_Queue_Beanstalk, delete, arginfo_phalcon_queue_beanstalk_delete, ZEND_ACC_PUBLIC) 
	PHP_ME(Phalcon_Queue_Beanstalk, _read, NULL, ZEND_ACC_PROTECTED) 
	PHP_ME(Phalcon_Queue_Beanstalk, _readStatus, NULL, ZEND_ACC_PROTECTED) 
