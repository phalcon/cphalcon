...
#[Group('pgsql')]
#[Group('sqlite')]
final class RollbackPendentTest extends AbstractDatabaseTestCase
{
    use DiTrait;
    ...
    /**
     * rollbackPendent() rolls back any pending managed transactions.
     *
     ...
     * @since  2026-06-22
     */
    public function testMvcModelTransactionManagerRollbackPendent(): void
    {
