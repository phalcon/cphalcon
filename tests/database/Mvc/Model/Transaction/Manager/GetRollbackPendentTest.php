...
#[Group('pgsql')]
#[Group('sqlite')]
final class GetRollbackPendentTest extends AbstractDatabaseTestCase
{
    use DiTrait;
     ...
     * @since  2026-06-22
     */
    public function testMvcModelTransactionManagerGetRollbackPendent(): void
    {
        $manager = new Manager($this->container);

        // Registering a shutdown rollback is on by default.
        $this->assertTrue($manager->getRollbackPendent());
