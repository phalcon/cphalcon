...
final class ReadTest extends AbstractDatabaseTestCase
{
    use DiTrait;
    ...
    public function testMvcModelMetadataRead(
        string $service
    ): void {
        ...
        // read() returns what was written to the underlying adapter
        ...
        if ('metadataMemory' === $service) {
            ...
            // read() is a no-op that always returns null.
