...
{
    public function testDMPdoConnectionExecCanceled(): void
    {
        $manager = new Manager();
        $manager->attach(
            Events::BEFORE_EXEC,
    ...
    public function testDMPdoConnectionPerformCanceled(): void
    {
        $manager = new Manager();
        $manager->attach(
    ...
    public function testDMPdoConnectionQueryCanceled(): void
    {
        $manager = new Manager();
        $manager->attach(
            Events::BEFORE_QUERY,
