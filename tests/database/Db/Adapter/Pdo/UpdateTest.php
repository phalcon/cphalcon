...
final class UpdateTest extends AbstractDatabaseTestCase
{
    ...
    /**
     * Tests Phalcon\Db\Adapter\Pdo :: update()
     *
     ...
     * @group sqlite
     */
    public function testDbAdapterPdoUpdate(): void
    {
        ...
        $this->assertSame('updated title', $row['inv_title']);
        $this->assertSame(9, (int) $row['inv_status_flag']);
    }
}
