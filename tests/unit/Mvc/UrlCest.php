...
class UrlCest
{
     ...
     * @since  2014-09-04
     */
    public function shouldGetCorrectUrlWithServer(UnitTester $I)
    {
     ...
     * @since  2014-09-04
     */
    public function shouldCorrectSetBaseUri(UnitTester $I)//+
    {
     ...
     */
    public function shouldGetCorrectUrl(UnitTester $I)
    {
