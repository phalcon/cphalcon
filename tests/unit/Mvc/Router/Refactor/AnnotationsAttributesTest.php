...
#[BackupGlobals(true)]
final class AnnotationsAttributesTest extends AbstractUnitTestCase
{
    use DiTrait;
    ...
    public function setUp(): void
    {
        ...
        /**
         * Same fixtures, same assertions, the attributes reader instead of the
         * docblock one. The two flavors must give the same routes.
         */
