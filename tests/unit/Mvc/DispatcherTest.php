...
class DispatcherTest extends UnitTest
{
    ...
    {
        $this->specify(
                'afterBinding event should be fired', function () {
            $di         = new FactoryDefault();
            $dispatcher = new Dispatcher();
            $dispatcher->setDI($di);
            $manager    = new Manager();
            $manager->attach(
                    'dispatch:afterBinding', function (Event $event, Dispatcher $dispatcher) {
    ...
    {
        $this->specify(
                'afterBinding callback should be called', function () {
            $di         = new FactoryDefault();
            $dispatcher = new Dispatcher();
            $dispatcher->setDI($di);
            $dispatcher->setActionName('index');
    ...
    {
        $this->specify(
                "Dispatcher doesn't throw exception when handler can't be loaded", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't throw exception when handler can't be loaded (2)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't throw exception when handler can't be loaded (3)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't throw exception when action can't be found", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't return controller after dispatching", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't throw exception when action can't be found (2)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected (2)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected (3)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected (4)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected (5)", function () {
            $di = new Di();
        ...
        $this->specify(
                "Dispatcher doesn't work as expected (6)", function () {
            $di = new Di();
    ...
    {
        $this->specify(
                "MVC Dispatcher doesn't forward properly", function () {
            $di = new Di();
    ...
    {
        $this->specify(
                "MVC Dispatcher doesn't forward properly (2)", function () {
            $di = new Di();
    ...
    {
        $this->specify(
                "MVC Dispatcher doesn't calculate the controller class properly", function () {
            $di = new Di();
    ...
    {
        $this->specify(
                "Dispatcher defaults are not resolved correctly", function () {
            $di = new Di();
    ...
    {
        $this->specify(
                "Action method isn't called properly", function () {
            $di = new FactoryDefault();
    ...
    {
        $this->specify(
                "Dispatcher doesn't store the last controller", function () {
            $di = new Di();
