...
class CreditCardCest
{
     ...
     * @since  2016-06-05
     */
    public function shouldValidateMultipleFields(UnitTester $I)
    {
        $validation = new Validation();
     ...
     * @since  2015-09-06
     */
    public function shouldDetectValidCreditCard(UnitTester $I)
    {
        $providers = [
     ...
     * @since  2015-09-06
     */
    public function shouldDetectInvalidCreditCard(UnitTester $I)
    {
        $cards = [
            '1203191201121221',
            '102030102320',
