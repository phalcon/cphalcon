...
class ApcuCest
{
    ...
    {
        $I->wantTo('Increment counter by using APCu as cache backend');
    ...
    {
        $I->wantTo('Decrement counter by using APCu as cache backend');
    ...
    {
        $I->wantTo('Flush all cache by using APCu as cache backend');
    ...
    {
        $I->wantTo('Get cache keys by using APCu as cache backend');
