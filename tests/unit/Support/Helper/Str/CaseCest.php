...
class CaseCest
{
    ...
    private function getSources(): array
    {
        return [
            ...
            [KebabCase::class, 'kebab', 'c_a_m_e_l_i_z_e', 'c_a_m_e_l_i_z_e', null],
            [KebabCase::class, 'kebab', 'Camelize', 'Camelize', null],
            [KebabCase::class, 'kebab', 'camel_ize', 'camel_ize', null],
            [KebabCase::class, 'kebab', 'CameLize', 'CameLize', null],
            [KebabCase::class, 'kebab', 'c_a-m_e-l_i-z_e', 'c_a_m_e_l_i_z_e', null],
            [KebabCase::class, 'kebab', 'came_li_ze', 'came_li_ze', null],
            [KebabCase::class, 'kebab', '=_camelize', '=_camelize', '_'],
            [KebabCase::class, 'kebab', 'camelize', 'camelize', '_'],
            [KebabCase::class, 'kebab', 'came_li_ze', 'came_li_ze', '_'],
            [KebabCase::class, 'kebab', 'came#li#ze', 'came_li_ze', '#'],
            [KebabCase::class, 'kebab', 'came li ze', 'came_li_ze', ' '],
            [KebabCase::class, 'kebab', 'came.li^ze', 'came_li_ze', '.^'],
            [KebabCase::class, 'kebab', 'c_a-m_e-l_i-z_e', 'c_a_m_e_l_i_z_e', '-_'],
            [KebabCase::class, 'kebab', 'came.li.ze', 'came_li_ze', '.'],
            [KebabCase::class, 'kebab', 'came-li-ze', 'came_li_ze', '-'],
            [KebabCase::class, 'kebab', 'c+a+m+e+l+i+z+e', 'c_a_m_e_l_i_z_e', '+'],
            [KebabCase::class, 'kebab', 'customer-session', 'customer_session', null],
            [KebabCase::class, 'kebab', 'customer Session', 'customer_Session', ' -_'],
            [KebabCase::class, 'kebab', 'customer-Session', 'customer_Session', ' -_'],
            ...
            [SnakeCase::class, 'snake', 'c_a_m_e_l_i_z_e', 'c-a-m-e-l-i-z-e', null],
            [SnakeCase::class, 'snake', 'Camelize', 'Camelize', null],
            [SnakeCase::class, 'snake', 'camel_ize', 'camel-ize', null],
            [SnakeCase::class, 'snake', 'CameLize', 'CameLize', null],
            [SnakeCase::class, 'snake', 'c_a-m_e-l_i-z_e', 'c-a-m-e-l-i-z-e', null],
            [SnakeCase::class, 'snake', 'came_li_ze', 'came-li-ze', null],
            [SnakeCase::class, 'snake', '=_camelize', '=-camelize', '_'],
            [SnakeCase::class, 'snake', 'camelize', 'camelize', '_'],
            [SnakeCase::class, 'snake', 'came_li_ze', 'came-li-ze', '_'],
            [SnakeCase::class, 'snake', 'came#li#ze', 'came-li-ze', '#'],
            [SnakeCase::class, 'snake', 'came li ze', 'came-li-ze', ' '],
            [SnakeCase::class, 'snake', 'came.li^ze', 'came-li-ze', '.^'],
            [SnakeCase::class, 'snake', 'c_a-m_e-l_i-z_e', 'c-a-m-e-l-i-z-e', '-_'],
            [SnakeCase::class, 'snake', 'came.li.ze', 'came-li-ze', '.'],
            [SnakeCase::class, 'snake', 'came-li-ze', 'came-li-ze', '-'],
            [SnakeCase::class, 'snake', 'c+a+m+e+l+i+z+e', 'c-a-m-e-l-i-z-e', '+'],
            [SnakeCase::class, 'snake', 'customer-session', 'customer-session', null],
            [SnakeCase::class, 'snake', 'customer Session', 'customer-Session', ' -_'],
            [SnakeCase::class, 'snake', 'customer-Session', 'customer-Session', ' -_'],
        ];
    }
}
