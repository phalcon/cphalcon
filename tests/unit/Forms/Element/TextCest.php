...
class TextCest
{
    ...
    public function testIssue1210(UnitTester $I)
    {
    ...
    public function testIssue2045(UnitTester $I)
    {
        $element = new Text("name");
    ...
    public function testFormElementEmpty(UnitTester $I)
    {
        $element = new Text("name");
    ...
    public function testFormElement(UnitTester $I)
    {
        $element = new Text("name");
    ...
    public function testFormPrepareAttributes(UnitTester $I)
    {
        $element1 = new Text("name");
    ...
    public function testFormPrepareAttributesDefault(UnitTester $I)
    {
        $element1 = new Text("name");
    ...
    public function testFormOptions(UnitTester $I)
    {
        $element1 = new Text("name");
