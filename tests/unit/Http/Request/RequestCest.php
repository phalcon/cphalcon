...
class RequestCest extends HttpBase
{
    ...
    public function testRequestGetValueByUsingSeveralMethods(UnitTester $I)
    {
        ...
        $I->assertEquals(null, $request->get('array', 'stringlegacy', null, true, true));

        // getQuery
        $I->assertEquals('hello', $request->getQuery('string', 'string'));
        $I->assertEquals(null, $request->getQuery('array', 'stringlegacy', null, true, true));
        ...
        $I->assertEquals(null, $request->getPost('array', 'stringlegacy', null, true, true));
