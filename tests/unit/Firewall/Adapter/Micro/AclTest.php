    ...
    public function testAfterBinding()
    {
        $this->specify(
            ...
            function () {
                ...
                expect($micro->getDI())->isInstanceOf('Phalcon\Di');
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE1", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE1", 2));
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE2", 1));
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-update/1', new BindingRole("ROLE3", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE3", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-update/1', new BindingRole("ROLE3", 2));
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE3", 2));
                expect($returnedValue)->null();
                ...
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE4", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE4", 2));
                expect($returnedValue)->equals("allowed");
                ...
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE5", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE5", 2));
                expect($returnedValue)->equals("allowed");
                ...
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE6", 1));
                expect($returnedValue)->equals("allowed");
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE6", 2));
                expect($returnedValue)->equals("allowed");
                ...
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE7", 1));
                expect($returnedValue)->null();
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE7", 2));
                expect($returnedValue)->null();
    ...
    public function testAfterBindingKeyMap()
    {
        $this->specify(
            ...
            function () {
                ...
                $di->set('acl', $acl);
                $eventsManager = new Manager();
                $eventsManager->attach('micro:beforebeforeExecuteRoute', $this->firewall);
                $this->micro->setEventsManager($eventsManager);
                $micro = $this->micro;
    ...
    public function testCache()
    {
        $this->specify(
            ...
            function () {
                ...
                $returnedValue = $this->getMicroValueFor($di, $micro, '/album-get/1', new BindingRole("ROLE2", 2));
                expect($returnedValue)->null();
