...
mysql_db="CREATE DATABASE IF NOT EXISTS phalcon_test charset=utf8mb4 collate=utf8mb4_unicode_ci;"

(mysql -uroot -e "${mysql_db}" && mysql -uroot phalcon_test < "${TRAVIS_BUILD_DIR}/tests/_data/schemas/mysql/mysql.dump.sql") &
