    ...
    protected function getCreateTableFixtures(): array
    {
        return [
            'example1' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example1.sql')
                    )
                ),
            ],
            'example2' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example2.sql')
                    )
                ),
            ],
            'example3' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example3.sql')
                    )
                ),
            ],
            'example4' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example4.sql')
                    )
                ),
            ],
            'example5' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example5.sql')
                    )
                ),
            ],
            'example6' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example6.sql')
                    )
                ),
            ],
            'example7' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example7.sql')
                    )
                ),
            ],
            'example8' => [
                ...
                rtrim(
                    file_get_contents(
                        dataFolder('fixtures/Db/sqlite/example8.sql')
                    )
                ),
            ],
        ];
