...
class GetOptionCest
{
     ...
     * @since  2019-05-23
     */
    public function filterValidationValidatorStringLengthMaxGetOption(IntegrationTester $I)
    {
        $I->wantToTest('Validation\Validator\StringLength\Max - getOption()');

        $validator = new Max();

        $I->assertSame(null, $validator->getOption('max'), 'Max option is null by default');
