...
class CompilerFilesCest
{
    ...
    public function shouldCompileExtendsFile(IntegrationTester $I)
    {
        ...
        $I->safeDeleteFile(dataDir('fixtures/views/extends/children.extends.volt.php'));
        ...
        $compilation = file_get_contents(dataDir('fixtures/views/extends/children.extends.volt.php'));
    ...
    public function shouldCompileImportFile(IntegrationTester $I)
    {
        ...
        $I->safeDeleteFile(dataDir('fixtures/views/partials/header.volt.php'));
        $I->safeDeleteFile(dataDir('fixtures/views/partials/footer.volt.php'));
        $I->safeDeleteFile(dataDir('fixtures/views/extends/import.volt.php'));
        ...
        $compilation = file_get_contents(dataDir('fixtures/views/extends/import.volt.php'));
    ...
    public function shouldCompileImportRecursiveFiles(IntegrationTester $I)
    {
        ...
        $I->safeDeleteFile(dataDir('fixtures/views/partials/header3.volt.php'));
        $I->safeDeleteFile(dataDir('fixtures/views/partials/header2.volt.php'));
        $I->safeDeleteFile(dataDir('fixtures/views/extends/import2.volt.php'));
        ...
        $compilation = file_get_contents(dataDir('fixtures/views/extends/import2.volt.php'));
