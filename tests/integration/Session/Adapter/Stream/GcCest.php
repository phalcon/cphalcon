...
class GcCest
{
    ...
    public function sessionAdapterStreamGc(IntegrationTester $I)
    {
         ...
         */
        $actual = file_put_contents(outputSessionsDir('/gc_1'), uniqid());
        $I->assertNotFalse($actual);
        $actual = file_put_contents(outputSessionsDir('/gc_2'), uniqid());
        $I->assertNotFalse($actual);
        /**
        ...
        $I->dontSeeFileFound('gc_1', outputSessionsDir());
        $I->dontSeeFileFound('gc_2', outputSessionsDir());
    }
}
